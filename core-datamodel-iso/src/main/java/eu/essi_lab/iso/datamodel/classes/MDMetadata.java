...
public class MDMetadata extends ISOMetadata<MDMetadataType> {
    ...
    /**
     * @param id
     * @XPathDirective(target = ".", create = "gmd:fileIdentifier/gco:CharacterString", clear = "gmd:fileIdentifier", position =
     * Position.FIRST)
     */
     ...
     * @XPathDirective(target = ".", create = "gmd:hierarchyLevelName/gco:CharacterString", clear = "gmd:hierachyLevelName", after =
     * "gmd:hierarchyLevel")
     */
	...
	for (MDIdentificationPropertyType mdIdentificationPropertyType : identificationInfo) {
	    ...
	    JAXBElement<? extends AbstractMDIdentificationType> abstractMDIdentification = mdIdentificationPropertyType.getAbstractMDIdentification();
		...
		for (MDAggregateInformationPropertyType mdAggregateInformationPropertyType : aggregationInfo) {
		    ...
		    try {
			String id = ISOMetadata.getStringFromCharacterString(
				mdAggregateInformationPropertyType.getMDAggregateInformation().getAggregateDataSetIdentifier()
					.getMDIdentifier().getValue().getCode());
    ...
    /**
     * @param language
     * @XPathDirective(target = ".", create = "gmd:language/gco:CharacterString", clear = "gmd:language", after = "gmd:fileIdentifier",
    ...
    /**
     * @param id
     * @XPathDirective(target = ".", create = "gmd:parentIdentifier/gco:CharacterString", clear = "gmd:parentIdentifier", after =
     * "gmd:fileIdentifier gmd:language gmd:characterSet", position = Position.FIRST)
     */
     ...
     * @XPathDirective(target = ".", parent = "gmd:identificationInfo", before = "gmd:distributionInfo", position = Position.LAST)
     */
	...
	identifications.addAll(Lists.newArrayList(getServiceIdentifications()));
	identifications.addAll(Lists.newArrayList(getDataIdentifications()));
    ...
    /**
     * @XPathDirective(target = ".", parent = "gmd:referenceSystemInfo", before = "gmd:identificationInfo", position = Position.LAST)
     */
	...
	for (MDContentInformationPropertyType contentInfo : contentInfos) {
		...
		JAXBElement<? extends AbstractMDContentInformationType> abstractMDContentInformation = contentInfo.getAbstractMDContentInformation();
		AbstractMDContentInformationType value = abstractMDContentInformation.getValue();
		if (value instanceof MDCoverageDescriptionType) {
    ...
    /**
     * @XPathDirective(target = ".", parent = "gmd:spatialRepresentationInfo", before = "gmd:referenceSystemInfo", position =
     * Position.LAST)
     */
