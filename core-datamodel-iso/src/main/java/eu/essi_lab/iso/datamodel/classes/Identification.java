...
public class Identification extends ISOMetadata<AbstractMDIdentificationType> {
    ...
    /**
     * @return
     * @XPathDirective(target = "gmd:citation/gmd:CI_Citation/gmd:identifier/gmd:MD_Identifier/gmd:code/gco:CharacterString")
     */
     ...
     * @return
     * @XPathDirective(target =
     * "(.//gmd:citation/gmd:CI_Citation/gmd:date/gmd:CI_Date[gmd:dateType/gmd:CI_DateTypeCode/@codeListValue='creation' or
     * gmd:dateType/gmd:CI_DateTypeCode/@codeListValue='created']/gmd:date/gco:DateTime)[1]")
     */
     ...
     * @XPathDirective(target =
     * "(.//gmd:citation/gmd:CI_Citation/gmd:date/gmd:CI_Date[gmd:dateType/gmd:CI_DateTypeCode/@codeListValue='creation' or
     * gmd:dateType/gmd:CI_DateTypeCode/@codeListValue='created']/gmd:date/gco:Date)[1]")
     */
	...
	try {
	    ...
	    CodeListValueType codeListValue = createCodeListValueType(ISOMetadata.CI_PRESENTATION_FORM_CODE_CODELIST, presentationForm,
		    ISOMetadata.ISO_19115_CODESPACE, presentationForm);
	    ...
	    GSLoggerFactory.getLogger(getClass())
		    .warn("Could not set presentation form using reflection, trying direct approach: " + e.getMessage());
	...
	if (!type.getPointOfContact().isEmpty()) {
		...
		if (poc.isSetCIResponsibleParty()) {
		    ...
		    if (party != null && party.getRole() != null && party.getRole().isSetCIRoleCode() && party.getRole().getCIRoleCode()
			    .isSetCodeListValue() && party.getRole().getCIRoleCode().getCodeListValue().equals(role)) {
	...
	if (type != null) {
	    ...
	    ciDateTypeCodePropertyType.setCIDateTypeCode(
		    createCodeListValueType(CI_DATE_TYPE_CODE_CODELIST, type, ISO_19115_CODESPACE, type));
    ...
    /**
     * @return
     * @XPathDirective(target = "gmd:citation/gmd:CI_Citation/gmd:identifier/gmd:RS_Identifier/gmd:code/gco:CharacterString")
     */
    ...
    /**
     * @return
     * @XPathDirective(target = "gmd:citation/gmd:CI_Citation/gmd:identifier/gmd:RS_Identifier/gmd:codeSpace/gco:CharacterString")
     */
    ...
    /**
     * @return
     * @XPathDirective(target = "gmd:citation/gmd:CI_Citation/gmd:identifier/*:MD_Identifier/gmd:code/gco:CharacterString")
     */
    ...
    /**
     * @return
     * @XPathDirective(target = "gmd:citation/gmd:CI_Citation/gmd:identifier/*:MD_Identifier/gmd:authority/gco:CharacterString")
     */
    ...
    /**
     * @param authority
     * @XPathDirective(target = "gmd:citation/gmd:CI_Citation/gmd:identifier/gmd:MD_Identifier/gmd:authority/gco:CharacterString")
     */
	...
	try {
	    ...
	    CodeListValueType codeListValue = createCodeListValueType(ISOMetadata.MD_PROGRESS_CODE_CODELIST, status,
		    ISOMetadata.ISO_19115_CODESPACE, status);
	...
	List<net.opengis.iso19139.gmd.v_20060504.MDMaintenanceInformationPropertyType> maintenanceList = getElementType().getResourceMaintenance();
	...
	return new ArrayList<TemporalExtent>().iterator();
    }
	...
	return new ArrayList<BrowseGraphic>().iterator();
    }
