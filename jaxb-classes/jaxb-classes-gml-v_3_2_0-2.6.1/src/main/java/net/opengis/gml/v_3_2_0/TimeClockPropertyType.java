...
public class TimeClockPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "timeClock", buffer, theTimeClock, this.isSetTimeClock());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TimeClockPropertyType that = ((TimeClockPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeClock", lhsTimeClock), LocatorUtils.property(thatLocator, "timeClock", rhsTimeClock), lhsTimeClock, rhsTimeClock, this.isSetTimeClock(), that.isSetTimeClock())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            TimeClockType theTimeClock;
            theTimeClock = this.getTimeClock();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeClock", theTimeClock), currentHashCode, theTimeClock, this.isSetTimeClock());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimeClockPropertyType) {
            ...
            {
                java.lang.Boolean timeClockShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTimeClock());
                if (timeClockShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    TimeClockType sourceTimeClock;
                    sourceTimeClock = this.getTimeClock();
                    TimeClockType copyTimeClock = ((TimeClockType) strategy.copy(LocatorUtils.property(locator, "timeClock", sourceTimeClock), sourceTimeClock, this.isSetTimeClock()));
                    copy.setTimeClock(copyTimeClock);
                } else {
                    if (timeClockShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
                        copy.timeClock = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TimeClockPropertyType) {
            ...
            {
                java.lang.Boolean timeClockShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTimeClock(), rightObject.isSetTimeClock());
                if (timeClockShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    TimeClockType lhsTimeClock;
                    lhsTimeClock = leftObject.getTimeClock();
                    TimeClockType rhsTimeClock;
                    rhsTimeClock = rightObject.getTimeClock();
                    TimeClockType mergedTimeClock = ((TimeClockType) strategy.merge(LocatorUtils.property(leftLocator, "timeClock", lhsTimeClock), LocatorUtils.property(rightLocator, "timeClock", rhsTimeClock), lhsTimeClock, rhsTimeClock, leftObject.isSetTimeClock(), rightObject.isSetTimeClock()));
                    target.setTimeClock(mergedTimeClock);
                } else {
                    if (timeClockShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.timeClock = null;
                    }
                }
            }
            {
    ...
    public TimeClockPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public TimeClockPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public TimeClockPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
