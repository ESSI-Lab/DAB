...
public class CurvePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof CurvePropertyType) {
            final CurvePropertyType copy = ((CurvePropertyType) draftCopy);
            {
                ...
                if (abstractCurveShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractCurveType> copyAbstractCurve = ((JAXBElement<? extends AbstractCurveType> ) strategy.copy(LocatorUtils.property(locator, "abstractCurve", sourceAbstractCurve), sourceAbstractCurve, this.isSetAbstractCurve()));
        ...
        if (right instanceof CurvePropertyType) {
            ...
            final CurvePropertyType rightObject = ((CurvePropertyType) right);
            {
                ...
                if (abstractCurveShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractCurveType> mergedAbstractCurve = ((JAXBElement<? extends AbstractCurveType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractCurve", lhsAbstractCurve), LocatorUtils.property(rightLocator, "abstractCurve", rhsAbstractCurve), lhsAbstractCurve, rhsAbstractCurve, leftObject.isSetAbstractCurve(), rightObject.isSetAbstractCurve()));
                    target.setAbstractCurve(mergedAbstractCurve);
                } else {
                    if (abstractCurveShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.abstractCurve = null;
                    }
                }
            }
            {
    ...
    public CurvePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public CurvePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CurvePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
