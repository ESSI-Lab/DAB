...
public class AffineCSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof AffineCSPropertyType) {
            final AffineCSPropertyType copy = ((AffineCSPropertyType) draftCopy);
            {
                ...
                if (affineCSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    AffineCSType copyAffineCS = ((AffineCSType) strategy.copy(LocatorUtils.property(locator, "affineCS", sourceAffineCS), sourceAffineCS, this.isSetAffineCS()));
        ...
        if (right instanceof AffineCSPropertyType) {
            ...
            final AffineCSPropertyType rightObject = ((AffineCSPropertyType) right);
            {
                ...
                if (affineCSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    AffineCSType mergedAffineCS = ((AffineCSType) strategy.merge(LocatorUtils.property(leftLocator, "affineCS", lhsAffineCS), LocatorUtils.property(rightLocator, "affineCS", rhsAffineCS), lhsAffineCS, rhsAffineCS, leftObject.isSetAffineCS(), rightObject.isSetAffineCS()));
    ...
    public AffineCSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public AffineCSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public AffineCSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
