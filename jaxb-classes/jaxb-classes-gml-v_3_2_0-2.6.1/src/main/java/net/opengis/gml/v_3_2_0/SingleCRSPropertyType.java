...
public class SingleCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "abstractSingleCRS", buffer, theAbstractSingleCRS, this.isSetAbstractSingleCRS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SingleCRSPropertyType that = ((SingleCRSPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractSingleCRS", lhsAbstractSingleCRS), LocatorUtils.property(thatLocator, "abstractSingleCRS", rhsAbstractSingleCRS), lhsAbstractSingleCRS, rhsAbstractSingleCRS, this.isSetAbstractSingleCRS(), that.isSetAbstractSingleCRS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractCRSType> theAbstractSingleCRS;
            theAbstractSingleCRS = this.getAbstractSingleCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractSingleCRS", theAbstractSingleCRS), currentHashCode, theAbstractSingleCRS, this.isSetAbstractSingleCRS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SingleCRSPropertyType) {
            ...
            {
                java.lang.Boolean abstractSingleCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractSingleCRS());
                if (abstractSingleCRSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    JAXBElement<? extends AbstractCRSType> sourceAbstractSingleCRS;
                    sourceAbstractSingleCRS = this.getAbstractSingleCRS();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractCRSType> copyAbstractSingleCRS = ((JAXBElement<? extends AbstractCRSType> ) strategy.copy(LocatorUtils.property(locator, "abstractSingleCRS", sourceAbstractSingleCRS), sourceAbstractSingleCRS, this.isSetAbstractSingleCRS()));
                    copy.setAbstractSingleCRS(copyAbstractSingleCRS);
                } else {
                    if (abstractSingleCRSShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SingleCRSPropertyType) {
            ...
            {
                java.lang.Boolean abstractSingleCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractSingleCRS(), rightObject.isSetAbstractSingleCRS());
                if (abstractSingleCRSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    JAXBElement<? extends AbstractCRSType> lhsAbstractSingleCRS;
                    lhsAbstractSingleCRS = leftObject.getAbstractSingleCRS();
                    JAXBElement<? extends AbstractCRSType> rhsAbstractSingleCRS;
                    rhsAbstractSingleCRS = rightObject.getAbstractSingleCRS();
                    JAXBElement<? extends AbstractCRSType> mergedAbstractSingleCRS = ((JAXBElement<? extends AbstractCRSType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractSingleCRS", lhsAbstractSingleCRS), LocatorUtils.property(rightLocator, "abstractSingleCRS", rhsAbstractSingleCRS), lhsAbstractSingleCRS, rhsAbstractSingleCRS, leftObject.isSetAbstractSingleCRS(), rightObject.isSetAbstractSingleCRS()));
                    target.setAbstractSingleCRS(mergedAbstractSingleCRS);
                } else {
                    if (abstractSingleCRSShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.abstractSingleCRS = null;
                    }
                }
            }
            {
    ...
    public SingleCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public SingleCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SingleCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
