...
public class MetaDataPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "abstractMetaData", buffer, theAbstractMetaData, this.isSetAbstractMetaData());
        }
        {
            String theAbout;
            theAbout = this.getAbout();
            strategy.appendField(locator, this, "about", buffer, theAbout, this.isSetAbout());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MetaDataPropertyType that = ((MetaDataPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractMetaData", lhsAbstractMetaData), LocatorUtils.property(thatLocator, "abstractMetaData", rhsAbstractMetaData), lhsAbstractMetaData, rhsAbstractMetaData, this.isSetAbstractMetaData(), that.isSetAbstractMetaData())) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "about", lhsAbout), LocatorUtils.property(thatLocator, "about", rhsAbout), lhsAbout, rhsAbout, this.isSetAbout(), that.isSetAbout())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractMetaDataType> theAbstractMetaData;
            theAbstractMetaData = this.getAbstractMetaData();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractMetaData", theAbstractMetaData), currentHashCode, theAbstractMetaData, this.isSetAbstractMetaData());
        }
        {
            String theAbout;
            theAbout = this.getAbout();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "about", theAbout), currentHashCode, theAbout, this.isSetAbout());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MetaDataPropertyType) {
            ...
            {
                java.lang.Boolean abstractMetaDataShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractMetaData());
                if (abstractMetaDataShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    JAXBElement<? extends AbstractMetaDataType> sourceAbstractMetaData;
                    sourceAbstractMetaData = this.getAbstractMetaData();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractMetaDataType> copyAbstractMetaData = ((JAXBElement<? extends AbstractMetaDataType> ) strategy.copy(LocatorUtils.property(locator, "abstractMetaData", sourceAbstractMetaData), sourceAbstractMetaData, this.isSetAbstractMetaData()));
                    copy.setAbstractMetaData(copyAbstractMetaData);
                } else {
                    if (abstractMetaDataShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
                        copy.abstractMetaData = null;
                    }
                }
            }
            {
                java.lang.Boolean aboutShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbout());
                if (aboutShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    String sourceAbout;
                    sourceAbout = this.getAbout();
                    String copyAbout = ((String) strategy.copy(LocatorUtils.property(locator, "about", sourceAbout), sourceAbout, this.isSetAbout()));
                    copy.setAbout(copyAbout);
                } else {
                    if (aboutShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
                        copy.about = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MetaDataPropertyType) {
            ...
            {
                java.lang.Boolean abstractMetaDataShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractMetaData(), rightObject.isSetAbstractMetaData());
                if (abstractMetaDataShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    JAXBElement<? extends AbstractMetaDataType> lhsAbstractMetaData;
                    lhsAbstractMetaData = leftObject.getAbstractMetaData();
                    JAXBElement<? extends AbstractMetaDataType> rhsAbstractMetaData;
                    rhsAbstractMetaData = rightObject.getAbstractMetaData();
                    JAXBElement<? extends AbstractMetaDataType> mergedAbstractMetaData = ((JAXBElement<? extends AbstractMetaDataType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractMetaData", lhsAbstractMetaData), LocatorUtils.property(rightLocator, "abstractMetaData", rhsAbstractMetaData), lhsAbstractMetaData, rhsAbstractMetaData, leftObject.isSetAbstractMetaData(), rightObject.isSetAbstractMetaData()));
                    target.setAbstractMetaData(mergedAbstractMetaData);
                } else {
                    if (abstractMetaDataShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.abstractMetaData = null;
                    }
                }
            }
            {
                java.lang.Boolean aboutShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbout(), rightObject.isSetAbout());
                if (aboutShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    String lhsAbout;
                    lhsAbout = leftObject.getAbout();
                    String rhsAbout;
                    rhsAbout = rightObject.getAbout();
                    String mergedAbout = ((String) strategy.merge(LocatorUtils.property(leftLocator, "about", lhsAbout), LocatorUtils.property(rightLocator, "about", rhsAbout), lhsAbout, rhsAbout, leftObject.isSetAbout(), rightObject.isSetAbout()));
                    target.setAbout(mergedAbout);
                } else {
                    if (aboutShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.about = null;
                    }
                }
            }
    ...
    public MetaDataPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public MetaDataPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MetaDataPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
