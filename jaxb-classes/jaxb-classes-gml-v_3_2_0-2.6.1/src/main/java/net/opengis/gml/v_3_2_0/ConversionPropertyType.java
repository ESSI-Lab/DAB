...
public class ConversionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof ConversionPropertyType) {
            final ConversionPropertyType copy = ((ConversionPropertyType) draftCopy);
            {
                ...
                if (conversionShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    ConversionType copyConversion = ((ConversionType) strategy.copy(LocatorUtils.property(locator, "conversion", sourceConversion), sourceConversion, this.isSetConversion()));
        ...
        if (right instanceof ConversionPropertyType) {
            ...
            final ConversionPropertyType rightObject = ((ConversionPropertyType) right);
            {
                ...
                if (conversionShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    ConversionType mergedConversion = ((ConversionType) strategy.merge(LocatorUtils.property(leftLocator, "conversion", lhsConversion), LocatorUtils.property(rightLocator, "conversion", rhsConversion), lhsConversion, rhsConversion, leftObject.isSetConversion(), rightObject.isSetConversion()));
    ...
    public ConversionPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public ConversionPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ConversionPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
