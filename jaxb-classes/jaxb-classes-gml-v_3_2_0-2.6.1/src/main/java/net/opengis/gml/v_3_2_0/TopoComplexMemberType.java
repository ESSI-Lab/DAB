...
public class TopoComplexMemberType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "topoComplex", buffer, theTopoComplex, this.isSetTopoComplex());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TopoComplexMemberType that = ((TopoComplexMemberType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "topoComplex", lhsTopoComplex), LocatorUtils.property(thatLocator, "topoComplex", rhsTopoComplex), lhsTopoComplex, rhsTopoComplex, this.isSetTopoComplex(), that.isSetTopoComplex())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            TopoComplexType theTopoComplex;
            theTopoComplex = this.getTopoComplex();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "topoComplex", theTopoComplex), currentHashCode, theTopoComplex, this.isSetTopoComplex());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TopoComplexMemberType) {
            ...
            {
                java.lang.Boolean topoComplexShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTopoComplex());
                if (topoComplexShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    TopoComplexType sourceTopoComplex;
                    sourceTopoComplex = this.getTopoComplex();
                    TopoComplexType copyTopoComplex = ((TopoComplexType) strategy.copy(LocatorUtils.property(locator, "topoComplex", sourceTopoComplex), sourceTopoComplex, this.isSetTopoComplex()));
                    copy.setTopoComplex(copyTopoComplex);
                } else {
                    if (topoComplexShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TopoComplexMemberType) {
            ...
            {
                java.lang.Boolean topoComplexShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTopoComplex(), rightObject.isSetTopoComplex());
                if (topoComplexShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    TopoComplexType lhsTopoComplex;
                    lhsTopoComplex = leftObject.getTopoComplex();
                    TopoComplexType rhsTopoComplex;
                    rhsTopoComplex = rightObject.getTopoComplex();
                    TopoComplexType mergedTopoComplex = ((TopoComplexType) strategy.merge(LocatorUtils.property(leftLocator, "topoComplex", lhsTopoComplex), LocatorUtils.property(rightLocator, "topoComplex", rhsTopoComplex), lhsTopoComplex, rhsTopoComplex, leftObject.isSetTopoComplex(), rightObject.isSetTopoComplex()));
                    target.setTopoComplex(mergedTopoComplex);
                } else {
                    if (topoComplexShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.topoComplex = null;
                    }
                }
            }
            {
    ...
    public TopoComplexMemberType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public TopoComplexMemberType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public TopoComplexMemberType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
