...
public class DatumPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "abstractDatum", buffer, theAbstractDatum, this.isSetAbstractDatum());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DatumPropertyType that = ((DatumPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractDatum", lhsAbstractDatum), LocatorUtils.property(thatLocator, "abstractDatum", rhsAbstractDatum), lhsAbstractDatum, rhsAbstractDatum, this.isSetAbstractDatum(), that.isSetAbstractDatum())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractDatumType> theAbstractDatum;
            theAbstractDatum = this.getAbstractDatum();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractDatum", theAbstractDatum), currentHashCode, theAbstractDatum, this.isSetAbstractDatum());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DatumPropertyType) {
            ...
            {
                java.lang.Boolean abstractDatumShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractDatum());
                if (abstractDatumShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    JAXBElement<? extends AbstractDatumType> sourceAbstractDatum;
                    sourceAbstractDatum = this.getAbstractDatum();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractDatumType> copyAbstractDatum = ((JAXBElement<? extends AbstractDatumType> ) strategy.copy(LocatorUtils.property(locator, "abstractDatum", sourceAbstractDatum), sourceAbstractDatum, this.isSetAbstractDatum()));
                    copy.setAbstractDatum(copyAbstractDatum);
                } else {
                    if (abstractDatumShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DatumPropertyType) {
            ...
            {
                java.lang.Boolean abstractDatumShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractDatum(), rightObject.isSetAbstractDatum());
                if (abstractDatumShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    JAXBElement<? extends AbstractDatumType> lhsAbstractDatum;
                    lhsAbstractDatum = leftObject.getAbstractDatum();
                    JAXBElement<? extends AbstractDatumType> rhsAbstractDatum;
                    rhsAbstractDatum = rightObject.getAbstractDatum();
                    JAXBElement<? extends AbstractDatumType> mergedAbstractDatum = ((JAXBElement<? extends AbstractDatumType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractDatum", lhsAbstractDatum), LocatorUtils.property(rightLocator, "abstractDatum", rhsAbstractDatum), lhsAbstractDatum, rhsAbstractDatum, leftObject.isSetAbstractDatum(), rightObject.isSetAbstractDatum()));
                    target.setAbstractDatum(mergedAbstractDatum);
                } else {
                    if (abstractDatumShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.abstractDatum = null;
                    }
                }
            }
            {
    ...
    public DatumPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public DatumPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DatumPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
