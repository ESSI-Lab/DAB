...
public class VerticalCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof VerticalCRSPropertyType) {
            ...
            {
                java.lang.Boolean verticalCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetVerticalCRS());
                if (verticalCRSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    VerticalCRSType sourceVerticalCRS;
                    sourceVerticalCRS = this.getVerticalCRS();
                    VerticalCRSType copyVerticalCRS = ((VerticalCRSType) strategy.copy(LocatorUtils.property(locator, "verticalCRS", sourceVerticalCRS), sourceVerticalCRS, this.isSetVerticalCRS()));
                    copy.setVerticalCRS(copyVerticalCRS);
                } else {
                    if (verticalCRSShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof VerticalCRSPropertyType) {
            ...
            {
                java.lang.Boolean verticalCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetVerticalCRS(), rightObject.isSetVerticalCRS());
                if (verticalCRSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    VerticalCRSType lhsVerticalCRS;
                    lhsVerticalCRS = leftObject.getVerticalCRS();
                    VerticalCRSType rhsVerticalCRS;
                    rhsVerticalCRS = rightObject.getVerticalCRS();
                    VerticalCRSType mergedVerticalCRS = ((VerticalCRSType) strategy.merge(LocatorUtils.property(leftLocator, "verticalCRS", lhsVerticalCRS), LocatorUtils.property(rightLocator, "verticalCRS", rhsVerticalCRS), lhsVerticalCRS, rhsVerticalCRS, leftObject.isSetVerticalCRS(), rightObject.isSetVerticalCRS()));
                    target.setVerticalCRS(mergedVerticalCRS);
                } else {
                    if (verticalCRSShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
    ...
    public VerticalCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public VerticalCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public VerticalCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
