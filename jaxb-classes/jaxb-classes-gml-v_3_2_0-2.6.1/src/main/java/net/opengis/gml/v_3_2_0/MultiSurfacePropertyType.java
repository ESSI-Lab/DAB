...
public class MultiSurfacePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "multiSurface", buffer, theMultiSurface, this.isSetMultiSurface());
        }
        {
            boolean theOwns;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MultiSurfacePropertyType that = ((MultiSurfacePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "multiSurface", lhsMultiSurface), LocatorUtils.property(thatLocator, "multiSurface", rhsMultiSurface), lhsMultiSurface, rhsMultiSurface, this.isSetMultiSurface(), that.isSetMultiSurface())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MultiSurfaceType theMultiSurface;
            theMultiSurface = this.getMultiSurface();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "multiSurface", theMultiSurface), currentHashCode, theMultiSurface, this.isSetMultiSurface());
        }
        {
            boolean theOwns;
            theOwns = (this.isSetOwns()?this.isOwns():false);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MultiSurfacePropertyType) {
            ...
            {
                java.lang.Boolean multiSurfaceShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMultiSurface());
                if (multiSurfaceShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    MultiSurfaceType sourceMultiSurface;
                    sourceMultiSurface = this.getMultiSurface();
                    MultiSurfaceType copyMultiSurface = ((MultiSurfaceType) strategy.copy(LocatorUtils.property(locator, "multiSurface", sourceMultiSurface), sourceMultiSurface, this.isSetMultiSurface()));
                    copy.setMultiSurface(copyMultiSurface);
                } else {
                    if (multiSurfaceShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MultiSurfacePropertyType) {
            ...
            {
                java.lang.Boolean multiSurfaceShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMultiSurface(), rightObject.isSetMultiSurface());
                if (multiSurfaceShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    MultiSurfaceType lhsMultiSurface;
                    lhsMultiSurface = leftObject.getMultiSurface();
                    MultiSurfaceType rhsMultiSurface;
                    rhsMultiSurface = rightObject.getMultiSurface();
                    MultiSurfaceType mergedMultiSurface = ((MultiSurfaceType) strategy.merge(LocatorUtils.property(leftLocator, "multiSurface", lhsMultiSurface), LocatorUtils.property(rightLocator, "multiSurface", rhsMultiSurface), lhsMultiSurface, rhsMultiSurface, leftObject.isSetMultiSurface(), rightObject.isSetMultiSurface()));
                    target.setMultiSurface(mergedMultiSurface);
                } else {
                    if (multiSurfaceShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.multiSurface = null;
                    }
                }
            }
            {
    ...
    public MultiSurfacePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public MultiSurfacePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MultiSurfacePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
