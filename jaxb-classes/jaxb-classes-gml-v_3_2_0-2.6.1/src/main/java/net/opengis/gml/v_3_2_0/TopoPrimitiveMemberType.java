...
public class TopoPrimitiveMemberType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof TopoPrimitiveMemberType) {
            final TopoPrimitiveMemberType copy = ((TopoPrimitiveMemberType) draftCopy);
            {
                ...
                if (abstractTopoPrimitiveShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractTopoPrimitiveType> copyAbstractTopoPrimitive = ((JAXBElement<? extends AbstractTopoPrimitiveType> ) strategy.copy(LocatorUtils.property(locator, "abstractTopoPrimitive", sourceAbstractTopoPrimitive), sourceAbstractTopoPrimitive, this.isSetAbstractTopoPrimitive()));
        ...
        if (right instanceof TopoPrimitiveMemberType) {
            ...
            final TopoPrimitiveMemberType rightObject = ((TopoPrimitiveMemberType) right);
            {
                ...
                if (abstractTopoPrimitiveShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractTopoPrimitiveType> mergedAbstractTopoPrimitive = ((JAXBElement<? extends AbstractTopoPrimitiveType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractTopoPrimitive", lhsAbstractTopoPrimitive), LocatorUtils.property(rightLocator, "abstractTopoPrimitive", rhsAbstractTopoPrimitive), lhsAbstractTopoPrimitive, rhsAbstractTopoPrimitive, leftObject.isSetAbstractTopoPrimitive(), rightObject.isSetAbstractTopoPrimitive()));
                    target.setAbstractTopoPrimitive(mergedAbstractTopoPrimitive);
                } else {
                    if (abstractTopoPrimitiveShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.abstractTopoPrimitive = null;
                    }
                }
            }
            {
    ...
    public TopoPrimitiveMemberType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public TopoPrimitiveMemberType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public TopoPrimitiveMemberType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
