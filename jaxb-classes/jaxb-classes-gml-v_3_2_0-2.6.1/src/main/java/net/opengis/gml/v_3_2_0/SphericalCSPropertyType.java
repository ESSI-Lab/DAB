...
public class SphericalCSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof SphericalCSPropertyType) {
            final SphericalCSPropertyType copy = ((SphericalCSPropertyType) draftCopy);
            {
                ...
                if (sphericalCSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    SphericalCSType copySphericalCS = ((SphericalCSType) strategy.copy(LocatorUtils.property(locator, "sphericalCS", sourceSphericalCS), sourceSphericalCS, this.isSetSphericalCS()));
        ...
        if (right instanceof SphericalCSPropertyType) {
            ...
            final SphericalCSPropertyType rightObject = ((SphericalCSPropertyType) right);
            {
                ...
                if (sphericalCSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    SphericalCSType mergedSphericalCS = ((SphericalCSType) strategy.merge(LocatorUtils.property(leftLocator, "sphericalCS", lhsSphericalCS), LocatorUtils.property(rightLocator, "sphericalCS", rhsSphericalCS), lhsSphericalCS, rhsSphericalCS, leftObject.isSetSphericalCS(), rightObject.isSetSphericalCS()));
    ...
    public SphericalCSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public SphericalCSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SphericalCSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
