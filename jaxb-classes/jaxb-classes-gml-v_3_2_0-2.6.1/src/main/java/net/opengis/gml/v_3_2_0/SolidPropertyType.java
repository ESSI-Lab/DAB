...
public class SolidPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof SolidPropertyType) {
            final SolidPropertyType copy = ((SolidPropertyType) draftCopy);
            {
                ...
                if (abstractSolidShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractSolidType> copyAbstractSolid = ((JAXBElement<? extends AbstractSolidType> ) strategy.copy(LocatorUtils.property(locator, "abstractSolid", sourceAbstractSolid), sourceAbstractSolid, this.isSetAbstractSolid()));
        ...
        if (right instanceof SolidPropertyType) {
            ...
            final SolidPropertyType rightObject = ((SolidPropertyType) right);
            {
                ...
                if (abstractSolidShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractSolidType> mergedAbstractSolid = ((JAXBElement<? extends AbstractSolidType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractSolid", lhsAbstractSolid), LocatorUtils.property(rightLocator, "abstractSolid", rhsAbstractSolid), lhsAbstractSolid, rhsAbstractSolid, leftObject.isSetAbstractSolid(), rightObject.isSetAbstractSolid()));
                    target.setAbstractSolid(mergedAbstractSolid);
                } else {
                    if (abstractSolidShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.abstractSolid = null;
                    }
                }
            }
            {
    ...
    public SolidPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public SolidPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SolidPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
