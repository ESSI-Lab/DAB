...
public class QuantityPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof QuantityPropertyType) {
            ...
            {
                java.lang.Boolean quantityShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetQuantity());
                if (quantityShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    Quantity sourceQuantity;
                    sourceQuantity = this.getQuantity();
                    Quantity copyQuantity = ((Quantity) strategy.copy(LocatorUtils.property(locator, "quantity", sourceQuantity), sourceQuantity, this.isSetQuantity()));
                    copy.setQuantity(copyQuantity);
                } else {
                    if (quantityShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
                        copy.quantity = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof QuantityPropertyType) {
            ...
            {
                java.lang.Boolean quantityShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetQuantity(), rightObject.isSetQuantity());
                if (quantityShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    Quantity lhsQuantity;
                    lhsQuantity = leftObject.getQuantity();
                    Quantity rhsQuantity;
                    rhsQuantity = rightObject.getQuantity();
                    Quantity mergedQuantity = ((Quantity) strategy.merge(LocatorUtils.property(leftLocator, "quantity", lhsQuantity), LocatorUtils.property(rightLocator, "quantity", rhsQuantity), lhsQuantity, rhsQuantity, leftObject.isSetQuantity(), rightObject.isSetQuantity()));
                    target.setQuantity(mergedQuantity);
                } else {
                    if (quantityShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
    ...
    public QuantityPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public QuantityPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public QuantityPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
