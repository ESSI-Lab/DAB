...
public class TimeTopologyComplexPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "timeTopologyComplex", buffer, theTimeTopologyComplex, this.isSetTimeTopologyComplex());
        }
        {
            boolean theOwns;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TimeTopologyComplexPropertyType that = ((TimeTopologyComplexPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeTopologyComplex", lhsTimeTopologyComplex), LocatorUtils.property(thatLocator, "timeTopologyComplex", rhsTimeTopologyComplex), lhsTimeTopologyComplex, rhsTimeTopologyComplex, this.isSetTimeTopologyComplex(), that.isSetTimeTopologyComplex())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            TimeTopologyComplexType theTimeTopologyComplex;
            theTimeTopologyComplex = this.getTimeTopologyComplex();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeTopologyComplex", theTimeTopologyComplex), currentHashCode, theTimeTopologyComplex, this.isSetTimeTopologyComplex());
        }
        {
            boolean theOwns;
            theOwns = (this.isSetOwns()?this.isOwns():false);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimeTopologyComplexPropertyType) {
            ...
            {
                java.lang.Boolean timeTopologyComplexShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTimeTopologyComplex());
                if (timeTopologyComplexShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    TimeTopologyComplexType sourceTimeTopologyComplex;
                    sourceTimeTopologyComplex = this.getTimeTopologyComplex();
                    TimeTopologyComplexType copyTimeTopologyComplex = ((TimeTopologyComplexType) strategy.copy(LocatorUtils.property(locator, "timeTopologyComplex", sourceTimeTopologyComplex), sourceTimeTopologyComplex, this.isSetTimeTopologyComplex()));
                    copy.setTimeTopologyComplex(copyTimeTopologyComplex);
                } else {
                    if (timeTopologyComplexShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TimeTopologyComplexPropertyType) {
            ...
            {
                java.lang.Boolean timeTopologyComplexShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTimeTopologyComplex(), rightObject.isSetTimeTopologyComplex());
                if (timeTopologyComplexShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    TimeTopologyComplexType lhsTimeTopologyComplex;
                    lhsTimeTopologyComplex = leftObject.getTimeTopologyComplex();
                    TimeTopologyComplexType rhsTimeTopologyComplex;
                    rhsTimeTopologyComplex = rightObject.getTimeTopologyComplex();
                    TimeTopologyComplexType mergedTimeTopologyComplex = ((TimeTopologyComplexType) strategy.merge(LocatorUtils.property(leftLocator, "timeTopologyComplex", lhsTimeTopologyComplex), LocatorUtils.property(rightLocator, "timeTopologyComplex", rhsTimeTopologyComplex), lhsTimeTopologyComplex, rhsTimeTopologyComplex, leftObject.isSetTimeTopologyComplex(), rightObject.isSetTimeTopologyComplex()));
                    target.setTimeTopologyComplex(mergedTimeTopologyComplex);
                } else {
                    if (timeTopologyComplexShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.timeTopologyComplex = null;
                    }
                }
            }
            {
    ...
    public TimeTopologyComplexPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public TimeTopologyComplexPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public TimeTopologyComplexPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
