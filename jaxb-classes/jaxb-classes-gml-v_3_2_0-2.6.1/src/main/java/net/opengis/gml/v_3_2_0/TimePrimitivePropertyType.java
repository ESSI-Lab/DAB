...
public class TimePrimitivePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "abstractTimePrimitive", buffer, theAbstractTimePrimitive, this.isSetAbstractTimePrimitive());
        }
        {
            boolean theOwns;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TimePrimitivePropertyType that = ((TimePrimitivePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractTimePrimitive", lhsAbstractTimePrimitive), LocatorUtils.property(thatLocator, "abstractTimePrimitive", rhsAbstractTimePrimitive), lhsAbstractTimePrimitive, rhsAbstractTimePrimitive, this.isSetAbstractTimePrimitive(), that.isSetAbstractTimePrimitive())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractTimePrimitiveType> theAbstractTimePrimitive;
            theAbstractTimePrimitive = this.getAbstractTimePrimitive();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractTimePrimitive", theAbstractTimePrimitive), currentHashCode, theAbstractTimePrimitive, this.isSetAbstractTimePrimitive());
        }
        {
            boolean theOwns;
            theOwns = (this.isSetOwns()?this.isOwns():false);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimePrimitivePropertyType) {
            ...
            {
                java.lang.Boolean abstractTimePrimitiveShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractTimePrimitive());
                if (abstractTimePrimitiveShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractTimePrimitiveType> copyAbstractTimePrimitive = ((JAXBElement<? extends AbstractTimePrimitiveType> ) strategy.copy(LocatorUtils.property(locator, "abstractTimePrimitive", sourceAbstractTimePrimitive), sourceAbstractTimePrimitive, this.isSetAbstractTimePrimitive()));
                    copy.setAbstractTimePrimitive(copyAbstractTimePrimitive);
                } else {
                    if (abstractTimePrimitiveShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TimePrimitivePropertyType) {
            ...
            {
                java.lang.Boolean abstractTimePrimitiveShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractTimePrimitive(), rightObject.isSetAbstractTimePrimitive());
                if (abstractTimePrimitiveShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    JAXBElement<? extends AbstractTimePrimitiveType> lhsAbstractTimePrimitive;
                    ...
                    JAXBElement<? extends AbstractTimePrimitiveType> mergedAbstractTimePrimitive = ((JAXBElement<? extends AbstractTimePrimitiveType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractTimePrimitive", lhsAbstractTimePrimitive), LocatorUtils.property(rightLocator, "abstractTimePrimitive", rhsAbstractTimePrimitive), lhsAbstractTimePrimitive, rhsAbstractTimePrimitive, leftObject.isSetAbstractTimePrimitive(), rightObject.isSetAbstractTimePrimitive()));
                    target.setAbstractTimePrimitive(mergedAbstractTimePrimitive);
                } else {
                    if (abstractTimePrimitiveShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.abstractTimePrimitive = null;
                    }
                }
            }
            {
    ...
    public TimePrimitivePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public TimePrimitivePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public TimePrimitivePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
