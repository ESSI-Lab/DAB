...
public class ConcatenatedOperationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "concatenatedOperation", buffer, theConcatenatedOperation, this.isSetConcatenatedOperation());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ConcatenatedOperationPropertyType that = ((ConcatenatedOperationPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "concatenatedOperation", lhsConcatenatedOperation), LocatorUtils.property(thatLocator, "concatenatedOperation", rhsConcatenatedOperation), lhsConcatenatedOperation, rhsConcatenatedOperation, this.isSetConcatenatedOperation(), that.isSetConcatenatedOperation())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            ConcatenatedOperationType theConcatenatedOperation;
            theConcatenatedOperation = this.getConcatenatedOperation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "concatenatedOperation", theConcatenatedOperation), currentHashCode, theConcatenatedOperation, this.isSetConcatenatedOperation());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ConcatenatedOperationPropertyType) {
            ...
            {
                java.lang.Boolean concatenatedOperationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetConcatenatedOperation());
                if (concatenatedOperationShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ConcatenatedOperationType sourceConcatenatedOperation;
                    sourceConcatenatedOperation = this.getConcatenatedOperation();
                    ConcatenatedOperationType copyConcatenatedOperation = ((ConcatenatedOperationType) strategy.copy(LocatorUtils.property(locator, "concatenatedOperation", sourceConcatenatedOperation), sourceConcatenatedOperation, this.isSetConcatenatedOperation()));
                    copy.setConcatenatedOperation(copyConcatenatedOperation);
                } else {
                    if (concatenatedOperationShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ConcatenatedOperationPropertyType) {
            ...
            {
                java.lang.Boolean concatenatedOperationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetConcatenatedOperation(), rightObject.isSetConcatenatedOperation());
                if (concatenatedOperationShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ConcatenatedOperationType lhsConcatenatedOperation;
                    ...
                    ConcatenatedOperationType mergedConcatenatedOperation = ((ConcatenatedOperationType) strategy.merge(LocatorUtils.property(leftLocator, "concatenatedOperation", lhsConcatenatedOperation), LocatorUtils.property(rightLocator, "concatenatedOperation", rhsConcatenatedOperation), lhsConcatenatedOperation, rhsConcatenatedOperation, leftObject.isSetConcatenatedOperation(), rightObject.isSetConcatenatedOperation()));
                    target.setConcatenatedOperation(mergedConcatenatedOperation);
                } else {
                    if (concatenatedOperationShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.concatenatedOperation = null;
                    }
                }
            }
            {
    ...
    public ConcatenatedOperationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public ConcatenatedOperationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ConcatenatedOperationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
