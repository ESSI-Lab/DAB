...
public class IsolatedPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "node", buffer, theNode, this.isSetNode());
        }
        {
            EdgeType theEdge;
            theEdge = this.getEdge();
            strategy.appendField(locator, this, "edge", buffer, theEdge, this.isSetEdge());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final IsolatedPropertyType that = ((IsolatedPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "node", lhsNode), LocatorUtils.property(thatLocator, "node", rhsNode), lhsNode, rhsNode, this.isSetNode(), that.isSetNode())) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "edge", lhsEdge), LocatorUtils.property(thatLocator, "edge", rhsEdge), lhsEdge, rhsEdge, this.isSetEdge(), that.isSetEdge())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            NodeType theNode;
            theNode = this.getNode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "node", theNode), currentHashCode, theNode, this.isSetNode());
        }
        {
            EdgeType theEdge;
            theEdge = this.getEdge();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "edge", theEdge), currentHashCode, theEdge, this.isSetEdge());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof IsolatedPropertyType) {
            ...
            {
                java.lang.Boolean nodeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetNode());
                if (nodeShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    NodeType sourceNode;
                    sourceNode = this.getNode();
                    NodeType copyNode = ((NodeType) strategy.copy(LocatorUtils.property(locator, "node", sourceNode), sourceNode, this.isSetNode()));
                    copy.setNode(copyNode);
                } else {
                    if (nodeShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
                        copy.node = null;
                    }
                }
            }
            {
                java.lang.Boolean edgeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetEdge());
                if (edgeShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    EdgeType sourceEdge;
                    sourceEdge = this.getEdge();
                    EdgeType copyEdge = ((EdgeType) strategy.copy(LocatorUtils.property(locator, "edge", sourceEdge), sourceEdge, this.isSetEdge()));
                    copy.setEdge(copyEdge);
                } else {
                    if (edgeShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
                        copy.edge = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof IsolatedPropertyType) {
            ...
            {
                java.lang.Boolean nodeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetNode(), rightObject.isSetNode());
                if (nodeShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    NodeType lhsNode;
                    lhsNode = leftObject.getNode();
                    NodeType rhsNode;
                    rhsNode = rightObject.getNode();
                    NodeType mergedNode = ((NodeType) strategy.merge(LocatorUtils.property(leftLocator, "node", lhsNode), LocatorUtils.property(rightLocator, "node", rhsNode), lhsNode, rhsNode, leftObject.isSetNode(), rightObject.isSetNode()));
                    target.setNode(mergedNode);
                } else {
                    if (nodeShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.node = null;
                    }
                }
            }
            {
                java.lang.Boolean edgeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetEdge(), rightObject.isSetEdge());
                if (edgeShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    EdgeType lhsEdge;
                    lhsEdge = leftObject.getEdge();
                    EdgeType rhsEdge;
                    rhsEdge = rightObject.getEdge();
                    EdgeType mergedEdge = ((EdgeType) strategy.merge(LocatorUtils.property(leftLocator, "edge", lhsEdge), LocatorUtils.property(rightLocator, "edge", rhsEdge), lhsEdge, rhsEdge, leftObject.isSetEdge(), rightObject.isSetEdge()));
                    target.setEdge(mergedEdge);
                } else {
                    if (edgeShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.edge = null;
                    }
                }
            }
    ...
    public IsolatedPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public IsolatedPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public IsolatedPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
