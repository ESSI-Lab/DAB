...
public class GeocentricCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "geocentricCRS", buffer, theGeocentricCRS, this.isSetGeocentricCRS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final GeocentricCRSPropertyType that = ((GeocentricCRSPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "geocentricCRS", lhsGeocentricCRS), LocatorUtils.property(thatLocator, "geocentricCRS", rhsGeocentricCRS), lhsGeocentricCRS, rhsGeocentricCRS, this.isSetGeocentricCRS(), that.isSetGeocentricCRS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            GeocentricCRSType theGeocentricCRS;
            theGeocentricCRS = this.getGeocentricCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "geocentricCRS", theGeocentricCRS), currentHashCode, theGeocentricCRS, this.isSetGeocentricCRS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof GeocentricCRSPropertyType) {
            ...
            {
                java.lang.Boolean geocentricCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetGeocentricCRS());
                if (geocentricCRSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    GeocentricCRSType sourceGeocentricCRS;
                    sourceGeocentricCRS = this.getGeocentricCRS();
                    GeocentricCRSType copyGeocentricCRS = ((GeocentricCRSType) strategy.copy(LocatorUtils.property(locator, "geocentricCRS", sourceGeocentricCRS), sourceGeocentricCRS, this.isSetGeocentricCRS()));
                    copy.setGeocentricCRS(copyGeocentricCRS);
                } else {
                    if (geocentricCRSShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof GeocentricCRSPropertyType) {
            ...
            {
                java.lang.Boolean geocentricCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetGeocentricCRS(), rightObject.isSetGeocentricCRS());
                if (geocentricCRSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    GeocentricCRSType lhsGeocentricCRS;
                    lhsGeocentricCRS = leftObject.getGeocentricCRS();
                    GeocentricCRSType rhsGeocentricCRS;
                    rhsGeocentricCRS = rightObject.getGeocentricCRS();
                    GeocentricCRSType mergedGeocentricCRS = ((GeocentricCRSType) strategy.merge(LocatorUtils.property(leftLocator, "geocentricCRS", lhsGeocentricCRS), LocatorUtils.property(rightLocator, "geocentricCRS", rhsGeocentricCRS), lhsGeocentricCRS, rhsGeocentricCRS, leftObject.isSetGeocentricCRS(), rightObject.isSetGeocentricCRS()));
                    target.setGeocentricCRS(mergedGeocentricCRS);
                } else {
                    if (geocentricCRSShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.geocentricCRS = null;
                    }
                }
            }
            {
    ...
    public GeocentricCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public GeocentricCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public GeocentricCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
