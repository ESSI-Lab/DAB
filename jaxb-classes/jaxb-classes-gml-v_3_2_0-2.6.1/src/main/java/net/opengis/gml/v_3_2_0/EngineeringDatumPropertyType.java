...
public class EngineeringDatumPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof EngineeringDatumPropertyType) {
            final EngineeringDatumPropertyType copy = ((EngineeringDatumPropertyType) draftCopy);
            {
                ...
                if (engineeringDatumShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    EngineeringDatumType copyEngineeringDatum = ((EngineeringDatumType) strategy.copy(LocatorUtils.property(locator, "engineeringDatum", sourceEngineeringDatum), sourceEngineeringDatum, this.isSetEngineeringDatum()));
        ...
        if (right instanceof EngineeringDatumPropertyType) {
            ...
            final EngineeringDatumPropertyType rightObject = ((EngineeringDatumPropertyType) right);
            {
                ...
                if (engineeringDatumShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    EngineeringDatumType mergedEngineeringDatum = ((EngineeringDatumType) strategy.merge(LocatorUtils.property(leftLocator, "engineeringDatum", lhsEngineeringDatum), LocatorUtils.property(rightLocator, "engineeringDatum", rhsEngineeringDatum), lhsEngineeringDatum, rhsEngineeringDatum, leftObject.isSetEngineeringDatum(), rightObject.isSetEngineeringDatum()));
    ...
    public EngineeringDatumPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public EngineeringDatumPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public EngineeringDatumPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
