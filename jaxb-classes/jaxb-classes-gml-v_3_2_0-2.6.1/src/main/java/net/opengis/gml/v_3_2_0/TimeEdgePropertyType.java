...
public class TimeEdgePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "timeEdge", buffer, theTimeEdge, this.isSetTimeEdge());
        }
        {
            boolean theOwns;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TimeEdgePropertyType that = ((TimeEdgePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeEdge", lhsTimeEdge), LocatorUtils.property(thatLocator, "timeEdge", rhsTimeEdge), lhsTimeEdge, rhsTimeEdge, this.isSetTimeEdge(), that.isSetTimeEdge())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            TimeEdgeType theTimeEdge;
            theTimeEdge = this.getTimeEdge();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeEdge", theTimeEdge), currentHashCode, theTimeEdge, this.isSetTimeEdge());
        }
        {
            boolean theOwns;
            theOwns = (this.isSetOwns()?this.isOwns():false);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimeEdgePropertyType) {
            ...
            {
                java.lang.Boolean timeEdgeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTimeEdge());
                if (timeEdgeShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    TimeEdgeType sourceTimeEdge;
                    sourceTimeEdge = this.getTimeEdge();
                    TimeEdgeType copyTimeEdge = ((TimeEdgeType) strategy.copy(LocatorUtils.property(locator, "timeEdge", sourceTimeEdge), sourceTimeEdge, this.isSetTimeEdge()));
                    copy.setTimeEdge(copyTimeEdge);
                } else {
                    if (timeEdgeShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
                        copy.timeEdge = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TimeEdgePropertyType) {
            ...
            {
                java.lang.Boolean timeEdgeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTimeEdge(), rightObject.isSetTimeEdge());
                if (timeEdgeShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    TimeEdgeType lhsTimeEdge;
                    lhsTimeEdge = leftObject.getTimeEdge();
                    TimeEdgeType rhsTimeEdge;
                    rhsTimeEdge = rightObject.getTimeEdge();
                    TimeEdgeType mergedTimeEdge = ((TimeEdgeType) strategy.merge(LocatorUtils.property(leftLocator, "timeEdge", lhsTimeEdge), LocatorUtils.property(rightLocator, "timeEdge", rhsTimeEdge), lhsTimeEdge, rhsTimeEdge, leftObject.isSetTimeEdge(), rightObject.isSetTimeEdge()));
                    target.setTimeEdge(mergedTimeEdge);
                } else {
                    if (timeEdgeShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.timeEdge = null;
                    }
                }
            }
            {
    ...
    public TimeEdgePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public TimeEdgePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public TimeEdgePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
