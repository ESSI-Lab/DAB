...
public class CountPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof CountPropertyType) {
            final CountPropertyType copy = ((CountPropertyType) draftCopy);
            {
                ...
                if (countShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    Count copyCount = ((Count) strategy.copy(LocatorUtils.property(locator, "count", sourceCount), sourceCount, this.isSetCount()));
        ...
        if (right instanceof CountPropertyType) {
            ...
            final CountPropertyType rightObject = ((CountPropertyType) right);
            {
                ...
                if (countShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    Count mergedCount = ((Count) strategy.merge(LocatorUtils.property(leftLocator, "count", lhsCount), LocatorUtils.property(rightLocator, "count", rhsCount), lhsCount, rhsCount, leftObject.isSetCount(), rightObject.isSetCount()));
