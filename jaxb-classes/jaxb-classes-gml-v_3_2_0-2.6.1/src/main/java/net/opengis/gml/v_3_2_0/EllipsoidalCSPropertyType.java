...
public class EllipsoidalCSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof EllipsoidalCSPropertyType) {
            final EllipsoidalCSPropertyType copy = ((EllipsoidalCSPropertyType) draftCopy);
            {
                ...
                if (ellipsoidalCSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    EllipsoidalCSType copyEllipsoidalCS = ((EllipsoidalCSType) strategy.copy(LocatorUtils.property(locator, "ellipsoidalCS", sourceEllipsoidalCS), sourceEllipsoidalCS, this.isSetEllipsoidalCS()));
        ...
        if (right instanceof EllipsoidalCSPropertyType) {
            ...
            final EllipsoidalCSPropertyType rightObject = ((EllipsoidalCSPropertyType) right);
            {
                ...
                if (ellipsoidalCSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    EllipsoidalCSType mergedEllipsoidalCS = ((EllipsoidalCSType) strategy.merge(LocatorUtils.property(leftLocator, "ellipsoidalCS", lhsEllipsoidalCS), LocatorUtils.property(rightLocator, "ellipsoidalCS", rhsEllipsoidalCS), lhsEllipsoidalCS, rhsEllipsoidalCS, leftObject.isSetEllipsoidalCS(), rightObject.isSetEllipsoidalCS()));
    ...
    public EllipsoidalCSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public EllipsoidalCSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public EllipsoidalCSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
