...
public class ProjectedCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "projectedCRS", buffer, theProjectedCRS, this.isSetProjectedCRS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProjectedCRSPropertyType that = ((ProjectedCRSPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "projectedCRS", lhsProjectedCRS), LocatorUtils.property(thatLocator, "projectedCRS", rhsProjectedCRS), lhsProjectedCRS, rhsProjectedCRS, this.isSetProjectedCRS(), that.isSetProjectedCRS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            ProjectedCRSType theProjectedCRS;
            theProjectedCRS = this.getProjectedCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "projectedCRS", theProjectedCRS), currentHashCode, theProjectedCRS, this.isSetProjectedCRS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ProjectedCRSPropertyType) {
            ...
            {
                java.lang.Boolean projectedCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetProjectedCRS());
                if (projectedCRSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ProjectedCRSType sourceProjectedCRS;
                    sourceProjectedCRS = this.getProjectedCRS();
                    ProjectedCRSType copyProjectedCRS = ((ProjectedCRSType) strategy.copy(LocatorUtils.property(locator, "projectedCRS", sourceProjectedCRS), sourceProjectedCRS, this.isSetProjectedCRS()));
                    copy.setProjectedCRS(copyProjectedCRS);
                } else {
                    if (projectedCRSShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ProjectedCRSPropertyType) {
            ...
            {
                java.lang.Boolean projectedCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetProjectedCRS(), rightObject.isSetProjectedCRS());
                if (projectedCRSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ProjectedCRSType lhsProjectedCRS;
                    lhsProjectedCRS = leftObject.getProjectedCRS();
                    ProjectedCRSType rhsProjectedCRS;
                    rhsProjectedCRS = rightObject.getProjectedCRS();
                    ProjectedCRSType mergedProjectedCRS = ((ProjectedCRSType) strategy.merge(LocatorUtils.property(leftLocator, "projectedCRS", lhsProjectedCRS), LocatorUtils.property(rightLocator, "projectedCRS", rhsProjectedCRS), lhsProjectedCRS, rhsProjectedCRS, leftObject.isSetProjectedCRS(), rightObject.isSetProjectedCRS()));
                    target.setProjectedCRS(mergedProjectedCRS);
                } else {
                    if (projectedCRSShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.projectedCRS = null;
                    }
                }
            }
            {
    ...
    public ProjectedCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public ProjectedCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ProjectedCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
