...
public class TemporalCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "temporalCRS", buffer, theTemporalCRS, this.isSetTemporalCRS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TemporalCRSPropertyType that = ((TemporalCRSPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "temporalCRS", lhsTemporalCRS), LocatorUtils.property(thatLocator, "temporalCRS", rhsTemporalCRS), lhsTemporalCRS, rhsTemporalCRS, this.isSetTemporalCRS(), that.isSetTemporalCRS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            TemporalCRSType theTemporalCRS;
            theTemporalCRS = this.getTemporalCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "temporalCRS", theTemporalCRS), currentHashCode, theTemporalCRS, this.isSetTemporalCRS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TemporalCRSPropertyType) {
            ...
            {
                java.lang.Boolean temporalCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTemporalCRS());
                if (temporalCRSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    TemporalCRSType sourceTemporalCRS;
                    sourceTemporalCRS = this.getTemporalCRS();
                    TemporalCRSType copyTemporalCRS = ((TemporalCRSType) strategy.copy(LocatorUtils.property(locator, "temporalCRS", sourceTemporalCRS), sourceTemporalCRS, this.isSetTemporalCRS()));
                    copy.setTemporalCRS(copyTemporalCRS);
                } else {
                    if (temporalCRSShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TemporalCRSPropertyType) {
            ...
            {
                java.lang.Boolean temporalCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTemporalCRS(), rightObject.isSetTemporalCRS());
                if (temporalCRSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    TemporalCRSType lhsTemporalCRS;
                    lhsTemporalCRS = leftObject.getTemporalCRS();
                    TemporalCRSType rhsTemporalCRS;
                    rhsTemporalCRS = rightObject.getTemporalCRS();
                    TemporalCRSType mergedTemporalCRS = ((TemporalCRSType) strategy.merge(LocatorUtils.property(leftLocator, "temporalCRS", lhsTemporalCRS), LocatorUtils.property(rightLocator, "temporalCRS", rhsTemporalCRS), lhsTemporalCRS, rhsTemporalCRS, leftObject.isSetTemporalCRS(), rightObject.isSetTemporalCRS()));
                    target.setTemporalCRS(mergedTemporalCRS);
                } else {
                    if (temporalCRSShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.temporalCRS = null;
                    }
                }
            }
            {
    ...
    public TemporalCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public TemporalCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public TemporalCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
