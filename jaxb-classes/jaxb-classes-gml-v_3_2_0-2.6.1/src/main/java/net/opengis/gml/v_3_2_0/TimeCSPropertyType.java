...
public class TimeCSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof TimeCSPropertyType) {
            final TimeCSPropertyType copy = ((TimeCSPropertyType) draftCopy);
            {
                ...
                if (timeCSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    TimeCSType copyTimeCS = ((TimeCSType) strategy.copy(LocatorUtils.property(locator, "timeCS", sourceTimeCS), sourceTimeCS, this.isSetTimeCS()));
        ...
        if (right instanceof TimeCSPropertyType) {
            ...
            final TimeCSPropertyType rightObject = ((TimeCSPropertyType) right);
            {
                ...
                if (timeCSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    TimeCSType mergedTimeCS = ((TimeCSType) strategy.merge(LocatorUtils.property(leftLocator, "timeCS", lhsTimeCS), LocatorUtils.property(rightLocator, "timeCS", rhsTimeCS), lhsTimeCS, rhsTimeCS, leftObject.isSetTimeCS(), rightObject.isSetTimeCS()));
    ...
    public TimeCSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public TimeCSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public TimeCSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
