...
public class GeodeticCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "geodeticCRS", buffer, theGeodeticCRS, this.isSetGeodeticCRS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final GeodeticCRSPropertyType that = ((GeodeticCRSPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "geodeticCRS", lhsGeodeticCRS), LocatorUtils.property(thatLocator, "geodeticCRS", rhsGeodeticCRS), lhsGeodeticCRS, rhsGeodeticCRS, this.isSetGeodeticCRS(), that.isSetGeodeticCRS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            GeodeticCRSType theGeodeticCRS;
            theGeodeticCRS = this.getGeodeticCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "geodeticCRS", theGeodeticCRS), currentHashCode, theGeodeticCRS, this.isSetGeodeticCRS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof GeodeticCRSPropertyType) {
            ...
            {
                java.lang.Boolean geodeticCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetGeodeticCRS());
                if (geodeticCRSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    GeodeticCRSType sourceGeodeticCRS;
                    sourceGeodeticCRS = this.getGeodeticCRS();
                    GeodeticCRSType copyGeodeticCRS = ((GeodeticCRSType) strategy.copy(LocatorUtils.property(locator, "geodeticCRS", sourceGeodeticCRS), sourceGeodeticCRS, this.isSetGeodeticCRS()));
                    copy.setGeodeticCRS(copyGeodeticCRS);
                } else {
                    if (geodeticCRSShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof GeodeticCRSPropertyType) {
            ...
            {
                java.lang.Boolean geodeticCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetGeodeticCRS(), rightObject.isSetGeodeticCRS());
                if (geodeticCRSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    GeodeticCRSType lhsGeodeticCRS;
                    lhsGeodeticCRS = leftObject.getGeodeticCRS();
                    GeodeticCRSType rhsGeodeticCRS;
                    rhsGeodeticCRS = rightObject.getGeodeticCRS();
                    GeodeticCRSType mergedGeodeticCRS = ((GeodeticCRSType) strategy.merge(LocatorUtils.property(leftLocator, "geodeticCRS", lhsGeodeticCRS), LocatorUtils.property(rightLocator, "geodeticCRS", rhsGeodeticCRS), lhsGeodeticCRS, rhsGeodeticCRS, leftObject.isSetGeodeticCRS(), rightObject.isSetGeodeticCRS()));
                    target.setGeodeticCRS(mergedGeodeticCRS);
                } else {
                    if (geodeticCRSShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.geodeticCRS = null;
                    }
                }
            }
            {
    ...
    public GeodeticCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public GeodeticCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public GeodeticCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
