...
public class EngineeringCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "engineeringCRS", buffer, theEngineeringCRS, this.isSetEngineeringCRS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final EngineeringCRSPropertyType that = ((EngineeringCRSPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "engineeringCRS", lhsEngineeringCRS), LocatorUtils.property(thatLocator, "engineeringCRS", rhsEngineeringCRS), lhsEngineeringCRS, rhsEngineeringCRS, this.isSetEngineeringCRS(), that.isSetEngineeringCRS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            EngineeringCRSType theEngineeringCRS;
            theEngineeringCRS = this.getEngineeringCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "engineeringCRS", theEngineeringCRS), currentHashCode, theEngineeringCRS, this.isSetEngineeringCRS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof EngineeringCRSPropertyType) {
            ...
            {
                java.lang.Boolean engineeringCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetEngineeringCRS());
                if (engineeringCRSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    EngineeringCRSType sourceEngineeringCRS;
                    sourceEngineeringCRS = this.getEngineeringCRS();
                    EngineeringCRSType copyEngineeringCRS = ((EngineeringCRSType) strategy.copy(LocatorUtils.property(locator, "engineeringCRS", sourceEngineeringCRS), sourceEngineeringCRS, this.isSetEngineeringCRS()));
                    copy.setEngineeringCRS(copyEngineeringCRS);
                } else {
                    if (engineeringCRSShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof EngineeringCRSPropertyType) {
            ...
            {
                java.lang.Boolean engineeringCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetEngineeringCRS(), rightObject.isSetEngineeringCRS());
                if (engineeringCRSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    EngineeringCRSType lhsEngineeringCRS;
                    lhsEngineeringCRS = leftObject.getEngineeringCRS();
                    EngineeringCRSType rhsEngineeringCRS;
                    rhsEngineeringCRS = rightObject.getEngineeringCRS();
                    EngineeringCRSType mergedEngineeringCRS = ((EngineeringCRSType) strategy.merge(LocatorUtils.property(leftLocator, "engineeringCRS", lhsEngineeringCRS), LocatorUtils.property(rightLocator, "engineeringCRS", rhsEngineeringCRS), lhsEngineeringCRS, rhsEngineeringCRS, leftObject.isSetEngineeringCRS(), rightObject.isSetEngineeringCRS()));
                    target.setEngineeringCRS(mergedEngineeringCRS);
                } else {
                    if (engineeringCRSShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.engineeringCRS = null;
                    }
                }
            }
            {
    ...
    public EngineeringCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public EngineeringCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public EngineeringCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
