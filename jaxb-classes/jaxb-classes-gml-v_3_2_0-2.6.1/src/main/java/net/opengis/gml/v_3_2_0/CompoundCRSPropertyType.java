...
public class CompoundCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "compoundCRS", buffer, theCompoundCRS, this.isSetCompoundCRS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CompoundCRSPropertyType that = ((CompoundCRSPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "compoundCRS", lhsCompoundCRS), LocatorUtils.property(thatLocator, "compoundCRS", rhsCompoundCRS), lhsCompoundCRS, rhsCompoundCRS, this.isSetCompoundCRS(), that.isSetCompoundCRS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            CompoundCRSType theCompoundCRS;
            theCompoundCRS = this.getCompoundCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "compoundCRS", theCompoundCRS), currentHashCode, theCompoundCRS, this.isSetCompoundCRS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CompoundCRSPropertyType) {
            ...
            {
                java.lang.Boolean compoundCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCompoundCRS());
                if (compoundCRSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    CompoundCRSType sourceCompoundCRS;
                    sourceCompoundCRS = this.getCompoundCRS();
                    CompoundCRSType copyCompoundCRS = ((CompoundCRSType) strategy.copy(LocatorUtils.property(locator, "compoundCRS", sourceCompoundCRS), sourceCompoundCRS, this.isSetCompoundCRS()));
                    copy.setCompoundCRS(copyCompoundCRS);
                } else {
                    if (compoundCRSShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CompoundCRSPropertyType) {
            ...
            {
                java.lang.Boolean compoundCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCompoundCRS(), rightObject.isSetCompoundCRS());
                if (compoundCRSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    CompoundCRSType lhsCompoundCRS;
                    lhsCompoundCRS = leftObject.getCompoundCRS();
                    CompoundCRSType rhsCompoundCRS;
                    rhsCompoundCRS = rightObject.getCompoundCRS();
                    CompoundCRSType mergedCompoundCRS = ((CompoundCRSType) strategy.merge(LocatorUtils.property(leftLocator, "compoundCRS", lhsCompoundCRS), LocatorUtils.property(rightLocator, "compoundCRS", rhsCompoundCRS), lhsCompoundCRS, rhsCompoundCRS, leftObject.isSetCompoundCRS(), rightObject.isSetCompoundCRS()));
                    target.setCompoundCRS(mergedCompoundCRS);
                } else {
                    if (compoundCRSShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.compoundCRS = null;
                    }
                }
            }
            {
    ...
    public CompoundCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public CompoundCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CompoundCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
