...
public class OperationMethodPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof OperationMethodPropertyType) {
            ...
            {
                java.lang.Boolean operationMethodShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetOperationMethod());
                if (operationMethodShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    OperationMethodType sourceOperationMethod;
                    sourceOperationMethod = this.getOperationMethod();
                    OperationMethodType copyOperationMethod = ((OperationMethodType) strategy.copy(LocatorUtils.property(locator, "operationMethod", sourceOperationMethod), sourceOperationMethod, this.isSetOperationMethod()));
                    copy.setOperationMethod(copyOperationMethod);
                } else {
                    if (operationMethodShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof OperationMethodPropertyType) {
            ...
            {
                java.lang.Boolean operationMethodShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetOperationMethod(), rightObject.isSetOperationMethod());
                if (operationMethodShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    OperationMethodType lhsOperationMethod;
                    lhsOperationMethod = leftObject.getOperationMethod();
                    OperationMethodType rhsOperationMethod;
                    rhsOperationMethod = rightObject.getOperationMethod();
                    OperationMethodType mergedOperationMethod = ((OperationMethodType) strategy.merge(LocatorUtils.property(leftLocator, "operationMethod", lhsOperationMethod), LocatorUtils.property(rightLocator, "operationMethod", rhsOperationMethod), lhsOperationMethod, rhsOperationMethod, leftObject.isSetOperationMethod(), rightObject.isSetOperationMethod()));
                    target.setOperationMethod(mergedOperationMethod);
                } else {
                    if (operationMethodShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
    ...
    public OperationMethodPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public OperationMethodPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public OperationMethodPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
