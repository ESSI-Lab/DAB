...
public class ImageCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "imageCRS", buffer, theImageCRS, this.isSetImageCRS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ImageCRSPropertyType that = ((ImageCRSPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "imageCRS", lhsImageCRS), LocatorUtils.property(thatLocator, "imageCRS", rhsImageCRS), lhsImageCRS, rhsImageCRS, this.isSetImageCRS(), that.isSetImageCRS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            ImageCRSType theImageCRS;
            theImageCRS = this.getImageCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "imageCRS", theImageCRS), currentHashCode, theImageCRS, this.isSetImageCRS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ImageCRSPropertyType) {
            ...
            {
                java.lang.Boolean imageCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetImageCRS());
                if (imageCRSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ImageCRSType sourceImageCRS;
                    sourceImageCRS = this.getImageCRS();
                    ImageCRSType copyImageCRS = ((ImageCRSType) strategy.copy(LocatorUtils.property(locator, "imageCRS", sourceImageCRS), sourceImageCRS, this.isSetImageCRS()));
                    copy.setImageCRS(copyImageCRS);
                } else {
                    if (imageCRSShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
                        copy.imageCRS = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ImageCRSPropertyType) {
            ...
            {
                java.lang.Boolean imageCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetImageCRS(), rightObject.isSetImageCRS());
                if (imageCRSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ImageCRSType lhsImageCRS;
                    lhsImageCRS = leftObject.getImageCRS();
                    ImageCRSType rhsImageCRS;
                    rhsImageCRS = rightObject.getImageCRS();
                    ImageCRSType mergedImageCRS = ((ImageCRSType) strategy.merge(LocatorUtils.property(leftLocator, "imageCRS", lhsImageCRS), LocatorUtils.property(rightLocator, "imageCRS", rhsImageCRS), lhsImageCRS, rhsImageCRS, leftObject.isSetImageCRS(), rightObject.isSetImageCRS()));
                    target.setImageCRS(mergedImageCRS);
                } else {
                    if (imageCRSShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.imageCRS = null;
                    }
                }
            }
            {
    ...
    public ImageCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public ImageCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ImageCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
