...
public class TopoVolumePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "topoVolume", buffer, theTopoVolume, this.isSetTopoVolume());
        }
        {
            boolean theOwns;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TopoVolumePropertyType that = ((TopoVolumePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "topoVolume", lhsTopoVolume), LocatorUtils.property(thatLocator, "topoVolume", rhsTopoVolume), lhsTopoVolume, rhsTopoVolume, this.isSetTopoVolume(), that.isSetTopoVolume())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            TopoVolumeType theTopoVolume;
            theTopoVolume = this.getTopoVolume();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "topoVolume", theTopoVolume), currentHashCode, theTopoVolume, this.isSetTopoVolume());
        }
        {
            boolean theOwns;
            theOwns = (this.isSetOwns()?this.isOwns():false);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TopoVolumePropertyType) {
            ...
            {
                java.lang.Boolean topoVolumeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTopoVolume());
                if (topoVolumeShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    TopoVolumeType sourceTopoVolume;
                    sourceTopoVolume = this.getTopoVolume();
                    TopoVolumeType copyTopoVolume = ((TopoVolumeType) strategy.copy(LocatorUtils.property(locator, "topoVolume", sourceTopoVolume), sourceTopoVolume, this.isSetTopoVolume()));
                    copy.setTopoVolume(copyTopoVolume);
                } else {
                    if (topoVolumeShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TopoVolumePropertyType) {
            ...
            {
                java.lang.Boolean topoVolumeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTopoVolume(), rightObject.isSetTopoVolume());
                if (topoVolumeShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    TopoVolumeType lhsTopoVolume;
                    lhsTopoVolume = leftObject.getTopoVolume();
                    TopoVolumeType rhsTopoVolume;
                    rhsTopoVolume = rightObject.getTopoVolume();
                    TopoVolumeType mergedTopoVolume = ((TopoVolumeType) strategy.merge(LocatorUtils.property(leftLocator, "topoVolume", lhsTopoVolume), LocatorUtils.property(rightLocator, "topoVolume", rhsTopoVolume), lhsTopoVolume, rhsTopoVolume, leftObject.isSetTopoVolume(), rightObject.isSetTopoVolume()));
                    target.setTopoVolume(mergedTopoVolume);
                } else {
                    if (topoVolumeShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.topoVolume = null;
                    }
                }
            }
            {
