...
public class PolarCSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "polarCS", buffer, thePolarCS, this.isSetPolarCS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PolarCSPropertyType that = ((PolarCSPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "polarCS", lhsPolarCS), LocatorUtils.property(thatLocator, "polarCS", rhsPolarCS), lhsPolarCS, rhsPolarCS, this.isSetPolarCS(), that.isSetPolarCS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            PolarCSType thePolarCS;
            thePolarCS = this.getPolarCS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "polarCS", thePolarCS), currentHashCode, thePolarCS, this.isSetPolarCS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof PolarCSPropertyType) {
            ...
            {
                java.lang.Boolean polarCSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetPolarCS());
                if (polarCSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    PolarCSType sourcePolarCS;
                    sourcePolarCS = this.getPolarCS();
                    PolarCSType copyPolarCS = ((PolarCSType) strategy.copy(LocatorUtils.property(locator, "polarCS", sourcePolarCS), sourcePolarCS, this.isSetPolarCS()));
                    copy.setPolarCS(copyPolarCS);
                } else {
                    if (polarCSShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
                        copy.polarCS = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof PolarCSPropertyType) {
            ...
            {
                java.lang.Boolean polarCSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetPolarCS(), rightObject.isSetPolarCS());
                if (polarCSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    PolarCSType lhsPolarCS;
                    lhsPolarCS = leftObject.getPolarCS();
                    PolarCSType rhsPolarCS;
                    rhsPolarCS = rightObject.getPolarCS();
                    PolarCSType mergedPolarCS = ((PolarCSType) strategy.merge(LocatorUtils.property(leftLocator, "polarCS", lhsPolarCS), LocatorUtils.property(rightLocator, "polarCS", rhsPolarCS), lhsPolarCS, rhsPolarCS, leftObject.isSetPolarCS(), rightObject.isSetPolarCS()));
                    target.setPolarCS(mergedPolarCS);
                } else {
                    if (polarCSShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.polarCS = null;
                    }
                }
            }
    ...
    public PolarCSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public PolarCSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public PolarCSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
