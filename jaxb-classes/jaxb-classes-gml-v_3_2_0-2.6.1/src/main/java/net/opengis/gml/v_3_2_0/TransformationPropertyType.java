...
public class TransformationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "transformation", buffer, theTransformation, this.isSetTransformation());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TransformationPropertyType that = ((TransformationPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "transformation", lhsTransformation), LocatorUtils.property(thatLocator, "transformation", rhsTransformation), lhsTransformation, rhsTransformation, this.isSetTransformation(), that.isSetTransformation())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            TransformationType theTransformation;
            theTransformation = this.getTransformation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "transformation", theTransformation), currentHashCode, theTransformation, this.isSetTransformation());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TransformationPropertyType) {
            ...
            {
                java.lang.Boolean transformationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTransformation());
                if (transformationShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    TransformationType sourceTransformation;
                    sourceTransformation = this.getTransformation();
                    TransformationType copyTransformation = ((TransformationType) strategy.copy(LocatorUtils.property(locator, "transformation", sourceTransformation), sourceTransformation, this.isSetTransformation()));
                    copy.setTransformation(copyTransformation);
                } else {
                    if (transformationShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TransformationPropertyType) {
            ...
            {
                java.lang.Boolean transformationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTransformation(), rightObject.isSetTransformation());
                if (transformationShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    TransformationType lhsTransformation;
                    lhsTransformation = leftObject.getTransformation();
                    TransformationType rhsTransformation;
                    rhsTransformation = rightObject.getTransformation();
                    TransformationType mergedTransformation = ((TransformationType) strategy.merge(LocatorUtils.property(leftLocator, "transformation", lhsTransformation), LocatorUtils.property(rightLocator, "transformation", rhsTransformation), lhsTransformation, rhsTransformation, leftObject.isSetTransformation(), rightObject.isSetTransformation()));
                    target.setTransformation(mergedTransformation);
                } else {
                    if (transformationShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
    ...
    public TransformationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public TransformationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public TransformationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
