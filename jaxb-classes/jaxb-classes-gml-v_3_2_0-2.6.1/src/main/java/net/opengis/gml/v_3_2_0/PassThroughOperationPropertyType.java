...
public class PassThroughOperationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "passThroughOperation", buffer, thePassThroughOperation, this.isSetPassThroughOperation());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PassThroughOperationPropertyType that = ((PassThroughOperationPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "passThroughOperation", lhsPassThroughOperation), LocatorUtils.property(thatLocator, "passThroughOperation", rhsPassThroughOperation), lhsPassThroughOperation, rhsPassThroughOperation, this.isSetPassThroughOperation(), that.isSetPassThroughOperation())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            PassThroughOperationType thePassThroughOperation;
            thePassThroughOperation = this.getPassThroughOperation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "passThroughOperation", thePassThroughOperation), currentHashCode, thePassThroughOperation, this.isSetPassThroughOperation());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof PassThroughOperationPropertyType) {
            ...
            {
                java.lang.Boolean passThroughOperationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetPassThroughOperation());
                if (passThroughOperationShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    PassThroughOperationType sourcePassThroughOperation;
                    sourcePassThroughOperation = this.getPassThroughOperation();
                    PassThroughOperationType copyPassThroughOperation = ((PassThroughOperationType) strategy.copy(LocatorUtils.property(locator, "passThroughOperation", sourcePassThroughOperation), sourcePassThroughOperation, this.isSetPassThroughOperation()));
                    copy.setPassThroughOperation(copyPassThroughOperation);
                } else {
                    if (passThroughOperationShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof PassThroughOperationPropertyType) {
            ...
            {
                java.lang.Boolean passThroughOperationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetPassThroughOperation(), rightObject.isSetPassThroughOperation());
                if (passThroughOperationShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    PassThroughOperationType lhsPassThroughOperation;
                    lhsPassThroughOperation = leftObject.getPassThroughOperation();
                    PassThroughOperationType rhsPassThroughOperation;
                    rhsPassThroughOperation = rightObject.getPassThroughOperation();
                    PassThroughOperationType mergedPassThroughOperation = ((PassThroughOperationType) strategy.merge(LocatorUtils.property(leftLocator, "passThroughOperation", lhsPassThroughOperation), LocatorUtils.property(rightLocator, "passThroughOperation", rhsPassThroughOperation), lhsPassThroughOperation, rhsPassThroughOperation, leftObject.isSetPassThroughOperation(), rightObject.isSetPassThroughOperation()));
                    target.setPassThroughOperation(mergedPassThroughOperation);
                } else {
                    if (passThroughOperationShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.passThroughOperation = null;
                    }
                }
            }
            {
    ...
    public PassThroughOperationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public PassThroughOperationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public PassThroughOperationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
