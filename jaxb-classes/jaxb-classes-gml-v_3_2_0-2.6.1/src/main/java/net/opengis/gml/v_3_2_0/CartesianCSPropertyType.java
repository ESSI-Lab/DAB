...
public class CartesianCSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof CartesianCSPropertyType) {
            final CartesianCSPropertyType copy = ((CartesianCSPropertyType) draftCopy);
            {
                ...
                if (cartesianCSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    CartesianCSType copyCartesianCS = ((CartesianCSType) strategy.copy(LocatorUtils.property(locator, "cartesianCS", sourceCartesianCS), sourceCartesianCS, this.isSetCartesianCS()));
        ...
        if (right instanceof CartesianCSPropertyType) {
            ...
            final CartesianCSPropertyType rightObject = ((CartesianCSPropertyType) right);
            {
                ...
                if (cartesianCSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    CartesianCSType mergedCartesianCS = ((CartesianCSType) strategy.merge(LocatorUtils.property(leftLocator, "cartesianCS", lhsCartesianCS), LocatorUtils.property(rightLocator, "cartesianCS", rhsCartesianCS), lhsCartesianCS, rhsCartesianCS, leftObject.isSetCartesianCS(), rightObject.isSetCartesianCS()));
    ...
    public CartesianCSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public CartesianCSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CartesianCSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
