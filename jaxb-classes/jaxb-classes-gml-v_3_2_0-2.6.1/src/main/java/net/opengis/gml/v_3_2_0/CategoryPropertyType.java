...
public class CategoryPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CategoryPropertyType) {
            ...
            {
                java.lang.Boolean categoryShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCategory());
                if (categoryShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    Category sourceCategory;
                    sourceCategory = this.getCategory();
                    Category copyCategory = ((Category) strategy.copy(LocatorUtils.property(locator, "category", sourceCategory), sourceCategory, this.isSetCategory()));
                    copy.setCategory(copyCategory);
                } else {
                    if (categoryShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
                        copy.category = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CategoryPropertyType) {
            ...
            {
                java.lang.Boolean categoryShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCategory(), rightObject.isSetCategory());
                if (categoryShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    Category lhsCategory;
                    lhsCategory = leftObject.getCategory();
                    Category rhsCategory;
                    rhsCategory = rightObject.getCategory();
                    Category mergedCategory = ((Category) strategy.merge(LocatorUtils.property(leftLocator, "category", lhsCategory), LocatorUtils.property(rightLocator, "category", rhsCategory), lhsCategory, rhsCategory, leftObject.isSetCategory(), rightObject.isSetCategory()));
                    target.setCategory(mergedCategory);
                } else {
                    if (categoryShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
    ...
    public CategoryPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public CategoryPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CategoryPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
