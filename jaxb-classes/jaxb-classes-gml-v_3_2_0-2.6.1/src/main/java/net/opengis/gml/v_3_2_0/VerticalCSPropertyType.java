...
public class VerticalCSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof VerticalCSPropertyType) {
            final VerticalCSPropertyType copy = ((VerticalCSPropertyType) draftCopy);
            {
                ...
                if (verticalCSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    VerticalCSType copyVerticalCS = ((VerticalCSType) strategy.copy(LocatorUtils.property(locator, "verticalCS", sourceVerticalCS), sourceVerticalCS, this.isSetVerticalCS()));
        ...
        if (right instanceof VerticalCSPropertyType) {
            ...
            final VerticalCSPropertyType rightObject = ((VerticalCSPropertyType) right);
            {
                ...
                if (verticalCSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    VerticalCSType mergedVerticalCS = ((VerticalCSType) strategy.merge(LocatorUtils.property(leftLocator, "verticalCS", lhsVerticalCS), LocatorUtils.property(rightLocator, "verticalCS", rhsVerticalCS), lhsVerticalCS, rhsVerticalCS, leftObject.isSetVerticalCS(), rightObject.isSetVerticalCS()));
    ...
    public VerticalCSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public VerticalCSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public VerticalCSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
