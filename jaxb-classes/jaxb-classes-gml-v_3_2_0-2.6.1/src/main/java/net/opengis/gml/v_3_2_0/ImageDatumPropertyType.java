...
public class ImageDatumPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof ImageDatumPropertyType) {
            final ImageDatumPropertyType copy = ((ImageDatumPropertyType) draftCopy);
            {
                ...
                if (imageDatumShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    ImageDatumType copyImageDatum = ((ImageDatumType) strategy.copy(LocatorUtils.property(locator, "imageDatum", sourceImageDatum), sourceImageDatum, this.isSetImageDatum()));
        ...
        if (right instanceof ImageDatumPropertyType) {
            ...
            final ImageDatumPropertyType rightObject = ((ImageDatumPropertyType) right);
            {
                ...
                if (imageDatumShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    ImageDatumType mergedImageDatum = ((ImageDatumType) strategy.merge(LocatorUtils.property(leftLocator, "imageDatum", lhsImageDatum), LocatorUtils.property(rightLocator, "imageDatum", rhsImageDatum), lhsImageDatum, rhsImageDatum, leftObject.isSetImageDatum(), rightObject.isSetImageDatum()));
    ...
    public ImageDatumPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public ImageDatumPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ImageDatumPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
