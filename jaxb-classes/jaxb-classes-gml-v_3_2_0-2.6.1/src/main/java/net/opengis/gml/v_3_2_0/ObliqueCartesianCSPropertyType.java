...
public class ObliqueCartesianCSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "obliqueCartesianCS", buffer, theObliqueCartesianCS, this.isSetObliqueCartesianCS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ObliqueCartesianCSPropertyType that = ((ObliqueCartesianCSPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "obliqueCartesianCS", lhsObliqueCartesianCS), LocatorUtils.property(thatLocator, "obliqueCartesianCS", rhsObliqueCartesianCS), lhsObliqueCartesianCS, rhsObliqueCartesianCS, this.isSetObliqueCartesianCS(), that.isSetObliqueCartesianCS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            ObliqueCartesianCSType theObliqueCartesianCS;
            theObliqueCartesianCS = this.getObliqueCartesianCS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "obliqueCartesianCS", theObliqueCartesianCS), currentHashCode, theObliqueCartesianCS, this.isSetObliqueCartesianCS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ObliqueCartesianCSPropertyType) {
            ...
            {
                java.lang.Boolean obliqueCartesianCSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetObliqueCartesianCS());
                if (obliqueCartesianCSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ObliqueCartesianCSType sourceObliqueCartesianCS;
                    sourceObliqueCartesianCS = this.getObliqueCartesianCS();
                    ObliqueCartesianCSType copyObliqueCartesianCS = ((ObliqueCartesianCSType) strategy.copy(LocatorUtils.property(locator, "obliqueCartesianCS", sourceObliqueCartesianCS), sourceObliqueCartesianCS, this.isSetObliqueCartesianCS()));
                    copy.setObliqueCartesianCS(copyObliqueCartesianCS);
                } else {
                    if (obliqueCartesianCSShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ObliqueCartesianCSPropertyType) {
            ...
            {
                java.lang.Boolean obliqueCartesianCSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetObliqueCartesianCS(), rightObject.isSetObliqueCartesianCS());
                if (obliqueCartesianCSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ObliqueCartesianCSType lhsObliqueCartesianCS;
                    lhsObliqueCartesianCS = leftObject.getObliqueCartesianCS();
                    ObliqueCartesianCSType rhsObliqueCartesianCS;
                    rhsObliqueCartesianCS = rightObject.getObliqueCartesianCS();
                    ObliqueCartesianCSType mergedObliqueCartesianCS = ((ObliqueCartesianCSType) strategy.merge(LocatorUtils.property(leftLocator, "obliqueCartesianCS", lhsObliqueCartesianCS), LocatorUtils.property(rightLocator, "obliqueCartesianCS", rhsObliqueCartesianCS), lhsObliqueCartesianCS, rhsObliqueCartesianCS, leftObject.isSetObliqueCartesianCS(), rightObject.isSetObliqueCartesianCS()));
                    target.setObliqueCartesianCS(mergedObliqueCartesianCS);
                } else {
                    if (obliqueCartesianCSShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.obliqueCartesianCS = null;
                    }
                }
            }
            {
    ...
    public ObliqueCartesianCSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public ObliqueCartesianCSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ObliqueCartesianCSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
