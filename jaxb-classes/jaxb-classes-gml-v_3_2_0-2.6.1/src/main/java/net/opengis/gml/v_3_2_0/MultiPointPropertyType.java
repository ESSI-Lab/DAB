...
public class MultiPointPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "multiPoint", buffer, theMultiPoint, this.isSetMultiPoint());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MultiPointPropertyType that = ((MultiPointPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "multiPoint", lhsMultiPoint), LocatorUtils.property(thatLocator, "multiPoint", rhsMultiPoint), lhsMultiPoint, rhsMultiPoint, this.isSetMultiPoint(), that.isSetMultiPoint())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MultiPointType theMultiPoint;
            theMultiPoint = this.getMultiPoint();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "multiPoint", theMultiPoint), currentHashCode, theMultiPoint, this.isSetMultiPoint());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MultiPointPropertyType) {
            ...
            {
                java.lang.Boolean multiPointShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMultiPoint());
                if (multiPointShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    MultiPointType sourceMultiPoint;
                    sourceMultiPoint = this.getMultiPoint();
                    MultiPointType copyMultiPoint = ((MultiPointType) strategy.copy(LocatorUtils.property(locator, "multiPoint", sourceMultiPoint), sourceMultiPoint, this.isSetMultiPoint()));
                    copy.setMultiPoint(copyMultiPoint);
                } else {
                    if (multiPointShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MultiPointPropertyType) {
            ...
            {
                java.lang.Boolean multiPointShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMultiPoint(), rightObject.isSetMultiPoint());
                if (multiPointShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    MultiPointType lhsMultiPoint;
                    lhsMultiPoint = leftObject.getMultiPoint();
                    MultiPointType rhsMultiPoint;
                    rhsMultiPoint = rightObject.getMultiPoint();
                    MultiPointType mergedMultiPoint = ((MultiPointType) strategy.merge(LocatorUtils.property(leftLocator, "multiPoint", lhsMultiPoint), LocatorUtils.property(rightLocator, "multiPoint", rhsMultiPoint), lhsMultiPoint, rhsMultiPoint, leftObject.isSetMultiPoint(), rightObject.isSetMultiPoint()));
                    target.setMultiPoint(mergedMultiPoint);
                } else {
                    if (multiPointShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.multiPoint = null;
                    }
                }
            }
            {
    ...
    public MultiPointPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public MultiPointPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MultiPointPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
