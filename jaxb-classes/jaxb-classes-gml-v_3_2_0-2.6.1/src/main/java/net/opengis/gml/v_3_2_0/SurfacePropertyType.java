...
public class SurfacePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof SurfacePropertyType) {
            final SurfacePropertyType copy = ((SurfacePropertyType) draftCopy);
            {
                ...
                if (abstractSurfaceShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractSurfaceType> copyAbstractSurface = ((JAXBElement<? extends AbstractSurfaceType> ) strategy.copy(LocatorUtils.property(locator, "abstractSurface", sourceAbstractSurface), sourceAbstractSurface, this.isSetAbstractSurface()));
    ...
    public SurfacePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public SurfacePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SurfacePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
