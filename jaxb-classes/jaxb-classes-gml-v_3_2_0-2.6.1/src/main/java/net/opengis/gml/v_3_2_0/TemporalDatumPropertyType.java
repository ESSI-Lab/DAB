...
public class TemporalDatumPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof TemporalDatumPropertyType) {
            final TemporalDatumPropertyType copy = ((TemporalDatumPropertyType) draftCopy);
            {
                ...
                if (temporalDatumShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    TemporalDatumType copyTemporalDatum = ((TemporalDatumType) strategy.copy(LocatorUtils.property(locator, "temporalDatum", sourceTemporalDatum), sourceTemporalDatum, this.isSetTemporalDatum()));
        ...
        if (right instanceof TemporalDatumPropertyType) {
            ...
            final TemporalDatumPropertyType rightObject = ((TemporalDatumPropertyType) right);
            {
                ...
                if (temporalDatumShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    TemporalDatumType mergedTemporalDatum = ((TemporalDatumType) strategy.merge(LocatorUtils.property(leftLocator, "temporalDatum", lhsTemporalDatum), LocatorUtils.property(rightLocator, "temporalDatum", rhsTemporalDatum), lhsTemporalDatum, rhsTemporalDatum, leftObject.isSetTemporalDatum(), rightObject.isSetTemporalDatum()));
    ...
    public TemporalDatumPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public TemporalDatumPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public TemporalDatumPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
