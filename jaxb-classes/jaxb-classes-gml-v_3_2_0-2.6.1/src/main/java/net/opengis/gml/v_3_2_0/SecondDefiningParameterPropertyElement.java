...
public class SecondDefiningParameterPropertyElement implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            SecondDefiningParameter theSecondDefiningParameter;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            SecondDefiningParameter lhsSecondDefiningParameter;
            lhsSecondDefiningParameter = this.getSecondDefiningParameter();
            SecondDefiningParameter rhsSecondDefiningParameter;
        ...
        if (draftCopy instanceof SecondDefiningParameterPropertyElement) {
            final SecondDefiningParameterPropertyElement copy = ((SecondDefiningParameterPropertyElement) draftCopy);
            {
                ...
                if (secondDefiningParameterShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    SecondDefiningParameter sourceSecondDefiningParameter;
                    sourceSecondDefiningParameter = this.getSecondDefiningParameter();
                    SecondDefiningParameter copySecondDefiningParameter = ((SecondDefiningParameter) strategy.copy(LocatorUtils.property(locator, "secondDefiningParameter", sourceSecondDefiningParameter), sourceSecondDefiningParameter, this.isSetSecondDefiningParameter()));
    ...
    public SecondDefiningParameterPropertyElement withSecondDefiningParameter(SecondDefiningParameter value) {
