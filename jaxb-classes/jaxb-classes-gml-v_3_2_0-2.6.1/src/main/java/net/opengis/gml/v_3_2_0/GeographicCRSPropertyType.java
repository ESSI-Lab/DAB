...
public class GeographicCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "geographicCRS", buffer, theGeographicCRS, this.isSetGeographicCRS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final GeographicCRSPropertyType that = ((GeographicCRSPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "geographicCRS", lhsGeographicCRS), LocatorUtils.property(thatLocator, "geographicCRS", rhsGeographicCRS), lhsGeographicCRS, rhsGeographicCRS, this.isSetGeographicCRS(), that.isSetGeographicCRS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            GeographicCRSType theGeographicCRS;
            theGeographicCRS = this.getGeographicCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "geographicCRS", theGeographicCRS), currentHashCode, theGeographicCRS, this.isSetGeographicCRS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof GeographicCRSPropertyType) {
            ...
            {
                java.lang.Boolean geographicCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetGeographicCRS());
                if (geographicCRSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    GeographicCRSType sourceGeographicCRS;
                    sourceGeographicCRS = this.getGeographicCRS();
                    GeographicCRSType copyGeographicCRS = ((GeographicCRSType) strategy.copy(LocatorUtils.property(locator, "geographicCRS", sourceGeographicCRS), sourceGeographicCRS, this.isSetGeographicCRS()));
                    copy.setGeographicCRS(copyGeographicCRS);
                } else {
                    if (geographicCRSShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof GeographicCRSPropertyType) {
            ...
            {
                java.lang.Boolean geographicCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetGeographicCRS(), rightObject.isSetGeographicCRS());
                if (geographicCRSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    GeographicCRSType lhsGeographicCRS;
                    lhsGeographicCRS = leftObject.getGeographicCRS();
                    GeographicCRSType rhsGeographicCRS;
                    rhsGeographicCRS = rightObject.getGeographicCRS();
                    GeographicCRSType mergedGeographicCRS = ((GeographicCRSType) strategy.merge(LocatorUtils.property(leftLocator, "geographicCRS", lhsGeographicCRS), LocatorUtils.property(rightLocator, "geographicCRS", rhsGeographicCRS), lhsGeographicCRS, rhsGeographicCRS, leftObject.isSetGeographicCRS(), rightObject.isSetGeographicCRS()));
                    target.setGeographicCRS(mergedGeographicCRS);
                } else {
                    if (geographicCRSShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.geographicCRS = null;
                    }
                }
            }
            {
    ...
    public GeographicCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public GeographicCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public GeographicCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
