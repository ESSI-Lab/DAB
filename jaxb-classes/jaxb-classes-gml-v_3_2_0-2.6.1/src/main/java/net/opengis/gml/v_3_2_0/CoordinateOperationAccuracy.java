...
public class CoordinateOperationAccuracy implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    @XmlAnyElement(lax = true)
    protected Object abstractDQPositionalAccuracy;
     ...
     *     
     */
    public Object getAbstractDQPositionalAccuracy() {
     ...
     *     
     */
    public void setAbstractDQPositionalAccuracy(Object value) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            Object theAbstractDQPositionalAccuracy;
            theAbstractDQPositionalAccuracy = this.getAbstractDQPositionalAccuracy();
            strategy.appendField(locator, this, "abstractDQPositionalAccuracy", buffer, theAbstractDQPositionalAccuracy, this.isSetAbstractDQPositionalAccuracy());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            Object lhsAbstractDQPositionalAccuracy;
            lhsAbstractDQPositionalAccuracy = this.getAbstractDQPositionalAccuracy();
            Object rhsAbstractDQPositionalAccuracy;
            rhsAbstractDQPositionalAccuracy = that.getAbstractDQPositionalAccuracy();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractDQPositionalAccuracy", lhsAbstractDQPositionalAccuracy), LocatorUtils.property(thatLocator, "abstractDQPositionalAccuracy", rhsAbstractDQPositionalAccuracy), lhsAbstractDQPositionalAccuracy, rhsAbstractDQPositionalAccuracy, this.isSetAbstractDQPositionalAccuracy(), that.isSetAbstractDQPositionalAccuracy())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            Object theAbstractDQPositionalAccuracy;
            theAbstractDQPositionalAccuracy = this.getAbstractDQPositionalAccuracy();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractDQPositionalAccuracy", theAbstractDQPositionalAccuracy), currentHashCode, theAbstractDQPositionalAccuracy, this.isSetAbstractDQPositionalAccuracy());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CoordinateOperationAccuracy) {
            final CoordinateOperationAccuracy copy = ((CoordinateOperationAccuracy) draftCopy);
            {
                java.lang.Boolean abstractDQPositionalAccuracyShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractDQPositionalAccuracy());
                if (abstractDQPositionalAccuracyShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    Object sourceAbstractDQPositionalAccuracy;
                    sourceAbstractDQPositionalAccuracy = this.getAbstractDQPositionalAccuracy();
                    Object copyAbstractDQPositionalAccuracy = ((Object) strategy.copy(LocatorUtils.property(locator, "abstractDQPositionalAccuracy", sourceAbstractDQPositionalAccuracy), sourceAbstractDQPositionalAccuracy, this.isSetAbstractDQPositionalAccuracy()));
                    copy.setAbstractDQPositionalAccuracy(copyAbstractDQPositionalAccuracy);
                } else {
                    if (abstractDQPositionalAccuracyShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CoordinateOperationAccuracy) {
            final CoordinateOperationAccuracy target = this;
            final CoordinateOperationAccuracy leftObject = ((CoordinateOperationAccuracy) left);
            final CoordinateOperationAccuracy rightObject = ((CoordinateOperationAccuracy) right);
            {
                java.lang.Boolean abstractDQPositionalAccuracyShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractDQPositionalAccuracy(), rightObject.isSetAbstractDQPositionalAccuracy());
                if (abstractDQPositionalAccuracyShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    Object lhsAbstractDQPositionalAccuracy;
                    ...
                    Object mergedAbstractDQPositionalAccuracy = ((Object) strategy.merge(LocatorUtils.property(leftLocator, "abstractDQPositionalAccuracy", lhsAbstractDQPositionalAccuracy), LocatorUtils.property(rightLocator, "abstractDQPositionalAccuracy", rhsAbstractDQPositionalAccuracy), lhsAbstractDQPositionalAccuracy, rhsAbstractDQPositionalAccuracy, leftObject.isSetAbstractDQPositionalAccuracy(), rightObject.isSetAbstractDQPositionalAccuracy()));
                    target.setAbstractDQPositionalAccuracy(mergedAbstractDQPositionalAccuracy);
                } else {
                    if (abstractDQPositionalAccuracyShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.abstractDQPositionalAccuracy = null;
                    }
                }
            }
            {
    ...
    public CoordinateOperationAccuracy withAbstractDQPositionalAccuracy(Object value) {
        setAbstractDQPositionalAccuracy(value);
        return this;
    }

    public CoordinateOperationAccuracy withNilReason(String... values) {
        if (values!= null) {
    ...
    public CoordinateOperationAccuracy withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CoordinateOperationAccuracy withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public CoordinateOperationAccuracy withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CoordinateOperationAccuracy withHref(String value) {
        setHref(value);
        return this;
    }

    public CoordinateOperationAccuracy withRole(String value) {
        setRole(value);
        return this;
    }

    public CoordinateOperationAccuracy withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CoordinateOperationAccuracy withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CoordinateOperationAccuracy withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CoordinateOperationAccuracy withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CoordinateOperationAccuracy withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
