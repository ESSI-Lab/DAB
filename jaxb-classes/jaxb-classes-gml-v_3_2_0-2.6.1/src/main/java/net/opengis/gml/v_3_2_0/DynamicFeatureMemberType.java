    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        super.appendFields(locator, buffer, strategy);
        {
            ...
            strategy.appendField(locator, this, "dynamicFeature", buffer, theDynamicFeature, this.isSetDynamicFeature());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DynamicFeatureMemberType that = ((DynamicFeatureMemberType) object);
        {
            ...
            lhsDynamicFeature = (this.isSetDynamicFeature()?this.getDynamicFeature():null);
            List<JAXBElement<? extends DynamicFeatureType>> rhsDynamicFeature;
            rhsDynamicFeature = (that.isSetDynamicFeature()?that.getDynamicFeature():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dynamicFeature", lhsDynamicFeature), LocatorUtils.property(thatLocator, "dynamicFeature", rhsDynamicFeature), lhsDynamicFeature, rhsDynamicFeature, this.isSetDynamicFeature(), that.isSetDynamicFeature())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            List<JAXBElement<? extends DynamicFeatureType>> theDynamicFeature;
            theDynamicFeature = (this.isSetDynamicFeature()?this.getDynamicFeature():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dynamicFeature", theDynamicFeature), currentHashCode, theDynamicFeature, this.isSetDynamicFeature());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DynamicFeatureMemberType) {
            ...
            {
                java.lang.Boolean dynamicFeatureShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDynamicFeature());
                if (dynamicFeatureShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    List<JAXBElement<? extends DynamicFeatureType>> sourceDynamicFeature;
                    sourceDynamicFeature = (this.isSetDynamicFeature()?this.getDynamicFeature():null);
                    @SuppressWarnings("unchecked")
                    List<JAXBElement<? extends DynamicFeatureType>> copyDynamicFeature = ((List<JAXBElement<? extends DynamicFeatureType>> ) strategy.copy(LocatorUtils.property(locator, "dynamicFeature", sourceDynamicFeature), sourceDynamicFeature, this.isSetDynamicFeature()));
                    copy.unsetDynamicFeature();
                    if (copyDynamicFeature!= null) {
                    ...
                    if (dynamicFeatureShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
                        copy.unsetDynamicFeature();
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof DynamicFeatureMemberType) {
            ...
            {
                java.lang.Boolean dynamicFeatureShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDynamicFeature(), rightObject.isSetDynamicFeature());
                if (dynamicFeatureShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    List<JAXBElement<? extends DynamicFeatureType>> lhsDynamicFeature;
                    lhsDynamicFeature = (leftObject.isSetDynamicFeature()?leftObject.getDynamicFeature():null);
                    List<JAXBElement<? extends DynamicFeatureType>> rhsDynamicFeature;
                    rhsDynamicFeature = (rightObject.isSetDynamicFeature()?rightObject.getDynamicFeature():null);
                    List<JAXBElement<? extends DynamicFeatureType>> mergedDynamicFeature = ((List<JAXBElement<? extends DynamicFeatureType>> ) strategy.merge(LocatorUtils.property(leftLocator, "dynamicFeature", lhsDynamicFeature), LocatorUtils.property(rightLocator, "dynamicFeature", rhsDynamicFeature), lhsDynamicFeature, rhsDynamicFeature, leftObject.isSetDynamicFeature(), rightObject.isSetDynamicFeature()));
                    target.unsetDynamicFeature();
                    if (mergedDynamicFeature!= null) {
                        List<JAXBElement<? extends DynamicFeatureType>> uniqueDynamicFeaturel = target.getDynamicFeature();
                        uniqueDynamicFeaturel.addAll(mergedDynamicFeature);
                    }
                } else {
                    if (dynamicFeatureShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.unsetDynamicFeature();
                    }
                }
            }
    ...
    public DynamicFeatureMemberType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public DynamicFeatureMemberType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DynamicFeatureMemberType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
