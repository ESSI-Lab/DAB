...
public class TimeNodePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "timeNode", buffer, theTimeNode, this.isSetTimeNode());
        }
        {
            boolean theOwns;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TimeNodePropertyType that = ((TimeNodePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeNode", lhsTimeNode), LocatorUtils.property(thatLocator, "timeNode", rhsTimeNode), lhsTimeNode, rhsTimeNode, this.isSetTimeNode(), that.isSetTimeNode())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            TimeNodeType theTimeNode;
            theTimeNode = this.getTimeNode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeNode", theTimeNode), currentHashCode, theTimeNode, this.isSetTimeNode());
        }
        {
            boolean theOwns;
            theOwns = (this.isSetOwns()?this.isOwns():false);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimeNodePropertyType) {
            ...
            {
                java.lang.Boolean timeNodeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTimeNode());
                if (timeNodeShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    TimeNodeType sourceTimeNode;
                    sourceTimeNode = this.getTimeNode();
                    TimeNodeType copyTimeNode = ((TimeNodeType) strategy.copy(LocatorUtils.property(locator, "timeNode", sourceTimeNode), sourceTimeNode, this.isSetTimeNode()));
                    copy.setTimeNode(copyTimeNode);
                } else {
                    if (timeNodeShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
                        copy.timeNode = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TimeNodePropertyType) {
            ...
            {
                java.lang.Boolean timeNodeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTimeNode(), rightObject.isSetTimeNode());
                if (timeNodeShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    TimeNodeType lhsTimeNode;
                    lhsTimeNode = leftObject.getTimeNode();
                    TimeNodeType rhsTimeNode;
                    rhsTimeNode = rightObject.getTimeNode();
                    TimeNodeType mergedTimeNode = ((TimeNodeType) strategy.merge(LocatorUtils.property(leftLocator, "timeNode", lhsTimeNode), LocatorUtils.property(rightLocator, "timeNode", rhsTimeNode), lhsTimeNode, rhsTimeNode, leftObject.isSetTimeNode(), rightObject.isSetTimeNode()));
                    target.setTimeNode(mergedTimeNode);
                } else {
                    if (timeNodeShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.timeNode = null;
                    }
                }
            }
            {
    ...
    public TimeNodePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public TimeNodePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public TimeNodePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
