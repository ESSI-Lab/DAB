...
public class GeodeticDatumPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof GeodeticDatumPropertyType) {
            final GeodeticDatumPropertyType copy = ((GeodeticDatumPropertyType) draftCopy);
            {
                ...
                if (geodeticDatumShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    GeodeticDatumType copyGeodeticDatum = ((GeodeticDatumType) strategy.copy(LocatorUtils.property(locator, "geodeticDatum", sourceGeodeticDatum), sourceGeodeticDatum, this.isSetGeodeticDatum()));
        ...
        if (right instanceof GeodeticDatumPropertyType) {
            ...
            final GeodeticDatumPropertyType rightObject = ((GeodeticDatumPropertyType) right);
            {
                ...
                if (geodeticDatumShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    ...
                    GeodeticDatumType mergedGeodeticDatum = ((GeodeticDatumType) strategy.merge(LocatorUtils.property(leftLocator, "geodeticDatum", lhsGeodeticDatum), LocatorUtils.property(rightLocator, "geodeticDatum", rhsGeodeticDatum), lhsGeodeticDatum, rhsGeodeticDatum, leftObject.isSetGeodeticDatum(), rightObject.isSetGeodeticDatum()));
    ...
    public GeodeticDatumPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public GeodeticDatumPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public GeodeticDatumPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
