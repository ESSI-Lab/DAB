...
public class ContainerPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "face", buffer, theFace, this.isSetFace());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ContainerPropertyType that = ((ContainerPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "face", lhsFace), LocatorUtils.property(thatLocator, "face", rhsFace), lhsFace, rhsFace, this.isSetFace(), that.isSetFace())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            FaceType theFace;
            theFace = this.getFace();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "face", theFace), currentHashCode, theFace, this.isSetFace());
        }
        {
            TopoSolidType theTopoSolid;
            theTopoSolid = this.getTopoSolid();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ContainerPropertyType) {
            ...
            {
                java.lang.Boolean faceShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetFace());
                if (faceShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    FaceType sourceFace;
                    sourceFace = this.getFace();
                    FaceType copyFace = ((FaceType) strategy.copy(LocatorUtils.property(locator, "face", sourceFace), sourceFace, this.isSetFace()));
                    copy.setFace(copyFace);
                } else {
                    if (faceShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
                        copy.face = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ContainerPropertyType) {
            ...
            {
                java.lang.Boolean faceShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetFace(), rightObject.isSetFace());
                if (faceShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    FaceType lhsFace;
                    lhsFace = leftObject.getFace();
                    FaceType rhsFace;
                    rhsFace = rightObject.getFace();
                    FaceType mergedFace = ((FaceType) strategy.merge(LocatorUtils.property(leftLocator, "face", lhsFace), LocatorUtils.property(rightLocator, "face", rhsFace), lhsFace, rhsFace, leftObject.isSetFace(), rightObject.isSetFace()));
                    target.setFace(mergedFace);
                } else {
                    if (faceShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.face = null;
                    }
                }
            }
    ...
    public ContainerPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public ContainerPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ContainerPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
