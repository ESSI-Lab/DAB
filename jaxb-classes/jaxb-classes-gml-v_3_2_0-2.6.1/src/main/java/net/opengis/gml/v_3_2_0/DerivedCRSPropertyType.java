...
public class DerivedCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "derivedCRS", buffer, theDerivedCRS, this.isSetDerivedCRS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DerivedCRSPropertyType that = ((DerivedCRSPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "derivedCRS", lhsDerivedCRS), LocatorUtils.property(thatLocator, "derivedCRS", rhsDerivedCRS), lhsDerivedCRS, rhsDerivedCRS, this.isSetDerivedCRS(), that.isSetDerivedCRS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            DerivedCRSType theDerivedCRS;
            theDerivedCRS = this.getDerivedCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "derivedCRS", theDerivedCRS), currentHashCode, theDerivedCRS, this.isSetDerivedCRS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DerivedCRSPropertyType) {
            ...
            {
                java.lang.Boolean derivedCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDerivedCRS());
                if (derivedCRSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    DerivedCRSType sourceDerivedCRS;
                    sourceDerivedCRS = this.getDerivedCRS();
                    DerivedCRSType copyDerivedCRS = ((DerivedCRSType) strategy.copy(LocatorUtils.property(locator, "derivedCRS", sourceDerivedCRS), sourceDerivedCRS, this.isSetDerivedCRS()));
                    copy.setDerivedCRS(copyDerivedCRS);
                } else {
                    if (derivedCRSShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DerivedCRSPropertyType) {
            ...
            {
                java.lang.Boolean derivedCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDerivedCRS(), rightObject.isSetDerivedCRS());
                if (derivedCRSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    DerivedCRSType lhsDerivedCRS;
                    lhsDerivedCRS = leftObject.getDerivedCRS();
                    DerivedCRSType rhsDerivedCRS;
                    rhsDerivedCRS = rightObject.getDerivedCRS();
                    DerivedCRSType mergedDerivedCRS = ((DerivedCRSType) strategy.merge(LocatorUtils.property(leftLocator, "derivedCRS", lhsDerivedCRS), LocatorUtils.property(rightLocator, "derivedCRS", rhsDerivedCRS), lhsDerivedCRS, rhsDerivedCRS, leftObject.isSetDerivedCRS(), rightObject.isSetDerivedCRS()));
                    target.setDerivedCRS(mergedDerivedCRS);
                } else {
                    if (derivedCRSShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.derivedCRS = null;
                    }
                }
            }
            {
    ...
    public DerivedCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public DerivedCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DerivedCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
