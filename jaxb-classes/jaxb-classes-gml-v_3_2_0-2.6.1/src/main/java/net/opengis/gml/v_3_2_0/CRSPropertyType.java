...
public class CRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "abstractCRS", buffer, theAbstractCRS, this.isSetAbstractCRS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CRSPropertyType that = ((CRSPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractCRS", lhsAbstractCRS), LocatorUtils.property(thatLocator, "abstractCRS", rhsAbstractCRS), lhsAbstractCRS, rhsAbstractCRS, this.isSetAbstractCRS(), that.isSetAbstractCRS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractCRSType> theAbstractCRS;
            theAbstractCRS = this.getAbstractCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractCRS", theAbstractCRS), currentHashCode, theAbstractCRS, this.isSetAbstractCRS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CRSPropertyType) {
            ...
            {
                java.lang.Boolean abstractCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractCRS());
                if (abstractCRSShouldBeCopiedAndSet == java.lang.Boolean.TRUE) {
                    JAXBElement<? extends AbstractCRSType> sourceAbstractCRS;
                    sourceAbstractCRS = this.getAbstractCRS();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractCRSType> copyAbstractCRS = ((JAXBElement<? extends AbstractCRSType> ) strategy.copy(LocatorUtils.property(locator, "abstractCRS", sourceAbstractCRS), sourceAbstractCRS, this.isSetAbstractCRS()));
                    copy.setAbstractCRS(copyAbstractCRS);
                } else {
                    if (abstractCRSShouldBeCopiedAndSet == java.lang.Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CRSPropertyType) {
            ...
            {
                java.lang.Boolean abstractCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractCRS(), rightObject.isSetAbstractCRS());
                if (abstractCRSShouldBeMergedAndSet == java.lang.Boolean.TRUE) {
                    JAXBElement<? extends AbstractCRSType> lhsAbstractCRS;
                    lhsAbstractCRS = leftObject.getAbstractCRS();
                    JAXBElement<? extends AbstractCRSType> rhsAbstractCRS;
                    rhsAbstractCRS = rightObject.getAbstractCRS();
                    JAXBElement<? extends AbstractCRSType> mergedAbstractCRS = ((JAXBElement<? extends AbstractCRSType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractCRS", lhsAbstractCRS), LocatorUtils.property(rightLocator, "abstractCRS", rhsAbstractCRS), lhsAbstractCRS, rhsAbstractCRS, leftObject.isSetAbstractCRS(), rightObject.isSetAbstractCRS()));
                    target.setAbstractCRS(mergedAbstractCRS);
                } else {
                    if (abstractCRSShouldBeMergedAndSet == java.lang.Boolean.FALSE) {
                        target.abstractCRS = null;
                    }
                }
            }
            {
    ...
    public CRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public CRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
