...
public class MatrixPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            theMatrix = this.getMatrix();
            strategy.appendField(locator, this, "matrix", buffer, theMatrix, this.isSetMatrix());
        }
        {
            TypeType theTYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MatrixPropertyType that = ((MatrixPropertyType) object);
        {
            MatrixType lhsMatrix;
            lhsMatrix = this.getMatrix();
            MatrixType rhsMatrix;
            rhsMatrix = that.getMatrix();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "matrix", lhsMatrix), LocatorUtils.property(thatLocator, "matrix", rhsMatrix), lhsMatrix, rhsMatrix, this.isSetMatrix(), that.isSetMatrix())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MatrixType theMatrix;
            theMatrix = this.getMatrix();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "matrix", theMatrix), currentHashCode, theMatrix, this.isSetMatrix());
        }
        {
            TypeType theTYPE;
            theTYPE = this.getTYPE();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MatrixPropertyType) {
            final MatrixPropertyType copy = ((MatrixPropertyType) draftCopy);
            {
                Boolean matrixShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMatrix());
                if (matrixShouldBeCopiedAndSet == Boolean.TRUE) {
                    MatrixType sourceMatrix;
                    sourceMatrix = this.getMatrix();
                    MatrixType copyMatrix = ((MatrixType) strategy.copy(LocatorUtils.property(locator, "matrix", sourceMatrix), sourceMatrix, this.isSetMatrix()));
                    copy.setMatrix(copyMatrix);
                } else {
                    if (matrixShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.matrix = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MatrixPropertyType) {
            final MatrixPropertyType target = this;
            final MatrixPropertyType leftObject = ((MatrixPropertyType) left);
            final MatrixPropertyType rightObject = ((MatrixPropertyType) right);
            {
                Boolean matrixShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMatrix(), rightObject.isSetMatrix());
                if (matrixShouldBeMergedAndSet == Boolean.TRUE) {
                    MatrixType lhsMatrix;
                    lhsMatrix = leftObject.getMatrix();
                    MatrixType rhsMatrix;
                    rhsMatrix = rightObject.getMatrix();
                    MatrixType mergedMatrix = ((MatrixType) strategy.merge(LocatorUtils.property(leftLocator, "matrix", lhsMatrix), LocatorUtils.property(rightLocator, "matrix", rhsMatrix), lhsMatrix, rhsMatrix, leftObject.isSetMatrix(), rightObject.isSetMatrix()));
                    target.setMatrix(mergedMatrix);
                } else {
                    if (matrixShouldBeMergedAndSet == Boolean.FALSE) {
                        target.matrix = null;
                    }
                }
            }
    ...
    public MatrixPropertyType withMatrix(MatrixType value) {
        setMatrix(value);
        return this;
    }

    public MatrixPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MatrixPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MatrixPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MatrixPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MatrixPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MatrixPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MatrixPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
