...
public class AbstractSimpleComponentPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetAbstractSimpleComponent() {
        return (this.abstractSimpleComponent!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            JAXBElement<? extends AbstractSimpleComponentType> theAbstractSimpleComponent;
            theAbstractSimpleComponent = this.getAbstractSimpleComponent();
            strategy.appendField(locator, this, "abstractSimpleComponent", buffer, theAbstractSimpleComponent, this.isSetAbstractSimpleComponent());
        }
        {
            TypeType theTYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final AbstractSimpleComponentPropertyType that = ((AbstractSimpleComponentPropertyType) object);
        {
            JAXBElement<? extends AbstractSimpleComponentType> lhsAbstractSimpleComponent;
            lhsAbstractSimpleComponent = this.getAbstractSimpleComponent();
            JAXBElement<? extends AbstractSimpleComponentType> rhsAbstractSimpleComponent;
            rhsAbstractSimpleComponent = that.getAbstractSimpleComponent();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractSimpleComponent", lhsAbstractSimpleComponent), LocatorUtils.property(thatLocator, "abstractSimpleComponent", rhsAbstractSimpleComponent), lhsAbstractSimpleComponent, rhsAbstractSimpleComponent, this.isSetAbstractSimpleComponent(), that.isSetAbstractSimpleComponent())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractSimpleComponentType> theAbstractSimpleComponent;
            theAbstractSimpleComponent = this.getAbstractSimpleComponent();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractSimpleComponent", theAbstractSimpleComponent), currentHashCode, theAbstractSimpleComponent, this.isSetAbstractSimpleComponent());
        }
        {
            TypeType theTYPE;
            theTYPE = this.getTYPE();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof AbstractSimpleComponentPropertyType) {
            final AbstractSimpleComponentPropertyType copy = ((AbstractSimpleComponentPropertyType) draftCopy);
            {
                Boolean abstractSimpleComponentShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractSimpleComponent());
                if (abstractSimpleComponentShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractSimpleComponentType> sourceAbstractSimpleComponent;
                    sourceAbstractSimpleComponent = this.getAbstractSimpleComponent();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractSimpleComponentType> copyAbstractSimpleComponent = ((JAXBElement<? extends AbstractSimpleComponentType> ) strategy.copy(LocatorUtils.property(locator, "abstractSimpleComponent", sourceAbstractSimpleComponent), sourceAbstractSimpleComponent, this.isSetAbstractSimpleComponent()));
                    copy.setAbstractSimpleComponent(copyAbstractSimpleComponent);
                } else {
                    if (abstractSimpleComponentShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.abstractSimpleComponent = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof AbstractSimpleComponentPropertyType) {
            final AbstractSimpleComponentPropertyType target = this;
            final AbstractSimpleComponentPropertyType leftObject = ((AbstractSimpleComponentPropertyType) left);
            final AbstractSimpleComponentPropertyType rightObject = ((AbstractSimpleComponentPropertyType) right);
            {
                Boolean abstractSimpleComponentShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractSimpleComponent(), rightObject.isSetAbstractSimpleComponent());
                if (abstractSimpleComponentShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractSimpleComponentType> lhsAbstractSimpleComponent;
                    lhsAbstractSimpleComponent = leftObject.getAbstractSimpleComponent();
                    JAXBElement<? extends AbstractSimpleComponentType> rhsAbstractSimpleComponent;
                    rhsAbstractSimpleComponent = rightObject.getAbstractSimpleComponent();
                    JAXBElement<? extends AbstractSimpleComponentType> mergedAbstractSimpleComponent = ((JAXBElement<? extends AbstractSimpleComponentType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractSimpleComponent", lhsAbstractSimpleComponent), LocatorUtils.property(rightLocator, "abstractSimpleComponent", rhsAbstractSimpleComponent), lhsAbstractSimpleComponent, rhsAbstractSimpleComponent, leftObject.isSetAbstractSimpleComponent(), rightObject.isSetAbstractSimpleComponent()));
                    target.setAbstractSimpleComponent(mergedAbstractSimpleComponent);
                } else {
                    if (abstractSimpleComponentShouldBeMergedAndSet == Boolean.FALSE) {
                        target.abstractSimpleComponent = null;
                    }
                }
            }
            {
    ...
    public AbstractSimpleComponentPropertyType withAbstractSimpleComponent(JAXBElement<? extends AbstractSimpleComponentType> value) {
        setAbstractSimpleComponent(value);
        return this;
    }

    public AbstractSimpleComponentPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public AbstractSimpleComponentPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public AbstractSimpleComponentPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public AbstractSimpleComponentPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public AbstractSimpleComponentPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public AbstractSimpleComponentPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public AbstractSimpleComponentPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
