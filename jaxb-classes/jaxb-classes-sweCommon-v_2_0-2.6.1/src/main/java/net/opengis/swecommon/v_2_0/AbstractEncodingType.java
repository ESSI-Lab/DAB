    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @Override
    public AbstractEncodingType withExtension(Object... values) {
        if (values!= null) {
    ...
    @Override
    public AbstractEncodingType withExtension(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public AbstractEncodingType withId(String value) {
        setId(value);
        return this;
    }

    @Override
    public AbstractEncodingType withExtension(List<Object> value) {
        setExtension(value);
        return this;
    }
