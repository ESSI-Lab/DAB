    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof QuantityRangeType) {
            final QuantityRangeType copy = ((QuantityRangeType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof QuantityRangeType) {
            final QuantityRangeType target = this;
            final QuantityRangeType leftObject = ((QuantityRangeType) left);
            final QuantityRangeType rightObject = ((QuantityRangeType) right);
            {
