...
public class NilValuesPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final NilValuesPropertyType that = ((NilValuesPropertyType) object);
        {
            NilValuesType lhsNilValues;
            lhsNilValues = this.getNilValues();
            NilValuesType rhsNilValues;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof NilValuesPropertyType) {
            final NilValuesPropertyType copy = ((NilValuesPropertyType) draftCopy);
            {
                ...
                if (nilValuesShouldBeCopiedAndSet == Boolean.TRUE) {
                    NilValuesType sourceNilValues;
                    sourceNilValues = this.getNilValues();
                    NilValuesType copyNilValues = ((NilValuesType) strategy.copy(LocatorUtils.property(locator, "nilValues", sourceNilValues), sourceNilValues, this.isSetNilValues()));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof NilValuesPropertyType) {
            final NilValuesPropertyType target = this;
            final NilValuesPropertyType leftObject = ((NilValuesPropertyType) left);
            final NilValuesPropertyType rightObject = ((NilValuesPropertyType) right);
            {
                ...
                if (nilValuesShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    NilValuesType mergedNilValues = ((NilValuesType) strategy.merge(LocatorUtils.property(leftLocator, "nilValues", lhsNilValues), LocatorUtils.property(rightLocator, "nilValues", rhsNilValues), lhsNilValues, rhsNilValues, leftObject.isSetNilValues(), rightObject.isSetNilValues()));
    ...
    public NilValuesPropertyType withNilValues(NilValuesType value) {
        setNilValues(value);
        return this;
    }

    public NilValuesPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public NilValuesPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public NilValuesPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public NilValuesPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public NilValuesPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public NilValuesPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public NilValuesPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
