...
public class UnitReference implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof UnitReference) {
            final UnitReference copy = ((UnitReference) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof UnitReference) {
            final UnitReference target = this;
            final UnitReference leftObject = ((UnitReference) left);
            final UnitReference rightObject = ((UnitReference) right);
            {
    ...
    public UnitReference withCode(String value) {
        setCode(value);
        return this;
    }

    public UnitReference withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public UnitReference withHref(String value) {
        setHref(value);
        return this;
    }

    public UnitReference withRole(String value) {
        setRole(value);
        return this;
    }

    public UnitReference withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public UnitReference withTitle(String value) {
        setTitle(value);
        return this;
    }

    public UnitReference withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public UnitReference withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
