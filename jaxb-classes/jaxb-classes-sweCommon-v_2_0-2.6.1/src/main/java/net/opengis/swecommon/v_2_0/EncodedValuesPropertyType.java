...
public class EncodedValuesPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final EncodedValuesPropertyType that = ((EncodedValuesPropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof EncodedValuesPropertyType) {
            final EncodedValuesPropertyType copy = ((EncodedValuesPropertyType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof EncodedValuesPropertyType) {
            final EncodedValuesPropertyType target = this;
            final EncodedValuesPropertyType leftObject = ((EncodedValuesPropertyType) left);
            final EncodedValuesPropertyType rightObject = ((EncodedValuesPropertyType) right);
            {
    ...
    public EncodedValuesPropertyType withContent(Serializable... values) {
        if (values!= null) {
    ...
    public EncodedValuesPropertyType withContent(Collection<Serializable> values) {
        if (values!= null) {
    ...
    public EncodedValuesPropertyType withContent(List<Serializable> value) {
        setContent(value);
        return this;
    }
