...
@XmlSeeAlso({
    ...
    DataStreamType.ElementType.class,
    DataChoiceType.Item.class
})
public class AbstractDataComponentPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            JAXBElement<? extends AbstractDataComponentType> theAbstractDataComponent;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<? extends AbstractDataComponentType> lhsAbstractDataComponent;
            lhsAbstractDataComponent = this.getAbstractDataComponent();
            JAXBElement<? extends AbstractDataComponentType> rhsAbstractDataComponent;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof AbstractDataComponentPropertyType) {
            final AbstractDataComponentPropertyType copy = ((AbstractDataComponentPropertyType) draftCopy);
            {
                ...
                if (abstractDataComponentShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractDataComponentType> sourceAbstractDataComponent;
                    sourceAbstractDataComponent = this.getAbstractDataComponent();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractDataComponentType> copyAbstractDataComponent = ((JAXBElement<? extends AbstractDataComponentType> ) strategy.copy(LocatorUtils.property(locator, "abstractDataComponent", sourceAbstractDataComponent), sourceAbstractDataComponent, this.isSetAbstractDataComponent()));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof AbstractDataComponentPropertyType) {
            final AbstractDataComponentPropertyType target = this;
            final AbstractDataComponentPropertyType leftObject = ((AbstractDataComponentPropertyType) left);
            final AbstractDataComponentPropertyType rightObject = ((AbstractDataComponentPropertyType) right);
            {
    ...
    public AbstractDataComponentPropertyType withAbstractDataComponent(JAXBElement<? extends AbstractDataComponentType> value) {
