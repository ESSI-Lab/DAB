...
public class AllowedTimesPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof AllowedTimesPropertyType) {
            final AllowedTimesPropertyType copy = ((AllowedTimesPropertyType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof AllowedTimesPropertyType) {
            final AllowedTimesPropertyType target = this;
            final AllowedTimesPropertyType leftObject = ((AllowedTimesPropertyType) left);
            final AllowedTimesPropertyType rightObject = ((AllowedTimesPropertyType) right);
            {
    ...
    public AllowedTimesPropertyType withAllowedTimes(AllowedTimesType value) {
        setAllowedTimes(value);
        return this;
    }

    public AllowedTimesPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public AllowedTimesPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public AllowedTimesPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public AllowedTimesPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public AllowedTimesPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public AllowedTimesPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public AllowedTimesPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
