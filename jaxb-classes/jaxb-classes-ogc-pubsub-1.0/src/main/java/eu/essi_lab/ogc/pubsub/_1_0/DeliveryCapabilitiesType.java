...
/**
 * <p>Classe Java per DeliveryCapabilitiesType complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.opengis.net/pubsub/1.0}DeliveryMethod" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "DeliveryCapabilitiesType", propOrder = {
    "deliveryMethod",
    "extension"
})
public class DeliveryCapabilitiesType {
    ...
    public boolean isSetDeliveryMethod() {
        return ((this.deliveryMethod!= null)&&(!this.deliveryMethod.isEmpty()));
    }
