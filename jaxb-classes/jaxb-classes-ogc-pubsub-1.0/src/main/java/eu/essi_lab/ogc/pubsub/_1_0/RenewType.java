...
/**
 * <p>Classe Java per RenewType complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="NewExpiration" type="{http://www.opengis.net/gml/3.2}TimeInstantType"/&gt;
 *         &lt;element ref="{http://www.opengis.net/pubsub/1.0}SubscriptionIdentifier"/&gt;
...
public class RenewType {
    ...
    @XmlElement(name = "NewExpiration", required = true)
    protected TimeInstantType newExpiration;
    ...
    /**
     * Recupera il valore della proprietà newExpiration.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public TimeInstantType getNewExpiration() {
        return newExpiration;
    }

    /**
     * Imposta il valore della proprietà newExpiration.
     * 
     * @param value
     *     allowed object is
     *     {@link TimeInstantType }
     *     
     */
    public void setNewExpiration(TimeInstantType value) {
        this.newExpiration = value;
    }

    public boolean isSetNewExpiration() {
