 ...
 *       &lt;/sequence&gt;
 *       &lt;attribute name="service" use="required" type="{http://www.opengis.net/ows/1.1}ServiceType" fixed="PubSub" /&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "GetCapabilitiesType", propOrder = { "extension" })
public class GetCapabilitiesType extends eu.essi_lab.jaxb.ows._1_0_0.GetCapabilitiesType {
    ...
    public final static String SERVICE = "PubSub";
