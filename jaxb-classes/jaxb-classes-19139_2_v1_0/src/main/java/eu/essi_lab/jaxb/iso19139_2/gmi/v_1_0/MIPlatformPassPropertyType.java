...
public class MIPlatformPassPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetMIPlatformPass() {
        return (this.miPlatformPass!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            MIPlatformPassType theMIPlatformPass;
            theMIPlatformPass = this.getMIPlatformPass();
            strategy.appendField(locator, this, "miPlatformPass", buffer, theMIPlatformPass, this.isSetMIPlatformPass());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MIPlatformPassPropertyType that = ((MIPlatformPassPropertyType) object);
        {
            MIPlatformPassType lhsMIPlatformPass;
            lhsMIPlatformPass = this.getMIPlatformPass();
            MIPlatformPassType rhsMIPlatformPass;
            rhsMIPlatformPass = that.getMIPlatformPass();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "miPlatformPass", lhsMIPlatformPass), LocatorUtils.property(thatLocator, "miPlatformPass", rhsMIPlatformPass), lhsMIPlatformPass, rhsMIPlatformPass, this.isSetMIPlatformPass(), that.isSetMIPlatformPass())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MIPlatformPassType theMIPlatformPass;
            theMIPlatformPass = this.getMIPlatformPass();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "miPlatformPass", theMIPlatformPass), currentHashCode, theMIPlatformPass, this.isSetMIPlatformPass());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MIPlatformPassPropertyType) {
            final MIPlatformPassPropertyType copy = ((MIPlatformPassPropertyType) draftCopy);
            {
                Boolean miPlatformPassShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMIPlatformPass());
                if (miPlatformPassShouldBeCopiedAndSet == Boolean.TRUE) {
                    MIPlatformPassType sourceMIPlatformPass;
                    sourceMIPlatformPass = this.getMIPlatformPass();
                    MIPlatformPassType copyMIPlatformPass = ((MIPlatformPassType) strategy.copy(LocatorUtils.property(locator, "miPlatformPass", sourceMIPlatformPass), sourceMIPlatformPass, this.isSetMIPlatformPass()));
                    copy.setMIPlatformPass(copyMIPlatformPass);
                } else {
                    if (miPlatformPassShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.miPlatformPass = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MIPlatformPassPropertyType) {
            final MIPlatformPassPropertyType target = this;
            final MIPlatformPassPropertyType leftObject = ((MIPlatformPassPropertyType) left);
            final MIPlatformPassPropertyType rightObject = ((MIPlatformPassPropertyType) right);
            {
                Boolean miPlatformPassShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMIPlatformPass(), rightObject.isSetMIPlatformPass());
                if (miPlatformPassShouldBeMergedAndSet == Boolean.TRUE) {
                    MIPlatformPassType lhsMIPlatformPass;
                    lhsMIPlatformPass = leftObject.getMIPlatformPass();
                    MIPlatformPassType rhsMIPlatformPass;
                    rhsMIPlatformPass = rightObject.getMIPlatformPass();
                    MIPlatformPassType mergedMIPlatformPass = ((MIPlatformPassType) strategy.merge(LocatorUtils.property(leftLocator, "miPlatformPass", lhsMIPlatformPass), LocatorUtils.property(rightLocator, "miPlatformPass", rhsMIPlatformPass), lhsMIPlatformPass, rhsMIPlatformPass, leftObject.isSetMIPlatformPass(), rightObject.isSetMIPlatformPass()));
                    target.setMIPlatformPass(mergedMIPlatformPass);
                } else {
                    if (miPlatformPassShouldBeMergedAndSet == Boolean.FALSE) {
                        target.miPlatformPass = null;
                    }
                }
            }
            {
    ...
    public MIPlatformPassPropertyType withMIPlatformPass(MIPlatformPassType value) {
        setMIPlatformPass(value);
        return this;
    }

    public MIPlatformPassPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MIPlatformPassPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MIPlatformPassPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MIPlatformPassPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MIPlatformPassPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MIPlatformPassPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MIPlatformPassPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MIPlatformPassPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MIPlatformPassPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MIPlatformPassPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MIPlatformPassPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
