...
public class MIPlanPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetMIPlan() {
        return (this.miPlan!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            MIPlanType theMIPlan;
            theMIPlan = this.getMIPlan();
            strategy.appendField(locator, this, "miPlan", buffer, theMIPlan, this.isSetMIPlan());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MIPlanPropertyType that = ((MIPlanPropertyType) object);
        {
            MIPlanType lhsMIPlan;
            lhsMIPlan = this.getMIPlan();
            MIPlanType rhsMIPlan;
            rhsMIPlan = that.getMIPlan();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "miPlan", lhsMIPlan), LocatorUtils.property(thatLocator, "miPlan", rhsMIPlan), lhsMIPlan, rhsMIPlan, this.isSetMIPlan(), that.isSetMIPlan())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MIPlanType theMIPlan;
            theMIPlan = this.getMIPlan();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "miPlan", theMIPlan), currentHashCode, theMIPlan, this.isSetMIPlan());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MIPlanPropertyType) {
            final MIPlanPropertyType copy = ((MIPlanPropertyType) draftCopy);
            {
                Boolean miPlanShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMIPlan());
                if (miPlanShouldBeCopiedAndSet == Boolean.TRUE) {
                    MIPlanType sourceMIPlan;
                    sourceMIPlan = this.getMIPlan();
                    MIPlanType copyMIPlan = ((MIPlanType) strategy.copy(LocatorUtils.property(locator, "miPlan", sourceMIPlan), sourceMIPlan, this.isSetMIPlan()));
                    copy.setMIPlan(copyMIPlan);
                } else {
                    if (miPlanShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.miPlan = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MIPlanPropertyType) {
            final MIPlanPropertyType target = this;
            final MIPlanPropertyType leftObject = ((MIPlanPropertyType) left);
            final MIPlanPropertyType rightObject = ((MIPlanPropertyType) right);
            {
                Boolean miPlanShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMIPlan(), rightObject.isSetMIPlan());
                if (miPlanShouldBeMergedAndSet == Boolean.TRUE) {
                    MIPlanType lhsMIPlan;
                    lhsMIPlan = leftObject.getMIPlan();
                    MIPlanType rhsMIPlan;
                    rhsMIPlan = rightObject.getMIPlan();
                    MIPlanType mergedMIPlan = ((MIPlanType) strategy.merge(LocatorUtils.property(leftLocator, "miPlan", lhsMIPlan), LocatorUtils.property(rightLocator, "miPlan", rhsMIPlan), lhsMIPlan, rhsMIPlan, leftObject.isSetMIPlan(), rightObject.isSetMIPlan()));
                    target.setMIPlan(mergedMIPlan);
                } else {
                    if (miPlanShouldBeMergedAndSet == Boolean.FALSE) {
                        target.miPlan = null;
                    }
                }
            }
    ...
    public MIPlanPropertyType withMIPlan(MIPlanType value) {
        setMIPlan(value);
        return this;
    }

    public MIPlanPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MIPlanPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MIPlanPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MIPlanPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MIPlanPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MIPlanPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MIPlanPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MIPlanPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MIPlanPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MIPlanPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MIPlanPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
