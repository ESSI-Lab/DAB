 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.isotc211.org/2005/gmi}MX_DataFile" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class MXDataFilePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mxDataFile", buffer, theMXDataFile, this.isSetMXDataFile());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MXDataFilePropertyType that = ((MXDataFilePropertyType) object);
        {
            MXDataFileType lhsMXDataFile;
            lhsMXDataFile = this.getMXDataFile();
            MXDataFileType rhsMXDataFile;
            rhsMXDataFile = that.getMXDataFile();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mxDataFile", lhsMXDataFile), LocatorUtils.property(thatLocator, "mxDataFile", rhsMXDataFile), lhsMXDataFile, rhsMXDataFile, this.isSetMXDataFile(), that.isSetMXDataFile())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MXDataFileType theMXDataFile;
            theMXDataFile = this.getMXDataFile();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mxDataFile", theMXDataFile), currentHashCode, theMXDataFile, this.isSetMXDataFile());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MXDataFilePropertyType) {
            final MXDataFilePropertyType copy = ((MXDataFilePropertyType) draftCopy);
            {
                Boolean mxDataFileShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMXDataFile());
                if (mxDataFileShouldBeCopiedAndSet == Boolean.TRUE) {
                    MXDataFileType sourceMXDataFile;
                    sourceMXDataFile = this.getMXDataFile();
                    MXDataFileType copyMXDataFile = ((MXDataFileType) strategy.copy(LocatorUtils.property(locator, "mxDataFile", sourceMXDataFile), sourceMXDataFile, this.isSetMXDataFile()));
                    copy.setMXDataFile(copyMXDataFile);
                } else {
                    if (mxDataFileShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mxDataFile = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MXDataFilePropertyType) {
            final MXDataFilePropertyType target = this;
            final MXDataFilePropertyType leftObject = ((MXDataFilePropertyType) left);
            final MXDataFilePropertyType rightObject = ((MXDataFilePropertyType) right);
            {
                Boolean mxDataFileShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMXDataFile(), rightObject.isSetMXDataFile());
                if (mxDataFileShouldBeMergedAndSet == Boolean.TRUE) {
                    MXDataFileType lhsMXDataFile;
                    lhsMXDataFile = leftObject.getMXDataFile();
                    MXDataFileType rhsMXDataFile;
                    rhsMXDataFile = rightObject.getMXDataFile();
                    MXDataFileType mergedMXDataFile = ((MXDataFileType) strategy.merge(LocatorUtils.property(leftLocator, "mxDataFile", lhsMXDataFile), LocatorUtils.property(rightLocator, "mxDataFile", rhsMXDataFile), lhsMXDataFile, rhsMXDataFile, leftObject.isSetMXDataFile(), rightObject.isSetMXDataFile()));
                    target.setMXDataFile(mergedMXDataFile);
                } else {
                    if (mxDataFileShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mxDataFile = null;
                    }
                }
            }
            {
    ...
    public MXDataFilePropertyType withMXDataFile(MXDataFileType value) {
        setMXDataFile(value);
        return this;
    }

    public MXDataFilePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MXDataFilePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MXDataFilePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MXDataFilePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MXDataFilePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MXDataFilePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MXDataFilePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MXDataFilePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MXDataFilePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MXDataFilePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MXDataFilePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
