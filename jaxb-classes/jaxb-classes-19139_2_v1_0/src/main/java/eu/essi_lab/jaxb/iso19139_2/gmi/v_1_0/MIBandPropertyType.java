...
public class MIBandPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetMIBand() {
        return (this.miBand!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            MIBandType theMIBand;
            theMIBand = this.getMIBand();
            strategy.appendField(locator, this, "miBand", buffer, theMIBand, this.isSetMIBand());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MIBandPropertyType that = ((MIBandPropertyType) object);
        {
            MIBandType lhsMIBand;
            lhsMIBand = this.getMIBand();
            MIBandType rhsMIBand;
            rhsMIBand = that.getMIBand();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "miBand", lhsMIBand), LocatorUtils.property(thatLocator, "miBand", rhsMIBand), lhsMIBand, rhsMIBand, this.isSetMIBand(), that.isSetMIBand())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MIBandType theMIBand;
            theMIBand = this.getMIBand();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "miBand", theMIBand), currentHashCode, theMIBand, this.isSetMIBand());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MIBandPropertyType) {
            final MIBandPropertyType copy = ((MIBandPropertyType) draftCopy);
            {
                Boolean miBandShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMIBand());
                if (miBandShouldBeCopiedAndSet == Boolean.TRUE) {
                    MIBandType sourceMIBand;
                    sourceMIBand = this.getMIBand();
                    MIBandType copyMIBand = ((MIBandType) strategy.copy(LocatorUtils.property(locator, "miBand", sourceMIBand), sourceMIBand, this.isSetMIBand()));
                    copy.setMIBand(copyMIBand);
                } else {
                    if (miBandShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.miBand = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MIBandPropertyType) {
            final MIBandPropertyType target = this;
            final MIBandPropertyType leftObject = ((MIBandPropertyType) left);
            final MIBandPropertyType rightObject = ((MIBandPropertyType) right);
            {
                Boolean miBandShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMIBand(), rightObject.isSetMIBand());
                if (miBandShouldBeMergedAndSet == Boolean.TRUE) {
                    MIBandType lhsMIBand;
                    lhsMIBand = leftObject.getMIBand();
                    MIBandType rhsMIBand;
                    rhsMIBand = rightObject.getMIBand();
                    MIBandType mergedMIBand = ((MIBandType) strategy.merge(LocatorUtils.property(leftLocator, "miBand", lhsMIBand), LocatorUtils.property(rightLocator, "miBand", rhsMIBand), lhsMIBand, rhsMIBand, leftObject.isSetMIBand(), rightObject.isSetMIBand()));
                    target.setMIBand(mergedMIBand);
                } else {
                    if (miBandShouldBeMergedAndSet == Boolean.FALSE) {
                        target.miBand = null;
                    }
                }
            }
    ...
    public MIBandPropertyType withMIBand(MIBandType value) {
        setMIBand(value);
        return this;
    }

    public MIBandPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MIBandPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MIBandPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MIBandPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MIBandPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MIBandPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MIBandPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MIBandPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MIBandPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MIBandPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MIBandPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
