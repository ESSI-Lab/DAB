...
public class MIEventPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetMIEvent() {
        return (this.miEvent!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            MIEventType theMIEvent;
            theMIEvent = this.getMIEvent();
            strategy.appendField(locator, this, "miEvent", buffer, theMIEvent, this.isSetMIEvent());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MIEventPropertyType that = ((MIEventPropertyType) object);
        {
            MIEventType lhsMIEvent;
            lhsMIEvent = this.getMIEvent();
            MIEventType rhsMIEvent;
            rhsMIEvent = that.getMIEvent();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "miEvent", lhsMIEvent), LocatorUtils.property(thatLocator, "miEvent", rhsMIEvent), lhsMIEvent, rhsMIEvent, this.isSetMIEvent(), that.isSetMIEvent())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MIEventType theMIEvent;
            theMIEvent = this.getMIEvent();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "miEvent", theMIEvent), currentHashCode, theMIEvent, this.isSetMIEvent());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MIEventPropertyType) {
            final MIEventPropertyType copy = ((MIEventPropertyType) draftCopy);
            {
                Boolean miEventShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMIEvent());
                if (miEventShouldBeCopiedAndSet == Boolean.TRUE) {
                    MIEventType sourceMIEvent;
                    sourceMIEvent = this.getMIEvent();
                    MIEventType copyMIEvent = ((MIEventType) strategy.copy(LocatorUtils.property(locator, "miEvent", sourceMIEvent), sourceMIEvent, this.isSetMIEvent()));
                    copy.setMIEvent(copyMIEvent);
                } else {
                    if (miEventShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.miEvent = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MIEventPropertyType) {
            final MIEventPropertyType target = this;
            final MIEventPropertyType leftObject = ((MIEventPropertyType) left);
            final MIEventPropertyType rightObject = ((MIEventPropertyType) right);
            {
                Boolean miEventShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMIEvent(), rightObject.isSetMIEvent());
                if (miEventShouldBeMergedAndSet == Boolean.TRUE) {
                    MIEventType lhsMIEvent;
                    lhsMIEvent = leftObject.getMIEvent();
                    MIEventType rhsMIEvent;
                    rhsMIEvent = rightObject.getMIEvent();
                    MIEventType mergedMIEvent = ((MIEventType) strategy.merge(LocatorUtils.property(leftLocator, "miEvent", lhsMIEvent), LocatorUtils.property(rightLocator, "miEvent", rhsMIEvent), lhsMIEvent, rhsMIEvent, leftObject.isSetMIEvent(), rightObject.isSetMIEvent()));
                    target.setMIEvent(mergedMIEvent);
                } else {
                    if (miEventShouldBeMergedAndSet == Boolean.FALSE) {
                        target.miEvent = null;
                    }
                }
            }
    ...
    public MIEventPropertyType withMIEvent(MIEventType value) {
        setMIEvent(value);
        return this;
    }

    public MIEventPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MIEventPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MIEventPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MIEventPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MIEventPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MIEventPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MIEventPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MIEventPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MIEventPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MIEventPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MIEventPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
