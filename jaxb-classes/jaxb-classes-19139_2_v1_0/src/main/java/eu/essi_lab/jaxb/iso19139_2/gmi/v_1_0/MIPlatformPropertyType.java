...
public class MIPlatformPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetMIPlatform() {
        return (this.miPlatform!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            MIPlatformType theMIPlatform;
            theMIPlatform = this.getMIPlatform();
            strategy.appendField(locator, this, "miPlatform", buffer, theMIPlatform, this.isSetMIPlatform());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MIPlatformPropertyType that = ((MIPlatformPropertyType) object);
        {
            MIPlatformType lhsMIPlatform;
            lhsMIPlatform = this.getMIPlatform();
            MIPlatformType rhsMIPlatform;
            rhsMIPlatform = that.getMIPlatform();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "miPlatform", lhsMIPlatform), LocatorUtils.property(thatLocator, "miPlatform", rhsMIPlatform), lhsMIPlatform, rhsMIPlatform, this.isSetMIPlatform(), that.isSetMIPlatform())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MIPlatformType theMIPlatform;
            theMIPlatform = this.getMIPlatform();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "miPlatform", theMIPlatform), currentHashCode, theMIPlatform, this.isSetMIPlatform());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MIPlatformPropertyType) {
            final MIPlatformPropertyType copy = ((MIPlatformPropertyType) draftCopy);
            {
                Boolean miPlatformShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMIPlatform());
                if (miPlatformShouldBeCopiedAndSet == Boolean.TRUE) {
                    MIPlatformType sourceMIPlatform;
                    sourceMIPlatform = this.getMIPlatform();
                    MIPlatformType copyMIPlatform = ((MIPlatformType) strategy.copy(LocatorUtils.property(locator, "miPlatform", sourceMIPlatform), sourceMIPlatform, this.isSetMIPlatform()));
                    copy.setMIPlatform(copyMIPlatform);
                } else {
                    if (miPlatformShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.miPlatform = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MIPlatformPropertyType) {
            final MIPlatformPropertyType target = this;
            final MIPlatformPropertyType leftObject = ((MIPlatformPropertyType) left);
            final MIPlatformPropertyType rightObject = ((MIPlatformPropertyType) right);
            {
                Boolean miPlatformShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMIPlatform(), rightObject.isSetMIPlatform());
                if (miPlatformShouldBeMergedAndSet == Boolean.TRUE) {
                    MIPlatformType lhsMIPlatform;
                    lhsMIPlatform = leftObject.getMIPlatform();
                    MIPlatformType rhsMIPlatform;
                    rhsMIPlatform = rightObject.getMIPlatform();
                    MIPlatformType mergedMIPlatform = ((MIPlatformType) strategy.merge(LocatorUtils.property(leftLocator, "miPlatform", lhsMIPlatform), LocatorUtils.property(rightLocator, "miPlatform", rhsMIPlatform), lhsMIPlatform, rhsMIPlatform, leftObject.isSetMIPlatform(), rightObject.isSetMIPlatform()));
                    target.setMIPlatform(mergedMIPlatform);
                } else {
                    if (miPlatformShouldBeMergedAndSet == Boolean.FALSE) {
                        target.miPlatform = null;
                    }
                }
            }
            {
    ...
    public MIPlatformPropertyType withMIPlatform(MIPlatformType value) {
        setMIPlatform(value);
        return this;
    }

    public MIPlatformPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MIPlatformPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MIPlatformPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MIPlatformPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MIPlatformPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MIPlatformPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MIPlatformPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MIPlatformPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MIPlatformPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MIPlatformPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MIPlatformPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
