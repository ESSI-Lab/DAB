...
public class MIRangeElementDescriptionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetMIRangeElementDescription() {
        return (this.miRangeElementDescription!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            MIRangeElementDescriptionType theMIRangeElementDescription;
            theMIRangeElementDescription = this.getMIRangeElementDescription();
            strategy.appendField(locator, this, "miRangeElementDescription", buffer, theMIRangeElementDescription, this.isSetMIRangeElementDescription());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MIRangeElementDescriptionPropertyType that = ((MIRangeElementDescriptionPropertyType) object);
        {
            MIRangeElementDescriptionType lhsMIRangeElementDescription;
            lhsMIRangeElementDescription = this.getMIRangeElementDescription();
            MIRangeElementDescriptionType rhsMIRangeElementDescription;
            rhsMIRangeElementDescription = that.getMIRangeElementDescription();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "miRangeElementDescription", lhsMIRangeElementDescription), LocatorUtils.property(thatLocator, "miRangeElementDescription", rhsMIRangeElementDescription), lhsMIRangeElementDescription, rhsMIRangeElementDescription, this.isSetMIRangeElementDescription(), that.isSetMIRangeElementDescription())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MIRangeElementDescriptionType theMIRangeElementDescription;
            theMIRangeElementDescription = this.getMIRangeElementDescription();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "miRangeElementDescription", theMIRangeElementDescription), currentHashCode, theMIRangeElementDescription, this.isSetMIRangeElementDescription());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MIRangeElementDescriptionPropertyType) {
            final MIRangeElementDescriptionPropertyType copy = ((MIRangeElementDescriptionPropertyType) draftCopy);
            {
                Boolean miRangeElementDescriptionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMIRangeElementDescription());
                if (miRangeElementDescriptionShouldBeCopiedAndSet == Boolean.TRUE) {
                    MIRangeElementDescriptionType sourceMIRangeElementDescription;
                    sourceMIRangeElementDescription = this.getMIRangeElementDescription();
                    MIRangeElementDescriptionType copyMIRangeElementDescription = ((MIRangeElementDescriptionType) strategy.copy(LocatorUtils.property(locator, "miRangeElementDescription", sourceMIRangeElementDescription), sourceMIRangeElementDescription, this.isSetMIRangeElementDescription()));
                    copy.setMIRangeElementDescription(copyMIRangeElementDescription);
                } else {
                    if (miRangeElementDescriptionShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.miRangeElementDescription = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MIRangeElementDescriptionPropertyType) {
            final MIRangeElementDescriptionPropertyType target = this;
            final MIRangeElementDescriptionPropertyType leftObject = ((MIRangeElementDescriptionPropertyType) left);
            final MIRangeElementDescriptionPropertyType rightObject = ((MIRangeElementDescriptionPropertyType) right);
            {
                Boolean miRangeElementDescriptionShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMIRangeElementDescription(), rightObject.isSetMIRangeElementDescription());
                if (miRangeElementDescriptionShouldBeMergedAndSet == Boolean.TRUE) {
                    MIRangeElementDescriptionType lhsMIRangeElementDescription;
                    lhsMIRangeElementDescription = leftObject.getMIRangeElementDescription();
                    MIRangeElementDescriptionType rhsMIRangeElementDescription;
                    rhsMIRangeElementDescription = rightObject.getMIRangeElementDescription();
                    MIRangeElementDescriptionType mergedMIRangeElementDescription = ((MIRangeElementDescriptionType) strategy.merge(LocatorUtils.property(leftLocator, "miRangeElementDescription", lhsMIRangeElementDescription), LocatorUtils.property(rightLocator, "miRangeElementDescription", rhsMIRangeElementDescription), lhsMIRangeElementDescription, rhsMIRangeElementDescription, leftObject.isSetMIRangeElementDescription(), rightObject.isSetMIRangeElementDescription()));
                    target.setMIRangeElementDescription(mergedMIRangeElementDescription);
                } else {
                    if (miRangeElementDescriptionShouldBeMergedAndSet == Boolean.FALSE) {
                        target.miRangeElementDescription = null;
                    }
                }
            }
            {
    ...
    public MIRangeElementDescriptionPropertyType withMIRangeElementDescription(MIRangeElementDescriptionType value) {
        setMIRangeElementDescription(value);
        return this;
    }

    public MIRangeElementDescriptionPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MIRangeElementDescriptionPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MIRangeElementDescriptionPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MIRangeElementDescriptionPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MIRangeElementDescriptionPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MIRangeElementDescriptionPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MIRangeElementDescriptionPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MIRangeElementDescriptionPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MIRangeElementDescriptionPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MIRangeElementDescriptionPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MIRangeElementDescriptionPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
