...
public class QEUsabilityPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetQEUsability() {
        return (this.qeUsability!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            QEUsabilityType theQEUsability;
            theQEUsability = this.getQEUsability();
            strategy.appendField(locator, this, "qeUsability", buffer, theQEUsability, this.isSetQEUsability());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final QEUsabilityPropertyType that = ((QEUsabilityPropertyType) object);
        {
            QEUsabilityType lhsQEUsability;
            lhsQEUsability = this.getQEUsability();
            QEUsabilityType rhsQEUsability;
            rhsQEUsability = that.getQEUsability();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "qeUsability", lhsQEUsability), LocatorUtils.property(thatLocator, "qeUsability", rhsQEUsability), lhsQEUsability, rhsQEUsability, this.isSetQEUsability(), that.isSetQEUsability())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            QEUsabilityType theQEUsability;
            theQEUsability = this.getQEUsability();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "qeUsability", theQEUsability), currentHashCode, theQEUsability, this.isSetQEUsability());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof QEUsabilityPropertyType) {
            final QEUsabilityPropertyType copy = ((QEUsabilityPropertyType) draftCopy);
            {
                Boolean qeUsabilityShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetQEUsability());
                if (qeUsabilityShouldBeCopiedAndSet == Boolean.TRUE) {
                    QEUsabilityType sourceQEUsability;
                    sourceQEUsability = this.getQEUsability();
                    QEUsabilityType copyQEUsability = ((QEUsabilityType) strategy.copy(LocatorUtils.property(locator, "qeUsability", sourceQEUsability), sourceQEUsability, this.isSetQEUsability()));
                    copy.setQEUsability(copyQEUsability);
                } else {
                    if (qeUsabilityShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.qeUsability = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof QEUsabilityPropertyType) {
            final QEUsabilityPropertyType target = this;
            final QEUsabilityPropertyType leftObject = ((QEUsabilityPropertyType) left);
            final QEUsabilityPropertyType rightObject = ((QEUsabilityPropertyType) right);
            {
                Boolean qeUsabilityShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetQEUsability(), rightObject.isSetQEUsability());
                if (qeUsabilityShouldBeMergedAndSet == Boolean.TRUE) {
                    QEUsabilityType lhsQEUsability;
                    lhsQEUsability = leftObject.getQEUsability();
                    QEUsabilityType rhsQEUsability;
                    rhsQEUsability = rightObject.getQEUsability();
                    QEUsabilityType mergedQEUsability = ((QEUsabilityType) strategy.merge(LocatorUtils.property(leftLocator, "qeUsability", lhsQEUsability), LocatorUtils.property(rightLocator, "qeUsability", rhsQEUsability), lhsQEUsability, rhsQEUsability, leftObject.isSetQEUsability(), rightObject.isSetQEUsability()));
                    target.setQEUsability(mergedQEUsability);
                } else {
                    if (qeUsabilityShouldBeMergedAndSet == Boolean.FALSE) {
                        target.qeUsability = null;
                    }
                }
            }
            {
    ...
    public QEUsabilityPropertyType withQEUsability(QEUsabilityType value) {
        setQEUsability(value);
        return this;
    }

    public QEUsabilityPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public QEUsabilityPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public QEUsabilityPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public QEUsabilityPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public QEUsabilityPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public QEUsabilityPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public QEUsabilityPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public QEUsabilityPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public QEUsabilityPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public QEUsabilityPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public QEUsabilityPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
