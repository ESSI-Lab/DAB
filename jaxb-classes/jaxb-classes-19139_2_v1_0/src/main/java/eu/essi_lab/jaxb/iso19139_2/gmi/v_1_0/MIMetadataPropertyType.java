...
public class MIMetadataPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetMIMetadata() {
        return (this.miMetadata!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            MIMetadataType theMIMetadata;
            theMIMetadata = this.getMIMetadata();
            strategy.appendField(locator, this, "miMetadata", buffer, theMIMetadata, this.isSetMIMetadata());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MIMetadataPropertyType that = ((MIMetadataPropertyType) object);
        {
            MIMetadataType lhsMIMetadata;
            lhsMIMetadata = this.getMIMetadata();
            MIMetadataType rhsMIMetadata;
            rhsMIMetadata = that.getMIMetadata();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "miMetadata", lhsMIMetadata), LocatorUtils.property(thatLocator, "miMetadata", rhsMIMetadata), lhsMIMetadata, rhsMIMetadata, this.isSetMIMetadata(), that.isSetMIMetadata())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MIMetadataType theMIMetadata;
            theMIMetadata = this.getMIMetadata();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "miMetadata", theMIMetadata), currentHashCode, theMIMetadata, this.isSetMIMetadata());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MIMetadataPropertyType) {
            final MIMetadataPropertyType copy = ((MIMetadataPropertyType) draftCopy);
            {
                Boolean miMetadataShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMIMetadata());
                if (miMetadataShouldBeCopiedAndSet == Boolean.TRUE) {
                    MIMetadataType sourceMIMetadata;
                    sourceMIMetadata = this.getMIMetadata();
                    MIMetadataType copyMIMetadata = ((MIMetadataType) strategy.copy(LocatorUtils.property(locator, "miMetadata", sourceMIMetadata), sourceMIMetadata, this.isSetMIMetadata()));
                    copy.setMIMetadata(copyMIMetadata);
                } else {
                    if (miMetadataShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.miMetadata = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MIMetadataPropertyType) {
            final MIMetadataPropertyType target = this;
            final MIMetadataPropertyType leftObject = ((MIMetadataPropertyType) left);
            final MIMetadataPropertyType rightObject = ((MIMetadataPropertyType) right);
            {
                Boolean miMetadataShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMIMetadata(), rightObject.isSetMIMetadata());
                if (miMetadataShouldBeMergedAndSet == Boolean.TRUE) {
                    MIMetadataType lhsMIMetadata;
                    lhsMIMetadata = leftObject.getMIMetadata();
                    MIMetadataType rhsMIMetadata;
                    rhsMIMetadata = rightObject.getMIMetadata();
                    MIMetadataType mergedMIMetadata = ((MIMetadataType) strategy.merge(LocatorUtils.property(leftLocator, "miMetadata", lhsMIMetadata), LocatorUtils.property(rightLocator, "miMetadata", rhsMIMetadata), lhsMIMetadata, rhsMIMetadata, leftObject.isSetMIMetadata(), rightObject.isSetMIMetadata()));
                    target.setMIMetadata(mergedMIMetadata);
                } else {
                    if (miMetadataShouldBeMergedAndSet == Boolean.FALSE) {
                        target.miMetadata = null;
                    }
                }
            }
            {
    ...
    public MIMetadataPropertyType withMIMetadata(MIMetadataType value) {
        setMIMetadata(value);
        return this;
    }

    public MIMetadataPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MIMetadataPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MIMetadataPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MIMetadataPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MIMetadataPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MIMetadataPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MIMetadataPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MIMetadataPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MIMetadataPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MIMetadataPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MIMetadataPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
