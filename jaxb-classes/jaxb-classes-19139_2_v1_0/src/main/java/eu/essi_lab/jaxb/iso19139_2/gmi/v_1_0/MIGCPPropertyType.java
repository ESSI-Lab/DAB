...
public class MIGCPPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetMIGCP() {
        return (this.migcp!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            MIGCPType theMIGCP;
            theMIGCP = this.getMIGCP();
            strategy.appendField(locator, this, "migcp", buffer, theMIGCP, this.isSetMIGCP());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MIGCPPropertyType that = ((MIGCPPropertyType) object);
        {
            MIGCPType lhsMIGCP;
            lhsMIGCP = this.getMIGCP();
            MIGCPType rhsMIGCP;
            rhsMIGCP = that.getMIGCP();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "migcp", lhsMIGCP), LocatorUtils.property(thatLocator, "migcp", rhsMIGCP), lhsMIGCP, rhsMIGCP, this.isSetMIGCP(), that.isSetMIGCP())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MIGCPType theMIGCP;
            theMIGCP = this.getMIGCP();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "migcp", theMIGCP), currentHashCode, theMIGCP, this.isSetMIGCP());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MIGCPPropertyType) {
            final MIGCPPropertyType copy = ((MIGCPPropertyType) draftCopy);
            {
                Boolean migcpShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMIGCP());
                if (migcpShouldBeCopiedAndSet == Boolean.TRUE) {
                    MIGCPType sourceMIGCP;
                    sourceMIGCP = this.getMIGCP();
                    MIGCPType copyMIGCP = ((MIGCPType) strategy.copy(LocatorUtils.property(locator, "migcp", sourceMIGCP), sourceMIGCP, this.isSetMIGCP()));
                    copy.setMIGCP(copyMIGCP);
                } else {
                    if (migcpShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.migcp = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MIGCPPropertyType) {
            final MIGCPPropertyType target = this;
            final MIGCPPropertyType leftObject = ((MIGCPPropertyType) left);
            final MIGCPPropertyType rightObject = ((MIGCPPropertyType) right);
            {
                Boolean migcpShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMIGCP(), rightObject.isSetMIGCP());
                if (migcpShouldBeMergedAndSet == Boolean.TRUE) {
                    MIGCPType lhsMIGCP;
                    lhsMIGCP = leftObject.getMIGCP();
                    MIGCPType rhsMIGCP;
                    rhsMIGCP = rightObject.getMIGCP();
                    MIGCPType mergedMIGCP = ((MIGCPType) strategy.merge(LocatorUtils.property(leftLocator, "migcp", lhsMIGCP), LocatorUtils.property(rightLocator, "migcp", rhsMIGCP), lhsMIGCP, rhsMIGCP, leftObject.isSetMIGCP(), rightObject.isSetMIGCP()));
                    target.setMIGCP(mergedMIGCP);
                } else {
                    if (migcpShouldBeMergedAndSet == Boolean.FALSE) {
                        target.migcp = null;
                    }
                }
            }
    ...
    public MIGCPPropertyType withMIGCP(MIGCPType value) {
        setMIGCP(value);
        return this;
    }

    public MIGCPPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MIGCPPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MIGCPPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MIGCPPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MIGCPPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MIGCPPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MIGCPPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MIGCPPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MIGCPPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MIGCPPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MIGCPPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
