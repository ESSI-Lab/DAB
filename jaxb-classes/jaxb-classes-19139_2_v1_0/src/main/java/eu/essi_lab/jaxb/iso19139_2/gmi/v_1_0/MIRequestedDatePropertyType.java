...
public class MIRequestedDatePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetMIRequestedDate() {
        return (this.miRequestedDate!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            MIRequestedDateType theMIRequestedDate;
            theMIRequestedDate = this.getMIRequestedDate();
            strategy.appendField(locator, this, "miRequestedDate", buffer, theMIRequestedDate, this.isSetMIRequestedDate());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MIRequestedDatePropertyType that = ((MIRequestedDatePropertyType) object);
        {
            MIRequestedDateType lhsMIRequestedDate;
            lhsMIRequestedDate = this.getMIRequestedDate();
            MIRequestedDateType rhsMIRequestedDate;
            rhsMIRequestedDate = that.getMIRequestedDate();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "miRequestedDate", lhsMIRequestedDate), LocatorUtils.property(thatLocator, "miRequestedDate", rhsMIRequestedDate), lhsMIRequestedDate, rhsMIRequestedDate, this.isSetMIRequestedDate(), that.isSetMIRequestedDate())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MIRequestedDateType theMIRequestedDate;
            theMIRequestedDate = this.getMIRequestedDate();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "miRequestedDate", theMIRequestedDate), currentHashCode, theMIRequestedDate, this.isSetMIRequestedDate());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MIRequestedDatePropertyType) {
            final MIRequestedDatePropertyType copy = ((MIRequestedDatePropertyType) draftCopy);
            {
                Boolean miRequestedDateShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMIRequestedDate());
                if (miRequestedDateShouldBeCopiedAndSet == Boolean.TRUE) {
                    MIRequestedDateType sourceMIRequestedDate;
                    sourceMIRequestedDate = this.getMIRequestedDate();
                    MIRequestedDateType copyMIRequestedDate = ((MIRequestedDateType) strategy.copy(LocatorUtils.property(locator, "miRequestedDate", sourceMIRequestedDate), sourceMIRequestedDate, this.isSetMIRequestedDate()));
                    copy.setMIRequestedDate(copyMIRequestedDate);
                } else {
                    if (miRequestedDateShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.miRequestedDate = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MIRequestedDatePropertyType) {
            final MIRequestedDatePropertyType target = this;
            final MIRequestedDatePropertyType leftObject = ((MIRequestedDatePropertyType) left);
            final MIRequestedDatePropertyType rightObject = ((MIRequestedDatePropertyType) right);
            {
                Boolean miRequestedDateShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMIRequestedDate(), rightObject.isSetMIRequestedDate());
                if (miRequestedDateShouldBeMergedAndSet == Boolean.TRUE) {
                    MIRequestedDateType lhsMIRequestedDate;
                    lhsMIRequestedDate = leftObject.getMIRequestedDate();
                    MIRequestedDateType rhsMIRequestedDate;
                    rhsMIRequestedDate = rightObject.getMIRequestedDate();
                    MIRequestedDateType mergedMIRequestedDate = ((MIRequestedDateType) strategy.merge(LocatorUtils.property(leftLocator, "miRequestedDate", lhsMIRequestedDate), LocatorUtils.property(rightLocator, "miRequestedDate", rhsMIRequestedDate), lhsMIRequestedDate, rhsMIRequestedDate, leftObject.isSetMIRequestedDate(), rightObject.isSetMIRequestedDate()));
                    target.setMIRequestedDate(mergedMIRequestedDate);
                } else {
                    if (miRequestedDateShouldBeMergedAndSet == Boolean.FALSE) {
                        target.miRequestedDate = null;
                    }
                }
            }
            {
    ...
    public MIRequestedDatePropertyType withMIRequestedDate(MIRequestedDateType value) {
        setMIRequestedDate(value);
        return this;
    }

    public MIRequestedDatePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MIRequestedDatePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MIRequestedDatePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MIRequestedDatePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MIRequestedDatePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MIRequestedDatePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MIRequestedDatePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MIRequestedDatePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MIRequestedDatePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MIRequestedDatePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MIRequestedDatePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
