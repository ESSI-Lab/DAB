...
public class MIInstrumentPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetMIInstrument() {
        return (this.miInstrument!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            MIInstrumentType theMIInstrument;
            theMIInstrument = this.getMIInstrument();
            strategy.appendField(locator, this, "miInstrument", buffer, theMIInstrument, this.isSetMIInstrument());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MIInstrumentPropertyType that = ((MIInstrumentPropertyType) object);
        {
            MIInstrumentType lhsMIInstrument;
            lhsMIInstrument = this.getMIInstrument();
            MIInstrumentType rhsMIInstrument;
            rhsMIInstrument = that.getMIInstrument();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "miInstrument", lhsMIInstrument), LocatorUtils.property(thatLocator, "miInstrument", rhsMIInstrument), lhsMIInstrument, rhsMIInstrument, this.isSetMIInstrument(), that.isSetMIInstrument())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MIInstrumentType theMIInstrument;
            theMIInstrument = this.getMIInstrument();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "miInstrument", theMIInstrument), currentHashCode, theMIInstrument, this.isSetMIInstrument());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MIInstrumentPropertyType) {
            final MIInstrumentPropertyType copy = ((MIInstrumentPropertyType) draftCopy);
            {
                Boolean miInstrumentShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMIInstrument());
                if (miInstrumentShouldBeCopiedAndSet == Boolean.TRUE) {
                    MIInstrumentType sourceMIInstrument;
                    sourceMIInstrument = this.getMIInstrument();
                    MIInstrumentType copyMIInstrument = ((MIInstrumentType) strategy.copy(LocatorUtils.property(locator, "miInstrument", sourceMIInstrument), sourceMIInstrument, this.isSetMIInstrument()));
                    copy.setMIInstrument(copyMIInstrument);
                } else {
                    if (miInstrumentShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.miInstrument = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MIInstrumentPropertyType) {
            final MIInstrumentPropertyType target = this;
            final MIInstrumentPropertyType leftObject = ((MIInstrumentPropertyType) left);
            final MIInstrumentPropertyType rightObject = ((MIInstrumentPropertyType) right);
            {
                Boolean miInstrumentShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMIInstrument(), rightObject.isSetMIInstrument());
                if (miInstrumentShouldBeMergedAndSet == Boolean.TRUE) {
                    MIInstrumentType lhsMIInstrument;
                    lhsMIInstrument = leftObject.getMIInstrument();
                    MIInstrumentType rhsMIInstrument;
                    rhsMIInstrument = rightObject.getMIInstrument();
                    MIInstrumentType mergedMIInstrument = ((MIInstrumentType) strategy.merge(LocatorUtils.property(leftLocator, "miInstrument", lhsMIInstrument), LocatorUtils.property(rightLocator, "miInstrument", rhsMIInstrument), lhsMIInstrument, rhsMIInstrument, leftObject.isSetMIInstrument(), rightObject.isSetMIInstrument()));
                    target.setMIInstrument(mergedMIInstrument);
                } else {
                    if (miInstrumentShouldBeMergedAndSet == Boolean.FALSE) {
                        target.miInstrument = null;
                    }
                }
            }
            {
    ...
    public MIInstrumentPropertyType withMIInstrument(MIInstrumentType value) {
        setMIInstrument(value);
        return this;
    }

    public MIInstrumentPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MIInstrumentPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MIInstrumentPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MIInstrumentPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MIInstrumentPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MIInstrumentPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MIInstrumentPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MIInstrumentPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MIInstrumentPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MIInstrumentPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MIInstrumentPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
