...
public class LEAlgorithmPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetLEAlgorithm() {
        return (this.leAlgorithm!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            LEAlgorithmType theLEAlgorithm;
            theLEAlgorithm = this.getLEAlgorithm();
            strategy.appendField(locator, this, "leAlgorithm", buffer, theLEAlgorithm, this.isSetLEAlgorithm());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LEAlgorithmPropertyType that = ((LEAlgorithmPropertyType) object);
        {
            LEAlgorithmType lhsLEAlgorithm;
            lhsLEAlgorithm = this.getLEAlgorithm();
            LEAlgorithmType rhsLEAlgorithm;
            rhsLEAlgorithm = that.getLEAlgorithm();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "leAlgorithm", lhsLEAlgorithm), LocatorUtils.property(thatLocator, "leAlgorithm", rhsLEAlgorithm), lhsLEAlgorithm, rhsLEAlgorithm, this.isSetLEAlgorithm(), that.isSetLEAlgorithm())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            LEAlgorithmType theLEAlgorithm;
            theLEAlgorithm = this.getLEAlgorithm();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "leAlgorithm", theLEAlgorithm), currentHashCode, theLEAlgorithm, this.isSetLEAlgorithm());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof LEAlgorithmPropertyType) {
            final LEAlgorithmPropertyType copy = ((LEAlgorithmPropertyType) draftCopy);
            {
                Boolean leAlgorithmShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetLEAlgorithm());
                if (leAlgorithmShouldBeCopiedAndSet == Boolean.TRUE) {
                    LEAlgorithmType sourceLEAlgorithm;
                    sourceLEAlgorithm = this.getLEAlgorithm();
                    LEAlgorithmType copyLEAlgorithm = ((LEAlgorithmType) strategy.copy(LocatorUtils.property(locator, "leAlgorithm", sourceLEAlgorithm), sourceLEAlgorithm, this.isSetLEAlgorithm()));
                    copy.setLEAlgorithm(copyLEAlgorithm);
                } else {
                    if (leAlgorithmShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.leAlgorithm = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof LEAlgorithmPropertyType) {
            final LEAlgorithmPropertyType target = this;
            final LEAlgorithmPropertyType leftObject = ((LEAlgorithmPropertyType) left);
            final LEAlgorithmPropertyType rightObject = ((LEAlgorithmPropertyType) right);
            {
                Boolean leAlgorithmShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetLEAlgorithm(), rightObject.isSetLEAlgorithm());
                if (leAlgorithmShouldBeMergedAndSet == Boolean.TRUE) {
                    LEAlgorithmType lhsLEAlgorithm;
                    lhsLEAlgorithm = leftObject.getLEAlgorithm();
                    LEAlgorithmType rhsLEAlgorithm;
                    rhsLEAlgorithm = rightObject.getLEAlgorithm();
                    LEAlgorithmType mergedLEAlgorithm = ((LEAlgorithmType) strategy.merge(LocatorUtils.property(leftLocator, "leAlgorithm", lhsLEAlgorithm), LocatorUtils.property(rightLocator, "leAlgorithm", rhsLEAlgorithm), lhsLEAlgorithm, rhsLEAlgorithm, leftObject.isSetLEAlgorithm(), rightObject.isSetLEAlgorithm()));
                    target.setLEAlgorithm(mergedLEAlgorithm);
                } else {
                    if (leAlgorithmShouldBeMergedAndSet == Boolean.FALSE) {
                        target.leAlgorithm = null;
                    }
                }
            }
            {
    ...
    public LEAlgorithmPropertyType withLEAlgorithm(LEAlgorithmType value) {
        setLEAlgorithm(value);
        return this;
    }

    public LEAlgorithmPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public LEAlgorithmPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public LEAlgorithmPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public LEAlgorithmPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public LEAlgorithmPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public LEAlgorithmPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public LEAlgorithmPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public LEAlgorithmPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public LEAlgorithmPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public LEAlgorithmPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public LEAlgorithmPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
