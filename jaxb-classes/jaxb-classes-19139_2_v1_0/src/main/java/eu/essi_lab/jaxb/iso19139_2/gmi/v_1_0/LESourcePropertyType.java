...
public class LESourcePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetLESource() {
        return (this.leSource!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            LESourceType theLESource;
            theLESource = this.getLESource();
            strategy.appendField(locator, this, "leSource", buffer, theLESource, this.isSetLESource());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LESourcePropertyType that = ((LESourcePropertyType) object);
        {
            LESourceType lhsLESource;
            lhsLESource = this.getLESource();
            LESourceType rhsLESource;
            rhsLESource = that.getLESource();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "leSource", lhsLESource), LocatorUtils.property(thatLocator, "leSource", rhsLESource), lhsLESource, rhsLESource, this.isSetLESource(), that.isSetLESource())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            LESourceType theLESource;
            theLESource = this.getLESource();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "leSource", theLESource), currentHashCode, theLESource, this.isSetLESource());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof LESourcePropertyType) {
            final LESourcePropertyType copy = ((LESourcePropertyType) draftCopy);
            {
                Boolean leSourceShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetLESource());
                if (leSourceShouldBeCopiedAndSet == Boolean.TRUE) {
                    LESourceType sourceLESource;
                    sourceLESource = this.getLESource();
                    LESourceType copyLESource = ((LESourceType) strategy.copy(LocatorUtils.property(locator, "leSource", sourceLESource), sourceLESource, this.isSetLESource()));
                    copy.setLESource(copyLESource);
                } else {
                    if (leSourceShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.leSource = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof LESourcePropertyType) {
            final LESourcePropertyType target = this;
            final LESourcePropertyType leftObject = ((LESourcePropertyType) left);
            final LESourcePropertyType rightObject = ((LESourcePropertyType) right);
            {
                Boolean leSourceShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetLESource(), rightObject.isSetLESource());
                if (leSourceShouldBeMergedAndSet == Boolean.TRUE) {
                    LESourceType lhsLESource;
                    lhsLESource = leftObject.getLESource();
                    LESourceType rhsLESource;
                    rhsLESource = rightObject.getLESource();
                    LESourceType mergedLESource = ((LESourceType) strategy.merge(LocatorUtils.property(leftLocator, "leSource", lhsLESource), LocatorUtils.property(rightLocator, "leSource", rhsLESource), lhsLESource, rhsLESource, leftObject.isSetLESource(), rightObject.isSetLESource()));
                    target.setLESource(mergedLESource);
                } else {
                    if (leSourceShouldBeMergedAndSet == Boolean.FALSE) {
                        target.leSource = null;
                    }
                }
            }
            {
    ...
    public LESourcePropertyType withLESource(LESourceType value) {
        setLESource(value);
        return this;
    }

    public LESourcePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public LESourcePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public LESourcePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public LESourcePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public LESourcePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public LESourcePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public LESourcePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public LESourcePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public LESourcePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public LESourcePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public LESourcePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
