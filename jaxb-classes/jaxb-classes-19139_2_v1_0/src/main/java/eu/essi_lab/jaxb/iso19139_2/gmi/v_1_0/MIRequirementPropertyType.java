...
public class MIRequirementPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetMIRequirement() {
        return (this.miRequirement!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            MIRequirementType theMIRequirement;
            theMIRequirement = this.getMIRequirement();
            strategy.appendField(locator, this, "miRequirement", buffer, theMIRequirement, this.isSetMIRequirement());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MIRequirementPropertyType that = ((MIRequirementPropertyType) object);
        {
            MIRequirementType lhsMIRequirement;
            lhsMIRequirement = this.getMIRequirement();
            MIRequirementType rhsMIRequirement;
            rhsMIRequirement = that.getMIRequirement();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "miRequirement", lhsMIRequirement), LocatorUtils.property(thatLocator, "miRequirement", rhsMIRequirement), lhsMIRequirement, rhsMIRequirement, this.isSetMIRequirement(), that.isSetMIRequirement())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MIRequirementType theMIRequirement;
            theMIRequirement = this.getMIRequirement();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "miRequirement", theMIRequirement), currentHashCode, theMIRequirement, this.isSetMIRequirement());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MIRequirementPropertyType) {
            final MIRequirementPropertyType copy = ((MIRequirementPropertyType) draftCopy);
            {
                Boolean miRequirementShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMIRequirement());
                if (miRequirementShouldBeCopiedAndSet == Boolean.TRUE) {
                    MIRequirementType sourceMIRequirement;
                    sourceMIRequirement = this.getMIRequirement();
                    MIRequirementType copyMIRequirement = ((MIRequirementType) strategy.copy(LocatorUtils.property(locator, "miRequirement", sourceMIRequirement), sourceMIRequirement, this.isSetMIRequirement()));
                    copy.setMIRequirement(copyMIRequirement);
                } else {
                    if (miRequirementShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.miRequirement = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MIRequirementPropertyType) {
            final MIRequirementPropertyType target = this;
            final MIRequirementPropertyType leftObject = ((MIRequirementPropertyType) left);
            final MIRequirementPropertyType rightObject = ((MIRequirementPropertyType) right);
            {
                Boolean miRequirementShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMIRequirement(), rightObject.isSetMIRequirement());
                if (miRequirementShouldBeMergedAndSet == Boolean.TRUE) {
                    MIRequirementType lhsMIRequirement;
                    lhsMIRequirement = leftObject.getMIRequirement();
                    MIRequirementType rhsMIRequirement;
                    rhsMIRequirement = rightObject.getMIRequirement();
                    MIRequirementType mergedMIRequirement = ((MIRequirementType) strategy.merge(LocatorUtils.property(leftLocator, "miRequirement", lhsMIRequirement), LocatorUtils.property(rightLocator, "miRequirement", rhsMIRequirement), lhsMIRequirement, rhsMIRequirement, leftObject.isSetMIRequirement(), rightObject.isSetMIRequirement()));
                    target.setMIRequirement(mergedMIRequirement);
                } else {
                    if (miRequirementShouldBeMergedAndSet == Boolean.FALSE) {
                        target.miRequirement = null;
                    }
                }
            }
            {
    ...
    public MIRequirementPropertyType withMIRequirement(MIRequirementType value) {
        setMIRequirement(value);
        return this;
    }

    public MIRequirementPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MIRequirementPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MIRequirementPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MIRequirementPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MIRequirementPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MIRequirementPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MIRequirementPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MIRequirementPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MIRequirementPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MIRequirementPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MIRequirementPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
