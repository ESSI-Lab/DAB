...
public class LEProcessStepPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetLEProcessStep() {
        return (this.leProcessStep!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            LEProcessStepType theLEProcessStep;
            theLEProcessStep = this.getLEProcessStep();
            strategy.appendField(locator, this, "leProcessStep", buffer, theLEProcessStep, this.isSetLEProcessStep());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LEProcessStepPropertyType that = ((LEProcessStepPropertyType) object);
        {
            LEProcessStepType lhsLEProcessStep;
            lhsLEProcessStep = this.getLEProcessStep();
            LEProcessStepType rhsLEProcessStep;
            rhsLEProcessStep = that.getLEProcessStep();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "leProcessStep", lhsLEProcessStep), LocatorUtils.property(thatLocator, "leProcessStep", rhsLEProcessStep), lhsLEProcessStep, rhsLEProcessStep, this.isSetLEProcessStep(), that.isSetLEProcessStep())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            LEProcessStepType theLEProcessStep;
            theLEProcessStep = this.getLEProcessStep();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "leProcessStep", theLEProcessStep), currentHashCode, theLEProcessStep, this.isSetLEProcessStep());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof LEProcessStepPropertyType) {
            final LEProcessStepPropertyType copy = ((LEProcessStepPropertyType) draftCopy);
            {
                Boolean leProcessStepShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetLEProcessStep());
                if (leProcessStepShouldBeCopiedAndSet == Boolean.TRUE) {
                    LEProcessStepType sourceLEProcessStep;
                    sourceLEProcessStep = this.getLEProcessStep();
                    LEProcessStepType copyLEProcessStep = ((LEProcessStepType) strategy.copy(LocatorUtils.property(locator, "leProcessStep", sourceLEProcessStep), sourceLEProcessStep, this.isSetLEProcessStep()));
                    copy.setLEProcessStep(copyLEProcessStep);
                } else {
                    if (leProcessStepShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.leProcessStep = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof LEProcessStepPropertyType) {
            final LEProcessStepPropertyType target = this;
            final LEProcessStepPropertyType leftObject = ((LEProcessStepPropertyType) left);
            final LEProcessStepPropertyType rightObject = ((LEProcessStepPropertyType) right);
            {
                Boolean leProcessStepShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetLEProcessStep(), rightObject.isSetLEProcessStep());
                if (leProcessStepShouldBeMergedAndSet == Boolean.TRUE) {
                    LEProcessStepType lhsLEProcessStep;
                    lhsLEProcessStep = leftObject.getLEProcessStep();
                    LEProcessStepType rhsLEProcessStep;
                    rhsLEProcessStep = rightObject.getLEProcessStep();
                    LEProcessStepType mergedLEProcessStep = ((LEProcessStepType) strategy.merge(LocatorUtils.property(leftLocator, "leProcessStep", lhsLEProcessStep), LocatorUtils.property(rightLocator, "leProcessStep", rhsLEProcessStep), lhsLEProcessStep, rhsLEProcessStep, leftObject.isSetLEProcessStep(), rightObject.isSetLEProcessStep()));
                    target.setLEProcessStep(mergedLEProcessStep);
                } else {
                    if (leProcessStepShouldBeMergedAndSet == Boolean.FALSE) {
                        target.leProcessStep = null;
                    }
                }
            }
            {
    ...
    public LEProcessStepPropertyType withLEProcessStep(LEProcessStepType value) {
        setLEProcessStep(value);
        return this;
    }

    public LEProcessStepPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public LEProcessStepPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public LEProcessStepPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public LEProcessStepPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public LEProcessStepPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public LEProcessStepPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public LEProcessStepPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public LEProcessStepPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public LEProcessStepPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public LEProcessStepPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public LEProcessStepPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
