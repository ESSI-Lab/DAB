...
public class MIOperationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetMIOperation() {
        return (this.miOperation!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            MIOperationType theMIOperation;
            theMIOperation = this.getMIOperation();
            strategy.appendField(locator, this, "miOperation", buffer, theMIOperation, this.isSetMIOperation());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MIOperationPropertyType that = ((MIOperationPropertyType) object);
        {
            MIOperationType lhsMIOperation;
            lhsMIOperation = this.getMIOperation();
            MIOperationType rhsMIOperation;
            rhsMIOperation = that.getMIOperation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "miOperation", lhsMIOperation), LocatorUtils.property(thatLocator, "miOperation", rhsMIOperation), lhsMIOperation, rhsMIOperation, this.isSetMIOperation(), that.isSetMIOperation())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MIOperationType theMIOperation;
            theMIOperation = this.getMIOperation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "miOperation", theMIOperation), currentHashCode, theMIOperation, this.isSetMIOperation());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MIOperationPropertyType) {
            final MIOperationPropertyType copy = ((MIOperationPropertyType) draftCopy);
            {
                Boolean miOperationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMIOperation());
                if (miOperationShouldBeCopiedAndSet == Boolean.TRUE) {
                    MIOperationType sourceMIOperation;
                    sourceMIOperation = this.getMIOperation();
                    MIOperationType copyMIOperation = ((MIOperationType) strategy.copy(LocatorUtils.property(locator, "miOperation", sourceMIOperation), sourceMIOperation, this.isSetMIOperation()));
                    copy.setMIOperation(copyMIOperation);
                } else {
                    if (miOperationShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.miOperation = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MIOperationPropertyType) {
            final MIOperationPropertyType target = this;
            final MIOperationPropertyType leftObject = ((MIOperationPropertyType) left);
            final MIOperationPropertyType rightObject = ((MIOperationPropertyType) right);
            {
                Boolean miOperationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMIOperation(), rightObject.isSetMIOperation());
                if (miOperationShouldBeMergedAndSet == Boolean.TRUE) {
                    MIOperationType lhsMIOperation;
                    lhsMIOperation = leftObject.getMIOperation();
                    MIOperationType rhsMIOperation;
                    rhsMIOperation = rightObject.getMIOperation();
                    MIOperationType mergedMIOperation = ((MIOperationType) strategy.merge(LocatorUtils.property(leftLocator, "miOperation", lhsMIOperation), LocatorUtils.property(rightLocator, "miOperation", rhsMIOperation), lhsMIOperation, rhsMIOperation, leftObject.isSetMIOperation(), rightObject.isSetMIOperation()));
                    target.setMIOperation(mergedMIOperation);
                } else {
                    if (miOperationShouldBeMergedAndSet == Boolean.FALSE) {
                        target.miOperation = null;
                    }
                }
            }
            {
    ...
    public MIOperationPropertyType withMIOperation(MIOperationType value) {
        setMIOperation(value);
        return this;
    }

    public MIOperationPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MIOperationPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MIOperationPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MIOperationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MIOperationPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MIOperationPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MIOperationPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MIOperationPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MIOperationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MIOperationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MIOperationPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
