...
public class MIObjectivePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetMIObjective() {
        return (this.miObjective!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            MIObjectiveType theMIObjective;
            theMIObjective = this.getMIObjective();
            strategy.appendField(locator, this, "miObjective", buffer, theMIObjective, this.isSetMIObjective());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MIObjectivePropertyType that = ((MIObjectivePropertyType) object);
        {
            MIObjectiveType lhsMIObjective;
            lhsMIObjective = this.getMIObjective();
            MIObjectiveType rhsMIObjective;
            rhsMIObjective = that.getMIObjective();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "miObjective", lhsMIObjective), LocatorUtils.property(thatLocator, "miObjective", rhsMIObjective), lhsMIObjective, rhsMIObjective, this.isSetMIObjective(), that.isSetMIObjective())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MIObjectiveType theMIObjective;
            theMIObjective = this.getMIObjective();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "miObjective", theMIObjective), currentHashCode, theMIObjective, this.isSetMIObjective());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MIObjectivePropertyType) {
            final MIObjectivePropertyType copy = ((MIObjectivePropertyType) draftCopy);
            {
                Boolean miObjectiveShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMIObjective());
                if (miObjectiveShouldBeCopiedAndSet == Boolean.TRUE) {
                    MIObjectiveType sourceMIObjective;
                    sourceMIObjective = this.getMIObjective();
                    MIObjectiveType copyMIObjective = ((MIObjectiveType) strategy.copy(LocatorUtils.property(locator, "miObjective", sourceMIObjective), sourceMIObjective, this.isSetMIObjective()));
                    copy.setMIObjective(copyMIObjective);
                } else {
                    if (miObjectiveShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.miObjective = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MIObjectivePropertyType) {
            final MIObjectivePropertyType target = this;
            final MIObjectivePropertyType leftObject = ((MIObjectivePropertyType) left);
            final MIObjectivePropertyType rightObject = ((MIObjectivePropertyType) right);
            {
                Boolean miObjectiveShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMIObjective(), rightObject.isSetMIObjective());
                if (miObjectiveShouldBeMergedAndSet == Boolean.TRUE) {
                    MIObjectiveType lhsMIObjective;
                    lhsMIObjective = leftObject.getMIObjective();
                    MIObjectiveType rhsMIObjective;
                    rhsMIObjective = rightObject.getMIObjective();
                    MIObjectiveType mergedMIObjective = ((MIObjectiveType) strategy.merge(LocatorUtils.property(leftLocator, "miObjective", lhsMIObjective), LocatorUtils.property(rightLocator, "miObjective", rhsMIObjective), lhsMIObjective, rhsMIObjective, leftObject.isSetMIObjective(), rightObject.isSetMIObjective()));
                    target.setMIObjective(mergedMIObjective);
                } else {
                    if (miObjectiveShouldBeMergedAndSet == Boolean.FALSE) {
                        target.miObjective = null;
                    }
                }
            }
            {
    ...
    public MIObjectivePropertyType withMIObjective(MIObjectiveType value) {
        setMIObjective(value);
        return this;
    }

    public MIObjectivePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MIObjectivePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MIObjectivePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MIObjectivePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MIObjectivePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MIObjectivePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MIObjectivePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MIObjectivePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MIObjectivePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MIObjectivePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MIObjectivePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
