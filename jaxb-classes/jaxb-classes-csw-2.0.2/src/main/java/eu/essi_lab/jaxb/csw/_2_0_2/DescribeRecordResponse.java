 ...
 * 
 * <p>Classe Java per DescribeRecordResponseType complex type.
 * 
...
public class DescribeRecordResponse {
    ...
    protected List<SchemaComponentType> schemaComponents;

    /**
     * Gets the value of the schemaComponents property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the schemaComponents property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSchemaComponents().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<SchemaComponentType> getSchemaComponents() {
        if (schemaComponents == null) {
            schemaComponents = new ArrayList<SchemaComponentType>();
        }
