...
public class MetadataType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            Object lhsAbstractMetaData;
            lhsAbstractMetaData = this.getAbstractMetaData();
            Object rhsAbstractMetaData;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MetadataType) {
            ...
            {
                Boolean abstractMetaDataShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractMetaData());
                if (abstractMetaDataShouldBeCopiedAndSet == Boolean.TRUE) {
                    Object sourceAbstractMetaData;
                    sourceAbstractMetaData = this.getAbstractMetaData();
                    Object copyAbstractMetaData = ((Object) strategy.copy(LocatorUtils.property(locator, "abstractMetaData", sourceAbstractMetaData), sourceAbstractMetaData, this.isSetAbstractMetaData()));
                    copy.setAbstractMetaData(copyAbstractMetaData);
                } else {
                    if (abstractMetaDataShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MetadataType) {
            final MetadataType target = this;
            final MetadataType leftObject = ((MetadataType) left);
            final MetadataType rightObject = ((MetadataType) right);
            {
                Boolean abstractMetaDataShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractMetaData(), rightObject.isSetAbstractMetaData());
                if (abstractMetaDataShouldBeMergedAndSet == Boolean.TRUE) {
                    Object lhsAbstractMetaData;
                    lhsAbstractMetaData = leftObject.getAbstractMetaData();
                    Object rhsAbstractMetaData;
                    rhsAbstractMetaData = rightObject.getAbstractMetaData();
                    Object mergedAbstractMetaData = ((Object) strategy.merge(LocatorUtils.property(leftLocator, "abstractMetaData", lhsAbstractMetaData), LocatorUtils.property(rightLocator, "abstractMetaData", rhsAbstractMetaData), lhsAbstractMetaData, rhsAbstractMetaData, leftObject.isSetAbstractMetaData(), rightObject.isSetAbstractMetaData()));
                    target.setAbstractMetaData(mergedAbstractMetaData);
                } else {
                    if (abstractMetaDataShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public MetadataType withAbstractMetaData(Object value) {
        setAbstractMetaData(value);
        return this;
    }

    public MetadataType withAbout(String value) {
        setAbout(value);
        return this;
    }

    public MetadataType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MetadataType withHref(String value) {
        setHref(value);
        return this;
    }

    public MetadataType withRole(String value) {
        setRole(value);
        return this;
    }

    public MetadataType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MetadataType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MetadataType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MetadataType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
