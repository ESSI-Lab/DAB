    ...
    extends AbstractSurfaceType
{
    ...
    @XmlElementRef(name = "surfaceMember", namespace = "http://www.opengis.net/gml/3.2", type = SingleSurfaceMember.class)
    protected List<SingleSurfaceMember> surfaceMember;
     ...
     * 
     */
    public List<SingleSurfaceMember> getSurfaceMember() {
        if (surfaceMember == null) {
            surfaceMember = new ArrayList<SingleSurfaceMember>();
        }
