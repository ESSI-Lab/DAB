...
public class SinglePointMember
    extends JAXBElement<PointPropertyType>
{

    protected final static QName NAME = new QName("http://www.opengis.net/gml/3.2", "pointMember");

    public SinglePointMember(PointPropertyType value) {
        super(NAME, ((Class) PointPropertyType.class), null, value);
    }

    public SinglePointMember() {
