...
public class UserDefinedCSPropertyType {
    ...
    @XmlElementRef(name = "UserDefinedCS", namespace = "http://www.opengis.net/gml/3.2", type = UserDefinedCS1 .class, required = false)
    protected UserDefinedCS1 userDefinedCS;
     ...
     *     
     */
    public UserDefinedCS1 getUserDefinedCS() {
     ...
     *     
     */
    public void setUserDefinedCS(UserDefinedCS1 value) {
