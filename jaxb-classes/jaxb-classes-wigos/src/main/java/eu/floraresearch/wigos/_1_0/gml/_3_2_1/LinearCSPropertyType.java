...
public class LinearCSPropertyType {
    ...
    @XmlElementRef(name = "LinearCS", namespace = "http://www.opengis.net/gml/3.2", type = LinearCS1 .class, required = false)
    protected LinearCS1 linearCS;
     ...
     *     
     */
    public void setLinearCS(LinearCS1 value) {
        this.linearCS = value;
    }
