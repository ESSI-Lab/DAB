...
public class PolarCSPropertyType {
    ...
    @XmlElementRef(name = "PolarCS", namespace = "http://www.opengis.net/gml/3.2", type = PolarCS1 .class, required = false)
    protected PolarCS1 polarCS;
     ...
     *     
     */
    public void setPolarCS(PolarCS1 value) {
        this.polarCS = value;
    }
