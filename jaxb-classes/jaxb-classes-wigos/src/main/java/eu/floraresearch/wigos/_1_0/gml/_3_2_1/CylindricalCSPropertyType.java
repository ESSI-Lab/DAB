...
public class CylindricalCSPropertyType {
    ...
    @XmlElementRef(name = "CylindricalCS", namespace = "http://www.opengis.net/gml/3.2", type = CylindricalCS1 .class, required = false)
    protected CylindricalCS1 cylindricalCS;
     ...
     *     
     */
    public CylindricalCS1 getCylindricalCS() {
     ...
     *     
     */
    public void setCylindricalCS(CylindricalCS1 value) {
