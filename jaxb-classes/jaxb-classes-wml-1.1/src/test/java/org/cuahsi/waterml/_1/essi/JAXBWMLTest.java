...
public class JAXBWMLTest {
	...
	int value = tsrt.getTimeSeries().getFirst().getValues().getFirst().getValue().getFirst().getValue().intValue();
	...
	value = tsrt.getTimeSeries().getFirst().getValues().getFirst().getValue().getFirst().getValue().intValue();
	assertEquals(13, value);
    }
	...
	String siteName = sirt.getSite().getFirst().getSiteInfo().getSiteName();
	...
	siteName = sirt.getSite().getFirst().getSiteInfo().getSiteName();
	assertEquals("Ancient_Forest", siteName);
    }
