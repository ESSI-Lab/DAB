...
public class TimeTopologyComplexPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimeTopologyComplexPropertyType) {
            ...
            {
                Boolean timeTopologyComplexShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTimeTopologyComplex());
                if (timeTopologyComplexShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (timeTopologyComplexShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TimeTopologyComplexPropertyType) {
            ...
            {
                Boolean timeTopologyComplexShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTimeTopologyComplex(), rightObject.isSetTimeTopologyComplex());
                if (timeTopologyComplexShouldBeMergedAndSet == Boolean.TRUE) {
                    TimeTopologyComplexType lhsTimeTopologyComplex;
                    ...
                    if (timeTopologyComplexShouldBeMergedAndSet == Boolean.FALSE) {
