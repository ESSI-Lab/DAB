...
public class CoordinateReferenceSystemRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof CoordinateReferenceSystemRefType) {
            final CoordinateReferenceSystemRefType copy = ((CoordinateReferenceSystemRefType) draftCopy);
            {
                ...
                if (coordinateReferenceSystemShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractReferenceSystemType> copyCoordinateReferenceSystem = ((JAXBElement<? extends AbstractReferenceSystemType> ) strategy.copy(LocatorUtils.property(locator, "coordinateReferenceSystem", sourceCoordinateReferenceSystem), sourceCoordinateReferenceSystem, this.isSetCoordinateReferenceSystem()));
    ...
    public CoordinateReferenceSystemRefType withCoordinateReferenceSystem(JAXBElement<? extends AbstractReferenceSystemType> value) {
        setCoordinateReferenceSystem(value);
        return this;
    }

    public CoordinateReferenceSystemRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public CoordinateReferenceSystemRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CoordinateReferenceSystemRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public CoordinateReferenceSystemRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public CoordinateReferenceSystemRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CoordinateReferenceSystemRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CoordinateReferenceSystemRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CoordinateReferenceSystemRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
