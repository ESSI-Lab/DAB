    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TinType) {
            ...
            {
                Boolean stopLinesShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetStopLines());
                if (stopLinesShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (stopLinesShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unsetStopLines();
                    }
                }
            }
            {
                Boolean breakLinesShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetBreakLines());
                if (breakLinesShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (breakLinesShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unsetBreakLines();
                    }
                }
            }
            {
                Boolean maxLengthShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMaxLength());
                if (maxLengthShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (maxLengthShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.maxLength = null;
                    }
                }
            }
            {
                Boolean controlPointShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetControlPoint());
                if (controlPointShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (controlPointShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof TinType) {
            ...
            {
                Boolean stopLinesShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetStopLines(), rightObject.isSetStopLines());
                if (stopLinesShouldBeMergedAndSet == Boolean.TRUE) {
                    List<LineStringSegmentArrayPropertyType> lhsStopLines;
                    ...
                    if (stopLinesShouldBeMergedAndSet == Boolean.FALSE) {
                        target.unsetStopLines();
                    }
                }
            }
            {
                Boolean breakLinesShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetBreakLines(), rightObject.isSetBreakLines());
                if (breakLinesShouldBeMergedAndSet == Boolean.TRUE) {
                    List<LineStringSegmentArrayPropertyType> lhsBreakLines;
                    ...
                    if (breakLinesShouldBeMergedAndSet == Boolean.FALSE) {
                        target.unsetBreakLines();
                    }
                }
            }
            {
                Boolean maxLengthShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMaxLength(), rightObject.isSetMaxLength());
                if (maxLengthShouldBeMergedAndSet == Boolean.TRUE) {
                    LengthType lhsMaxLength;
                    ...
                    if (maxLengthShouldBeMergedAndSet == Boolean.FALSE) {
                        target.maxLength = null;
                    }
                }
            }
            {
                Boolean controlPointShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetControlPoint(), rightObject.isSetControlPoint());
                if (controlPointShouldBeMergedAndSet == Boolean.TRUE) {
                    ControlPoint lhsControlPoint;
                    ...
                    if (controlPointShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    @Override
    public TinType withGid(String value) {
        setGid(value);
        return this;
    }
    ...
    @Override
    public TinType withName(JAXBElement<CodeType> ... values) {
        if (values!= null) {
    ...
    @Override
    public TinType withName(Collection<JAXBElement<CodeType>> values) {
        if (values!= null) {
    ...
    @Override
    public TinType withName(List<JAXBElement<CodeType>> value) {
        setName(value);
        return this;
    }
