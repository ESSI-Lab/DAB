...
public class LocationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof LocationPropertyType) {
            final LocationPropertyType copy = ((LocationPropertyType) draftCopy);
            {
                ...
                if (geometryShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractGeometryType> copyGeometry = ((JAXBElement<? extends AbstractGeometryType> ) strategy.copy(LocatorUtils.property(locator, "geometry", sourceGeometry), sourceGeometry, this.isSetGeometry()));
            ...
            {
                Boolean locationKeyWordShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetLocationKeyWord());
                if (locationKeyWordShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (locationKeyWordShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.locationKeyWord = null;
                    }
                }
            }
            {
                Boolean locationStringShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetLocationString());
                if (locationStringShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (locationStringShouldBeCopiedAndSet == Boolean.FALSE) {
        ...
        if (right instanceof LocationPropertyType) {
            ...
            final LocationPropertyType rightObject = ((LocationPropertyType) right);
            {
                ...
                if (geometryShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractGeometryType> mergedGeometry = ((JAXBElement<? extends AbstractGeometryType> ) strategy.merge(LocatorUtils.property(leftLocator, "geometry", lhsGeometry), LocatorUtils.property(rightLocator, "geometry", rhsGeometry), lhsGeometry, rhsGeometry, leftObject.isSetGeometry(), rightObject.isSetGeometry()));
            ...
            {
                Boolean locationKeyWordShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetLocationKeyWord(), rightObject.isSetLocationKeyWord());
                if (locationKeyWordShouldBeMergedAndSet == Boolean.TRUE) {
                    CodeType lhsLocationKeyWord;
                    ...
                    if (locationKeyWordShouldBeMergedAndSet == Boolean.FALSE) {
                        target.locationKeyWord = null;
                    }
                }
            }
            {
                Boolean locationStringShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetLocationString(), rightObject.isSetLocationString());
                if (locationStringShouldBeMergedAndSet == Boolean.TRUE) {
                    StringOrRefType lhsLocationString;
                    ...
                    if (locationStringShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public LocationPropertyType withGeometry(JAXBElement<? extends AbstractGeometryType> value) {
        setGeometry(value);
        return this;
    }
