...
public class TimeCalendarEraPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimeCalendarEraPropertyType) {
            ...
            {
                Boolean timeCalendarEraShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTimeCalendarEra());
                if (timeCalendarEraShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (timeCalendarEraShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TimeCalendarEraPropertyType) {
            ...
            {
                Boolean timeCalendarEraShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTimeCalendarEra(), rightObject.isSetTimeCalendarEra());
                if (timeCalendarEraShouldBeMergedAndSet == Boolean.TRUE) {
                    TimeCalendarEraType lhsTimeCalendarEra;
                    ...
                    if (timeCalendarEraShouldBeMergedAndSet == Boolean.FALSE) {
