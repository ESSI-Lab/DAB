...
public class TimeCalendarPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimeCalendarPropertyType) {
            ...
            {
                Boolean timeCalendarShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTimeCalendar());
                if (timeCalendarShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (timeCalendarShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TimeCalendarPropertyType) {
            ...
            {
                Boolean timeCalendarShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTimeCalendar(), rightObject.isSetTimeCalendar());
                if (timeCalendarShouldBeMergedAndSet == Boolean.TRUE) {
                    TimeCalendarType lhsTimeCalendar;
                    ...
                    if (timeCalendarShouldBeMergedAndSet == Boolean.FALSE) {
