...
public class EngineeringCRSRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof EngineeringCRSRefType) {
            ...
            {
                Boolean engineeringCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetEngineeringCRS());
                if (engineeringCRSShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (engineeringCRSShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof EngineeringCRSRefType) {
            ...
            {
                Boolean engineeringCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetEngineeringCRS(), rightObject.isSetEngineeringCRS());
                if (engineeringCRSShouldBeMergedAndSet == Boolean.TRUE) {
                    EngineeringCRSType lhsEngineeringCRS;
                    ...
                    if (engineeringCRSShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public EngineeringCRSRefType withEngineeringCRS(EngineeringCRSType value) {
        setEngineeringCRS(value);
        return this;
    }

    public EngineeringCRSRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public EngineeringCRSRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public EngineeringCRSRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public EngineeringCRSRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public EngineeringCRSRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public EngineeringCRSRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public EngineeringCRSRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public EngineeringCRSRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
