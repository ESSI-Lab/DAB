...
public class DatumRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof DatumRefType) {
            final DatumRefType copy = ((DatumRefType) draftCopy);
            {
                ...
                if (datumShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractDatumType> copyDatum = ((JAXBElement<? extends AbstractDatumType> ) strategy.copy(LocatorUtils.property(locator, "datum", sourceDatum), sourceDatum, this.isSetDatum()));
        ...
        if (right instanceof DatumRefType) {
            ...
            final DatumRefType rightObject = ((DatumRefType) right);
            {
                ...
                if (datumShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractDatumType> mergedDatum = ((JAXBElement<? extends AbstractDatumType> ) strategy.merge(LocatorUtils.property(leftLocator, "datum", lhsDatum), LocatorUtils.property(rightLocator, "datum", rhsDatum), lhsDatum, rhsDatum, leftObject.isSetDatum(), rightObject.isSetDatum()));
                    target.setDatum(mergedDatum);
                } else {
    ...
    public DatumRefType withDatum(JAXBElement<? extends AbstractDatumType> value) {
        setDatum(value);
        return this;
    }

    public DatumRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public DatumRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DatumRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public DatumRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public DatumRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DatumRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DatumRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DatumRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
