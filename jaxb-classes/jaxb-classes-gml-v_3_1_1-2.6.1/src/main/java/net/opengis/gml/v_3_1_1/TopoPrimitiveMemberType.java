...
public class TopoPrimitiveMemberType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof TopoPrimitiveMemberType) {
            final TopoPrimitiveMemberType copy = ((TopoPrimitiveMemberType) draftCopy);
            {
                ...
                if (topoPrimitiveShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractTopoPrimitiveType> copyTopoPrimitive = ((JAXBElement<? extends AbstractTopoPrimitiveType> ) strategy.copy(LocatorUtils.property(locator, "topoPrimitive", sourceTopoPrimitive), sourceTopoPrimitive, this.isSetTopoPrimitive()));
        ...
        if (right instanceof TopoPrimitiveMemberType) {
            ...
            final TopoPrimitiveMemberType rightObject = ((TopoPrimitiveMemberType) right);
            {
                ...
                if (topoPrimitiveShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractTopoPrimitiveType> mergedTopoPrimitive = ((JAXBElement<? extends AbstractTopoPrimitiveType> ) strategy.merge(LocatorUtils.property(leftLocator, "topoPrimitive", lhsTopoPrimitive), LocatorUtils.property(rightLocator, "topoPrimitive", rhsTopoPrimitive), lhsTopoPrimitive, rhsTopoPrimitive, leftObject.isSetTopoPrimitive(), rightObject.isSetTopoPrimitive()));
                    target.setTopoPrimitive(mergedTopoPrimitive);
                } else {
                    if (topoPrimitiveShouldBeMergedAndSet == Boolean.FALSE) {
                        target.topoPrimitive = null;
                    }
                }
            }
            {
    ...
    public TopoPrimitiveMemberType withTopoPrimitive(JAXBElement<? extends AbstractTopoPrimitiveType> value) {
