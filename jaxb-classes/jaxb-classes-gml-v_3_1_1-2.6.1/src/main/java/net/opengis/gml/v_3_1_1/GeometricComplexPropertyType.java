...
public class GeometricComplexPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof GeometricComplexPropertyType) {
            ...
            {
                Boolean geometricComplexShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetGeometricComplex());
                if (geometricComplexShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (geometricComplexShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.geometricComplex = null;
                    }
                }
            }
            {
                Boolean compositeCurveShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCompositeCurve());
                if (compositeCurveShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (compositeCurveShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.compositeCurve = null;
                    }
                }
            }
            {
                Boolean compositeSurfaceShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCompositeSurface());
                if (compositeSurfaceShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (compositeSurfaceShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.compositeSurface = null;
                    }
                }
            }
            {
                Boolean compositeSolidShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCompositeSolid());
                if (compositeSolidShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (compositeSolidShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof GeometricComplexPropertyType) {
            ...
            {
                Boolean geometricComplexShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetGeometricComplex(), rightObject.isSetGeometricComplex());
                if (geometricComplexShouldBeMergedAndSet == Boolean.TRUE) {
                    GeometricComplexType lhsGeometricComplex;
                    ...
                    if (geometricComplexShouldBeMergedAndSet == Boolean.FALSE) {
                        target.geometricComplex = null;
                    }
                }
            }
            {
                Boolean compositeCurveShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCompositeCurve(), rightObject.isSetCompositeCurve());
                if (compositeCurveShouldBeMergedAndSet == Boolean.TRUE) {
                    CompositeCurveType lhsCompositeCurve;
                    ...
                    if (compositeCurveShouldBeMergedAndSet == Boolean.FALSE) {
                        target.compositeCurve = null;
                    }
                }
            }
            {
                Boolean compositeSurfaceShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCompositeSurface(), rightObject.isSetCompositeSurface());
                if (compositeSurfaceShouldBeMergedAndSet == Boolean.TRUE) {
                    CompositeSurfaceType lhsCompositeSurface;
                    ...
                    if (compositeSurfaceShouldBeMergedAndSet == Boolean.FALSE) {
                        target.compositeSurface = null;
                    }
                }
            }
            {
                Boolean compositeSolidShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCompositeSolid(), rightObject.isSetCompositeSolid());
                if (compositeSolidShouldBeMergedAndSet == Boolean.TRUE) {
                    CompositeSolidType lhsCompositeSolid;
                    ...
                    if (compositeSolidShouldBeMergedAndSet == Boolean.FALSE) {
