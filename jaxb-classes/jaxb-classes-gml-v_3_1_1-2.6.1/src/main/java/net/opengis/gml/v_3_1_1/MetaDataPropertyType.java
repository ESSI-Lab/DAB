...
public class MetaDataPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof MetaDataPropertyType) {
            final MetaDataPropertyType copy = ((MetaDataPropertyType) draftCopy);
            {
                ...
                if (anyShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    Object copyAny = ((Object) strategy.copy(LocatorUtils.property(locator, "any", sourceAny), sourceAny, this.isSetAny()));
                    copy.setAny(copyAny);
                } else {
        ...
        if (right instanceof MetaDataPropertyType) {
            ...
            final MetaDataPropertyType rightObject = ((MetaDataPropertyType) right);
            {
                ...
                if (anyShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    Object mergedAny = ((Object) strategy.merge(LocatorUtils.property(leftLocator, "any", lhsAny), LocatorUtils.property(rightLocator, "any", rhsAny), lhsAny, rhsAny, leftObject.isSetAny(), rightObject.isSetAny()));
    ...
    public MetaDataPropertyType withAny(Object value) {
        setAny(value);
        return this;
    }
