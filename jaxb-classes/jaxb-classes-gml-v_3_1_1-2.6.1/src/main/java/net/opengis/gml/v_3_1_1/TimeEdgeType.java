    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @Override
    public TimeEdgeType withName(JAXBElement<CodeType> ... values) {
        if (values!= null) {
    ...
    @Override
    public TimeEdgeType withName(Collection<JAXBElement<CodeType>> values) {
        if (values!= null) {
    ...
    @Override
    public TimeEdgeType withName(List<JAXBElement<CodeType>> value) {
        setName(value);
        return this;
    }
