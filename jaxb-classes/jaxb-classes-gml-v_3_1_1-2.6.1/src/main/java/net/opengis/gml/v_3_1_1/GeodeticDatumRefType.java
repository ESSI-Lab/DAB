...
public class GeodeticDatumRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof GeodeticDatumRefType) {
            ...
            {
                Boolean geodeticDatumShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetGeodeticDatum());
                if (geodeticDatumShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (geodeticDatumShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof GeodeticDatumRefType) {
            ...
            {
                Boolean geodeticDatumShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetGeodeticDatum(), rightObject.isSetGeodeticDatum());
                if (geodeticDatumShouldBeMergedAndSet == Boolean.TRUE) {
                    GeodeticDatumType lhsGeodeticDatum;
                    ...
                    if (geodeticDatumShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public GeodeticDatumRefType withGeodeticDatum(GeodeticDatumType value) {
        setGeodeticDatum(value);
        return this;
    }

    public GeodeticDatumRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public GeodeticDatumRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public GeodeticDatumRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public GeodeticDatumRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public GeodeticDatumRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public GeodeticDatumRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public GeodeticDatumRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public GeodeticDatumRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
