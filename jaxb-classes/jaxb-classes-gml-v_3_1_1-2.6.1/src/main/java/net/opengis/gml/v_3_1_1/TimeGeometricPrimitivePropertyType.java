...
public class TimeGeometricPrimitivePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "timeGeometricPrimitive", buffer, theTimeGeometricPrimitive, this.isSetTimeGeometricPrimitive());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TimeGeometricPrimitivePropertyType that = ((TimeGeometricPrimitivePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeGeometricPrimitive", lhsTimeGeometricPrimitive), LocatorUtils.property(thatLocator, "timeGeometricPrimitive", rhsTimeGeometricPrimitive), lhsTimeGeometricPrimitive, rhsTimeGeometricPrimitive, this.isSetTimeGeometricPrimitive(), that.isSetTimeGeometricPrimitive())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractTimeGeometricPrimitiveType> theTimeGeometricPrimitive;
            theTimeGeometricPrimitive = this.getTimeGeometricPrimitive();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeGeometricPrimitive", theTimeGeometricPrimitive), currentHashCode, theTimeGeometricPrimitive, this.isSetTimeGeometricPrimitive());
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimeGeometricPrimitivePropertyType) {
            ...
            {
                Boolean timeGeometricPrimitiveShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTimeGeometricPrimitive());
                if (timeGeometricPrimitiveShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractTimeGeometricPrimitiveType> copyTimeGeometricPrimitive = ((JAXBElement<? extends AbstractTimeGeometricPrimitiveType> ) strategy.copy(LocatorUtils.property(locator, "timeGeometricPrimitive", sourceTimeGeometricPrimitive), sourceTimeGeometricPrimitive, this.isSetTimeGeometricPrimitive()));
                    copy.setTimeGeometricPrimitive(copyTimeGeometricPrimitive);
                } else {
                    if (timeGeometricPrimitiveShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TimeGeometricPrimitivePropertyType) {
            ...
            {
                Boolean timeGeometricPrimitiveShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTimeGeometricPrimitive(), rightObject.isSetTimeGeometricPrimitive());
                if (timeGeometricPrimitiveShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractTimeGeometricPrimitiveType> lhsTimeGeometricPrimitive;
                    ...
                    JAXBElement<? extends AbstractTimeGeometricPrimitiveType> mergedTimeGeometricPrimitive = ((JAXBElement<? extends AbstractTimeGeometricPrimitiveType> ) strategy.merge(LocatorUtils.property(leftLocator, "timeGeometricPrimitive", lhsTimeGeometricPrimitive), LocatorUtils.property(rightLocator, "timeGeometricPrimitive", rhsTimeGeometricPrimitive), lhsTimeGeometricPrimitive, rhsTimeGeometricPrimitive, leftObject.isSetTimeGeometricPrimitive(), rightObject.isSetTimeGeometricPrimitive()));
                    target.setTimeGeometricPrimitive(mergedTimeGeometricPrimitive);
                } else {
                    if (timeGeometricPrimitiveShouldBeMergedAndSet == Boolean.FALSE) {
                        target.timeGeometricPrimitive = null;
                    }
                }
            }
            {
    ...
    public TimeGeometricPrimitivePropertyType withTimeGeometricPrimitive(JAXBElement<? extends AbstractTimeGeometricPrimitiveType> value) {
        setTimeGeometricPrimitive(value);
        return this;
    }

    public TimeGeometricPrimitivePropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public TimeGeometricPrimitivePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public TimeGeometricPrimitivePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public TimeGeometricPrimitivePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public TimeGeometricPrimitivePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public TimeGeometricPrimitivePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public TimeGeometricPrimitivePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public TimeGeometricPrimitivePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
