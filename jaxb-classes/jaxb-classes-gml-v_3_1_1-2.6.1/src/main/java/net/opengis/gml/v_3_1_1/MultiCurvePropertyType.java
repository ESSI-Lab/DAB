...
public class MultiCurvePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MultiCurvePropertyType) {
            ...
            {
                Boolean multiCurveShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMultiCurve());
                if (multiCurveShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (multiCurveShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MultiCurvePropertyType) {
            ...
            {
                Boolean multiCurveShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMultiCurve(), rightObject.isSetMultiCurve());
                if (multiCurveShouldBeMergedAndSet == Boolean.TRUE) {
                    MultiCurveType lhsMultiCurve;
                    ...
                    if (multiCurveShouldBeMergedAndSet == Boolean.FALSE) {
