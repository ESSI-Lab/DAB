...
public class DomainSetType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "timeObject", buffer, theTimeObject, this.isSetTimeObject());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeObject", lhsTimeObject), LocatorUtils.property(thatLocator, "timeObject", rhsTimeObject), lhsTimeObject, rhsTimeObject, this.isSetTimeObject(), that.isSetTimeObject())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            JAXBElement<? extends AbstractTimeObjectType> theTimeObject;
            theTimeObject = this.getTimeObject();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeObject", theTimeObject), currentHashCode, theTimeObject, this.isSetTimeObject());
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DomainSetType) {
            ...
            {
                Boolean timeObjectShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTimeObject());
                if (timeObjectShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractTimeObjectType> sourceTimeObject;
                    sourceTimeObject = this.getTimeObject();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractTimeObjectType> copyTimeObject = ((JAXBElement<? extends AbstractTimeObjectType> ) strategy.copy(LocatorUtils.property(locator, "timeObject", sourceTimeObject), sourceTimeObject, this.isSetTimeObject()));
                    copy.setTimeObject(copyTimeObject);
                } else {
                    if (timeObjectShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DomainSetType) {
            ...
            {
                Boolean timeObjectShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTimeObject(), rightObject.isSetTimeObject());
                if (timeObjectShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractTimeObjectType> lhsTimeObject;
                    lhsTimeObject = leftObject.getTimeObject();
                    JAXBElement<? extends AbstractTimeObjectType> rhsTimeObject;
                    rhsTimeObject = rightObject.getTimeObject();
                    JAXBElement<? extends AbstractTimeObjectType> mergedTimeObject = ((JAXBElement<? extends AbstractTimeObjectType> ) strategy.merge(LocatorUtils.property(leftLocator, "timeObject", lhsTimeObject), LocatorUtils.property(rightLocator, "timeObject", rhsTimeObject), lhsTimeObject, rhsTimeObject, leftObject.isSetTimeObject(), rightObject.isSetTimeObject()));
                    target.setTimeObject(mergedTimeObject);
                } else {
                    if (timeObjectShouldBeMergedAndSet == Boolean.FALSE) {
                        target.timeObject = null;
                    }
                }
            }
            {
    ...
    public DomainSetType withGeometry(JAXBElement<? extends AbstractGeometryType> value) {
        setGeometry(value);
        return this;
    }

    public DomainSetType withTimeObject(JAXBElement<? extends AbstractTimeObjectType> value) {
        setTimeObject(value);
        return this;
    }
