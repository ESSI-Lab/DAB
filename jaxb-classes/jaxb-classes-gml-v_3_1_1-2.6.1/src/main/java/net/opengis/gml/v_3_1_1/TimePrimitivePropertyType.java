...
public class TimePrimitivePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "timePrimitive", buffer, theTimePrimitive, this.isSetTimePrimitive());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TimePrimitivePropertyType that = ((TimePrimitivePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timePrimitive", lhsTimePrimitive), LocatorUtils.property(thatLocator, "timePrimitive", rhsTimePrimitive), lhsTimePrimitive, rhsTimePrimitive, this.isSetTimePrimitive(), that.isSetTimePrimitive())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractTimePrimitiveType> theTimePrimitive;
            theTimePrimitive = this.getTimePrimitive();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timePrimitive", theTimePrimitive), currentHashCode, theTimePrimitive, this.isSetTimePrimitive());
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimePrimitivePropertyType) {
            ...
            {
                Boolean timePrimitiveShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTimePrimitive());
                if (timePrimitiveShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractTimePrimitiveType> sourceTimePrimitive;
                    sourceTimePrimitive = this.getTimePrimitive();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractTimePrimitiveType> copyTimePrimitive = ((JAXBElement<? extends AbstractTimePrimitiveType> ) strategy.copy(LocatorUtils.property(locator, "timePrimitive", sourceTimePrimitive), sourceTimePrimitive, this.isSetTimePrimitive()));
                    copy.setTimePrimitive(copyTimePrimitive);
                } else {
                    if (timePrimitiveShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TimePrimitivePropertyType) {
            ...
            {
                Boolean timePrimitiveShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTimePrimitive(), rightObject.isSetTimePrimitive());
                if (timePrimitiveShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractTimePrimitiveType> lhsTimePrimitive;
                    lhsTimePrimitive = leftObject.getTimePrimitive();
                    JAXBElement<? extends AbstractTimePrimitiveType> rhsTimePrimitive;
                    rhsTimePrimitive = rightObject.getTimePrimitive();
                    JAXBElement<? extends AbstractTimePrimitiveType> mergedTimePrimitive = ((JAXBElement<? extends AbstractTimePrimitiveType> ) strategy.merge(LocatorUtils.property(leftLocator, "timePrimitive", lhsTimePrimitive), LocatorUtils.property(rightLocator, "timePrimitive", rhsTimePrimitive), lhsTimePrimitive, rhsTimePrimitive, leftObject.isSetTimePrimitive(), rightObject.isSetTimePrimitive()));
                    target.setTimePrimitive(mergedTimePrimitive);
                } else {
                    if (timePrimitiveShouldBeMergedAndSet == Boolean.FALSE) {
                        target.timePrimitive = null;
                    }
                }
            }
            {
    ...
    public TimePrimitivePropertyType withTimePrimitive(JAXBElement<? extends AbstractTimePrimitiveType> value) {
