...
public class SurfacePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof SurfacePropertyType) {
            final SurfacePropertyType copy = ((SurfacePropertyType) draftCopy);
            {
                ...
                if (surfaceShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractSurfaceType> copySurface = ((JAXBElement<? extends AbstractSurfaceType> ) strategy.copy(LocatorUtils.property(locator, "surface", sourceSurface), sourceSurface, this.isSetSurface()));
        ...
        if (right instanceof SurfacePropertyType) {
            ...
            final SurfacePropertyType rightObject = ((SurfacePropertyType) right);
            {
                ...
                if (surfaceShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractSurfaceType> mergedSurface = ((JAXBElement<? extends AbstractSurfaceType> ) strategy.merge(LocatorUtils.property(leftLocator, "surface", lhsSurface), LocatorUtils.property(rightLocator, "surface", rhsSurface), lhsSurface, rhsSurface, leftObject.isSetSurface(), rightObject.isSetSurface()));
                    target.setSurface(mergedSurface);
                } else {
    ...
    public SurfacePropertyType withSurface(JAXBElement<? extends AbstractSurfaceType> value) {
        setSurface(value);
        return this;
    }
