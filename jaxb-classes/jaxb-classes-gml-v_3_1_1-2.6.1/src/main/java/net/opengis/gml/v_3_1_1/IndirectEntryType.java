...
public class IndirectEntryType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof IndirectEntryType) {
            ...
            {
                Boolean definitionProxyShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDefinitionProxy());
                if (definitionProxyShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (definitionProxyShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof IndirectEntryType) {
            ...
            {
                Boolean definitionProxyShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDefinitionProxy(), rightObject.isSetDefinitionProxy());
                if (definitionProxyShouldBeMergedAndSet == Boolean.TRUE) {
                    DefinitionProxyType lhsDefinitionProxy;
                    ...
                    if (definitionProxyShouldBeMergedAndSet == Boolean.FALSE) {
