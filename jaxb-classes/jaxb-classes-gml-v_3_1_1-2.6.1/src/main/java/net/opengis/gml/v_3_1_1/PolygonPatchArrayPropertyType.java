    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @Override
    public PolygonPatchArrayPropertyType withSurfacePatch(JAXBElement<? extends AbstractSurfacePatchType> ... values) {
        if (values!= null) {
    ...
    @Override
    public PolygonPatchArrayPropertyType withSurfacePatch(Collection<JAXBElement<? extends AbstractSurfacePatchType>> values) {
        if (values!= null) {
    ...
    @Override
    public PolygonPatchArrayPropertyType withSurfacePatch(List<JAXBElement<? extends AbstractSurfacePatchType>> value) {
