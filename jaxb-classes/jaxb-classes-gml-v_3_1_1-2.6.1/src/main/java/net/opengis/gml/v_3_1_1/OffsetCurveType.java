    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof OffsetCurveType) {
            ...
            {
                Boolean offsetBaseShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetOffsetBase());
                if (offsetBaseShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (offsetBaseShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof OffsetCurveType) {
            ...
            {
                Boolean offsetBaseShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetOffsetBase(), rightObject.isSetOffsetBase());
                if (offsetBaseShouldBeMergedAndSet == Boolean.TRUE) {
                    CurvePropertyType lhsOffsetBase;
                    ...
                    if (offsetBaseShouldBeMergedAndSet == Boolean.FALSE) {
