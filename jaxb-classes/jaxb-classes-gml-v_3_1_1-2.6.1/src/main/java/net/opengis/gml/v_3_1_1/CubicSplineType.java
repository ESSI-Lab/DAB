    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CubicSplineType) {
            ...
            {
                Boolean vectorAtStartShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetVectorAtStart());
                if (vectorAtStartShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (vectorAtStartShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.vectorAtStart = null;
                    }
                }
            }
            {
                Boolean vectorAtEndShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetVectorAtEnd());
                if (vectorAtEndShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (vectorAtEndShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof CubicSplineType) {
            ...
            {
                Boolean vectorAtStartShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetVectorAtStart(), rightObject.isSetVectorAtStart());
                if (vectorAtStartShouldBeMergedAndSet == Boolean.TRUE) {
                    VectorType lhsVectorAtStart;
                    ...
                    if (vectorAtStartShouldBeMergedAndSet == Boolean.FALSE) {
                        target.vectorAtStart = null;
                    }
                }
            }
            {
                Boolean vectorAtEndShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetVectorAtEnd(), rightObject.isSetVectorAtEnd());
                if (vectorAtEndShouldBeMergedAndSet == Boolean.TRUE) {
                    VectorType lhsVectorAtEnd;
                    ...
                    if (vectorAtEndShouldBeMergedAndSet == Boolean.FALSE) {
