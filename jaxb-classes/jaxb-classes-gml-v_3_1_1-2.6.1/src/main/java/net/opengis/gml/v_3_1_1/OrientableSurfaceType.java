    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof OrientableSurfaceType) {
            ...
            {
                Boolean baseSurfaceShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetBaseSurface());
                if (baseSurfaceShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (baseSurfaceShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof OrientableSurfaceType) {
            ...
            {
                Boolean baseSurfaceShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetBaseSurface(), rightObject.isSetBaseSurface());
                if (baseSurfaceShouldBeMergedAndSet == Boolean.TRUE) {
                    SurfacePropertyType lhsBaseSurface;
                    ...
                    if (baseSurfaceShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    @Override
    public OrientableSurfaceType withGid(String value) {
        setGid(value);
        return this;
    }
    ...
    @Override
    public OrientableSurfaceType withName(JAXBElement<CodeType> ... values) {
        if (values!= null) {
    ...
    @Override
    public OrientableSurfaceType withName(Collection<JAXBElement<CodeType>> values) {
        if (values!= null) {
    ...
    @Override
    public OrientableSurfaceType withName(List<JAXBElement<CodeType>> value) {
        setName(value);
        return this;
    }
