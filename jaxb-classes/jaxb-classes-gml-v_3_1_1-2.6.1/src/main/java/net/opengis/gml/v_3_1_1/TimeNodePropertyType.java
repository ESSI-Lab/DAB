...
public class TimeNodePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimeNodePropertyType) {
            ...
            {
                Boolean timeNodeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTimeNode());
                if (timeNodeShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (timeNodeShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.timeNode = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TimeNodePropertyType) {
            ...
            {
                Boolean timeNodeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTimeNode(), rightObject.isSetTimeNode());
                if (timeNodeShouldBeMergedAndSet == Boolean.TRUE) {
                    TimeNodeType lhsTimeNode;
                    ...
                    if (timeNodeShouldBeMergedAndSet == Boolean.FALSE) {
