...
public class GeometricPrimitivePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "geometricPrimitive", buffer, theGeometricPrimitive, this.isSetGeometricPrimitive());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final GeometricPrimitivePropertyType that = ((GeometricPrimitivePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "geometricPrimitive", lhsGeometricPrimitive), LocatorUtils.property(thatLocator, "geometricPrimitive", rhsGeometricPrimitive), lhsGeometricPrimitive, rhsGeometricPrimitive, this.isSetGeometricPrimitive(), that.isSetGeometricPrimitive())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractGeometricPrimitiveType> theGeometricPrimitive;
            theGeometricPrimitive = this.getGeometricPrimitive();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "geometricPrimitive", theGeometricPrimitive), currentHashCode, theGeometricPrimitive, this.isSetGeometricPrimitive());
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof GeometricPrimitivePropertyType) {
            ...
            {
                Boolean geometricPrimitiveShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetGeometricPrimitive());
                if (geometricPrimitiveShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractGeometricPrimitiveType> copyGeometricPrimitive = ((JAXBElement<? extends AbstractGeometricPrimitiveType> ) strategy.copy(LocatorUtils.property(locator, "geometricPrimitive", sourceGeometricPrimitive), sourceGeometricPrimitive, this.isSetGeometricPrimitive()));
                    copy.setGeometricPrimitive(copyGeometricPrimitive);
                } else {
                    if (geometricPrimitiveShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof GeometricPrimitivePropertyType) {
            ...
            {
                Boolean geometricPrimitiveShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetGeometricPrimitive(), rightObject.isSetGeometricPrimitive());
                if (geometricPrimitiveShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractGeometricPrimitiveType> lhsGeometricPrimitive;
                    lhsGeometricPrimitive = leftObject.getGeometricPrimitive();
                    JAXBElement<? extends AbstractGeometricPrimitiveType> rhsGeometricPrimitive;
                    rhsGeometricPrimitive = rightObject.getGeometricPrimitive();
                    JAXBElement<? extends AbstractGeometricPrimitiveType> mergedGeometricPrimitive = ((JAXBElement<? extends AbstractGeometricPrimitiveType> ) strategy.merge(LocatorUtils.property(leftLocator, "geometricPrimitive", lhsGeometricPrimitive), LocatorUtils.property(rightLocator, "geometricPrimitive", rhsGeometricPrimitive), lhsGeometricPrimitive, rhsGeometricPrimitive, leftObject.isSetGeometricPrimitive(), rightObject.isSetGeometricPrimitive()));
                    target.setGeometricPrimitive(mergedGeometricPrimitive);
                } else {
                    if (geometricPrimitiveShouldBeMergedAndSet == Boolean.FALSE) {
                        target.geometricPrimitive = null;
                    }
                }
            }
            {
    ...
    public GeometricPrimitivePropertyType withGeometricPrimitive(JAXBElement<? extends AbstractGeometricPrimitiveType> value) {
        setGeometricPrimitive(value);
        return this;
    }
