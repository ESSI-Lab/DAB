...
public class LineStringPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "lineString", buffer, theLineString, this.isSetLineString());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LineStringPropertyType that = ((LineStringPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "lineString", lhsLineString), LocatorUtils.property(thatLocator, "lineString", rhsLineString), lhsLineString, rhsLineString, this.isSetLineString(), that.isSetLineString())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            LineStringType theLineString;
            theLineString = this.getLineString();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "lineString", theLineString), currentHashCode, theLineString, this.isSetLineString());
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof LineStringPropertyType) {
            ...
            {
                Boolean lineStringShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetLineString());
                if (lineStringShouldBeCopiedAndSet == Boolean.TRUE) {
                    LineStringType sourceLineString;
                    sourceLineString = this.getLineString();
                    LineStringType copyLineString = ((LineStringType) strategy.copy(LocatorUtils.property(locator, "lineString", sourceLineString), sourceLineString, this.isSetLineString()));
                    copy.setLineString(copyLineString);
                } else {
                    if (lineStringShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof LineStringPropertyType) {
            ...
            {
                Boolean lineStringShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetLineString(), rightObject.isSetLineString());
                if (lineStringShouldBeMergedAndSet == Boolean.TRUE) {
                    LineStringType lhsLineString;
                    lhsLineString = leftObject.getLineString();
                    LineStringType rhsLineString;
                    rhsLineString = rightObject.getLineString();
                    LineStringType mergedLineString = ((LineStringType) strategy.merge(LocatorUtils.property(leftLocator, "lineString", lhsLineString), LocatorUtils.property(rightLocator, "lineString", rhsLineString), lhsLineString, rhsLineString, leftObject.isSetLineString(), rightObject.isSetLineString()));
                    target.setLineString(mergedLineString);
                } else {
                    if (lineStringShouldBeMergedAndSet == Boolean.FALSE) {
                        target.lineString = null;
                    }
                }
            }
            {
    ...
    public LineStringPropertyType withLineString(LineStringType value) {
        setLineString(value);
        return this;
    }

    public LineStringPropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public LineStringPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public LineStringPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public LineStringPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public LineStringPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public LineStringPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public LineStringPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public LineStringPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
