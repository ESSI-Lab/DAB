...
public class ImageDatumRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ImageDatumRefType) {
            ...
            {
                Boolean imageDatumShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetImageDatum());
                if (imageDatumShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (imageDatumShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ImageDatumRefType) {
            ...
            {
                Boolean imageDatumShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetImageDatum(), rightObject.isSetImageDatum());
                if (imageDatumShouldBeMergedAndSet == Boolean.TRUE) {
                    ImageDatumType lhsImageDatum;
                    ...
                    if (imageDatumShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public ImageDatumRefType withImageDatum(ImageDatumType value) {
        setImageDatum(value);
        return this;
    }

    public ImageDatumRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public ImageDatumRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public ImageDatumRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public ImageDatumRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public ImageDatumRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public ImageDatumRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public ImageDatumRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ImageDatumRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
