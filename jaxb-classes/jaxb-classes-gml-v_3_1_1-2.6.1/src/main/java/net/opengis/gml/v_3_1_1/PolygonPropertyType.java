...
public class PolygonPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof PolygonPropertyType) {
            final PolygonPropertyType copy = ((PolygonPropertyType) draftCopy);
            {
                ...
                if (polygonShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    PolygonType copyPolygon = ((PolygonType) strategy.copy(LocatorUtils.property(locator, "polygon", sourcePolygon), sourcePolygon, this.isSetPolygon()));
        ...
        if (right instanceof PolygonPropertyType) {
            ...
            final PolygonPropertyType rightObject = ((PolygonPropertyType) right);
            {
                ...
                if (polygonShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    PolygonType mergedPolygon = ((PolygonType) strategy.merge(LocatorUtils.property(leftLocator, "polygon", lhsPolygon), LocatorUtils.property(rightLocator, "polygon", rhsPolygon), lhsPolygon, rhsPolygon, leftObject.isSetPolygon(), rightObject.isSetPolygon()));
                    target.setPolygon(mergedPolygon);
                } else {
    ...
    public PolygonPropertyType withPolygon(PolygonType value) {
        setPolygon(value);
        return this;
    }

    public PolygonPropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public PolygonPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public PolygonPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public PolygonPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public PolygonPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public PolygonPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public PolygonPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public PolygonPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
