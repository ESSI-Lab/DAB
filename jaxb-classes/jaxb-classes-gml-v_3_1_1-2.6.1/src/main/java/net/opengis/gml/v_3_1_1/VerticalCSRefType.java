...
public class VerticalCSRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof VerticalCSRefType) {
            ...
            {
                Boolean verticalCSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetVerticalCS());
                if (verticalCSShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (verticalCSShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof VerticalCSRefType) {
            ...
            {
                Boolean verticalCSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetVerticalCS(), rightObject.isSetVerticalCS());
                if (verticalCSShouldBeMergedAndSet == Boolean.TRUE) {
                    VerticalCSType lhsVerticalCS;
                    ...
                    if (verticalCSShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public VerticalCSRefType withVerticalCS(VerticalCSType value) {
        setVerticalCS(value);
        return this;
    }

    public VerticalCSRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public VerticalCSRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public VerticalCSRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public VerticalCSRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public VerticalCSRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public VerticalCSRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public VerticalCSRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public VerticalCSRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
