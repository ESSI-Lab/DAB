...
public class CompositeSurfacePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public CompositeSurfacePropertyType withCompositeSurface(CompositeSurfaceType value) {
        setCompositeSurface(value);
        return this;
    }

    public CompositeSurfacePropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public CompositeSurfacePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CompositeSurfacePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CompositeSurfacePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CompositeSurfacePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CompositeSurfacePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CompositeSurfacePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CompositeSurfacePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
