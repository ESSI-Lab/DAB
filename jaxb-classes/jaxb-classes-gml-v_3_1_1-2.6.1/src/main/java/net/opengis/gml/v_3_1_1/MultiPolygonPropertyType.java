...
public class MultiPolygonPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "multiPolygon", buffer, theMultiPolygon, this.isSetMultiPolygon());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MultiPolygonPropertyType that = ((MultiPolygonPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "multiPolygon", lhsMultiPolygon), LocatorUtils.property(thatLocator, "multiPolygon", rhsMultiPolygon), lhsMultiPolygon, rhsMultiPolygon, this.isSetMultiPolygon(), that.isSetMultiPolygon())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MultiPolygonType theMultiPolygon;
            theMultiPolygon = this.getMultiPolygon();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "multiPolygon", theMultiPolygon), currentHashCode, theMultiPolygon, this.isSetMultiPolygon());
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MultiPolygonPropertyType) {
            ...
            {
                Boolean multiPolygonShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMultiPolygon());
                if (multiPolygonShouldBeCopiedAndSet == Boolean.TRUE) {
                    MultiPolygonType sourceMultiPolygon;
                    sourceMultiPolygon = this.getMultiPolygon();
                    MultiPolygonType copyMultiPolygon = ((MultiPolygonType) strategy.copy(LocatorUtils.property(locator, "multiPolygon", sourceMultiPolygon), sourceMultiPolygon, this.isSetMultiPolygon()));
                    copy.setMultiPolygon(copyMultiPolygon);
                } else {
                    if (multiPolygonShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MultiPolygonPropertyType) {
            ...
            {
                Boolean multiPolygonShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMultiPolygon(), rightObject.isSetMultiPolygon());
                if (multiPolygonShouldBeMergedAndSet == Boolean.TRUE) {
                    MultiPolygonType lhsMultiPolygon;
                    lhsMultiPolygon = leftObject.getMultiPolygon();
                    MultiPolygonType rhsMultiPolygon;
                    rhsMultiPolygon = rightObject.getMultiPolygon();
                    MultiPolygonType mergedMultiPolygon = ((MultiPolygonType) strategy.merge(LocatorUtils.property(leftLocator, "multiPolygon", lhsMultiPolygon), LocatorUtils.property(rightLocator, "multiPolygon", rhsMultiPolygon), lhsMultiPolygon, rhsMultiPolygon, leftObject.isSetMultiPolygon(), rightObject.isSetMultiPolygon()));
                    target.setMultiPolygon(mergedMultiPolygon);
                } else {
                    if (multiPolygonShouldBeMergedAndSet == Boolean.FALSE) {
                        target.multiPolygon = null;
                    }
                }
            }
            {
    ...
    public MultiPolygonPropertyType withMultiPolygon(MultiPolygonType value) {
        setMultiPolygon(value);
        return this;
    }

    public MultiPolygonPropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public MultiPolygonPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MultiPolygonPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MultiPolygonPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MultiPolygonPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MultiPolygonPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MultiPolygonPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MultiPolygonPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
