    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @Override
    public OperationParameterGroupBaseType withMinimumOccurs(BigInteger value) {
        setMinimumOccurs(value);
        return this;
    }

    @Override
    public OperationParameterGroupBaseType withMetaDataProperty(MetaDataPropertyType... values) {
        if (values!= null) {
    ...
    @Override
    public OperationParameterGroupBaseType withMetaDataProperty(Collection<MetaDataPropertyType> values) {
        if (values!= null) {
    ...
    @Override
    public OperationParameterGroupBaseType withDescription(StringOrRefType value) {
        setDescription(value);
        return this;
    }

    @Override
    public OperationParameterGroupBaseType withName(JAXBElement<CodeType> ... values) {
        if (values!= null) {
    ...
    @Override
    public OperationParameterGroupBaseType withName(Collection<JAXBElement<CodeType>> values) {
        if (values!= null) {
    ...
    @Override
    public OperationParameterGroupBaseType withId(String value) {
        setId(value);
        return this;
    }

    @Override
    public OperationParameterGroupBaseType withMetaDataProperty(List<MetaDataPropertyType> value) {
        setMetaDataProperty(value);
        return this;
    }

    @Override
    public OperationParameterGroupBaseType withName(List<JAXBElement<CodeType>> value) {
        setName(value);
        return this;
    }
