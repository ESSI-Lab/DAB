...
public class GraphStylePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof GraphStylePropertyType) {
            final GraphStylePropertyType copy = ((GraphStylePropertyType) draftCopy);
            {
                ...
                if (graphStyleShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    GraphStyleType copyGraphStyle = ((GraphStyleType) strategy.copy(LocatorUtils.property(locator, "graphStyle", sourceGraphStyle), sourceGraphStyle, this.isSetGraphStyle()));
        ...
        if (right instanceof GraphStylePropertyType) {
            ...
            final GraphStylePropertyType rightObject = ((GraphStylePropertyType) right);
            {
                ...
                if (graphStyleShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    GraphStyleType mergedGraphStyle = ((GraphStyleType) strategy.merge(LocatorUtils.property(leftLocator, "graphStyle", lhsGraphStyle), LocatorUtils.property(rightLocator, "graphStyle", rhsGraphStyle), lhsGraphStyle, rhsGraphStyle, leftObject.isSetGraphStyle(), rightObject.isSetGraphStyle()));
    ...
    public GraphStylePropertyType withGraphStyle(GraphStyleType value) {
        setGraphStyle(value);
        return this;
    }

    public GraphStylePropertyType withAbout(String value) {
        setAbout(value);
        return this;
    }

    public GraphStylePropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public GraphStylePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public GraphStylePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public GraphStylePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public GraphStylePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public GraphStylePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public GraphStylePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public GraphStylePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
