...
public class TopologyStylePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof TopologyStylePropertyType) {
            final TopologyStylePropertyType copy = ((TopologyStylePropertyType) draftCopy);
            {
                ...
                if (topologyStyleShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    TopologyStyleType copyTopologyStyle = ((TopologyStyleType) strategy.copy(LocatorUtils.property(locator, "topologyStyle", sourceTopologyStyle), sourceTopologyStyle, this.isSetTopologyStyle()));
        ...
        if (right instanceof TopologyStylePropertyType) {
            ...
            final TopologyStylePropertyType rightObject = ((TopologyStylePropertyType) right);
            {
                ...
                if (topologyStyleShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    TopologyStyleType mergedTopologyStyle = ((TopologyStyleType) strategy.merge(LocatorUtils.property(leftLocator, "topologyStyle", lhsTopologyStyle), LocatorUtils.property(rightLocator, "topologyStyle", rhsTopologyStyle), lhsTopologyStyle, rhsTopologyStyle, leftObject.isSetTopologyStyle(), rightObject.isSetTopologyStyle()));
                    target.setTopologyStyle(mergedTopologyStyle);
                } else {
                    if (topologyStyleShouldBeMergedAndSet == Boolean.FALSE) {
                        target.topologyStyle = null;
                    }
                }
            }
            {
    ...
    public TopologyStylePropertyType withTopologyStyle(TopologyStyleType value) {
        setTopologyStyle(value);
        return this;
    }

    public TopologyStylePropertyType withAbout(String value) {
        setAbout(value);
        return this;
    }

    public TopologyStylePropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public TopologyStylePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public TopologyStylePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public TopologyStylePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public TopologyStylePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public TopologyStylePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public TopologyStylePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public TopologyStylePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
