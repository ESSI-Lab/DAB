...
public class ConcatenatedOperationRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ConcatenatedOperationRefType) {
            ...
            {
                Boolean concatenatedOperationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetConcatenatedOperation());
                if (concatenatedOperationShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (concatenatedOperationShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ConcatenatedOperationRefType) {
            ...
            {
                Boolean concatenatedOperationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetConcatenatedOperation(), rightObject.isSetConcatenatedOperation());
                if (concatenatedOperationShouldBeMergedAndSet == Boolean.TRUE) {
                    ConcatenatedOperationType lhsConcatenatedOperation;
                    ...
                    if (concatenatedOperationShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public ConcatenatedOperationRefType withConcatenatedOperation(ConcatenatedOperationType value) {
        setConcatenatedOperation(value);
        return this;
    }

    public ConcatenatedOperationRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public ConcatenatedOperationRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public ConcatenatedOperationRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public ConcatenatedOperationRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public ConcatenatedOperationRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public ConcatenatedOperationRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public ConcatenatedOperationRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ConcatenatedOperationRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
