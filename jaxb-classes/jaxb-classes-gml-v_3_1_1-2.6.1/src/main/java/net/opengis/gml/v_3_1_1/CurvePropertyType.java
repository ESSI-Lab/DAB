...
public class CurvePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof CurvePropertyType) {
            final CurvePropertyType copy = ((CurvePropertyType) draftCopy);
            {
                ...
                if (curveShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractCurveType> copyCurve = ((JAXBElement<? extends AbstractCurveType> ) strategy.copy(LocatorUtils.property(locator, "curve", sourceCurve), sourceCurve, this.isSetCurve()));
        ...
        if (right instanceof CurvePropertyType) {
            ...
            final CurvePropertyType rightObject = ((CurvePropertyType) right);
            {
                ...
                if (curveShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractCurveType> mergedCurve = ((JAXBElement<? extends AbstractCurveType> ) strategy.merge(LocatorUtils.property(leftLocator, "curve", lhsCurve), LocatorUtils.property(rightLocator, "curve", rhsCurve), lhsCurve, rhsCurve, leftObject.isSetCurve(), rightObject.isSetCurve()));
                    target.setCurve(mergedCurve);
                } else {
    ...
    public CurvePropertyType withCurve(JAXBElement<? extends AbstractCurveType> value) {
        setCurve(value);
        return this;
    }
