...
public class FileType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof FileType) {
            ...
            {
                Boolean fileStructureShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetFileStructure());
                if (fileStructureShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (fileStructureShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof FileType) {
            ...
            {
                Boolean fileStructureShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetFileStructure(), rightObject.isSetFileStructure());
                if (fileStructureShouldBeMergedAndSet == Boolean.TRUE) {
                    FileValueModelType lhsFileStructure;
                    ...
                    if (fileStructureShouldBeMergedAndSet == Boolean.FALSE) {
