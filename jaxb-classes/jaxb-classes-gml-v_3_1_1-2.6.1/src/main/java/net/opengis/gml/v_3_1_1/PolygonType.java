    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof PolygonType) {
            ...
            {
                Boolean exteriorShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetExterior());
                if (exteriorShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<AbstractRingPropertyType> sourceExterior;
                    sourceExterior = this.getExterior();
                    @SuppressWarnings("unchecked")
                    JAXBElement<AbstractRingPropertyType> copyExterior = ((JAXBElement<AbstractRingPropertyType> ) strategy.copy(LocatorUtils.property(locator, "exterior", sourceExterior), sourceExterior, this.isSetExterior()));
                    copy.setExterior(copyExterior);
                } else {
                    if (exteriorShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.exterior = null;
                    }
                }
            }
            {
                Boolean interiorShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetInterior());
                if (interiorShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<JAXBElement<AbstractRingPropertyType>> sourceInterior;
                    sourceInterior = (this.isSetInterior()?this.getInterior():null);
                    @SuppressWarnings("unchecked")
                    List<JAXBElement<AbstractRingPropertyType>> copyInterior = ((List<JAXBElement<AbstractRingPropertyType>> ) strategy.copy(LocatorUtils.property(locator, "interior", sourceInterior), sourceInterior, this.isSetInterior()));
                    copy.unsetInterior();
                    ...
                    if (interiorShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unsetInterior();
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof PolygonType) {
            ...
            {
                Boolean exteriorShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetExterior(), rightObject.isSetExterior());
                if (exteriorShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<AbstractRingPropertyType> lhsExterior;
                    lhsExterior = leftObject.getExterior();
                    JAXBElement<AbstractRingPropertyType> rhsExterior;
                    rhsExterior = rightObject.getExterior();
                    JAXBElement<AbstractRingPropertyType> mergedExterior = ((JAXBElement<AbstractRingPropertyType> ) strategy.merge(LocatorUtils.property(leftLocator, "exterior", lhsExterior), LocatorUtils.property(rightLocator, "exterior", rhsExterior), lhsExterior, rhsExterior, leftObject.isSetExterior(), rightObject.isSetExterior()));
                    target.setExterior(mergedExterior);
                } else {
                    if (exteriorShouldBeMergedAndSet == Boolean.FALSE) {
                        target.exterior = null;
                    }
                }
            }
            {
                Boolean interiorShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetInterior(), rightObject.isSetInterior());
                if (interiorShouldBeMergedAndSet == Boolean.TRUE) {
                    List<JAXBElement<AbstractRingPropertyType>> lhsInterior;
                    ...
                    List<JAXBElement<AbstractRingPropertyType>> mergedInterior = ((List<JAXBElement<AbstractRingPropertyType>> ) strategy.merge(LocatorUtils.property(leftLocator, "interior", lhsInterior), LocatorUtils.property(rightLocator, "interior", rhsInterior), lhsInterior, rhsInterior, leftObject.isSetInterior(), rightObject.isSetInterior()));
                    ...
                    if (interiorShouldBeMergedAndSet == Boolean.FALSE) {
                        target.unsetInterior();
                    }
                }
            }
    ...
    public PolygonType withExterior(JAXBElement<AbstractRingPropertyType> value) {
        setExterior(value);
        return this;
    }

    public PolygonType withInterior(JAXBElement<AbstractRingPropertyType> ... values) {
        if (values!= null) {
            for (JAXBElement<AbstractRingPropertyType> value: values) {
    ...
    public PolygonType withInterior(Collection<JAXBElement<AbstractRingPropertyType>> values) {
        if (values!= null) {
    ...
    public PolygonType withInterior(List<JAXBElement<AbstractRingPropertyType>> value) {
        setInterior(value);
        return this;
    }

    @Override
    public PolygonType withGid(String value) {
        setGid(value);
        return this;
    }
    ...
    @Override
    public PolygonType withName(JAXBElement<CodeType> ... values) {
        if (values!= null) {
    ...
    @Override
    public PolygonType withName(Collection<JAXBElement<CodeType>> values) {
        if (values!= null) {
    ...
    @Override
    public PolygonType withName(List<JAXBElement<CodeType>> value) {
        setName(value);
        return this;
    }
