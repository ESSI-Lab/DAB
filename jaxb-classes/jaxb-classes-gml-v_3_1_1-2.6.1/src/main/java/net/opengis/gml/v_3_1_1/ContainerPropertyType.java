...
public class ContainerPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ContainerPropertyType) {
            ...
            {
                Boolean faceShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetFace());
                if (faceShouldBeCopiedAndSet == Boolean.TRUE) {
                    FaceType sourceFace;
                    ...
                    if (faceShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.face = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ContainerPropertyType) {
            ...
            {
                Boolean faceShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetFace(), rightObject.isSetFace());
                if (faceShouldBeMergedAndSet == Boolean.TRUE) {
                    FaceType lhsFace;
                    ...
                    if (faceShouldBeMergedAndSet == Boolean.FALSE) {
                        target.face = null;
                    }
                }
            }
