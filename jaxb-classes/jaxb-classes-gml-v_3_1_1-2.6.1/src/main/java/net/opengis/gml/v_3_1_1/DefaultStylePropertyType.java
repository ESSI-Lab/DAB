...
public class DefaultStylePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof DefaultStylePropertyType) {
            final DefaultStylePropertyType copy = ((DefaultStylePropertyType) draftCopy);
            {
                ...
                if (styleShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractStyleType> copyStyle = ((JAXBElement<? extends AbstractStyleType> ) strategy.copy(LocatorUtils.property(locator, "style", sourceStyle), sourceStyle, this.isSetStyle()));
        ...
        if (right instanceof DefaultStylePropertyType) {
            ...
            final DefaultStylePropertyType rightObject = ((DefaultStylePropertyType) right);
            {
                ...
                if (styleShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractStyleType> mergedStyle = ((JAXBElement<? extends AbstractStyleType> ) strategy.merge(LocatorUtils.property(leftLocator, "style", lhsStyle), LocatorUtils.property(rightLocator, "style", rhsStyle), lhsStyle, rhsStyle, leftObject.isSetStyle(), rightObject.isSetStyle()));
    ...
    public DefaultStylePropertyType withStyle(JAXBElement<? extends AbstractStyleType> value) {
        setStyle(value);
        return this;
    }

    public DefaultStylePropertyType withAbout(String value) {
        setAbout(value);
        return this;
    }

    public DefaultStylePropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public DefaultStylePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DefaultStylePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DefaultStylePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DefaultStylePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DefaultStylePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DefaultStylePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DefaultStylePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
