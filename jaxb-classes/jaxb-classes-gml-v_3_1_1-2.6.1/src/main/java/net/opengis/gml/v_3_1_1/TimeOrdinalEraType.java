    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimeOrdinalEraType) {
            ...
            {
                Boolean groupShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetGroup());
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof TimeOrdinalEraType) {
            ...
            {
                Boolean groupShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetGroup(), rightObject.isSetGroup());
                if (groupShouldBeMergedAndSet == Boolean.TRUE) {
                    ReferenceType lhsGroup;
                    ...
                    if (groupShouldBeMergedAndSet == Boolean.FALSE) {
                        target.group = null;
                    }
                }
            }
    ...
    @Override
    public TimeOrdinalEraType withName(JAXBElement<CodeType> ... values) {
        if (values!= null) {
    ...
    @Override
    public TimeOrdinalEraType withName(Collection<JAXBElement<CodeType>> values) {
        if (values!= null) {
    ...
    @Override
    public TimeOrdinalEraType withName(List<JAXBElement<CodeType>> value) {
        setName(value);
        return this;
    }
