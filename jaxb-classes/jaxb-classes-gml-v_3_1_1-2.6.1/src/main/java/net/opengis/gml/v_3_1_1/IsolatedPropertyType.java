...
public class IsolatedPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof IsolatedPropertyType) {
            ...
            {
                Boolean nodeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetNode());
            ...
            {
                Boolean edgeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetEdge());
                if (edgeShouldBeCopiedAndSet == Boolean.TRUE) {
                    EdgeType sourceEdge;
                    ...
                    if (edgeShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.edge = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof IsolatedPropertyType) {
            ...
            {
                Boolean nodeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetNode(), rightObject.isSetNode());
                if (nodeShouldBeMergedAndSet == Boolean.TRUE) {
                    NodeType lhsNode;
                    ...
                    if (nodeShouldBeMergedAndSet == Boolean.FALSE) {
                        target.node = null;
                    }
                }
            }
            {
                Boolean edgeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetEdge(), rightObject.isSetEdge());
                if (edgeShouldBeMergedAndSet == Boolean.TRUE) {
                    EdgeType lhsEdge;
                    ...
                    if (edgeShouldBeMergedAndSet == Boolean.FALSE) {
                        target.edge = null;
                    }
                }
            }
