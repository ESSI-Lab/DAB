...
public class TargetPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof TargetPropertyType) {
            final TargetPropertyType copy = ((TargetPropertyType) draftCopy);
            {
                ...
                if (featureShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    Object copyFeature = ((Object) strategy.copy(LocatorUtils.property(locator, "feature", sourceFeature), sourceFeature, this.isSetFeature()));
        ...
        if (right instanceof TargetPropertyType) {
            ...
            final TargetPropertyType rightObject = ((TargetPropertyType) right);
            {
                ...
                if (featureShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    Object mergedFeature = ((Object) strategy.merge(LocatorUtils.property(leftLocator, "feature", lhsFeature), LocatorUtils.property(rightLocator, "feature", rhsFeature), lhsFeature, rhsFeature, leftObject.isSetFeature(), rightObject.isSetFeature()));
                    target.setFeature(mergedFeature);
                } else {
    ...
    public TargetPropertyType withFeature(Object value) {
        setFeature(value);
        return this;
    }

    public TargetPropertyType withGeometry(JAXBElement<? extends AbstractGeometryType> value) {
        setGeometry(value);
        return this;
    }
