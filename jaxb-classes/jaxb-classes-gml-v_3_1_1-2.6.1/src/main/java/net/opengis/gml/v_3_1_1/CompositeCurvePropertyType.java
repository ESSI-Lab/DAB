...
public class CompositeCurvePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public CompositeCurvePropertyType withCompositeCurve(CompositeCurveType value) {
        setCompositeCurve(value);
        return this;
    }

    public CompositeCurvePropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public CompositeCurvePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CompositeCurvePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CompositeCurvePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CompositeCurvePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CompositeCurvePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CompositeCurvePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CompositeCurvePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
