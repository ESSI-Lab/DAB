...
public class MultiPointPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MultiPointPropertyType) {
            ...
            {
                Boolean multiPointShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMultiPoint());
                if (multiPointShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (multiPointShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MultiPointPropertyType) {
            ...
            {
                Boolean multiPointShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMultiPoint(), rightObject.isSetMultiPoint());
                if (multiPointShouldBeMergedAndSet == Boolean.TRUE) {
                    MultiPointType lhsMultiPoint;
                    ...
                    if (multiPointShouldBeMergedAndSet == Boolean.FALSE) {
