...
public class AbstractGeneralOperationParameterRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof AbstractGeneralOperationParameterRefType) {
            ...
            {
                Boolean generalOperationParameterShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetGeneralOperationParameter());
                if (generalOperationParameterShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractGeneralOperationParameterType> copyGeneralOperationParameter = ((JAXBElement<? extends AbstractGeneralOperationParameterType> ) strategy.copy(LocatorUtils.property(locator, "generalOperationParameter", sourceGeneralOperationParameter), sourceGeneralOperationParameter, this.isSetGeneralOperationParameter()));
                    copy.setGeneralOperationParameter(copyGeneralOperationParameter);
                } else {
                    if (generalOperationParameterShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof AbstractGeneralOperationParameterRefType) {
            ...
            {
                Boolean generalOperationParameterShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetGeneralOperationParameter(), rightObject.isSetGeneralOperationParameter());
                if (generalOperationParameterShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractGeneralOperationParameterType> lhsGeneralOperationParameter;
                    ...
                    JAXBElement<? extends AbstractGeneralOperationParameterType> mergedGeneralOperationParameter = ((JAXBElement<? extends AbstractGeneralOperationParameterType> ) strategy.merge(LocatorUtils.property(leftLocator, "generalOperationParameter", lhsGeneralOperationParameter), LocatorUtils.property(rightLocator, "generalOperationParameter", rhsGeneralOperationParameter), lhsGeneralOperationParameter, rhsGeneralOperationParameter, leftObject.isSetGeneralOperationParameter(), rightObject.isSetGeneralOperationParameter()));
                    target.setGeneralOperationParameter(mergedGeneralOperationParameter);
                } else {
                    if (generalOperationParameterShouldBeMergedAndSet == Boolean.FALSE) {
                        target.generalOperationParameter = null;
                    }
                }
            }
            {
    ...
    public AbstractGeneralOperationParameterRefType withGeneralOperationParameter(JAXBElement<? extends AbstractGeneralOperationParameterType> value) {
        setGeneralOperationParameter(value);
        return this;
    }

    public AbstractGeneralOperationParameterRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public AbstractGeneralOperationParameterRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public AbstractGeneralOperationParameterRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public AbstractGeneralOperationParameterRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public AbstractGeneralOperationParameterRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public AbstractGeneralOperationParameterRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public AbstractGeneralOperationParameterRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public AbstractGeneralOperationParameterRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
