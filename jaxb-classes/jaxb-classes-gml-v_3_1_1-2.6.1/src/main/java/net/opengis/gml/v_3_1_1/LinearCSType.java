    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @Override
    public LinearCSType withCsID(IdentifierType... values) {
        if (values!= null) {
    ...
    @Override
    public LinearCSType withCsID(Collection<IdentifierType> values) {
        if (values!= null) {
    ...
    @Override
    public LinearCSType withRemarks(StringOrRefType value) {
        setRemarks(value);
        return this;
    }

    @Override
    public LinearCSType withUsesAxis(CoordinateSystemAxisRefType... values) {
        if (values!= null) {
    ...
    @Override
    public LinearCSType withUsesAxis(Collection<CoordinateSystemAxisRefType> values) {
        if (values!= null) {
    ...
    @Override
    public LinearCSType withCsID(List<IdentifierType> value) {
        setCsID(value);
        return this;
    }

    @Override
    public LinearCSType withUsesAxis(List<CoordinateSystemAxisRefType> value) {
        setUsesAxis(value);
        return this;
    }
    ...
    @Override
    public LinearCSType withName(JAXBElement<CodeType> ... values) {
        if (values!= null) {
    ...
    @Override
    public LinearCSType withName(Collection<JAXBElement<CodeType>> values) {
        if (values!= null) {
    ...
    @Override
    public LinearCSType withName(List<JAXBElement<CodeType>> value) {
        setName(value);
        return this;
    }
