...
public class MultiSolidPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MultiSolidPropertyType) {
            ...
            {
                Boolean multiSolidShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMultiSolid());
                if (multiSolidShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (multiSolidShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MultiSolidPropertyType) {
            ...
            {
                Boolean multiSolidShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMultiSolid(), rightObject.isSetMultiSolid());
                if (multiSolidShouldBeMergedAndSet == Boolean.TRUE) {
                    MultiSolidType lhsMultiSolid;
                    ...
                    if (multiSolidShouldBeMergedAndSet == Boolean.FALSE) {
