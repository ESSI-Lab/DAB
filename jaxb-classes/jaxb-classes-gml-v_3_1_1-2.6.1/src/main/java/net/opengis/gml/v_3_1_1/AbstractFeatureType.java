    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (target instanceof AbstractFeatureType) {
            ...
            {
                Boolean boundedByShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetBoundedBy());
                if (boundedByShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (boundedByShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.boundedBy = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof AbstractFeatureType) {
            ...
            {
                Boolean boundedByShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetBoundedBy(), rightObject.isSetBoundedBy());
                if (boundedByShouldBeMergedAndSet == Boolean.TRUE) {
                    BoundingShapeType lhsBoundedBy;
                    ...
                    if (boundedByShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    @Override
    public AbstractFeatureType withName(JAXBElement<CodeType> ... values) {
        if (values!= null) {
    ...
    @Override
    public AbstractFeatureType withName(Collection<JAXBElement<CodeType>> values) {
        if (values!= null) {
    ...
    @Override
    public AbstractFeatureType withName(List<JAXBElement<CodeType>> value) {
        setName(value);
        return this;
    }
