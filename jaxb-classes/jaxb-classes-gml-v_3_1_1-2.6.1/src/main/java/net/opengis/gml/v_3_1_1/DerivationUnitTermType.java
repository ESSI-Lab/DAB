    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DerivationUnitTermType) {
            ...
            {
                Boolean exponentShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetExponent());
                if (exponentShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (exponentShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.exponent = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof DerivationUnitTermType) {
            ...
            {
                Boolean exponentShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetExponent(), rightObject.isSetExponent());
                if (exponentShouldBeMergedAndSet == Boolean.TRUE) {
                    BigInteger lhsExponent;
                    ...
                    if (exponentShouldBeMergedAndSet == Boolean.FALSE) {
