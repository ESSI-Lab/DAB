...
public class MeasureOrNullListType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public MeasureOrNullListType withValue(String... values) {
        if (values!= null) {
    ...
    public MeasureOrNullListType withValue(Collection<String> values) {
        if (values!= null) {
    ...
    public MeasureOrNullListType withUom(String value) {
        setUom(value);
        return this;
    }

    public MeasureOrNullListType withValue(List<String> value) {
        setValue(value);
        return this;
    }
