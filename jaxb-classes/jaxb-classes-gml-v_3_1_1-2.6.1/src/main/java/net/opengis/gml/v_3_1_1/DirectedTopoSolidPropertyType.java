...
public class DirectedTopoSolidPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DirectedTopoSolidPropertyType) {
            ...
            {
                Boolean topoSolidShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTopoSolid());
                if (topoSolidShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (topoSolidShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.topoSolid = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DirectedTopoSolidPropertyType) {
            ...
            {
                Boolean topoSolidShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTopoSolid(), rightObject.isSetTopoSolid());
                if (topoSolidShouldBeMergedAndSet == Boolean.TRUE) {
                    TopoSolidType lhsTopoSolid;
                    ...
                    if (topoSolidShouldBeMergedAndSet == Boolean.FALSE) {
