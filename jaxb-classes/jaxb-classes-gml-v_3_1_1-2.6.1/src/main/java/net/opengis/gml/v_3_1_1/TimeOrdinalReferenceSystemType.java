    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @Override
    public TimeOrdinalReferenceSystemType withName(JAXBElement<CodeType> ... values) {
        if (values!= null) {
    ...
    @Override
    public TimeOrdinalReferenceSystemType withName(Collection<JAXBElement<CodeType>> values) {
        if (values!= null) {
    ...
    @Override
    public TimeOrdinalReferenceSystemType withName(List<JAXBElement<CodeType>> value) {
        setName(value);
        return this;
    }
