...
public class MultiGeometryPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "geometricAggregate", buffer, theGeometricAggregate, this.isSetGeometricAggregate());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MultiGeometryPropertyType that = ((MultiGeometryPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "geometricAggregate", lhsGeometricAggregate), LocatorUtils.property(thatLocator, "geometricAggregate", rhsGeometricAggregate), lhsGeometricAggregate, rhsGeometricAggregate, this.isSetGeometricAggregate(), that.isSetGeometricAggregate())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractGeometricAggregateType> theGeometricAggregate;
            theGeometricAggregate = this.getGeometricAggregate();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "geometricAggregate", theGeometricAggregate), currentHashCode, theGeometricAggregate, this.isSetGeometricAggregate());
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MultiGeometryPropertyType) {
            ...
            {
                Boolean geometricAggregateShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetGeometricAggregate());
                if (geometricAggregateShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractGeometricAggregateType> copyGeometricAggregate = ((JAXBElement<? extends AbstractGeometricAggregateType> ) strategy.copy(LocatorUtils.property(locator, "geometricAggregate", sourceGeometricAggregate), sourceGeometricAggregate, this.isSetGeometricAggregate()));
                    copy.setGeometricAggregate(copyGeometricAggregate);
                } else {
                    if (geometricAggregateShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MultiGeometryPropertyType) {
            ...
            {
                Boolean geometricAggregateShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetGeometricAggregate(), rightObject.isSetGeometricAggregate());
                if (geometricAggregateShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractGeometricAggregateType> lhsGeometricAggregate;
                    lhsGeometricAggregate = leftObject.getGeometricAggregate();
                    JAXBElement<? extends AbstractGeometricAggregateType> rhsGeometricAggregate;
                    rhsGeometricAggregate = rightObject.getGeometricAggregate();
                    JAXBElement<? extends AbstractGeometricAggregateType> mergedGeometricAggregate = ((JAXBElement<? extends AbstractGeometricAggregateType> ) strategy.merge(LocatorUtils.property(leftLocator, "geometricAggregate", lhsGeometricAggregate), LocatorUtils.property(rightLocator, "geometricAggregate", rhsGeometricAggregate), lhsGeometricAggregate, rhsGeometricAggregate, leftObject.isSetGeometricAggregate(), rightObject.isSetGeometricAggregate()));
                    target.setGeometricAggregate(mergedGeometricAggregate);
                } else {
                    if (geometricAggregateShouldBeMergedAndSet == Boolean.FALSE) {
                        target.geometricAggregate = null;
                    }
                }
            }
            {
    ...
    public MultiGeometryPropertyType withGeometricAggregate(JAXBElement<? extends AbstractGeometricAggregateType> value) {
        setGeometricAggregate(value);
        return this;
    }
