...
public class TimeClockPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimeClockPropertyType) {
            ...
            {
                Boolean timeClockShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTimeClock());
                if (timeClockShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (timeClockShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.timeClock = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TimeClockPropertyType) {
            ...
            {
                Boolean timeClockShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTimeClock(), rightObject.isSetTimeClock());
                if (timeClockShouldBeMergedAndSet == Boolean.TRUE) {
                    TimeClockType lhsTimeClock;
                    ...
                    if (timeClockShouldBeMergedAndSet == Boolean.FALSE) {
