...
public class PassThroughOperationRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof PassThroughOperationRefType) {
            ...
            {
                Boolean passThroughOperationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetPassThroughOperation());
                if (passThroughOperationShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (passThroughOperationShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof PassThroughOperationRefType) {
            ...
            {
                Boolean passThroughOperationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetPassThroughOperation(), rightObject.isSetPassThroughOperation());
                if (passThroughOperationShouldBeMergedAndSet == Boolean.TRUE) {
                    PassThroughOperationType lhsPassThroughOperation;
                    ...
                    if (passThroughOperationShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public PassThroughOperationRefType withPassThroughOperation(PassThroughOperationType value) {
        setPassThroughOperation(value);
        return this;
    }

    public PassThroughOperationRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public PassThroughOperationRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public PassThroughOperationRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public PassThroughOperationRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public PassThroughOperationRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public PassThroughOperationRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public PassThroughOperationRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public PassThroughOperationRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
