...
public class ProjectedCRSRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ProjectedCRSRefType) {
            ...
            {
                Boolean projectedCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetProjectedCRS());
                if (projectedCRSShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (projectedCRSShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ProjectedCRSRefType) {
            ...
            {
                Boolean projectedCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetProjectedCRS(), rightObject.isSetProjectedCRS());
                if (projectedCRSShouldBeMergedAndSet == Boolean.TRUE) {
                    ProjectedCRSType lhsProjectedCRS;
                    ...
                    if (projectedCRSShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public ProjectedCRSRefType withProjectedCRS(ProjectedCRSType value) {
        setProjectedCRS(value);
        return this;
    }

    public ProjectedCRSRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public ProjectedCRSRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public ProjectedCRSRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public ProjectedCRSRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public ProjectedCRSRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public ProjectedCRSRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public ProjectedCRSRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ProjectedCRSRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
