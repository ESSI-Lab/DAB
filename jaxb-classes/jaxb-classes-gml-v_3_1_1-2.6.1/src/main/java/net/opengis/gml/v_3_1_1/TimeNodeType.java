    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimeNodeType) {
            ...
            {
                Boolean previousEdgeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetPreviousEdge());
                if (previousEdgeShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (previousEdgeShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unsetPreviousEdge();
                    }
                }
            }
            {
                Boolean nextEdgeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetNextEdge());
                if (nextEdgeShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (nextEdgeShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unsetNextEdge();
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof TimeNodeType) {
            ...
            {
                Boolean previousEdgeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetPreviousEdge(), rightObject.isSetPreviousEdge());
                if (previousEdgeShouldBeMergedAndSet == Boolean.TRUE) {
                    List<TimeEdgePropertyType> lhsPreviousEdge;
                    ...
                    if (previousEdgeShouldBeMergedAndSet == Boolean.FALSE) {
                        target.unsetPreviousEdge();
                    }
                }
            }
            {
                Boolean nextEdgeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetNextEdge(), rightObject.isSetNextEdge());
                if (nextEdgeShouldBeMergedAndSet == Boolean.TRUE) {
                    List<TimeEdgePropertyType> lhsNextEdge;
                    ...
                    if (nextEdgeShouldBeMergedAndSet == Boolean.FALSE) {
                        target.unsetNextEdge();
                    }
                }
            }
    ...
    @Override
    public TimeNodeType withName(JAXBElement<CodeType> ... values) {
        if (values!= null) {
    ...
    @Override
    public TimeNodeType withName(Collection<JAXBElement<CodeType>> values) {
        if (values!= null) {
    ...
    @Override
    public TimeNodeType withName(List<JAXBElement<CodeType>> value) {
        setName(value);
        return this;
    }
