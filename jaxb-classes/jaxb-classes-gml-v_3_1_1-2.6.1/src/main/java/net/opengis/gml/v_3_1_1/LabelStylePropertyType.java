...
public class LabelStylePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof LabelStylePropertyType) {
            final LabelStylePropertyType copy = ((LabelStylePropertyType) draftCopy);
            {
                ...
                if (labelStyleShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    LabelStyleType copyLabelStyle = ((LabelStyleType) strategy.copy(LocatorUtils.property(locator, "labelStyle", sourceLabelStyle), sourceLabelStyle, this.isSetLabelStyle()));
        ...
        if (right instanceof LabelStylePropertyType) {
            ...
            final LabelStylePropertyType rightObject = ((LabelStylePropertyType) right);
            {
                ...
                if (labelStyleShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    LabelStyleType mergedLabelStyle = ((LabelStyleType) strategy.merge(LocatorUtils.property(leftLocator, "labelStyle", lhsLabelStyle), LocatorUtils.property(rightLocator, "labelStyle", rhsLabelStyle), lhsLabelStyle, rhsLabelStyle, leftObject.isSetLabelStyle(), rightObject.isSetLabelStyle()));
    ...
    public LabelStylePropertyType withLabelStyle(LabelStyleType value) {
        setLabelStyle(value);
        return this;
    }

    public LabelStylePropertyType withAbout(String value) {
        setAbout(value);
        return this;
    }

    public LabelStylePropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public LabelStylePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public LabelStylePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public LabelStylePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public LabelStylePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public LabelStylePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public LabelStylePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public LabelStylePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
