...
public class DerivedCRSRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DerivedCRSRefType) {
            ...
            {
                Boolean derivedCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDerivedCRS());
                if (derivedCRSShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (derivedCRSShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DerivedCRSRefType) {
            ...
            {
                Boolean derivedCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDerivedCRS(), rightObject.isSetDerivedCRS());
                if (derivedCRSShouldBeMergedAndSet == Boolean.TRUE) {
                    DerivedCRSType lhsDerivedCRS;
                    ...
                    if (derivedCRSShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public DerivedCRSRefType withDerivedCRS(DerivedCRSType value) {
        setDerivedCRS(value);
        return this;
    }

    public DerivedCRSRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public DerivedCRSRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DerivedCRSRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public DerivedCRSRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public DerivedCRSRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DerivedCRSRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DerivedCRSRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DerivedCRSRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
