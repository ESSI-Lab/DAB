...
public class SolidPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof SolidPropertyType) {
            final SolidPropertyType copy = ((SolidPropertyType) draftCopy);
            {
                ...
                if (solidShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractSolidType> copySolid = ((JAXBElement<? extends AbstractSolidType> ) strategy.copy(LocatorUtils.property(locator, "solid", sourceSolid), sourceSolid, this.isSetSolid()));
        ...
        if (right instanceof SolidPropertyType) {
            ...
            final SolidPropertyType rightObject = ((SolidPropertyType) right);
            {
                ...
                if (solidShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractSolidType> mergedSolid = ((JAXBElement<? extends AbstractSolidType> ) strategy.merge(LocatorUtils.property(leftLocator, "solid", lhsSolid), LocatorUtils.property(rightLocator, "solid", rhsSolid), lhsSolid, rhsSolid, leftObject.isSetSolid(), rightObject.isSetSolid()));
                    target.setSolid(mergedSolid);
                } else {
    ...
    public SolidPropertyType withSolid(JAXBElement<? extends AbstractSolidType> value) {
        setSolid(value);
        return this;
    }
