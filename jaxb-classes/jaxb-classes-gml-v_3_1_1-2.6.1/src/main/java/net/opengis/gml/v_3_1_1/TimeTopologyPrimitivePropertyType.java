...
public class TimeTopologyPrimitivePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "timeTopologyPrimitive", buffer, theTimeTopologyPrimitive, this.isSetTimeTopologyPrimitive());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final TimeTopologyPrimitivePropertyType that = ((TimeTopologyPrimitivePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeTopologyPrimitive", lhsTimeTopologyPrimitive), LocatorUtils.property(thatLocator, "timeTopologyPrimitive", rhsTimeTopologyPrimitive), lhsTimeTopologyPrimitive, rhsTimeTopologyPrimitive, this.isSetTimeTopologyPrimitive(), that.isSetTimeTopologyPrimitive())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractTimeTopologyPrimitiveType> theTimeTopologyPrimitive;
            theTimeTopologyPrimitive = this.getTimeTopologyPrimitive();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeTopologyPrimitive", theTimeTopologyPrimitive), currentHashCode, theTimeTopologyPrimitive, this.isSetTimeTopologyPrimitive());
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimeTopologyPrimitivePropertyType) {
            ...
            {
                Boolean timeTopologyPrimitiveShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTimeTopologyPrimitive());
                if (timeTopologyPrimitiveShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractTimeTopologyPrimitiveType> copyTimeTopologyPrimitive = ((JAXBElement<? extends AbstractTimeTopologyPrimitiveType> ) strategy.copy(LocatorUtils.property(locator, "timeTopologyPrimitive", sourceTimeTopologyPrimitive), sourceTimeTopologyPrimitive, this.isSetTimeTopologyPrimitive()));
                    copy.setTimeTopologyPrimitive(copyTimeTopologyPrimitive);
                } else {
                    if (timeTopologyPrimitiveShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TimeTopologyPrimitivePropertyType) {
            ...
            {
                Boolean timeTopologyPrimitiveShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTimeTopologyPrimitive(), rightObject.isSetTimeTopologyPrimitive());
                if (timeTopologyPrimitiveShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractTimeTopologyPrimitiveType> lhsTimeTopologyPrimitive;
                    ...
                    JAXBElement<? extends AbstractTimeTopologyPrimitiveType> mergedTimeTopologyPrimitive = ((JAXBElement<? extends AbstractTimeTopologyPrimitiveType> ) strategy.merge(LocatorUtils.property(leftLocator, "timeTopologyPrimitive", lhsTimeTopologyPrimitive), LocatorUtils.property(rightLocator, "timeTopologyPrimitive", rhsTimeTopologyPrimitive), lhsTimeTopologyPrimitive, rhsTimeTopologyPrimitive, leftObject.isSetTimeTopologyPrimitive(), rightObject.isSetTimeTopologyPrimitive()));
                    target.setTimeTopologyPrimitive(mergedTimeTopologyPrimitive);
                } else {
                    if (timeTopologyPrimitiveShouldBeMergedAndSet == Boolean.FALSE) {
                        target.timeTopologyPrimitive = null;
                    }
                }
            }
            {
    ...
    public TimeTopologyPrimitivePropertyType withTimeTopologyPrimitive(JAXBElement<? extends AbstractTimeTopologyPrimitiveType> value) {
        setTimeTopologyPrimitive(value);
        return this;
    }
