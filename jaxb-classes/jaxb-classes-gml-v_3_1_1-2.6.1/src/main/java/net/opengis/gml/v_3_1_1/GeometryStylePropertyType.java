...
public class GeometryStylePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof GeometryStylePropertyType) {
            final GeometryStylePropertyType copy = ((GeometryStylePropertyType) draftCopy);
            {
                ...
                if (geometryStyleShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    GeometryStyleType copyGeometryStyle = ((GeometryStyleType) strategy.copy(LocatorUtils.property(locator, "geometryStyle", sourceGeometryStyle), sourceGeometryStyle, this.isSetGeometryStyle()));
        ...
        if (right instanceof GeometryStylePropertyType) {
            ...
            final GeometryStylePropertyType rightObject = ((GeometryStylePropertyType) right);
            {
                ...
                if (geometryStyleShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    GeometryStyleType mergedGeometryStyle = ((GeometryStyleType) strategy.merge(LocatorUtils.property(leftLocator, "geometryStyle", lhsGeometryStyle), LocatorUtils.property(rightLocator, "geometryStyle", rhsGeometryStyle), lhsGeometryStyle, rhsGeometryStyle, leftObject.isSetGeometryStyle(), rightObject.isSetGeometryStyle()));
                    target.setGeometryStyle(mergedGeometryStyle);
                } else {
                    if (geometryStyleShouldBeMergedAndSet == Boolean.FALSE) {
                        target.geometryStyle = null;
                    }
                }
            }
            {
    ...
    public GeometryStylePropertyType withGeometryStyle(GeometryStyleType value) {
        setGeometryStyle(value);
        return this;
    }

    public GeometryStylePropertyType withAbout(String value) {
        setAbout(value);
        return this;
    }

    public GeometryStylePropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public GeometryStylePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public GeometryStylePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public GeometryStylePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public GeometryStylePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public GeometryStylePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public GeometryStylePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public GeometryStylePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
