...
public class OperationRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof OperationRefType) {
            final OperationRefType copy = ((OperationRefType) draftCopy);
            {
                ...
                if (operationShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractCoordinateOperationType> copyOperation = ((JAXBElement<? extends AbstractCoordinateOperationType> ) strategy.copy(LocatorUtils.property(locator, "operation", sourceOperation), sourceOperation, this.isSetOperation()));
        ...
        if (right instanceof OperationRefType) {
            ...
            final OperationRefType rightObject = ((OperationRefType) right);
            {
                ...
                if (operationShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractCoordinateOperationType> mergedOperation = ((JAXBElement<? extends AbstractCoordinateOperationType> ) strategy.merge(LocatorUtils.property(leftLocator, "operation", lhsOperation), LocatorUtils.property(rightLocator, "operation", rhsOperation), lhsOperation, rhsOperation, leftObject.isSetOperation(), rightObject.isSetOperation()));
    ...
    public OperationRefType withOperation(JAXBElement<? extends AbstractCoordinateOperationType> value) {
        setOperation(value);
        return this;
    }

    public OperationRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public OperationRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public OperationRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public OperationRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public OperationRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public OperationRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public OperationRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public OperationRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
