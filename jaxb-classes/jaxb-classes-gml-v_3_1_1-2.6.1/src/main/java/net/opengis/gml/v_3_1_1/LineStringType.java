    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @Override
    public LineStringType withGid(String value) {
        setGid(value);
        return this;
    }
    ...
    @Override
    public LineStringType withName(JAXBElement<CodeType> ... values) {
        if (values!= null) {
    ...
    @Override
    public LineStringType withName(Collection<JAXBElement<CodeType>> values) {
        if (values!= null) {
    ...
    @Override
    public LineStringType withName(List<JAXBElement<CodeType>> value) {
        setName(value);
        return this;
    }
