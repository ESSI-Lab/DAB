    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @Override
    public TrackType withTimeSlice(JAXBElement<? extends AbstractTimeSliceType> ... values) {
        if (values!= null) {
    ...
    @Override
    public TrackType withTimeSlice(Collection<JAXBElement<? extends AbstractTimeSliceType>> values) {
        if (values!= null) {
    ...
    @Override
    public TrackType withTimeSlice(List<JAXBElement<? extends AbstractTimeSliceType>> value) {
        setTimeSlice(value);
        return this;
    }
