...
public class ReferenceSystemRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "referenceSystem", buffer, theReferenceSystem, this.isSetReferenceSystem());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ReferenceSystemRefType that = ((ReferenceSystemRefType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "referenceSystem", lhsReferenceSystem), LocatorUtils.property(thatLocator, "referenceSystem", rhsReferenceSystem), lhsReferenceSystem, rhsReferenceSystem, this.isSetReferenceSystem(), that.isSetReferenceSystem())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractReferenceSystemType> theReferenceSystem;
            theReferenceSystem = this.getReferenceSystem();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "referenceSystem", theReferenceSystem), currentHashCode, theReferenceSystem, this.isSetReferenceSystem());
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ReferenceSystemRefType) {
            ...
            {
                Boolean referenceSystemShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetReferenceSystem());
                if (referenceSystemShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractReferenceSystemType> sourceReferenceSystem;
                    sourceReferenceSystem = this.getReferenceSystem();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractReferenceSystemType> copyReferenceSystem = ((JAXBElement<? extends AbstractReferenceSystemType> ) strategy.copy(LocatorUtils.property(locator, "referenceSystem", sourceReferenceSystem), sourceReferenceSystem, this.isSetReferenceSystem()));
                    copy.setReferenceSystem(copyReferenceSystem);
                } else {
                    if (referenceSystemShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ReferenceSystemRefType) {
            ...
            {
                Boolean referenceSystemShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetReferenceSystem(), rightObject.isSetReferenceSystem());
                if (referenceSystemShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractReferenceSystemType> lhsReferenceSystem;
                    lhsReferenceSystem = leftObject.getReferenceSystem();
                    JAXBElement<? extends AbstractReferenceSystemType> rhsReferenceSystem;
                    rhsReferenceSystem = rightObject.getReferenceSystem();
                    JAXBElement<? extends AbstractReferenceSystemType> mergedReferenceSystem = ((JAXBElement<? extends AbstractReferenceSystemType> ) strategy.merge(LocatorUtils.property(leftLocator, "referenceSystem", lhsReferenceSystem), LocatorUtils.property(rightLocator, "referenceSystem", rhsReferenceSystem), lhsReferenceSystem, rhsReferenceSystem, leftObject.isSetReferenceSystem(), rightObject.isSetReferenceSystem()));
                    target.setReferenceSystem(mergedReferenceSystem);
                } else {
                    if (referenceSystemShouldBeMergedAndSet == Boolean.FALSE) {
                        target.referenceSystem = null;
                    }
                }
            }
            {
    ...
    public ReferenceSystemRefType withReferenceSystem(JAXBElement<? extends AbstractReferenceSystemType> value) {
        setReferenceSystem(value);
        return this;
    }

    public ReferenceSystemRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public ReferenceSystemRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public ReferenceSystemRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public ReferenceSystemRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public ReferenceSystemRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public ReferenceSystemRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public ReferenceSystemRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ReferenceSystemRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
