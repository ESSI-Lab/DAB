    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @Override
    public AbstractGeometricAggregateType withGid(String value) {
        setGid(value);
        return this;
    }
    ...
    @Override
    public AbstractGeometricAggregateType withName(JAXBElement<CodeType> ... values) {
        if (values!= null) {
    ...
    @Override
    public AbstractGeometricAggregateType withName(Collection<JAXBElement<CodeType>> values) {
        if (values!= null) {
    ...
    @Override
    public AbstractGeometricAggregateType withName(List<JAXBElement<CodeType>> value) {
        setName(value);
        return this;
    }
