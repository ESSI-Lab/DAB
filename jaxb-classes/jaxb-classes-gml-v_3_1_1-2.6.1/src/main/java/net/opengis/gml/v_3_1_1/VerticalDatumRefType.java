...
public class VerticalDatumRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public VerticalDatumRefType withVerticalDatum(VerticalDatumType value) {
        setVerticalDatum(value);
        return this;
    }

    public VerticalDatumRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public VerticalDatumRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public VerticalDatumRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public VerticalDatumRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public VerticalDatumRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public VerticalDatumRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public VerticalDatumRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public VerticalDatumRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
