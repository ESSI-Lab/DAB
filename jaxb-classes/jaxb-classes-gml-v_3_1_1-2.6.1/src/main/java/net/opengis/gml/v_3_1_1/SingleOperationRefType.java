...
public class SingleOperationRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "singleOperation", buffer, theSingleOperation, this.isSetSingleOperation());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SingleOperationRefType that = ((SingleOperationRefType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "singleOperation", lhsSingleOperation), LocatorUtils.property(thatLocator, "singleOperation", rhsSingleOperation), lhsSingleOperation, rhsSingleOperation, this.isSetSingleOperation(), that.isSetSingleOperation())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractCoordinateOperationType> theSingleOperation;
            theSingleOperation = this.getSingleOperation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "singleOperation", theSingleOperation), currentHashCode, theSingleOperation, this.isSetSingleOperation());
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SingleOperationRefType) {
            ...
            {
                Boolean singleOperationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSingleOperation());
                if (singleOperationShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractCoordinateOperationType> copySingleOperation = ((JAXBElement<? extends AbstractCoordinateOperationType> ) strategy.copy(LocatorUtils.property(locator, "singleOperation", sourceSingleOperation), sourceSingleOperation, this.isSetSingleOperation()));
                    copy.setSingleOperation(copySingleOperation);
                } else {
                    if (singleOperationShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SingleOperationRefType) {
            ...
            {
                Boolean singleOperationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSingleOperation(), rightObject.isSetSingleOperation());
                if (singleOperationShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractCoordinateOperationType> lhsSingleOperation;
                    lhsSingleOperation = leftObject.getSingleOperation();
                    JAXBElement<? extends AbstractCoordinateOperationType> rhsSingleOperation;
                    rhsSingleOperation = rightObject.getSingleOperation();
                    JAXBElement<? extends AbstractCoordinateOperationType> mergedSingleOperation = ((JAXBElement<? extends AbstractCoordinateOperationType> ) strategy.merge(LocatorUtils.property(leftLocator, "singleOperation", lhsSingleOperation), LocatorUtils.property(rightLocator, "singleOperation", rhsSingleOperation), lhsSingleOperation, rhsSingleOperation, leftObject.isSetSingleOperation(), rightObject.isSetSingleOperation()));
                    target.setSingleOperation(mergedSingleOperation);
                } else {
                    if (singleOperationShouldBeMergedAndSet == Boolean.FALSE) {
                        target.singleOperation = null;
                    }
                }
            }
            {
    ...
    public SingleOperationRefType withSingleOperation(JAXBElement<? extends AbstractCoordinateOperationType> value) {
        setSingleOperation(value);
        return this;
    }

    public SingleOperationRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public SingleOperationRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SingleOperationRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public SingleOperationRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public SingleOperationRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SingleOperationRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SingleOperationRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SingleOperationRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
