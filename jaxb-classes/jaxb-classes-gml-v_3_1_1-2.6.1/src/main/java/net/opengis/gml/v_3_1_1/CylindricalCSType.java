    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @Override
    public CylindricalCSType withCsID(IdentifierType... values) {
        if (values!= null) {
    ...
    @Override
    public CylindricalCSType withCsID(Collection<IdentifierType> values) {
        if (values!= null) {
    ...
    @Override
    public CylindricalCSType withRemarks(StringOrRefType value) {
        setRemarks(value);
        return this;
    }

    @Override
    public CylindricalCSType withUsesAxis(CoordinateSystemAxisRefType... values) {
        if (values!= null) {
    ...
    @Override
    public CylindricalCSType withUsesAxis(Collection<CoordinateSystemAxisRefType> values) {
        if (values!= null) {
    ...
    @Override
    public CylindricalCSType withCsID(List<IdentifierType> value) {
        setCsID(value);
        return this;
    }

    @Override
    public CylindricalCSType withUsesAxis(List<CoordinateSystemAxisRefType> value) {
        setUsesAxis(value);
        return this;
    }
    ...
    @Override
    public CylindricalCSType withName(JAXBElement<CodeType> ... values) {
        if (values!= null) {
    ...
    @Override
    public CylindricalCSType withName(Collection<JAXBElement<CodeType>> values) {
        if (values!= null) {
    ...
    @Override
    public CylindricalCSType withName(List<JAXBElement<CodeType>> value) {
        setName(value);
        return this;
    }
