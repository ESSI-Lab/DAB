...
public class TransformationRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TransformationRefType) {
            ...
            {
                Boolean transformationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTransformation());
                if (transformationShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (transformationShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TransformationRefType) {
            ...
            {
                Boolean transformationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTransformation(), rightObject.isSetTransformation());
                if (transformationShouldBeMergedAndSet == Boolean.TRUE) {
                    TransformationType lhsTransformation;
                    ...
                    if (transformationShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public TransformationRefType withTransformation(TransformationType value) {
        setTransformation(value);
        return this;
    }

    public TransformationRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public TransformationRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public TransformationRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public TransformationRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public TransformationRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public TransformationRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public TransformationRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public TransformationRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
