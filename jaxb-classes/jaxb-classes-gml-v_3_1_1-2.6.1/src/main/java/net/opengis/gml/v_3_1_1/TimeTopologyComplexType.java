    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimeTopologyComplexType) {
            ...
            {
                Boolean primitiveShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetPrimitive());
                if (primitiveShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (primitiveShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unsetPrimitive();
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof TimeTopologyComplexType) {
            ...
            {
                Boolean primitiveShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetPrimitive(), rightObject.isSetPrimitive());
                if (primitiveShouldBeMergedAndSet == Boolean.TRUE) {
                    List<TimeTopologyPrimitivePropertyType> lhsPrimitive;
                    ...
                    if (primitiveShouldBeMergedAndSet == Boolean.FALSE) {
                        target.unsetPrimitive();
                    }
                }
            }
    ...
    @Override
    public TimeTopologyComplexType withName(JAXBElement<CodeType> ... values) {
        if (values!= null) {
    ...
    @Override
    public TimeTopologyComplexType withName(Collection<JAXBElement<CodeType>> values) {
        if (values!= null) {
    ...
    @Override
    public TimeTopologyComplexType withName(List<JAXBElement<CodeType>> value) {
        setName(value);
        return this;
    }
