...
public class TopoComplexMemberType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TopoComplexMemberType) {
            ...
            {
                Boolean topoComplexShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTopoComplex());
                if (topoComplexShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (topoComplexShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TopoComplexMemberType) {
            ...
            {
                Boolean topoComplexShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTopoComplex(), rightObject.isSetTopoComplex());
                if (topoComplexShouldBeMergedAndSet == Boolean.TRUE) {
                    TopoComplexType lhsTopoComplex;
                    ...
                    if (topoComplexShouldBeMergedAndSet == Boolean.FALSE) {
