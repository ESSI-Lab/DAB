...
public class GeocentricCRSRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof GeocentricCRSRefType) {
            ...
            {
                Boolean geocentricCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetGeocentricCRS());
                if (geocentricCRSShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (geocentricCRSShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof GeocentricCRSRefType) {
            ...
            {
                Boolean geocentricCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetGeocentricCRS(), rightObject.isSetGeocentricCRS());
                if (geocentricCRSShouldBeMergedAndSet == Boolean.TRUE) {
                    GeocentricCRSType lhsGeocentricCRS;
                    ...
                    if (geocentricCRSShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public GeocentricCRSRefType withGeocentricCRS(GeocentricCRSType value) {
        setGeocentricCRS(value);
        return this;
    }

    public GeocentricCRSRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public GeocentricCRSRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public GeocentricCRSRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public GeocentricCRSRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public GeocentricCRSRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public GeocentricCRSRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public GeocentricCRSRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public GeocentricCRSRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
