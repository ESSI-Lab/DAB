...
public class TimeEdgePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimeEdgePropertyType) {
            ...
            {
                Boolean timeEdgeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTimeEdge());
                if (timeEdgeShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (timeEdgeShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.timeEdge = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TimeEdgePropertyType) {
            ...
            {
                Boolean timeEdgeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTimeEdge(), rightObject.isSetTimeEdge());
                if (timeEdgeShouldBeMergedAndSet == Boolean.TRUE) {
                    TimeEdgeType lhsTimeEdge;
                    ...
                    if (timeEdgeShouldBeMergedAndSet == Boolean.FALSE) {
