...
public class MultiSurfacePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MultiSurfacePropertyType) {
            ...
            {
                Boolean multiSurfaceShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMultiSurface());
                if (multiSurfaceShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (multiSurfaceShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MultiSurfacePropertyType) {
            ...
            {
                Boolean multiSurfaceShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMultiSurface(), rightObject.isSetMultiSurface());
                if (multiSurfaceShouldBeMergedAndSet == Boolean.TRUE) {
                    MultiSurfaceType lhsMultiSurface;
                    ...
                    if (multiSurfaceShouldBeMergedAndSet == Boolean.FALSE) {
