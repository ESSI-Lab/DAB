...
public class DirectionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DirectionPropertyType) {
            ...
            {
                Boolean directionVectorShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDirectionVector());
                if (directionVectorShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (directionVectorShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.directionVector = null;
                    }
                }
            }
            {
                Boolean compassPointShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCompassPoint());
                if (compassPointShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (compassPointShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.compassPoint = null;
                    }
                }
            }
            {
                Boolean directionKeywordShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDirectionKeyword());
                if (directionKeywordShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (directionKeywordShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.directionKeyword = null;
                    }
                }
            }
            {
                Boolean directionStringShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDirectionString());
                if (directionStringShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (directionStringShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DirectionPropertyType) {
            ...
            {
                Boolean directionVectorShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDirectionVector(), rightObject.isSetDirectionVector());
                if (directionVectorShouldBeMergedAndSet == Boolean.TRUE) {
                    DirectionVectorType lhsDirectionVector;
                    ...
                    if (directionVectorShouldBeMergedAndSet == Boolean.FALSE) {
                        target.directionVector = null;
                    }
                }
            }
            {
                Boolean compassPointShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCompassPoint(), rightObject.isSetCompassPoint());
                if (compassPointShouldBeMergedAndSet == Boolean.TRUE) {
                    CompassPointEnumeration lhsCompassPoint;
                    ...
                    if (compassPointShouldBeMergedAndSet == Boolean.FALSE) {
                        target.compassPoint = null;
                    }
                }
            }
            {
                Boolean directionKeywordShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDirectionKeyword(), rightObject.isSetDirectionKeyword());
                if (directionKeywordShouldBeMergedAndSet == Boolean.TRUE) {
                    CodeType lhsDirectionKeyword;
                    ...
                    if (directionKeywordShouldBeMergedAndSet == Boolean.FALSE) {
                        target.directionKeyword = null;
                    }
                }
            }
            {
                Boolean directionStringShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDirectionString(), rightObject.isSetDirectionString());
                if (directionStringShouldBeMergedAndSet == Boolean.TRUE) {
                    StringOrRefType lhsDirectionString;
                    ...
                    if (directionStringShouldBeMergedAndSet == Boolean.FALSE) {
