...
public class SymbolType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "symbolType", buffer, theSymbolType, this.isSetSymbolType());
        }
        {
            String theTransform;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "symbolType", lhsSymbolType), LocatorUtils.property(thatLocator, "symbolType", rhsSymbolType), lhsSymbolType, rhsSymbolType, this.isSetSymbolType(), that.isSetSymbolType())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            SymbolTypeEnumeration theSymbolType;
            theSymbolType = this.getSymbolType();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "symbolType", theSymbolType), currentHashCode, theSymbolType, this.isSetSymbolType());
        }
        {
            String theTransform;
            theTransform = this.getTransform();
        ...
        if (draftCopy instanceof SymbolType) {
            final SymbolType copy = ((SymbolType) draftCopy);
            {
                ...
                if (anyShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    List<Element> copyAny = ((List<Element> ) strategy.copy(LocatorUtils.property(locator, "any", sourceAny), sourceAny, this.isSetAny()));
                    copy.unsetAny();
                    if (copyAny!= null) {
            ...
            {
                Boolean symbolTypeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSymbolType());
                if (symbolTypeShouldBeCopiedAndSet == Boolean.TRUE) {
                    SymbolTypeEnumeration sourceSymbolType;
                    sourceSymbolType = this.getSymbolType();
                    SymbolTypeEnumeration copySymbolType = ((SymbolTypeEnumeration) strategy.copy(LocatorUtils.property(locator, "symbolType", sourceSymbolType), sourceSymbolType, this.isSetSymbolType()));
                    copy.setSymbolType(copySymbolType);
                } else {
                    if (symbolTypeShouldBeCopiedAndSet == Boolean.FALSE) {
            ...
            {
                Boolean aboutShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbout());
                if (aboutShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceAbout;
                    ...
                    if (aboutShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.about = null;
                    }
                }
            }
        ...
        if (right instanceof SymbolType) {
            ...
            final SymbolType rightObject = ((SymbolType) right);
            {
                ...
                if (anyShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    List<Element> mergedAny = ((List<Element> ) strategy.merge(LocatorUtils.property(leftLocator, "any", lhsAny), LocatorUtils.property(rightLocator, "any", rhsAny), lhsAny, rhsAny, leftObject.isSetAny(), rightObject.isSetAny()));
                    target.unsetAny();
                    if (mergedAny!= null) {
            ...
            {
                Boolean symbolTypeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSymbolType(), rightObject.isSetSymbolType());
                if (symbolTypeShouldBeMergedAndSet == Boolean.TRUE) {
                    SymbolTypeEnumeration lhsSymbolType;
                    lhsSymbolType = leftObject.getSymbolType();
                    SymbolTypeEnumeration rhsSymbolType;
                    rhsSymbolType = rightObject.getSymbolType();
                    SymbolTypeEnumeration mergedSymbolType = ((SymbolTypeEnumeration) strategy.merge(LocatorUtils.property(leftLocator, "symbolType", lhsSymbolType), LocatorUtils.property(rightLocator, "symbolType", rhsSymbolType), lhsSymbolType, rhsSymbolType, leftObject.isSetSymbolType(), rightObject.isSetSymbolType()));
                    target.setSymbolType(mergedSymbolType);
                } else {
                    if (symbolTypeShouldBeMergedAndSet == Boolean.FALSE) {
                        target.symbolType = null;
                    }
                }
            }
            {
            ...
            {
                Boolean aboutShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbout(), rightObject.isSetAbout());
                if (aboutShouldBeMergedAndSet == Boolean.TRUE) {
                    String lhsAbout;
                    ...
                    if (aboutShouldBeMergedAndSet == Boolean.FALSE) {
                        target.about = null;
                    }
                }
            }
    ...
    public SymbolType withAny(Element... values) {
        if (values!= null) {
    ...
    public SymbolType withAny(Collection<Element> values) {
        if (values!= null) {
    ...
    public SymbolType withSymbolType(SymbolTypeEnumeration value) {
        setSymbolType(value);
        return this;
    }

    public SymbolType withTransform(String value) {
        setTransform(value);
        return this;
    }

    public SymbolType withAbout(String value) {
        setAbout(value);
        return this;
    }

    public SymbolType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public SymbolType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SymbolType withHref(String value) {
        setHref(value);
        return this;
    }

    public SymbolType withRole(String value) {
        setRole(value);
        return this;
    }

    public SymbolType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SymbolType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SymbolType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SymbolType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public SymbolType withAny(List<Element> value) {
        setAny(value);
        return this;
    }
