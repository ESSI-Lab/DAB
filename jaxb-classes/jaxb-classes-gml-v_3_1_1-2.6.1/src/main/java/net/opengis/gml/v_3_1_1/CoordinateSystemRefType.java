...
public class CoordinateSystemRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof CoordinateSystemRefType) {
            final CoordinateSystemRefType copy = ((CoordinateSystemRefType) draftCopy);
            {
                ...
                if (coordinateSystemShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractCoordinateSystemType> copyCoordinateSystem = ((JAXBElement<? extends AbstractCoordinateSystemType> ) strategy.copy(LocatorUtils.property(locator, "coordinateSystem", sourceCoordinateSystem), sourceCoordinateSystem, this.isSetCoordinateSystem()));
    ...
    public CoordinateSystemRefType withCoordinateSystem(JAXBElement<? extends AbstractCoordinateSystemType> value) {
        setCoordinateSystem(value);
        return this;
    }

    public CoordinateSystemRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public CoordinateSystemRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CoordinateSystemRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public CoordinateSystemRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public CoordinateSystemRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CoordinateSystemRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CoordinateSystemRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CoordinateSystemRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
