...
public class GeneralTransformationRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "generalTransformation", buffer, theGeneralTransformation, this.isSetGeneralTransformation());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final GeneralTransformationRefType that = ((GeneralTransformationRefType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "generalTransformation", lhsGeneralTransformation), LocatorUtils.property(thatLocator, "generalTransformation", rhsGeneralTransformation), lhsGeneralTransformation, rhsGeneralTransformation, this.isSetGeneralTransformation(), that.isSetGeneralTransformation())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractGeneralTransformationType> theGeneralTransformation;
            theGeneralTransformation = this.getGeneralTransformation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "generalTransformation", theGeneralTransformation), currentHashCode, theGeneralTransformation, this.isSetGeneralTransformation());
        }
        {
            String theRemoteSchema;
            theRemoteSchema = this.getRemoteSchema();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof GeneralTransformationRefType) {
            ...
            {
                Boolean generalTransformationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetGeneralTransformation());
                if (generalTransformationShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractGeneralTransformationType> copyGeneralTransformation = ((JAXBElement<? extends AbstractGeneralTransformationType> ) strategy.copy(LocatorUtils.property(locator, "generalTransformation", sourceGeneralTransformation), sourceGeneralTransformation, this.isSetGeneralTransformation()));
                    copy.setGeneralTransformation(copyGeneralTransformation);
                } else {
                    if (generalTransformationShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof GeneralTransformationRefType) {
            ...
            {
                Boolean generalTransformationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetGeneralTransformation(), rightObject.isSetGeneralTransformation());
                if (generalTransformationShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractGeneralTransformationType> lhsGeneralTransformation;
                    ...
                    JAXBElement<? extends AbstractGeneralTransformationType> mergedGeneralTransformation = ((JAXBElement<? extends AbstractGeneralTransformationType> ) strategy.merge(LocatorUtils.property(leftLocator, "generalTransformation", lhsGeneralTransformation), LocatorUtils.property(rightLocator, "generalTransformation", rhsGeneralTransformation), lhsGeneralTransformation, rhsGeneralTransformation, leftObject.isSetGeneralTransformation(), rightObject.isSetGeneralTransformation()));
                    target.setGeneralTransformation(mergedGeneralTransformation);
                } else {
                    if (generalTransformationShouldBeMergedAndSet == Boolean.FALSE) {
                        target.generalTransformation = null;
                    }
                }
            }
            {
    ...
    public GeneralTransformationRefType withGeneralTransformation(JAXBElement<? extends AbstractGeneralTransformationType> value) {
        setGeneralTransformation(value);
        return this;
    }

    public GeneralTransformationRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public GeneralTransformationRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public GeneralTransformationRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public GeneralTransformationRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public GeneralTransformationRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public GeneralTransformationRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public GeneralTransformationRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public GeneralTransformationRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
