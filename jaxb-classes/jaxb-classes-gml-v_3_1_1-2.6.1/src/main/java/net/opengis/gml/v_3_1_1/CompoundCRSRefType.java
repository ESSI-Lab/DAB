...
public class CompoundCRSRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CompoundCRSRefType) {
            ...
            {
                Boolean compoundCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCompoundCRS());
                if (compoundCRSShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (compoundCRSShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CompoundCRSRefType) {
            ...
            {
                Boolean compoundCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCompoundCRS(), rightObject.isSetCompoundCRS());
                if (compoundCRSShouldBeMergedAndSet == Boolean.TRUE) {
                    CompoundCRSType lhsCompoundCRS;
                    ...
                    if (compoundCRSShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public CompoundCRSRefType withCompoundCRS(CompoundCRSType value) {
        setCompoundCRS(value);
        return this;
    }

    public CompoundCRSRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public CompoundCRSRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CompoundCRSRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public CompoundCRSRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public CompoundCRSRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CompoundCRSRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CompoundCRSRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CompoundCRSRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
