...
public class TimeOrdinalEraPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TimeOrdinalEraPropertyType) {
            ...
            {
                Boolean timeOrdinalEraShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTimeOrdinalEra());
                if (timeOrdinalEraShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    if (timeOrdinalEraShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TimeOrdinalEraPropertyType) {
            ...
            {
                Boolean timeOrdinalEraShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTimeOrdinalEra(), rightObject.isSetTimeOrdinalEra());
                if (timeOrdinalEraShouldBeMergedAndSet == Boolean.TRUE) {
                    TimeOrdinalEraType lhsTimeOrdinalEra;
                    ...
                    if (timeOrdinalEraShouldBeMergedAndSet == Boolean.FALSE) {
