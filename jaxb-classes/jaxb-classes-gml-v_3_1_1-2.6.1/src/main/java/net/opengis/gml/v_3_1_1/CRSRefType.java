...
public class CRSRefType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof CRSRefType) {
            final CRSRefType copy = ((CRSRefType) draftCopy);
            {
                ...
                if (crsShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractReferenceSystemType> copyCRS = ((JAXBElement<? extends AbstractReferenceSystemType> ) strategy.copy(LocatorUtils.property(locator, "crs", sourceCRS), sourceCRS, this.isSetCRS()));
                    copy.setCRS(copyCRS);
                } else {
        ...
        if (right instanceof CRSRefType) {
            ...
            final CRSRefType rightObject = ((CRSRefType) right);
            {
                ...
                if (crsShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends AbstractReferenceSystemType> mergedCRS = ((JAXBElement<? extends AbstractReferenceSystemType> ) strategy.merge(LocatorUtils.property(leftLocator, "crs", lhsCRS), LocatorUtils.property(rightLocator, "crs", rhsCRS), lhsCRS, rhsCRS, leftObject.isSetCRS(), rightObject.isSetCRS()));
    ...
    public CRSRefType withCRS(JAXBElement<? extends AbstractReferenceSystemType> value) {
        setCRS(value);
        return this;
    }

    public CRSRefType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public CRSRefType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CRSRefType withHref(String value) {
        setHref(value);
        return this;
    }

    public CRSRefType withRole(String value) {
        setRole(value);
        return this;
    }

    public CRSRefType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CRSRefType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CRSRefType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CRSRefType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
