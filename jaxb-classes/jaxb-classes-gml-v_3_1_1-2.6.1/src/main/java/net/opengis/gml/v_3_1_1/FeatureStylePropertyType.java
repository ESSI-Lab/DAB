...
public class FeatureStylePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof FeatureStylePropertyType) {
            final FeatureStylePropertyType copy = ((FeatureStylePropertyType) draftCopy);
            {
                ...
                if (featureStyleShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    FeatureStyleType copyFeatureStyle = ((FeatureStyleType) strategy.copy(LocatorUtils.property(locator, "featureStyle", sourceFeatureStyle), sourceFeatureStyle, this.isSetFeatureStyle()));
        ...
        if (right instanceof FeatureStylePropertyType) {
            ...
            final FeatureStylePropertyType rightObject = ((FeatureStylePropertyType) right);
            {
                ...
                if (featureStyleShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    FeatureStyleType mergedFeatureStyle = ((FeatureStyleType) strategy.merge(LocatorUtils.property(leftLocator, "featureStyle", lhsFeatureStyle), LocatorUtils.property(rightLocator, "featureStyle", rhsFeatureStyle), lhsFeatureStyle, rhsFeatureStyle, leftObject.isSetFeatureStyle(), rightObject.isSetFeatureStyle()));
                    target.setFeatureStyle(mergedFeatureStyle);
                } else {
                    if (featureStyleShouldBeMergedAndSet == Boolean.FALSE) {
                        target.featureStyle = null;
                    }
                }
            }
            {
    ...
    public FeatureStylePropertyType withFeatureStyle(FeatureStyleType value) {
        setFeatureStyle(value);
        return this;
    }

    public FeatureStylePropertyType withAbout(String value) {
        setAbout(value);
        return this;
    }

    public FeatureStylePropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public FeatureStylePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public FeatureStylePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public FeatureStylePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public FeatureStylePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public FeatureStylePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public FeatureStylePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public FeatureStylePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
