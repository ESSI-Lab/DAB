...
public class DerivedUnitPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    @XmlElementRef(name = "DerivedUnit", namespace = "http://www.opengis.net/gml", type = JAXBElement.class, required = false)
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "derivedUnit", buffer, theDerivedUnit, this.isSetDerivedUnit());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DerivedUnitPropertyType that = ((DerivedUnitPropertyType) object);
        {
            JAXBElement<? extends DerivedUnitType> lhsDerivedUnit;
            lhsDerivedUnit = this.getDerivedUnit();
            JAXBElement<? extends DerivedUnitType> rhsDerivedUnit;
            rhsDerivedUnit = that.getDerivedUnit();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "derivedUnit", lhsDerivedUnit), LocatorUtils.property(thatLocator, "derivedUnit", rhsDerivedUnit), lhsDerivedUnit, rhsDerivedUnit, this.isSetDerivedUnit(), that.isSetDerivedUnit())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends DerivedUnitType> theDerivedUnit;
            theDerivedUnit = this.getDerivedUnit();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "derivedUnit", theDerivedUnit), currentHashCode, theDerivedUnit, this.isSetDerivedUnit());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DerivedUnitPropertyType) {
            final DerivedUnitPropertyType copy = ((DerivedUnitPropertyType) draftCopy);
            {
                Boolean derivedUnitShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDerivedUnit());
                if (derivedUnitShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends DerivedUnitType> sourceDerivedUnit;
                    sourceDerivedUnit = this.getDerivedUnit();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends DerivedUnitType> copyDerivedUnit = ((JAXBElement<? extends DerivedUnitType> ) strategy.copy(LocatorUtils.property(locator, "derivedUnit", sourceDerivedUnit), sourceDerivedUnit, this.isSetDerivedUnit()));
                    copy.setDerivedUnit(copyDerivedUnit);
                } else {
                    if (derivedUnitShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.derivedUnit = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DerivedUnitPropertyType) {
            final DerivedUnitPropertyType target = this;
            final DerivedUnitPropertyType leftObject = ((DerivedUnitPropertyType) left);
            final DerivedUnitPropertyType rightObject = ((DerivedUnitPropertyType) right);
            {
                Boolean derivedUnitShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDerivedUnit(), rightObject.isSetDerivedUnit());
                if (derivedUnitShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends DerivedUnitType> lhsDerivedUnit;
                    lhsDerivedUnit = leftObject.getDerivedUnit();
                    JAXBElement<? extends DerivedUnitType> rhsDerivedUnit;
                    rhsDerivedUnit = rightObject.getDerivedUnit();
                    JAXBElement<? extends DerivedUnitType> mergedDerivedUnit = ((JAXBElement<? extends DerivedUnitType> ) strategy.merge(LocatorUtils.property(leftLocator, "derivedUnit", lhsDerivedUnit), LocatorUtils.property(rightLocator, "derivedUnit", rhsDerivedUnit), lhsDerivedUnit, rhsDerivedUnit, leftObject.isSetDerivedUnit(), rightObject.isSetDerivedUnit()));
                    target.setDerivedUnit(mergedDerivedUnit);
                } else {
                    if (derivedUnitShouldBeMergedAndSet == Boolean.FALSE) {
                        target.derivedUnit = null;
                    }
                }
            }
            {
    ...
    public DerivedUnitPropertyType withDerivedUnit(JAXBElement<? extends DerivedUnitType> value) {
        setDerivedUnit(value);
        return this;
    }

    public DerivedUnitPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DerivedUnitPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DerivedUnitPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DerivedUnitPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DerivedUnitPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DerivedUnitPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DerivedUnitPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DerivedUnitPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DerivedUnitPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DerivedUnitPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DerivedUnitPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
