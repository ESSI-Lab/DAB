...
public class URLPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final URLPropertyType that = ((URLPropertyType) object);
        {
            ...
            String rhsURL;
            rhsURL = that.getURL();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "url", lhsURL), LocatorUtils.property(thatLocator, "url", rhsURL), lhsURL, rhsURL, this.isSetURL(), that.isSetURL())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            String theURL;
            theURL = this.getURL();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "url", theURL), currentHashCode, theURL, this.isSetURL());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof URLPropertyType) {
            final URLPropertyType copy = ((URLPropertyType) draftCopy);
            {
                Boolean urlShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetURL());
                if (urlShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceURL;
                    sourceURL = this.getURL();
                    String copyURL = ((String) strategy.copy(LocatorUtils.property(locator, "url", sourceURL), sourceURL, this.isSetURL()));
                    copy.setURL(copyURL);
                } else {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof URLPropertyType) {
            final URLPropertyType target = this;
            final URLPropertyType leftObject = ((URLPropertyType) left);
            final URLPropertyType rightObject = ((URLPropertyType) right);
            {
                Boolean urlShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetURL(), rightObject.isSetURL());
                if (urlShouldBeMergedAndSet == Boolean.TRUE) {
                    String lhsURL;
                    lhsURL = leftObject.getURL();
                    String rhsURL;
                    rhsURL = rightObject.getURL();
                    String mergedURL = ((String) strategy.merge(LocatorUtils.property(leftLocator, "url", lhsURL), LocatorUtils.property(rightLocator, "url", rhsURL), lhsURL, rhsURL, leftObject.isSetURL(), rightObject.isSetURL()));
    ...
    public URLPropertyType withURL(String value) {
        setURL(value);
        return this;
    }

    public URLPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public URLPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public URLPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
