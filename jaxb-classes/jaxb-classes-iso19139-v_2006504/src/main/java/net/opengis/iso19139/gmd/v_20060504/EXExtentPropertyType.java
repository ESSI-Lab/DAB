...
public class EXExtentPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            EXExtentType lhsEXExtent;
            lhsEXExtent = this.getEXExtent();
            EXExtentType rhsEXExtent;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof EXExtentPropertyType) {
            final EXExtentPropertyType copy = ((EXExtentPropertyType) draftCopy);
            {
                Boolean exExtentShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetEXExtent());
                if (exExtentShouldBeCopiedAndSet == Boolean.TRUE) {
                    EXExtentType sourceEXExtent;
                    sourceEXExtent = this.getEXExtent();
                    EXExtentType copyEXExtent = ((EXExtentType) strategy.copy(LocatorUtils.property(locator, "exExtent", sourceEXExtent), sourceEXExtent, this.isSetEXExtent()));
                    copy.setEXExtent(copyEXExtent);
                } else {
                    if (exExtentShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.exExtent = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof EXExtentPropertyType) {
            final EXExtentPropertyType target = this;
            final EXExtentPropertyType leftObject = ((EXExtentPropertyType) left);
            final EXExtentPropertyType rightObject = ((EXExtentPropertyType) right);
            {
                Boolean exExtentShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetEXExtent(), rightObject.isSetEXExtent());
                if (exExtentShouldBeMergedAndSet == Boolean.TRUE) {
                    EXExtentType lhsEXExtent;
                    lhsEXExtent = leftObject.getEXExtent();
                    EXExtentType rhsEXExtent;
                    rhsEXExtent = rightObject.getEXExtent();
                    EXExtentType mergedEXExtent = ((EXExtentType) strategy.merge(LocatorUtils.property(leftLocator, "exExtent", lhsEXExtent), LocatorUtils.property(rightLocator, "exExtent", rhsEXExtent), lhsEXExtent, rhsEXExtent, leftObject.isSetEXExtent(), rightObject.isSetEXExtent()));
                    target.setEXExtent(mergedEXExtent);
                } else {
                    if (exExtentShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public EXExtentPropertyType withEXExtent(EXExtentType value) {
        setEXExtent(value);
        return this;
    }

    public EXExtentPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public EXExtentPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public EXExtentPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public EXExtentPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public EXExtentPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public EXExtentPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public EXExtentPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public EXExtentPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public EXExtentPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public EXExtentPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public EXExtentPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
