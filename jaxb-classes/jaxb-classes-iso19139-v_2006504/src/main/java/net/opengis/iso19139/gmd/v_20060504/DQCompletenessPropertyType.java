...
public class DQCompletenessPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "abstractDQCompleteness", buffer, theAbstractDQCompleteness, this.isSetAbstractDQCompleteness());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<? extends AbstractDQCompletenessType> lhsAbstractDQCompleteness;
            lhsAbstractDQCompleteness = this.getAbstractDQCompleteness();
            JAXBElement<? extends AbstractDQCompletenessType> rhsAbstractDQCompleteness;
            rhsAbstractDQCompleteness = that.getAbstractDQCompleteness();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractDQCompleteness", lhsAbstractDQCompleteness), LocatorUtils.property(thatLocator, "abstractDQCompleteness", rhsAbstractDQCompleteness), lhsAbstractDQCompleteness, rhsAbstractDQCompleteness, this.isSetAbstractDQCompleteness(), that.isSetAbstractDQCompleteness())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractDQCompletenessType> theAbstractDQCompleteness;
            theAbstractDQCompleteness = this.getAbstractDQCompleteness();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractDQCompleteness", theAbstractDQCompleteness), currentHashCode, theAbstractDQCompleteness, this.isSetAbstractDQCompleteness());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DQCompletenessPropertyType) {
            final DQCompletenessPropertyType copy = ((DQCompletenessPropertyType) draftCopy);
            {
                Boolean abstractDQCompletenessShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractDQCompleteness());
                if (abstractDQCompletenessShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractDQCompletenessType> sourceAbstractDQCompleteness;
                    sourceAbstractDQCompleteness = this.getAbstractDQCompleteness();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractDQCompletenessType> copyAbstractDQCompleteness = ((JAXBElement<? extends AbstractDQCompletenessType> ) strategy.copy(LocatorUtils.property(locator, "abstractDQCompleteness", sourceAbstractDQCompleteness), sourceAbstractDQCompleteness, this.isSetAbstractDQCompleteness()));
                    copy.setAbstractDQCompleteness(copyAbstractDQCompleteness);
                } else {
                    if (abstractDQCompletenessShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.abstractDQCompleteness = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DQCompletenessPropertyType) {
            final DQCompletenessPropertyType target = this;
            final DQCompletenessPropertyType leftObject = ((DQCompletenessPropertyType) left);
            final DQCompletenessPropertyType rightObject = ((DQCompletenessPropertyType) right);
            {
                Boolean abstractDQCompletenessShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractDQCompleteness(), rightObject.isSetAbstractDQCompleteness());
                if (abstractDQCompletenessShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractDQCompletenessType> lhsAbstractDQCompleteness;
                    lhsAbstractDQCompleteness = leftObject.getAbstractDQCompleteness();
                    JAXBElement<? extends AbstractDQCompletenessType> rhsAbstractDQCompleteness;
                    rhsAbstractDQCompleteness = rightObject.getAbstractDQCompleteness();
                    JAXBElement<? extends AbstractDQCompletenessType> mergedAbstractDQCompleteness = ((JAXBElement<? extends AbstractDQCompletenessType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractDQCompleteness", lhsAbstractDQCompleteness), LocatorUtils.property(rightLocator, "abstractDQCompleteness", rhsAbstractDQCompleteness), lhsAbstractDQCompleteness, rhsAbstractDQCompleteness, leftObject.isSetAbstractDQCompleteness(), rightObject.isSetAbstractDQCompleteness()));
                    target.setAbstractDQCompleteness(mergedAbstractDQCompleteness);
                } else {
                    if (abstractDQCompletenessShouldBeMergedAndSet == Boolean.FALSE) {
                        target.abstractDQCompleteness = null;
                    }
                }
            }
            {
    ...
    public DQCompletenessPropertyType withAbstractDQCompleteness(JAXBElement<? extends AbstractDQCompletenessType> value) {
        setAbstractDQCompleteness(value);
        return this;
    }

    public DQCompletenessPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DQCompletenessPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DQCompletenessPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DQCompletenessPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DQCompletenessPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DQCompletenessPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DQCompletenessPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DQCompletenessPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DQCompletenessPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DQCompletenessPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DQCompletenessPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
