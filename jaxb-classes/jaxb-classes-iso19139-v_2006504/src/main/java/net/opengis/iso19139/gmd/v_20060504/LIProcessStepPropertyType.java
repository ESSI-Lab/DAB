...
public class LIProcessStepPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "liProcessStep", buffer, theLIProcessStep, this.isSetLIProcessStep());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            LIProcessStepType lhsLIProcessStep;
            lhsLIProcessStep = this.getLIProcessStep();
            LIProcessStepType rhsLIProcessStep;
            rhsLIProcessStep = that.getLIProcessStep();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "liProcessStep", lhsLIProcessStep), LocatorUtils.property(thatLocator, "liProcessStep", rhsLIProcessStep), lhsLIProcessStep, rhsLIProcessStep, this.isSetLIProcessStep(), that.isSetLIProcessStep())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            LIProcessStepType theLIProcessStep;
            theLIProcessStep = this.getLIProcessStep();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "liProcessStep", theLIProcessStep), currentHashCode, theLIProcessStep, this.isSetLIProcessStep());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof LIProcessStepPropertyType) {
            final LIProcessStepPropertyType copy = ((LIProcessStepPropertyType) draftCopy);
            {
                Boolean liProcessStepShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetLIProcessStep());
                if (liProcessStepShouldBeCopiedAndSet == Boolean.TRUE) {
                    LIProcessStepType sourceLIProcessStep;
                    sourceLIProcessStep = this.getLIProcessStep();
                    LIProcessStepType copyLIProcessStep = ((LIProcessStepType) strategy.copy(LocatorUtils.property(locator, "liProcessStep", sourceLIProcessStep), sourceLIProcessStep, this.isSetLIProcessStep()));
                    copy.setLIProcessStep(copyLIProcessStep);
                } else {
                    if (liProcessStepShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.liProcessStep = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof LIProcessStepPropertyType) {
            final LIProcessStepPropertyType target = this;
            final LIProcessStepPropertyType leftObject = ((LIProcessStepPropertyType) left);
            final LIProcessStepPropertyType rightObject = ((LIProcessStepPropertyType) right);
            {
                Boolean liProcessStepShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetLIProcessStep(), rightObject.isSetLIProcessStep());
                if (liProcessStepShouldBeMergedAndSet == Boolean.TRUE) {
                    LIProcessStepType lhsLIProcessStep;
                    lhsLIProcessStep = leftObject.getLIProcessStep();
                    LIProcessStepType rhsLIProcessStep;
                    rhsLIProcessStep = rightObject.getLIProcessStep();
                    LIProcessStepType mergedLIProcessStep = ((LIProcessStepType) strategy.merge(LocatorUtils.property(leftLocator, "liProcessStep", lhsLIProcessStep), LocatorUtils.property(rightLocator, "liProcessStep", rhsLIProcessStep), lhsLIProcessStep, rhsLIProcessStep, leftObject.isSetLIProcessStep(), rightObject.isSetLIProcessStep()));
                    target.setLIProcessStep(mergedLIProcessStep);
                } else {
                    if (liProcessStepShouldBeMergedAndSet == Boolean.FALSE) {
                        target.liProcessStep = null;
                    }
                }
            }
            {
    ...
    public LIProcessStepPropertyType withLIProcessStep(LIProcessStepType value) {
        setLIProcessStep(value);
        return this;
    }

    public LIProcessStepPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public LIProcessStepPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public LIProcessStepPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public LIProcessStepPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public LIProcessStepPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public LIProcessStepPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public LIProcessStepPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public LIProcessStepPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public LIProcessStepPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public LIProcessStepPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public LIProcessStepPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
