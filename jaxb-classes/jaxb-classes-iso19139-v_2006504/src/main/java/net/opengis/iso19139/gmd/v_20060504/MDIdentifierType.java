    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public MDIdentifierType withAuthority(CICitationPropertyType value) {
        setAuthority(value);
        return this;
    }

    public MDIdentifierType withCode(CharacterStringPropertyType value) {
        setCode(value);
        return this;
    }

    @Override
    public MDIdentifierType withId(String value) {
        setId(value);
        return this;
    }

    @Override
    public MDIdentifierType withUuid(String value) {
        setUuid(value);
        return this;
    }
