...
public class SVServicePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "svService", buffer, theSVService, this.isSetSVService());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SVServicePropertyType that = ((SVServicePropertyType) object);
        {
            SVServiceType lhsSVService;
            lhsSVService = this.getSVService();
            SVServiceType rhsSVService;
            rhsSVService = that.getSVService();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "svService", lhsSVService), LocatorUtils.property(thatLocator, "svService", rhsSVService), lhsSVService, rhsSVService, this.isSetSVService(), that.isSetSVService())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            SVServiceType theSVService;
            theSVService = this.getSVService();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "svService", theSVService), currentHashCode, theSVService, this.isSetSVService());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SVServicePropertyType) {
            final SVServicePropertyType copy = ((SVServicePropertyType) draftCopy);
            {
                Boolean svServiceShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSVService());
                if (svServiceShouldBeCopiedAndSet == Boolean.TRUE) {
                    SVServiceType sourceSVService;
                    sourceSVService = this.getSVService();
                    SVServiceType copySVService = ((SVServiceType) strategy.copy(LocatorUtils.property(locator, "svService", sourceSVService), sourceSVService, this.isSetSVService()));
                    copy.setSVService(copySVService);
                } else {
                    if (svServiceShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.svService = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SVServicePropertyType) {
            final SVServicePropertyType target = this;
            final SVServicePropertyType leftObject = ((SVServicePropertyType) left);
            final SVServicePropertyType rightObject = ((SVServicePropertyType) right);
            {
                Boolean svServiceShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSVService(), rightObject.isSetSVService());
                if (svServiceShouldBeMergedAndSet == Boolean.TRUE) {
                    SVServiceType lhsSVService;
                    lhsSVService = leftObject.getSVService();
                    SVServiceType rhsSVService;
                    rhsSVService = rightObject.getSVService();
                    SVServiceType mergedSVService = ((SVServiceType) strategy.merge(LocatorUtils.property(leftLocator, "svService", lhsSVService), LocatorUtils.property(rightLocator, "svService", rhsSVService), lhsSVService, rhsSVService, leftObject.isSetSVService(), rightObject.isSetSVService()));
                    target.setSVService(mergedSVService);
                } else {
                    if (svServiceShouldBeMergedAndSet == Boolean.FALSE) {
                        target.svService = null;
                    }
                }
            }
            {
    ...
    public SVServicePropertyType withSVService(SVServiceType value) {
        setSVService(value);
        return this;
    }

    public SVServicePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public SVServicePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public SVServicePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public SVServicePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SVServicePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public SVServicePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public SVServicePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SVServicePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SVServicePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SVServicePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public SVServicePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
