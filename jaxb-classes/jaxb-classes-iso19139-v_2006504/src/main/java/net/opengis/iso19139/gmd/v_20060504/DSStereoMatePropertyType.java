...
public class DSStereoMatePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "dsStereoMate", buffer, theDSStereoMate, this.isSetDSStereoMate());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            DSStereoMateType lhsDSStereoMate;
            lhsDSStereoMate = this.getDSStereoMate();
            DSStereoMateType rhsDSStereoMate;
            rhsDSStereoMate = that.getDSStereoMate();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dsStereoMate", lhsDSStereoMate), LocatorUtils.property(thatLocator, "dsStereoMate", rhsDSStereoMate), lhsDSStereoMate, rhsDSStereoMate, this.isSetDSStereoMate(), that.isSetDSStereoMate())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            DSStereoMateType theDSStereoMate;
            theDSStereoMate = this.getDSStereoMate();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dsStereoMate", theDSStereoMate), currentHashCode, theDSStereoMate, this.isSetDSStereoMate());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DSStereoMatePropertyType) {
            final DSStereoMatePropertyType copy = ((DSStereoMatePropertyType) draftCopy);
            {
                Boolean dsStereoMateShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDSStereoMate());
                if (dsStereoMateShouldBeCopiedAndSet == Boolean.TRUE) {
                    DSStereoMateType sourceDSStereoMate;
                    sourceDSStereoMate = this.getDSStereoMate();
                    DSStereoMateType copyDSStereoMate = ((DSStereoMateType) strategy.copy(LocatorUtils.property(locator, "dsStereoMate", sourceDSStereoMate), sourceDSStereoMate, this.isSetDSStereoMate()));
                    copy.setDSStereoMate(copyDSStereoMate);
                } else {
                    if (dsStereoMateShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.dsStereoMate = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DSStereoMatePropertyType) {
            final DSStereoMatePropertyType target = this;
            final DSStereoMatePropertyType leftObject = ((DSStereoMatePropertyType) left);
            final DSStereoMatePropertyType rightObject = ((DSStereoMatePropertyType) right);
            {
                Boolean dsStereoMateShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDSStereoMate(), rightObject.isSetDSStereoMate());
                if (dsStereoMateShouldBeMergedAndSet == Boolean.TRUE) {
                    DSStereoMateType lhsDSStereoMate;
                    lhsDSStereoMate = leftObject.getDSStereoMate();
                    DSStereoMateType rhsDSStereoMate;
                    rhsDSStereoMate = rightObject.getDSStereoMate();
                    DSStereoMateType mergedDSStereoMate = ((DSStereoMateType) strategy.merge(LocatorUtils.property(leftLocator, "dsStereoMate", lhsDSStereoMate), LocatorUtils.property(rightLocator, "dsStereoMate", rhsDSStereoMate), lhsDSStereoMate, rhsDSStereoMate, leftObject.isSetDSStereoMate(), rightObject.isSetDSStereoMate()));
                    target.setDSStereoMate(mergedDSStereoMate);
                } else {
                    if (dsStereoMateShouldBeMergedAndSet == Boolean.FALSE) {
                        target.dsStereoMate = null;
                    }
                }
            }
            {
    ...
    public DSStereoMatePropertyType withDSStereoMate(DSStereoMateType value) {
        setDSStereoMate(value);
        return this;
    }

    public DSStereoMatePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DSStereoMatePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DSStereoMatePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DSStereoMatePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DSStereoMatePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DSStereoMatePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DSStereoMatePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DSStereoMatePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DSStereoMatePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DSStereoMatePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DSStereoMatePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
