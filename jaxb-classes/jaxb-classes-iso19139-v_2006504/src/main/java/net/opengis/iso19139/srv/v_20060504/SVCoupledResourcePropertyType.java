...
public class SVCoupledResourcePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "svCoupledResource", buffer, theSVCoupledResource, this.isSetSVCoupledResource());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SVCoupledResourcePropertyType that = ((SVCoupledResourcePropertyType) object);
        {
            SVCoupledResourceType lhsSVCoupledResource;
            lhsSVCoupledResource = this.getSVCoupledResource();
            SVCoupledResourceType rhsSVCoupledResource;
            rhsSVCoupledResource = that.getSVCoupledResource();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "svCoupledResource", lhsSVCoupledResource), LocatorUtils.property(thatLocator, "svCoupledResource", rhsSVCoupledResource), lhsSVCoupledResource, rhsSVCoupledResource, this.isSetSVCoupledResource(), that.isSetSVCoupledResource())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            SVCoupledResourceType theSVCoupledResource;
            theSVCoupledResource = this.getSVCoupledResource();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "svCoupledResource", theSVCoupledResource), currentHashCode, theSVCoupledResource, this.isSetSVCoupledResource());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SVCoupledResourcePropertyType) {
            final SVCoupledResourcePropertyType copy = ((SVCoupledResourcePropertyType) draftCopy);
            {
                Boolean svCoupledResourceShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSVCoupledResource());
                if (svCoupledResourceShouldBeCopiedAndSet == Boolean.TRUE) {
                    SVCoupledResourceType sourceSVCoupledResource;
                    sourceSVCoupledResource = this.getSVCoupledResource();
                    SVCoupledResourceType copySVCoupledResource = ((SVCoupledResourceType) strategy.copy(LocatorUtils.property(locator, "svCoupledResource", sourceSVCoupledResource), sourceSVCoupledResource, this.isSetSVCoupledResource()));
                    copy.setSVCoupledResource(copySVCoupledResource);
                } else {
                    if (svCoupledResourceShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.svCoupledResource = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SVCoupledResourcePropertyType) {
            final SVCoupledResourcePropertyType target = this;
            final SVCoupledResourcePropertyType leftObject = ((SVCoupledResourcePropertyType) left);
            final SVCoupledResourcePropertyType rightObject = ((SVCoupledResourcePropertyType) right);
            {
                Boolean svCoupledResourceShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSVCoupledResource(), rightObject.isSetSVCoupledResource());
                if (svCoupledResourceShouldBeMergedAndSet == Boolean.TRUE) {
                    SVCoupledResourceType lhsSVCoupledResource;
                    lhsSVCoupledResource = leftObject.getSVCoupledResource();
                    SVCoupledResourceType rhsSVCoupledResource;
                    rhsSVCoupledResource = rightObject.getSVCoupledResource();
                    SVCoupledResourceType mergedSVCoupledResource = ((SVCoupledResourceType) strategy.merge(LocatorUtils.property(leftLocator, "svCoupledResource", lhsSVCoupledResource), LocatorUtils.property(rightLocator, "svCoupledResource", rhsSVCoupledResource), lhsSVCoupledResource, rhsSVCoupledResource, leftObject.isSetSVCoupledResource(), rightObject.isSetSVCoupledResource()));
                    target.setSVCoupledResource(mergedSVCoupledResource);
                } else {
                    if (svCoupledResourceShouldBeMergedAndSet == Boolean.FALSE) {
                        target.svCoupledResource = null;
                    }
                }
            }
            {
    ...
    public SVCoupledResourcePropertyType withSVCoupledResource(SVCoupledResourceType value) {
        setSVCoupledResource(value);
        return this;
    }

    public SVCoupledResourcePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public SVCoupledResourcePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public SVCoupledResourcePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public SVCoupledResourcePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SVCoupledResourcePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public SVCoupledResourcePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public SVCoupledResourcePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SVCoupledResourcePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SVCoupledResourcePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SVCoupledResourcePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public SVCoupledResourcePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
