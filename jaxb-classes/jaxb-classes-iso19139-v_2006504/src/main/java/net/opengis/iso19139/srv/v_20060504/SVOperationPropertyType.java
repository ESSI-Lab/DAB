...
public class SVOperationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "svOperation", buffer, theSVOperation, this.isSetSVOperation());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SVOperationPropertyType that = ((SVOperationPropertyType) object);
        {
            SVOperationType lhsSVOperation;
            lhsSVOperation = this.getSVOperation();
            SVOperationType rhsSVOperation;
            rhsSVOperation = that.getSVOperation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "svOperation", lhsSVOperation), LocatorUtils.property(thatLocator, "svOperation", rhsSVOperation), lhsSVOperation, rhsSVOperation, this.isSetSVOperation(), that.isSetSVOperation())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            SVOperationType theSVOperation;
            theSVOperation = this.getSVOperation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "svOperation", theSVOperation), currentHashCode, theSVOperation, this.isSetSVOperation());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SVOperationPropertyType) {
            final SVOperationPropertyType copy = ((SVOperationPropertyType) draftCopy);
            {
                Boolean svOperationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSVOperation());
                if (svOperationShouldBeCopiedAndSet == Boolean.TRUE) {
                    SVOperationType sourceSVOperation;
                    sourceSVOperation = this.getSVOperation();
                    SVOperationType copySVOperation = ((SVOperationType) strategy.copy(LocatorUtils.property(locator, "svOperation", sourceSVOperation), sourceSVOperation, this.isSetSVOperation()));
                    copy.setSVOperation(copySVOperation);
                } else {
                    if (svOperationShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.svOperation = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SVOperationPropertyType) {
            final SVOperationPropertyType target = this;
            final SVOperationPropertyType leftObject = ((SVOperationPropertyType) left);
            final SVOperationPropertyType rightObject = ((SVOperationPropertyType) right);
            {
                Boolean svOperationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSVOperation(), rightObject.isSetSVOperation());
                if (svOperationShouldBeMergedAndSet == Boolean.TRUE) {
                    SVOperationType lhsSVOperation;
                    lhsSVOperation = leftObject.getSVOperation();
                    SVOperationType rhsSVOperation;
                    rhsSVOperation = rightObject.getSVOperation();
                    SVOperationType mergedSVOperation = ((SVOperationType) strategy.merge(LocatorUtils.property(leftLocator, "svOperation", lhsSVOperation), LocatorUtils.property(rightLocator, "svOperation", rhsSVOperation), lhsSVOperation, rhsSVOperation, leftObject.isSetSVOperation(), rightObject.isSetSVOperation()));
                    target.setSVOperation(mergedSVOperation);
                } else {
                    if (svOperationShouldBeMergedAndSet == Boolean.FALSE) {
                        target.svOperation = null;
                    }
                }
            }
            {
    ...
    public SVOperationPropertyType withSVOperation(SVOperationType value) {
        setSVOperation(value);
        return this;
    }

    public SVOperationPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public SVOperationPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public SVOperationPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public SVOperationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SVOperationPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public SVOperationPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public SVOperationPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SVOperationPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SVOperationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SVOperationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public SVOperationPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
