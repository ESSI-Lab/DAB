...
public class MDPortrayalCatalogueReferencePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdPortrayalCatalogueReference", buffer, theMDPortrayalCatalogueReference, this.isSetMDPortrayalCatalogueReference());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            MDPortrayalCatalogueReferenceType lhsMDPortrayalCatalogueReference;
            lhsMDPortrayalCatalogueReference = this.getMDPortrayalCatalogueReference();
            MDPortrayalCatalogueReferenceType rhsMDPortrayalCatalogueReference;
            rhsMDPortrayalCatalogueReference = that.getMDPortrayalCatalogueReference();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdPortrayalCatalogueReference", lhsMDPortrayalCatalogueReference), LocatorUtils.property(thatLocator, "mdPortrayalCatalogueReference", rhsMDPortrayalCatalogueReference), lhsMDPortrayalCatalogueReference, rhsMDPortrayalCatalogueReference, this.isSetMDPortrayalCatalogueReference(), that.isSetMDPortrayalCatalogueReference())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MDPortrayalCatalogueReferenceType theMDPortrayalCatalogueReference;
            theMDPortrayalCatalogueReference = this.getMDPortrayalCatalogueReference();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdPortrayalCatalogueReference", theMDPortrayalCatalogueReference), currentHashCode, theMDPortrayalCatalogueReference, this.isSetMDPortrayalCatalogueReference());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDPortrayalCatalogueReferencePropertyType) {
            final MDPortrayalCatalogueReferencePropertyType copy = ((MDPortrayalCatalogueReferencePropertyType) draftCopy);
            {
                Boolean mdPortrayalCatalogueReferenceShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDPortrayalCatalogueReference());
                if (mdPortrayalCatalogueReferenceShouldBeCopiedAndSet == Boolean.TRUE) {
                    MDPortrayalCatalogueReferenceType sourceMDPortrayalCatalogueReference;
                    sourceMDPortrayalCatalogueReference = this.getMDPortrayalCatalogueReference();
                    MDPortrayalCatalogueReferenceType copyMDPortrayalCatalogueReference = ((MDPortrayalCatalogueReferenceType) strategy.copy(LocatorUtils.property(locator, "mdPortrayalCatalogueReference", sourceMDPortrayalCatalogueReference), sourceMDPortrayalCatalogueReference, this.isSetMDPortrayalCatalogueReference()));
                    copy.setMDPortrayalCatalogueReference(copyMDPortrayalCatalogueReference);
                } else {
                    if (mdPortrayalCatalogueReferenceShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdPortrayalCatalogueReference = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDPortrayalCatalogueReferencePropertyType) {
            final MDPortrayalCatalogueReferencePropertyType target = this;
            final MDPortrayalCatalogueReferencePropertyType leftObject = ((MDPortrayalCatalogueReferencePropertyType) left);
            final MDPortrayalCatalogueReferencePropertyType rightObject = ((MDPortrayalCatalogueReferencePropertyType) right);
            {
                Boolean mdPortrayalCatalogueReferenceShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDPortrayalCatalogueReference(), rightObject.isSetMDPortrayalCatalogueReference());
                if (mdPortrayalCatalogueReferenceShouldBeMergedAndSet == Boolean.TRUE) {
                    MDPortrayalCatalogueReferenceType lhsMDPortrayalCatalogueReference;
                    lhsMDPortrayalCatalogueReference = leftObject.getMDPortrayalCatalogueReference();
                    MDPortrayalCatalogueReferenceType rhsMDPortrayalCatalogueReference;
                    rhsMDPortrayalCatalogueReference = rightObject.getMDPortrayalCatalogueReference();
                    MDPortrayalCatalogueReferenceType mergedMDPortrayalCatalogueReference = ((MDPortrayalCatalogueReferenceType) strategy.merge(LocatorUtils.property(leftLocator, "mdPortrayalCatalogueReference", lhsMDPortrayalCatalogueReference), LocatorUtils.property(rightLocator, "mdPortrayalCatalogueReference", rhsMDPortrayalCatalogueReference), lhsMDPortrayalCatalogueReference, rhsMDPortrayalCatalogueReference, leftObject.isSetMDPortrayalCatalogueReference(), rightObject.isSetMDPortrayalCatalogueReference()));
                    target.setMDPortrayalCatalogueReference(mergedMDPortrayalCatalogueReference);
                } else {
                    if (mdPortrayalCatalogueReferenceShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdPortrayalCatalogueReference = null;
                    }
                }
            }
            {
    ...
    public MDPortrayalCatalogueReferencePropertyType withMDPortrayalCatalogueReference(MDPortrayalCatalogueReferenceType value) {
        setMDPortrayalCatalogueReference(value);
        return this;
    }

    public MDPortrayalCatalogueReferencePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDPortrayalCatalogueReferencePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDPortrayalCatalogueReferencePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDPortrayalCatalogueReferencePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDPortrayalCatalogueReferencePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDPortrayalCatalogueReferencePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDPortrayalCatalogueReferencePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDPortrayalCatalogueReferencePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDPortrayalCatalogueReferencePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDPortrayalCatalogueReferencePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDPortrayalCatalogueReferencePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
