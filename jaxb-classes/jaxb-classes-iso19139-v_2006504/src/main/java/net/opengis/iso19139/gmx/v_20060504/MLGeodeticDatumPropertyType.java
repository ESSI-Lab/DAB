...
public class MLGeodeticDatumPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlGeodeticDatum", buffer, theMLGeodeticDatum, this.isSetMLGeodeticDatum());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLGeodeticDatumPropertyType that = ((MLGeodeticDatumPropertyType) object);
        {
            MLGeodeticDatumType lhsMLGeodeticDatum;
            lhsMLGeodeticDatum = this.getMLGeodeticDatum();
            MLGeodeticDatumType rhsMLGeodeticDatum;
            rhsMLGeodeticDatum = that.getMLGeodeticDatum();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlGeodeticDatum", lhsMLGeodeticDatum), LocatorUtils.property(thatLocator, "mlGeodeticDatum", rhsMLGeodeticDatum), lhsMLGeodeticDatum, rhsMLGeodeticDatum, this.isSetMLGeodeticDatum(), that.isSetMLGeodeticDatum())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLGeodeticDatumType theMLGeodeticDatum;
            theMLGeodeticDatum = this.getMLGeodeticDatum();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlGeodeticDatum", theMLGeodeticDatum), currentHashCode, theMLGeodeticDatum, this.isSetMLGeodeticDatum());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLGeodeticDatumPropertyType) {
            final MLGeodeticDatumPropertyType copy = ((MLGeodeticDatumPropertyType) draftCopy);
            {
                Boolean mlGeodeticDatumShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLGeodeticDatum());
                if (mlGeodeticDatumShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLGeodeticDatumType sourceMLGeodeticDatum;
                    sourceMLGeodeticDatum = this.getMLGeodeticDatum();
                    MLGeodeticDatumType copyMLGeodeticDatum = ((MLGeodeticDatumType) strategy.copy(LocatorUtils.property(locator, "mlGeodeticDatum", sourceMLGeodeticDatum), sourceMLGeodeticDatum, this.isSetMLGeodeticDatum()));
                    copy.setMLGeodeticDatum(copyMLGeodeticDatum);
                } else {
                    if (mlGeodeticDatumShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlGeodeticDatum = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLGeodeticDatumPropertyType) {
            final MLGeodeticDatumPropertyType target = this;
            final MLGeodeticDatumPropertyType leftObject = ((MLGeodeticDatumPropertyType) left);
            final MLGeodeticDatumPropertyType rightObject = ((MLGeodeticDatumPropertyType) right);
            {
                Boolean mlGeodeticDatumShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLGeodeticDatum(), rightObject.isSetMLGeodeticDatum());
                if (mlGeodeticDatumShouldBeMergedAndSet == Boolean.TRUE) {
                    MLGeodeticDatumType lhsMLGeodeticDatum;
                    lhsMLGeodeticDatum = leftObject.getMLGeodeticDatum();
                    MLGeodeticDatumType rhsMLGeodeticDatum;
                    rhsMLGeodeticDatum = rightObject.getMLGeodeticDatum();
                    MLGeodeticDatumType mergedMLGeodeticDatum = ((MLGeodeticDatumType) strategy.merge(LocatorUtils.property(leftLocator, "mlGeodeticDatum", lhsMLGeodeticDatum), LocatorUtils.property(rightLocator, "mlGeodeticDatum", rhsMLGeodeticDatum), lhsMLGeodeticDatum, rhsMLGeodeticDatum, leftObject.isSetMLGeodeticDatum(), rightObject.isSetMLGeodeticDatum()));
                    target.setMLGeodeticDatum(mergedMLGeodeticDatum);
                } else {
                    if (mlGeodeticDatumShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlGeodeticDatum = null;
                    }
                }
            }
            {
    ...
    public MLGeodeticDatumPropertyType withMLGeodeticDatum(MLGeodeticDatumType value) {
        setMLGeodeticDatum(value);
        return this;
    }

    public MLGeodeticDatumPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLGeodeticDatumPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLGeodeticDatumPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLGeodeticDatumPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLGeodeticDatumPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLGeodeticDatumPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLGeodeticDatumPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLGeodeticDatumPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLGeodeticDatumPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLGeodeticDatumPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLGeodeticDatumPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
