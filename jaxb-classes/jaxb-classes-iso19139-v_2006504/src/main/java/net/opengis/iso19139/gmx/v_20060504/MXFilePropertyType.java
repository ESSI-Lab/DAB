...
public class MXFilePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "abstractMXFile", buffer, theAbstractMXFile, this.isSetAbstractMXFile());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MXFilePropertyType that = ((MXFilePropertyType) object);
        {
            JAXBElement<? extends AbstractMXFileType> lhsAbstractMXFile;
            lhsAbstractMXFile = this.getAbstractMXFile();
            JAXBElement<? extends AbstractMXFileType> rhsAbstractMXFile;
            rhsAbstractMXFile = that.getAbstractMXFile();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractMXFile", lhsAbstractMXFile), LocatorUtils.property(thatLocator, "abstractMXFile", rhsAbstractMXFile), lhsAbstractMXFile, rhsAbstractMXFile, this.isSetAbstractMXFile(), that.isSetAbstractMXFile())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractMXFileType> theAbstractMXFile;
            theAbstractMXFile = this.getAbstractMXFile();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractMXFile", theAbstractMXFile), currentHashCode, theAbstractMXFile, this.isSetAbstractMXFile());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MXFilePropertyType) {
            final MXFilePropertyType copy = ((MXFilePropertyType) draftCopy);
            {
                Boolean abstractMXFileShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractMXFile());
                if (abstractMXFileShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractMXFileType> sourceAbstractMXFile;
                    sourceAbstractMXFile = this.getAbstractMXFile();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractMXFileType> copyAbstractMXFile = ((JAXBElement<? extends AbstractMXFileType> ) strategy.copy(LocatorUtils.property(locator, "abstractMXFile", sourceAbstractMXFile), sourceAbstractMXFile, this.isSetAbstractMXFile()));
                    copy.setAbstractMXFile(copyAbstractMXFile);
                } else {
                    if (abstractMXFileShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.abstractMXFile = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MXFilePropertyType) {
            final MXFilePropertyType target = this;
            final MXFilePropertyType leftObject = ((MXFilePropertyType) left);
            final MXFilePropertyType rightObject = ((MXFilePropertyType) right);
            {
                Boolean abstractMXFileShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractMXFile(), rightObject.isSetAbstractMXFile());
                if (abstractMXFileShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractMXFileType> lhsAbstractMXFile;
                    lhsAbstractMXFile = leftObject.getAbstractMXFile();
                    JAXBElement<? extends AbstractMXFileType> rhsAbstractMXFile;
                    rhsAbstractMXFile = rightObject.getAbstractMXFile();
                    JAXBElement<? extends AbstractMXFileType> mergedAbstractMXFile = ((JAXBElement<? extends AbstractMXFileType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractMXFile", lhsAbstractMXFile), LocatorUtils.property(rightLocator, "abstractMXFile", rhsAbstractMXFile), lhsAbstractMXFile, rhsAbstractMXFile, leftObject.isSetAbstractMXFile(), rightObject.isSetAbstractMXFile()));
                    target.setAbstractMXFile(mergedAbstractMXFile);
                } else {
                    if (abstractMXFileShouldBeMergedAndSet == Boolean.FALSE) {
                        target.abstractMXFile = null;
                    }
                }
            }
            {
    ...
    public MXFilePropertyType withAbstractMXFile(JAXBElement<? extends AbstractMXFileType> value) {
        setAbstractMXFile(value);
        return this;
    }

    public MXFilePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MXFilePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MXFilePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MXFilePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MXFilePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MXFilePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MXFilePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MXFilePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MXFilePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MXFilePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MXFilePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
