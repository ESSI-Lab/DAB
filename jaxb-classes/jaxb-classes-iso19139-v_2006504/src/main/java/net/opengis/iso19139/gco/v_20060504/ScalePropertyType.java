...
public class ScalePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "scale", buffer, theScale, this.isSetScale());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ScalePropertyType that = ((ScalePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "scale", lhsScale), LocatorUtils.property(thatLocator, "scale", rhsScale), lhsScale, rhsScale, this.isSetScale(), that.isSetScale())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            ScaleType theScale;
            theScale = this.getScale();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "scale", theScale), currentHashCode, theScale, this.isSetScale());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ScalePropertyType) {
            final ScalePropertyType copy = ((ScalePropertyType) draftCopy);
            {
                Boolean scaleShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetScale());
                if (scaleShouldBeCopiedAndSet == Boolean.TRUE) {
                    ScaleType sourceScale;
                    sourceScale = this.getScale();
                    ScaleType copyScale = ((ScaleType) strategy.copy(LocatorUtils.property(locator, "scale", sourceScale), sourceScale, this.isSetScale()));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ScalePropertyType) {
            final ScalePropertyType target = this;
            final ScalePropertyType leftObject = ((ScalePropertyType) left);
            final ScalePropertyType rightObject = ((ScalePropertyType) right);
            {
                Boolean scaleShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetScale(), rightObject.isSetScale());
                if (scaleShouldBeMergedAndSet == Boolean.TRUE) {
                    ScaleType lhsScale;
                    lhsScale = leftObject.getScale();
                    ScaleType rhsScale;
                    rhsScale = rightObject.getScale();
                    ScaleType mergedScale = ((ScaleType) strategy.merge(LocatorUtils.property(leftLocator, "scale", lhsScale), LocatorUtils.property(rightLocator, "scale", rhsScale), lhsScale, rhsScale, leftObject.isSetScale(), rightObject.isSetScale()));
    ...
    public ScalePropertyType withScale(ScaleType value) {
        setScale(value);
        return this;
    }

    public ScalePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public ScalePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public ScalePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
