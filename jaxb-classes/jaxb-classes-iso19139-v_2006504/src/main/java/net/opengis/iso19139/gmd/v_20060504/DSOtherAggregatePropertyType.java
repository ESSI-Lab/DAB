...
public class DSOtherAggregatePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "dsOtherAggregate", buffer, theDSOtherAggregate, this.isSetDSOtherAggregate());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<? extends DSOtherAggregateType> lhsDSOtherAggregate;
            lhsDSOtherAggregate = this.getDSOtherAggregate();
            JAXBElement<? extends DSOtherAggregateType> rhsDSOtherAggregate;
            rhsDSOtherAggregate = that.getDSOtherAggregate();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dsOtherAggregate", lhsDSOtherAggregate), LocatorUtils.property(thatLocator, "dsOtherAggregate", rhsDSOtherAggregate), lhsDSOtherAggregate, rhsDSOtherAggregate, this.isSetDSOtherAggregate(), that.isSetDSOtherAggregate())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends DSOtherAggregateType> theDSOtherAggregate;
            theDSOtherAggregate = this.getDSOtherAggregate();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dsOtherAggregate", theDSOtherAggregate), currentHashCode, theDSOtherAggregate, this.isSetDSOtherAggregate());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DSOtherAggregatePropertyType) {
            final DSOtherAggregatePropertyType copy = ((DSOtherAggregatePropertyType) draftCopy);
            {
                Boolean dsOtherAggregateShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDSOtherAggregate());
                if (dsOtherAggregateShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends DSOtherAggregateType> sourceDSOtherAggregate;
                    sourceDSOtherAggregate = this.getDSOtherAggregate();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends DSOtherAggregateType> copyDSOtherAggregate = ((JAXBElement<? extends DSOtherAggregateType> ) strategy.copy(LocatorUtils.property(locator, "dsOtherAggregate", sourceDSOtherAggregate), sourceDSOtherAggregate, this.isSetDSOtherAggregate()));
                    copy.setDSOtherAggregate(copyDSOtherAggregate);
                } else {
                    if (dsOtherAggregateShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.dsOtherAggregate = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DSOtherAggregatePropertyType) {
            final DSOtherAggregatePropertyType target = this;
            final DSOtherAggregatePropertyType leftObject = ((DSOtherAggregatePropertyType) left);
            final DSOtherAggregatePropertyType rightObject = ((DSOtherAggregatePropertyType) right);
            {
                Boolean dsOtherAggregateShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDSOtherAggregate(), rightObject.isSetDSOtherAggregate());
                if (dsOtherAggregateShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends DSOtherAggregateType> lhsDSOtherAggregate;
                    lhsDSOtherAggregate = leftObject.getDSOtherAggregate();
                    JAXBElement<? extends DSOtherAggregateType> rhsDSOtherAggregate;
                    rhsDSOtherAggregate = rightObject.getDSOtherAggregate();
                    JAXBElement<? extends DSOtherAggregateType> mergedDSOtherAggregate = ((JAXBElement<? extends DSOtherAggregateType> ) strategy.merge(LocatorUtils.property(leftLocator, "dsOtherAggregate", lhsDSOtherAggregate), LocatorUtils.property(rightLocator, "dsOtherAggregate", rhsDSOtherAggregate), lhsDSOtherAggregate, rhsDSOtherAggregate, leftObject.isSetDSOtherAggregate(), rightObject.isSetDSOtherAggregate()));
                    target.setDSOtherAggregate(mergedDSOtherAggregate);
                } else {
                    if (dsOtherAggregateShouldBeMergedAndSet == Boolean.FALSE) {
                        target.dsOtherAggregate = null;
                    }
                }
            }
            {
    ...
    public DSOtherAggregatePropertyType withDSOtherAggregate(JAXBElement<? extends DSOtherAggregateType> value) {
        setDSOtherAggregate(value);
        return this;
    }

    public DSOtherAggregatePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DSOtherAggregatePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DSOtherAggregatePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DSOtherAggregatePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DSOtherAggregatePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DSOtherAggregatePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DSOtherAggregatePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DSOtherAggregatePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DSOtherAggregatePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DSOtherAggregatePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DSOtherAggregatePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
