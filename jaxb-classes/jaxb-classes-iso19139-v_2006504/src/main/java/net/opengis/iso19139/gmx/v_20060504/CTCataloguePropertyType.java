...
public class CTCataloguePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "abstractCTCatalogue", buffer, theAbstractCTCatalogue, this.isSetAbstractCTCatalogue());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTCataloguePropertyType that = ((CTCataloguePropertyType) object);
        {
            JAXBElement<? extends AbstractCTCatalogueType> lhsAbstractCTCatalogue;
            lhsAbstractCTCatalogue = this.getAbstractCTCatalogue();
            JAXBElement<? extends AbstractCTCatalogueType> rhsAbstractCTCatalogue;
            rhsAbstractCTCatalogue = that.getAbstractCTCatalogue();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractCTCatalogue", lhsAbstractCTCatalogue), LocatorUtils.property(thatLocator, "abstractCTCatalogue", rhsAbstractCTCatalogue), lhsAbstractCTCatalogue, rhsAbstractCTCatalogue, this.isSetAbstractCTCatalogue(), that.isSetAbstractCTCatalogue())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractCTCatalogueType> theAbstractCTCatalogue;
            theAbstractCTCatalogue = this.getAbstractCTCatalogue();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractCTCatalogue", theAbstractCTCatalogue), currentHashCode, theAbstractCTCatalogue, this.isSetAbstractCTCatalogue());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CTCataloguePropertyType) {
            final CTCataloguePropertyType copy = ((CTCataloguePropertyType) draftCopy);
            {
                Boolean abstractCTCatalogueShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractCTCatalogue());
                if (abstractCTCatalogueShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractCTCatalogueType> sourceAbstractCTCatalogue;
                    sourceAbstractCTCatalogue = this.getAbstractCTCatalogue();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractCTCatalogueType> copyAbstractCTCatalogue = ((JAXBElement<? extends AbstractCTCatalogueType> ) strategy.copy(LocatorUtils.property(locator, "abstractCTCatalogue", sourceAbstractCTCatalogue), sourceAbstractCTCatalogue, this.isSetAbstractCTCatalogue()));
                    copy.setAbstractCTCatalogue(copyAbstractCTCatalogue);
                } else {
                    if (abstractCTCatalogueShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.abstractCTCatalogue = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CTCataloguePropertyType) {
            final CTCataloguePropertyType target = this;
            final CTCataloguePropertyType leftObject = ((CTCataloguePropertyType) left);
            final CTCataloguePropertyType rightObject = ((CTCataloguePropertyType) right);
            {
                Boolean abstractCTCatalogueShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractCTCatalogue(), rightObject.isSetAbstractCTCatalogue());
                if (abstractCTCatalogueShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractCTCatalogueType> lhsAbstractCTCatalogue;
                    lhsAbstractCTCatalogue = leftObject.getAbstractCTCatalogue();
                    JAXBElement<? extends AbstractCTCatalogueType> rhsAbstractCTCatalogue;
                    rhsAbstractCTCatalogue = rightObject.getAbstractCTCatalogue();
                    JAXBElement<? extends AbstractCTCatalogueType> mergedAbstractCTCatalogue = ((JAXBElement<? extends AbstractCTCatalogueType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractCTCatalogue", lhsAbstractCTCatalogue), LocatorUtils.property(rightLocator, "abstractCTCatalogue", rhsAbstractCTCatalogue), lhsAbstractCTCatalogue, rhsAbstractCTCatalogue, leftObject.isSetAbstractCTCatalogue(), rightObject.isSetAbstractCTCatalogue()));
                    target.setAbstractCTCatalogue(mergedAbstractCTCatalogue);
                } else {
                    if (abstractCTCatalogueShouldBeMergedAndSet == Boolean.FALSE) {
                        target.abstractCTCatalogue = null;
                    }
                }
            }
            {
    ...
    public CTCataloguePropertyType withAbstractCTCatalogue(JAXBElement<? extends AbstractCTCatalogueType> value) {
        setAbstractCTCatalogue(value);
        return this;
    }

    public CTCataloguePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CTCataloguePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CTCataloguePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public CTCataloguePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CTCataloguePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CTCataloguePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CTCataloguePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CTCataloguePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CTCataloguePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CTCataloguePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CTCataloguePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
