...
public class DSSeriesPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "dsSeries", buffer, theDSSeries, this.isSetDSSeries());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<? extends DSSeriesType> lhsDSSeries;
            lhsDSSeries = this.getDSSeries();
            JAXBElement<? extends DSSeriesType> rhsDSSeries;
            rhsDSSeries = that.getDSSeries();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dsSeries", lhsDSSeries), LocatorUtils.property(thatLocator, "dsSeries", rhsDSSeries), lhsDSSeries, rhsDSSeries, this.isSetDSSeries(), that.isSetDSSeries())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends DSSeriesType> theDSSeries;
            theDSSeries = this.getDSSeries();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dsSeries", theDSSeries), currentHashCode, theDSSeries, this.isSetDSSeries());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DSSeriesPropertyType) {
            final DSSeriesPropertyType copy = ((DSSeriesPropertyType) draftCopy);
            {
                Boolean dsSeriesShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDSSeries());
                if (dsSeriesShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends DSSeriesType> sourceDSSeries;
                    sourceDSSeries = this.getDSSeries();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends DSSeriesType> copyDSSeries = ((JAXBElement<? extends DSSeriesType> ) strategy.copy(LocatorUtils.property(locator, "dsSeries", sourceDSSeries), sourceDSSeries, this.isSetDSSeries()));
                    copy.setDSSeries(copyDSSeries);
                } else {
                    if (dsSeriesShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.dsSeries = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DSSeriesPropertyType) {
            final DSSeriesPropertyType target = this;
            final DSSeriesPropertyType leftObject = ((DSSeriesPropertyType) left);
            final DSSeriesPropertyType rightObject = ((DSSeriesPropertyType) right);
            {
                Boolean dsSeriesShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDSSeries(), rightObject.isSetDSSeries());
                if (dsSeriesShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends DSSeriesType> lhsDSSeries;
                    lhsDSSeries = leftObject.getDSSeries();
                    JAXBElement<? extends DSSeriesType> rhsDSSeries;
                    rhsDSSeries = rightObject.getDSSeries();
                    JAXBElement<? extends DSSeriesType> mergedDSSeries = ((JAXBElement<? extends DSSeriesType> ) strategy.merge(LocatorUtils.property(leftLocator, "dsSeries", lhsDSSeries), LocatorUtils.property(rightLocator, "dsSeries", rhsDSSeries), lhsDSSeries, rhsDSSeries, leftObject.isSetDSSeries(), rightObject.isSetDSSeries()));
                    target.setDSSeries(mergedDSSeries);
                } else {
                    if (dsSeriesShouldBeMergedAndSet == Boolean.FALSE) {
                        target.dsSeries = null;
                    }
                }
            }
            {
    ...
    public DSSeriesPropertyType withDSSeries(JAXBElement<? extends DSSeriesType> value) {
        setDSSeries(value);
        return this;
    }

    public DSSeriesPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DSSeriesPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DSSeriesPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DSSeriesPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DSSeriesPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DSSeriesPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DSSeriesPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DSSeriesPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DSSeriesPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DSSeriesPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DSSeriesPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
