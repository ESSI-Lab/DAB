...
public class EXVerticalExtentPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "exVerticalExtent", buffer, theEXVerticalExtent, this.isSetEXVerticalExtent());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            EXVerticalExtentType lhsEXVerticalExtent;
            lhsEXVerticalExtent = this.getEXVerticalExtent();
            EXVerticalExtentType rhsEXVerticalExtent;
            rhsEXVerticalExtent = that.getEXVerticalExtent();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "exVerticalExtent", lhsEXVerticalExtent), LocatorUtils.property(thatLocator, "exVerticalExtent", rhsEXVerticalExtent), lhsEXVerticalExtent, rhsEXVerticalExtent, this.isSetEXVerticalExtent(), that.isSetEXVerticalExtent())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            EXVerticalExtentType theEXVerticalExtent;
            theEXVerticalExtent = this.getEXVerticalExtent();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "exVerticalExtent", theEXVerticalExtent), currentHashCode, theEXVerticalExtent, this.isSetEXVerticalExtent());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof EXVerticalExtentPropertyType) {
            final EXVerticalExtentPropertyType copy = ((EXVerticalExtentPropertyType) draftCopy);
            {
                Boolean exVerticalExtentShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetEXVerticalExtent());
                if (exVerticalExtentShouldBeCopiedAndSet == Boolean.TRUE) {
                    EXVerticalExtentType sourceEXVerticalExtent;
                    sourceEXVerticalExtent = this.getEXVerticalExtent();
                    EXVerticalExtentType copyEXVerticalExtent = ((EXVerticalExtentType) strategy.copy(LocatorUtils.property(locator, "exVerticalExtent", sourceEXVerticalExtent), sourceEXVerticalExtent, this.isSetEXVerticalExtent()));
                    copy.setEXVerticalExtent(copyEXVerticalExtent);
                } else {
                    if (exVerticalExtentShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.exVerticalExtent = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof EXVerticalExtentPropertyType) {
            final EXVerticalExtentPropertyType target = this;
            final EXVerticalExtentPropertyType leftObject = ((EXVerticalExtentPropertyType) left);
            final EXVerticalExtentPropertyType rightObject = ((EXVerticalExtentPropertyType) right);
            {
                Boolean exVerticalExtentShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetEXVerticalExtent(), rightObject.isSetEXVerticalExtent());
                if (exVerticalExtentShouldBeMergedAndSet == Boolean.TRUE) {
                    EXVerticalExtentType lhsEXVerticalExtent;
                    lhsEXVerticalExtent = leftObject.getEXVerticalExtent();
                    EXVerticalExtentType rhsEXVerticalExtent;
                    rhsEXVerticalExtent = rightObject.getEXVerticalExtent();
                    EXVerticalExtentType mergedEXVerticalExtent = ((EXVerticalExtentType) strategy.merge(LocatorUtils.property(leftLocator, "exVerticalExtent", lhsEXVerticalExtent), LocatorUtils.property(rightLocator, "exVerticalExtent", rhsEXVerticalExtent), lhsEXVerticalExtent, rhsEXVerticalExtent, leftObject.isSetEXVerticalExtent(), rightObject.isSetEXVerticalExtent()));
                    target.setEXVerticalExtent(mergedEXVerticalExtent);
                } else {
                    if (exVerticalExtentShouldBeMergedAndSet == Boolean.FALSE) {
                        target.exVerticalExtent = null;
                    }
                }
            }
            {
    ...
    public EXVerticalExtentPropertyType withEXVerticalExtent(EXVerticalExtentType value) {
        setEXVerticalExtent(value);
        return this;
    }

    public EXVerticalExtentPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public EXVerticalExtentPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public EXVerticalExtentPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public EXVerticalExtentPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public EXVerticalExtentPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public EXVerticalExtentPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public EXVerticalExtentPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public EXVerticalExtentPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public EXVerticalExtentPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public EXVerticalExtentPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public EXVerticalExtentPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
