...
public class LanguageCodePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            CodeListValueType lhsLanguageCode;
            lhsLanguageCode = this.getLanguageCode();
            CodeListValueType rhsLanguageCode;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof LanguageCodePropertyType) {
            final LanguageCodePropertyType copy = ((LanguageCodePropertyType) draftCopy);
            {
                ...
                if (languageCodeShouldBeCopiedAndSet == Boolean.TRUE) {
                    CodeListValueType sourceLanguageCode;
                    sourceLanguageCode = this.getLanguageCode();
                    CodeListValueType copyLanguageCode = ((CodeListValueType) strategy.copy(LocatorUtils.property(locator, "languageCode", sourceLanguageCode), sourceLanguageCode, this.isSetLanguageCode()));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof LanguageCodePropertyType) {
            final LanguageCodePropertyType target = this;
            final LanguageCodePropertyType leftObject = ((LanguageCodePropertyType) left);
            final LanguageCodePropertyType rightObject = ((LanguageCodePropertyType) right);
            {
                ...
                if (languageCodeShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    CodeListValueType mergedLanguageCode = ((CodeListValueType) strategy.merge(LocatorUtils.property(leftLocator, "languageCode", lhsLanguageCode), LocatorUtils.property(rightLocator, "languageCode", rhsLanguageCode), lhsLanguageCode, rhsLanguageCode, leftObject.isSetLanguageCode(), rightObject.isSetLanguageCode()));
    ...
    public LanguageCodePropertyType withLanguageCode(CodeListValueType value) {
        setLanguageCode(value);
        return this;
    }

    public LanguageCodePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public LanguageCodePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public LanguageCodePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
