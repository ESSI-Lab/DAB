...
public class DQScopePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "dqScope", buffer, theDQScope, this.isSetDQScope());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            DQScopeType lhsDQScope;
            lhsDQScope = this.getDQScope();
            DQScopeType rhsDQScope;
            rhsDQScope = that.getDQScope();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dqScope", lhsDQScope), LocatorUtils.property(thatLocator, "dqScope", rhsDQScope), lhsDQScope, rhsDQScope, this.isSetDQScope(), that.isSetDQScope())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            DQScopeType theDQScope;
            theDQScope = this.getDQScope();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dqScope", theDQScope), currentHashCode, theDQScope, this.isSetDQScope());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DQScopePropertyType) {
            final DQScopePropertyType copy = ((DQScopePropertyType) draftCopy);
            {
                Boolean dqScopeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDQScope());
                if (dqScopeShouldBeCopiedAndSet == Boolean.TRUE) {
                    DQScopeType sourceDQScope;
                    sourceDQScope = this.getDQScope();
                    DQScopeType copyDQScope = ((DQScopeType) strategy.copy(LocatorUtils.property(locator, "dqScope", sourceDQScope), sourceDQScope, this.isSetDQScope()));
                    copy.setDQScope(copyDQScope);
                } else {
                    if (dqScopeShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.dqScope = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DQScopePropertyType) {
            final DQScopePropertyType target = this;
            final DQScopePropertyType leftObject = ((DQScopePropertyType) left);
            final DQScopePropertyType rightObject = ((DQScopePropertyType) right);
            {
                Boolean dqScopeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDQScope(), rightObject.isSetDQScope());
                if (dqScopeShouldBeMergedAndSet == Boolean.TRUE) {
                    DQScopeType lhsDQScope;
                    lhsDQScope = leftObject.getDQScope();
                    DQScopeType rhsDQScope;
                    rhsDQScope = rightObject.getDQScope();
                    DQScopeType mergedDQScope = ((DQScopeType) strategy.merge(LocatorUtils.property(leftLocator, "dqScope", lhsDQScope), LocatorUtils.property(rightLocator, "dqScope", rhsDQScope), lhsDQScope, rhsDQScope, leftObject.isSetDQScope(), rightObject.isSetDQScope()));
                    target.setDQScope(mergedDQScope);
                } else {
                    if (dqScopeShouldBeMergedAndSet == Boolean.FALSE) {
                        target.dqScope = null;
                    }
                }
            }
    ...
    public DQScopePropertyType withDQScope(DQScopeType value) {
        setDQScope(value);
        return this;
    }

    public DQScopePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DQScopePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DQScopePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DQScopePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DQScopePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DQScopePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DQScopePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DQScopePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DQScopePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DQScopePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DQScopePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
