...
public class MLVerticalCSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlVerticalCS", buffer, theMLVerticalCS, this.isSetMLVerticalCS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLVerticalCSPropertyType that = ((MLVerticalCSPropertyType) object);
        {
            MLVerticalCSType lhsMLVerticalCS;
            lhsMLVerticalCS = this.getMLVerticalCS();
            MLVerticalCSType rhsMLVerticalCS;
            rhsMLVerticalCS = that.getMLVerticalCS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlVerticalCS", lhsMLVerticalCS), LocatorUtils.property(thatLocator, "mlVerticalCS", rhsMLVerticalCS), lhsMLVerticalCS, rhsMLVerticalCS, this.isSetMLVerticalCS(), that.isSetMLVerticalCS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLVerticalCSType theMLVerticalCS;
            theMLVerticalCS = this.getMLVerticalCS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlVerticalCS", theMLVerticalCS), currentHashCode, theMLVerticalCS, this.isSetMLVerticalCS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLVerticalCSPropertyType) {
            final MLVerticalCSPropertyType copy = ((MLVerticalCSPropertyType) draftCopy);
            {
                Boolean mlVerticalCSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLVerticalCS());
                if (mlVerticalCSShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLVerticalCSType sourceMLVerticalCS;
                    sourceMLVerticalCS = this.getMLVerticalCS();
                    MLVerticalCSType copyMLVerticalCS = ((MLVerticalCSType) strategy.copy(LocatorUtils.property(locator, "mlVerticalCS", sourceMLVerticalCS), sourceMLVerticalCS, this.isSetMLVerticalCS()));
                    copy.setMLVerticalCS(copyMLVerticalCS);
                } else {
                    if (mlVerticalCSShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlVerticalCS = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLVerticalCSPropertyType) {
            final MLVerticalCSPropertyType target = this;
            final MLVerticalCSPropertyType leftObject = ((MLVerticalCSPropertyType) left);
            final MLVerticalCSPropertyType rightObject = ((MLVerticalCSPropertyType) right);
            {
                Boolean mlVerticalCSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLVerticalCS(), rightObject.isSetMLVerticalCS());
                if (mlVerticalCSShouldBeMergedAndSet == Boolean.TRUE) {
                    MLVerticalCSType lhsMLVerticalCS;
                    lhsMLVerticalCS = leftObject.getMLVerticalCS();
                    MLVerticalCSType rhsMLVerticalCS;
                    rhsMLVerticalCS = rightObject.getMLVerticalCS();
                    MLVerticalCSType mergedMLVerticalCS = ((MLVerticalCSType) strategy.merge(LocatorUtils.property(leftLocator, "mlVerticalCS", lhsMLVerticalCS), LocatorUtils.property(rightLocator, "mlVerticalCS", rhsMLVerticalCS), lhsMLVerticalCS, rhsMLVerticalCS, leftObject.isSetMLVerticalCS(), rightObject.isSetMLVerticalCS()));
                    target.setMLVerticalCS(mergedMLVerticalCS);
                } else {
                    if (mlVerticalCSShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlVerticalCS = null;
                    }
                }
            }
            {
    ...
    public MLVerticalCSPropertyType withMLVerticalCS(MLVerticalCSType value) {
        setMLVerticalCS(value);
        return this;
    }

    public MLVerticalCSPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLVerticalCSPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLVerticalCSPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLVerticalCSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLVerticalCSPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLVerticalCSPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLVerticalCSPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLVerticalCSPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLVerticalCSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLVerticalCSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLVerticalCSPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
