...
public class CIAddressPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "ciAddress", buffer, theCIAddress, this.isSetCIAddress());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            CIAddressType lhsCIAddress;
            lhsCIAddress = this.getCIAddress();
            CIAddressType rhsCIAddress;
            rhsCIAddress = that.getCIAddress();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ciAddress", lhsCIAddress), LocatorUtils.property(thatLocator, "ciAddress", rhsCIAddress), lhsCIAddress, rhsCIAddress, this.isSetCIAddress(), that.isSetCIAddress())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            CIAddressType theCIAddress;
            theCIAddress = this.getCIAddress();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ciAddress", theCIAddress), currentHashCode, theCIAddress, this.isSetCIAddress());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CIAddressPropertyType) {
            final CIAddressPropertyType copy = ((CIAddressPropertyType) draftCopy);
            {
                Boolean ciAddressShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCIAddress());
                if (ciAddressShouldBeCopiedAndSet == Boolean.TRUE) {
                    CIAddressType sourceCIAddress;
                    sourceCIAddress = this.getCIAddress();
                    CIAddressType copyCIAddress = ((CIAddressType) strategy.copy(LocatorUtils.property(locator, "ciAddress", sourceCIAddress), sourceCIAddress, this.isSetCIAddress()));
                    copy.setCIAddress(copyCIAddress);
                } else {
                    if (ciAddressShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.ciAddress = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CIAddressPropertyType) {
            final CIAddressPropertyType target = this;
            final CIAddressPropertyType leftObject = ((CIAddressPropertyType) left);
            final CIAddressPropertyType rightObject = ((CIAddressPropertyType) right);
            {
                Boolean ciAddressShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCIAddress(), rightObject.isSetCIAddress());
                if (ciAddressShouldBeMergedAndSet == Boolean.TRUE) {
                    CIAddressType lhsCIAddress;
                    lhsCIAddress = leftObject.getCIAddress();
                    CIAddressType rhsCIAddress;
                    rhsCIAddress = rightObject.getCIAddress();
                    CIAddressType mergedCIAddress = ((CIAddressType) strategy.merge(LocatorUtils.property(leftLocator, "ciAddress", lhsCIAddress), LocatorUtils.property(rightLocator, "ciAddress", rhsCIAddress), lhsCIAddress, rhsCIAddress, leftObject.isSetCIAddress(), rightObject.isSetCIAddress()));
                    target.setCIAddress(mergedCIAddress);
                } else {
                    if (ciAddressShouldBeMergedAndSet == Boolean.FALSE) {
                        target.ciAddress = null;
                    }
                }
            }
            {
    ...
    public CIAddressPropertyType withCIAddress(CIAddressType value) {
        setCIAddress(value);
        return this;
    }

    public CIAddressPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CIAddressPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CIAddressPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public CIAddressPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CIAddressPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CIAddressPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CIAddressPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CIAddressPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CIAddressPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CIAddressPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CIAddressPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
