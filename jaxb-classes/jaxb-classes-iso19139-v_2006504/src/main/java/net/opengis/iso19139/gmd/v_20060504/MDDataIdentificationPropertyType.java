...
public class MDDataIdentificationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdDataIdentification", buffer, theMDDataIdentification, this.isSetMDDataIdentification());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            MDDataIdentificationType lhsMDDataIdentification;
            lhsMDDataIdentification = this.getMDDataIdentification();
            MDDataIdentificationType rhsMDDataIdentification;
            rhsMDDataIdentification = that.getMDDataIdentification();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdDataIdentification", lhsMDDataIdentification), LocatorUtils.property(thatLocator, "mdDataIdentification", rhsMDDataIdentification), lhsMDDataIdentification, rhsMDDataIdentification, this.isSetMDDataIdentification(), that.isSetMDDataIdentification())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MDDataIdentificationType theMDDataIdentification;
            theMDDataIdentification = this.getMDDataIdentification();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdDataIdentification", theMDDataIdentification), currentHashCode, theMDDataIdentification, this.isSetMDDataIdentification());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDDataIdentificationPropertyType) {
            final MDDataIdentificationPropertyType copy = ((MDDataIdentificationPropertyType) draftCopy);
            {
                Boolean mdDataIdentificationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDDataIdentification());
                if (mdDataIdentificationShouldBeCopiedAndSet == Boolean.TRUE) {
                    MDDataIdentificationType sourceMDDataIdentification;
                    sourceMDDataIdentification = this.getMDDataIdentification();
                    MDDataIdentificationType copyMDDataIdentification = ((MDDataIdentificationType) strategy.copy(LocatorUtils.property(locator, "mdDataIdentification", sourceMDDataIdentification), sourceMDDataIdentification, this.isSetMDDataIdentification()));
                    copy.setMDDataIdentification(copyMDDataIdentification);
                } else {
                    if (mdDataIdentificationShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdDataIdentification = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDDataIdentificationPropertyType) {
            final MDDataIdentificationPropertyType target = this;
            final MDDataIdentificationPropertyType leftObject = ((MDDataIdentificationPropertyType) left);
            final MDDataIdentificationPropertyType rightObject = ((MDDataIdentificationPropertyType) right);
            {
                Boolean mdDataIdentificationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDDataIdentification(), rightObject.isSetMDDataIdentification());
                if (mdDataIdentificationShouldBeMergedAndSet == Boolean.TRUE) {
                    MDDataIdentificationType lhsMDDataIdentification;
                    lhsMDDataIdentification = leftObject.getMDDataIdentification();
                    MDDataIdentificationType rhsMDDataIdentification;
                    rhsMDDataIdentification = rightObject.getMDDataIdentification();
                    MDDataIdentificationType mergedMDDataIdentification = ((MDDataIdentificationType) strategy.merge(LocatorUtils.property(leftLocator, "mdDataIdentification", lhsMDDataIdentification), LocatorUtils.property(rightLocator, "mdDataIdentification", rhsMDDataIdentification), lhsMDDataIdentification, rhsMDDataIdentification, leftObject.isSetMDDataIdentification(), rightObject.isSetMDDataIdentification()));
                    target.setMDDataIdentification(mergedMDDataIdentification);
                } else {
                    if (mdDataIdentificationShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdDataIdentification = null;
                    }
                }
            }
            {
    ...
    public MDDataIdentificationPropertyType withMDDataIdentification(MDDataIdentificationType value) {
        setMDDataIdentification(value);
        return this;
    }

    public MDDataIdentificationPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDDataIdentificationPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDDataIdentificationPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDDataIdentificationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDDataIdentificationPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDDataIdentificationPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDDataIdentificationPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDDataIdentificationPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDDataIdentificationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDDataIdentificationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDDataIdentificationPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
