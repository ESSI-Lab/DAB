...
public class CountryPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            CodeListValueType lhsCountry;
            lhsCountry = this.getCountry();
            CodeListValueType rhsCountry;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CountryPropertyType) {
            final CountryPropertyType copy = ((CountryPropertyType) draftCopy);
            {
                ...
                if (countryShouldBeCopiedAndSet == Boolean.TRUE) {
                    CodeListValueType sourceCountry;
                    sourceCountry = this.getCountry();
                    CodeListValueType copyCountry = ((CodeListValueType) strategy.copy(LocatorUtils.property(locator, "country", sourceCountry), sourceCountry, this.isSetCountry()));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CountryPropertyType) {
            final CountryPropertyType target = this;
            final CountryPropertyType leftObject = ((CountryPropertyType) left);
            final CountryPropertyType rightObject = ((CountryPropertyType) right);
            {
                ...
                if (countryShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    CodeListValueType mergedCountry = ((CodeListValueType) strategy.merge(LocatorUtils.property(leftLocator, "country", lhsCountry), LocatorUtils.property(rightLocator, "country", rhsCountry), lhsCountry, rhsCountry, leftObject.isSetCountry(), rightObject.isSetCountry()));
    ...
    public CountryPropertyType withCountry(CodeListValueType value) {
        setCountry(value);
        return this;
    }

    public CountryPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CountryPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CountryPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
