...
public class SVServiceSpecificationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    @XmlElementRef(name = "SV_ServiceSpecification", namespace = "http://www.isotc211.org/2005/srv", type = JAXBElement.class, required = false)
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "svServiceSpecification", buffer, theSVServiceSpecification, this.isSetSVServiceSpecification());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SVServiceSpecificationPropertyType that = ((SVServiceSpecificationPropertyType) object);
        {
            JAXBElement<? extends SVServiceSpecificationType> lhsSVServiceSpecification;
            lhsSVServiceSpecification = this.getSVServiceSpecification();
            JAXBElement<? extends SVServiceSpecificationType> rhsSVServiceSpecification;
            rhsSVServiceSpecification = that.getSVServiceSpecification();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "svServiceSpecification", lhsSVServiceSpecification), LocatorUtils.property(thatLocator, "svServiceSpecification", rhsSVServiceSpecification), lhsSVServiceSpecification, rhsSVServiceSpecification, this.isSetSVServiceSpecification(), that.isSetSVServiceSpecification())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends SVServiceSpecificationType> theSVServiceSpecification;
            theSVServiceSpecification = this.getSVServiceSpecification();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "svServiceSpecification", theSVServiceSpecification), currentHashCode, theSVServiceSpecification, this.isSetSVServiceSpecification());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SVServiceSpecificationPropertyType) {
            final SVServiceSpecificationPropertyType copy = ((SVServiceSpecificationPropertyType) draftCopy);
            {
                Boolean svServiceSpecificationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSVServiceSpecification());
                if (svServiceSpecificationShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends SVServiceSpecificationType> sourceSVServiceSpecification;
                    sourceSVServiceSpecification = this.getSVServiceSpecification();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends SVServiceSpecificationType> copySVServiceSpecification = ((JAXBElement<? extends SVServiceSpecificationType> ) strategy.copy(LocatorUtils.property(locator, "svServiceSpecification", sourceSVServiceSpecification), sourceSVServiceSpecification, this.isSetSVServiceSpecification()));
                    copy.setSVServiceSpecification(copySVServiceSpecification);
                } else {
                    if (svServiceSpecificationShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.svServiceSpecification = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SVServiceSpecificationPropertyType) {
            final SVServiceSpecificationPropertyType target = this;
            final SVServiceSpecificationPropertyType leftObject = ((SVServiceSpecificationPropertyType) left);
            final SVServiceSpecificationPropertyType rightObject = ((SVServiceSpecificationPropertyType) right);
            {
                Boolean svServiceSpecificationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSVServiceSpecification(), rightObject.isSetSVServiceSpecification());
                if (svServiceSpecificationShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends SVServiceSpecificationType> lhsSVServiceSpecification;
                    lhsSVServiceSpecification = leftObject.getSVServiceSpecification();
                    JAXBElement<? extends SVServiceSpecificationType> rhsSVServiceSpecification;
                    rhsSVServiceSpecification = rightObject.getSVServiceSpecification();
                    JAXBElement<? extends SVServiceSpecificationType> mergedSVServiceSpecification = ((JAXBElement<? extends SVServiceSpecificationType> ) strategy.merge(LocatorUtils.property(leftLocator, "svServiceSpecification", lhsSVServiceSpecification), LocatorUtils.property(rightLocator, "svServiceSpecification", rhsSVServiceSpecification), lhsSVServiceSpecification, rhsSVServiceSpecification, leftObject.isSetSVServiceSpecification(), rightObject.isSetSVServiceSpecification()));
                    target.setSVServiceSpecification(mergedSVServiceSpecification);
                } else {
                    if (svServiceSpecificationShouldBeMergedAndSet == Boolean.FALSE) {
                        target.svServiceSpecification = null;
                    }
                }
            }
            {
    ...
    public SVServiceSpecificationPropertyType withSVServiceSpecification(JAXBElement<? extends SVServiceSpecificationType> value) {
        setSVServiceSpecification(value);
        return this;
    }

    public SVServiceSpecificationPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public SVServiceSpecificationPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public SVServiceSpecificationPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public SVServiceSpecificationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SVServiceSpecificationPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public SVServiceSpecificationPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public SVServiceSpecificationPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SVServiceSpecificationPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SVServiceSpecificationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SVServiceSpecificationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public SVServiceSpecificationPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
