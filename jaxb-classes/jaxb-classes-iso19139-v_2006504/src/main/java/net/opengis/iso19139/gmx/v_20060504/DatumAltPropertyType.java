...
public class DatumAltPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "datumAlt", buffer, theDatumAlt, this.isSetDatumAlt());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DatumAltPropertyType that = ((DatumAltPropertyType) object);
        {
            DatumAltType lhsDatumAlt;
            lhsDatumAlt = this.getDatumAlt();
            DatumAltType rhsDatumAlt;
            rhsDatumAlt = that.getDatumAlt();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "datumAlt", lhsDatumAlt), LocatorUtils.property(thatLocator, "datumAlt", rhsDatumAlt), lhsDatumAlt, rhsDatumAlt, this.isSetDatumAlt(), that.isSetDatumAlt())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            DatumAltType theDatumAlt;
            theDatumAlt = this.getDatumAlt();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "datumAlt", theDatumAlt), currentHashCode, theDatumAlt, this.isSetDatumAlt());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DatumAltPropertyType) {
            final DatumAltPropertyType copy = ((DatumAltPropertyType) draftCopy);
            {
                Boolean datumAltShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDatumAlt());
                if (datumAltShouldBeCopiedAndSet == Boolean.TRUE) {
                    DatumAltType sourceDatumAlt;
                    sourceDatumAlt = this.getDatumAlt();
                    DatumAltType copyDatumAlt = ((DatumAltType) strategy.copy(LocatorUtils.property(locator, "datumAlt", sourceDatumAlt), sourceDatumAlt, this.isSetDatumAlt()));
                    copy.setDatumAlt(copyDatumAlt);
                } else {
                    if (datumAltShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.datumAlt = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DatumAltPropertyType) {
            final DatumAltPropertyType target = this;
            final DatumAltPropertyType leftObject = ((DatumAltPropertyType) left);
            final DatumAltPropertyType rightObject = ((DatumAltPropertyType) right);
            {
                Boolean datumAltShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDatumAlt(), rightObject.isSetDatumAlt());
                if (datumAltShouldBeMergedAndSet == Boolean.TRUE) {
                    DatumAltType lhsDatumAlt;
                    lhsDatumAlt = leftObject.getDatumAlt();
                    DatumAltType rhsDatumAlt;
                    rhsDatumAlt = rightObject.getDatumAlt();
                    DatumAltType mergedDatumAlt = ((DatumAltType) strategy.merge(LocatorUtils.property(leftLocator, "datumAlt", lhsDatumAlt), LocatorUtils.property(rightLocator, "datumAlt", rhsDatumAlt), lhsDatumAlt, rhsDatumAlt, leftObject.isSetDatumAlt(), rightObject.isSetDatumAlt()));
                    target.setDatumAlt(mergedDatumAlt);
                } else {
                    if (datumAltShouldBeMergedAndSet == Boolean.FALSE) {
                        target.datumAlt = null;
                    }
                }
            }
            {
    ...
    public DatumAltPropertyType withDatumAlt(DatumAltType value) {
        setDatumAlt(value);
        return this;
    }

    public DatumAltPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DatumAltPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DatumAltPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DatumAltPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DatumAltPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DatumAltPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DatumAltPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DatumAltPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DatumAltPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DatumAltPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DatumAltPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
