...
import net.opengis.gml.v_3_2_0.DefinitionType;
    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CodeAlternativeExpressionType that = ((CodeAlternativeExpressionType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CodeAlternativeExpressionType) {
            final CodeAlternativeExpressionType copy = ((CodeAlternativeExpressionType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof CodeAlternativeExpressionType) {
            final CodeAlternativeExpressionType target = this;
            final CodeAlternativeExpressionType leftObject = ((CodeAlternativeExpressionType) left);
            final CodeAlternativeExpressionType rightObject = ((CodeAlternativeExpressionType) right);
            {
    ...
    public CodeAlternativeExpressionType withLocale(PTLocalePropertyType value) {
        setLocale(value);
        return this;
    }

    public CodeAlternativeExpressionType withCodeSpace(String value) {
        setCodeSpace(value);
        return this;
    }
