...
public class DSAggregatePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "abstractDSAggregate", buffer, theAbstractDSAggregate, this.isSetAbstractDSAggregate());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<? extends AbstractDSAggregateType> lhsAbstractDSAggregate;
            lhsAbstractDSAggregate = this.getAbstractDSAggregate();
            JAXBElement<? extends AbstractDSAggregateType> rhsAbstractDSAggregate;
            rhsAbstractDSAggregate = that.getAbstractDSAggregate();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractDSAggregate", lhsAbstractDSAggregate), LocatorUtils.property(thatLocator, "abstractDSAggregate", rhsAbstractDSAggregate), lhsAbstractDSAggregate, rhsAbstractDSAggregate, this.isSetAbstractDSAggregate(), that.isSetAbstractDSAggregate())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractDSAggregateType> theAbstractDSAggregate;
            theAbstractDSAggregate = this.getAbstractDSAggregate();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractDSAggregate", theAbstractDSAggregate), currentHashCode, theAbstractDSAggregate, this.isSetAbstractDSAggregate());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DSAggregatePropertyType) {
            final DSAggregatePropertyType copy = ((DSAggregatePropertyType) draftCopy);
            {
                Boolean abstractDSAggregateShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractDSAggregate());
                if (abstractDSAggregateShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractDSAggregateType> sourceAbstractDSAggregate;
                    sourceAbstractDSAggregate = this.getAbstractDSAggregate();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractDSAggregateType> copyAbstractDSAggregate = ((JAXBElement<? extends AbstractDSAggregateType> ) strategy.copy(LocatorUtils.property(locator, "abstractDSAggregate", sourceAbstractDSAggregate), sourceAbstractDSAggregate, this.isSetAbstractDSAggregate()));
                    copy.setAbstractDSAggregate(copyAbstractDSAggregate);
                } else {
                    if (abstractDSAggregateShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.abstractDSAggregate = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DSAggregatePropertyType) {
            final DSAggregatePropertyType target = this;
            final DSAggregatePropertyType leftObject = ((DSAggregatePropertyType) left);
            final DSAggregatePropertyType rightObject = ((DSAggregatePropertyType) right);
            {
                Boolean abstractDSAggregateShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractDSAggregate(), rightObject.isSetAbstractDSAggregate());
                if (abstractDSAggregateShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractDSAggregateType> lhsAbstractDSAggregate;
                    lhsAbstractDSAggregate = leftObject.getAbstractDSAggregate();
                    JAXBElement<? extends AbstractDSAggregateType> rhsAbstractDSAggregate;
                    rhsAbstractDSAggregate = rightObject.getAbstractDSAggregate();
                    JAXBElement<? extends AbstractDSAggregateType> mergedAbstractDSAggregate = ((JAXBElement<? extends AbstractDSAggregateType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractDSAggregate", lhsAbstractDSAggregate), LocatorUtils.property(rightLocator, "abstractDSAggregate", rhsAbstractDSAggregate), lhsAbstractDSAggregate, rhsAbstractDSAggregate, leftObject.isSetAbstractDSAggregate(), rightObject.isSetAbstractDSAggregate()));
                    target.setAbstractDSAggregate(mergedAbstractDSAggregate);
                } else {
                    if (abstractDSAggregateShouldBeMergedAndSet == Boolean.FALSE) {
                        target.abstractDSAggregate = null;
                    }
                }
            }
            {
    ...
    public DSAggregatePropertyType withAbstractDSAggregate(JAXBElement<? extends AbstractDSAggregateType> value) {
        setAbstractDSAggregate(value);
        return this;
    }

    public DSAggregatePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DSAggregatePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DSAggregatePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DSAggregatePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DSAggregatePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DSAggregatePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DSAggregatePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DSAggregatePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DSAggregatePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DSAggregatePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DSAggregatePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
