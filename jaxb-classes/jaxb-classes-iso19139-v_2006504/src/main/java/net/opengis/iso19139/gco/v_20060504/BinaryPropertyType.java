...
public class BinaryPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "binary", buffer, theBinary, this.isSetBinary());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            BinaryType lhsBinary;
            lhsBinary = this.getBinary();
            BinaryType rhsBinary;
            rhsBinary = that.getBinary();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "binary", lhsBinary), LocatorUtils.property(thatLocator, "binary", rhsBinary), lhsBinary, rhsBinary, this.isSetBinary(), that.isSetBinary())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            BinaryType theBinary;
            theBinary = this.getBinary();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "binary", theBinary), currentHashCode, theBinary, this.isSetBinary());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof BinaryPropertyType) {
            final BinaryPropertyType copy = ((BinaryPropertyType) draftCopy);
            {
                Boolean binaryShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetBinary());
                if (binaryShouldBeCopiedAndSet == Boolean.TRUE) {
                    BinaryType sourceBinary;
                    sourceBinary = this.getBinary();
                    BinaryType copyBinary = ((BinaryType) strategy.copy(LocatorUtils.property(locator, "binary", sourceBinary), sourceBinary, this.isSetBinary()));
                    copy.setBinary(copyBinary);
                } else {
                    if (binaryShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.binary = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof BinaryPropertyType) {
            final BinaryPropertyType target = this;
            final BinaryPropertyType leftObject = ((BinaryPropertyType) left);
            final BinaryPropertyType rightObject = ((BinaryPropertyType) right);
            {
                Boolean binaryShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetBinary(), rightObject.isSetBinary());
                if (binaryShouldBeMergedAndSet == Boolean.TRUE) {
                    BinaryType lhsBinary;
                    lhsBinary = leftObject.getBinary();
                    BinaryType rhsBinary;
                    rhsBinary = rightObject.getBinary();
                    BinaryType mergedBinary = ((BinaryType) strategy.merge(LocatorUtils.property(leftLocator, "binary", lhsBinary), LocatorUtils.property(rightLocator, "binary", rhsBinary), lhsBinary, rhsBinary, leftObject.isSetBinary(), rightObject.isSetBinary()));
                    target.setBinary(mergedBinary);
                } else {
                    if (binaryShouldBeMergedAndSet == Boolean.FALSE) {
                        target.binary = null;
                    }
                }
            }
    ...
    public BinaryPropertyType withBinary(BinaryType value) {
        setBinary(value);
        return this;
    }

    public BinaryPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public BinaryPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public BinaryPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
