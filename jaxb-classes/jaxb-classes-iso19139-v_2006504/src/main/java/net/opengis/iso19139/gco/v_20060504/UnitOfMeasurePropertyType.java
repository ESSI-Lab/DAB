...
import net.opengis.iso19139.gmx.v_20060504.MLBaseUnitType;
import net.opengis.iso19139.gmx.v_20060504.MLConventionalUnitType;
import net.opengis.iso19139.gmx.v_20060504.MLDerivedUnitType;
import net.opengis.iso19139.gmx.v_20060504.MLUnitDefinitionType;
...
public class UnitOfMeasurePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "unitDefinition", buffer, theUnitDefinition, this.isSetUnitDefinition());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<?> lhsUnitDefinition;
            lhsUnitDefinition = this.getUnitDefinition();
            JAXBElement<?> rhsUnitDefinition;
            rhsUnitDefinition = that.getUnitDefinition();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "unitDefinition", lhsUnitDefinition), LocatorUtils.property(thatLocator, "unitDefinition", rhsUnitDefinition), lhsUnitDefinition, rhsUnitDefinition, this.isSetUnitDefinition(), that.isSetUnitDefinition())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<?> theUnitDefinition;
            theUnitDefinition = this.getUnitDefinition();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "unitDefinition", theUnitDefinition), currentHashCode, theUnitDefinition, this.isSetUnitDefinition());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof UnitOfMeasurePropertyType) {
            final UnitOfMeasurePropertyType copy = ((UnitOfMeasurePropertyType) draftCopy);
            {
                Boolean unitDefinitionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetUnitDefinition());
                if (unitDefinitionShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<?> sourceUnitDefinition;
                    sourceUnitDefinition = this.getUnitDefinition();
                    @SuppressWarnings("unchecked")
                    JAXBElement<?> copyUnitDefinition = ((JAXBElement<?> ) strategy.copy(LocatorUtils.property(locator, "unitDefinition", sourceUnitDefinition), sourceUnitDefinition, this.isSetUnitDefinition()));
                    copy.setUnitDefinition(copyUnitDefinition);
                } else {
                    if (unitDefinitionShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unitDefinition = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof UnitOfMeasurePropertyType) {
            final UnitOfMeasurePropertyType target = this;
            final UnitOfMeasurePropertyType leftObject = ((UnitOfMeasurePropertyType) left);
            final UnitOfMeasurePropertyType rightObject = ((UnitOfMeasurePropertyType) right);
            {
                Boolean unitDefinitionShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetUnitDefinition(), rightObject.isSetUnitDefinition());
                if (unitDefinitionShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<?> lhsUnitDefinition;
                    lhsUnitDefinition = leftObject.getUnitDefinition();
                    JAXBElement<?> rhsUnitDefinition;
                    rhsUnitDefinition = rightObject.getUnitDefinition();
                    JAXBElement<?> mergedUnitDefinition = ((JAXBElement<?> ) strategy.merge(LocatorUtils.property(leftLocator, "unitDefinition", lhsUnitDefinition), LocatorUtils.property(rightLocator, "unitDefinition", rhsUnitDefinition), lhsUnitDefinition, rhsUnitDefinition, leftObject.isSetUnitDefinition(), rightObject.isSetUnitDefinition()));
                    target.setUnitDefinition(mergedUnitDefinition);
                } else {
                    if (unitDefinitionShouldBeMergedAndSet == Boolean.FALSE) {
                        target.unitDefinition = null;
                    }
                }
            }
            {
    ...
    public UnitOfMeasurePropertyType withUnitDefinition(JAXBElement<?> value) {
        setUnitDefinition(value);
        return this;
    }

    public UnitOfMeasurePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public UnitOfMeasurePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public UnitOfMeasurePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public UnitOfMeasurePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public UnitOfMeasurePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public UnitOfMeasurePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public UnitOfMeasurePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public UnitOfMeasurePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public UnitOfMeasurePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public UnitOfMeasurePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public UnitOfMeasurePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
