...
package net.opengis.iso19139.gts.v_20060504;
...
public class TMPrimitivePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<AbstractTimePrimitiveType> lhsAbstractTimePrimitive;
            lhsAbstractTimePrimitive = this.getAbstractTimePrimitive();
            JAXBElement<AbstractTimePrimitiveType> rhsAbstractTimePrimitive;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof TMPrimitivePropertyType) {
            final TMPrimitivePropertyType copy = ((TMPrimitivePropertyType) draftCopy);
            {
                Boolean abstractTimePrimitiveShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractTimePrimitive());
                if (abstractTimePrimitiveShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<AbstractTimePrimitiveType> sourceAbstractTimePrimitive;
                    sourceAbstractTimePrimitive = this.getAbstractTimePrimitive();
                    @SuppressWarnings("unchecked")
                    JAXBElement<AbstractTimePrimitiveType> copyAbstractTimePrimitive = ((JAXBElement<AbstractTimePrimitiveType> ) strategy.copy(LocatorUtils.property(locator, "abstractTimePrimitive", sourceAbstractTimePrimitive), sourceAbstractTimePrimitive, this.isSetAbstractTimePrimitive()));
                    copy.setAbstractTimePrimitive(copyAbstractTimePrimitive);
                } else {
                    if (abstractTimePrimitiveShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof TMPrimitivePropertyType) {
            final TMPrimitivePropertyType target = this;
            final TMPrimitivePropertyType leftObject = ((TMPrimitivePropertyType) left);
            final TMPrimitivePropertyType rightObject = ((TMPrimitivePropertyType) right);
            {
                Boolean abstractTimePrimitiveShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractTimePrimitive(), rightObject.isSetAbstractTimePrimitive());
                if (abstractTimePrimitiveShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<AbstractTimePrimitiveType> lhsAbstractTimePrimitive;
                    ...
                    JAXBElement<AbstractTimePrimitiveType> mergedAbstractTimePrimitive = ((JAXBElement<AbstractTimePrimitiveType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractTimePrimitive", lhsAbstractTimePrimitive), LocatorUtils.property(rightLocator, "abstractTimePrimitive", rhsAbstractTimePrimitive), lhsAbstractTimePrimitive, rhsAbstractTimePrimitive, leftObject.isSetAbstractTimePrimitive(), rightObject.isSetAbstractTimePrimitive()));
                    target.setAbstractTimePrimitive(mergedAbstractTimePrimitive);
                } else {
                    if (abstractTimePrimitiveShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public TMPrimitivePropertyType withAbstractTimePrimitive(JAXBElement<AbstractTimePrimitiveType> value) {
        setAbstractTimePrimitive(value);
        return this;
    }

    public TMPrimitivePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public TMPrimitivePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public TMPrimitivePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public TMPrimitivePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public TMPrimitivePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public TMPrimitivePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public TMPrimitivePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public TMPrimitivePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public TMPrimitivePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public TMPrimitivePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public TMPrimitivePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
