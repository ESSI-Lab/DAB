...
public class RSReferenceSystemPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "abstractRSReferenceSystem", buffer, theAbstractRSReferenceSystem, this.isSetAbstractRSReferenceSystem());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            AbstractRSReferenceSystemType lhsAbstractRSReferenceSystem;
            lhsAbstractRSReferenceSystem = this.getAbstractRSReferenceSystem();
            AbstractRSReferenceSystemType rhsAbstractRSReferenceSystem;
            rhsAbstractRSReferenceSystem = that.getAbstractRSReferenceSystem();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractRSReferenceSystem", lhsAbstractRSReferenceSystem), LocatorUtils.property(thatLocator, "abstractRSReferenceSystem", rhsAbstractRSReferenceSystem), lhsAbstractRSReferenceSystem, rhsAbstractRSReferenceSystem, this.isSetAbstractRSReferenceSystem(), that.isSetAbstractRSReferenceSystem())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            AbstractRSReferenceSystemType theAbstractRSReferenceSystem;
            theAbstractRSReferenceSystem = this.getAbstractRSReferenceSystem();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractRSReferenceSystem", theAbstractRSReferenceSystem), currentHashCode, theAbstractRSReferenceSystem, this.isSetAbstractRSReferenceSystem());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof RSReferenceSystemPropertyType) {
            final RSReferenceSystemPropertyType copy = ((RSReferenceSystemPropertyType) draftCopy);
            {
                Boolean abstractRSReferenceSystemShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractRSReferenceSystem());
                if (abstractRSReferenceSystemShouldBeCopiedAndSet == Boolean.TRUE) {
                    AbstractRSReferenceSystemType sourceAbstractRSReferenceSystem;
                    sourceAbstractRSReferenceSystem = this.getAbstractRSReferenceSystem();
                    AbstractRSReferenceSystemType copyAbstractRSReferenceSystem = ((AbstractRSReferenceSystemType) strategy.copy(LocatorUtils.property(locator, "abstractRSReferenceSystem", sourceAbstractRSReferenceSystem), sourceAbstractRSReferenceSystem, this.isSetAbstractRSReferenceSystem()));
                    copy.setAbstractRSReferenceSystem(copyAbstractRSReferenceSystem);
                } else {
                    if (abstractRSReferenceSystemShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.abstractRSReferenceSystem = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof RSReferenceSystemPropertyType) {
            final RSReferenceSystemPropertyType target = this;
            final RSReferenceSystemPropertyType leftObject = ((RSReferenceSystemPropertyType) left);
            final RSReferenceSystemPropertyType rightObject = ((RSReferenceSystemPropertyType) right);
            {
                Boolean abstractRSReferenceSystemShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractRSReferenceSystem(), rightObject.isSetAbstractRSReferenceSystem());
                if (abstractRSReferenceSystemShouldBeMergedAndSet == Boolean.TRUE) {
                    AbstractRSReferenceSystemType lhsAbstractRSReferenceSystem;
                    lhsAbstractRSReferenceSystem = leftObject.getAbstractRSReferenceSystem();
                    AbstractRSReferenceSystemType rhsAbstractRSReferenceSystem;
                    rhsAbstractRSReferenceSystem = rightObject.getAbstractRSReferenceSystem();
                    AbstractRSReferenceSystemType mergedAbstractRSReferenceSystem = ((AbstractRSReferenceSystemType) strategy.merge(LocatorUtils.property(leftLocator, "abstractRSReferenceSystem", lhsAbstractRSReferenceSystem), LocatorUtils.property(rightLocator, "abstractRSReferenceSystem", rhsAbstractRSReferenceSystem), lhsAbstractRSReferenceSystem, rhsAbstractRSReferenceSystem, leftObject.isSetAbstractRSReferenceSystem(), rightObject.isSetAbstractRSReferenceSystem()));
                    target.setAbstractRSReferenceSystem(mergedAbstractRSReferenceSystem);
                } else {
                    if (abstractRSReferenceSystemShouldBeMergedAndSet == Boolean.FALSE) {
                        target.abstractRSReferenceSystem = null;
                    }
                }
            }
            {
    ...
    public RSReferenceSystemPropertyType withAbstractRSReferenceSystem(AbstractRSReferenceSystemType value) {
        setAbstractRSReferenceSystem(value);
        return this;
    }

    public RSReferenceSystemPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public RSReferenceSystemPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public RSReferenceSystemPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public RSReferenceSystemPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public RSReferenceSystemPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public RSReferenceSystemPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public RSReferenceSystemPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public RSReferenceSystemPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public RSReferenceSystemPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public RSReferenceSystemPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public RSReferenceSystemPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
