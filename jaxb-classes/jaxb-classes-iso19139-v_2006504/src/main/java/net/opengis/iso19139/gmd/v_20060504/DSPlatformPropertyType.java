...
public class DSPlatformPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "dsPlatform", buffer, theDSPlatform, this.isSetDSPlatform());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            DSPlatformType lhsDSPlatform;
            lhsDSPlatform = this.getDSPlatform();
            DSPlatformType rhsDSPlatform;
            rhsDSPlatform = that.getDSPlatform();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dsPlatform", lhsDSPlatform), LocatorUtils.property(thatLocator, "dsPlatform", rhsDSPlatform), lhsDSPlatform, rhsDSPlatform, this.isSetDSPlatform(), that.isSetDSPlatform())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            DSPlatformType theDSPlatform;
            theDSPlatform = this.getDSPlatform();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dsPlatform", theDSPlatform), currentHashCode, theDSPlatform, this.isSetDSPlatform());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DSPlatformPropertyType) {
            final DSPlatformPropertyType copy = ((DSPlatformPropertyType) draftCopy);
            {
                Boolean dsPlatformShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDSPlatform());
                if (dsPlatformShouldBeCopiedAndSet == Boolean.TRUE) {
                    DSPlatformType sourceDSPlatform;
                    sourceDSPlatform = this.getDSPlatform();
                    DSPlatformType copyDSPlatform = ((DSPlatformType) strategy.copy(LocatorUtils.property(locator, "dsPlatform", sourceDSPlatform), sourceDSPlatform, this.isSetDSPlatform()));
                    copy.setDSPlatform(copyDSPlatform);
                } else {
                    if (dsPlatformShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.dsPlatform = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DSPlatformPropertyType) {
            final DSPlatformPropertyType target = this;
            final DSPlatformPropertyType leftObject = ((DSPlatformPropertyType) left);
            final DSPlatformPropertyType rightObject = ((DSPlatformPropertyType) right);
            {
                Boolean dsPlatformShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDSPlatform(), rightObject.isSetDSPlatform());
                if (dsPlatformShouldBeMergedAndSet == Boolean.TRUE) {
                    DSPlatformType lhsDSPlatform;
                    lhsDSPlatform = leftObject.getDSPlatform();
                    DSPlatformType rhsDSPlatform;
                    rhsDSPlatform = rightObject.getDSPlatform();
                    DSPlatformType mergedDSPlatform = ((DSPlatformType) strategy.merge(LocatorUtils.property(leftLocator, "dsPlatform", lhsDSPlatform), LocatorUtils.property(rightLocator, "dsPlatform", rhsDSPlatform), lhsDSPlatform, rhsDSPlatform, leftObject.isSetDSPlatform(), rightObject.isSetDSPlatform()));
                    target.setDSPlatform(mergedDSPlatform);
                } else {
                    if (dsPlatformShouldBeMergedAndSet == Boolean.FALSE) {
                        target.dsPlatform = null;
                    }
                }
            }
            {
    ...
    public DSPlatformPropertyType withDSPlatform(DSPlatformType value) {
        setDSPlatform(value);
        return this;
    }

    public DSPlatformPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DSPlatformPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DSPlatformPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DSPlatformPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DSPlatformPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DSPlatformPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DSPlatformPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DSPlatformPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DSPlatformPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DSPlatformPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DSPlatformPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
