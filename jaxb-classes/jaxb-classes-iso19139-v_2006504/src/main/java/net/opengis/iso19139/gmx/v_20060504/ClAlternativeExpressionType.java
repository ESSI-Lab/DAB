    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ClAlternativeExpressionType that = ((ClAlternativeExpressionType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ClAlternativeExpressionType) {
            final ClAlternativeExpressionType copy = ((ClAlternativeExpressionType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof ClAlternativeExpressionType) {
            final ClAlternativeExpressionType target = this;
            final ClAlternativeExpressionType leftObject = ((ClAlternativeExpressionType) left);
            final ClAlternativeExpressionType rightObject = ((ClAlternativeExpressionType) right);
            {
    ...
    public ClAlternativeExpressionType withLocale(PTLocalePropertyType value) {
        setLocale(value);
        return this;
    }

    public ClAlternativeExpressionType withCodeSpace(String value) {
        setCodeSpace(value);
        return this;
    }
