...
public class MDFormatPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdFormat", buffer, theMDFormat, this.isSetMDFormat());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            MDFormatType lhsMDFormat;
            lhsMDFormat = this.getMDFormat();
            MDFormatType rhsMDFormat;
            rhsMDFormat = that.getMDFormat();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdFormat", lhsMDFormat), LocatorUtils.property(thatLocator, "mdFormat", rhsMDFormat), lhsMDFormat, rhsMDFormat, this.isSetMDFormat(), that.isSetMDFormat())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MDFormatType theMDFormat;
            theMDFormat = this.getMDFormat();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdFormat", theMDFormat), currentHashCode, theMDFormat, this.isSetMDFormat());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDFormatPropertyType) {
            final MDFormatPropertyType copy = ((MDFormatPropertyType) draftCopy);
            {
                Boolean mdFormatShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDFormat());
                if (mdFormatShouldBeCopiedAndSet == Boolean.TRUE) {
                    MDFormatType sourceMDFormat;
                    sourceMDFormat = this.getMDFormat();
                    MDFormatType copyMDFormat = ((MDFormatType) strategy.copy(LocatorUtils.property(locator, "mdFormat", sourceMDFormat), sourceMDFormat, this.isSetMDFormat()));
                    copy.setMDFormat(copyMDFormat);
                } else {
                    if (mdFormatShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdFormat = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDFormatPropertyType) {
            final MDFormatPropertyType target = this;
            final MDFormatPropertyType leftObject = ((MDFormatPropertyType) left);
            final MDFormatPropertyType rightObject = ((MDFormatPropertyType) right);
            {
                Boolean mdFormatShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDFormat(), rightObject.isSetMDFormat());
                if (mdFormatShouldBeMergedAndSet == Boolean.TRUE) {
                    MDFormatType lhsMDFormat;
                    lhsMDFormat = leftObject.getMDFormat();
                    MDFormatType rhsMDFormat;
                    rhsMDFormat = rightObject.getMDFormat();
                    MDFormatType mergedMDFormat = ((MDFormatType) strategy.merge(LocatorUtils.property(leftLocator, "mdFormat", lhsMDFormat), LocatorUtils.property(rightLocator, "mdFormat", rhsMDFormat), lhsMDFormat, rhsMDFormat, leftObject.isSetMDFormat(), rightObject.isSetMDFormat()));
                    target.setMDFormat(mergedMDFormat);
                } else {
                    if (mdFormatShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdFormat = null;
                    }
                }
            }
            {
    ...
    public MDFormatPropertyType withMDFormat(MDFormatType value) {
        setMDFormat(value);
        return this;
    }

    public MDFormatPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDFormatPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDFormatPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDFormatPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDFormatPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDFormatPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDFormatPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDFormatPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDFormatPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDFormatPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDFormatPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
