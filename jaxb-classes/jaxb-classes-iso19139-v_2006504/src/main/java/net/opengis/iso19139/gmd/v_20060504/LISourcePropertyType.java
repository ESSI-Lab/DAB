...
public class LISourcePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "liSource", buffer, theLISource, this.isSetLISource());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            LISourceType lhsLISource;
            lhsLISource = this.getLISource();
            LISourceType rhsLISource;
            rhsLISource = that.getLISource();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "liSource", lhsLISource), LocatorUtils.property(thatLocator, "liSource", rhsLISource), lhsLISource, rhsLISource, this.isSetLISource(), that.isSetLISource())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            LISourceType theLISource;
            theLISource = this.getLISource();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "liSource", theLISource), currentHashCode, theLISource, this.isSetLISource());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof LISourcePropertyType) {
            final LISourcePropertyType copy = ((LISourcePropertyType) draftCopy);
            {
                Boolean liSourceShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetLISource());
                if (liSourceShouldBeCopiedAndSet == Boolean.TRUE) {
                    LISourceType sourceLISource;
                    sourceLISource = this.getLISource();
                    LISourceType copyLISource = ((LISourceType) strategy.copy(LocatorUtils.property(locator, "liSource", sourceLISource), sourceLISource, this.isSetLISource()));
                    copy.setLISource(copyLISource);
                } else {
                    if (liSourceShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.liSource = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof LISourcePropertyType) {
            final LISourcePropertyType target = this;
            final LISourcePropertyType leftObject = ((LISourcePropertyType) left);
            final LISourcePropertyType rightObject = ((LISourcePropertyType) right);
            {
                Boolean liSourceShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetLISource(), rightObject.isSetLISource());
                if (liSourceShouldBeMergedAndSet == Boolean.TRUE) {
                    LISourceType lhsLISource;
                    lhsLISource = leftObject.getLISource();
                    LISourceType rhsLISource;
                    rhsLISource = rightObject.getLISource();
                    LISourceType mergedLISource = ((LISourceType) strategy.merge(LocatorUtils.property(leftLocator, "liSource", lhsLISource), LocatorUtils.property(rightLocator, "liSource", rhsLISource), lhsLISource, rhsLISource, leftObject.isSetLISource(), rightObject.isSetLISource()));
                    target.setLISource(mergedLISource);
                } else {
                    if (liSourceShouldBeMergedAndSet == Boolean.FALSE) {
                        target.liSource = null;
                    }
                }
            }
            {
    ...
    public LISourcePropertyType withLISource(LISourceType value) {
        setLISource(value);
        return this;
    }

    public LISourcePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public LISourcePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public LISourcePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public LISourcePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public LISourcePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public LISourcePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public LISourcePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public LISourcePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public LISourcePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public LISourcePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public LISourcePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
