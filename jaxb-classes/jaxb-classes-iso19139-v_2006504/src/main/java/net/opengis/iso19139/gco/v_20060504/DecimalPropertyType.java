...
public class DecimalPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DecimalPropertyType) {
            final DecimalPropertyType copy = ((DecimalPropertyType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DecimalPropertyType) {
            final DecimalPropertyType target = this;
            final DecimalPropertyType leftObject = ((DecimalPropertyType) left);
            final DecimalPropertyType rightObject = ((DecimalPropertyType) right);
            {
    ...
    public DecimalPropertyType withDecimal(BigDecimal value) {
        setDecimal(value);
        return this;
    }

    public DecimalPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DecimalPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DecimalPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
