...
public class CITelephonePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "ciTelephone", buffer, theCITelephone, this.isSetCITelephone());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            CITelephoneType lhsCITelephone;
            lhsCITelephone = this.getCITelephone();
            CITelephoneType rhsCITelephone;
            rhsCITelephone = that.getCITelephone();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ciTelephone", lhsCITelephone), LocatorUtils.property(thatLocator, "ciTelephone", rhsCITelephone), lhsCITelephone, rhsCITelephone, this.isSetCITelephone(), that.isSetCITelephone())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            CITelephoneType theCITelephone;
            theCITelephone = this.getCITelephone();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ciTelephone", theCITelephone), currentHashCode, theCITelephone, this.isSetCITelephone());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CITelephonePropertyType) {
            final CITelephonePropertyType copy = ((CITelephonePropertyType) draftCopy);
            {
                Boolean ciTelephoneShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCITelephone());
                if (ciTelephoneShouldBeCopiedAndSet == Boolean.TRUE) {
                    CITelephoneType sourceCITelephone;
                    sourceCITelephone = this.getCITelephone();
                    CITelephoneType copyCITelephone = ((CITelephoneType) strategy.copy(LocatorUtils.property(locator, "ciTelephone", sourceCITelephone), sourceCITelephone, this.isSetCITelephone()));
                    copy.setCITelephone(copyCITelephone);
                } else {
                    if (ciTelephoneShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.ciTelephone = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CITelephonePropertyType) {
            final CITelephonePropertyType target = this;
            final CITelephonePropertyType leftObject = ((CITelephonePropertyType) left);
            final CITelephonePropertyType rightObject = ((CITelephonePropertyType) right);
            {
                Boolean ciTelephoneShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCITelephone(), rightObject.isSetCITelephone());
                if (ciTelephoneShouldBeMergedAndSet == Boolean.TRUE) {
                    CITelephoneType lhsCITelephone;
                    lhsCITelephone = leftObject.getCITelephone();
                    CITelephoneType rhsCITelephone;
                    rhsCITelephone = rightObject.getCITelephone();
                    CITelephoneType mergedCITelephone = ((CITelephoneType) strategy.merge(LocatorUtils.property(leftLocator, "ciTelephone", lhsCITelephone), LocatorUtils.property(rightLocator, "ciTelephone", rhsCITelephone), lhsCITelephone, rhsCITelephone, leftObject.isSetCITelephone(), rightObject.isSetCITelephone()));
                    target.setCITelephone(mergedCITelephone);
                } else {
                    if (ciTelephoneShouldBeMergedAndSet == Boolean.FALSE) {
                        target.ciTelephone = null;
                    }
                }
            }
            {
    ...
    public CITelephonePropertyType withCITelephone(CITelephoneType value) {
        setCITelephone(value);
        return this;
    }

    public CITelephonePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CITelephonePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CITelephonePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public CITelephonePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CITelephonePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CITelephonePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CITelephonePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CITelephonePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CITelephonePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CITelephonePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CITelephonePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
