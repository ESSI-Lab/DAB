...
public class SVPortSpecificationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "svPortSpecification", buffer, theSVPortSpecification, this.isSetSVPortSpecification());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SVPortSpecificationPropertyType that = ((SVPortSpecificationPropertyType) object);
        {
            SVPortSpecificationType lhsSVPortSpecification;
            lhsSVPortSpecification = this.getSVPortSpecification();
            SVPortSpecificationType rhsSVPortSpecification;
            rhsSVPortSpecification = that.getSVPortSpecification();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "svPortSpecification", lhsSVPortSpecification), LocatorUtils.property(thatLocator, "svPortSpecification", rhsSVPortSpecification), lhsSVPortSpecification, rhsSVPortSpecification, this.isSetSVPortSpecification(), that.isSetSVPortSpecification())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            SVPortSpecificationType theSVPortSpecification;
            theSVPortSpecification = this.getSVPortSpecification();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "svPortSpecification", theSVPortSpecification), currentHashCode, theSVPortSpecification, this.isSetSVPortSpecification());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SVPortSpecificationPropertyType) {
            final SVPortSpecificationPropertyType copy = ((SVPortSpecificationPropertyType) draftCopy);
            {
                Boolean svPortSpecificationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSVPortSpecification());
                if (svPortSpecificationShouldBeCopiedAndSet == Boolean.TRUE) {
                    SVPortSpecificationType sourceSVPortSpecification;
                    sourceSVPortSpecification = this.getSVPortSpecification();
                    SVPortSpecificationType copySVPortSpecification = ((SVPortSpecificationType) strategy.copy(LocatorUtils.property(locator, "svPortSpecification", sourceSVPortSpecification), sourceSVPortSpecification, this.isSetSVPortSpecification()));
                    copy.setSVPortSpecification(copySVPortSpecification);
                } else {
                    if (svPortSpecificationShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.svPortSpecification = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SVPortSpecificationPropertyType) {
            final SVPortSpecificationPropertyType target = this;
            final SVPortSpecificationPropertyType leftObject = ((SVPortSpecificationPropertyType) left);
            final SVPortSpecificationPropertyType rightObject = ((SVPortSpecificationPropertyType) right);
            {
                Boolean svPortSpecificationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSVPortSpecification(), rightObject.isSetSVPortSpecification());
                if (svPortSpecificationShouldBeMergedAndSet == Boolean.TRUE) {
                    SVPortSpecificationType lhsSVPortSpecification;
                    lhsSVPortSpecification = leftObject.getSVPortSpecification();
                    SVPortSpecificationType rhsSVPortSpecification;
                    rhsSVPortSpecification = rightObject.getSVPortSpecification();
                    SVPortSpecificationType mergedSVPortSpecification = ((SVPortSpecificationType) strategy.merge(LocatorUtils.property(leftLocator, "svPortSpecification", lhsSVPortSpecification), LocatorUtils.property(rightLocator, "svPortSpecification", rhsSVPortSpecification), lhsSVPortSpecification, rhsSVPortSpecification, leftObject.isSetSVPortSpecification(), rightObject.isSetSVPortSpecification()));
                    target.setSVPortSpecification(mergedSVPortSpecification);
                } else {
                    if (svPortSpecificationShouldBeMergedAndSet == Boolean.FALSE) {
                        target.svPortSpecification = null;
                    }
                }
            }
            {
    ...
    public SVPortSpecificationPropertyType withSVPortSpecification(SVPortSpecificationType value) {
        setSVPortSpecification(value);
        return this;
    }

    public SVPortSpecificationPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public SVPortSpecificationPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public SVPortSpecificationPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public SVPortSpecificationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SVPortSpecificationPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public SVPortSpecificationPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public SVPortSpecificationPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SVPortSpecificationPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SVPortSpecificationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SVPortSpecificationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public SVPortSpecificationPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
