...
public class SVPortPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "svPort", buffer, theSVPort, this.isSetSVPort());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SVPortPropertyType that = ((SVPortPropertyType) object);
        {
            SVPortType lhsSVPort;
            lhsSVPort = this.getSVPort();
            SVPortType rhsSVPort;
            rhsSVPort = that.getSVPort();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "svPort", lhsSVPort), LocatorUtils.property(thatLocator, "svPort", rhsSVPort), lhsSVPort, rhsSVPort, this.isSetSVPort(), that.isSetSVPort())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            SVPortType theSVPort;
            theSVPort = this.getSVPort();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "svPort", theSVPort), currentHashCode, theSVPort, this.isSetSVPort());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SVPortPropertyType) {
            final SVPortPropertyType copy = ((SVPortPropertyType) draftCopy);
            {
                Boolean svPortShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSVPort());
                if (svPortShouldBeCopiedAndSet == Boolean.TRUE) {
                    SVPortType sourceSVPort;
                    sourceSVPort = this.getSVPort();
                    SVPortType copySVPort = ((SVPortType) strategy.copy(LocatorUtils.property(locator, "svPort", sourceSVPort), sourceSVPort, this.isSetSVPort()));
                    copy.setSVPort(copySVPort);
                } else {
                    if (svPortShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.svPort = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SVPortPropertyType) {
            final SVPortPropertyType target = this;
            final SVPortPropertyType leftObject = ((SVPortPropertyType) left);
            final SVPortPropertyType rightObject = ((SVPortPropertyType) right);
            {
                Boolean svPortShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSVPort(), rightObject.isSetSVPort());
                if (svPortShouldBeMergedAndSet == Boolean.TRUE) {
                    SVPortType lhsSVPort;
                    lhsSVPort = leftObject.getSVPort();
                    SVPortType rhsSVPort;
                    rhsSVPort = rightObject.getSVPort();
                    SVPortType mergedSVPort = ((SVPortType) strategy.merge(LocatorUtils.property(leftLocator, "svPort", lhsSVPort), LocatorUtils.property(rightLocator, "svPort", rhsSVPort), lhsSVPort, rhsSVPort, leftObject.isSetSVPort(), rightObject.isSetSVPort()));
                    target.setSVPort(mergedSVPort);
                } else {
                    if (svPortShouldBeMergedAndSet == Boolean.FALSE) {
                        target.svPort = null;
                    }
                }
            }
    ...
    public SVPortPropertyType withSVPort(SVPortType value) {
        setSVPort(value);
        return this;
    }

    public SVPortPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public SVPortPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public SVPortPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public SVPortPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SVPortPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public SVPortPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public SVPortPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SVPortPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SVPortPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SVPortPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public SVPortPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
