...
public class CoordinateSystemAxisAltPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "coordinateSystemAxisAlt", buffer, theCoordinateSystemAxisAlt, this.isSetCoordinateSystemAxisAlt());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CoordinateSystemAxisAltPropertyType that = ((CoordinateSystemAxisAltPropertyType) object);
        {
            CoordinateSystemAxisAltType lhsCoordinateSystemAxisAlt;
            lhsCoordinateSystemAxisAlt = this.getCoordinateSystemAxisAlt();
            CoordinateSystemAxisAltType rhsCoordinateSystemAxisAlt;
            rhsCoordinateSystemAxisAlt = that.getCoordinateSystemAxisAlt();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "coordinateSystemAxisAlt", lhsCoordinateSystemAxisAlt), LocatorUtils.property(thatLocator, "coordinateSystemAxisAlt", rhsCoordinateSystemAxisAlt), lhsCoordinateSystemAxisAlt, rhsCoordinateSystemAxisAlt, this.isSetCoordinateSystemAxisAlt(), that.isSetCoordinateSystemAxisAlt())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            CoordinateSystemAxisAltType theCoordinateSystemAxisAlt;
            theCoordinateSystemAxisAlt = this.getCoordinateSystemAxisAlt();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "coordinateSystemAxisAlt", theCoordinateSystemAxisAlt), currentHashCode, theCoordinateSystemAxisAlt, this.isSetCoordinateSystemAxisAlt());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CoordinateSystemAxisAltPropertyType) {
            final CoordinateSystemAxisAltPropertyType copy = ((CoordinateSystemAxisAltPropertyType) draftCopy);
            {
                Boolean coordinateSystemAxisAltShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCoordinateSystemAxisAlt());
                if (coordinateSystemAxisAltShouldBeCopiedAndSet == Boolean.TRUE) {
                    CoordinateSystemAxisAltType sourceCoordinateSystemAxisAlt;
                    sourceCoordinateSystemAxisAlt = this.getCoordinateSystemAxisAlt();
                    CoordinateSystemAxisAltType copyCoordinateSystemAxisAlt = ((CoordinateSystemAxisAltType) strategy.copy(LocatorUtils.property(locator, "coordinateSystemAxisAlt", sourceCoordinateSystemAxisAlt), sourceCoordinateSystemAxisAlt, this.isSetCoordinateSystemAxisAlt()));
                    copy.setCoordinateSystemAxisAlt(copyCoordinateSystemAxisAlt);
                } else {
                    if (coordinateSystemAxisAltShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.coordinateSystemAxisAlt = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CoordinateSystemAxisAltPropertyType) {
            final CoordinateSystemAxisAltPropertyType target = this;
            final CoordinateSystemAxisAltPropertyType leftObject = ((CoordinateSystemAxisAltPropertyType) left);
            final CoordinateSystemAxisAltPropertyType rightObject = ((CoordinateSystemAxisAltPropertyType) right);
            {
                Boolean coordinateSystemAxisAltShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCoordinateSystemAxisAlt(), rightObject.isSetCoordinateSystemAxisAlt());
                if (coordinateSystemAxisAltShouldBeMergedAndSet == Boolean.TRUE) {
                    CoordinateSystemAxisAltType lhsCoordinateSystemAxisAlt;
                    lhsCoordinateSystemAxisAlt = leftObject.getCoordinateSystemAxisAlt();
                    CoordinateSystemAxisAltType rhsCoordinateSystemAxisAlt;
                    rhsCoordinateSystemAxisAlt = rightObject.getCoordinateSystemAxisAlt();
                    CoordinateSystemAxisAltType mergedCoordinateSystemAxisAlt = ((CoordinateSystemAxisAltType) strategy.merge(LocatorUtils.property(leftLocator, "coordinateSystemAxisAlt", lhsCoordinateSystemAxisAlt), LocatorUtils.property(rightLocator, "coordinateSystemAxisAlt", rhsCoordinateSystemAxisAlt), lhsCoordinateSystemAxisAlt, rhsCoordinateSystemAxisAlt, leftObject.isSetCoordinateSystemAxisAlt(), rightObject.isSetCoordinateSystemAxisAlt()));
                    target.setCoordinateSystemAxisAlt(mergedCoordinateSystemAxisAlt);
                } else {
                    if (coordinateSystemAxisAltShouldBeMergedAndSet == Boolean.FALSE) {
                        target.coordinateSystemAxisAlt = null;
                    }
                }
            }
            {
    ...
    public CoordinateSystemAxisAltPropertyType withCoordinateSystemAxisAlt(CoordinateSystemAxisAltType value) {
        setCoordinateSystemAxisAlt(value);
        return this;
    }

    public CoordinateSystemAxisAltPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CoordinateSystemAxisAltPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CoordinateSystemAxisAltPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public CoordinateSystemAxisAltPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CoordinateSystemAxisAltPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CoordinateSystemAxisAltPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CoordinateSystemAxisAltPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CoordinateSystemAxisAltPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CoordinateSystemAxisAltPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CoordinateSystemAxisAltPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CoordinateSystemAxisAltPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
