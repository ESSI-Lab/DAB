...
public class MDDimensionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdDimension", buffer, theMDDimension, this.isSetMDDimension());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            MDDimensionType lhsMDDimension;
            lhsMDDimension = this.getMDDimension();
            MDDimensionType rhsMDDimension;
            rhsMDDimension = that.getMDDimension();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdDimension", lhsMDDimension), LocatorUtils.property(thatLocator, "mdDimension", rhsMDDimension), lhsMDDimension, rhsMDDimension, this.isSetMDDimension(), that.isSetMDDimension())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MDDimensionType theMDDimension;
            theMDDimension = this.getMDDimension();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdDimension", theMDDimension), currentHashCode, theMDDimension, this.isSetMDDimension());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDDimensionPropertyType) {
            final MDDimensionPropertyType copy = ((MDDimensionPropertyType) draftCopy);
            {
                Boolean mdDimensionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDDimension());
                if (mdDimensionShouldBeCopiedAndSet == Boolean.TRUE) {
                    MDDimensionType sourceMDDimension;
                    sourceMDDimension = this.getMDDimension();
                    MDDimensionType copyMDDimension = ((MDDimensionType) strategy.copy(LocatorUtils.property(locator, "mdDimension", sourceMDDimension), sourceMDDimension, this.isSetMDDimension()));
                    copy.setMDDimension(copyMDDimension);
                } else {
                    if (mdDimensionShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdDimension = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDDimensionPropertyType) {
            final MDDimensionPropertyType target = this;
            final MDDimensionPropertyType leftObject = ((MDDimensionPropertyType) left);
            final MDDimensionPropertyType rightObject = ((MDDimensionPropertyType) right);
            {
                Boolean mdDimensionShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDDimension(), rightObject.isSetMDDimension());
                if (mdDimensionShouldBeMergedAndSet == Boolean.TRUE) {
                    MDDimensionType lhsMDDimension;
                    lhsMDDimension = leftObject.getMDDimension();
                    MDDimensionType rhsMDDimension;
                    rhsMDDimension = rightObject.getMDDimension();
                    MDDimensionType mergedMDDimension = ((MDDimensionType) strategy.merge(LocatorUtils.property(leftLocator, "mdDimension", lhsMDDimension), LocatorUtils.property(rightLocator, "mdDimension", rhsMDDimension), lhsMDDimension, rhsMDDimension, leftObject.isSetMDDimension(), rightObject.isSetMDDimension()));
                    target.setMDDimension(mergedMDDimension);
                } else {
                    if (mdDimensionShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdDimension = null;
                    }
                }
            }
            {
    ...
    public MDDimensionPropertyType withMDDimension(MDDimensionType value) {
        setMDDimension(value);
        return this;
    }

    public MDDimensionPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDDimensionPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDDimensionPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDDimensionPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDDimensionPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDDimensionPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDDimensionPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDDimensionPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDDimensionPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDDimensionPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDDimensionPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
