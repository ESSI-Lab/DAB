...
public class SVParameterPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "svParameter", buffer, theSVParameter, this.isSetSVParameter());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SVParameterPropertyType that = ((SVParameterPropertyType) object);
        {
            SVParameterType lhsSVParameter;
            lhsSVParameter = this.getSVParameter();
            SVParameterType rhsSVParameter;
            rhsSVParameter = that.getSVParameter();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "svParameter", lhsSVParameter), LocatorUtils.property(thatLocator, "svParameter", rhsSVParameter), lhsSVParameter, rhsSVParameter, this.isSetSVParameter(), that.isSetSVParameter())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            SVParameterType theSVParameter;
            theSVParameter = this.getSVParameter();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "svParameter", theSVParameter), currentHashCode, theSVParameter, this.isSetSVParameter());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SVParameterPropertyType) {
            final SVParameterPropertyType copy = ((SVParameterPropertyType) draftCopy);
            {
                Boolean svParameterShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSVParameter());
                if (svParameterShouldBeCopiedAndSet == Boolean.TRUE) {
                    SVParameterType sourceSVParameter;
                    sourceSVParameter = this.getSVParameter();
                    SVParameterType copySVParameter = ((SVParameterType) strategy.copy(LocatorUtils.property(locator, "svParameter", sourceSVParameter), sourceSVParameter, this.isSetSVParameter()));
                    copy.setSVParameter(copySVParameter);
                } else {
                    if (svParameterShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.svParameter = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SVParameterPropertyType) {
            final SVParameterPropertyType target = this;
            final SVParameterPropertyType leftObject = ((SVParameterPropertyType) left);
            final SVParameterPropertyType rightObject = ((SVParameterPropertyType) right);
            {
                Boolean svParameterShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSVParameter(), rightObject.isSetSVParameter());
                if (svParameterShouldBeMergedAndSet == Boolean.TRUE) {
                    SVParameterType lhsSVParameter;
                    lhsSVParameter = leftObject.getSVParameter();
                    SVParameterType rhsSVParameter;
                    rhsSVParameter = rightObject.getSVParameter();
                    SVParameterType mergedSVParameter = ((SVParameterType) strategy.merge(LocatorUtils.property(leftLocator, "svParameter", lhsSVParameter), LocatorUtils.property(rightLocator, "svParameter", rhsSVParameter), lhsSVParameter, rhsSVParameter, leftObject.isSetSVParameter(), rightObject.isSetSVParameter()));
                    target.setSVParameter(mergedSVParameter);
                } else {
                    if (svParameterShouldBeMergedAndSet == Boolean.FALSE) {
                        target.svParameter = null;
                    }
                }
            }
            {
    ...
    public SVParameterPropertyType withSVParameter(SVParameterType value) {
        setSVParameter(value);
        return this;
    }

    public SVParameterPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public SVParameterPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public SVParameterPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public SVParameterPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SVParameterPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public SVParameterPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public SVParameterPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SVParameterPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SVParameterPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SVParameterPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public SVParameterPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
