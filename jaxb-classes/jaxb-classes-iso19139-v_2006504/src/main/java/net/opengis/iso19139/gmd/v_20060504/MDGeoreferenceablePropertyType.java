...
public class MDGeoreferenceablePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdGeoreferenceable", buffer, theMDGeoreferenceable, this.isSetMDGeoreferenceable());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            MDGeoreferenceableType lhsMDGeoreferenceable;
            lhsMDGeoreferenceable = this.getMDGeoreferenceable();
            MDGeoreferenceableType rhsMDGeoreferenceable;
            rhsMDGeoreferenceable = that.getMDGeoreferenceable();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdGeoreferenceable", lhsMDGeoreferenceable), LocatorUtils.property(thatLocator, "mdGeoreferenceable", rhsMDGeoreferenceable), lhsMDGeoreferenceable, rhsMDGeoreferenceable, this.isSetMDGeoreferenceable(), that.isSetMDGeoreferenceable())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MDGeoreferenceableType theMDGeoreferenceable;
            theMDGeoreferenceable = this.getMDGeoreferenceable();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdGeoreferenceable", theMDGeoreferenceable), currentHashCode, theMDGeoreferenceable, this.isSetMDGeoreferenceable());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDGeoreferenceablePropertyType) {
            final MDGeoreferenceablePropertyType copy = ((MDGeoreferenceablePropertyType) draftCopy);
            {
                Boolean mdGeoreferenceableShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDGeoreferenceable());
                if (mdGeoreferenceableShouldBeCopiedAndSet == Boolean.TRUE) {
                    MDGeoreferenceableType sourceMDGeoreferenceable;
                    sourceMDGeoreferenceable = this.getMDGeoreferenceable();
                    MDGeoreferenceableType copyMDGeoreferenceable = ((MDGeoreferenceableType) strategy.copy(LocatorUtils.property(locator, "mdGeoreferenceable", sourceMDGeoreferenceable), sourceMDGeoreferenceable, this.isSetMDGeoreferenceable()));
                    copy.setMDGeoreferenceable(copyMDGeoreferenceable);
                } else {
                    if (mdGeoreferenceableShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdGeoreferenceable = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDGeoreferenceablePropertyType) {
            final MDGeoreferenceablePropertyType target = this;
            final MDGeoreferenceablePropertyType leftObject = ((MDGeoreferenceablePropertyType) left);
            final MDGeoreferenceablePropertyType rightObject = ((MDGeoreferenceablePropertyType) right);
            {
                Boolean mdGeoreferenceableShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDGeoreferenceable(), rightObject.isSetMDGeoreferenceable());
                if (mdGeoreferenceableShouldBeMergedAndSet == Boolean.TRUE) {
                    MDGeoreferenceableType lhsMDGeoreferenceable;
                    lhsMDGeoreferenceable = leftObject.getMDGeoreferenceable();
                    MDGeoreferenceableType rhsMDGeoreferenceable;
                    rhsMDGeoreferenceable = rightObject.getMDGeoreferenceable();
                    MDGeoreferenceableType mergedMDGeoreferenceable = ((MDGeoreferenceableType) strategy.merge(LocatorUtils.property(leftLocator, "mdGeoreferenceable", lhsMDGeoreferenceable), LocatorUtils.property(rightLocator, "mdGeoreferenceable", rhsMDGeoreferenceable), lhsMDGeoreferenceable, rhsMDGeoreferenceable, leftObject.isSetMDGeoreferenceable(), rightObject.isSetMDGeoreferenceable()));
                    target.setMDGeoreferenceable(mergedMDGeoreferenceable);
                } else {
                    if (mdGeoreferenceableShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdGeoreferenceable = null;
                    }
                }
            }
            {
    ...
    public MDGeoreferenceablePropertyType withMDGeoreferenceable(MDGeoreferenceableType value) {
        setMDGeoreferenceable(value);
        return this;
    }

    public MDGeoreferenceablePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDGeoreferenceablePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDGeoreferenceablePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDGeoreferenceablePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDGeoreferenceablePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDGeoreferenceablePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDGeoreferenceablePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDGeoreferenceablePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDGeoreferenceablePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDGeoreferenceablePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDGeoreferenceablePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
