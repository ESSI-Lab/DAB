...
public class MDFeatureCatalogueDescriptionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdFeatureCatalogueDescription", buffer, theMDFeatureCatalogueDescription, this.isSetMDFeatureCatalogueDescription());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            MDFeatureCatalogueDescriptionType lhsMDFeatureCatalogueDescription;
            lhsMDFeatureCatalogueDescription = this.getMDFeatureCatalogueDescription();
            MDFeatureCatalogueDescriptionType rhsMDFeatureCatalogueDescription;
            rhsMDFeatureCatalogueDescription = that.getMDFeatureCatalogueDescription();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdFeatureCatalogueDescription", lhsMDFeatureCatalogueDescription), LocatorUtils.property(thatLocator, "mdFeatureCatalogueDescription", rhsMDFeatureCatalogueDescription), lhsMDFeatureCatalogueDescription, rhsMDFeatureCatalogueDescription, this.isSetMDFeatureCatalogueDescription(), that.isSetMDFeatureCatalogueDescription())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MDFeatureCatalogueDescriptionType theMDFeatureCatalogueDescription;
            theMDFeatureCatalogueDescription = this.getMDFeatureCatalogueDescription();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdFeatureCatalogueDescription", theMDFeatureCatalogueDescription), currentHashCode, theMDFeatureCatalogueDescription, this.isSetMDFeatureCatalogueDescription());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDFeatureCatalogueDescriptionPropertyType) {
            final MDFeatureCatalogueDescriptionPropertyType copy = ((MDFeatureCatalogueDescriptionPropertyType) draftCopy);
            {
                Boolean mdFeatureCatalogueDescriptionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDFeatureCatalogueDescription());
                if (mdFeatureCatalogueDescriptionShouldBeCopiedAndSet == Boolean.TRUE) {
                    MDFeatureCatalogueDescriptionType sourceMDFeatureCatalogueDescription;
                    sourceMDFeatureCatalogueDescription = this.getMDFeatureCatalogueDescription();
                    MDFeatureCatalogueDescriptionType copyMDFeatureCatalogueDescription = ((MDFeatureCatalogueDescriptionType) strategy.copy(LocatorUtils.property(locator, "mdFeatureCatalogueDescription", sourceMDFeatureCatalogueDescription), sourceMDFeatureCatalogueDescription, this.isSetMDFeatureCatalogueDescription()));
                    copy.setMDFeatureCatalogueDescription(copyMDFeatureCatalogueDescription);
                } else {
                    if (mdFeatureCatalogueDescriptionShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdFeatureCatalogueDescription = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDFeatureCatalogueDescriptionPropertyType) {
            final MDFeatureCatalogueDescriptionPropertyType target = this;
            final MDFeatureCatalogueDescriptionPropertyType leftObject = ((MDFeatureCatalogueDescriptionPropertyType) left);
            final MDFeatureCatalogueDescriptionPropertyType rightObject = ((MDFeatureCatalogueDescriptionPropertyType) right);
            {
                Boolean mdFeatureCatalogueDescriptionShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDFeatureCatalogueDescription(), rightObject.isSetMDFeatureCatalogueDescription());
                if (mdFeatureCatalogueDescriptionShouldBeMergedAndSet == Boolean.TRUE) {
                    MDFeatureCatalogueDescriptionType lhsMDFeatureCatalogueDescription;
                    lhsMDFeatureCatalogueDescription = leftObject.getMDFeatureCatalogueDescription();
                    MDFeatureCatalogueDescriptionType rhsMDFeatureCatalogueDescription;
                    rhsMDFeatureCatalogueDescription = rightObject.getMDFeatureCatalogueDescription();
                    MDFeatureCatalogueDescriptionType mergedMDFeatureCatalogueDescription = ((MDFeatureCatalogueDescriptionType) strategy.merge(LocatorUtils.property(leftLocator, "mdFeatureCatalogueDescription", lhsMDFeatureCatalogueDescription), LocatorUtils.property(rightLocator, "mdFeatureCatalogueDescription", rhsMDFeatureCatalogueDescription), lhsMDFeatureCatalogueDescription, rhsMDFeatureCatalogueDescription, leftObject.isSetMDFeatureCatalogueDescription(), rightObject.isSetMDFeatureCatalogueDescription()));
                    target.setMDFeatureCatalogueDescription(mergedMDFeatureCatalogueDescription);
                } else {
                    if (mdFeatureCatalogueDescriptionShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdFeatureCatalogueDescription = null;
                    }
                }
            }
            {
    ...
    public MDFeatureCatalogueDescriptionPropertyType withMDFeatureCatalogueDescription(MDFeatureCatalogueDescriptionType value) {
        setMDFeatureCatalogueDescription(value);
        return this;
    }

    public MDFeatureCatalogueDescriptionPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDFeatureCatalogueDescriptionPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDFeatureCatalogueDescriptionPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDFeatureCatalogueDescriptionPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDFeatureCatalogueDescriptionPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDFeatureCatalogueDescriptionPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDFeatureCatalogueDescriptionPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDFeatureCatalogueDescriptionPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDFeatureCatalogueDescriptionPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDFeatureCatalogueDescriptionPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDFeatureCatalogueDescriptionPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
