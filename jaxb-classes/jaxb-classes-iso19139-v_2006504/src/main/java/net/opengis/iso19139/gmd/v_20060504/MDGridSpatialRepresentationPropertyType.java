...
public class MDGridSpatialRepresentationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdGridSpatialRepresentation", buffer, theMDGridSpatialRepresentation, this.isSetMDGridSpatialRepresentation());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<? extends MDGridSpatialRepresentationType> lhsMDGridSpatialRepresentation;
            lhsMDGridSpatialRepresentation = this.getMDGridSpatialRepresentation();
            JAXBElement<? extends MDGridSpatialRepresentationType> rhsMDGridSpatialRepresentation;
            rhsMDGridSpatialRepresentation = that.getMDGridSpatialRepresentation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdGridSpatialRepresentation", lhsMDGridSpatialRepresentation), LocatorUtils.property(thatLocator, "mdGridSpatialRepresentation", rhsMDGridSpatialRepresentation), lhsMDGridSpatialRepresentation, rhsMDGridSpatialRepresentation, this.isSetMDGridSpatialRepresentation(), that.isSetMDGridSpatialRepresentation())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends MDGridSpatialRepresentationType> theMDGridSpatialRepresentation;
            theMDGridSpatialRepresentation = this.getMDGridSpatialRepresentation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdGridSpatialRepresentation", theMDGridSpatialRepresentation), currentHashCode, theMDGridSpatialRepresentation, this.isSetMDGridSpatialRepresentation());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDGridSpatialRepresentationPropertyType) {
            final MDGridSpatialRepresentationPropertyType copy = ((MDGridSpatialRepresentationPropertyType) draftCopy);
            {
                Boolean mdGridSpatialRepresentationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDGridSpatialRepresentation());
                if (mdGridSpatialRepresentationShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends MDGridSpatialRepresentationType> sourceMDGridSpatialRepresentation;
                    sourceMDGridSpatialRepresentation = this.getMDGridSpatialRepresentation();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends MDGridSpatialRepresentationType> copyMDGridSpatialRepresentation = ((JAXBElement<? extends MDGridSpatialRepresentationType> ) strategy.copy(LocatorUtils.property(locator, "mdGridSpatialRepresentation", sourceMDGridSpatialRepresentation), sourceMDGridSpatialRepresentation, this.isSetMDGridSpatialRepresentation()));
                    copy.setMDGridSpatialRepresentation(copyMDGridSpatialRepresentation);
                } else {
                    if (mdGridSpatialRepresentationShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdGridSpatialRepresentation = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDGridSpatialRepresentationPropertyType) {
            final MDGridSpatialRepresentationPropertyType target = this;
            final MDGridSpatialRepresentationPropertyType leftObject = ((MDGridSpatialRepresentationPropertyType) left);
            final MDGridSpatialRepresentationPropertyType rightObject = ((MDGridSpatialRepresentationPropertyType) right);
            {
                Boolean mdGridSpatialRepresentationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDGridSpatialRepresentation(), rightObject.isSetMDGridSpatialRepresentation());
                if (mdGridSpatialRepresentationShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends MDGridSpatialRepresentationType> lhsMDGridSpatialRepresentation;
                    lhsMDGridSpatialRepresentation = leftObject.getMDGridSpatialRepresentation();
                    JAXBElement<? extends MDGridSpatialRepresentationType> rhsMDGridSpatialRepresentation;
                    rhsMDGridSpatialRepresentation = rightObject.getMDGridSpatialRepresentation();
                    JAXBElement<? extends MDGridSpatialRepresentationType> mergedMDGridSpatialRepresentation = ((JAXBElement<? extends MDGridSpatialRepresentationType> ) strategy.merge(LocatorUtils.property(leftLocator, "mdGridSpatialRepresentation", lhsMDGridSpatialRepresentation), LocatorUtils.property(rightLocator, "mdGridSpatialRepresentation", rhsMDGridSpatialRepresentation), lhsMDGridSpatialRepresentation, rhsMDGridSpatialRepresentation, leftObject.isSetMDGridSpatialRepresentation(), rightObject.isSetMDGridSpatialRepresentation()));
                    target.setMDGridSpatialRepresentation(mergedMDGridSpatialRepresentation);
                } else {
                    if (mdGridSpatialRepresentationShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdGridSpatialRepresentation = null;
                    }
                }
            }
            {
    ...
    public MDGridSpatialRepresentationPropertyType withMDGridSpatialRepresentation(JAXBElement<? extends MDGridSpatialRepresentationType> value) {
        setMDGridSpatialRepresentation(value);
        return this;
    }

    public MDGridSpatialRepresentationPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDGridSpatialRepresentationPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDGridSpatialRepresentationPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDGridSpatialRepresentationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDGridSpatialRepresentationPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDGridSpatialRepresentationPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDGridSpatialRepresentationPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDGridSpatialRepresentationPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDGridSpatialRepresentationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDGridSpatialRepresentationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDGridSpatialRepresentationPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
