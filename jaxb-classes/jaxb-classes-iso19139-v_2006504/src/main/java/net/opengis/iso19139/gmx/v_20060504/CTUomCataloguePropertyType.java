...
public class CTUomCataloguePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "ctUomCatalogue", buffer, theCTUomCatalogue, this.isSetCTUomCatalogue());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTUomCataloguePropertyType that = ((CTUomCataloguePropertyType) object);
        {
            CTUomCatalogueType lhsCTUomCatalogue;
            lhsCTUomCatalogue = this.getCTUomCatalogue();
            CTUomCatalogueType rhsCTUomCatalogue;
            rhsCTUomCatalogue = that.getCTUomCatalogue();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ctUomCatalogue", lhsCTUomCatalogue), LocatorUtils.property(thatLocator, "ctUomCatalogue", rhsCTUomCatalogue), lhsCTUomCatalogue, rhsCTUomCatalogue, this.isSetCTUomCatalogue(), that.isSetCTUomCatalogue())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            CTUomCatalogueType theCTUomCatalogue;
            theCTUomCatalogue = this.getCTUomCatalogue();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ctUomCatalogue", theCTUomCatalogue), currentHashCode, theCTUomCatalogue, this.isSetCTUomCatalogue());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CTUomCataloguePropertyType) {
            final CTUomCataloguePropertyType copy = ((CTUomCataloguePropertyType) draftCopy);
            {
                Boolean ctUomCatalogueShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCTUomCatalogue());
                if (ctUomCatalogueShouldBeCopiedAndSet == Boolean.TRUE) {
                    CTUomCatalogueType sourceCTUomCatalogue;
                    sourceCTUomCatalogue = this.getCTUomCatalogue();
                    CTUomCatalogueType copyCTUomCatalogue = ((CTUomCatalogueType) strategy.copy(LocatorUtils.property(locator, "ctUomCatalogue", sourceCTUomCatalogue), sourceCTUomCatalogue, this.isSetCTUomCatalogue()));
                    copy.setCTUomCatalogue(copyCTUomCatalogue);
                } else {
                    if (ctUomCatalogueShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.ctUomCatalogue = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CTUomCataloguePropertyType) {
            final CTUomCataloguePropertyType target = this;
            final CTUomCataloguePropertyType leftObject = ((CTUomCataloguePropertyType) left);
            final CTUomCataloguePropertyType rightObject = ((CTUomCataloguePropertyType) right);
            {
                Boolean ctUomCatalogueShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCTUomCatalogue(), rightObject.isSetCTUomCatalogue());
                if (ctUomCatalogueShouldBeMergedAndSet == Boolean.TRUE) {
                    CTUomCatalogueType lhsCTUomCatalogue;
                    lhsCTUomCatalogue = leftObject.getCTUomCatalogue();
                    CTUomCatalogueType rhsCTUomCatalogue;
                    rhsCTUomCatalogue = rightObject.getCTUomCatalogue();
                    CTUomCatalogueType mergedCTUomCatalogue = ((CTUomCatalogueType) strategy.merge(LocatorUtils.property(leftLocator, "ctUomCatalogue", lhsCTUomCatalogue), LocatorUtils.property(rightLocator, "ctUomCatalogue", rhsCTUomCatalogue), lhsCTUomCatalogue, rhsCTUomCatalogue, leftObject.isSetCTUomCatalogue(), rightObject.isSetCTUomCatalogue()));
                    target.setCTUomCatalogue(mergedCTUomCatalogue);
                } else {
                    if (ctUomCatalogueShouldBeMergedAndSet == Boolean.FALSE) {
                        target.ctUomCatalogue = null;
                    }
                }
            }
            {
    ...
    public CTUomCataloguePropertyType withCTUomCatalogue(CTUomCatalogueType value) {
        setCTUomCatalogue(value);
        return this;
    }

    public CTUomCataloguePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CTUomCataloguePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CTUomCataloguePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public CTUomCataloguePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CTUomCataloguePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CTUomCataloguePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CTUomCataloguePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CTUomCataloguePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CTUomCataloguePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CTUomCataloguePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CTUomCataloguePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
