...
public class OperationMethodAltPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "operationMethodAlt", buffer, theOperationMethodAlt, this.isSetOperationMethodAlt());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final OperationMethodAltPropertyType that = ((OperationMethodAltPropertyType) object);
        {
            OperationMethodAltType lhsOperationMethodAlt;
            lhsOperationMethodAlt = this.getOperationMethodAlt();
            OperationMethodAltType rhsOperationMethodAlt;
            rhsOperationMethodAlt = that.getOperationMethodAlt();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "operationMethodAlt", lhsOperationMethodAlt), LocatorUtils.property(thatLocator, "operationMethodAlt", rhsOperationMethodAlt), lhsOperationMethodAlt, rhsOperationMethodAlt, this.isSetOperationMethodAlt(), that.isSetOperationMethodAlt())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            OperationMethodAltType theOperationMethodAlt;
            theOperationMethodAlt = this.getOperationMethodAlt();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "operationMethodAlt", theOperationMethodAlt), currentHashCode, theOperationMethodAlt, this.isSetOperationMethodAlt());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof OperationMethodAltPropertyType) {
            final OperationMethodAltPropertyType copy = ((OperationMethodAltPropertyType) draftCopy);
            {
                Boolean operationMethodAltShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetOperationMethodAlt());
                if (operationMethodAltShouldBeCopiedAndSet == Boolean.TRUE) {
                    OperationMethodAltType sourceOperationMethodAlt;
                    sourceOperationMethodAlt = this.getOperationMethodAlt();
                    OperationMethodAltType copyOperationMethodAlt = ((OperationMethodAltType) strategy.copy(LocatorUtils.property(locator, "operationMethodAlt", sourceOperationMethodAlt), sourceOperationMethodAlt, this.isSetOperationMethodAlt()));
                    copy.setOperationMethodAlt(copyOperationMethodAlt);
                } else {
                    if (operationMethodAltShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.operationMethodAlt = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof OperationMethodAltPropertyType) {
            final OperationMethodAltPropertyType target = this;
            final OperationMethodAltPropertyType leftObject = ((OperationMethodAltPropertyType) left);
            final OperationMethodAltPropertyType rightObject = ((OperationMethodAltPropertyType) right);
            {
                Boolean operationMethodAltShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetOperationMethodAlt(), rightObject.isSetOperationMethodAlt());
                if (operationMethodAltShouldBeMergedAndSet == Boolean.TRUE) {
                    OperationMethodAltType lhsOperationMethodAlt;
                    lhsOperationMethodAlt = leftObject.getOperationMethodAlt();
                    OperationMethodAltType rhsOperationMethodAlt;
                    rhsOperationMethodAlt = rightObject.getOperationMethodAlt();
                    OperationMethodAltType mergedOperationMethodAlt = ((OperationMethodAltType) strategy.merge(LocatorUtils.property(leftLocator, "operationMethodAlt", lhsOperationMethodAlt), LocatorUtils.property(rightLocator, "operationMethodAlt", rhsOperationMethodAlt), lhsOperationMethodAlt, rhsOperationMethodAlt, leftObject.isSetOperationMethodAlt(), rightObject.isSetOperationMethodAlt()));
                    target.setOperationMethodAlt(mergedOperationMethodAlt);
                } else {
                    if (operationMethodAltShouldBeMergedAndSet == Boolean.FALSE) {
                        target.operationMethodAlt = null;
                    }
                }
            }
            {
    ...
    public OperationMethodAltPropertyType withOperationMethodAlt(OperationMethodAltType value) {
        setOperationMethodAlt(value);
        return this;
    }

    public OperationMethodAltPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public OperationMethodAltPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public OperationMethodAltPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public OperationMethodAltPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public OperationMethodAltPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public OperationMethodAltPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public OperationMethodAltPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public OperationMethodAltPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public OperationMethodAltPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public OperationMethodAltPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public OperationMethodAltPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
