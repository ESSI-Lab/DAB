...
public class MLPassThroughOperationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlPassThroughOperation", buffer, theMLPassThroughOperation, this.isSetMLPassThroughOperation());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLPassThroughOperationPropertyType that = ((MLPassThroughOperationPropertyType) object);
        {
            MLPassThroughOperationType lhsMLPassThroughOperation;
            lhsMLPassThroughOperation = this.getMLPassThroughOperation();
            MLPassThroughOperationType rhsMLPassThroughOperation;
            rhsMLPassThroughOperation = that.getMLPassThroughOperation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlPassThroughOperation", lhsMLPassThroughOperation), LocatorUtils.property(thatLocator, "mlPassThroughOperation", rhsMLPassThroughOperation), lhsMLPassThroughOperation, rhsMLPassThroughOperation, this.isSetMLPassThroughOperation(), that.isSetMLPassThroughOperation())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLPassThroughOperationType theMLPassThroughOperation;
            theMLPassThroughOperation = this.getMLPassThroughOperation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlPassThroughOperation", theMLPassThroughOperation), currentHashCode, theMLPassThroughOperation, this.isSetMLPassThroughOperation());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLPassThroughOperationPropertyType) {
            final MLPassThroughOperationPropertyType copy = ((MLPassThroughOperationPropertyType) draftCopy);
            {
                Boolean mlPassThroughOperationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLPassThroughOperation());
                if (mlPassThroughOperationShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLPassThroughOperationType sourceMLPassThroughOperation;
                    sourceMLPassThroughOperation = this.getMLPassThroughOperation();
                    MLPassThroughOperationType copyMLPassThroughOperation = ((MLPassThroughOperationType) strategy.copy(LocatorUtils.property(locator, "mlPassThroughOperation", sourceMLPassThroughOperation), sourceMLPassThroughOperation, this.isSetMLPassThroughOperation()));
                    copy.setMLPassThroughOperation(copyMLPassThroughOperation);
                } else {
                    if (mlPassThroughOperationShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlPassThroughOperation = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLPassThroughOperationPropertyType) {
            final MLPassThroughOperationPropertyType target = this;
            final MLPassThroughOperationPropertyType leftObject = ((MLPassThroughOperationPropertyType) left);
            final MLPassThroughOperationPropertyType rightObject = ((MLPassThroughOperationPropertyType) right);
            {
                Boolean mlPassThroughOperationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLPassThroughOperation(), rightObject.isSetMLPassThroughOperation());
                if (mlPassThroughOperationShouldBeMergedAndSet == Boolean.TRUE) {
                    MLPassThroughOperationType lhsMLPassThroughOperation;
                    lhsMLPassThroughOperation = leftObject.getMLPassThroughOperation();
                    MLPassThroughOperationType rhsMLPassThroughOperation;
                    rhsMLPassThroughOperation = rightObject.getMLPassThroughOperation();
                    MLPassThroughOperationType mergedMLPassThroughOperation = ((MLPassThroughOperationType) strategy.merge(LocatorUtils.property(leftLocator, "mlPassThroughOperation", lhsMLPassThroughOperation), LocatorUtils.property(rightLocator, "mlPassThroughOperation", rhsMLPassThroughOperation), lhsMLPassThroughOperation, rhsMLPassThroughOperation, leftObject.isSetMLPassThroughOperation(), rightObject.isSetMLPassThroughOperation()));
                    target.setMLPassThroughOperation(mergedMLPassThroughOperation);
                } else {
                    if (mlPassThroughOperationShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlPassThroughOperation = null;
                    }
                }
            }
            {
    ...
    public MLPassThroughOperationPropertyType withMLPassThroughOperation(MLPassThroughOperationType value) {
        setMLPassThroughOperation(value);
        return this;
    }

    public MLPassThroughOperationPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLPassThroughOperationPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLPassThroughOperationPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLPassThroughOperationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLPassThroughOperationPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLPassThroughOperationPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLPassThroughOperationPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLPassThroughOperationPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLPassThroughOperationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLPassThroughOperationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLPassThroughOperationPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
