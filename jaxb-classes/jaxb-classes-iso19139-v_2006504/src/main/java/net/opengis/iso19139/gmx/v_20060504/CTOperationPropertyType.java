...
import net.opengis.gml.v_3_2_0.AbstractCoordinateOperationType;
import net.opengis.gml.v_3_2_0.AbstractGeneralConversionType;
import net.opengis.gml.v_3_2_0.AbstractGeneralTransformationType;
import net.opengis.gml.v_3_2_0.ConcatenatedOperationType;
import net.opengis.gml.v_3_2_0.ConversionType;
import net.opengis.gml.v_3_2_0.PassThroughOperationType;
...
public class CTOperationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTOperationPropertyType that = ((CTOperationPropertyType) object);
        {
            JAXBElement<?> lhsAbstractCoordinateOperation;
            lhsAbstractCoordinateOperation = this.getAbstractCoordinateOperation();
            JAXBElement<?> rhsAbstractCoordinateOperation;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CTOperationPropertyType) {
            final CTOperationPropertyType copy = ((CTOperationPropertyType) draftCopy);
            {
                Boolean abstractCoordinateOperationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractCoordinateOperation());
                if (abstractCoordinateOperationShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<?> sourceAbstractCoordinateOperation;
                    sourceAbstractCoordinateOperation = this.getAbstractCoordinateOperation();
                    @SuppressWarnings("unchecked")
                    JAXBElement<?> copyAbstractCoordinateOperation = ((JAXBElement<?> ) strategy.copy(LocatorUtils.property(locator, "abstractCoordinateOperation", sourceAbstractCoordinateOperation), sourceAbstractCoordinateOperation, this.isSetAbstractCoordinateOperation()));
                    copy.setAbstractCoordinateOperation(copyAbstractCoordinateOperation);
                } else {
                    if (abstractCoordinateOperationShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CTOperationPropertyType) {
            final CTOperationPropertyType target = this;
            final CTOperationPropertyType leftObject = ((CTOperationPropertyType) left);
            final CTOperationPropertyType rightObject = ((CTOperationPropertyType) right);
            {
                Boolean abstractCoordinateOperationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractCoordinateOperation(), rightObject.isSetAbstractCoordinateOperation());
                if (abstractCoordinateOperationShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<?> lhsAbstractCoordinateOperation;
    ...
    public CTOperationPropertyType withAbstractCoordinateOperation(JAXBElement<?> value) {
        setAbstractCoordinateOperation(value);
        return this;
    }

    public CTOperationPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CTOperationPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CTOperationPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public CTOperationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CTOperationPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CTOperationPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CTOperationPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CTOperationPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CTOperationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CTOperationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CTOperationPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
