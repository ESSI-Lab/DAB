...
public class AnchorPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "anchor", buffer, theAnchor, this.isSetAnchor());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final AnchorPropertyType that = ((AnchorPropertyType) object);
        {
            AnchorType lhsAnchor;
            lhsAnchor = this.getAnchor();
            AnchorType rhsAnchor;
            rhsAnchor = that.getAnchor();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "anchor", lhsAnchor), LocatorUtils.property(thatLocator, "anchor", rhsAnchor), lhsAnchor, rhsAnchor, this.isSetAnchor(), that.isSetAnchor())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            AnchorType theAnchor;
            theAnchor = this.getAnchor();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "anchor", theAnchor), currentHashCode, theAnchor, this.isSetAnchor());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof AnchorPropertyType) {
            final AnchorPropertyType copy = ((AnchorPropertyType) draftCopy);
            {
                Boolean anchorShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAnchor());
                if (anchorShouldBeCopiedAndSet == Boolean.TRUE) {
                    AnchorType sourceAnchor;
                    sourceAnchor = this.getAnchor();
                    AnchorType copyAnchor = ((AnchorType) strategy.copy(LocatorUtils.property(locator, "anchor", sourceAnchor), sourceAnchor, this.isSetAnchor()));
                    copy.setAnchor(copyAnchor);
                } else {
                    if (anchorShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.anchor = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof AnchorPropertyType) {
            final AnchorPropertyType target = this;
            final AnchorPropertyType leftObject = ((AnchorPropertyType) left);
            final AnchorPropertyType rightObject = ((AnchorPropertyType) right);
            {
                Boolean anchorShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAnchor(), rightObject.isSetAnchor());
                if (anchorShouldBeMergedAndSet == Boolean.TRUE) {
                    AnchorType lhsAnchor;
                    lhsAnchor = leftObject.getAnchor();
                    AnchorType rhsAnchor;
                    rhsAnchor = rightObject.getAnchor();
                    AnchorType mergedAnchor = ((AnchorType) strategy.merge(LocatorUtils.property(leftLocator, "anchor", lhsAnchor), LocatorUtils.property(rightLocator, "anchor", rhsAnchor), lhsAnchor, rhsAnchor, leftObject.isSetAnchor(), rightObject.isSetAnchor()));
                    target.setAnchor(mergedAnchor);
                } else {
                    if (anchorShouldBeMergedAndSet == Boolean.FALSE) {
                        target.anchor = null;
                    }
                }
            }
    ...
    public AnchorPropertyType withAnchor(AnchorType value) {
        setAnchor(value);
        return this;
    }

    public AnchorPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public AnchorPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public AnchorPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
