...
public class MLVerticalCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlVerticalCRS", buffer, theMLVerticalCRS, this.isSetMLVerticalCRS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLVerticalCRSPropertyType that = ((MLVerticalCRSPropertyType) object);
        {
            MLVerticalCRSType lhsMLVerticalCRS;
            lhsMLVerticalCRS = this.getMLVerticalCRS();
            MLVerticalCRSType rhsMLVerticalCRS;
            rhsMLVerticalCRS = that.getMLVerticalCRS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlVerticalCRS", lhsMLVerticalCRS), LocatorUtils.property(thatLocator, "mlVerticalCRS", rhsMLVerticalCRS), lhsMLVerticalCRS, rhsMLVerticalCRS, this.isSetMLVerticalCRS(), that.isSetMLVerticalCRS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLVerticalCRSType theMLVerticalCRS;
            theMLVerticalCRS = this.getMLVerticalCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlVerticalCRS", theMLVerticalCRS), currentHashCode, theMLVerticalCRS, this.isSetMLVerticalCRS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLVerticalCRSPropertyType) {
            final MLVerticalCRSPropertyType copy = ((MLVerticalCRSPropertyType) draftCopy);
            {
                Boolean mlVerticalCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLVerticalCRS());
                if (mlVerticalCRSShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLVerticalCRSType sourceMLVerticalCRS;
                    sourceMLVerticalCRS = this.getMLVerticalCRS();
                    MLVerticalCRSType copyMLVerticalCRS = ((MLVerticalCRSType) strategy.copy(LocatorUtils.property(locator, "mlVerticalCRS", sourceMLVerticalCRS), sourceMLVerticalCRS, this.isSetMLVerticalCRS()));
                    copy.setMLVerticalCRS(copyMLVerticalCRS);
                } else {
                    if (mlVerticalCRSShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlVerticalCRS = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLVerticalCRSPropertyType) {
            final MLVerticalCRSPropertyType target = this;
            final MLVerticalCRSPropertyType leftObject = ((MLVerticalCRSPropertyType) left);
            final MLVerticalCRSPropertyType rightObject = ((MLVerticalCRSPropertyType) right);
            {
                Boolean mlVerticalCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLVerticalCRS(), rightObject.isSetMLVerticalCRS());
                if (mlVerticalCRSShouldBeMergedAndSet == Boolean.TRUE) {
                    MLVerticalCRSType lhsMLVerticalCRS;
                    lhsMLVerticalCRS = leftObject.getMLVerticalCRS();
                    MLVerticalCRSType rhsMLVerticalCRS;
                    rhsMLVerticalCRS = rightObject.getMLVerticalCRS();
                    MLVerticalCRSType mergedMLVerticalCRS = ((MLVerticalCRSType) strategy.merge(LocatorUtils.property(leftLocator, "mlVerticalCRS", lhsMLVerticalCRS), LocatorUtils.property(rightLocator, "mlVerticalCRS", rhsMLVerticalCRS), lhsMLVerticalCRS, rhsMLVerticalCRS, leftObject.isSetMLVerticalCRS(), rightObject.isSetMLVerticalCRS()));
                    target.setMLVerticalCRS(mergedMLVerticalCRS);
                } else {
                    if (mlVerticalCRSShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlVerticalCRS = null;
                    }
                }
            }
            {
    ...
    public MLVerticalCRSPropertyType withMLVerticalCRS(MLVerticalCRSType value) {
        setMLVerticalCRS(value);
        return this;
    }

    public MLVerticalCRSPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLVerticalCRSPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLVerticalCRSPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLVerticalCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLVerticalCRSPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLVerticalCRSPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLVerticalCRSPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLVerticalCRSPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLVerticalCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLVerticalCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLVerticalCRSPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
