...
public class MDConstraintsPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdConstraints", buffer, theMDConstraints, this.isSetMDConstraints());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<? extends MDConstraintsType> lhsMDConstraints;
            lhsMDConstraints = this.getMDConstraints();
            JAXBElement<? extends MDConstraintsType> rhsMDConstraints;
            rhsMDConstraints = that.getMDConstraints();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdConstraints", lhsMDConstraints), LocatorUtils.property(thatLocator, "mdConstraints", rhsMDConstraints), lhsMDConstraints, rhsMDConstraints, this.isSetMDConstraints(), that.isSetMDConstraints())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends MDConstraintsType> theMDConstraints;
            theMDConstraints = this.getMDConstraints();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdConstraints", theMDConstraints), currentHashCode, theMDConstraints, this.isSetMDConstraints());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDConstraintsPropertyType) {
            final MDConstraintsPropertyType copy = ((MDConstraintsPropertyType) draftCopy);
            {
                Boolean mdConstraintsShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDConstraints());
                if (mdConstraintsShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends MDConstraintsType> sourceMDConstraints;
                    sourceMDConstraints = this.getMDConstraints();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends MDConstraintsType> copyMDConstraints = ((JAXBElement<? extends MDConstraintsType> ) strategy.copy(LocatorUtils.property(locator, "mdConstraints", sourceMDConstraints), sourceMDConstraints, this.isSetMDConstraints()));
                    copy.setMDConstraints(copyMDConstraints);
                } else {
                    if (mdConstraintsShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdConstraints = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDConstraintsPropertyType) {
            final MDConstraintsPropertyType target = this;
            final MDConstraintsPropertyType leftObject = ((MDConstraintsPropertyType) left);
            final MDConstraintsPropertyType rightObject = ((MDConstraintsPropertyType) right);
            {
                Boolean mdConstraintsShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDConstraints(), rightObject.isSetMDConstraints());
                if (mdConstraintsShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends MDConstraintsType> lhsMDConstraints;
                    lhsMDConstraints = leftObject.getMDConstraints();
                    JAXBElement<? extends MDConstraintsType> rhsMDConstraints;
                    rhsMDConstraints = rightObject.getMDConstraints();
                    JAXBElement<? extends MDConstraintsType> mergedMDConstraints = ((JAXBElement<? extends MDConstraintsType> ) strategy.merge(LocatorUtils.property(leftLocator, "mdConstraints", lhsMDConstraints), LocatorUtils.property(rightLocator, "mdConstraints", rhsMDConstraints), lhsMDConstraints, rhsMDConstraints, leftObject.isSetMDConstraints(), rightObject.isSetMDConstraints()));
                    target.setMDConstraints(mergedMDConstraints);
                } else {
                    if (mdConstraintsShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdConstraints = null;
                    }
                }
            }
            {
    ...
    public MDConstraintsPropertyType withMDConstraints(JAXBElement<? extends MDConstraintsType> value) {
        setMDConstraints(value);
        return this;
    }

    public MDConstraintsPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDConstraintsPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDConstraintsPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDConstraintsPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDConstraintsPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDConstraintsPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDConstraintsPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDConstraintsPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDConstraintsPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDConstraintsPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDConstraintsPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
