...
public class MLCoordinateSystemAxisPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlCoordinateSystemAxis", buffer, theMLCoordinateSystemAxis, this.isSetMLCoordinateSystemAxis());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLCoordinateSystemAxisPropertyType that = ((MLCoordinateSystemAxisPropertyType) object);
        {
            MLCoordinateSystemAxisType lhsMLCoordinateSystemAxis;
            lhsMLCoordinateSystemAxis = this.getMLCoordinateSystemAxis();
            MLCoordinateSystemAxisType rhsMLCoordinateSystemAxis;
            rhsMLCoordinateSystemAxis = that.getMLCoordinateSystemAxis();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlCoordinateSystemAxis", lhsMLCoordinateSystemAxis), LocatorUtils.property(thatLocator, "mlCoordinateSystemAxis", rhsMLCoordinateSystemAxis), lhsMLCoordinateSystemAxis, rhsMLCoordinateSystemAxis, this.isSetMLCoordinateSystemAxis(), that.isSetMLCoordinateSystemAxis())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLCoordinateSystemAxisType theMLCoordinateSystemAxis;
            theMLCoordinateSystemAxis = this.getMLCoordinateSystemAxis();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlCoordinateSystemAxis", theMLCoordinateSystemAxis), currentHashCode, theMLCoordinateSystemAxis, this.isSetMLCoordinateSystemAxis());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLCoordinateSystemAxisPropertyType) {
            final MLCoordinateSystemAxisPropertyType copy = ((MLCoordinateSystemAxisPropertyType) draftCopy);
            {
                Boolean mlCoordinateSystemAxisShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLCoordinateSystemAxis());
                if (mlCoordinateSystemAxisShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLCoordinateSystemAxisType sourceMLCoordinateSystemAxis;
                    sourceMLCoordinateSystemAxis = this.getMLCoordinateSystemAxis();
                    MLCoordinateSystemAxisType copyMLCoordinateSystemAxis = ((MLCoordinateSystemAxisType) strategy.copy(LocatorUtils.property(locator, "mlCoordinateSystemAxis", sourceMLCoordinateSystemAxis), sourceMLCoordinateSystemAxis, this.isSetMLCoordinateSystemAxis()));
                    copy.setMLCoordinateSystemAxis(copyMLCoordinateSystemAxis);
                } else {
                    if (mlCoordinateSystemAxisShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlCoordinateSystemAxis = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLCoordinateSystemAxisPropertyType) {
            final MLCoordinateSystemAxisPropertyType target = this;
            final MLCoordinateSystemAxisPropertyType leftObject = ((MLCoordinateSystemAxisPropertyType) left);
            final MLCoordinateSystemAxisPropertyType rightObject = ((MLCoordinateSystemAxisPropertyType) right);
            {
                Boolean mlCoordinateSystemAxisShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLCoordinateSystemAxis(), rightObject.isSetMLCoordinateSystemAxis());
                if (mlCoordinateSystemAxisShouldBeMergedAndSet == Boolean.TRUE) {
                    MLCoordinateSystemAxisType lhsMLCoordinateSystemAxis;
                    lhsMLCoordinateSystemAxis = leftObject.getMLCoordinateSystemAxis();
                    MLCoordinateSystemAxisType rhsMLCoordinateSystemAxis;
                    rhsMLCoordinateSystemAxis = rightObject.getMLCoordinateSystemAxis();
                    MLCoordinateSystemAxisType mergedMLCoordinateSystemAxis = ((MLCoordinateSystemAxisType) strategy.merge(LocatorUtils.property(leftLocator, "mlCoordinateSystemAxis", lhsMLCoordinateSystemAxis), LocatorUtils.property(rightLocator, "mlCoordinateSystemAxis", rhsMLCoordinateSystemAxis), lhsMLCoordinateSystemAxis, rhsMLCoordinateSystemAxis, leftObject.isSetMLCoordinateSystemAxis(), rightObject.isSetMLCoordinateSystemAxis()));
                    target.setMLCoordinateSystemAxis(mergedMLCoordinateSystemAxis);
                } else {
                    if (mlCoordinateSystemAxisShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlCoordinateSystemAxis = null;
                    }
                }
            }
            {
    ...
    public MLCoordinateSystemAxisPropertyType withMLCoordinateSystemAxis(MLCoordinateSystemAxisType value) {
        setMLCoordinateSystemAxis(value);
        return this;
    }

    public MLCoordinateSystemAxisPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLCoordinateSystemAxisPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLCoordinateSystemAxisPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLCoordinateSystemAxisPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLCoordinateSystemAxisPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLCoordinateSystemAxisPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLCoordinateSystemAxisPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLCoordinateSystemAxisPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLCoordinateSystemAxisPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLCoordinateSystemAxisPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLCoordinateSystemAxisPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
