...
public class MDCoverageDescriptionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdCoverageDescription", buffer, theMDCoverageDescription, this.isSetMDCoverageDescription());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<? extends MDCoverageDescriptionType> lhsMDCoverageDescription;
            lhsMDCoverageDescription = this.getMDCoverageDescription();
            JAXBElement<? extends MDCoverageDescriptionType> rhsMDCoverageDescription;
            rhsMDCoverageDescription = that.getMDCoverageDescription();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdCoverageDescription", lhsMDCoverageDescription), LocatorUtils.property(thatLocator, "mdCoverageDescription", rhsMDCoverageDescription), lhsMDCoverageDescription, rhsMDCoverageDescription, this.isSetMDCoverageDescription(), that.isSetMDCoverageDescription())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends MDCoverageDescriptionType> theMDCoverageDescription;
            theMDCoverageDescription = this.getMDCoverageDescription();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdCoverageDescription", theMDCoverageDescription), currentHashCode, theMDCoverageDescription, this.isSetMDCoverageDescription());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDCoverageDescriptionPropertyType) {
            final MDCoverageDescriptionPropertyType copy = ((MDCoverageDescriptionPropertyType) draftCopy);
            {
                Boolean mdCoverageDescriptionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDCoverageDescription());
                if (mdCoverageDescriptionShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends MDCoverageDescriptionType> sourceMDCoverageDescription;
                    sourceMDCoverageDescription = this.getMDCoverageDescription();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends MDCoverageDescriptionType> copyMDCoverageDescription = ((JAXBElement<? extends MDCoverageDescriptionType> ) strategy.copy(LocatorUtils.property(locator, "mdCoverageDescription", sourceMDCoverageDescription), sourceMDCoverageDescription, this.isSetMDCoverageDescription()));
                    copy.setMDCoverageDescription(copyMDCoverageDescription);
                } else {
                    if (mdCoverageDescriptionShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdCoverageDescription = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDCoverageDescriptionPropertyType) {
            final MDCoverageDescriptionPropertyType target = this;
            final MDCoverageDescriptionPropertyType leftObject = ((MDCoverageDescriptionPropertyType) left);
            final MDCoverageDescriptionPropertyType rightObject = ((MDCoverageDescriptionPropertyType) right);
            {
                Boolean mdCoverageDescriptionShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDCoverageDescription(), rightObject.isSetMDCoverageDescription());
                if (mdCoverageDescriptionShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends MDCoverageDescriptionType> lhsMDCoverageDescription;
                    lhsMDCoverageDescription = leftObject.getMDCoverageDescription();
                    JAXBElement<? extends MDCoverageDescriptionType> rhsMDCoverageDescription;
                    rhsMDCoverageDescription = rightObject.getMDCoverageDescription();
                    JAXBElement<? extends MDCoverageDescriptionType> mergedMDCoverageDescription = ((JAXBElement<? extends MDCoverageDescriptionType> ) strategy.merge(LocatorUtils.property(leftLocator, "mdCoverageDescription", lhsMDCoverageDescription), LocatorUtils.property(rightLocator, "mdCoverageDescription", rhsMDCoverageDescription), lhsMDCoverageDescription, rhsMDCoverageDescription, leftObject.isSetMDCoverageDescription(), rightObject.isSetMDCoverageDescription()));
                    target.setMDCoverageDescription(mergedMDCoverageDescription);
                } else {
                    if (mdCoverageDescriptionShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdCoverageDescription = null;
                    }
                }
            }
            {
    ...
    public MDCoverageDescriptionPropertyType withMDCoverageDescription(JAXBElement<? extends MDCoverageDescriptionType> value) {
        setMDCoverageDescription(value);
        return this;
    }

    public MDCoverageDescriptionPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDCoverageDescriptionPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDCoverageDescriptionPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDCoverageDescriptionPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDCoverageDescriptionPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDCoverageDescriptionPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDCoverageDescriptionPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDCoverageDescriptionPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDCoverageDescriptionPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDCoverageDescriptionPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDCoverageDescriptionPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
