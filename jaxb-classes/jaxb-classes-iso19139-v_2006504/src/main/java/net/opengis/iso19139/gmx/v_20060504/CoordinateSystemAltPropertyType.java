...
public class CoordinateSystemAltPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "coordinateSystemAlt", buffer, theCoordinateSystemAlt, this.isSetCoordinateSystemAlt());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CoordinateSystemAltPropertyType that = ((CoordinateSystemAltPropertyType) object);
        {
            CoordinateSystemAltType lhsCoordinateSystemAlt;
            lhsCoordinateSystemAlt = this.getCoordinateSystemAlt();
            CoordinateSystemAltType rhsCoordinateSystemAlt;
            rhsCoordinateSystemAlt = that.getCoordinateSystemAlt();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "coordinateSystemAlt", lhsCoordinateSystemAlt), LocatorUtils.property(thatLocator, "coordinateSystemAlt", rhsCoordinateSystemAlt), lhsCoordinateSystemAlt, rhsCoordinateSystemAlt, this.isSetCoordinateSystemAlt(), that.isSetCoordinateSystemAlt())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            CoordinateSystemAltType theCoordinateSystemAlt;
            theCoordinateSystemAlt = this.getCoordinateSystemAlt();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "coordinateSystemAlt", theCoordinateSystemAlt), currentHashCode, theCoordinateSystemAlt, this.isSetCoordinateSystemAlt());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CoordinateSystemAltPropertyType) {
            final CoordinateSystemAltPropertyType copy = ((CoordinateSystemAltPropertyType) draftCopy);
            {
                Boolean coordinateSystemAltShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCoordinateSystemAlt());
                if (coordinateSystemAltShouldBeCopiedAndSet == Boolean.TRUE) {
                    CoordinateSystemAltType sourceCoordinateSystemAlt;
                    sourceCoordinateSystemAlt = this.getCoordinateSystemAlt();
                    CoordinateSystemAltType copyCoordinateSystemAlt = ((CoordinateSystemAltType) strategy.copy(LocatorUtils.property(locator, "coordinateSystemAlt", sourceCoordinateSystemAlt), sourceCoordinateSystemAlt, this.isSetCoordinateSystemAlt()));
                    copy.setCoordinateSystemAlt(copyCoordinateSystemAlt);
                } else {
                    if (coordinateSystemAltShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.coordinateSystemAlt = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CoordinateSystemAltPropertyType) {
            final CoordinateSystemAltPropertyType target = this;
            final CoordinateSystemAltPropertyType leftObject = ((CoordinateSystemAltPropertyType) left);
            final CoordinateSystemAltPropertyType rightObject = ((CoordinateSystemAltPropertyType) right);
            {
                Boolean coordinateSystemAltShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCoordinateSystemAlt(), rightObject.isSetCoordinateSystemAlt());
                if (coordinateSystemAltShouldBeMergedAndSet == Boolean.TRUE) {
                    CoordinateSystemAltType lhsCoordinateSystemAlt;
                    lhsCoordinateSystemAlt = leftObject.getCoordinateSystemAlt();
                    CoordinateSystemAltType rhsCoordinateSystemAlt;
                    rhsCoordinateSystemAlt = rightObject.getCoordinateSystemAlt();
                    CoordinateSystemAltType mergedCoordinateSystemAlt = ((CoordinateSystemAltType) strategy.merge(LocatorUtils.property(leftLocator, "coordinateSystemAlt", lhsCoordinateSystemAlt), LocatorUtils.property(rightLocator, "coordinateSystemAlt", rhsCoordinateSystemAlt), lhsCoordinateSystemAlt, rhsCoordinateSystemAlt, leftObject.isSetCoordinateSystemAlt(), rightObject.isSetCoordinateSystemAlt()));
                    target.setCoordinateSystemAlt(mergedCoordinateSystemAlt);
                } else {
                    if (coordinateSystemAltShouldBeMergedAndSet == Boolean.FALSE) {
                        target.coordinateSystemAlt = null;
                    }
                }
            }
            {
    ...
    public CoordinateSystemAltPropertyType withCoordinateSystemAlt(CoordinateSystemAltType value) {
        setCoordinateSystemAlt(value);
        return this;
    }

    public CoordinateSystemAltPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CoordinateSystemAltPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CoordinateSystemAltPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public CoordinateSystemAltPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CoordinateSystemAltPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CoordinateSystemAltPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CoordinateSystemAltPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CoordinateSystemAltPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CoordinateSystemAltPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CoordinateSystemAltPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CoordinateSystemAltPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
