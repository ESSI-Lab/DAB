    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SVOperationChainMetadataType that = ((SVOperationChainMetadataType) object);
        {
        ...
        {
            List<SVOperationMetadataPropertyType> lhsOperation;
            lhsOperation = (this.isSetOperation()?this.getOperation():null);
            List<SVOperationMetadataPropertyType> rhsOperation;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SVOperationChainMetadataType) {
            final SVOperationChainMetadataType copy = ((SVOperationChainMetadataType) draftCopy);
            {
            ...
            }
            {
                ...
                if (operationShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<SVOperationMetadataPropertyType> sourceOperation;
                    sourceOperation = (this.isSetOperation()?this.getOperation():null);
                    @SuppressWarnings("unchecked")
                    List<SVOperationMetadataPropertyType> copyOperation = ((List<SVOperationMetadataPropertyType> ) strategy.copy(LocatorUtils.property(locator, "operation", sourceOperation), sourceOperation, this.isSetOperation()));
                    copy.unsetOperation();
                    if (copyOperation!= null) {
                        List<SVOperationMetadataPropertyType> uniqueOperationl = copy.getOperation();
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof SVOperationChainMetadataType) {
            final SVOperationChainMetadataType target = this;
            final SVOperationChainMetadataType leftObject = ((SVOperationChainMetadataType) left);
            final SVOperationChainMetadataType rightObject = ((SVOperationChainMetadataType) right);
            {
            ...
            }
            {
                ...
                if (operationShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    List<SVOperationMetadataPropertyType> mergedOperation = ((List<SVOperationMetadataPropertyType> ) strategy.merge(LocatorUtils.property(leftLocator, "operation", lhsOperation), LocatorUtils.property(rightLocator, "operation", rhsOperation), lhsOperation, rhsOperation, leftObject.isSetOperation(), rightObject.isSetOperation()));
                    target.unsetOperation();
                    if (mergedOperation!= null) {
                        List<SVOperationMetadataPropertyType> uniqueOperationl = target.getOperation();
    ...
    public SVOperationChainMetadataType withName(CharacterStringPropertyType value) {
        setName(value);
        return this;
    }

    public SVOperationChainMetadataType withDescription(CharacterStringPropertyType value) {
        setDescription(value);
        return this;
    }

    public SVOperationChainMetadataType withOperation(SVOperationMetadataPropertyType... values) {
        if (values!= null) {
    ...
    public SVOperationChainMetadataType withOperation(Collection<SVOperationMetadataPropertyType> values) {
        if (values!= null) {
    ...
    public SVOperationChainMetadataType withOperation(List<SVOperationMetadataPropertyType> value) {
        setOperation(value);
        return this;
    }

    @Override
    public SVOperationChainMetadataType withId(String value) {
        setId(value);
        return this;
    }

    @Override
    public SVOperationChainMetadataType withUuid(String value) {
        setUuid(value);
        return this;
    }
