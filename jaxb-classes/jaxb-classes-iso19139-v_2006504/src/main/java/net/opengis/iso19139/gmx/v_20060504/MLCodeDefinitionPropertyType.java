...
public class MLCodeDefinitionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlCodeDefinition", buffer, theMLCodeDefinition, this.isSetMLCodeDefinition());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLCodeDefinitionPropertyType that = ((MLCodeDefinitionPropertyType) object);
        {
            MLCodeDefinitionType lhsMLCodeDefinition;
            lhsMLCodeDefinition = this.getMLCodeDefinition();
            MLCodeDefinitionType rhsMLCodeDefinition;
            rhsMLCodeDefinition = that.getMLCodeDefinition();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlCodeDefinition", lhsMLCodeDefinition), LocatorUtils.property(thatLocator, "mlCodeDefinition", rhsMLCodeDefinition), lhsMLCodeDefinition, rhsMLCodeDefinition, this.isSetMLCodeDefinition(), that.isSetMLCodeDefinition())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLCodeDefinitionType theMLCodeDefinition;
            theMLCodeDefinition = this.getMLCodeDefinition();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlCodeDefinition", theMLCodeDefinition), currentHashCode, theMLCodeDefinition, this.isSetMLCodeDefinition());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLCodeDefinitionPropertyType) {
            final MLCodeDefinitionPropertyType copy = ((MLCodeDefinitionPropertyType) draftCopy);
            {
                Boolean mlCodeDefinitionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLCodeDefinition());
                if (mlCodeDefinitionShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLCodeDefinitionType sourceMLCodeDefinition;
                    sourceMLCodeDefinition = this.getMLCodeDefinition();
                    MLCodeDefinitionType copyMLCodeDefinition = ((MLCodeDefinitionType) strategy.copy(LocatorUtils.property(locator, "mlCodeDefinition", sourceMLCodeDefinition), sourceMLCodeDefinition, this.isSetMLCodeDefinition()));
                    copy.setMLCodeDefinition(copyMLCodeDefinition);
                } else {
                    if (mlCodeDefinitionShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlCodeDefinition = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLCodeDefinitionPropertyType) {
            final MLCodeDefinitionPropertyType target = this;
            final MLCodeDefinitionPropertyType leftObject = ((MLCodeDefinitionPropertyType) left);
            final MLCodeDefinitionPropertyType rightObject = ((MLCodeDefinitionPropertyType) right);
            {
                Boolean mlCodeDefinitionShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLCodeDefinition(), rightObject.isSetMLCodeDefinition());
                if (mlCodeDefinitionShouldBeMergedAndSet == Boolean.TRUE) {
                    MLCodeDefinitionType lhsMLCodeDefinition;
                    lhsMLCodeDefinition = leftObject.getMLCodeDefinition();
                    MLCodeDefinitionType rhsMLCodeDefinition;
                    rhsMLCodeDefinition = rightObject.getMLCodeDefinition();
                    MLCodeDefinitionType mergedMLCodeDefinition = ((MLCodeDefinitionType) strategy.merge(LocatorUtils.property(leftLocator, "mlCodeDefinition", lhsMLCodeDefinition), LocatorUtils.property(rightLocator, "mlCodeDefinition", rhsMLCodeDefinition), lhsMLCodeDefinition, rhsMLCodeDefinition, leftObject.isSetMLCodeDefinition(), rightObject.isSetMLCodeDefinition()));
                    target.setMLCodeDefinition(mergedMLCodeDefinition);
                } else {
                    if (mlCodeDefinitionShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlCodeDefinition = null;
                    }
                }
            }
            {
    ...
    public MLCodeDefinitionPropertyType withMLCodeDefinition(MLCodeDefinitionType value) {
        setMLCodeDefinition(value);
        return this;
    }

    public MLCodeDefinitionPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLCodeDefinitionPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLCodeDefinitionPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLCodeDefinitionPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLCodeDefinitionPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLCodeDefinitionPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLCodeDefinitionPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLCodeDefinitionPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLCodeDefinitionPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLCodeDefinitionPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLCodeDefinitionPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
