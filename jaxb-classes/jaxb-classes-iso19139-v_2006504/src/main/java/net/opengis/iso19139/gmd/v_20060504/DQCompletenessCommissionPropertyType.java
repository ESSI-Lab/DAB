...
public class DQCompletenessCommissionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "dqCompletenessCommission", buffer, theDQCompletenessCommission, this.isSetDQCompletenessCommission());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            DQCompletenessCommissionType lhsDQCompletenessCommission;
            lhsDQCompletenessCommission = this.getDQCompletenessCommission();
            DQCompletenessCommissionType rhsDQCompletenessCommission;
            rhsDQCompletenessCommission = that.getDQCompletenessCommission();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dqCompletenessCommission", lhsDQCompletenessCommission), LocatorUtils.property(thatLocator, "dqCompletenessCommission", rhsDQCompletenessCommission), lhsDQCompletenessCommission, rhsDQCompletenessCommission, this.isSetDQCompletenessCommission(), that.isSetDQCompletenessCommission())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            DQCompletenessCommissionType theDQCompletenessCommission;
            theDQCompletenessCommission = this.getDQCompletenessCommission();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dqCompletenessCommission", theDQCompletenessCommission), currentHashCode, theDQCompletenessCommission, this.isSetDQCompletenessCommission());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DQCompletenessCommissionPropertyType) {
            final DQCompletenessCommissionPropertyType copy = ((DQCompletenessCommissionPropertyType) draftCopy);
            {
                Boolean dqCompletenessCommissionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDQCompletenessCommission());
                if (dqCompletenessCommissionShouldBeCopiedAndSet == Boolean.TRUE) {
                    DQCompletenessCommissionType sourceDQCompletenessCommission;
                    sourceDQCompletenessCommission = this.getDQCompletenessCommission();
                    DQCompletenessCommissionType copyDQCompletenessCommission = ((DQCompletenessCommissionType) strategy.copy(LocatorUtils.property(locator, "dqCompletenessCommission", sourceDQCompletenessCommission), sourceDQCompletenessCommission, this.isSetDQCompletenessCommission()));
                    copy.setDQCompletenessCommission(copyDQCompletenessCommission);
                } else {
                    if (dqCompletenessCommissionShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.dqCompletenessCommission = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DQCompletenessCommissionPropertyType) {
            final DQCompletenessCommissionPropertyType target = this;
            final DQCompletenessCommissionPropertyType leftObject = ((DQCompletenessCommissionPropertyType) left);
            final DQCompletenessCommissionPropertyType rightObject = ((DQCompletenessCommissionPropertyType) right);
            {
                Boolean dqCompletenessCommissionShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDQCompletenessCommission(), rightObject.isSetDQCompletenessCommission());
                if (dqCompletenessCommissionShouldBeMergedAndSet == Boolean.TRUE) {
                    DQCompletenessCommissionType lhsDQCompletenessCommission;
                    lhsDQCompletenessCommission = leftObject.getDQCompletenessCommission();
                    DQCompletenessCommissionType rhsDQCompletenessCommission;
                    rhsDQCompletenessCommission = rightObject.getDQCompletenessCommission();
                    DQCompletenessCommissionType mergedDQCompletenessCommission = ((DQCompletenessCommissionType) strategy.merge(LocatorUtils.property(leftLocator, "dqCompletenessCommission", lhsDQCompletenessCommission), LocatorUtils.property(rightLocator, "dqCompletenessCommission", rhsDQCompletenessCommission), lhsDQCompletenessCommission, rhsDQCompletenessCommission, leftObject.isSetDQCompletenessCommission(), rightObject.isSetDQCompletenessCommission()));
                    target.setDQCompletenessCommission(mergedDQCompletenessCommission);
                } else {
                    if (dqCompletenessCommissionShouldBeMergedAndSet == Boolean.FALSE) {
                        target.dqCompletenessCommission = null;
                    }
                }
            }
            {
    ...
    public DQCompletenessCommissionPropertyType withDQCompletenessCommission(DQCompletenessCommissionType value) {
        setDQCompletenessCommission(value);
        return this;
    }

    public DQCompletenessCommissionPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DQCompletenessCommissionPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DQCompletenessCommissionPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DQCompletenessCommissionPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DQCompletenessCommissionPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DQCompletenessCommissionPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DQCompletenessCommissionPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DQCompletenessCommissionPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DQCompletenessCommissionPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DQCompletenessCommissionPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DQCompletenessCommissionPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
