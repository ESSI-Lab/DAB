...
public class MeasurePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "measure", buffer, theMeasure, this.isSetMeasure());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MeasurePropertyType that = ((MeasurePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "measure", lhsMeasure), LocatorUtils.property(thatLocator, "measure", rhsMeasure), lhsMeasure, rhsMeasure, this.isSetMeasure(), that.isSetMeasure())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<?> theMeasure;
            theMeasure = this.getMeasure();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "measure", theMeasure), currentHashCode, theMeasure, this.isSetMeasure());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MeasurePropertyType) {
            ...
            {
                Boolean measureShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMeasure());
                if (measureShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<?> sourceMeasure;
                    sourceMeasure = this.getMeasure();
                    @SuppressWarnings("unchecked")
                    JAXBElement<?> copyMeasure = ((JAXBElement<?> ) strategy.copy(LocatorUtils.property(locator, "measure", sourceMeasure), sourceMeasure, this.isSetMeasure()));
                    copy.setMeasure(copyMeasure);
                } else {
                    if (measureShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.measure = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MeasurePropertyType) {
            final MeasurePropertyType target = this;
            final MeasurePropertyType leftObject = ((MeasurePropertyType) left);
            final MeasurePropertyType rightObject = ((MeasurePropertyType) right);
            {
                Boolean measureShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMeasure(), rightObject.isSetMeasure());
                if (measureShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<?> lhsMeasure;
                    lhsMeasure = leftObject.getMeasure();
                    JAXBElement<?> rhsMeasure;
                    rhsMeasure = rightObject.getMeasure();
                    JAXBElement<?> mergedMeasure = ((JAXBElement<?> ) strategy.merge(LocatorUtils.property(leftLocator, "measure", lhsMeasure), LocatorUtils.property(rightLocator, "measure", rhsMeasure), lhsMeasure, rhsMeasure, leftObject.isSetMeasure(), rightObject.isSetMeasure()));
                    target.setMeasure(mergedMeasure);
                } else {
                    if (measureShouldBeMergedAndSet == Boolean.FALSE) {
                        target.measure = null;
                    }
                }
            }
    ...
    public MeasurePropertyType withMeasure(JAXBElement<?> value) {
        setMeasure(value);
        return this;
    }

    public MeasurePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MeasurePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MeasurePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
