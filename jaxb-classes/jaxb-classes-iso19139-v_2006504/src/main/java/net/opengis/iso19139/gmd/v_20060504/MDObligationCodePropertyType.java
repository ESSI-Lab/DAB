...
public class MDObligationCodePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public MDObligationCodePropertyType withMDObligationCode(MDObligationCodeType value) {
        setMDObligationCode(value);
        return this;
    }

    public MDObligationCodePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDObligationCodePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDObligationCodePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
