...
public class SVServiceIdentificationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "svServiceIdentification", buffer, theSVServiceIdentification, this.isSetSVServiceIdentification());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SVServiceIdentificationPropertyType that = ((SVServiceIdentificationPropertyType) object);
        {
            SVServiceIdentificationType lhsSVServiceIdentification;
            lhsSVServiceIdentification = this.getSVServiceIdentification();
            SVServiceIdentificationType rhsSVServiceIdentification;
            rhsSVServiceIdentification = that.getSVServiceIdentification();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "svServiceIdentification", lhsSVServiceIdentification), LocatorUtils.property(thatLocator, "svServiceIdentification", rhsSVServiceIdentification), lhsSVServiceIdentification, rhsSVServiceIdentification, this.isSetSVServiceIdentification(), that.isSetSVServiceIdentification())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            SVServiceIdentificationType theSVServiceIdentification;
            theSVServiceIdentification = this.getSVServiceIdentification();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "svServiceIdentification", theSVServiceIdentification), currentHashCode, theSVServiceIdentification, this.isSetSVServiceIdentification());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SVServiceIdentificationPropertyType) {
            final SVServiceIdentificationPropertyType copy = ((SVServiceIdentificationPropertyType) draftCopy);
            {
                Boolean svServiceIdentificationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSVServiceIdentification());
                if (svServiceIdentificationShouldBeCopiedAndSet == Boolean.TRUE) {
                    SVServiceIdentificationType sourceSVServiceIdentification;
                    sourceSVServiceIdentification = this.getSVServiceIdentification();
                    SVServiceIdentificationType copySVServiceIdentification = ((SVServiceIdentificationType) strategy.copy(LocatorUtils.property(locator, "svServiceIdentification", sourceSVServiceIdentification), sourceSVServiceIdentification, this.isSetSVServiceIdentification()));
                    copy.setSVServiceIdentification(copySVServiceIdentification);
                } else {
                    if (svServiceIdentificationShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.svServiceIdentification = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SVServiceIdentificationPropertyType) {
            final SVServiceIdentificationPropertyType target = this;
            final SVServiceIdentificationPropertyType leftObject = ((SVServiceIdentificationPropertyType) left);
            final SVServiceIdentificationPropertyType rightObject = ((SVServiceIdentificationPropertyType) right);
            {
                Boolean svServiceIdentificationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSVServiceIdentification(), rightObject.isSetSVServiceIdentification());
                if (svServiceIdentificationShouldBeMergedAndSet == Boolean.TRUE) {
                    SVServiceIdentificationType lhsSVServiceIdentification;
                    lhsSVServiceIdentification = leftObject.getSVServiceIdentification();
                    SVServiceIdentificationType rhsSVServiceIdentification;
                    rhsSVServiceIdentification = rightObject.getSVServiceIdentification();
                    SVServiceIdentificationType mergedSVServiceIdentification = ((SVServiceIdentificationType) strategy.merge(LocatorUtils.property(leftLocator, "svServiceIdentification", lhsSVServiceIdentification), LocatorUtils.property(rightLocator, "svServiceIdentification", rhsSVServiceIdentification), lhsSVServiceIdentification, rhsSVServiceIdentification, leftObject.isSetSVServiceIdentification(), rightObject.isSetSVServiceIdentification()));
                    target.setSVServiceIdentification(mergedSVServiceIdentification);
                } else {
                    if (svServiceIdentificationShouldBeMergedAndSet == Boolean.FALSE) {
                        target.svServiceIdentification = null;
                    }
                }
            }
            {
    ...
    public SVServiceIdentificationPropertyType withSVServiceIdentification(SVServiceIdentificationType value) {
        setSVServiceIdentification(value);
        return this;
    }

    public SVServiceIdentificationPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public SVServiceIdentificationPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public SVServiceIdentificationPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public SVServiceIdentificationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SVServiceIdentificationPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public SVServiceIdentificationPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public SVServiceIdentificationPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SVServiceIdentificationPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SVServiceIdentificationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SVServiceIdentificationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public SVServiceIdentificationPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
