...
public class MLConcatenatedOperationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlConcatenatedOperation", buffer, theMLConcatenatedOperation, this.isSetMLConcatenatedOperation());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLConcatenatedOperationPropertyType that = ((MLConcatenatedOperationPropertyType) object);
        {
            MLConcatenatedOperationType lhsMLConcatenatedOperation;
            lhsMLConcatenatedOperation = this.getMLConcatenatedOperation();
            MLConcatenatedOperationType rhsMLConcatenatedOperation;
            rhsMLConcatenatedOperation = that.getMLConcatenatedOperation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlConcatenatedOperation", lhsMLConcatenatedOperation), LocatorUtils.property(thatLocator, "mlConcatenatedOperation", rhsMLConcatenatedOperation), lhsMLConcatenatedOperation, rhsMLConcatenatedOperation, this.isSetMLConcatenatedOperation(), that.isSetMLConcatenatedOperation())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLConcatenatedOperationType theMLConcatenatedOperation;
            theMLConcatenatedOperation = this.getMLConcatenatedOperation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlConcatenatedOperation", theMLConcatenatedOperation), currentHashCode, theMLConcatenatedOperation, this.isSetMLConcatenatedOperation());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLConcatenatedOperationPropertyType) {
            final MLConcatenatedOperationPropertyType copy = ((MLConcatenatedOperationPropertyType) draftCopy);
            {
                Boolean mlConcatenatedOperationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLConcatenatedOperation());
                if (mlConcatenatedOperationShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLConcatenatedOperationType sourceMLConcatenatedOperation;
                    sourceMLConcatenatedOperation = this.getMLConcatenatedOperation();
                    MLConcatenatedOperationType copyMLConcatenatedOperation = ((MLConcatenatedOperationType) strategy.copy(LocatorUtils.property(locator, "mlConcatenatedOperation", sourceMLConcatenatedOperation), sourceMLConcatenatedOperation, this.isSetMLConcatenatedOperation()));
                    copy.setMLConcatenatedOperation(copyMLConcatenatedOperation);
                } else {
                    if (mlConcatenatedOperationShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlConcatenatedOperation = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLConcatenatedOperationPropertyType) {
            final MLConcatenatedOperationPropertyType target = this;
            final MLConcatenatedOperationPropertyType leftObject = ((MLConcatenatedOperationPropertyType) left);
            final MLConcatenatedOperationPropertyType rightObject = ((MLConcatenatedOperationPropertyType) right);
            {
                Boolean mlConcatenatedOperationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLConcatenatedOperation(), rightObject.isSetMLConcatenatedOperation());
                if (mlConcatenatedOperationShouldBeMergedAndSet == Boolean.TRUE) {
                    MLConcatenatedOperationType lhsMLConcatenatedOperation;
                    lhsMLConcatenatedOperation = leftObject.getMLConcatenatedOperation();
                    MLConcatenatedOperationType rhsMLConcatenatedOperation;
                    rhsMLConcatenatedOperation = rightObject.getMLConcatenatedOperation();
                    MLConcatenatedOperationType mergedMLConcatenatedOperation = ((MLConcatenatedOperationType) strategy.merge(LocatorUtils.property(leftLocator, "mlConcatenatedOperation", lhsMLConcatenatedOperation), LocatorUtils.property(rightLocator, "mlConcatenatedOperation", rhsMLConcatenatedOperation), lhsMLConcatenatedOperation, rhsMLConcatenatedOperation, leftObject.isSetMLConcatenatedOperation(), rightObject.isSetMLConcatenatedOperation()));
                    target.setMLConcatenatedOperation(mergedMLConcatenatedOperation);
                } else {
                    if (mlConcatenatedOperationShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlConcatenatedOperation = null;
                    }
                }
            }
            {
    ...
    public MLConcatenatedOperationPropertyType withMLConcatenatedOperation(MLConcatenatedOperationType value) {
        setMLConcatenatedOperation(value);
        return this;
    }

    public MLConcatenatedOperationPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLConcatenatedOperationPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLConcatenatedOperationPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLConcatenatedOperationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLConcatenatedOperationPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLConcatenatedOperationPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLConcatenatedOperationPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLConcatenatedOperationPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLConcatenatedOperationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLConcatenatedOperationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLConcatenatedOperationPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
