...
import net.opengis.gml.v_3_2_0.AbstractCRSType;
import net.opengis.gml.v_3_2_0.AbstractGeneralDerivedCRSType;
...
import net.opengis.iso19139.gmx.v_20060504.MLCompoundCRSType;
import net.opengis.iso19139.gmx.v_20060504.MLDerivedCRSType;
import net.opengis.iso19139.gmx.v_20060504.MLEngineeringCRSType;
import net.opengis.iso19139.gmx.v_20060504.MLGeodeticCRSType;
import net.opengis.iso19139.gmx.v_20060504.MLImageCRSType;
import net.opengis.iso19139.gmx.v_20060504.MLProjectedCRSType;
import net.opengis.iso19139.gmx.v_20060504.MLTemporalCRSType;
import net.opengis.iso19139.gmx.v_20060504.MLVerticalCRSType;
...
public class SCCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<?> lhsAbstractCRS;
            lhsAbstractCRS = this.getAbstractCRS();
            JAXBElement<?> rhsAbstractCRS;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SCCRSPropertyType) {
            final SCCRSPropertyType copy = ((SCCRSPropertyType) draftCopy);
            {
                Boolean abstractCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractCRS());
                if (abstractCRSShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<?> sourceAbstractCRS;
                    sourceAbstractCRS = this.getAbstractCRS();
                    @SuppressWarnings("unchecked")
                    JAXBElement<?> copyAbstractCRS = ((JAXBElement<?> ) strategy.copy(LocatorUtils.property(locator, "abstractCRS", sourceAbstractCRS), sourceAbstractCRS, this.isSetAbstractCRS()));
                    copy.setAbstractCRS(copyAbstractCRS);
                } else {
                    if (abstractCRSShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SCCRSPropertyType) {
            final SCCRSPropertyType target = this;
            final SCCRSPropertyType leftObject = ((SCCRSPropertyType) left);
            final SCCRSPropertyType rightObject = ((SCCRSPropertyType) right);
            {
                Boolean abstractCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractCRS(), rightObject.isSetAbstractCRS());
                if (abstractCRSShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<?> lhsAbstractCRS;
                    lhsAbstractCRS = leftObject.getAbstractCRS();
                    JAXBElement<?> rhsAbstractCRS;
                    rhsAbstractCRS = rightObject.getAbstractCRS();
                    JAXBElement<?> mergedAbstractCRS = ((JAXBElement<?> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractCRS", lhsAbstractCRS), LocatorUtils.property(rightLocator, "abstractCRS", rhsAbstractCRS), lhsAbstractCRS, rhsAbstractCRS, leftObject.isSetAbstractCRS(), rightObject.isSetAbstractCRS()));
                    target.setAbstractCRS(mergedAbstractCRS);
                } else {
                    if (abstractCRSShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public SCCRSPropertyType withAbstractCRS(JAXBElement<?> value) {
        setAbstractCRS(value);
        return this;
    }

    public SCCRSPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public SCCRSPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public SCCRSPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public SCCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SCCRSPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public SCCRSPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public SCCRSPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SCCRSPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SCCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SCCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public SCCRSPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
