...
public class MLDerivedCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlDerivedCRS", buffer, theMLDerivedCRS, this.isSetMLDerivedCRS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLDerivedCRSPropertyType that = ((MLDerivedCRSPropertyType) object);
        {
            MLDerivedCRSType lhsMLDerivedCRS;
            lhsMLDerivedCRS = this.getMLDerivedCRS();
            MLDerivedCRSType rhsMLDerivedCRS;
            rhsMLDerivedCRS = that.getMLDerivedCRS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlDerivedCRS", lhsMLDerivedCRS), LocatorUtils.property(thatLocator, "mlDerivedCRS", rhsMLDerivedCRS), lhsMLDerivedCRS, rhsMLDerivedCRS, this.isSetMLDerivedCRS(), that.isSetMLDerivedCRS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLDerivedCRSType theMLDerivedCRS;
            theMLDerivedCRS = this.getMLDerivedCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlDerivedCRS", theMLDerivedCRS), currentHashCode, theMLDerivedCRS, this.isSetMLDerivedCRS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLDerivedCRSPropertyType) {
            final MLDerivedCRSPropertyType copy = ((MLDerivedCRSPropertyType) draftCopy);
            {
                Boolean mlDerivedCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLDerivedCRS());
                if (mlDerivedCRSShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLDerivedCRSType sourceMLDerivedCRS;
                    sourceMLDerivedCRS = this.getMLDerivedCRS();
                    MLDerivedCRSType copyMLDerivedCRS = ((MLDerivedCRSType) strategy.copy(LocatorUtils.property(locator, "mlDerivedCRS", sourceMLDerivedCRS), sourceMLDerivedCRS, this.isSetMLDerivedCRS()));
                    copy.setMLDerivedCRS(copyMLDerivedCRS);
                } else {
                    if (mlDerivedCRSShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlDerivedCRS = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLDerivedCRSPropertyType) {
            final MLDerivedCRSPropertyType target = this;
            final MLDerivedCRSPropertyType leftObject = ((MLDerivedCRSPropertyType) left);
            final MLDerivedCRSPropertyType rightObject = ((MLDerivedCRSPropertyType) right);
            {
                Boolean mlDerivedCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLDerivedCRS(), rightObject.isSetMLDerivedCRS());
                if (mlDerivedCRSShouldBeMergedAndSet == Boolean.TRUE) {
                    MLDerivedCRSType lhsMLDerivedCRS;
                    lhsMLDerivedCRS = leftObject.getMLDerivedCRS();
                    MLDerivedCRSType rhsMLDerivedCRS;
                    rhsMLDerivedCRS = rightObject.getMLDerivedCRS();
                    MLDerivedCRSType mergedMLDerivedCRS = ((MLDerivedCRSType) strategy.merge(LocatorUtils.property(leftLocator, "mlDerivedCRS", lhsMLDerivedCRS), LocatorUtils.property(rightLocator, "mlDerivedCRS", rhsMLDerivedCRS), lhsMLDerivedCRS, rhsMLDerivedCRS, leftObject.isSetMLDerivedCRS(), rightObject.isSetMLDerivedCRS()));
                    target.setMLDerivedCRS(mergedMLDerivedCRS);
                } else {
                    if (mlDerivedCRSShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlDerivedCRS = null;
                    }
                }
            }
            {
    ...
    public MLDerivedCRSPropertyType withMLDerivedCRS(MLDerivedCRSType value) {
        setMLDerivedCRS(value);
        return this;
    }

    public MLDerivedCRSPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLDerivedCRSPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLDerivedCRSPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLDerivedCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLDerivedCRSPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLDerivedCRSPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLDerivedCRSPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLDerivedCRSPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLDerivedCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLDerivedCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLDerivedCRSPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
