...
public class MDMediumNameCodePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public MDMediumNameCodePropertyType withMDMediumNameCode(CodeListValueType value) {
        setMDMediumNameCode(value);
        return this;
    }

    public MDMediumNameCodePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDMediumNameCodePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDMediumNameCodePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
