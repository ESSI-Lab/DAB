...
public class MLCodeListDictionaryPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlCodeListDictionary", buffer, theMLCodeListDictionary, this.isSetMLCodeListDictionary());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLCodeListDictionaryPropertyType that = ((MLCodeListDictionaryPropertyType) object);
        {
            MLCodeListDictionaryType lhsMLCodeListDictionary;
            lhsMLCodeListDictionary = this.getMLCodeListDictionary();
            MLCodeListDictionaryType rhsMLCodeListDictionary;
            rhsMLCodeListDictionary = that.getMLCodeListDictionary();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlCodeListDictionary", lhsMLCodeListDictionary), LocatorUtils.property(thatLocator, "mlCodeListDictionary", rhsMLCodeListDictionary), lhsMLCodeListDictionary, rhsMLCodeListDictionary, this.isSetMLCodeListDictionary(), that.isSetMLCodeListDictionary())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLCodeListDictionaryType theMLCodeListDictionary;
            theMLCodeListDictionary = this.getMLCodeListDictionary();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlCodeListDictionary", theMLCodeListDictionary), currentHashCode, theMLCodeListDictionary, this.isSetMLCodeListDictionary());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLCodeListDictionaryPropertyType) {
            final MLCodeListDictionaryPropertyType copy = ((MLCodeListDictionaryPropertyType) draftCopy);
            {
                Boolean mlCodeListDictionaryShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLCodeListDictionary());
                if (mlCodeListDictionaryShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLCodeListDictionaryType sourceMLCodeListDictionary;
                    sourceMLCodeListDictionary = this.getMLCodeListDictionary();
                    MLCodeListDictionaryType copyMLCodeListDictionary = ((MLCodeListDictionaryType) strategy.copy(LocatorUtils.property(locator, "mlCodeListDictionary", sourceMLCodeListDictionary), sourceMLCodeListDictionary, this.isSetMLCodeListDictionary()));
                    copy.setMLCodeListDictionary(copyMLCodeListDictionary);
                } else {
                    if (mlCodeListDictionaryShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlCodeListDictionary = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLCodeListDictionaryPropertyType) {
            final MLCodeListDictionaryPropertyType target = this;
            final MLCodeListDictionaryPropertyType leftObject = ((MLCodeListDictionaryPropertyType) left);
            final MLCodeListDictionaryPropertyType rightObject = ((MLCodeListDictionaryPropertyType) right);
            {
                Boolean mlCodeListDictionaryShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLCodeListDictionary(), rightObject.isSetMLCodeListDictionary());
                if (mlCodeListDictionaryShouldBeMergedAndSet == Boolean.TRUE) {
                    MLCodeListDictionaryType lhsMLCodeListDictionary;
                    lhsMLCodeListDictionary = leftObject.getMLCodeListDictionary();
                    MLCodeListDictionaryType rhsMLCodeListDictionary;
                    rhsMLCodeListDictionary = rightObject.getMLCodeListDictionary();
                    MLCodeListDictionaryType mergedMLCodeListDictionary = ((MLCodeListDictionaryType) strategy.merge(LocatorUtils.property(leftLocator, "mlCodeListDictionary", lhsMLCodeListDictionary), LocatorUtils.property(rightLocator, "mlCodeListDictionary", rhsMLCodeListDictionary), lhsMLCodeListDictionary, rhsMLCodeListDictionary, leftObject.isSetMLCodeListDictionary(), rightObject.isSetMLCodeListDictionary()));
                    target.setMLCodeListDictionary(mergedMLCodeListDictionary);
                } else {
                    if (mlCodeListDictionaryShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlCodeListDictionary = null;
                    }
                }
            }
            {
    ...
    public MLCodeListDictionaryPropertyType withMLCodeListDictionary(MLCodeListDictionaryType value) {
        setMLCodeListDictionary(value);
        return this;
    }

    public MLCodeListDictionaryPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLCodeListDictionaryPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLCodeListDictionaryPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLCodeListDictionaryPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLCodeListDictionaryPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLCodeListDictionaryPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLCodeListDictionaryPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLCodeListDictionaryPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLCodeListDictionaryPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLCodeListDictionaryPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLCodeListDictionaryPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
