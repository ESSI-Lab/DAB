...
public class MLConversionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlConversion", buffer, theMLConversion, this.isSetMLConversion());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLConversionPropertyType that = ((MLConversionPropertyType) object);
        {
            MLConversionType lhsMLConversion;
            lhsMLConversion = this.getMLConversion();
            MLConversionType rhsMLConversion;
            rhsMLConversion = that.getMLConversion();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlConversion", lhsMLConversion), LocatorUtils.property(thatLocator, "mlConversion", rhsMLConversion), lhsMLConversion, rhsMLConversion, this.isSetMLConversion(), that.isSetMLConversion())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLConversionType theMLConversion;
            theMLConversion = this.getMLConversion();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlConversion", theMLConversion), currentHashCode, theMLConversion, this.isSetMLConversion());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLConversionPropertyType) {
            final MLConversionPropertyType copy = ((MLConversionPropertyType) draftCopy);
            {
                Boolean mlConversionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLConversion());
                if (mlConversionShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLConversionType sourceMLConversion;
                    sourceMLConversion = this.getMLConversion();
                    MLConversionType copyMLConversion = ((MLConversionType) strategy.copy(LocatorUtils.property(locator, "mlConversion", sourceMLConversion), sourceMLConversion, this.isSetMLConversion()));
                    copy.setMLConversion(copyMLConversion);
                } else {
                    if (mlConversionShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlConversion = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLConversionPropertyType) {
            final MLConversionPropertyType target = this;
            final MLConversionPropertyType leftObject = ((MLConversionPropertyType) left);
            final MLConversionPropertyType rightObject = ((MLConversionPropertyType) right);
            {
                Boolean mlConversionShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLConversion(), rightObject.isSetMLConversion());
                if (mlConversionShouldBeMergedAndSet == Boolean.TRUE) {
                    MLConversionType lhsMLConversion;
                    lhsMLConversion = leftObject.getMLConversion();
                    MLConversionType rhsMLConversion;
                    rhsMLConversion = rightObject.getMLConversion();
                    MLConversionType mergedMLConversion = ((MLConversionType) strategy.merge(LocatorUtils.property(leftLocator, "mlConversion", lhsMLConversion), LocatorUtils.property(rightLocator, "mlConversion", rhsMLConversion), lhsMLConversion, rhsMLConversion, leftObject.isSetMLConversion(), rightObject.isSetMLConversion()));
                    target.setMLConversion(mergedMLConversion);
                } else {
                    if (mlConversionShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlConversion = null;
                    }
                }
            }
            {
    ...
    public MLConversionPropertyType withMLConversion(MLConversionType value) {
        setMLConversion(value);
        return this;
    }

    public MLConversionPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLConversionPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLConversionPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLConversionPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLConversionPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLConversionPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLConversionPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLConversionPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLConversionPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLConversionPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLConversionPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
