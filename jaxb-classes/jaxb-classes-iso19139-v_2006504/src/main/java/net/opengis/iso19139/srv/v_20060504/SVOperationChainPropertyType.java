...
public class SVOperationChainPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "svOperationChain", buffer, theSVOperationChain, this.isSetSVOperationChain());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SVOperationChainPropertyType that = ((SVOperationChainPropertyType) object);
        {
            SVOperationChainType lhsSVOperationChain;
            lhsSVOperationChain = this.getSVOperationChain();
            SVOperationChainType rhsSVOperationChain;
            rhsSVOperationChain = that.getSVOperationChain();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "svOperationChain", lhsSVOperationChain), LocatorUtils.property(thatLocator, "svOperationChain", rhsSVOperationChain), lhsSVOperationChain, rhsSVOperationChain, this.isSetSVOperationChain(), that.isSetSVOperationChain())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            SVOperationChainType theSVOperationChain;
            theSVOperationChain = this.getSVOperationChain();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "svOperationChain", theSVOperationChain), currentHashCode, theSVOperationChain, this.isSetSVOperationChain());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SVOperationChainPropertyType) {
            final SVOperationChainPropertyType copy = ((SVOperationChainPropertyType) draftCopy);
            {
                Boolean svOperationChainShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSVOperationChain());
                if (svOperationChainShouldBeCopiedAndSet == Boolean.TRUE) {
                    SVOperationChainType sourceSVOperationChain;
                    sourceSVOperationChain = this.getSVOperationChain();
                    SVOperationChainType copySVOperationChain = ((SVOperationChainType) strategy.copy(LocatorUtils.property(locator, "svOperationChain", sourceSVOperationChain), sourceSVOperationChain, this.isSetSVOperationChain()));
                    copy.setSVOperationChain(copySVOperationChain);
                } else {
                    if (svOperationChainShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.svOperationChain = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SVOperationChainPropertyType) {
            final SVOperationChainPropertyType target = this;
            final SVOperationChainPropertyType leftObject = ((SVOperationChainPropertyType) left);
            final SVOperationChainPropertyType rightObject = ((SVOperationChainPropertyType) right);
            {
                Boolean svOperationChainShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSVOperationChain(), rightObject.isSetSVOperationChain());
                if (svOperationChainShouldBeMergedAndSet == Boolean.TRUE) {
                    SVOperationChainType lhsSVOperationChain;
                    lhsSVOperationChain = leftObject.getSVOperationChain();
                    SVOperationChainType rhsSVOperationChain;
                    rhsSVOperationChain = rightObject.getSVOperationChain();
                    SVOperationChainType mergedSVOperationChain = ((SVOperationChainType) strategy.merge(LocatorUtils.property(leftLocator, "svOperationChain", lhsSVOperationChain), LocatorUtils.property(rightLocator, "svOperationChain", rhsSVOperationChain), lhsSVOperationChain, rhsSVOperationChain, leftObject.isSetSVOperationChain(), rightObject.isSetSVOperationChain()));
                    target.setSVOperationChain(mergedSVOperationChain);
                } else {
                    if (svOperationChainShouldBeMergedAndSet == Boolean.FALSE) {
                        target.svOperationChain = null;
                    }
                }
            }
            {
    ...
    public SVOperationChainPropertyType withSVOperationChain(SVOperationChainType value) {
        setSVOperationChain(value);
        return this;
    }

    public SVOperationChainPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public SVOperationChainPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public SVOperationChainPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public SVOperationChainPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SVOperationChainPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public SVOperationChainPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public SVOperationChainPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SVOperationChainPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SVOperationChainPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SVOperationChainPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public SVOperationChainPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
