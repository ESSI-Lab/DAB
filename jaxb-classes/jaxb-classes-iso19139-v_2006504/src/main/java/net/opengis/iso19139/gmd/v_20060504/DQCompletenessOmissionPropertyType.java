...
public class DQCompletenessOmissionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "dqCompletenessOmission", buffer, theDQCompletenessOmission, this.isSetDQCompletenessOmission());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            DQCompletenessOmissionType lhsDQCompletenessOmission;
            lhsDQCompletenessOmission = this.getDQCompletenessOmission();
            DQCompletenessOmissionType rhsDQCompletenessOmission;
            rhsDQCompletenessOmission = that.getDQCompletenessOmission();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dqCompletenessOmission", lhsDQCompletenessOmission), LocatorUtils.property(thatLocator, "dqCompletenessOmission", rhsDQCompletenessOmission), lhsDQCompletenessOmission, rhsDQCompletenessOmission, this.isSetDQCompletenessOmission(), that.isSetDQCompletenessOmission())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            DQCompletenessOmissionType theDQCompletenessOmission;
            theDQCompletenessOmission = this.getDQCompletenessOmission();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dqCompletenessOmission", theDQCompletenessOmission), currentHashCode, theDQCompletenessOmission, this.isSetDQCompletenessOmission());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DQCompletenessOmissionPropertyType) {
            final DQCompletenessOmissionPropertyType copy = ((DQCompletenessOmissionPropertyType) draftCopy);
            {
                Boolean dqCompletenessOmissionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDQCompletenessOmission());
                if (dqCompletenessOmissionShouldBeCopiedAndSet == Boolean.TRUE) {
                    DQCompletenessOmissionType sourceDQCompletenessOmission;
                    sourceDQCompletenessOmission = this.getDQCompletenessOmission();
                    DQCompletenessOmissionType copyDQCompletenessOmission = ((DQCompletenessOmissionType) strategy.copy(LocatorUtils.property(locator, "dqCompletenessOmission", sourceDQCompletenessOmission), sourceDQCompletenessOmission, this.isSetDQCompletenessOmission()));
                    copy.setDQCompletenessOmission(copyDQCompletenessOmission);
                } else {
                    if (dqCompletenessOmissionShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.dqCompletenessOmission = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DQCompletenessOmissionPropertyType) {
            final DQCompletenessOmissionPropertyType target = this;
            final DQCompletenessOmissionPropertyType leftObject = ((DQCompletenessOmissionPropertyType) left);
            final DQCompletenessOmissionPropertyType rightObject = ((DQCompletenessOmissionPropertyType) right);
            {
                Boolean dqCompletenessOmissionShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDQCompletenessOmission(), rightObject.isSetDQCompletenessOmission());
                if (dqCompletenessOmissionShouldBeMergedAndSet == Boolean.TRUE) {
                    DQCompletenessOmissionType lhsDQCompletenessOmission;
                    lhsDQCompletenessOmission = leftObject.getDQCompletenessOmission();
                    DQCompletenessOmissionType rhsDQCompletenessOmission;
                    rhsDQCompletenessOmission = rightObject.getDQCompletenessOmission();
                    DQCompletenessOmissionType mergedDQCompletenessOmission = ((DQCompletenessOmissionType) strategy.merge(LocatorUtils.property(leftLocator, "dqCompletenessOmission", lhsDQCompletenessOmission), LocatorUtils.property(rightLocator, "dqCompletenessOmission", rhsDQCompletenessOmission), lhsDQCompletenessOmission, rhsDQCompletenessOmission, leftObject.isSetDQCompletenessOmission(), rightObject.isSetDQCompletenessOmission()));
                    target.setDQCompletenessOmission(mergedDQCompletenessOmission);
                } else {
                    if (dqCompletenessOmissionShouldBeMergedAndSet == Boolean.FALSE) {
                        target.dqCompletenessOmission = null;
                    }
                }
            }
            {
    ...
    public DQCompletenessOmissionPropertyType withDQCompletenessOmission(DQCompletenessOmissionType value) {
        setDQCompletenessOmission(value);
        return this;
    }

    public DQCompletenessOmissionPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DQCompletenessOmissionPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DQCompletenessOmissionPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DQCompletenessOmissionPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DQCompletenessOmissionPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DQCompletenessOmissionPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DQCompletenessOmissionPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DQCompletenessOmissionPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DQCompletenessOmissionPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DQCompletenessOmissionPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DQCompletenessOmissionPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
