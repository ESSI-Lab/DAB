...
public class MLDerivedUnitPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlDerivedUnit", buffer, theMLDerivedUnit, this.isSetMLDerivedUnit());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLDerivedUnitPropertyType that = ((MLDerivedUnitPropertyType) object);
        {
            MLDerivedUnitType lhsMLDerivedUnit;
            lhsMLDerivedUnit = this.getMLDerivedUnit();
            MLDerivedUnitType rhsMLDerivedUnit;
            rhsMLDerivedUnit = that.getMLDerivedUnit();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlDerivedUnit", lhsMLDerivedUnit), LocatorUtils.property(thatLocator, "mlDerivedUnit", rhsMLDerivedUnit), lhsMLDerivedUnit, rhsMLDerivedUnit, this.isSetMLDerivedUnit(), that.isSetMLDerivedUnit())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLDerivedUnitType theMLDerivedUnit;
            theMLDerivedUnit = this.getMLDerivedUnit();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlDerivedUnit", theMLDerivedUnit), currentHashCode, theMLDerivedUnit, this.isSetMLDerivedUnit());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLDerivedUnitPropertyType) {
            final MLDerivedUnitPropertyType copy = ((MLDerivedUnitPropertyType) draftCopy);
            {
                Boolean mlDerivedUnitShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLDerivedUnit());
                if (mlDerivedUnitShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLDerivedUnitType sourceMLDerivedUnit;
                    sourceMLDerivedUnit = this.getMLDerivedUnit();
                    MLDerivedUnitType copyMLDerivedUnit = ((MLDerivedUnitType) strategy.copy(LocatorUtils.property(locator, "mlDerivedUnit", sourceMLDerivedUnit), sourceMLDerivedUnit, this.isSetMLDerivedUnit()));
                    copy.setMLDerivedUnit(copyMLDerivedUnit);
                } else {
                    if (mlDerivedUnitShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlDerivedUnit = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLDerivedUnitPropertyType) {
            final MLDerivedUnitPropertyType target = this;
            final MLDerivedUnitPropertyType leftObject = ((MLDerivedUnitPropertyType) left);
            final MLDerivedUnitPropertyType rightObject = ((MLDerivedUnitPropertyType) right);
            {
                Boolean mlDerivedUnitShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLDerivedUnit(), rightObject.isSetMLDerivedUnit());
                if (mlDerivedUnitShouldBeMergedAndSet == Boolean.TRUE) {
                    MLDerivedUnitType lhsMLDerivedUnit;
                    lhsMLDerivedUnit = leftObject.getMLDerivedUnit();
                    MLDerivedUnitType rhsMLDerivedUnit;
                    rhsMLDerivedUnit = rightObject.getMLDerivedUnit();
                    MLDerivedUnitType mergedMLDerivedUnit = ((MLDerivedUnitType) strategy.merge(LocatorUtils.property(leftLocator, "mlDerivedUnit", lhsMLDerivedUnit), LocatorUtils.property(rightLocator, "mlDerivedUnit", rhsMLDerivedUnit), lhsMLDerivedUnit, rhsMLDerivedUnit, leftObject.isSetMLDerivedUnit(), rightObject.isSetMLDerivedUnit()));
                    target.setMLDerivedUnit(mergedMLDerivedUnit);
                } else {
                    if (mlDerivedUnitShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlDerivedUnit = null;
                    }
                }
            }
            {
    ...
    public MLDerivedUnitPropertyType withMLDerivedUnit(MLDerivedUnitType value) {
        setMLDerivedUnit(value);
        return this;
    }

    public MLDerivedUnitPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLDerivedUnitPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLDerivedUnitPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLDerivedUnitPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLDerivedUnitPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLDerivedUnitPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLDerivedUnitPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLDerivedUnitPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLDerivedUnitPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLDerivedUnitPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLDerivedUnitPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
