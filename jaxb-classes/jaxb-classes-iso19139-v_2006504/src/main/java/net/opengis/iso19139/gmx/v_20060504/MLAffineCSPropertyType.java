...
public class MLAffineCSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlAffineCS", buffer, theMLAffineCS, this.isSetMLAffineCS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLAffineCSPropertyType that = ((MLAffineCSPropertyType) object);
        {
            MLAffineCSType lhsMLAffineCS;
            lhsMLAffineCS = this.getMLAffineCS();
            MLAffineCSType rhsMLAffineCS;
            rhsMLAffineCS = that.getMLAffineCS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlAffineCS", lhsMLAffineCS), LocatorUtils.property(thatLocator, "mlAffineCS", rhsMLAffineCS), lhsMLAffineCS, rhsMLAffineCS, this.isSetMLAffineCS(), that.isSetMLAffineCS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLAffineCSType theMLAffineCS;
            theMLAffineCS = this.getMLAffineCS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlAffineCS", theMLAffineCS), currentHashCode, theMLAffineCS, this.isSetMLAffineCS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLAffineCSPropertyType) {
            final MLAffineCSPropertyType copy = ((MLAffineCSPropertyType) draftCopy);
            {
                Boolean mlAffineCSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLAffineCS());
                if (mlAffineCSShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLAffineCSType sourceMLAffineCS;
                    sourceMLAffineCS = this.getMLAffineCS();
                    MLAffineCSType copyMLAffineCS = ((MLAffineCSType) strategy.copy(LocatorUtils.property(locator, "mlAffineCS", sourceMLAffineCS), sourceMLAffineCS, this.isSetMLAffineCS()));
                    copy.setMLAffineCS(copyMLAffineCS);
                } else {
                    if (mlAffineCSShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlAffineCS = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLAffineCSPropertyType) {
            final MLAffineCSPropertyType target = this;
            final MLAffineCSPropertyType leftObject = ((MLAffineCSPropertyType) left);
            final MLAffineCSPropertyType rightObject = ((MLAffineCSPropertyType) right);
            {
                Boolean mlAffineCSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLAffineCS(), rightObject.isSetMLAffineCS());
                if (mlAffineCSShouldBeMergedAndSet == Boolean.TRUE) {
                    MLAffineCSType lhsMLAffineCS;
                    lhsMLAffineCS = leftObject.getMLAffineCS();
                    MLAffineCSType rhsMLAffineCS;
                    rhsMLAffineCS = rightObject.getMLAffineCS();
                    MLAffineCSType mergedMLAffineCS = ((MLAffineCSType) strategy.merge(LocatorUtils.property(leftLocator, "mlAffineCS", lhsMLAffineCS), LocatorUtils.property(rightLocator, "mlAffineCS", rhsMLAffineCS), lhsMLAffineCS, rhsMLAffineCS, leftObject.isSetMLAffineCS(), rightObject.isSetMLAffineCS()));
                    target.setMLAffineCS(mergedMLAffineCS);
                } else {
                    if (mlAffineCSShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlAffineCS = null;
                    }
                }
            }
            {
    ...
    public MLAffineCSPropertyType withMLAffineCS(MLAffineCSType value) {
        setMLAffineCS(value);
        return this;
    }

    public MLAffineCSPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLAffineCSPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLAffineCSPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLAffineCSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLAffineCSPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLAffineCSPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLAffineCSPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLAffineCSPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLAffineCSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLAffineCSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLAffineCSPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
