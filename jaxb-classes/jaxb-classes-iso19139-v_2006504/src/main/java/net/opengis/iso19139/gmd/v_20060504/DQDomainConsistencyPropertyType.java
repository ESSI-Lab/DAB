...
public class DQDomainConsistencyPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "dqDomainConsistency", buffer, theDQDomainConsistency, this.isSetDQDomainConsistency());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            DQDomainConsistencyType lhsDQDomainConsistency;
            lhsDQDomainConsistency = this.getDQDomainConsistency();
            DQDomainConsistencyType rhsDQDomainConsistency;
            rhsDQDomainConsistency = that.getDQDomainConsistency();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dqDomainConsistency", lhsDQDomainConsistency), LocatorUtils.property(thatLocator, "dqDomainConsistency", rhsDQDomainConsistency), lhsDQDomainConsistency, rhsDQDomainConsistency, this.isSetDQDomainConsistency(), that.isSetDQDomainConsistency())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            DQDomainConsistencyType theDQDomainConsistency;
            theDQDomainConsistency = this.getDQDomainConsistency();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dqDomainConsistency", theDQDomainConsistency), currentHashCode, theDQDomainConsistency, this.isSetDQDomainConsistency());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DQDomainConsistencyPropertyType) {
            final DQDomainConsistencyPropertyType copy = ((DQDomainConsistencyPropertyType) draftCopy);
            {
                Boolean dqDomainConsistencyShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDQDomainConsistency());
                if (dqDomainConsistencyShouldBeCopiedAndSet == Boolean.TRUE) {
                    DQDomainConsistencyType sourceDQDomainConsistency;
                    sourceDQDomainConsistency = this.getDQDomainConsistency();
                    DQDomainConsistencyType copyDQDomainConsistency = ((DQDomainConsistencyType) strategy.copy(LocatorUtils.property(locator, "dqDomainConsistency", sourceDQDomainConsistency), sourceDQDomainConsistency, this.isSetDQDomainConsistency()));
                    copy.setDQDomainConsistency(copyDQDomainConsistency);
                } else {
                    if (dqDomainConsistencyShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.dqDomainConsistency = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DQDomainConsistencyPropertyType) {
            final DQDomainConsistencyPropertyType target = this;
            final DQDomainConsistencyPropertyType leftObject = ((DQDomainConsistencyPropertyType) left);
            final DQDomainConsistencyPropertyType rightObject = ((DQDomainConsistencyPropertyType) right);
            {
                Boolean dqDomainConsistencyShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDQDomainConsistency(), rightObject.isSetDQDomainConsistency());
                if (dqDomainConsistencyShouldBeMergedAndSet == Boolean.TRUE) {
                    DQDomainConsistencyType lhsDQDomainConsistency;
                    lhsDQDomainConsistency = leftObject.getDQDomainConsistency();
                    DQDomainConsistencyType rhsDQDomainConsistency;
                    rhsDQDomainConsistency = rightObject.getDQDomainConsistency();
                    DQDomainConsistencyType mergedDQDomainConsistency = ((DQDomainConsistencyType) strategy.merge(LocatorUtils.property(leftLocator, "dqDomainConsistency", lhsDQDomainConsistency), LocatorUtils.property(rightLocator, "dqDomainConsistency", rhsDQDomainConsistency), lhsDQDomainConsistency, rhsDQDomainConsistency, leftObject.isSetDQDomainConsistency(), rightObject.isSetDQDomainConsistency()));
                    target.setDQDomainConsistency(mergedDQDomainConsistency);
                } else {
                    if (dqDomainConsistencyShouldBeMergedAndSet == Boolean.FALSE) {
                        target.dqDomainConsistency = null;
                    }
                }
            }
            {
    ...
    public DQDomainConsistencyPropertyType withDQDomainConsistency(DQDomainConsistencyType value) {
        setDQDomainConsistency(value);
        return this;
    }

    public DQDomainConsistencyPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DQDomainConsistencyPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DQDomainConsistencyPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DQDomainConsistencyPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DQDomainConsistencyPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DQDomainConsistencyPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DQDomainConsistencyPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DQDomainConsistencyPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DQDomainConsistencyPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DQDomainConsistencyPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DQDomainConsistencyPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
