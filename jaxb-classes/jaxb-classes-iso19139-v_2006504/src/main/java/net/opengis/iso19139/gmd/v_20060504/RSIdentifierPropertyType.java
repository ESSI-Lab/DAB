...
public class RSIdentifierPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "rsIdentifier", buffer, theRSIdentifier, this.isSetRSIdentifier());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            RSIdentifierType lhsRSIdentifier;
            lhsRSIdentifier = this.getRSIdentifier();
            RSIdentifierType rhsRSIdentifier;
            rhsRSIdentifier = that.getRSIdentifier();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "rsIdentifier", lhsRSIdentifier), LocatorUtils.property(thatLocator, "rsIdentifier", rhsRSIdentifier), lhsRSIdentifier, rhsRSIdentifier, this.isSetRSIdentifier(), that.isSetRSIdentifier())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            RSIdentifierType theRSIdentifier;
            theRSIdentifier = this.getRSIdentifier();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "rsIdentifier", theRSIdentifier), currentHashCode, theRSIdentifier, this.isSetRSIdentifier());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof RSIdentifierPropertyType) {
            final RSIdentifierPropertyType copy = ((RSIdentifierPropertyType) draftCopy);
            {
                Boolean rsIdentifierShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetRSIdentifier());
                if (rsIdentifierShouldBeCopiedAndSet == Boolean.TRUE) {
                    RSIdentifierType sourceRSIdentifier;
                    sourceRSIdentifier = this.getRSIdentifier();
                    RSIdentifierType copyRSIdentifier = ((RSIdentifierType) strategy.copy(LocatorUtils.property(locator, "rsIdentifier", sourceRSIdentifier), sourceRSIdentifier, this.isSetRSIdentifier()));
                    copy.setRSIdentifier(copyRSIdentifier);
                } else {
                    if (rsIdentifierShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.rsIdentifier = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof RSIdentifierPropertyType) {
            final RSIdentifierPropertyType target = this;
            final RSIdentifierPropertyType leftObject = ((RSIdentifierPropertyType) left);
            final RSIdentifierPropertyType rightObject = ((RSIdentifierPropertyType) right);
            {
                Boolean rsIdentifierShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetRSIdentifier(), rightObject.isSetRSIdentifier());
                if (rsIdentifierShouldBeMergedAndSet == Boolean.TRUE) {
                    RSIdentifierType lhsRSIdentifier;
                    lhsRSIdentifier = leftObject.getRSIdentifier();
                    RSIdentifierType rhsRSIdentifier;
                    rhsRSIdentifier = rightObject.getRSIdentifier();
                    RSIdentifierType mergedRSIdentifier = ((RSIdentifierType) strategy.merge(LocatorUtils.property(leftLocator, "rsIdentifier", lhsRSIdentifier), LocatorUtils.property(rightLocator, "rsIdentifier", rhsRSIdentifier), lhsRSIdentifier, rhsRSIdentifier, leftObject.isSetRSIdentifier(), rightObject.isSetRSIdentifier()));
                    target.setRSIdentifier(mergedRSIdentifier);
                } else {
                    if (rsIdentifierShouldBeMergedAndSet == Boolean.FALSE) {
                        target.rsIdentifier = null;
                    }
                }
            }
            {
    ...
    public RSIdentifierPropertyType withRSIdentifier(RSIdentifierType value) {
        setRSIdentifier(value);
        return this;
    }

    public RSIdentifierPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public RSIdentifierPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public RSIdentifierPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public RSIdentifierPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public RSIdentifierPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public RSIdentifierPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public RSIdentifierPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public RSIdentifierPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public RSIdentifierPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public RSIdentifierPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public RSIdentifierPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
