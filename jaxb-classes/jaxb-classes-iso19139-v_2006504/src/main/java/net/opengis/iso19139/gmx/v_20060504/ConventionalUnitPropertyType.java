...
public class ConventionalUnitPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    @XmlElementRef(name = "ConventionalUnit", namespace = "http://www.opengis.net/gml", type = JAXBElement.class, required = false)
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "conventionalUnit", buffer, theConventionalUnit, this.isSetConventionalUnit());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ConventionalUnitPropertyType that = ((ConventionalUnitPropertyType) object);
        {
            JAXBElement<? extends ConventionalUnitType> lhsConventionalUnit;
            lhsConventionalUnit = this.getConventionalUnit();
            JAXBElement<? extends ConventionalUnitType> rhsConventionalUnit;
            rhsConventionalUnit = that.getConventionalUnit();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "conventionalUnit", lhsConventionalUnit), LocatorUtils.property(thatLocator, "conventionalUnit", rhsConventionalUnit), lhsConventionalUnit, rhsConventionalUnit, this.isSetConventionalUnit(), that.isSetConventionalUnit())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends ConventionalUnitType> theConventionalUnit;
            theConventionalUnit = this.getConventionalUnit();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "conventionalUnit", theConventionalUnit), currentHashCode, theConventionalUnit, this.isSetConventionalUnit());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ConventionalUnitPropertyType) {
            final ConventionalUnitPropertyType copy = ((ConventionalUnitPropertyType) draftCopy);
            {
                Boolean conventionalUnitShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetConventionalUnit());
                if (conventionalUnitShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends ConventionalUnitType> sourceConventionalUnit;
                    sourceConventionalUnit = this.getConventionalUnit();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends ConventionalUnitType> copyConventionalUnit = ((JAXBElement<? extends ConventionalUnitType> ) strategy.copy(LocatorUtils.property(locator, "conventionalUnit", sourceConventionalUnit), sourceConventionalUnit, this.isSetConventionalUnit()));
                    copy.setConventionalUnit(copyConventionalUnit);
                } else {
                    if (conventionalUnitShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.conventionalUnit = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ConventionalUnitPropertyType) {
            final ConventionalUnitPropertyType target = this;
            final ConventionalUnitPropertyType leftObject = ((ConventionalUnitPropertyType) left);
            final ConventionalUnitPropertyType rightObject = ((ConventionalUnitPropertyType) right);
            {
                Boolean conventionalUnitShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetConventionalUnit(), rightObject.isSetConventionalUnit());
                if (conventionalUnitShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends ConventionalUnitType> lhsConventionalUnit;
                    lhsConventionalUnit = leftObject.getConventionalUnit();
                    JAXBElement<? extends ConventionalUnitType> rhsConventionalUnit;
                    rhsConventionalUnit = rightObject.getConventionalUnit();
                    JAXBElement<? extends ConventionalUnitType> mergedConventionalUnit = ((JAXBElement<? extends ConventionalUnitType> ) strategy.merge(LocatorUtils.property(leftLocator, "conventionalUnit", lhsConventionalUnit), LocatorUtils.property(rightLocator, "conventionalUnit", rhsConventionalUnit), lhsConventionalUnit, rhsConventionalUnit, leftObject.isSetConventionalUnit(), rightObject.isSetConventionalUnit()));
                    target.setConventionalUnit(mergedConventionalUnit);
                } else {
                    if (conventionalUnitShouldBeMergedAndSet == Boolean.FALSE) {
                        target.conventionalUnit = null;
                    }
                }
            }
            {
    ...
    public ConventionalUnitPropertyType withConventionalUnit(JAXBElement<? extends ConventionalUnitType> value) {
        setConventionalUnit(value);
        return this;
    }

    public ConventionalUnitPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public ConventionalUnitPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public ConventionalUnitPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public ConventionalUnitPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public ConventionalUnitPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public ConventionalUnitPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public ConventionalUnitPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public ConventionalUnitPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public ConventionalUnitPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ConventionalUnitPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public ConventionalUnitPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
