...
public class MDIdentificationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "abstractMDIdentification", buffer, theAbstractMDIdentification, this.isSetAbstractMDIdentification());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<? extends AbstractMDIdentificationType> lhsAbstractMDIdentification;
            lhsAbstractMDIdentification = this.getAbstractMDIdentification();
            JAXBElement<? extends AbstractMDIdentificationType> rhsAbstractMDIdentification;
            rhsAbstractMDIdentification = that.getAbstractMDIdentification();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractMDIdentification", lhsAbstractMDIdentification), LocatorUtils.property(thatLocator, "abstractMDIdentification", rhsAbstractMDIdentification), lhsAbstractMDIdentification, rhsAbstractMDIdentification, this.isSetAbstractMDIdentification(), that.isSetAbstractMDIdentification())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractMDIdentificationType> theAbstractMDIdentification;
            theAbstractMDIdentification = this.getAbstractMDIdentification();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractMDIdentification", theAbstractMDIdentification), currentHashCode, theAbstractMDIdentification, this.isSetAbstractMDIdentification());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDIdentificationPropertyType) {
            final MDIdentificationPropertyType copy = ((MDIdentificationPropertyType) draftCopy);
            {
                Boolean abstractMDIdentificationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractMDIdentification());
                if (abstractMDIdentificationShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractMDIdentificationType> sourceAbstractMDIdentification;
                    sourceAbstractMDIdentification = this.getAbstractMDIdentification();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractMDIdentificationType> copyAbstractMDIdentification = ((JAXBElement<? extends AbstractMDIdentificationType> ) strategy.copy(LocatorUtils.property(locator, "abstractMDIdentification", sourceAbstractMDIdentification), sourceAbstractMDIdentification, this.isSetAbstractMDIdentification()));
                    copy.setAbstractMDIdentification(copyAbstractMDIdentification);
                } else {
                    if (abstractMDIdentificationShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.abstractMDIdentification = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDIdentificationPropertyType) {
            final MDIdentificationPropertyType target = this;
            final MDIdentificationPropertyType leftObject = ((MDIdentificationPropertyType) left);
            final MDIdentificationPropertyType rightObject = ((MDIdentificationPropertyType) right);
            {
                Boolean abstractMDIdentificationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractMDIdentification(), rightObject.isSetAbstractMDIdentification());
                if (abstractMDIdentificationShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractMDIdentificationType> lhsAbstractMDIdentification;
                    lhsAbstractMDIdentification = leftObject.getAbstractMDIdentification();
                    JAXBElement<? extends AbstractMDIdentificationType> rhsAbstractMDIdentification;
                    rhsAbstractMDIdentification = rightObject.getAbstractMDIdentification();
                    JAXBElement<? extends AbstractMDIdentificationType> mergedAbstractMDIdentification = ((JAXBElement<? extends AbstractMDIdentificationType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractMDIdentification", lhsAbstractMDIdentification), LocatorUtils.property(rightLocator, "abstractMDIdentification", rhsAbstractMDIdentification), lhsAbstractMDIdentification, rhsAbstractMDIdentification, leftObject.isSetAbstractMDIdentification(), rightObject.isSetAbstractMDIdentification()));
                    target.setAbstractMDIdentification(mergedAbstractMDIdentification);
                } else {
                    if (abstractMDIdentificationShouldBeMergedAndSet == Boolean.FALSE) {
                        target.abstractMDIdentification = null;
                    }
                }
            }
            {
    ...
    public MDIdentificationPropertyType withAbstractMDIdentification(JAXBElement<? extends AbstractMDIdentificationType> value) {
        setAbstractMDIdentification(value);
        return this;
    }

    public MDIdentificationPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDIdentificationPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDIdentificationPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDIdentificationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDIdentificationPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDIdentificationPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDIdentificationPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDIdentificationPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDIdentificationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDIdentificationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDIdentificationPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
