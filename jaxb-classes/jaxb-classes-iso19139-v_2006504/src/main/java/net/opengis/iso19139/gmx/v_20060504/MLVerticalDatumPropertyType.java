...
public class MLVerticalDatumPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlVerticalDatum", buffer, theMLVerticalDatum, this.isSetMLVerticalDatum());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLVerticalDatumPropertyType that = ((MLVerticalDatumPropertyType) object);
        {
            MLVerticalDatumType lhsMLVerticalDatum;
            lhsMLVerticalDatum = this.getMLVerticalDatum();
            MLVerticalDatumType rhsMLVerticalDatum;
            rhsMLVerticalDatum = that.getMLVerticalDatum();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlVerticalDatum", lhsMLVerticalDatum), LocatorUtils.property(thatLocator, "mlVerticalDatum", rhsMLVerticalDatum), lhsMLVerticalDatum, rhsMLVerticalDatum, this.isSetMLVerticalDatum(), that.isSetMLVerticalDatum())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLVerticalDatumType theMLVerticalDatum;
            theMLVerticalDatum = this.getMLVerticalDatum();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlVerticalDatum", theMLVerticalDatum), currentHashCode, theMLVerticalDatum, this.isSetMLVerticalDatum());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLVerticalDatumPropertyType) {
            final MLVerticalDatumPropertyType copy = ((MLVerticalDatumPropertyType) draftCopy);
            {
                Boolean mlVerticalDatumShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLVerticalDatum());
                if (mlVerticalDatumShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLVerticalDatumType sourceMLVerticalDatum;
                    sourceMLVerticalDatum = this.getMLVerticalDatum();
                    MLVerticalDatumType copyMLVerticalDatum = ((MLVerticalDatumType) strategy.copy(LocatorUtils.property(locator, "mlVerticalDatum", sourceMLVerticalDatum), sourceMLVerticalDatum, this.isSetMLVerticalDatum()));
                    copy.setMLVerticalDatum(copyMLVerticalDatum);
                } else {
                    if (mlVerticalDatumShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlVerticalDatum = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLVerticalDatumPropertyType) {
            final MLVerticalDatumPropertyType target = this;
            final MLVerticalDatumPropertyType leftObject = ((MLVerticalDatumPropertyType) left);
            final MLVerticalDatumPropertyType rightObject = ((MLVerticalDatumPropertyType) right);
            {
                Boolean mlVerticalDatumShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLVerticalDatum(), rightObject.isSetMLVerticalDatum());
                if (mlVerticalDatumShouldBeMergedAndSet == Boolean.TRUE) {
                    MLVerticalDatumType lhsMLVerticalDatum;
                    lhsMLVerticalDatum = leftObject.getMLVerticalDatum();
                    MLVerticalDatumType rhsMLVerticalDatum;
                    rhsMLVerticalDatum = rightObject.getMLVerticalDatum();
                    MLVerticalDatumType mergedMLVerticalDatum = ((MLVerticalDatumType) strategy.merge(LocatorUtils.property(leftLocator, "mlVerticalDatum", lhsMLVerticalDatum), LocatorUtils.property(rightLocator, "mlVerticalDatum", rhsMLVerticalDatum), lhsMLVerticalDatum, rhsMLVerticalDatum, leftObject.isSetMLVerticalDatum(), rightObject.isSetMLVerticalDatum()));
                    target.setMLVerticalDatum(mergedMLVerticalDatum);
                } else {
                    if (mlVerticalDatumShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlVerticalDatum = null;
                    }
                }
            }
            {
    ...
    public MLVerticalDatumPropertyType withMLVerticalDatum(MLVerticalDatumType value) {
        setMLVerticalDatum(value);
        return this;
    }

    public MLVerticalDatumPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLVerticalDatumPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLVerticalDatumPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLVerticalDatumPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLVerticalDatumPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLVerticalDatumPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLVerticalDatumPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLVerticalDatumPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLVerticalDatumPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLVerticalDatumPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLVerticalDatumPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
