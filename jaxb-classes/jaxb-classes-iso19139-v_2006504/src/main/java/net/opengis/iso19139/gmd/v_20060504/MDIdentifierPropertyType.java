...
public class MDIdentifierPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdIdentifier", buffer, theMDIdentifier, this.isSetMDIdentifier());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<? extends MDIdentifierType> lhsMDIdentifier;
            lhsMDIdentifier = this.getMDIdentifier();
            JAXBElement<? extends MDIdentifierType> rhsMDIdentifier;
            rhsMDIdentifier = that.getMDIdentifier();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdIdentifier", lhsMDIdentifier), LocatorUtils.property(thatLocator, "mdIdentifier", rhsMDIdentifier), lhsMDIdentifier, rhsMDIdentifier, this.isSetMDIdentifier(), that.isSetMDIdentifier())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends MDIdentifierType> theMDIdentifier;
            theMDIdentifier = this.getMDIdentifier();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdIdentifier", theMDIdentifier), currentHashCode, theMDIdentifier, this.isSetMDIdentifier());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDIdentifierPropertyType) {
            final MDIdentifierPropertyType copy = ((MDIdentifierPropertyType) draftCopy);
            {
                Boolean mdIdentifierShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDIdentifier());
                if (mdIdentifierShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends MDIdentifierType> sourceMDIdentifier;
                    sourceMDIdentifier = this.getMDIdentifier();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends MDIdentifierType> copyMDIdentifier = ((JAXBElement<? extends MDIdentifierType> ) strategy.copy(LocatorUtils.property(locator, "mdIdentifier", sourceMDIdentifier), sourceMDIdentifier, this.isSetMDIdentifier()));
                    copy.setMDIdentifier(copyMDIdentifier);
                } else {
                    if (mdIdentifierShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdIdentifier = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDIdentifierPropertyType) {
            final MDIdentifierPropertyType target = this;
            final MDIdentifierPropertyType leftObject = ((MDIdentifierPropertyType) left);
            final MDIdentifierPropertyType rightObject = ((MDIdentifierPropertyType) right);
            {
                Boolean mdIdentifierShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDIdentifier(), rightObject.isSetMDIdentifier());
                if (mdIdentifierShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends MDIdentifierType> lhsMDIdentifier;
                    lhsMDIdentifier = leftObject.getMDIdentifier();
                    JAXBElement<? extends MDIdentifierType> rhsMDIdentifier;
                    rhsMDIdentifier = rightObject.getMDIdentifier();
                    JAXBElement<? extends MDIdentifierType> mergedMDIdentifier = ((JAXBElement<? extends MDIdentifierType> ) strategy.merge(LocatorUtils.property(leftLocator, "mdIdentifier", lhsMDIdentifier), LocatorUtils.property(rightLocator, "mdIdentifier", rhsMDIdentifier), lhsMDIdentifier, rhsMDIdentifier, leftObject.isSetMDIdentifier(), rightObject.isSetMDIdentifier()));
                    target.setMDIdentifier(mergedMDIdentifier);
                } else {
                    if (mdIdentifierShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdIdentifier = null;
                    }
                }
            }
            {
    ...
    public MDIdentifierPropertyType withMDIdentifier(JAXBElement<? extends MDIdentifierType> value) {
        setMDIdentifier(value);
        return this;
    }

    public MDIdentifierPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDIdentifierPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDIdentifierPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDIdentifierPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDIdentifierPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDIdentifierPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDIdentifierPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDIdentifierPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDIdentifierPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDIdentifierPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDIdentifierPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
