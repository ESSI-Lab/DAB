...
public class CIRoleCodePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "ciRoleCode", buffer, theCIRoleCode, this.isSetCIRoleCode());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            CodeListValueType lhsCIRoleCode;
            lhsCIRoleCode = this.getCIRoleCode();
            CodeListValueType rhsCIRoleCode;
            rhsCIRoleCode = that.getCIRoleCode();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ciRoleCode", lhsCIRoleCode), LocatorUtils.property(thatLocator, "ciRoleCode", rhsCIRoleCode), lhsCIRoleCode, rhsCIRoleCode, this.isSetCIRoleCode(), that.isSetCIRoleCode())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            CodeListValueType theCIRoleCode;
            theCIRoleCode = this.getCIRoleCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ciRoleCode", theCIRoleCode), currentHashCode, theCIRoleCode, this.isSetCIRoleCode());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CIRoleCodePropertyType) {
            final CIRoleCodePropertyType copy = ((CIRoleCodePropertyType) draftCopy);
            {
                Boolean ciRoleCodeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCIRoleCode());
                if (ciRoleCodeShouldBeCopiedAndSet == Boolean.TRUE) {
                    CodeListValueType sourceCIRoleCode;
                    sourceCIRoleCode = this.getCIRoleCode();
                    CodeListValueType copyCIRoleCode = ((CodeListValueType) strategy.copy(LocatorUtils.property(locator, "ciRoleCode", sourceCIRoleCode), sourceCIRoleCode, this.isSetCIRoleCode()));
                    copy.setCIRoleCode(copyCIRoleCode);
                } else {
                    if (ciRoleCodeShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.ciRoleCode = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CIRoleCodePropertyType) {
            final CIRoleCodePropertyType target = this;
            final CIRoleCodePropertyType leftObject = ((CIRoleCodePropertyType) left);
            final CIRoleCodePropertyType rightObject = ((CIRoleCodePropertyType) right);
            {
                Boolean ciRoleCodeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCIRoleCode(), rightObject.isSetCIRoleCode());
                if (ciRoleCodeShouldBeMergedAndSet == Boolean.TRUE) {
                    CodeListValueType lhsCIRoleCode;
                    lhsCIRoleCode = leftObject.getCIRoleCode();
                    CodeListValueType rhsCIRoleCode;
                    rhsCIRoleCode = rightObject.getCIRoleCode();
                    CodeListValueType mergedCIRoleCode = ((CodeListValueType) strategy.merge(LocatorUtils.property(leftLocator, "ciRoleCode", lhsCIRoleCode), LocatorUtils.property(rightLocator, "ciRoleCode", rhsCIRoleCode), lhsCIRoleCode, rhsCIRoleCode, leftObject.isSetCIRoleCode(), rightObject.isSetCIRoleCode()));
                    target.setCIRoleCode(mergedCIRoleCode);
                } else {
                    if (ciRoleCodeShouldBeMergedAndSet == Boolean.FALSE) {
                        target.ciRoleCode = null;
                    }
                }
            }
            {
    ...
    public CIRoleCodePropertyType withCIRoleCode(CodeListValueType value) {
        setCIRoleCode(value);
        return this;
    }

    public CIRoleCodePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CIRoleCodePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CIRoleCodePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
