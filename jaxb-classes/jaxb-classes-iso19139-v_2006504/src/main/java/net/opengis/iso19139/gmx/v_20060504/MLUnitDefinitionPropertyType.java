...
public class MLUnitDefinitionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlUnitDefinition", buffer, theMLUnitDefinition, this.isSetMLUnitDefinition());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLUnitDefinitionPropertyType that = ((MLUnitDefinitionPropertyType) object);
        {
            MLUnitDefinitionType lhsMLUnitDefinition;
            lhsMLUnitDefinition = this.getMLUnitDefinition();
            MLUnitDefinitionType rhsMLUnitDefinition;
            rhsMLUnitDefinition = that.getMLUnitDefinition();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlUnitDefinition", lhsMLUnitDefinition), LocatorUtils.property(thatLocator, "mlUnitDefinition", rhsMLUnitDefinition), lhsMLUnitDefinition, rhsMLUnitDefinition, this.isSetMLUnitDefinition(), that.isSetMLUnitDefinition())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLUnitDefinitionType theMLUnitDefinition;
            theMLUnitDefinition = this.getMLUnitDefinition();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlUnitDefinition", theMLUnitDefinition), currentHashCode, theMLUnitDefinition, this.isSetMLUnitDefinition());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLUnitDefinitionPropertyType) {
            final MLUnitDefinitionPropertyType copy = ((MLUnitDefinitionPropertyType) draftCopy);
            {
                Boolean mlUnitDefinitionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLUnitDefinition());
                if (mlUnitDefinitionShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLUnitDefinitionType sourceMLUnitDefinition;
                    sourceMLUnitDefinition = this.getMLUnitDefinition();
                    MLUnitDefinitionType copyMLUnitDefinition = ((MLUnitDefinitionType) strategy.copy(LocatorUtils.property(locator, "mlUnitDefinition", sourceMLUnitDefinition), sourceMLUnitDefinition, this.isSetMLUnitDefinition()));
                    copy.setMLUnitDefinition(copyMLUnitDefinition);
                } else {
                    if (mlUnitDefinitionShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlUnitDefinition = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLUnitDefinitionPropertyType) {
            final MLUnitDefinitionPropertyType target = this;
            final MLUnitDefinitionPropertyType leftObject = ((MLUnitDefinitionPropertyType) left);
            final MLUnitDefinitionPropertyType rightObject = ((MLUnitDefinitionPropertyType) right);
            {
                Boolean mlUnitDefinitionShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLUnitDefinition(), rightObject.isSetMLUnitDefinition());
                if (mlUnitDefinitionShouldBeMergedAndSet == Boolean.TRUE) {
                    MLUnitDefinitionType lhsMLUnitDefinition;
                    lhsMLUnitDefinition = leftObject.getMLUnitDefinition();
                    MLUnitDefinitionType rhsMLUnitDefinition;
                    rhsMLUnitDefinition = rightObject.getMLUnitDefinition();
                    MLUnitDefinitionType mergedMLUnitDefinition = ((MLUnitDefinitionType) strategy.merge(LocatorUtils.property(leftLocator, "mlUnitDefinition", lhsMLUnitDefinition), LocatorUtils.property(rightLocator, "mlUnitDefinition", rhsMLUnitDefinition), lhsMLUnitDefinition, rhsMLUnitDefinition, leftObject.isSetMLUnitDefinition(), rightObject.isSetMLUnitDefinition()));
                    target.setMLUnitDefinition(mergedMLUnitDefinition);
                } else {
                    if (mlUnitDefinitionShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlUnitDefinition = null;
                    }
                }
            }
            {
    ...
    public MLUnitDefinitionPropertyType withMLUnitDefinition(MLUnitDefinitionType value) {
        setMLUnitDefinition(value);
        return this;
    }

    public MLUnitDefinitionPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLUnitDefinitionPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLUnitDefinitionPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLUnitDefinitionPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLUnitDefinitionPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLUnitDefinitionPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLUnitDefinitionPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLUnitDefinitionPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLUnitDefinitionPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLUnitDefinitionPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLUnitDefinitionPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
