...
public class MLBaseUnitPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlBaseUnit", buffer, theMLBaseUnit, this.isSetMLBaseUnit());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLBaseUnitPropertyType that = ((MLBaseUnitPropertyType) object);
        {
            MLBaseUnitType lhsMLBaseUnit;
            lhsMLBaseUnit = this.getMLBaseUnit();
            MLBaseUnitType rhsMLBaseUnit;
            rhsMLBaseUnit = that.getMLBaseUnit();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlBaseUnit", lhsMLBaseUnit), LocatorUtils.property(thatLocator, "mlBaseUnit", rhsMLBaseUnit), lhsMLBaseUnit, rhsMLBaseUnit, this.isSetMLBaseUnit(), that.isSetMLBaseUnit())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLBaseUnitType theMLBaseUnit;
            theMLBaseUnit = this.getMLBaseUnit();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlBaseUnit", theMLBaseUnit), currentHashCode, theMLBaseUnit, this.isSetMLBaseUnit());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLBaseUnitPropertyType) {
            final MLBaseUnitPropertyType copy = ((MLBaseUnitPropertyType) draftCopy);
            {
                Boolean mlBaseUnitShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLBaseUnit());
                if (mlBaseUnitShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLBaseUnitType sourceMLBaseUnit;
                    sourceMLBaseUnit = this.getMLBaseUnit();
                    MLBaseUnitType copyMLBaseUnit = ((MLBaseUnitType) strategy.copy(LocatorUtils.property(locator, "mlBaseUnit", sourceMLBaseUnit), sourceMLBaseUnit, this.isSetMLBaseUnit()));
                    copy.setMLBaseUnit(copyMLBaseUnit);
                } else {
                    if (mlBaseUnitShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlBaseUnit = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLBaseUnitPropertyType) {
            final MLBaseUnitPropertyType target = this;
            final MLBaseUnitPropertyType leftObject = ((MLBaseUnitPropertyType) left);
            final MLBaseUnitPropertyType rightObject = ((MLBaseUnitPropertyType) right);
            {
                Boolean mlBaseUnitShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLBaseUnit(), rightObject.isSetMLBaseUnit());
                if (mlBaseUnitShouldBeMergedAndSet == Boolean.TRUE) {
                    MLBaseUnitType lhsMLBaseUnit;
                    lhsMLBaseUnit = leftObject.getMLBaseUnit();
                    MLBaseUnitType rhsMLBaseUnit;
                    rhsMLBaseUnit = rightObject.getMLBaseUnit();
                    MLBaseUnitType mergedMLBaseUnit = ((MLBaseUnitType) strategy.merge(LocatorUtils.property(leftLocator, "mlBaseUnit", lhsMLBaseUnit), LocatorUtils.property(rightLocator, "mlBaseUnit", rhsMLBaseUnit), lhsMLBaseUnit, rhsMLBaseUnit, leftObject.isSetMLBaseUnit(), rightObject.isSetMLBaseUnit()));
                    target.setMLBaseUnit(mergedMLBaseUnit);
                } else {
                    if (mlBaseUnitShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlBaseUnit = null;
                    }
                }
            }
            {
    ...
    public MLBaseUnitPropertyType withMLBaseUnit(MLBaseUnitType value) {
        setMLBaseUnit(value);
        return this;
    }

    public MLBaseUnitPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLBaseUnitPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLBaseUnitPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLBaseUnitPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLBaseUnitPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLBaseUnitPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLBaseUnitPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLBaseUnitPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLBaseUnitPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLBaseUnitPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLBaseUnitPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
