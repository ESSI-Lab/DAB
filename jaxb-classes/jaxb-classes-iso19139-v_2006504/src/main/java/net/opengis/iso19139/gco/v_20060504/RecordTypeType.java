...
public class RecordTypeType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public RecordTypeType withValue(String value) {
        setValue(value);
        return this;
    }

    public RecordTypeType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public RecordTypeType withHref(String value) {
        setHref(value);
        return this;
    }

    public RecordTypeType withRole(String value) {
        setRole(value);
        return this;
    }

    public RecordTypeType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public RecordTypeType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public RecordTypeType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public RecordTypeType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
