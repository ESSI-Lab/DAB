...
public class MXDataSetPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mxDataSet", buffer, theMXDataSet, this.isSetMXDataSet());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MXDataSetPropertyType that = ((MXDataSetPropertyType) object);
        {
            MXDataSetType lhsMXDataSet;
            lhsMXDataSet = this.getMXDataSet();
            MXDataSetType rhsMXDataSet;
            rhsMXDataSet = that.getMXDataSet();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mxDataSet", lhsMXDataSet), LocatorUtils.property(thatLocator, "mxDataSet", rhsMXDataSet), lhsMXDataSet, rhsMXDataSet, this.isSetMXDataSet(), that.isSetMXDataSet())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MXDataSetType theMXDataSet;
            theMXDataSet = this.getMXDataSet();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mxDataSet", theMXDataSet), currentHashCode, theMXDataSet, this.isSetMXDataSet());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MXDataSetPropertyType) {
            final MXDataSetPropertyType copy = ((MXDataSetPropertyType) draftCopy);
            {
                Boolean mxDataSetShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMXDataSet());
                if (mxDataSetShouldBeCopiedAndSet == Boolean.TRUE) {
                    MXDataSetType sourceMXDataSet;
                    sourceMXDataSet = this.getMXDataSet();
                    MXDataSetType copyMXDataSet = ((MXDataSetType) strategy.copy(LocatorUtils.property(locator, "mxDataSet", sourceMXDataSet), sourceMXDataSet, this.isSetMXDataSet()));
                    copy.setMXDataSet(copyMXDataSet);
                } else {
                    if (mxDataSetShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mxDataSet = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MXDataSetPropertyType) {
            final MXDataSetPropertyType target = this;
            final MXDataSetPropertyType leftObject = ((MXDataSetPropertyType) left);
            final MXDataSetPropertyType rightObject = ((MXDataSetPropertyType) right);
            {
                Boolean mxDataSetShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMXDataSet(), rightObject.isSetMXDataSet());
                if (mxDataSetShouldBeMergedAndSet == Boolean.TRUE) {
                    MXDataSetType lhsMXDataSet;
                    lhsMXDataSet = leftObject.getMXDataSet();
                    MXDataSetType rhsMXDataSet;
                    rhsMXDataSet = rightObject.getMXDataSet();
                    MXDataSetType mergedMXDataSet = ((MXDataSetType) strategy.merge(LocatorUtils.property(leftLocator, "mxDataSet", lhsMXDataSet), LocatorUtils.property(rightLocator, "mxDataSet", rhsMXDataSet), lhsMXDataSet, rhsMXDataSet, leftObject.isSetMXDataSet(), rightObject.isSetMXDataSet()));
                    target.setMXDataSet(mergedMXDataSet);
                } else {
                    if (mxDataSetShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mxDataSet = null;
                    }
                }
            }
            {
    ...
    public MXDataSetPropertyType withMXDataSet(MXDataSetType value) {
        setMXDataSet(value);
        return this;
    }

    public MXDataSetPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MXDataSetPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MXDataSetPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MXDataSetPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MXDataSetPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MXDataSetPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MXDataSetPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MXDataSetPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MXDataSetPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MXDataSetPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MXDataSetPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
