...
public class MDRangeDimensionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdRangeDimension", buffer, theMDRangeDimension, this.isSetMDRangeDimension());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<? extends MDRangeDimensionType> lhsMDRangeDimension;
            lhsMDRangeDimension = this.getMDRangeDimension();
            JAXBElement<? extends MDRangeDimensionType> rhsMDRangeDimension;
            rhsMDRangeDimension = that.getMDRangeDimension();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdRangeDimension", lhsMDRangeDimension), LocatorUtils.property(thatLocator, "mdRangeDimension", rhsMDRangeDimension), lhsMDRangeDimension, rhsMDRangeDimension, this.isSetMDRangeDimension(), that.isSetMDRangeDimension())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends MDRangeDimensionType> theMDRangeDimension;
            theMDRangeDimension = this.getMDRangeDimension();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdRangeDimension", theMDRangeDimension), currentHashCode, theMDRangeDimension, this.isSetMDRangeDimension());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDRangeDimensionPropertyType) {
            final MDRangeDimensionPropertyType copy = ((MDRangeDimensionPropertyType) draftCopy);
            {
                Boolean mdRangeDimensionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDRangeDimension());
                if (mdRangeDimensionShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends MDRangeDimensionType> sourceMDRangeDimension;
                    sourceMDRangeDimension = this.getMDRangeDimension();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends MDRangeDimensionType> copyMDRangeDimension = ((JAXBElement<? extends MDRangeDimensionType> ) strategy.copy(LocatorUtils.property(locator, "mdRangeDimension", sourceMDRangeDimension), sourceMDRangeDimension, this.isSetMDRangeDimension()));
                    copy.setMDRangeDimension(copyMDRangeDimension);
                } else {
                    if (mdRangeDimensionShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDRangeDimensionPropertyType) {
            ...
            final MDRangeDimensionPropertyType leftObject = ((MDRangeDimensionPropertyType) left);
            final MDRangeDimensionPropertyType rightObject = ((MDRangeDimensionPropertyType) right);
            {
                Boolean mdRangeDimensionShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDRangeDimension(), rightObject.isSetMDRangeDimension());
                if (mdRangeDimensionShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends MDRangeDimensionType> lhsMDRangeDimension;
                    lhsMDRangeDimension = leftObject.getMDRangeDimension();
                    JAXBElement<? extends MDRangeDimensionType> rhsMDRangeDimension;
                    rhsMDRangeDimension = rightObject.getMDRangeDimension();
                    JAXBElement<? extends MDRangeDimensionType> mergedMDRangeDimension = ((JAXBElement<? extends MDRangeDimensionType> ) strategy.merge(LocatorUtils.property(leftLocator, "mdRangeDimension", lhsMDRangeDimension), LocatorUtils.property(rightLocator, "mdRangeDimension", rhsMDRangeDimension), lhsMDRangeDimension, rhsMDRangeDimension, leftObject.isSetMDRangeDimension(), rightObject.isSetMDRangeDimension()));
                    target.setMDRangeDimension(mergedMDRangeDimension);
                } else {
                    if (mdRangeDimensionShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdRangeDimension = null;
                    }
                }
            }
            {
    ...
    public MDRangeDimensionPropertyType withMDRangeDimension(JAXBElement<? extends MDRangeDimensionType> value) {
    ...
    public MDRangeDimensionPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDRangeDimensionPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDRangeDimensionPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }
    ...
    public MDRangeDimensionPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDRangeDimensionPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDRangeDimensionPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDRangeDimensionPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDRangeDimensionPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
