...
public class MLEngineeringDatumPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlEngineeringDatum", buffer, theMLEngineeringDatum, this.isSetMLEngineeringDatum());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLEngineeringDatumPropertyType that = ((MLEngineeringDatumPropertyType) object);
        {
            MLEngineeringDatumType lhsMLEngineeringDatum;
            lhsMLEngineeringDatum = this.getMLEngineeringDatum();
            MLEngineeringDatumType rhsMLEngineeringDatum;
            rhsMLEngineeringDatum = that.getMLEngineeringDatum();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlEngineeringDatum", lhsMLEngineeringDatum), LocatorUtils.property(thatLocator, "mlEngineeringDatum", rhsMLEngineeringDatum), lhsMLEngineeringDatum, rhsMLEngineeringDatum, this.isSetMLEngineeringDatum(), that.isSetMLEngineeringDatum())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLEngineeringDatumType theMLEngineeringDatum;
            theMLEngineeringDatum = this.getMLEngineeringDatum();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlEngineeringDatum", theMLEngineeringDatum), currentHashCode, theMLEngineeringDatum, this.isSetMLEngineeringDatum());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLEngineeringDatumPropertyType) {
            final MLEngineeringDatumPropertyType copy = ((MLEngineeringDatumPropertyType) draftCopy);
            {
                Boolean mlEngineeringDatumShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLEngineeringDatum());
                if (mlEngineeringDatumShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLEngineeringDatumType sourceMLEngineeringDatum;
                    sourceMLEngineeringDatum = this.getMLEngineeringDatum();
                    MLEngineeringDatumType copyMLEngineeringDatum = ((MLEngineeringDatumType) strategy.copy(LocatorUtils.property(locator, "mlEngineeringDatum", sourceMLEngineeringDatum), sourceMLEngineeringDatum, this.isSetMLEngineeringDatum()));
                    copy.setMLEngineeringDatum(copyMLEngineeringDatum);
                } else {
                    if (mlEngineeringDatumShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlEngineeringDatum = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLEngineeringDatumPropertyType) {
            final MLEngineeringDatumPropertyType target = this;
            final MLEngineeringDatumPropertyType leftObject = ((MLEngineeringDatumPropertyType) left);
            final MLEngineeringDatumPropertyType rightObject = ((MLEngineeringDatumPropertyType) right);
            {
                Boolean mlEngineeringDatumShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLEngineeringDatum(), rightObject.isSetMLEngineeringDatum());
                if (mlEngineeringDatumShouldBeMergedAndSet == Boolean.TRUE) {
                    MLEngineeringDatumType lhsMLEngineeringDatum;
                    lhsMLEngineeringDatum = leftObject.getMLEngineeringDatum();
                    MLEngineeringDatumType rhsMLEngineeringDatum;
                    rhsMLEngineeringDatum = rightObject.getMLEngineeringDatum();
                    MLEngineeringDatumType mergedMLEngineeringDatum = ((MLEngineeringDatumType) strategy.merge(LocatorUtils.property(leftLocator, "mlEngineeringDatum", lhsMLEngineeringDatum), LocatorUtils.property(rightLocator, "mlEngineeringDatum", rhsMLEngineeringDatum), lhsMLEngineeringDatum, rhsMLEngineeringDatum, leftObject.isSetMLEngineeringDatum(), rightObject.isSetMLEngineeringDatum()));
                    target.setMLEngineeringDatum(mergedMLEngineeringDatum);
                } else {
                    if (mlEngineeringDatumShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlEngineeringDatum = null;
                    }
                }
            }
            {
    ...
    public MLEngineeringDatumPropertyType withMLEngineeringDatum(MLEngineeringDatumType value) {
        setMLEngineeringDatum(value);
        return this;
    }

    public MLEngineeringDatumPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLEngineeringDatumPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLEngineeringDatumPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLEngineeringDatumPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLEngineeringDatumPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLEngineeringDatumPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLEngineeringDatumPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLEngineeringDatumPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLEngineeringDatumPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLEngineeringDatumPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLEngineeringDatumPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
