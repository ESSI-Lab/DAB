...
public class DSDataSetPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<? extends DSDataSetType> lhsDSDataSet;
            lhsDSDataSet = this.getDSDataSet();
            JAXBElement<? extends DSDataSetType> rhsDSDataSet;
        ...
        if (draftCopy instanceof DSDataSetPropertyType) {
            final DSDataSetPropertyType copy = ((DSDataSetPropertyType) draftCopy);
            {
                ...
                if (dsDataSetShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends DSDataSetType> sourceDSDataSet;
                    sourceDSDataSet = this.getDSDataSet();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends DSDataSetType> copyDSDataSet = ((JAXBElement<? extends DSDataSetType> ) strategy.copy(LocatorUtils.property(locator, "dsDataSet", sourceDSDataSet), sourceDSDataSet, this.isSetDSDataSet()));
        ...
        if (right instanceof DSDataSetPropertyType) {
            ...
            final DSDataSetPropertyType rightObject = ((DSDataSetPropertyType) right);
            {
                ...
                if (dsDataSetShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<? extends DSDataSetType> mergedDSDataSet = ((JAXBElement<? extends DSDataSetType> ) strategy.merge(LocatorUtils.property(leftLocator, "dsDataSet", lhsDSDataSet), LocatorUtils.property(rightLocator, "dsDataSet", rhsDSDataSet), lhsDSDataSet, rhsDSDataSet, leftObject.isSetDSDataSet(), rightObject.isSetDSDataSet()));
    ...
    public DSDataSetPropertyType withDSDataSet(JAXBElement<? extends DSDataSetType> value) {
        setDSDataSet(value);
        return this;
    }

    public DSDataSetPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DSDataSetPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DSDataSetPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DSDataSetPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DSDataSetPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DSDataSetPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DSDataSetPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DSDataSetPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DSDataSetPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DSDataSetPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DSDataSetPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
