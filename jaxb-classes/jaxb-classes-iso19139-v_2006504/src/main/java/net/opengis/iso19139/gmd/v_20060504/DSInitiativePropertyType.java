...
public class DSInitiativePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "dsInitiative", buffer, theDSInitiative, this.isSetDSInitiative());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            DSInitiativeType lhsDSInitiative;
            lhsDSInitiative = this.getDSInitiative();
            DSInitiativeType rhsDSInitiative;
            rhsDSInitiative = that.getDSInitiative();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dsInitiative", lhsDSInitiative), LocatorUtils.property(thatLocator, "dsInitiative", rhsDSInitiative), lhsDSInitiative, rhsDSInitiative, this.isSetDSInitiative(), that.isSetDSInitiative())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            DSInitiativeType theDSInitiative;
            theDSInitiative = this.getDSInitiative();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dsInitiative", theDSInitiative), currentHashCode, theDSInitiative, this.isSetDSInitiative());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DSInitiativePropertyType) {
            final DSInitiativePropertyType copy = ((DSInitiativePropertyType) draftCopy);
            {
                Boolean dsInitiativeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDSInitiative());
                if (dsInitiativeShouldBeCopiedAndSet == Boolean.TRUE) {
                    DSInitiativeType sourceDSInitiative;
                    sourceDSInitiative = this.getDSInitiative();
                    DSInitiativeType copyDSInitiative = ((DSInitiativeType) strategy.copy(LocatorUtils.property(locator, "dsInitiative", sourceDSInitiative), sourceDSInitiative, this.isSetDSInitiative()));
                    copy.setDSInitiative(copyDSInitiative);
                } else {
                    if (dsInitiativeShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.dsInitiative = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DSInitiativePropertyType) {
            final DSInitiativePropertyType target = this;
            final DSInitiativePropertyType leftObject = ((DSInitiativePropertyType) left);
            final DSInitiativePropertyType rightObject = ((DSInitiativePropertyType) right);
            {
                Boolean dsInitiativeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDSInitiative(), rightObject.isSetDSInitiative());
                if (dsInitiativeShouldBeMergedAndSet == Boolean.TRUE) {
                    DSInitiativeType lhsDSInitiative;
                    lhsDSInitiative = leftObject.getDSInitiative();
                    DSInitiativeType rhsDSInitiative;
                    rhsDSInitiative = rightObject.getDSInitiative();
                    DSInitiativeType mergedDSInitiative = ((DSInitiativeType) strategy.merge(LocatorUtils.property(leftLocator, "dsInitiative", lhsDSInitiative), LocatorUtils.property(rightLocator, "dsInitiative", rhsDSInitiative), lhsDSInitiative, rhsDSInitiative, leftObject.isSetDSInitiative(), rightObject.isSetDSInitiative()));
                    target.setDSInitiative(mergedDSInitiative);
                } else {
                    if (dsInitiativeShouldBeMergedAndSet == Boolean.FALSE) {
                        target.dsInitiative = null;
                    }
                }
            }
            {
    ...
    public DSInitiativePropertyType withDSInitiative(DSInitiativeType value) {
        setDSInitiative(value);
        return this;
    }

    public DSInitiativePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DSInitiativePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DSInitiativePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DSInitiativePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DSInitiativePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DSInitiativePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DSInitiativePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DSInitiativePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DSInitiativePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DSInitiativePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DSInitiativePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
