...
public class MLPolarCSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlPolarCS", buffer, theMLPolarCS, this.isSetMLPolarCS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLPolarCSPropertyType that = ((MLPolarCSPropertyType) object);
        {
            MLPolarCSType lhsMLPolarCS;
            lhsMLPolarCS = this.getMLPolarCS();
            MLPolarCSType rhsMLPolarCS;
            rhsMLPolarCS = that.getMLPolarCS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlPolarCS", lhsMLPolarCS), LocatorUtils.property(thatLocator, "mlPolarCS", rhsMLPolarCS), lhsMLPolarCS, rhsMLPolarCS, this.isSetMLPolarCS(), that.isSetMLPolarCS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLPolarCSType theMLPolarCS;
            theMLPolarCS = this.getMLPolarCS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlPolarCS", theMLPolarCS), currentHashCode, theMLPolarCS, this.isSetMLPolarCS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLPolarCSPropertyType) {
            final MLPolarCSPropertyType copy = ((MLPolarCSPropertyType) draftCopy);
            {
                Boolean mlPolarCSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLPolarCS());
                if (mlPolarCSShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLPolarCSType sourceMLPolarCS;
                    sourceMLPolarCS = this.getMLPolarCS();
                    MLPolarCSType copyMLPolarCS = ((MLPolarCSType) strategy.copy(LocatorUtils.property(locator, "mlPolarCS", sourceMLPolarCS), sourceMLPolarCS, this.isSetMLPolarCS()));
                    copy.setMLPolarCS(copyMLPolarCS);
                } else {
                    if (mlPolarCSShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlPolarCS = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLPolarCSPropertyType) {
            final MLPolarCSPropertyType target = this;
            final MLPolarCSPropertyType leftObject = ((MLPolarCSPropertyType) left);
            final MLPolarCSPropertyType rightObject = ((MLPolarCSPropertyType) right);
            {
                Boolean mlPolarCSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLPolarCS(), rightObject.isSetMLPolarCS());
                if (mlPolarCSShouldBeMergedAndSet == Boolean.TRUE) {
                    MLPolarCSType lhsMLPolarCS;
                    lhsMLPolarCS = leftObject.getMLPolarCS();
                    MLPolarCSType rhsMLPolarCS;
                    rhsMLPolarCS = rightObject.getMLPolarCS();
                    MLPolarCSType mergedMLPolarCS = ((MLPolarCSType) strategy.merge(LocatorUtils.property(leftLocator, "mlPolarCS", lhsMLPolarCS), LocatorUtils.property(rightLocator, "mlPolarCS", rhsMLPolarCS), lhsMLPolarCS, rhsMLPolarCS, leftObject.isSetMLPolarCS(), rightObject.isSetMLPolarCS()));
                    target.setMLPolarCS(mergedMLPolarCS);
                } else {
                    if (mlPolarCSShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlPolarCS = null;
                    }
                }
            }
            {
    ...
    public MLPolarCSPropertyType withMLPolarCS(MLPolarCSType value) {
        setMLPolarCS(value);
        return this;
    }

    public MLPolarCSPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLPolarCSPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLPolarCSPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLPolarCSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLPolarCSPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLPolarCSPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLPolarCSPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLPolarCSPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLPolarCSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLPolarCSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLPolarCSPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
