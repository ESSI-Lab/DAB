...
public class BaseUnitPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    @XmlElementRef(name = "BaseUnit", namespace = "http://www.opengis.net/gml", type = JAXBElement.class, required = false)
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "baseUnit", buffer, theBaseUnit, this.isSetBaseUnit());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final BaseUnitPropertyType that = ((BaseUnitPropertyType) object);
        {
            JAXBElement<? extends BaseUnitType> lhsBaseUnit;
            lhsBaseUnit = this.getBaseUnit();
            JAXBElement<? extends BaseUnitType> rhsBaseUnit;
            rhsBaseUnit = that.getBaseUnit();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "baseUnit", lhsBaseUnit), LocatorUtils.property(thatLocator, "baseUnit", rhsBaseUnit), lhsBaseUnit, rhsBaseUnit, this.isSetBaseUnit(), that.isSetBaseUnit())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends BaseUnitType> theBaseUnit;
            theBaseUnit = this.getBaseUnit();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "baseUnit", theBaseUnit), currentHashCode, theBaseUnit, this.isSetBaseUnit());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof BaseUnitPropertyType) {
            final BaseUnitPropertyType copy = ((BaseUnitPropertyType) draftCopy);
            {
                Boolean baseUnitShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetBaseUnit());
                if (baseUnitShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends BaseUnitType> sourceBaseUnit;
                    sourceBaseUnit = this.getBaseUnit();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends BaseUnitType> copyBaseUnit = ((JAXBElement<? extends BaseUnitType> ) strategy.copy(LocatorUtils.property(locator, "baseUnit", sourceBaseUnit), sourceBaseUnit, this.isSetBaseUnit()));
                    copy.setBaseUnit(copyBaseUnit);
                } else {
                    if (baseUnitShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.baseUnit = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof BaseUnitPropertyType) {
            final BaseUnitPropertyType target = this;
            final BaseUnitPropertyType leftObject = ((BaseUnitPropertyType) left);
            final BaseUnitPropertyType rightObject = ((BaseUnitPropertyType) right);
            {
                Boolean baseUnitShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetBaseUnit(), rightObject.isSetBaseUnit());
                if (baseUnitShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends BaseUnitType> lhsBaseUnit;
                    lhsBaseUnit = leftObject.getBaseUnit();
                    JAXBElement<? extends BaseUnitType> rhsBaseUnit;
                    rhsBaseUnit = rightObject.getBaseUnit();
                    JAXBElement<? extends BaseUnitType> mergedBaseUnit = ((JAXBElement<? extends BaseUnitType> ) strategy.merge(LocatorUtils.property(leftLocator, "baseUnit", lhsBaseUnit), LocatorUtils.property(rightLocator, "baseUnit", rhsBaseUnit), lhsBaseUnit, rhsBaseUnit, leftObject.isSetBaseUnit(), rightObject.isSetBaseUnit()));
                    target.setBaseUnit(mergedBaseUnit);
                } else {
                    if (baseUnitShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public BaseUnitPropertyType withBaseUnit(JAXBElement<? extends BaseUnitType> value) {
        setBaseUnit(value);
        return this;
    }

    public BaseUnitPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public BaseUnitPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public BaseUnitPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public BaseUnitPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public BaseUnitPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public BaseUnitPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public BaseUnitPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public BaseUnitPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public BaseUnitPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public BaseUnitPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public BaseUnitPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
