...
public class OperationAltPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "operationAlt", buffer, theOperationAlt, this.isSetOperationAlt());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final OperationAltPropertyType that = ((OperationAltPropertyType) object);
        {
            OperationAltType lhsOperationAlt;
            lhsOperationAlt = this.getOperationAlt();
            OperationAltType rhsOperationAlt;
            rhsOperationAlt = that.getOperationAlt();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "operationAlt", lhsOperationAlt), LocatorUtils.property(thatLocator, "operationAlt", rhsOperationAlt), lhsOperationAlt, rhsOperationAlt, this.isSetOperationAlt(), that.isSetOperationAlt())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            OperationAltType theOperationAlt;
            theOperationAlt = this.getOperationAlt();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "operationAlt", theOperationAlt), currentHashCode, theOperationAlt, this.isSetOperationAlt());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof OperationAltPropertyType) {
            final OperationAltPropertyType copy = ((OperationAltPropertyType) draftCopy);
            {
                Boolean operationAltShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetOperationAlt());
                if (operationAltShouldBeCopiedAndSet == Boolean.TRUE) {
                    OperationAltType sourceOperationAlt;
                    sourceOperationAlt = this.getOperationAlt();
                    OperationAltType copyOperationAlt = ((OperationAltType) strategy.copy(LocatorUtils.property(locator, "operationAlt", sourceOperationAlt), sourceOperationAlt, this.isSetOperationAlt()));
                    copy.setOperationAlt(copyOperationAlt);
                } else {
                    if (operationAltShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.operationAlt = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof OperationAltPropertyType) {
            final OperationAltPropertyType target = this;
            final OperationAltPropertyType leftObject = ((OperationAltPropertyType) left);
            final OperationAltPropertyType rightObject = ((OperationAltPropertyType) right);
            {
                Boolean operationAltShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetOperationAlt(), rightObject.isSetOperationAlt());
                if (operationAltShouldBeMergedAndSet == Boolean.TRUE) {
                    OperationAltType lhsOperationAlt;
                    lhsOperationAlt = leftObject.getOperationAlt();
                    OperationAltType rhsOperationAlt;
                    rhsOperationAlt = rightObject.getOperationAlt();
                    OperationAltType mergedOperationAlt = ((OperationAltType) strategy.merge(LocatorUtils.property(leftLocator, "operationAlt", lhsOperationAlt), LocatorUtils.property(rightLocator, "operationAlt", rhsOperationAlt), lhsOperationAlt, rhsOperationAlt, leftObject.isSetOperationAlt(), rightObject.isSetOperationAlt()));
                    target.setOperationAlt(mergedOperationAlt);
                } else {
                    if (operationAltShouldBeMergedAndSet == Boolean.FALSE) {
                        target.operationAlt = null;
                    }
                }
            }
            {
    ...
    public OperationAltPropertyType withOperationAlt(OperationAltType value) {
        setOperationAlt(value);
        return this;
    }

    public OperationAltPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public OperationAltPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public OperationAltPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public OperationAltPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public OperationAltPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public OperationAltPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public OperationAltPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public OperationAltPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public OperationAltPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public OperationAltPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public OperationAltPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
