...
public class MLGeodeticCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlGeodeticCRS", buffer, theMLGeodeticCRS, this.isSetMLGeodeticCRS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLGeodeticCRSPropertyType that = ((MLGeodeticCRSPropertyType) object);
        {
            MLGeodeticCRSType lhsMLGeodeticCRS;
            lhsMLGeodeticCRS = this.getMLGeodeticCRS();
            MLGeodeticCRSType rhsMLGeodeticCRS;
            rhsMLGeodeticCRS = that.getMLGeodeticCRS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlGeodeticCRS", lhsMLGeodeticCRS), LocatorUtils.property(thatLocator, "mlGeodeticCRS", rhsMLGeodeticCRS), lhsMLGeodeticCRS, rhsMLGeodeticCRS, this.isSetMLGeodeticCRS(), that.isSetMLGeodeticCRS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLGeodeticCRSType theMLGeodeticCRS;
            theMLGeodeticCRS = this.getMLGeodeticCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlGeodeticCRS", theMLGeodeticCRS), currentHashCode, theMLGeodeticCRS, this.isSetMLGeodeticCRS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLGeodeticCRSPropertyType) {
            final MLGeodeticCRSPropertyType copy = ((MLGeodeticCRSPropertyType) draftCopy);
            {
                Boolean mlGeodeticCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLGeodeticCRS());
                if (mlGeodeticCRSShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLGeodeticCRSType sourceMLGeodeticCRS;
                    sourceMLGeodeticCRS = this.getMLGeodeticCRS();
                    MLGeodeticCRSType copyMLGeodeticCRS = ((MLGeodeticCRSType) strategy.copy(LocatorUtils.property(locator, "mlGeodeticCRS", sourceMLGeodeticCRS), sourceMLGeodeticCRS, this.isSetMLGeodeticCRS()));
                    copy.setMLGeodeticCRS(copyMLGeodeticCRS);
                } else {
                    if (mlGeodeticCRSShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlGeodeticCRS = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLGeodeticCRSPropertyType) {
            final MLGeodeticCRSPropertyType target = this;
            final MLGeodeticCRSPropertyType leftObject = ((MLGeodeticCRSPropertyType) left);
            final MLGeodeticCRSPropertyType rightObject = ((MLGeodeticCRSPropertyType) right);
            {
                Boolean mlGeodeticCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLGeodeticCRS(), rightObject.isSetMLGeodeticCRS());
                if (mlGeodeticCRSShouldBeMergedAndSet == Boolean.TRUE) {
                    MLGeodeticCRSType lhsMLGeodeticCRS;
                    lhsMLGeodeticCRS = leftObject.getMLGeodeticCRS();
                    MLGeodeticCRSType rhsMLGeodeticCRS;
                    rhsMLGeodeticCRS = rightObject.getMLGeodeticCRS();
                    MLGeodeticCRSType mergedMLGeodeticCRS = ((MLGeodeticCRSType) strategy.merge(LocatorUtils.property(leftLocator, "mlGeodeticCRS", lhsMLGeodeticCRS), LocatorUtils.property(rightLocator, "mlGeodeticCRS", rhsMLGeodeticCRS), lhsMLGeodeticCRS, rhsMLGeodeticCRS, leftObject.isSetMLGeodeticCRS(), rightObject.isSetMLGeodeticCRS()));
                    target.setMLGeodeticCRS(mergedMLGeodeticCRS);
                } else {
                    if (mlGeodeticCRSShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlGeodeticCRS = null;
                    }
                }
            }
            {
    ...
    public MLGeodeticCRSPropertyType withMLGeodeticCRS(MLGeodeticCRSType value) {
        setMLGeodeticCRS(value);
        return this;
    }

    public MLGeodeticCRSPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLGeodeticCRSPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLGeodeticCRSPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLGeodeticCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLGeodeticCRSPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLGeodeticCRSPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLGeodeticCRSPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLGeodeticCRSPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLGeodeticCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLGeodeticCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLGeodeticCRSPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
