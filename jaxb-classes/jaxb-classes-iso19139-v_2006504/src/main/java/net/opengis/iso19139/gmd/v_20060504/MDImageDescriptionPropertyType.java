...
public class MDImageDescriptionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdImageDescription", buffer, theMDImageDescription, this.isSetMDImageDescription());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            MDImageDescriptionType lhsMDImageDescription;
            lhsMDImageDescription = this.getMDImageDescription();
            MDImageDescriptionType rhsMDImageDescription;
            rhsMDImageDescription = that.getMDImageDescription();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdImageDescription", lhsMDImageDescription), LocatorUtils.property(thatLocator, "mdImageDescription", rhsMDImageDescription), lhsMDImageDescription, rhsMDImageDescription, this.isSetMDImageDescription(), that.isSetMDImageDescription())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MDImageDescriptionType theMDImageDescription;
            theMDImageDescription = this.getMDImageDescription();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdImageDescription", theMDImageDescription), currentHashCode, theMDImageDescription, this.isSetMDImageDescription());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDImageDescriptionPropertyType) {
            final MDImageDescriptionPropertyType copy = ((MDImageDescriptionPropertyType) draftCopy);
            {
                Boolean mdImageDescriptionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDImageDescription());
                if (mdImageDescriptionShouldBeCopiedAndSet == Boolean.TRUE) {
                    MDImageDescriptionType sourceMDImageDescription;
                    sourceMDImageDescription = this.getMDImageDescription();
                    MDImageDescriptionType copyMDImageDescription = ((MDImageDescriptionType) strategy.copy(LocatorUtils.property(locator, "mdImageDescription", sourceMDImageDescription), sourceMDImageDescription, this.isSetMDImageDescription()));
                    copy.setMDImageDescription(copyMDImageDescription);
                } else {
                    if (mdImageDescriptionShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdImageDescription = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDImageDescriptionPropertyType) {
            final MDImageDescriptionPropertyType target = this;
            final MDImageDescriptionPropertyType leftObject = ((MDImageDescriptionPropertyType) left);
            final MDImageDescriptionPropertyType rightObject = ((MDImageDescriptionPropertyType) right);
            {
                Boolean mdImageDescriptionShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDImageDescription(), rightObject.isSetMDImageDescription());
                if (mdImageDescriptionShouldBeMergedAndSet == Boolean.TRUE) {
                    MDImageDescriptionType lhsMDImageDescription;
                    lhsMDImageDescription = leftObject.getMDImageDescription();
                    MDImageDescriptionType rhsMDImageDescription;
                    rhsMDImageDescription = rightObject.getMDImageDescription();
                    MDImageDescriptionType mergedMDImageDescription = ((MDImageDescriptionType) strategy.merge(LocatorUtils.property(leftLocator, "mdImageDescription", lhsMDImageDescription), LocatorUtils.property(rightLocator, "mdImageDescription", rhsMDImageDescription), lhsMDImageDescription, rhsMDImageDescription, leftObject.isSetMDImageDescription(), rightObject.isSetMDImageDescription()));
                    target.setMDImageDescription(mergedMDImageDescription);
                } else {
                    if (mdImageDescriptionShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdImageDescription = null;
                    }
                }
            }
            {
    ...
    public MDImageDescriptionPropertyType withMDImageDescription(MDImageDescriptionType value) {
        setMDImageDescription(value);
        return this;
    }

    public MDImageDescriptionPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDImageDescriptionPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDImageDescriptionPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDImageDescriptionPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDImageDescriptionPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDImageDescriptionPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDImageDescriptionPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDImageDescriptionPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDImageDescriptionPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDImageDescriptionPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDImageDescriptionPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
