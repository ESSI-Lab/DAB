...
public class MemberNamePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "memberName", buffer, theMemberName, this.isSetMemberName());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            MemberNameType lhsMemberName;
            lhsMemberName = this.getMemberName();
            MemberNameType rhsMemberName;
            rhsMemberName = that.getMemberName();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "memberName", lhsMemberName), LocatorUtils.property(thatLocator, "memberName", rhsMemberName), lhsMemberName, rhsMemberName, this.isSetMemberName(), that.isSetMemberName())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MemberNameType theMemberName;
            theMemberName = this.getMemberName();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "memberName", theMemberName), currentHashCode, theMemberName, this.isSetMemberName());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MemberNamePropertyType) {
            final MemberNamePropertyType copy = ((MemberNamePropertyType) draftCopy);
            {
                Boolean memberNameShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMemberName());
                if (memberNameShouldBeCopiedAndSet == Boolean.TRUE) {
                    MemberNameType sourceMemberName;
                    sourceMemberName = this.getMemberName();
                    MemberNameType copyMemberName = ((MemberNameType) strategy.copy(LocatorUtils.property(locator, "memberName", sourceMemberName), sourceMemberName, this.isSetMemberName()));
                    copy.setMemberName(copyMemberName);
                } else {
                    if (memberNameShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.memberName = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MemberNamePropertyType) {
            final MemberNamePropertyType target = this;
            final MemberNamePropertyType leftObject = ((MemberNamePropertyType) left);
            final MemberNamePropertyType rightObject = ((MemberNamePropertyType) right);
            {
                Boolean memberNameShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMemberName(), rightObject.isSetMemberName());
                if (memberNameShouldBeMergedAndSet == Boolean.TRUE) {
                    MemberNameType lhsMemberName;
                    lhsMemberName = leftObject.getMemberName();
                    MemberNameType rhsMemberName;
                    rhsMemberName = rightObject.getMemberName();
                    MemberNameType mergedMemberName = ((MemberNameType) strategy.merge(LocatorUtils.property(leftLocator, "memberName", lhsMemberName), LocatorUtils.property(rightLocator, "memberName", rhsMemberName), lhsMemberName, rhsMemberName, leftObject.isSetMemberName(), rightObject.isSetMemberName()));
                    target.setMemberName(mergedMemberName);
                } else {
                    if (memberNameShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public MemberNamePropertyType withMemberName(MemberNameType value) {
        setMemberName(value);
        return this;
    }

    public MemberNamePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MemberNamePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MemberNamePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MemberNamePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MemberNamePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MemberNamePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MemberNamePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MemberNamePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MemberNamePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MemberNamePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MemberNamePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
