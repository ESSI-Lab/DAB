...
public class CTCrsCataloguePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "ctCrsCatalogue", buffer, theCTCrsCatalogue, this.isSetCTCrsCatalogue());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTCrsCataloguePropertyType that = ((CTCrsCataloguePropertyType) object);
        {
            CTCrsCatalogueType lhsCTCrsCatalogue;
            lhsCTCrsCatalogue = this.getCTCrsCatalogue();
            CTCrsCatalogueType rhsCTCrsCatalogue;
            rhsCTCrsCatalogue = that.getCTCrsCatalogue();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ctCrsCatalogue", lhsCTCrsCatalogue), LocatorUtils.property(thatLocator, "ctCrsCatalogue", rhsCTCrsCatalogue), lhsCTCrsCatalogue, rhsCTCrsCatalogue, this.isSetCTCrsCatalogue(), that.isSetCTCrsCatalogue())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            CTCrsCatalogueType theCTCrsCatalogue;
            theCTCrsCatalogue = this.getCTCrsCatalogue();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ctCrsCatalogue", theCTCrsCatalogue), currentHashCode, theCTCrsCatalogue, this.isSetCTCrsCatalogue());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CTCrsCataloguePropertyType) {
            final CTCrsCataloguePropertyType copy = ((CTCrsCataloguePropertyType) draftCopy);
            {
                Boolean ctCrsCatalogueShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCTCrsCatalogue());
                if (ctCrsCatalogueShouldBeCopiedAndSet == Boolean.TRUE) {
                    CTCrsCatalogueType sourceCTCrsCatalogue;
                    sourceCTCrsCatalogue = this.getCTCrsCatalogue();
                    CTCrsCatalogueType copyCTCrsCatalogue = ((CTCrsCatalogueType) strategy.copy(LocatorUtils.property(locator, "ctCrsCatalogue", sourceCTCrsCatalogue), sourceCTCrsCatalogue, this.isSetCTCrsCatalogue()));
                    copy.setCTCrsCatalogue(copyCTCrsCatalogue);
                } else {
                    if (ctCrsCatalogueShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.ctCrsCatalogue = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CTCrsCataloguePropertyType) {
            final CTCrsCataloguePropertyType target = this;
            final CTCrsCataloguePropertyType leftObject = ((CTCrsCataloguePropertyType) left);
            final CTCrsCataloguePropertyType rightObject = ((CTCrsCataloguePropertyType) right);
            {
                Boolean ctCrsCatalogueShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCTCrsCatalogue(), rightObject.isSetCTCrsCatalogue());
                if (ctCrsCatalogueShouldBeMergedAndSet == Boolean.TRUE) {
                    CTCrsCatalogueType lhsCTCrsCatalogue;
                    lhsCTCrsCatalogue = leftObject.getCTCrsCatalogue();
                    CTCrsCatalogueType rhsCTCrsCatalogue;
                    rhsCTCrsCatalogue = rightObject.getCTCrsCatalogue();
                    CTCrsCatalogueType mergedCTCrsCatalogue = ((CTCrsCatalogueType) strategy.merge(LocatorUtils.property(leftLocator, "ctCrsCatalogue", lhsCTCrsCatalogue), LocatorUtils.property(rightLocator, "ctCrsCatalogue", rhsCTCrsCatalogue), lhsCTCrsCatalogue, rhsCTCrsCatalogue, leftObject.isSetCTCrsCatalogue(), rightObject.isSetCTCrsCatalogue()));
                    target.setCTCrsCatalogue(mergedCTCrsCatalogue);
                } else {
                    if (ctCrsCatalogueShouldBeMergedAndSet == Boolean.FALSE) {
                        target.ctCrsCatalogue = null;
                    }
                }
            }
            {
    ...
    public CTCrsCataloguePropertyType withCTCrsCatalogue(CTCrsCatalogueType value) {
        setCTCrsCatalogue(value);
        return this;
    }

    public CTCrsCataloguePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CTCrsCataloguePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CTCrsCataloguePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public CTCrsCataloguePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CTCrsCataloguePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CTCrsCataloguePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CTCrsCataloguePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CTCrsCataloguePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CTCrsCataloguePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CTCrsCataloguePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CTCrsCataloguePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
