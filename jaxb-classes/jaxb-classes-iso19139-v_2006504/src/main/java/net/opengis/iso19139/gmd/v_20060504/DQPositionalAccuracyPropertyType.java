...
public class DQPositionalAccuracyPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<? extends AbstractDQPositionalAccuracyType> lhsAbstractDQPositionalAccuracy;
            lhsAbstractDQPositionalAccuracy = this.getAbstractDQPositionalAccuracy();
            JAXBElement<? extends AbstractDQPositionalAccuracyType> rhsAbstractDQPositionalAccuracy;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DQPositionalAccuracyPropertyType) {
            final DQPositionalAccuracyPropertyType copy = ((DQPositionalAccuracyPropertyType) draftCopy);
            {
                Boolean abstractDQPositionalAccuracyShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractDQPositionalAccuracy());
                if (abstractDQPositionalAccuracyShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractDQPositionalAccuracyType> sourceAbstractDQPositionalAccuracy;
                    sourceAbstractDQPositionalAccuracy = this.getAbstractDQPositionalAccuracy();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractDQPositionalAccuracyType> copyAbstractDQPositionalAccuracy = ((JAXBElement<? extends AbstractDQPositionalAccuracyType> ) strategy.copy(LocatorUtils.property(locator, "abstractDQPositionalAccuracy", sourceAbstractDQPositionalAccuracy), sourceAbstractDQPositionalAccuracy, this.isSetAbstractDQPositionalAccuracy()));
                    copy.setAbstractDQPositionalAccuracy(copyAbstractDQPositionalAccuracy);
                } else {
                    if (abstractDQPositionalAccuracyShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DQPositionalAccuracyPropertyType) {
            final DQPositionalAccuracyPropertyType target = this;
            final DQPositionalAccuracyPropertyType leftObject = ((DQPositionalAccuracyPropertyType) left);
            final DQPositionalAccuracyPropertyType rightObject = ((DQPositionalAccuracyPropertyType) right);
            {
                Boolean abstractDQPositionalAccuracyShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractDQPositionalAccuracy(), rightObject.isSetAbstractDQPositionalAccuracy());
                if (abstractDQPositionalAccuracyShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractDQPositionalAccuracyType> lhsAbstractDQPositionalAccuracy;
    ...
    public DQPositionalAccuracyPropertyType withAbstractDQPositionalAccuracy(JAXBElement<? extends AbstractDQPositionalAccuracyType> value) {
        setAbstractDQPositionalAccuracy(value);
        return this;
    }

    public DQPositionalAccuracyPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DQPositionalAccuracyPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DQPositionalAccuracyPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DQPositionalAccuracyPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DQPositionalAccuracyPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DQPositionalAccuracyPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DQPositionalAccuracyPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DQPositionalAccuracyPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DQPositionalAccuracyPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DQPositionalAccuracyPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DQPositionalAccuracyPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
