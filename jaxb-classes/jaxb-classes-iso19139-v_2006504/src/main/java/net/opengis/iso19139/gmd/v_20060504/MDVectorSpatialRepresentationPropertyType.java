...
public class MDVectorSpatialRepresentationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdVectorSpatialRepresentation", buffer, theMDVectorSpatialRepresentation, this.isSetMDVectorSpatialRepresentation());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            MDVectorSpatialRepresentationType lhsMDVectorSpatialRepresentation;
            lhsMDVectorSpatialRepresentation = this.getMDVectorSpatialRepresentation();
            MDVectorSpatialRepresentationType rhsMDVectorSpatialRepresentation;
            rhsMDVectorSpatialRepresentation = that.getMDVectorSpatialRepresentation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdVectorSpatialRepresentation", lhsMDVectorSpatialRepresentation), LocatorUtils.property(thatLocator, "mdVectorSpatialRepresentation", rhsMDVectorSpatialRepresentation), lhsMDVectorSpatialRepresentation, rhsMDVectorSpatialRepresentation, this.isSetMDVectorSpatialRepresentation(), that.isSetMDVectorSpatialRepresentation())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MDVectorSpatialRepresentationType theMDVectorSpatialRepresentation;
            theMDVectorSpatialRepresentation = this.getMDVectorSpatialRepresentation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdVectorSpatialRepresentation", theMDVectorSpatialRepresentation), currentHashCode, theMDVectorSpatialRepresentation, this.isSetMDVectorSpatialRepresentation());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDVectorSpatialRepresentationPropertyType) {
            final MDVectorSpatialRepresentationPropertyType copy = ((MDVectorSpatialRepresentationPropertyType) draftCopy);
            {
                Boolean mdVectorSpatialRepresentationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDVectorSpatialRepresentation());
                if (mdVectorSpatialRepresentationShouldBeCopiedAndSet == Boolean.TRUE) {
                    MDVectorSpatialRepresentationType sourceMDVectorSpatialRepresentation;
                    sourceMDVectorSpatialRepresentation = this.getMDVectorSpatialRepresentation();
                    MDVectorSpatialRepresentationType copyMDVectorSpatialRepresentation = ((MDVectorSpatialRepresentationType) strategy.copy(LocatorUtils.property(locator, "mdVectorSpatialRepresentation", sourceMDVectorSpatialRepresentation), sourceMDVectorSpatialRepresentation, this.isSetMDVectorSpatialRepresentation()));
                    copy.setMDVectorSpatialRepresentation(copyMDVectorSpatialRepresentation);
                } else {
                    if (mdVectorSpatialRepresentationShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdVectorSpatialRepresentation = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDVectorSpatialRepresentationPropertyType) {
            final MDVectorSpatialRepresentationPropertyType target = this;
            final MDVectorSpatialRepresentationPropertyType leftObject = ((MDVectorSpatialRepresentationPropertyType) left);
            final MDVectorSpatialRepresentationPropertyType rightObject = ((MDVectorSpatialRepresentationPropertyType) right);
            {
                Boolean mdVectorSpatialRepresentationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDVectorSpatialRepresentation(), rightObject.isSetMDVectorSpatialRepresentation());
                if (mdVectorSpatialRepresentationShouldBeMergedAndSet == Boolean.TRUE) {
                    MDVectorSpatialRepresentationType lhsMDVectorSpatialRepresentation;
                    lhsMDVectorSpatialRepresentation = leftObject.getMDVectorSpatialRepresentation();
                    MDVectorSpatialRepresentationType rhsMDVectorSpatialRepresentation;
                    rhsMDVectorSpatialRepresentation = rightObject.getMDVectorSpatialRepresentation();
                    MDVectorSpatialRepresentationType mergedMDVectorSpatialRepresentation = ((MDVectorSpatialRepresentationType) strategy.merge(LocatorUtils.property(leftLocator, "mdVectorSpatialRepresentation", lhsMDVectorSpatialRepresentation), LocatorUtils.property(rightLocator, "mdVectorSpatialRepresentation", rhsMDVectorSpatialRepresentation), lhsMDVectorSpatialRepresentation, rhsMDVectorSpatialRepresentation, leftObject.isSetMDVectorSpatialRepresentation(), rightObject.isSetMDVectorSpatialRepresentation()));
                    target.setMDVectorSpatialRepresentation(mergedMDVectorSpatialRepresentation);
                } else {
                    if (mdVectorSpatialRepresentationShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdVectorSpatialRepresentation = null;
                    }
                }
            }
            {
    ...
    public MDVectorSpatialRepresentationPropertyType withMDVectorSpatialRepresentation(MDVectorSpatialRepresentationType value) {
        setMDVectorSpatialRepresentation(value);
        return this;
    }

    public MDVectorSpatialRepresentationPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDVectorSpatialRepresentationPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDVectorSpatialRepresentationPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDVectorSpatialRepresentationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDVectorSpatialRepresentationPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDVectorSpatialRepresentationPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDVectorSpatialRepresentationPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDVectorSpatialRepresentationPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDVectorSpatialRepresentationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDVectorSpatialRepresentationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDVectorSpatialRepresentationPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
