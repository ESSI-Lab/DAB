...
public class DQElementPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "abstractDQElement", buffer, theAbstractDQElement, this.isSetAbstractDQElement());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<? extends AbstractDQElementType> lhsAbstractDQElement;
            lhsAbstractDQElement = this.getAbstractDQElement();
            JAXBElement<? extends AbstractDQElementType> rhsAbstractDQElement;
            rhsAbstractDQElement = that.getAbstractDQElement();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractDQElement", lhsAbstractDQElement), LocatorUtils.property(thatLocator, "abstractDQElement", rhsAbstractDQElement), lhsAbstractDQElement, rhsAbstractDQElement, this.isSetAbstractDQElement(), that.isSetAbstractDQElement())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractDQElementType> theAbstractDQElement;
            theAbstractDQElement = this.getAbstractDQElement();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractDQElement", theAbstractDQElement), currentHashCode, theAbstractDQElement, this.isSetAbstractDQElement());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DQElementPropertyType) {
            final DQElementPropertyType copy = ((DQElementPropertyType) draftCopy);
            {
                Boolean abstractDQElementShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractDQElement());
                if (abstractDQElementShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractDQElementType> sourceAbstractDQElement;
                    sourceAbstractDQElement = this.getAbstractDQElement();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractDQElementType> copyAbstractDQElement = ((JAXBElement<? extends AbstractDQElementType> ) strategy.copy(LocatorUtils.property(locator, "abstractDQElement", sourceAbstractDQElement), sourceAbstractDQElement, this.isSetAbstractDQElement()));
                    copy.setAbstractDQElement(copyAbstractDQElement);
                } else {
                    if (abstractDQElementShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.abstractDQElement = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DQElementPropertyType) {
            final DQElementPropertyType target = this;
            final DQElementPropertyType leftObject = ((DQElementPropertyType) left);
            final DQElementPropertyType rightObject = ((DQElementPropertyType) right);
            {
                Boolean abstractDQElementShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractDQElement(), rightObject.isSetAbstractDQElement());
                if (abstractDQElementShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractDQElementType> lhsAbstractDQElement;
                    lhsAbstractDQElement = leftObject.getAbstractDQElement();
                    JAXBElement<? extends AbstractDQElementType> rhsAbstractDQElement;
                    rhsAbstractDQElement = rightObject.getAbstractDQElement();
                    JAXBElement<? extends AbstractDQElementType> mergedAbstractDQElement = ((JAXBElement<? extends AbstractDQElementType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractDQElement", lhsAbstractDQElement), LocatorUtils.property(rightLocator, "abstractDQElement", rhsAbstractDQElement), lhsAbstractDQElement, rhsAbstractDQElement, leftObject.isSetAbstractDQElement(), rightObject.isSetAbstractDQElement()));
                    target.setAbstractDQElement(mergedAbstractDQElement);
                } else {
                    if (abstractDQElementShouldBeMergedAndSet == Boolean.FALSE) {
                        target.abstractDQElement = null;
                    }
                }
            }
            {
    ...
    public DQElementPropertyType withAbstractDQElement(JAXBElement<? extends AbstractDQElementType> value) {
        setAbstractDQElement(value);
        return this;
    }

    public DQElementPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DQElementPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DQElementPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DQElementPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DQElementPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DQElementPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DQElementPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DQElementPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DQElementPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DQElementPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DQElementPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
