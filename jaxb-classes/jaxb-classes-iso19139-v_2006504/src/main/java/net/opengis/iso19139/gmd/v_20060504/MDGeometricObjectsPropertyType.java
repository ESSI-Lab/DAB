...
public class MDGeometricObjectsPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdGeometricObjects", buffer, theMDGeometricObjects, this.isSetMDGeometricObjects());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            MDGeometricObjectsType lhsMDGeometricObjects;
            lhsMDGeometricObjects = this.getMDGeometricObjects();
            MDGeometricObjectsType rhsMDGeometricObjects;
            rhsMDGeometricObjects = that.getMDGeometricObjects();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdGeometricObjects", lhsMDGeometricObjects), LocatorUtils.property(thatLocator, "mdGeometricObjects", rhsMDGeometricObjects), lhsMDGeometricObjects, rhsMDGeometricObjects, this.isSetMDGeometricObjects(), that.isSetMDGeometricObjects())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MDGeometricObjectsType theMDGeometricObjects;
            theMDGeometricObjects = this.getMDGeometricObjects();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdGeometricObjects", theMDGeometricObjects), currentHashCode, theMDGeometricObjects, this.isSetMDGeometricObjects());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDGeometricObjectsPropertyType) {
            final MDGeometricObjectsPropertyType copy = ((MDGeometricObjectsPropertyType) draftCopy);
            {
                Boolean mdGeometricObjectsShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDGeometricObjects());
                if (mdGeometricObjectsShouldBeCopiedAndSet == Boolean.TRUE) {
                    MDGeometricObjectsType sourceMDGeometricObjects;
                    sourceMDGeometricObjects = this.getMDGeometricObjects();
                    MDGeometricObjectsType copyMDGeometricObjects = ((MDGeometricObjectsType) strategy.copy(LocatorUtils.property(locator, "mdGeometricObjects", sourceMDGeometricObjects), sourceMDGeometricObjects, this.isSetMDGeometricObjects()));
                    copy.setMDGeometricObjects(copyMDGeometricObjects);
                } else {
                    if (mdGeometricObjectsShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdGeometricObjects = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDGeometricObjectsPropertyType) {
            final MDGeometricObjectsPropertyType target = this;
            final MDGeometricObjectsPropertyType leftObject = ((MDGeometricObjectsPropertyType) left);
            final MDGeometricObjectsPropertyType rightObject = ((MDGeometricObjectsPropertyType) right);
            {
                Boolean mdGeometricObjectsShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDGeometricObjects(), rightObject.isSetMDGeometricObjects());
                if (mdGeometricObjectsShouldBeMergedAndSet == Boolean.TRUE) {
                    MDGeometricObjectsType lhsMDGeometricObjects;
                    lhsMDGeometricObjects = leftObject.getMDGeometricObjects();
                    MDGeometricObjectsType rhsMDGeometricObjects;
                    rhsMDGeometricObjects = rightObject.getMDGeometricObjects();
                    MDGeometricObjectsType mergedMDGeometricObjects = ((MDGeometricObjectsType) strategy.merge(LocatorUtils.property(leftLocator, "mdGeometricObjects", lhsMDGeometricObjects), LocatorUtils.property(rightLocator, "mdGeometricObjects", rhsMDGeometricObjects), lhsMDGeometricObjects, rhsMDGeometricObjects, leftObject.isSetMDGeometricObjects(), rightObject.isSetMDGeometricObjects()));
                    target.setMDGeometricObjects(mergedMDGeometricObjects);
                } else {
                    if (mdGeometricObjectsShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdGeometricObjects = null;
                    }
                }
            }
            {
    ...
    public MDGeometricObjectsPropertyType withMDGeometricObjects(MDGeometricObjectsType value) {
        setMDGeometricObjects(value);
        return this;
    }

    public MDGeometricObjectsPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDGeometricObjectsPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDGeometricObjectsPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDGeometricObjectsPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDGeometricObjectsPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDGeometricObjectsPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDGeometricObjectsPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDGeometricObjectsPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDGeometricObjectsPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDGeometricObjectsPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDGeometricObjectsPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
