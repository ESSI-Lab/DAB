...
public class MXAggregatePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mxAggregate", buffer, theMXAggregate, this.isSetMXAggregate());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MXAggregatePropertyType that = ((MXAggregatePropertyType) object);
        {
            MXAggregateType lhsMXAggregate;
            lhsMXAggregate = this.getMXAggregate();
            MXAggregateType rhsMXAggregate;
            rhsMXAggregate = that.getMXAggregate();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mxAggregate", lhsMXAggregate), LocatorUtils.property(thatLocator, "mxAggregate", rhsMXAggregate), lhsMXAggregate, rhsMXAggregate, this.isSetMXAggregate(), that.isSetMXAggregate())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MXAggregateType theMXAggregate;
            theMXAggregate = this.getMXAggregate();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mxAggregate", theMXAggregate), currentHashCode, theMXAggregate, this.isSetMXAggregate());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MXAggregatePropertyType) {
            final MXAggregatePropertyType copy = ((MXAggregatePropertyType) draftCopy);
            {
                Boolean mxAggregateShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMXAggregate());
                if (mxAggregateShouldBeCopiedAndSet == Boolean.TRUE) {
                    MXAggregateType sourceMXAggregate;
                    sourceMXAggregate = this.getMXAggregate();
                    MXAggregateType copyMXAggregate = ((MXAggregateType) strategy.copy(LocatorUtils.property(locator, "mxAggregate", sourceMXAggregate), sourceMXAggregate, this.isSetMXAggregate()));
                    copy.setMXAggregate(copyMXAggregate);
                } else {
                    if (mxAggregateShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mxAggregate = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MXAggregatePropertyType) {
            final MXAggregatePropertyType target = this;
            final MXAggregatePropertyType leftObject = ((MXAggregatePropertyType) left);
            final MXAggregatePropertyType rightObject = ((MXAggregatePropertyType) right);
            {
                Boolean mxAggregateShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMXAggregate(), rightObject.isSetMXAggregate());
                if (mxAggregateShouldBeMergedAndSet == Boolean.TRUE) {
                    MXAggregateType lhsMXAggregate;
                    lhsMXAggregate = leftObject.getMXAggregate();
                    MXAggregateType rhsMXAggregate;
                    rhsMXAggregate = rightObject.getMXAggregate();
                    MXAggregateType mergedMXAggregate = ((MXAggregateType) strategy.merge(LocatorUtils.property(leftLocator, "mxAggregate", lhsMXAggregate), LocatorUtils.property(rightLocator, "mxAggregate", rhsMXAggregate), lhsMXAggregate, rhsMXAggregate, leftObject.isSetMXAggregate(), rightObject.isSetMXAggregate()));
                    target.setMXAggregate(mergedMXAggregate);
                } else {
                    if (mxAggregateShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mxAggregate = null;
                    }
                }
            }
            {
    ...
    public MXAggregatePropertyType withMXAggregate(MXAggregateType value) {
        setMXAggregate(value);
        return this;
    }

    public MXAggregatePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MXAggregatePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MXAggregatePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MXAggregatePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MXAggregatePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MXAggregatePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MXAggregatePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MXAggregatePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MXAggregatePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MXAggregatePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MXAggregatePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
