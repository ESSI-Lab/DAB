...
public class MDMetadataPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdMetadata", buffer, theMDMetadata, this.isSetMDMetadata());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            MDMetadataType lhsMDMetadata;
            lhsMDMetadata = this.getMDMetadata();
            MDMetadataType rhsMDMetadata;
            rhsMDMetadata = that.getMDMetadata();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdMetadata", lhsMDMetadata), LocatorUtils.property(thatLocator, "mdMetadata", rhsMDMetadata), lhsMDMetadata, rhsMDMetadata, this.isSetMDMetadata(), that.isSetMDMetadata())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MDMetadataType theMDMetadata;
            theMDMetadata = this.getMDMetadata();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdMetadata", theMDMetadata), currentHashCode, theMDMetadata, this.isSetMDMetadata());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDMetadataPropertyType) {
            final MDMetadataPropertyType copy = ((MDMetadataPropertyType) draftCopy);
            {
                Boolean mdMetadataShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDMetadata());
                if (mdMetadataShouldBeCopiedAndSet == Boolean.TRUE) {
                    MDMetadataType sourceMDMetadata;
                    sourceMDMetadata = this.getMDMetadata();
                    MDMetadataType copyMDMetadata = ((MDMetadataType) strategy.copy(LocatorUtils.property(locator, "mdMetadata", sourceMDMetadata), sourceMDMetadata, this.isSetMDMetadata()));
                    copy.setMDMetadata(copyMDMetadata);
                } else {
                    if (mdMetadataShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdMetadata = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDMetadataPropertyType) {
            final MDMetadataPropertyType target = this;
            final MDMetadataPropertyType leftObject = ((MDMetadataPropertyType) left);
            final MDMetadataPropertyType rightObject = ((MDMetadataPropertyType) right);
            {
                Boolean mdMetadataShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDMetadata(), rightObject.isSetMDMetadata());
                if (mdMetadataShouldBeMergedAndSet == Boolean.TRUE) {
                    MDMetadataType lhsMDMetadata;
                    lhsMDMetadata = leftObject.getMDMetadata();
                    MDMetadataType rhsMDMetadata;
                    rhsMDMetadata = rightObject.getMDMetadata();
                    MDMetadataType mergedMDMetadata = ((MDMetadataType) strategy.merge(LocatorUtils.property(leftLocator, "mdMetadata", lhsMDMetadata), LocatorUtils.property(rightLocator, "mdMetadata", rhsMDMetadata), lhsMDMetadata, rhsMDMetadata, leftObject.isSetMDMetadata(), rightObject.isSetMDMetadata()));
                    target.setMDMetadata(mergedMDMetadata);
                } else {
                    if (mdMetadataShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdMetadata = null;
                    }
                }
            }
            {
    ...
    public MDMetadataPropertyType withMDMetadata(MDMetadataType value) {
        setMDMetadata(value);
        return this;
    }

    public MDMetadataPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDMetadataPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDMetadataPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDMetadataPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDMetadataPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDMetadataPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDMetadataPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDMetadataPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDMetadataPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDMetadataPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDMetadataPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
