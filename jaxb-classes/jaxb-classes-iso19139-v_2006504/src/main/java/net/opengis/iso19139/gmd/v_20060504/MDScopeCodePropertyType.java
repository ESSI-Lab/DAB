...
public class MDScopeCodePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdScopeCode", buffer, theMDScopeCode, this.isSetMDScopeCode());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<CodeListValueType> lhsMDScopeCode;
            lhsMDScopeCode = this.getMDScopeCode();
            JAXBElement<CodeListValueType> rhsMDScopeCode;
            rhsMDScopeCode = that.getMDScopeCode();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdScopeCode", lhsMDScopeCode), LocatorUtils.property(thatLocator, "mdScopeCode", rhsMDScopeCode), lhsMDScopeCode, rhsMDScopeCode, this.isSetMDScopeCode(), that.isSetMDScopeCode())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<CodeListValueType> theMDScopeCode;
            theMDScopeCode = this.getMDScopeCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdScopeCode", theMDScopeCode), currentHashCode, theMDScopeCode, this.isSetMDScopeCode());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDScopeCodePropertyType) {
            ...
            {
                Boolean mdScopeCodeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDScopeCode());
                if (mdScopeCodeShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<CodeListValueType> sourceMDScopeCode;
                    sourceMDScopeCode = this.getMDScopeCode();
                    @SuppressWarnings("unchecked")
                    JAXBElement<CodeListValueType> copyMDScopeCode = ((JAXBElement<CodeListValueType> ) strategy.copy(LocatorUtils.property(locator, "mdScopeCode", sourceMDScopeCode), sourceMDScopeCode, this.isSetMDScopeCode()));
                    copy.setMDScopeCode(copyMDScopeCode);
                } else {
                    if (mdScopeCodeShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDScopeCodePropertyType) {
            final MDScopeCodePropertyType target = this;
            final MDScopeCodePropertyType leftObject = ((MDScopeCodePropertyType) left);
            final MDScopeCodePropertyType rightObject = ((MDScopeCodePropertyType) right);
            {
                Boolean mdScopeCodeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDScopeCode(), rightObject.isSetMDScopeCode());
                if (mdScopeCodeShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<CodeListValueType> lhsMDScopeCode;
                    lhsMDScopeCode = leftObject.getMDScopeCode();
                    JAXBElement<CodeListValueType> rhsMDScopeCode;
                    rhsMDScopeCode = rightObject.getMDScopeCode();
                    JAXBElement<CodeListValueType> mergedMDScopeCode = ((JAXBElement<CodeListValueType> ) strategy.merge(LocatorUtils.property(leftLocator, "mdScopeCode", lhsMDScopeCode), LocatorUtils.property(rightLocator, "mdScopeCode", rhsMDScopeCode), lhsMDScopeCode, rhsMDScopeCode, leftObject.isSetMDScopeCode(), rightObject.isSetMDScopeCode()));
                    target.setMDScopeCode(mergedMDScopeCode);
                } else {
                    if (mdScopeCodeShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdScopeCode = null;
                    }
                }
            }
            {
    ...
    public MDScopeCodePropertyType withMDScopeCode(JAXBElement<CodeListValueType> value) {
        setMDScopeCode(value);
        return this;
    }

    public MDScopeCodePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDScopeCodePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDScopeCodePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
