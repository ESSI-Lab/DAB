...
public class MLPrimeMeridianPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlPrimeMeridian", buffer, theMLPrimeMeridian, this.isSetMLPrimeMeridian());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLPrimeMeridianPropertyType that = ((MLPrimeMeridianPropertyType) object);
        {
            MLPrimeMeridianType lhsMLPrimeMeridian;
            lhsMLPrimeMeridian = this.getMLPrimeMeridian();
            MLPrimeMeridianType rhsMLPrimeMeridian;
            rhsMLPrimeMeridian = that.getMLPrimeMeridian();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlPrimeMeridian", lhsMLPrimeMeridian), LocatorUtils.property(thatLocator, "mlPrimeMeridian", rhsMLPrimeMeridian), lhsMLPrimeMeridian, rhsMLPrimeMeridian, this.isSetMLPrimeMeridian(), that.isSetMLPrimeMeridian())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLPrimeMeridianType theMLPrimeMeridian;
            theMLPrimeMeridian = this.getMLPrimeMeridian();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlPrimeMeridian", theMLPrimeMeridian), currentHashCode, theMLPrimeMeridian, this.isSetMLPrimeMeridian());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLPrimeMeridianPropertyType) {
            final MLPrimeMeridianPropertyType copy = ((MLPrimeMeridianPropertyType) draftCopy);
            {
                Boolean mlPrimeMeridianShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLPrimeMeridian());
                if (mlPrimeMeridianShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLPrimeMeridianType sourceMLPrimeMeridian;
                    sourceMLPrimeMeridian = this.getMLPrimeMeridian();
                    MLPrimeMeridianType copyMLPrimeMeridian = ((MLPrimeMeridianType) strategy.copy(LocatorUtils.property(locator, "mlPrimeMeridian", sourceMLPrimeMeridian), sourceMLPrimeMeridian, this.isSetMLPrimeMeridian()));
                    copy.setMLPrimeMeridian(copyMLPrimeMeridian);
                } else {
                    if (mlPrimeMeridianShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlPrimeMeridian = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLPrimeMeridianPropertyType) {
            final MLPrimeMeridianPropertyType target = this;
            final MLPrimeMeridianPropertyType leftObject = ((MLPrimeMeridianPropertyType) left);
            final MLPrimeMeridianPropertyType rightObject = ((MLPrimeMeridianPropertyType) right);
            {
                Boolean mlPrimeMeridianShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLPrimeMeridian(), rightObject.isSetMLPrimeMeridian());
                if (mlPrimeMeridianShouldBeMergedAndSet == Boolean.TRUE) {
                    MLPrimeMeridianType lhsMLPrimeMeridian;
                    lhsMLPrimeMeridian = leftObject.getMLPrimeMeridian();
                    MLPrimeMeridianType rhsMLPrimeMeridian;
                    rhsMLPrimeMeridian = rightObject.getMLPrimeMeridian();
                    MLPrimeMeridianType mergedMLPrimeMeridian = ((MLPrimeMeridianType) strategy.merge(LocatorUtils.property(leftLocator, "mlPrimeMeridian", lhsMLPrimeMeridian), LocatorUtils.property(rightLocator, "mlPrimeMeridian", rhsMLPrimeMeridian), lhsMLPrimeMeridian, rhsMLPrimeMeridian, leftObject.isSetMLPrimeMeridian(), rightObject.isSetMLPrimeMeridian()));
                    target.setMLPrimeMeridian(mergedMLPrimeMeridian);
                } else {
                    if (mlPrimeMeridianShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlPrimeMeridian = null;
                    }
                }
            }
            {
    ...
    public MLPrimeMeridianPropertyType withMLPrimeMeridian(MLPrimeMeridianType value) {
        setMLPrimeMeridian(value);
        return this;
    }

    public MLPrimeMeridianPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLPrimeMeridianPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLPrimeMeridianPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLPrimeMeridianPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLPrimeMeridianPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLPrimeMeridianPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLPrimeMeridianPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLPrimeMeridianPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLPrimeMeridianPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLPrimeMeridianPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLPrimeMeridianPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
