...
public class DQFormatConsistencyPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "dqFormatConsistency", buffer, theDQFormatConsistency, this.isSetDQFormatConsistency());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DQFormatConsistencyPropertyType that = ((DQFormatConsistencyPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dqFormatConsistency", lhsDQFormatConsistency), LocatorUtils.property(thatLocator, "dqFormatConsistency", rhsDQFormatConsistency), lhsDQFormatConsistency, rhsDQFormatConsistency, this.isSetDQFormatConsistency(), that.isSetDQFormatConsistency())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            DQFormatConsistencyType theDQFormatConsistency;
            theDQFormatConsistency = this.getDQFormatConsistency();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dqFormatConsistency", theDQFormatConsistency), currentHashCode, theDQFormatConsistency, this.isSetDQFormatConsistency());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DQFormatConsistencyPropertyType) {
            ...
            {
                Boolean dqFormatConsistencyShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDQFormatConsistency());
                if (dqFormatConsistencyShouldBeCopiedAndSet == Boolean.TRUE) {
                    DQFormatConsistencyType sourceDQFormatConsistency;
                    sourceDQFormatConsistency = this.getDQFormatConsistency();
                    DQFormatConsistencyType copyDQFormatConsistency = ((DQFormatConsistencyType) strategy.copy(LocatorUtils.property(locator, "dqFormatConsistency", sourceDQFormatConsistency), sourceDQFormatConsistency, this.isSetDQFormatConsistency()));
                    copy.setDQFormatConsistency(copyDQFormatConsistency);
                } else {
                    if (dqFormatConsistencyShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DQFormatConsistencyPropertyType) {
            final DQFormatConsistencyPropertyType target = this;
            final DQFormatConsistencyPropertyType leftObject = ((DQFormatConsistencyPropertyType) left);
            final DQFormatConsistencyPropertyType rightObject = ((DQFormatConsistencyPropertyType) right);
            {
                Boolean dqFormatConsistencyShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDQFormatConsistency(), rightObject.isSetDQFormatConsistency());
                if (dqFormatConsistencyShouldBeMergedAndSet == Boolean.TRUE) {
                    DQFormatConsistencyType lhsDQFormatConsistency;
                    lhsDQFormatConsistency = leftObject.getDQFormatConsistency();
                    DQFormatConsistencyType rhsDQFormatConsistency;
                    rhsDQFormatConsistency = rightObject.getDQFormatConsistency();
                    DQFormatConsistencyType mergedDQFormatConsistency = ((DQFormatConsistencyType) strategy.merge(LocatorUtils.property(leftLocator, "dqFormatConsistency", lhsDQFormatConsistency), LocatorUtils.property(rightLocator, "dqFormatConsistency", rhsDQFormatConsistency), lhsDQFormatConsistency, rhsDQFormatConsistency, leftObject.isSetDQFormatConsistency(), rightObject.isSetDQFormatConsistency()));
                    target.setDQFormatConsistency(mergedDQFormatConsistency);
                } else {
                    if (dqFormatConsistencyShouldBeMergedAndSet == Boolean.FALSE) {
                        target.dqFormatConsistency = null;
                    }
                }
            }
            {
    ...
    public DQFormatConsistencyPropertyType withDQFormatConsistency(DQFormatConsistencyType value) {
        setDQFormatConsistency(value);
        return this;
    }

    public DQFormatConsistencyPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DQFormatConsistencyPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DQFormatConsistencyPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DQFormatConsistencyPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DQFormatConsistencyPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DQFormatConsistencyPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DQFormatConsistencyPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DQFormatConsistencyPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DQFormatConsistencyPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DQFormatConsistencyPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DQFormatConsistencyPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
