...
public class MLImageDatumPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlImageDatum", buffer, theMLImageDatum, this.isSetMLImageDatum());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLImageDatumPropertyType that = ((MLImageDatumPropertyType) object);
        {
            MLImageDatumType lhsMLImageDatum;
            lhsMLImageDatum = this.getMLImageDatum();
            MLImageDatumType rhsMLImageDatum;
            rhsMLImageDatum = that.getMLImageDatum();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlImageDatum", lhsMLImageDatum), LocatorUtils.property(thatLocator, "mlImageDatum", rhsMLImageDatum), lhsMLImageDatum, rhsMLImageDatum, this.isSetMLImageDatum(), that.isSetMLImageDatum())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLImageDatumType theMLImageDatum;
            theMLImageDatum = this.getMLImageDatum();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlImageDatum", theMLImageDatum), currentHashCode, theMLImageDatum, this.isSetMLImageDatum());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLImageDatumPropertyType) {
            final MLImageDatumPropertyType copy = ((MLImageDatumPropertyType) draftCopy);
            {
                Boolean mlImageDatumShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLImageDatum());
                if (mlImageDatumShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLImageDatumType sourceMLImageDatum;
                    sourceMLImageDatum = this.getMLImageDatum();
                    MLImageDatumType copyMLImageDatum = ((MLImageDatumType) strategy.copy(LocatorUtils.property(locator, "mlImageDatum", sourceMLImageDatum), sourceMLImageDatum, this.isSetMLImageDatum()));
                    copy.setMLImageDatum(copyMLImageDatum);
                } else {
                    if (mlImageDatumShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlImageDatum = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLImageDatumPropertyType) {
            final MLImageDatumPropertyType target = this;
            final MLImageDatumPropertyType leftObject = ((MLImageDatumPropertyType) left);
            final MLImageDatumPropertyType rightObject = ((MLImageDatumPropertyType) right);
            {
                Boolean mlImageDatumShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLImageDatum(), rightObject.isSetMLImageDatum());
                if (mlImageDatumShouldBeMergedAndSet == Boolean.TRUE) {
                    MLImageDatumType lhsMLImageDatum;
                    lhsMLImageDatum = leftObject.getMLImageDatum();
                    MLImageDatumType rhsMLImageDatum;
                    rhsMLImageDatum = rightObject.getMLImageDatum();
                    MLImageDatumType mergedMLImageDatum = ((MLImageDatumType) strategy.merge(LocatorUtils.property(leftLocator, "mlImageDatum", lhsMLImageDatum), LocatorUtils.property(rightLocator, "mlImageDatum", rhsMLImageDatum), lhsMLImageDatum, rhsMLImageDatum, leftObject.isSetMLImageDatum(), rightObject.isSetMLImageDatum()));
                    target.setMLImageDatum(mergedMLImageDatum);
                } else {
                    if (mlImageDatumShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlImageDatum = null;
                    }
                }
            }
            {
    ...
    public MLImageDatumPropertyType withMLImageDatum(MLImageDatumType value) {
        setMLImageDatum(value);
        return this;
    }

    public MLImageDatumPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLImageDatumPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLImageDatumPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLImageDatumPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLImageDatumPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLImageDatumPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLImageDatumPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLImageDatumPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLImageDatumPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLImageDatumPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLImageDatumPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
