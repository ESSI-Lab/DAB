...
public class MLEngineeringCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlEngineeringCRS", buffer, theMLEngineeringCRS, this.isSetMLEngineeringCRS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLEngineeringCRSPropertyType that = ((MLEngineeringCRSPropertyType) object);
        {
            MLEngineeringCRSType lhsMLEngineeringCRS;
            lhsMLEngineeringCRS = this.getMLEngineeringCRS();
            MLEngineeringCRSType rhsMLEngineeringCRS;
            rhsMLEngineeringCRS = that.getMLEngineeringCRS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlEngineeringCRS", lhsMLEngineeringCRS), LocatorUtils.property(thatLocator, "mlEngineeringCRS", rhsMLEngineeringCRS), lhsMLEngineeringCRS, rhsMLEngineeringCRS, this.isSetMLEngineeringCRS(), that.isSetMLEngineeringCRS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLEngineeringCRSType theMLEngineeringCRS;
            theMLEngineeringCRS = this.getMLEngineeringCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlEngineeringCRS", theMLEngineeringCRS), currentHashCode, theMLEngineeringCRS, this.isSetMLEngineeringCRS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLEngineeringCRSPropertyType) {
            final MLEngineeringCRSPropertyType copy = ((MLEngineeringCRSPropertyType) draftCopy);
            {
                Boolean mlEngineeringCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLEngineeringCRS());
                if (mlEngineeringCRSShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLEngineeringCRSType sourceMLEngineeringCRS;
                    sourceMLEngineeringCRS = this.getMLEngineeringCRS();
                    MLEngineeringCRSType copyMLEngineeringCRS = ((MLEngineeringCRSType) strategy.copy(LocatorUtils.property(locator, "mlEngineeringCRS", sourceMLEngineeringCRS), sourceMLEngineeringCRS, this.isSetMLEngineeringCRS()));
                    copy.setMLEngineeringCRS(copyMLEngineeringCRS);
                } else {
                    if (mlEngineeringCRSShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlEngineeringCRS = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLEngineeringCRSPropertyType) {
            final MLEngineeringCRSPropertyType target = this;
            final MLEngineeringCRSPropertyType leftObject = ((MLEngineeringCRSPropertyType) left);
            final MLEngineeringCRSPropertyType rightObject = ((MLEngineeringCRSPropertyType) right);
            {
                Boolean mlEngineeringCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLEngineeringCRS(), rightObject.isSetMLEngineeringCRS());
                if (mlEngineeringCRSShouldBeMergedAndSet == Boolean.TRUE) {
                    MLEngineeringCRSType lhsMLEngineeringCRS;
                    lhsMLEngineeringCRS = leftObject.getMLEngineeringCRS();
                    MLEngineeringCRSType rhsMLEngineeringCRS;
                    rhsMLEngineeringCRS = rightObject.getMLEngineeringCRS();
                    MLEngineeringCRSType mergedMLEngineeringCRS = ((MLEngineeringCRSType) strategy.merge(LocatorUtils.property(leftLocator, "mlEngineeringCRS", lhsMLEngineeringCRS), LocatorUtils.property(rightLocator, "mlEngineeringCRS", rhsMLEngineeringCRS), lhsMLEngineeringCRS, rhsMLEngineeringCRS, leftObject.isSetMLEngineeringCRS(), rightObject.isSetMLEngineeringCRS()));
                    target.setMLEngineeringCRS(mergedMLEngineeringCRS);
                } else {
                    if (mlEngineeringCRSShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlEngineeringCRS = null;
                    }
                }
            }
            {
    ...
    public MLEngineeringCRSPropertyType withMLEngineeringCRS(MLEngineeringCRSType value) {
        setMLEngineeringCRS(value);
        return this;
    }

    public MLEngineeringCRSPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLEngineeringCRSPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLEngineeringCRSPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLEngineeringCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLEngineeringCRSPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLEngineeringCRSPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLEngineeringCRSPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLEngineeringCRSPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLEngineeringCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLEngineeringCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLEngineeringCRSPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
