...
import net.opengis.gml.v_3_2_0.AbstractDatumType;
...
public class CTDatumPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTDatumPropertyType that = ((CTDatumPropertyType) object);
        {
            JAXBElement<?> lhsAbstractDatum;
            lhsAbstractDatum = this.getAbstractDatum();
            JAXBElement<?> rhsAbstractDatum;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CTDatumPropertyType) {
            final CTDatumPropertyType copy = ((CTDatumPropertyType) draftCopy);
            {
                Boolean abstractDatumShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractDatum());
                if (abstractDatumShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<?> sourceAbstractDatum;
                    sourceAbstractDatum = this.getAbstractDatum();
                    @SuppressWarnings("unchecked")
                    JAXBElement<?> copyAbstractDatum = ((JAXBElement<?> ) strategy.copy(LocatorUtils.property(locator, "abstractDatum", sourceAbstractDatum), sourceAbstractDatum, this.isSetAbstractDatum()));
                    copy.setAbstractDatum(copyAbstractDatum);
                } else {
                    if (abstractDatumShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CTDatumPropertyType) {
            final CTDatumPropertyType target = this;
            final CTDatumPropertyType leftObject = ((CTDatumPropertyType) left);
            final CTDatumPropertyType rightObject = ((CTDatumPropertyType) right);
            {
                Boolean abstractDatumShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractDatum(), rightObject.isSetAbstractDatum());
                if (abstractDatumShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<?> lhsAbstractDatum;
                    lhsAbstractDatum = leftObject.getAbstractDatum();
                    JAXBElement<?> rhsAbstractDatum;
                    rhsAbstractDatum = rightObject.getAbstractDatum();
                    JAXBElement<?> mergedAbstractDatum = ((JAXBElement<?> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractDatum", lhsAbstractDatum), LocatorUtils.property(rightLocator, "abstractDatum", rhsAbstractDatum), lhsAbstractDatum, rhsAbstractDatum, leftObject.isSetAbstractDatum(), rightObject.isSetAbstractDatum()));
                    target.setAbstractDatum(mergedAbstractDatum);
                } else {
                    if (abstractDatumShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public CTDatumPropertyType withAbstractDatum(JAXBElement<?> value) {
        setAbstractDatum(value);
        return this;
    }

    public CTDatumPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CTDatumPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CTDatumPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public CTDatumPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CTDatumPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CTDatumPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CTDatumPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CTDatumPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CTDatumPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CTDatumPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CTDatumPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
