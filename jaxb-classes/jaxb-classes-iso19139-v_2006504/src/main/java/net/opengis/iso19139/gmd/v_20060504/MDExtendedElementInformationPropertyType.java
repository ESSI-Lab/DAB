...
public class MDExtendedElementInformationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdExtendedElementInformation", buffer, theMDExtendedElementInformation, this.isSetMDExtendedElementInformation());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            MDExtendedElementInformationType lhsMDExtendedElementInformation;
            lhsMDExtendedElementInformation = this.getMDExtendedElementInformation();
            MDExtendedElementInformationType rhsMDExtendedElementInformation;
            rhsMDExtendedElementInformation = that.getMDExtendedElementInformation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdExtendedElementInformation", lhsMDExtendedElementInformation), LocatorUtils.property(thatLocator, "mdExtendedElementInformation", rhsMDExtendedElementInformation), lhsMDExtendedElementInformation, rhsMDExtendedElementInformation, this.isSetMDExtendedElementInformation(), that.isSetMDExtendedElementInformation())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MDExtendedElementInformationType theMDExtendedElementInformation;
            theMDExtendedElementInformation = this.getMDExtendedElementInformation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdExtendedElementInformation", theMDExtendedElementInformation), currentHashCode, theMDExtendedElementInformation, this.isSetMDExtendedElementInformation());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDExtendedElementInformationPropertyType) {
            final MDExtendedElementInformationPropertyType copy = ((MDExtendedElementInformationPropertyType) draftCopy);
            {
                Boolean mdExtendedElementInformationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDExtendedElementInformation());
                if (mdExtendedElementInformationShouldBeCopiedAndSet == Boolean.TRUE) {
                    MDExtendedElementInformationType sourceMDExtendedElementInformation;
                    sourceMDExtendedElementInformation = this.getMDExtendedElementInformation();
                    MDExtendedElementInformationType copyMDExtendedElementInformation = ((MDExtendedElementInformationType) strategy.copy(LocatorUtils.property(locator, "mdExtendedElementInformation", sourceMDExtendedElementInformation), sourceMDExtendedElementInformation, this.isSetMDExtendedElementInformation()));
                    copy.setMDExtendedElementInformation(copyMDExtendedElementInformation);
                } else {
                    if (mdExtendedElementInformationShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdExtendedElementInformation = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDExtendedElementInformationPropertyType) {
            final MDExtendedElementInformationPropertyType target = this;
            final MDExtendedElementInformationPropertyType leftObject = ((MDExtendedElementInformationPropertyType) left);
            final MDExtendedElementInformationPropertyType rightObject = ((MDExtendedElementInformationPropertyType) right);
            {
                Boolean mdExtendedElementInformationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDExtendedElementInformation(), rightObject.isSetMDExtendedElementInformation());
                if (mdExtendedElementInformationShouldBeMergedAndSet == Boolean.TRUE) {
                    MDExtendedElementInformationType lhsMDExtendedElementInformation;
                    lhsMDExtendedElementInformation = leftObject.getMDExtendedElementInformation();
                    MDExtendedElementInformationType rhsMDExtendedElementInformation;
                    rhsMDExtendedElementInformation = rightObject.getMDExtendedElementInformation();
                    MDExtendedElementInformationType mergedMDExtendedElementInformation = ((MDExtendedElementInformationType) strategy.merge(LocatorUtils.property(leftLocator, "mdExtendedElementInformation", lhsMDExtendedElementInformation), LocatorUtils.property(rightLocator, "mdExtendedElementInformation", rhsMDExtendedElementInformation), lhsMDExtendedElementInformation, rhsMDExtendedElementInformation, leftObject.isSetMDExtendedElementInformation(), rightObject.isSetMDExtendedElementInformation()));
                    target.setMDExtendedElementInformation(mergedMDExtendedElementInformation);
                } else {
                    if (mdExtendedElementInformationShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdExtendedElementInformation = null;
                    }
                }
            }
            {
    ...
    public MDExtendedElementInformationPropertyType withMDExtendedElementInformation(MDExtendedElementInformationType value) {
        setMDExtendedElementInformation(value);
        return this;
    }

    public MDExtendedElementInformationPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDExtendedElementInformationPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDExtendedElementInformationPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDExtendedElementInformationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDExtendedElementInformationPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDExtendedElementInformationPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDExtendedElementInformationPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDExtendedElementInformationPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDExtendedElementInformationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDExtendedElementInformationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDExtendedElementInformationPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
