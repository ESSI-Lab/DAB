...
public class SVInterfacePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "svInterface", buffer, theSVInterface, this.isSetSVInterface());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SVInterfacePropertyType that = ((SVInterfacePropertyType) object);
        {
            SVInterfaceType lhsSVInterface;
            lhsSVInterface = this.getSVInterface();
            SVInterfaceType rhsSVInterface;
            rhsSVInterface = that.getSVInterface();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "svInterface", lhsSVInterface), LocatorUtils.property(thatLocator, "svInterface", rhsSVInterface), lhsSVInterface, rhsSVInterface, this.isSetSVInterface(), that.isSetSVInterface())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            SVInterfaceType theSVInterface;
            theSVInterface = this.getSVInterface();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "svInterface", theSVInterface), currentHashCode, theSVInterface, this.isSetSVInterface());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SVInterfacePropertyType) {
            final SVInterfacePropertyType copy = ((SVInterfacePropertyType) draftCopy);
            {
                Boolean svInterfaceShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSVInterface());
                if (svInterfaceShouldBeCopiedAndSet == Boolean.TRUE) {
                    SVInterfaceType sourceSVInterface;
                    sourceSVInterface = this.getSVInterface();
                    SVInterfaceType copySVInterface = ((SVInterfaceType) strategy.copy(LocatorUtils.property(locator, "svInterface", sourceSVInterface), sourceSVInterface, this.isSetSVInterface()));
                    copy.setSVInterface(copySVInterface);
                } else {
                    if (svInterfaceShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.svInterface = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SVInterfacePropertyType) {
            final SVInterfacePropertyType target = this;
            final SVInterfacePropertyType leftObject = ((SVInterfacePropertyType) left);
            final SVInterfacePropertyType rightObject = ((SVInterfacePropertyType) right);
            {
                Boolean svInterfaceShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSVInterface(), rightObject.isSetSVInterface());
                if (svInterfaceShouldBeMergedAndSet == Boolean.TRUE) {
                    SVInterfaceType lhsSVInterface;
                    lhsSVInterface = leftObject.getSVInterface();
                    SVInterfaceType rhsSVInterface;
                    rhsSVInterface = rightObject.getSVInterface();
                    SVInterfaceType mergedSVInterface = ((SVInterfaceType) strategy.merge(LocatorUtils.property(leftLocator, "svInterface", lhsSVInterface), LocatorUtils.property(rightLocator, "svInterface", rhsSVInterface), lhsSVInterface, rhsSVInterface, leftObject.isSetSVInterface(), rightObject.isSetSVInterface()));
                    target.setSVInterface(mergedSVInterface);
                } else {
                    if (svInterfaceShouldBeMergedAndSet == Boolean.FALSE) {
                        target.svInterface = null;
                    }
                }
            }
            {
    ...
    public SVInterfacePropertyType withSVInterface(SVInterfaceType value) {
        setSVInterface(value);
        return this;
    }

    public SVInterfacePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public SVInterfacePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public SVInterfacePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public SVInterfacePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SVInterfacePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public SVInterfacePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public SVInterfacePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SVInterfacePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SVInterfacePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SVInterfacePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public SVInterfacePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
