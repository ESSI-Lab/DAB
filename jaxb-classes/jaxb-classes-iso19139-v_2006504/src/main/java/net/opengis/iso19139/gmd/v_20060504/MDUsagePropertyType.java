...
public class MDUsagePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdUsage", buffer, theMDUsage, this.isSetMDUsage());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            MDUsageType lhsMDUsage;
            lhsMDUsage = this.getMDUsage();
            MDUsageType rhsMDUsage;
            rhsMDUsage = that.getMDUsage();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdUsage", lhsMDUsage), LocatorUtils.property(thatLocator, "mdUsage", rhsMDUsage), lhsMDUsage, rhsMDUsage, this.isSetMDUsage(), that.isSetMDUsage())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MDUsageType theMDUsage;
            theMDUsage = this.getMDUsage();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdUsage", theMDUsage), currentHashCode, theMDUsage, this.isSetMDUsage());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDUsagePropertyType) {
            final MDUsagePropertyType copy = ((MDUsagePropertyType) draftCopy);
            {
                Boolean mdUsageShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDUsage());
                if (mdUsageShouldBeCopiedAndSet == Boolean.TRUE) {
                    MDUsageType sourceMDUsage;
                    sourceMDUsage = this.getMDUsage();
                    MDUsageType copyMDUsage = ((MDUsageType) strategy.copy(LocatorUtils.property(locator, "mdUsage", sourceMDUsage), sourceMDUsage, this.isSetMDUsage()));
                    copy.setMDUsage(copyMDUsage);
                } else {
                    if (mdUsageShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdUsage = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDUsagePropertyType) {
            final MDUsagePropertyType target = this;
            final MDUsagePropertyType leftObject = ((MDUsagePropertyType) left);
            final MDUsagePropertyType rightObject = ((MDUsagePropertyType) right);
            {
                Boolean mdUsageShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDUsage(), rightObject.isSetMDUsage());
                if (mdUsageShouldBeMergedAndSet == Boolean.TRUE) {
                    MDUsageType lhsMDUsage;
                    lhsMDUsage = leftObject.getMDUsage();
                    MDUsageType rhsMDUsage;
                    rhsMDUsage = rightObject.getMDUsage();
                    MDUsageType mergedMDUsage = ((MDUsageType) strategy.merge(LocatorUtils.property(leftLocator, "mdUsage", lhsMDUsage), LocatorUtils.property(rightLocator, "mdUsage", rhsMDUsage), lhsMDUsage, rhsMDUsage, leftObject.isSetMDUsage(), rightObject.isSetMDUsage()));
                    target.setMDUsage(mergedMDUsage);
                } else {
                    if (mdUsageShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdUsage = null;
                    }
                }
            }
    ...
    public MDUsagePropertyType withMDUsage(MDUsageType value) {
        setMDUsage(value);
        return this;
    }

    public MDUsagePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDUsagePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDUsagePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDUsagePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDUsagePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDUsagePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDUsagePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDUsagePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDUsagePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDUsagePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDUsagePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
