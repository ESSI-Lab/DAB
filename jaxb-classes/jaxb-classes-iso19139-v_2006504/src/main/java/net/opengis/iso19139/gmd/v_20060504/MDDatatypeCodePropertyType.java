...
public class MDDatatypeCodePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdDatatypeCode", buffer, theMDDatatypeCode, this.isSetMDDatatypeCode());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MDDatatypeCodePropertyType that = ((MDDatatypeCodePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdDatatypeCode", lhsMDDatatypeCode), LocatorUtils.property(thatLocator, "mdDatatypeCode", rhsMDDatatypeCode), lhsMDDatatypeCode, rhsMDDatatypeCode, this.isSetMDDatatypeCode(), that.isSetMDDatatypeCode())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            CodeListValueType theMDDatatypeCode;
            theMDDatatypeCode = this.getMDDatatypeCode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdDatatypeCode", theMDDatatypeCode), currentHashCode, theMDDatatypeCode, this.isSetMDDatatypeCode());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDDatatypeCodePropertyType) {
            ...
            {
                Boolean mdDatatypeCodeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDDatatypeCode());
                if (mdDatatypeCodeShouldBeCopiedAndSet == Boolean.TRUE) {
                    CodeListValueType sourceMDDatatypeCode;
                    sourceMDDatatypeCode = this.getMDDatatypeCode();
                    CodeListValueType copyMDDatatypeCode = ((CodeListValueType) strategy.copy(LocatorUtils.property(locator, "mdDatatypeCode", sourceMDDatatypeCode), sourceMDDatatypeCode, this.isSetMDDatatypeCode()));
                    copy.setMDDatatypeCode(copyMDDatatypeCode);
                } else {
                    if (mdDatatypeCodeShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDDatatypeCodePropertyType) {
            final MDDatatypeCodePropertyType target = this;
            final MDDatatypeCodePropertyType leftObject = ((MDDatatypeCodePropertyType) left);
            final MDDatatypeCodePropertyType rightObject = ((MDDatatypeCodePropertyType) right);
            {
                Boolean mdDatatypeCodeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDDatatypeCode(), rightObject.isSetMDDatatypeCode());
                if (mdDatatypeCodeShouldBeMergedAndSet == Boolean.TRUE) {
                    CodeListValueType lhsMDDatatypeCode;
                    lhsMDDatatypeCode = leftObject.getMDDatatypeCode();
                    CodeListValueType rhsMDDatatypeCode;
                    rhsMDDatatypeCode = rightObject.getMDDatatypeCode();
                    CodeListValueType mergedMDDatatypeCode = ((CodeListValueType) strategy.merge(LocatorUtils.property(leftLocator, "mdDatatypeCode", lhsMDDatatypeCode), LocatorUtils.property(rightLocator, "mdDatatypeCode", rhsMDDatatypeCode), lhsMDDatatypeCode, rhsMDDatatypeCode, leftObject.isSetMDDatatypeCode(), rightObject.isSetMDDatatypeCode()));
                    target.setMDDatatypeCode(mergedMDDatatypeCode);
                } else {
                    if (mdDatatypeCodeShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdDatatypeCode = null;
                    }
                }
            }
            {
    ...
    public MDDatatypeCodePropertyType withMDDatatypeCode(CodeListValueType value) {
        setMDDatatypeCode(value);
        return this;
    }

    public MDDatatypeCodePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDDatatypeCodePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDDatatypeCodePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
