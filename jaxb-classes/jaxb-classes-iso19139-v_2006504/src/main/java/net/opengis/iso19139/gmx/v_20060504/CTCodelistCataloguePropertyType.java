...
public class CTCodelistCataloguePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "ctCodelistCatalogue", buffer, theCTCodelistCatalogue, this.isSetCTCodelistCatalogue());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTCodelistCataloguePropertyType that = ((CTCodelistCataloguePropertyType) object);
        {
            CTCodelistCatalogueType lhsCTCodelistCatalogue;
            lhsCTCodelistCatalogue = this.getCTCodelistCatalogue();
            CTCodelistCatalogueType rhsCTCodelistCatalogue;
            rhsCTCodelistCatalogue = that.getCTCodelistCatalogue();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ctCodelistCatalogue", lhsCTCodelistCatalogue), LocatorUtils.property(thatLocator, "ctCodelistCatalogue", rhsCTCodelistCatalogue), lhsCTCodelistCatalogue, rhsCTCodelistCatalogue, this.isSetCTCodelistCatalogue(), that.isSetCTCodelistCatalogue())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            CTCodelistCatalogueType theCTCodelistCatalogue;
            theCTCodelistCatalogue = this.getCTCodelistCatalogue();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ctCodelistCatalogue", theCTCodelistCatalogue), currentHashCode, theCTCodelistCatalogue, this.isSetCTCodelistCatalogue());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CTCodelistCataloguePropertyType) {
            final CTCodelistCataloguePropertyType copy = ((CTCodelistCataloguePropertyType) draftCopy);
            {
                Boolean ctCodelistCatalogueShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCTCodelistCatalogue());
                if (ctCodelistCatalogueShouldBeCopiedAndSet == Boolean.TRUE) {
                    CTCodelistCatalogueType sourceCTCodelistCatalogue;
                    sourceCTCodelistCatalogue = this.getCTCodelistCatalogue();
                    CTCodelistCatalogueType copyCTCodelistCatalogue = ((CTCodelistCatalogueType) strategy.copy(LocatorUtils.property(locator, "ctCodelistCatalogue", sourceCTCodelistCatalogue), sourceCTCodelistCatalogue, this.isSetCTCodelistCatalogue()));
                    copy.setCTCodelistCatalogue(copyCTCodelistCatalogue);
                } else {
                    if (ctCodelistCatalogueShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.ctCodelistCatalogue = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CTCodelistCataloguePropertyType) {
            final CTCodelistCataloguePropertyType target = this;
            final CTCodelistCataloguePropertyType leftObject = ((CTCodelistCataloguePropertyType) left);
            final CTCodelistCataloguePropertyType rightObject = ((CTCodelistCataloguePropertyType) right);
            {
                Boolean ctCodelistCatalogueShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCTCodelistCatalogue(), rightObject.isSetCTCodelistCatalogue());
                if (ctCodelistCatalogueShouldBeMergedAndSet == Boolean.TRUE) {
                    CTCodelistCatalogueType lhsCTCodelistCatalogue;
                    lhsCTCodelistCatalogue = leftObject.getCTCodelistCatalogue();
                    CTCodelistCatalogueType rhsCTCodelistCatalogue;
                    rhsCTCodelistCatalogue = rightObject.getCTCodelistCatalogue();
                    CTCodelistCatalogueType mergedCTCodelistCatalogue = ((CTCodelistCatalogueType) strategy.merge(LocatorUtils.property(leftLocator, "ctCodelistCatalogue", lhsCTCodelistCatalogue), LocatorUtils.property(rightLocator, "ctCodelistCatalogue", rhsCTCodelistCatalogue), lhsCTCodelistCatalogue, rhsCTCodelistCatalogue, leftObject.isSetCTCodelistCatalogue(), rightObject.isSetCTCodelistCatalogue()));
                    target.setCTCodelistCatalogue(mergedCTCodelistCatalogue);
                } else {
                    if (ctCodelistCatalogueShouldBeMergedAndSet == Boolean.FALSE) {
                        target.ctCodelistCatalogue = null;
                    }
                }
            }
            {
    ...
    public CTCodelistCataloguePropertyType withCTCodelistCatalogue(CTCodelistCatalogueType value) {
        setCTCodelistCatalogue(value);
        return this;
    }

    public CTCodelistCataloguePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CTCodelistCataloguePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CTCodelistCataloguePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public CTCodelistCataloguePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CTCodelistCataloguePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CTCodelistCataloguePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CTCodelistCataloguePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CTCodelistCataloguePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CTCodelistCataloguePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CTCodelistCataloguePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CTCodelistCataloguePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
