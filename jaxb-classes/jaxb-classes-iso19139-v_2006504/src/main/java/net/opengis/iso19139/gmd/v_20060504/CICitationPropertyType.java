...
public class CICitationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "ciCitation", buffer, theCICitation, this.isSetCICitation());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            CICitationType lhsCICitation;
            lhsCICitation = this.getCICitation();
            CICitationType rhsCICitation;
            rhsCICitation = that.getCICitation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ciCitation", lhsCICitation), LocatorUtils.property(thatLocator, "ciCitation", rhsCICitation), lhsCICitation, rhsCICitation, this.isSetCICitation(), that.isSetCICitation())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            CICitationType theCICitation;
            theCICitation = this.getCICitation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ciCitation", theCICitation), currentHashCode, theCICitation, this.isSetCICitation());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CICitationPropertyType) {
            final CICitationPropertyType copy = ((CICitationPropertyType) draftCopy);
            {
                Boolean ciCitationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCICitation());
                if (ciCitationShouldBeCopiedAndSet == Boolean.TRUE) {
                    CICitationType sourceCICitation;
                    sourceCICitation = this.getCICitation();
                    CICitationType copyCICitation = ((CICitationType) strategy.copy(LocatorUtils.property(locator, "ciCitation", sourceCICitation), sourceCICitation, this.isSetCICitation()));
                    copy.setCICitation(copyCICitation);
                } else {
                    if (ciCitationShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CICitationPropertyType) {
            final CICitationPropertyType target = this;
            final CICitationPropertyType leftObject = ((CICitationPropertyType) left);
            final CICitationPropertyType rightObject = ((CICitationPropertyType) right);
            {
                Boolean ciCitationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCICitation(), rightObject.isSetCICitation());
                if (ciCitationShouldBeMergedAndSet == Boolean.TRUE) {
                    CICitationType lhsCICitation;
                    lhsCICitation = leftObject.getCICitation();
                    CICitationType rhsCICitation;
                    rhsCICitation = rightObject.getCICitation();
                    CICitationType mergedCICitation = ((CICitationType) strategy.merge(LocatorUtils.property(leftLocator, "ciCitation", lhsCICitation), LocatorUtils.property(rightLocator, "ciCitation", rhsCICitation), lhsCICitation, rhsCICitation, leftObject.isSetCICitation(), rightObject.isSetCICitation()));
                    target.setCICitation(mergedCICitation);
                } else {
                    if (ciCitationShouldBeMergedAndSet == Boolean.FALSE) {
                        target.ciCitation = null;
                    }
                }
            }
            {
    ...
    public CICitationPropertyType withCICitation(CICitationType value) {
        setCICitation(value);
        return this;
    }

    public CICitationPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CICitationPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CICitationPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public CICitationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CICitationPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CICitationPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CICitationPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CICitationPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CICitationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CICitationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CICitationPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
