...
public class EXBoundingPolygonPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "exBoundingPolygon", buffer, theEXBoundingPolygon, this.isSetEXBoundingPolygon());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            EXBoundingPolygonType lhsEXBoundingPolygon;
            lhsEXBoundingPolygon = this.getEXBoundingPolygon();
            EXBoundingPolygonType rhsEXBoundingPolygon;
            rhsEXBoundingPolygon = that.getEXBoundingPolygon();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "exBoundingPolygon", lhsEXBoundingPolygon), LocatorUtils.property(thatLocator, "exBoundingPolygon", rhsEXBoundingPolygon), lhsEXBoundingPolygon, rhsEXBoundingPolygon, this.isSetEXBoundingPolygon(), that.isSetEXBoundingPolygon())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            EXBoundingPolygonType theEXBoundingPolygon;
            theEXBoundingPolygon = this.getEXBoundingPolygon();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "exBoundingPolygon", theEXBoundingPolygon), currentHashCode, theEXBoundingPolygon, this.isSetEXBoundingPolygon());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof EXBoundingPolygonPropertyType) {
            final EXBoundingPolygonPropertyType copy = ((EXBoundingPolygonPropertyType) draftCopy);
            {
                Boolean exBoundingPolygonShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetEXBoundingPolygon());
                if (exBoundingPolygonShouldBeCopiedAndSet == Boolean.TRUE) {
                    EXBoundingPolygonType sourceEXBoundingPolygon;
                    sourceEXBoundingPolygon = this.getEXBoundingPolygon();
                    EXBoundingPolygonType copyEXBoundingPolygon = ((EXBoundingPolygonType) strategy.copy(LocatorUtils.property(locator, "exBoundingPolygon", sourceEXBoundingPolygon), sourceEXBoundingPolygon, this.isSetEXBoundingPolygon()));
                    copy.setEXBoundingPolygon(copyEXBoundingPolygon);
                } else {
                    if (exBoundingPolygonShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.exBoundingPolygon = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof EXBoundingPolygonPropertyType) {
            final EXBoundingPolygonPropertyType target = this;
            final EXBoundingPolygonPropertyType leftObject = ((EXBoundingPolygonPropertyType) left);
            final EXBoundingPolygonPropertyType rightObject = ((EXBoundingPolygonPropertyType) right);
            {
                Boolean exBoundingPolygonShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetEXBoundingPolygon(), rightObject.isSetEXBoundingPolygon());
                if (exBoundingPolygonShouldBeMergedAndSet == Boolean.TRUE) {
                    EXBoundingPolygonType lhsEXBoundingPolygon;
                    lhsEXBoundingPolygon = leftObject.getEXBoundingPolygon();
                    EXBoundingPolygonType rhsEXBoundingPolygon;
                    rhsEXBoundingPolygon = rightObject.getEXBoundingPolygon();
                    EXBoundingPolygonType mergedEXBoundingPolygon = ((EXBoundingPolygonType) strategy.merge(LocatorUtils.property(leftLocator, "exBoundingPolygon", lhsEXBoundingPolygon), LocatorUtils.property(rightLocator, "exBoundingPolygon", rhsEXBoundingPolygon), lhsEXBoundingPolygon, rhsEXBoundingPolygon, leftObject.isSetEXBoundingPolygon(), rightObject.isSetEXBoundingPolygon()));
                    target.setEXBoundingPolygon(mergedEXBoundingPolygon);
                } else {
                    if (exBoundingPolygonShouldBeMergedAndSet == Boolean.FALSE) {
                        target.exBoundingPolygon = null;
                    }
                }
            }
            {
    ...
    public EXBoundingPolygonPropertyType withEXBoundingPolygon(EXBoundingPolygonType value) {
        setEXBoundingPolygon(value);
        return this;
    }

    public EXBoundingPolygonPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public EXBoundingPolygonPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public EXBoundingPolygonPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public EXBoundingPolygonPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public EXBoundingPolygonPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public EXBoundingPolygonPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public EXBoundingPolygonPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public EXBoundingPolygonPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public EXBoundingPolygonPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public EXBoundingPolygonPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public EXBoundingPolygonPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
