...
public class EXGeographicBoundingBoxPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "exGeographicBoundingBox", buffer, theEXGeographicBoundingBox, this.isSetEXGeographicBoundingBox());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            EXGeographicBoundingBoxType lhsEXGeographicBoundingBox;
            lhsEXGeographicBoundingBox = this.getEXGeographicBoundingBox();
            EXGeographicBoundingBoxType rhsEXGeographicBoundingBox;
            rhsEXGeographicBoundingBox = that.getEXGeographicBoundingBox();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "exGeographicBoundingBox", lhsEXGeographicBoundingBox), LocatorUtils.property(thatLocator, "exGeographicBoundingBox", rhsEXGeographicBoundingBox), lhsEXGeographicBoundingBox, rhsEXGeographicBoundingBox, this.isSetEXGeographicBoundingBox(), that.isSetEXGeographicBoundingBox())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            EXGeographicBoundingBoxType theEXGeographicBoundingBox;
            theEXGeographicBoundingBox = this.getEXGeographicBoundingBox();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "exGeographicBoundingBox", theEXGeographicBoundingBox), currentHashCode, theEXGeographicBoundingBox, this.isSetEXGeographicBoundingBox());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof EXGeographicBoundingBoxPropertyType) {
            final EXGeographicBoundingBoxPropertyType copy = ((EXGeographicBoundingBoxPropertyType) draftCopy);
            {
                Boolean exGeographicBoundingBoxShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetEXGeographicBoundingBox());
                if (exGeographicBoundingBoxShouldBeCopiedAndSet == Boolean.TRUE) {
                    EXGeographicBoundingBoxType sourceEXGeographicBoundingBox;
                    sourceEXGeographicBoundingBox = this.getEXGeographicBoundingBox();
                    EXGeographicBoundingBoxType copyEXGeographicBoundingBox = ((EXGeographicBoundingBoxType) strategy.copy(LocatorUtils.property(locator, "exGeographicBoundingBox", sourceEXGeographicBoundingBox), sourceEXGeographicBoundingBox, this.isSetEXGeographicBoundingBox()));
                    copy.setEXGeographicBoundingBox(copyEXGeographicBoundingBox);
                } else {
                    if (exGeographicBoundingBoxShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.exGeographicBoundingBox = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof EXGeographicBoundingBoxPropertyType) {
            final EXGeographicBoundingBoxPropertyType target = this;
            final EXGeographicBoundingBoxPropertyType leftObject = ((EXGeographicBoundingBoxPropertyType) left);
            final EXGeographicBoundingBoxPropertyType rightObject = ((EXGeographicBoundingBoxPropertyType) right);
            {
                Boolean exGeographicBoundingBoxShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetEXGeographicBoundingBox(), rightObject.isSetEXGeographicBoundingBox());
                if (exGeographicBoundingBoxShouldBeMergedAndSet == Boolean.TRUE) {
                    EXGeographicBoundingBoxType lhsEXGeographicBoundingBox;
                    lhsEXGeographicBoundingBox = leftObject.getEXGeographicBoundingBox();
                    EXGeographicBoundingBoxType rhsEXGeographicBoundingBox;
                    rhsEXGeographicBoundingBox = rightObject.getEXGeographicBoundingBox();
                    EXGeographicBoundingBoxType mergedEXGeographicBoundingBox = ((EXGeographicBoundingBoxType) strategy.merge(LocatorUtils.property(leftLocator, "exGeographicBoundingBox", lhsEXGeographicBoundingBox), LocatorUtils.property(rightLocator, "exGeographicBoundingBox", rhsEXGeographicBoundingBox), lhsEXGeographicBoundingBox, rhsEXGeographicBoundingBox, leftObject.isSetEXGeographicBoundingBox(), rightObject.isSetEXGeographicBoundingBox()));
                    target.setEXGeographicBoundingBox(mergedEXGeographicBoundingBox);
                } else {
                    if (exGeographicBoundingBoxShouldBeMergedAndSet == Boolean.FALSE) {
                        target.exGeographicBoundingBox = null;
                    }
                }
            }
            {
    ...
    public EXGeographicBoundingBoxPropertyType withEXGeographicBoundingBox(EXGeographicBoundingBoxType value) {
        setEXGeographicBoundingBox(value);
        return this;
    }

    public EXGeographicBoundingBoxPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public EXGeographicBoundingBoxPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public EXGeographicBoundingBoxPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public EXGeographicBoundingBoxPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public EXGeographicBoundingBoxPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public EXGeographicBoundingBoxPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public EXGeographicBoundingBoxPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public EXGeographicBoundingBoxPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public EXGeographicBoundingBoxPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public EXGeographicBoundingBoxPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public EXGeographicBoundingBoxPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
