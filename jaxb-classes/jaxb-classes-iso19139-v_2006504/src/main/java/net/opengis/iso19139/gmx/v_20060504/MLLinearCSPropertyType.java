...
public class MLLinearCSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlLinearCS", buffer, theMLLinearCS, this.isSetMLLinearCS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLLinearCSPropertyType that = ((MLLinearCSPropertyType) object);
        {
            MLLinearCSType lhsMLLinearCS;
            lhsMLLinearCS = this.getMLLinearCS();
            MLLinearCSType rhsMLLinearCS;
            rhsMLLinearCS = that.getMLLinearCS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlLinearCS", lhsMLLinearCS), LocatorUtils.property(thatLocator, "mlLinearCS", rhsMLLinearCS), lhsMLLinearCS, rhsMLLinearCS, this.isSetMLLinearCS(), that.isSetMLLinearCS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLLinearCSType theMLLinearCS;
            theMLLinearCS = this.getMLLinearCS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlLinearCS", theMLLinearCS), currentHashCode, theMLLinearCS, this.isSetMLLinearCS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLLinearCSPropertyType) {
            final MLLinearCSPropertyType copy = ((MLLinearCSPropertyType) draftCopy);
            {
                Boolean mlLinearCSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLLinearCS());
                if (mlLinearCSShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLLinearCSType sourceMLLinearCS;
                    sourceMLLinearCS = this.getMLLinearCS();
                    MLLinearCSType copyMLLinearCS = ((MLLinearCSType) strategy.copy(LocatorUtils.property(locator, "mlLinearCS", sourceMLLinearCS), sourceMLLinearCS, this.isSetMLLinearCS()));
                    copy.setMLLinearCS(copyMLLinearCS);
                } else {
                    if (mlLinearCSShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlLinearCS = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLLinearCSPropertyType) {
            final MLLinearCSPropertyType target = this;
            final MLLinearCSPropertyType leftObject = ((MLLinearCSPropertyType) left);
            final MLLinearCSPropertyType rightObject = ((MLLinearCSPropertyType) right);
            {
                Boolean mlLinearCSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLLinearCS(), rightObject.isSetMLLinearCS());
                if (mlLinearCSShouldBeMergedAndSet == Boolean.TRUE) {
                    MLLinearCSType lhsMLLinearCS;
                    lhsMLLinearCS = leftObject.getMLLinearCS();
                    MLLinearCSType rhsMLLinearCS;
                    rhsMLLinearCS = rightObject.getMLLinearCS();
                    MLLinearCSType mergedMLLinearCS = ((MLLinearCSType) strategy.merge(LocatorUtils.property(leftLocator, "mlLinearCS", lhsMLLinearCS), LocatorUtils.property(rightLocator, "mlLinearCS", rhsMLLinearCS), lhsMLLinearCS, rhsMLLinearCS, leftObject.isSetMLLinearCS(), rightObject.isSetMLLinearCS()));
                    target.setMLLinearCS(mergedMLLinearCS);
                } else {
                    if (mlLinearCSShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlLinearCS = null;
                    }
                }
            }
            {
    ...
    public MLLinearCSPropertyType withMLLinearCS(MLLinearCSType value) {
        setMLLinearCS(value);
        return this;
    }

    public MLLinearCSPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLLinearCSPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLLinearCSPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLLinearCSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLLinearCSPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLLinearCSPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLLinearCSPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLLinearCSPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLLinearCSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLLinearCSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLLinearCSPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
