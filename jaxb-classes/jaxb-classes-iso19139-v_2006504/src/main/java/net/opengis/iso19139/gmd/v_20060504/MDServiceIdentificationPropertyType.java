...
public class MDServiceIdentificationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public MDServiceIdentificationPropertyType withMDServiceIdentification(MDServiceIdentificationType value) {
        setMDServiceIdentification(value);
        return this;
    }

    public MDServiceIdentificationPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDServiceIdentificationPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDServiceIdentificationPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDServiceIdentificationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDServiceIdentificationPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDServiceIdentificationPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDServiceIdentificationPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDServiceIdentificationPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDServiceIdentificationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDServiceIdentificationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDServiceIdentificationPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
