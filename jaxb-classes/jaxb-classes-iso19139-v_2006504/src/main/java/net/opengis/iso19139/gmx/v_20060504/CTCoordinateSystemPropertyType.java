...
import net.opengis.gml.v_3_2_0.AbstractCoordinateSystemType;
import net.opengis.gml.v_3_2_0.AffineCSType;
import net.opengis.gml.v_3_2_0.CartesianCSType;
import net.opengis.gml.v_3_2_0.CylindricalCSType;
import net.opengis.gml.v_3_2_0.EllipsoidalCSType;
import net.opengis.gml.v_3_2_0.LinearCSType;
import net.opengis.gml.v_3_2_0.PolarCSType;
import net.opengis.gml.v_3_2_0.SphericalCSType;
import net.opengis.gml.v_3_2_0.TimeCSType;
import net.opengis.gml.v_3_2_0.UserDefinedCSType;
import net.opengis.gml.v_3_2_0.VerticalCSType;
...
public class CTCoordinateSystemPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTCoordinateSystemPropertyType that = ((CTCoordinateSystemPropertyType) object);
        {
            JAXBElement<?> lhsAbstractCoordinateSystem;
            lhsAbstractCoordinateSystem = this.getAbstractCoordinateSystem();
            JAXBElement<?> rhsAbstractCoordinateSystem;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CTCoordinateSystemPropertyType) {
            final CTCoordinateSystemPropertyType copy = ((CTCoordinateSystemPropertyType) draftCopy);
            {
                Boolean abstractCoordinateSystemShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractCoordinateSystem());
                if (abstractCoordinateSystemShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<?> sourceAbstractCoordinateSystem;
                    sourceAbstractCoordinateSystem = this.getAbstractCoordinateSystem();
                    @SuppressWarnings("unchecked")
                    JAXBElement<?> copyAbstractCoordinateSystem = ((JAXBElement<?> ) strategy.copy(LocatorUtils.property(locator, "abstractCoordinateSystem", sourceAbstractCoordinateSystem), sourceAbstractCoordinateSystem, this.isSetAbstractCoordinateSystem()));
                    copy.setAbstractCoordinateSystem(copyAbstractCoordinateSystem);
                } else {
                    if (abstractCoordinateSystemShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CTCoordinateSystemPropertyType) {
            final CTCoordinateSystemPropertyType target = this;
            final CTCoordinateSystemPropertyType leftObject = ((CTCoordinateSystemPropertyType) left);
            final CTCoordinateSystemPropertyType rightObject = ((CTCoordinateSystemPropertyType) right);
            {
                Boolean abstractCoordinateSystemShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractCoordinateSystem(), rightObject.isSetAbstractCoordinateSystem());
                if (abstractCoordinateSystemShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<?> lhsAbstractCoordinateSystem;
                    ...
                    JAXBElement<?> mergedAbstractCoordinateSystem = ((JAXBElement<?> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractCoordinateSystem", lhsAbstractCoordinateSystem), LocatorUtils.property(rightLocator, "abstractCoordinateSystem", rhsAbstractCoordinateSystem), lhsAbstractCoordinateSystem, rhsAbstractCoordinateSystem, leftObject.isSetAbstractCoordinateSystem(), rightObject.isSetAbstractCoordinateSystem()));
                    target.setAbstractCoordinateSystem(mergedAbstractCoordinateSystem);
                } else {
                    if (abstractCoordinateSystemShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public CTCoordinateSystemPropertyType withAbstractCoordinateSystem(JAXBElement<?> value) {
        setAbstractCoordinateSystem(value);
        return this;
    }

    public CTCoordinateSystemPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CTCoordinateSystemPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CTCoordinateSystemPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public CTCoordinateSystemPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CTCoordinateSystemPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CTCoordinateSystemPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CTCoordinateSystemPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CTCoordinateSystemPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CTCoordinateSystemPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CTCoordinateSystemPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CTCoordinateSystemPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
