...
public class CodeListDictionaryPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "codeListDictionary", buffer, theCodeListDictionary, this.isSetCodeListDictionary());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CodeListDictionaryPropertyType that = ((CodeListDictionaryPropertyType) object);
        {
            JAXBElement<? extends CodeListDictionaryType> lhsCodeListDictionary;
            lhsCodeListDictionary = this.getCodeListDictionary();
            JAXBElement<? extends CodeListDictionaryType> rhsCodeListDictionary;
            rhsCodeListDictionary = that.getCodeListDictionary();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "codeListDictionary", lhsCodeListDictionary), LocatorUtils.property(thatLocator, "codeListDictionary", rhsCodeListDictionary), lhsCodeListDictionary, rhsCodeListDictionary, this.isSetCodeListDictionary(), that.isSetCodeListDictionary())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends CodeListDictionaryType> theCodeListDictionary;
            theCodeListDictionary = this.getCodeListDictionary();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "codeListDictionary", theCodeListDictionary), currentHashCode, theCodeListDictionary, this.isSetCodeListDictionary());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CodeListDictionaryPropertyType) {
            final CodeListDictionaryPropertyType copy = ((CodeListDictionaryPropertyType) draftCopy);
            {
                Boolean codeListDictionaryShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCodeListDictionary());
                if (codeListDictionaryShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends CodeListDictionaryType> sourceCodeListDictionary;
                    sourceCodeListDictionary = this.getCodeListDictionary();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends CodeListDictionaryType> copyCodeListDictionary = ((JAXBElement<? extends CodeListDictionaryType> ) strategy.copy(LocatorUtils.property(locator, "codeListDictionary", sourceCodeListDictionary), sourceCodeListDictionary, this.isSetCodeListDictionary()));
                    copy.setCodeListDictionary(copyCodeListDictionary);
                } else {
                    if (codeListDictionaryShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.codeListDictionary = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CodeListDictionaryPropertyType) {
            final CodeListDictionaryPropertyType target = this;
            final CodeListDictionaryPropertyType leftObject = ((CodeListDictionaryPropertyType) left);
            final CodeListDictionaryPropertyType rightObject = ((CodeListDictionaryPropertyType) right);
            {
                Boolean codeListDictionaryShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCodeListDictionary(), rightObject.isSetCodeListDictionary());
                if (codeListDictionaryShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends CodeListDictionaryType> lhsCodeListDictionary;
                    lhsCodeListDictionary = leftObject.getCodeListDictionary();
                    JAXBElement<? extends CodeListDictionaryType> rhsCodeListDictionary;
                    rhsCodeListDictionary = rightObject.getCodeListDictionary();
                    JAXBElement<? extends CodeListDictionaryType> mergedCodeListDictionary = ((JAXBElement<? extends CodeListDictionaryType> ) strategy.merge(LocatorUtils.property(leftLocator, "codeListDictionary", lhsCodeListDictionary), LocatorUtils.property(rightLocator, "codeListDictionary", rhsCodeListDictionary), lhsCodeListDictionary, rhsCodeListDictionary, leftObject.isSetCodeListDictionary(), rightObject.isSetCodeListDictionary()));
                    target.setCodeListDictionary(mergedCodeListDictionary);
                } else {
                    if (codeListDictionaryShouldBeMergedAndSet == Boolean.FALSE) {
                        target.codeListDictionary = null;
                    }
                }
            }
            {
    ...
    public CodeListDictionaryPropertyType withCodeListDictionary(JAXBElement<? extends CodeListDictionaryType> value) {
        setCodeListDictionary(value);
        return this;
    }

    public CodeListDictionaryPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CodeListDictionaryPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CodeListDictionaryPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public CodeListDictionaryPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CodeListDictionaryPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CodeListDictionaryPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CodeListDictionaryPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CodeListDictionaryPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CodeListDictionaryPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CodeListDictionaryPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CodeListDictionaryPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
