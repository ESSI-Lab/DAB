...
public class MDDistributorPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdDistributor", buffer, theMDDistributor, this.isSetMDDistributor());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            MDDistributorType lhsMDDistributor;
            lhsMDDistributor = this.getMDDistributor();
            MDDistributorType rhsMDDistributor;
            rhsMDDistributor = that.getMDDistributor();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdDistributor", lhsMDDistributor), LocatorUtils.property(thatLocator, "mdDistributor", rhsMDDistributor), lhsMDDistributor, rhsMDDistributor, this.isSetMDDistributor(), that.isSetMDDistributor())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MDDistributorType theMDDistributor;
            theMDDistributor = this.getMDDistributor();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdDistributor", theMDDistributor), currentHashCode, theMDDistributor, this.isSetMDDistributor());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDDistributorPropertyType) {
            final MDDistributorPropertyType copy = ((MDDistributorPropertyType) draftCopy);
            {
                Boolean mdDistributorShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDDistributor());
                if (mdDistributorShouldBeCopiedAndSet == Boolean.TRUE) {
                    MDDistributorType sourceMDDistributor;
                    sourceMDDistributor = this.getMDDistributor();
                    MDDistributorType copyMDDistributor = ((MDDistributorType) strategy.copy(LocatorUtils.property(locator, "mdDistributor", sourceMDDistributor), sourceMDDistributor, this.isSetMDDistributor()));
                    copy.setMDDistributor(copyMDDistributor);
                } else {
                    if (mdDistributorShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdDistributor = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDDistributorPropertyType) {
            final MDDistributorPropertyType target = this;
            final MDDistributorPropertyType leftObject = ((MDDistributorPropertyType) left);
            final MDDistributorPropertyType rightObject = ((MDDistributorPropertyType) right);
            {
                Boolean mdDistributorShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDDistributor(), rightObject.isSetMDDistributor());
                if (mdDistributorShouldBeMergedAndSet == Boolean.TRUE) {
                    MDDistributorType lhsMDDistributor;
                    lhsMDDistributor = leftObject.getMDDistributor();
                    MDDistributorType rhsMDDistributor;
                    rhsMDDistributor = rightObject.getMDDistributor();
                    MDDistributorType mergedMDDistributor = ((MDDistributorType) strategy.merge(LocatorUtils.property(leftLocator, "mdDistributor", lhsMDDistributor), LocatorUtils.property(rightLocator, "mdDistributor", rhsMDDistributor), lhsMDDistributor, rhsMDDistributor, leftObject.isSetMDDistributor(), rightObject.isSetMDDistributor()));
                    target.setMDDistributor(mergedMDDistributor);
                } else {
                    if (mdDistributorShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdDistributor = null;
                    }
                }
            }
            {
    ...
    public MDDistributorPropertyType withMDDistributor(MDDistributorType value) {
        setMDDistributor(value);
        return this;
    }

    public MDDistributorPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDDistributorPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDDistributorPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDDistributorPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDDistributorPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDDistributorPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDDistributorPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDDistributorPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDDistributorPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDDistributorPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDDistributorPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
