...
public class MXSupportFilePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mxSupportFile", buffer, theMXSupportFile, this.isSetMXSupportFile());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MXSupportFilePropertyType that = ((MXSupportFilePropertyType) object);
        {
            MXSupportFileType lhsMXSupportFile;
            lhsMXSupportFile = this.getMXSupportFile();
            MXSupportFileType rhsMXSupportFile;
            rhsMXSupportFile = that.getMXSupportFile();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mxSupportFile", lhsMXSupportFile), LocatorUtils.property(thatLocator, "mxSupportFile", rhsMXSupportFile), lhsMXSupportFile, rhsMXSupportFile, this.isSetMXSupportFile(), that.isSetMXSupportFile())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MXSupportFileType theMXSupportFile;
            theMXSupportFile = this.getMXSupportFile();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mxSupportFile", theMXSupportFile), currentHashCode, theMXSupportFile, this.isSetMXSupportFile());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MXSupportFilePropertyType) {
            final MXSupportFilePropertyType copy = ((MXSupportFilePropertyType) draftCopy);
            {
                Boolean mxSupportFileShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMXSupportFile());
                if (mxSupportFileShouldBeCopiedAndSet == Boolean.TRUE) {
                    MXSupportFileType sourceMXSupportFile;
                    sourceMXSupportFile = this.getMXSupportFile();
                    MXSupportFileType copyMXSupportFile = ((MXSupportFileType) strategy.copy(LocatorUtils.property(locator, "mxSupportFile", sourceMXSupportFile), sourceMXSupportFile, this.isSetMXSupportFile()));
                    copy.setMXSupportFile(copyMXSupportFile);
                } else {
                    if (mxSupportFileShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mxSupportFile = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MXSupportFilePropertyType) {
            final MXSupportFilePropertyType target = this;
            final MXSupportFilePropertyType leftObject = ((MXSupportFilePropertyType) left);
            final MXSupportFilePropertyType rightObject = ((MXSupportFilePropertyType) right);
            {
                Boolean mxSupportFileShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMXSupportFile(), rightObject.isSetMXSupportFile());
                if (mxSupportFileShouldBeMergedAndSet == Boolean.TRUE) {
                    MXSupportFileType lhsMXSupportFile;
                    lhsMXSupportFile = leftObject.getMXSupportFile();
                    MXSupportFileType rhsMXSupportFile;
                    rhsMXSupportFile = rightObject.getMXSupportFile();
                    MXSupportFileType mergedMXSupportFile = ((MXSupportFileType) strategy.merge(LocatorUtils.property(leftLocator, "mxSupportFile", lhsMXSupportFile), LocatorUtils.property(rightLocator, "mxSupportFile", rhsMXSupportFile), lhsMXSupportFile, rhsMXSupportFile, leftObject.isSetMXSupportFile(), rightObject.isSetMXSupportFile()));
                    target.setMXSupportFile(mergedMXSupportFile);
                } else {
                    if (mxSupportFileShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mxSupportFile = null;
                    }
                }
            }
            {
    ...
    public MXSupportFilePropertyType withMXSupportFile(MXSupportFileType value) {
        setMXSupportFile(value);
        return this;
    }

    public MXSupportFilePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MXSupportFilePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MXSupportFilePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MXSupportFilePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MXSupportFilePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MXSupportFilePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MXSupportFilePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MXSupportFilePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MXSupportFilePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MXSupportFilePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MXSupportFilePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
