...
public class FileNamePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final FileNamePropertyType that = ((FileNamePropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof FileNamePropertyType) {
            final FileNamePropertyType copy = ((FileNamePropertyType) draftCopy);
            {
                ...
                if (fileNameShouldBeCopiedAndSet == Boolean.TRUE) {
                    FileNameType sourceFileName;
                    sourceFileName = this.getFileName();
                    FileNameType copyFileName = ((FileNameType) strategy.copy(LocatorUtils.property(locator, "fileName", sourceFileName), sourceFileName, this.isSetFileName()));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof FileNamePropertyType) {
            final FileNamePropertyType target = this;
            final FileNamePropertyType leftObject = ((FileNamePropertyType) left);
            final FileNamePropertyType rightObject = ((FileNamePropertyType) right);
            {
                ...
                if (fileNameShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    FileNameType mergedFileName = ((FileNameType) strategy.merge(LocatorUtils.property(leftLocator, "fileName", lhsFileName), LocatorUtils.property(rightLocator, "fileName", rhsFileName), lhsFileName, rhsFileName, leftObject.isSetFileName(), rightObject.isSetFileName()));
    ...
    public FileNamePropertyType withFileName(FileNameType value) {
        setFileName(value);
        return this;
    }

    public FileNamePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public FileNamePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public FileNamePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
