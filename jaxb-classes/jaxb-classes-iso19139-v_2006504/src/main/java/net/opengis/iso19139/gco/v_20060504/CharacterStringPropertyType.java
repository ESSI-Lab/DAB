...
import net.opengis.iso19139.gmd.v_20060504.LocalisedCharacterStringType;
import net.opengis.iso19139.gmd.v_20060504.MDObligationCodeType;
import net.opengis.iso19139.gmd.v_20060504.MDPixelOrientationCodeType;
import net.opengis.iso19139.gmd.v_20060504.MDTopicCategoryCodeType;
import net.opengis.iso19139.gmd.v_20060504.PTFreeTextPropertyType;
import net.opengis.iso19139.gmx.v_20060504.AnchorType;
import net.opengis.iso19139.gmx.v_20060504.FileNameType;
import net.opengis.iso19139.gmx.v_20060504.MimeFileTypeType;
import net.opengis.iso19139.srv.v_20060504.SVOperationModelType;
import net.opengis.iso19139.srv.v_20060504.SVParameterDirectionType;
...
public class CharacterStringPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public CharacterStringPropertyType withCharacterString(JAXBElement<?> value) {
        setCharacterString(value);
        return this;
    }

    public CharacterStringPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CharacterStringPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CharacterStringPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
