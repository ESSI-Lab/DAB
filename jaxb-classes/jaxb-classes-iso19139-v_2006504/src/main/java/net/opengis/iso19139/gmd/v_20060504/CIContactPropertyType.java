...
public class CIContactPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "ciContact", buffer, theCIContact, this.isSetCIContact());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            CIContactType lhsCIContact;
            lhsCIContact = this.getCIContact();
            CIContactType rhsCIContact;
            rhsCIContact = that.getCIContact();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ciContact", lhsCIContact), LocatorUtils.property(thatLocator, "ciContact", rhsCIContact), lhsCIContact, rhsCIContact, this.isSetCIContact(), that.isSetCIContact())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            CIContactType theCIContact;
            theCIContact = this.getCIContact();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ciContact", theCIContact), currentHashCode, theCIContact, this.isSetCIContact());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CIContactPropertyType) {
            final CIContactPropertyType copy = ((CIContactPropertyType) draftCopy);
            {
                Boolean ciContactShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCIContact());
                if (ciContactShouldBeCopiedAndSet == Boolean.TRUE) {
                    CIContactType sourceCIContact;
                    sourceCIContact = this.getCIContact();
                    CIContactType copyCIContact = ((CIContactType) strategy.copy(LocatorUtils.property(locator, "ciContact", sourceCIContact), sourceCIContact, this.isSetCIContact()));
                    copy.setCIContact(copyCIContact);
                } else {
                    if (ciContactShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.ciContact = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CIContactPropertyType) {
            final CIContactPropertyType target = this;
            final CIContactPropertyType leftObject = ((CIContactPropertyType) left);
            final CIContactPropertyType rightObject = ((CIContactPropertyType) right);
            {
                Boolean ciContactShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCIContact(), rightObject.isSetCIContact());
                if (ciContactShouldBeMergedAndSet == Boolean.TRUE) {
                    CIContactType lhsCIContact;
                    lhsCIContact = leftObject.getCIContact();
                    CIContactType rhsCIContact;
                    rhsCIContact = rightObject.getCIContact();
                    CIContactType mergedCIContact = ((CIContactType) strategy.merge(LocatorUtils.property(leftLocator, "ciContact", lhsCIContact), LocatorUtils.property(rightLocator, "ciContact", rhsCIContact), lhsCIContact, rhsCIContact, leftObject.isSetCIContact(), rightObject.isSetCIContact()));
                    target.setCIContact(mergedCIContact);
                } else {
                    if (ciContactShouldBeMergedAndSet == Boolean.FALSE) {
                        target.ciContact = null;
                    }
                }
            }
            {
    ...
    public CIContactPropertyType withCIContact(CIContactType value) {
        setCIContact(value);
        return this;
    }

    public CIContactPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CIContactPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CIContactPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public CIContactPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CIContactPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CIContactPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CIContactPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CIContactPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CIContactPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CIContactPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CIContactPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
