    ...
    implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final OperationParameterAltType that = ((OperationParameterAltType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof OperationParameterAltType) {
            final OperationParameterAltType copy = ((OperationParameterAltType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof OperationParameterAltType) {
            final OperationParameterAltType target = this;
            final OperationParameterAltType leftObject = ((OperationParameterAltType) left);
            final OperationParameterAltType rightObject = ((OperationParameterAltType) right);
            {
    ...
    public OperationParameterAltType withLocale(PTLocalePropertyType value) {
        setLocale(value);
        return this;
    }

    public OperationParameterAltType withCodeSpace(String value) {
        setCodeSpace(value);
        return this;
    }
