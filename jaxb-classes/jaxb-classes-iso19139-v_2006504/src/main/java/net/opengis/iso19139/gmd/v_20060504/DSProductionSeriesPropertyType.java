...
public class DSProductionSeriesPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "dsProductionSeries", buffer, theDSProductionSeries, this.isSetDSProductionSeries());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            DSProductionSeriesType lhsDSProductionSeries;
            lhsDSProductionSeries = this.getDSProductionSeries();
            DSProductionSeriesType rhsDSProductionSeries;
            rhsDSProductionSeries = that.getDSProductionSeries();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dsProductionSeries", lhsDSProductionSeries), LocatorUtils.property(thatLocator, "dsProductionSeries", rhsDSProductionSeries), lhsDSProductionSeries, rhsDSProductionSeries, this.isSetDSProductionSeries(), that.isSetDSProductionSeries())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            DSProductionSeriesType theDSProductionSeries;
            theDSProductionSeries = this.getDSProductionSeries();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dsProductionSeries", theDSProductionSeries), currentHashCode, theDSProductionSeries, this.isSetDSProductionSeries());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DSProductionSeriesPropertyType) {
            final DSProductionSeriesPropertyType copy = ((DSProductionSeriesPropertyType) draftCopy);
            {
                Boolean dsProductionSeriesShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDSProductionSeries());
                if (dsProductionSeriesShouldBeCopiedAndSet == Boolean.TRUE) {
                    DSProductionSeriesType sourceDSProductionSeries;
                    sourceDSProductionSeries = this.getDSProductionSeries();
                    DSProductionSeriesType copyDSProductionSeries = ((DSProductionSeriesType) strategy.copy(LocatorUtils.property(locator, "dsProductionSeries", sourceDSProductionSeries), sourceDSProductionSeries, this.isSetDSProductionSeries()));
                    copy.setDSProductionSeries(copyDSProductionSeries);
                } else {
                    if (dsProductionSeriesShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.dsProductionSeries = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DSProductionSeriesPropertyType) {
            final DSProductionSeriesPropertyType target = this;
            final DSProductionSeriesPropertyType leftObject = ((DSProductionSeriesPropertyType) left);
            final DSProductionSeriesPropertyType rightObject = ((DSProductionSeriesPropertyType) right);
            {
                Boolean dsProductionSeriesShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDSProductionSeries(), rightObject.isSetDSProductionSeries());
                if (dsProductionSeriesShouldBeMergedAndSet == Boolean.TRUE) {
                    DSProductionSeriesType lhsDSProductionSeries;
                    lhsDSProductionSeries = leftObject.getDSProductionSeries();
                    DSProductionSeriesType rhsDSProductionSeries;
                    rhsDSProductionSeries = rightObject.getDSProductionSeries();
                    DSProductionSeriesType mergedDSProductionSeries = ((DSProductionSeriesType) strategy.merge(LocatorUtils.property(leftLocator, "dsProductionSeries", lhsDSProductionSeries), LocatorUtils.property(rightLocator, "dsProductionSeries", rhsDSProductionSeries), lhsDSProductionSeries, rhsDSProductionSeries, leftObject.isSetDSProductionSeries(), rightObject.isSetDSProductionSeries()));
                    target.setDSProductionSeries(mergedDSProductionSeries);
                } else {
                    if (dsProductionSeriesShouldBeMergedAndSet == Boolean.FALSE) {
                        target.dsProductionSeries = null;
                    }
                }
            }
            {
    ...
    public DSProductionSeriesPropertyType withDSProductionSeries(DSProductionSeriesType value) {
        setDSProductionSeries(value);
        return this;
    }

    public DSProductionSeriesPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DSProductionSeriesPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DSProductionSeriesPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DSProductionSeriesPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DSProductionSeriesPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DSProductionSeriesPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DSProductionSeriesPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DSProductionSeriesPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DSProductionSeriesPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DSProductionSeriesPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DSProductionSeriesPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
