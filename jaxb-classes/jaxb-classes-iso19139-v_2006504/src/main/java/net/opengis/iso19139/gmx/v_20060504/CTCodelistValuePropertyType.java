...
public class CTCodelistValuePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "codeDefinition", buffer, theCodeDefinition, this.isSetCodeDefinition());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CTCodelistValuePropertyType that = ((CTCodelistValuePropertyType) object);
        {
            JAXBElement<? extends CodeDefinitionType> lhsCodeDefinition;
            lhsCodeDefinition = this.getCodeDefinition();
            JAXBElement<? extends CodeDefinitionType> rhsCodeDefinition;
            rhsCodeDefinition = that.getCodeDefinition();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "codeDefinition", lhsCodeDefinition), LocatorUtils.property(thatLocator, "codeDefinition", rhsCodeDefinition), lhsCodeDefinition, rhsCodeDefinition, this.isSetCodeDefinition(), that.isSetCodeDefinition())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends CodeDefinitionType> theCodeDefinition;
            theCodeDefinition = this.getCodeDefinition();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "codeDefinition", theCodeDefinition), currentHashCode, theCodeDefinition, this.isSetCodeDefinition());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CTCodelistValuePropertyType) {
            final CTCodelistValuePropertyType copy = ((CTCodelistValuePropertyType) draftCopy);
            {
                Boolean codeDefinitionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCodeDefinition());
                if (codeDefinitionShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends CodeDefinitionType> sourceCodeDefinition;
                    sourceCodeDefinition = this.getCodeDefinition();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends CodeDefinitionType> copyCodeDefinition = ((JAXBElement<? extends CodeDefinitionType> ) strategy.copy(LocatorUtils.property(locator, "codeDefinition", sourceCodeDefinition), sourceCodeDefinition, this.isSetCodeDefinition()));
                    copy.setCodeDefinition(copyCodeDefinition);
                } else {
                    if (codeDefinitionShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.codeDefinition = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CTCodelistValuePropertyType) {
            final CTCodelistValuePropertyType target = this;
            final CTCodelistValuePropertyType leftObject = ((CTCodelistValuePropertyType) left);
            final CTCodelistValuePropertyType rightObject = ((CTCodelistValuePropertyType) right);
            {
                Boolean codeDefinitionShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCodeDefinition(), rightObject.isSetCodeDefinition());
                if (codeDefinitionShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends CodeDefinitionType> lhsCodeDefinition;
                    lhsCodeDefinition = leftObject.getCodeDefinition();
                    JAXBElement<? extends CodeDefinitionType> rhsCodeDefinition;
                    rhsCodeDefinition = rightObject.getCodeDefinition();
                    JAXBElement<? extends CodeDefinitionType> mergedCodeDefinition = ((JAXBElement<? extends CodeDefinitionType> ) strategy.merge(LocatorUtils.property(leftLocator, "codeDefinition", lhsCodeDefinition), LocatorUtils.property(rightLocator, "codeDefinition", rhsCodeDefinition), lhsCodeDefinition, rhsCodeDefinition, leftObject.isSetCodeDefinition(), rightObject.isSetCodeDefinition()));
                    target.setCodeDefinition(mergedCodeDefinition);
                } else {
                    if (codeDefinitionShouldBeMergedAndSet == Boolean.FALSE) {
                        target.codeDefinition = null;
                    }
                }
            }
            {
    ...
    public CTCodelistValuePropertyType withCodeDefinition(JAXBElement<? extends CodeDefinitionType> value) {
        setCodeDefinition(value);
        return this;
    }

    public CTCodelistValuePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CTCodelistValuePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CTCodelistValuePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public CTCodelistValuePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CTCodelistValuePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CTCodelistValuePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CTCodelistValuePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CTCodelistValuePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CTCodelistValuePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CTCodelistValuePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CTCodelistValuePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
