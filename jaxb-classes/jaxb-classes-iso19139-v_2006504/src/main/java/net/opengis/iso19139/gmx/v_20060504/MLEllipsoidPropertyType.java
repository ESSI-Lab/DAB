...
public class MLEllipsoidPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlEllipsoid", buffer, theMLEllipsoid, this.isSetMLEllipsoid());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLEllipsoidPropertyType that = ((MLEllipsoidPropertyType) object);
        {
            MLEllipsoidType lhsMLEllipsoid;
            lhsMLEllipsoid = this.getMLEllipsoid();
            MLEllipsoidType rhsMLEllipsoid;
            rhsMLEllipsoid = that.getMLEllipsoid();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlEllipsoid", lhsMLEllipsoid), LocatorUtils.property(thatLocator, "mlEllipsoid", rhsMLEllipsoid), lhsMLEllipsoid, rhsMLEllipsoid, this.isSetMLEllipsoid(), that.isSetMLEllipsoid())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLEllipsoidType theMLEllipsoid;
            theMLEllipsoid = this.getMLEllipsoid();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlEllipsoid", theMLEllipsoid), currentHashCode, theMLEllipsoid, this.isSetMLEllipsoid());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLEllipsoidPropertyType) {
            final MLEllipsoidPropertyType copy = ((MLEllipsoidPropertyType) draftCopy);
            {
                Boolean mlEllipsoidShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLEllipsoid());
                if (mlEllipsoidShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLEllipsoidType sourceMLEllipsoid;
                    sourceMLEllipsoid = this.getMLEllipsoid();
                    MLEllipsoidType copyMLEllipsoid = ((MLEllipsoidType) strategy.copy(LocatorUtils.property(locator, "mlEllipsoid", sourceMLEllipsoid), sourceMLEllipsoid, this.isSetMLEllipsoid()));
                    copy.setMLEllipsoid(copyMLEllipsoid);
                } else {
                    if (mlEllipsoidShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlEllipsoid = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLEllipsoidPropertyType) {
            final MLEllipsoidPropertyType target = this;
            final MLEllipsoidPropertyType leftObject = ((MLEllipsoidPropertyType) left);
            final MLEllipsoidPropertyType rightObject = ((MLEllipsoidPropertyType) right);
            {
                Boolean mlEllipsoidShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLEllipsoid(), rightObject.isSetMLEllipsoid());
                if (mlEllipsoidShouldBeMergedAndSet == Boolean.TRUE) {
                    MLEllipsoidType lhsMLEllipsoid;
                    lhsMLEllipsoid = leftObject.getMLEllipsoid();
                    MLEllipsoidType rhsMLEllipsoid;
                    rhsMLEllipsoid = rightObject.getMLEllipsoid();
                    MLEllipsoidType mergedMLEllipsoid = ((MLEllipsoidType) strategy.merge(LocatorUtils.property(leftLocator, "mlEllipsoid", lhsMLEllipsoid), LocatorUtils.property(rightLocator, "mlEllipsoid", rhsMLEllipsoid), lhsMLEllipsoid, rhsMLEllipsoid, leftObject.isSetMLEllipsoid(), rightObject.isSetMLEllipsoid()));
                    target.setMLEllipsoid(mergedMLEllipsoid);
                } else {
                    if (mlEllipsoidShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlEllipsoid = null;
                    }
                }
            }
            {
    ...
    public MLEllipsoidPropertyType withMLEllipsoid(MLEllipsoidType value) {
        setMLEllipsoid(value);
        return this;
    }

    public MLEllipsoidPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLEllipsoidPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLEllipsoidPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLEllipsoidPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLEllipsoidPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLEllipsoidPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLEllipsoidPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLEllipsoidPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLEllipsoidPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLEllipsoidPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLEllipsoidPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
