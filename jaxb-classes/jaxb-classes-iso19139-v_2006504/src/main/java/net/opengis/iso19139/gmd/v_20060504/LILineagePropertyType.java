...
public class LILineagePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "liLineage", buffer, theLILineage, this.isSetLILineage());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            LILineageType lhsLILineage;
            lhsLILineage = this.getLILineage();
            LILineageType rhsLILineage;
            rhsLILineage = that.getLILineage();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "liLineage", lhsLILineage), LocatorUtils.property(thatLocator, "liLineage", rhsLILineage), lhsLILineage, rhsLILineage, this.isSetLILineage(), that.isSetLILineage())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            LILineageType theLILineage;
            theLILineage = this.getLILineage();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "liLineage", theLILineage), currentHashCode, theLILineage, this.isSetLILineage());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof LILineagePropertyType) {
            final LILineagePropertyType copy = ((LILineagePropertyType) draftCopy);
            {
                Boolean liLineageShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetLILineage());
                if (liLineageShouldBeCopiedAndSet == Boolean.TRUE) {
                    LILineageType sourceLILineage;
                    sourceLILineage = this.getLILineage();
                    LILineageType copyLILineage = ((LILineageType) strategy.copy(LocatorUtils.property(locator, "liLineage", sourceLILineage), sourceLILineage, this.isSetLILineage()));
                    copy.setLILineage(copyLILineage);
                } else {
                    if (liLineageShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.liLineage = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof LILineagePropertyType) {
            final LILineagePropertyType target = this;
            final LILineagePropertyType leftObject = ((LILineagePropertyType) left);
            final LILineagePropertyType rightObject = ((LILineagePropertyType) right);
            {
                Boolean liLineageShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetLILineage(), rightObject.isSetLILineage());
                if (liLineageShouldBeMergedAndSet == Boolean.TRUE) {
                    LILineageType lhsLILineage;
                    lhsLILineage = leftObject.getLILineage();
                    LILineageType rhsLILineage;
                    rhsLILineage = rightObject.getLILineage();
                    LILineageType mergedLILineage = ((LILineageType) strategy.merge(LocatorUtils.property(leftLocator, "liLineage", lhsLILineage), LocatorUtils.property(rightLocator, "liLineage", rhsLILineage), lhsLILineage, rhsLILineage, leftObject.isSetLILineage(), rightObject.isSetLILineage()));
                    target.setLILineage(mergedLILineage);
                } else {
                    if (liLineageShouldBeMergedAndSet == Boolean.FALSE) {
                        target.liLineage = null;
                    }
                }
            }
            {
    ...
    public LILineagePropertyType withLILineage(LILineageType value) {
        setLILineage(value);
        return this;
    }

    public LILineagePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public LILineagePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public LILineagePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public LILineagePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public LILineagePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public LILineagePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public LILineagePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public LILineagePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public LILineagePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public LILineagePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public LILineagePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
