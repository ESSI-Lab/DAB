...
public class MLTimeCSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlTimeCS", buffer, theMLTimeCS, this.isSetMLTimeCS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLTimeCSPropertyType that = ((MLTimeCSPropertyType) object);
        {
            MLTimeCSType lhsMLTimeCS;
            lhsMLTimeCS = this.getMLTimeCS();
            MLTimeCSType rhsMLTimeCS;
            rhsMLTimeCS = that.getMLTimeCS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlTimeCS", lhsMLTimeCS), LocatorUtils.property(thatLocator, "mlTimeCS", rhsMLTimeCS), lhsMLTimeCS, rhsMLTimeCS, this.isSetMLTimeCS(), that.isSetMLTimeCS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLTimeCSType theMLTimeCS;
            theMLTimeCS = this.getMLTimeCS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlTimeCS", theMLTimeCS), currentHashCode, theMLTimeCS, this.isSetMLTimeCS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLTimeCSPropertyType) {
            final MLTimeCSPropertyType copy = ((MLTimeCSPropertyType) draftCopy);
            {
                Boolean mlTimeCSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLTimeCS());
                if (mlTimeCSShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLTimeCSType sourceMLTimeCS;
                    sourceMLTimeCS = this.getMLTimeCS();
                    MLTimeCSType copyMLTimeCS = ((MLTimeCSType) strategy.copy(LocatorUtils.property(locator, "mlTimeCS", sourceMLTimeCS), sourceMLTimeCS, this.isSetMLTimeCS()));
                    copy.setMLTimeCS(copyMLTimeCS);
                } else {
                    if (mlTimeCSShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlTimeCS = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLTimeCSPropertyType) {
            final MLTimeCSPropertyType target = this;
            final MLTimeCSPropertyType leftObject = ((MLTimeCSPropertyType) left);
            final MLTimeCSPropertyType rightObject = ((MLTimeCSPropertyType) right);
            {
                Boolean mlTimeCSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLTimeCS(), rightObject.isSetMLTimeCS());
                if (mlTimeCSShouldBeMergedAndSet == Boolean.TRUE) {
                    MLTimeCSType lhsMLTimeCS;
                    lhsMLTimeCS = leftObject.getMLTimeCS();
                    MLTimeCSType rhsMLTimeCS;
                    rhsMLTimeCS = rightObject.getMLTimeCS();
                    MLTimeCSType mergedMLTimeCS = ((MLTimeCSType) strategy.merge(LocatorUtils.property(leftLocator, "mlTimeCS", lhsMLTimeCS), LocatorUtils.property(rightLocator, "mlTimeCS", rhsMLTimeCS), lhsMLTimeCS, rhsMLTimeCS, leftObject.isSetMLTimeCS(), rightObject.isSetMLTimeCS()));
                    target.setMLTimeCS(mergedMLTimeCS);
                } else {
                    if (mlTimeCSShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlTimeCS = null;
                    }
                }
            }
            {
    ...
    public MLTimeCSPropertyType withMLTimeCS(MLTimeCSType value) {
        setMLTimeCS(value);
        return this;
    }

    public MLTimeCSPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLTimeCSPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLTimeCSPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLTimeCSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLTimeCSPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLTimeCSPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLTimeCSPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLTimeCSPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLTimeCSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLTimeCSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLTimeCSPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
