...
public class PrimeMeridianAltPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "primeMeridianAlt", buffer, thePrimeMeridianAlt, this.isSetPrimeMeridianAlt());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PrimeMeridianAltPropertyType that = ((PrimeMeridianAltPropertyType) object);
        {
            PrimeMeridianAltType lhsPrimeMeridianAlt;
            lhsPrimeMeridianAlt = this.getPrimeMeridianAlt();
            PrimeMeridianAltType rhsPrimeMeridianAlt;
            rhsPrimeMeridianAlt = that.getPrimeMeridianAlt();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "primeMeridianAlt", lhsPrimeMeridianAlt), LocatorUtils.property(thatLocator, "primeMeridianAlt", rhsPrimeMeridianAlt), lhsPrimeMeridianAlt, rhsPrimeMeridianAlt, this.isSetPrimeMeridianAlt(), that.isSetPrimeMeridianAlt())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            PrimeMeridianAltType thePrimeMeridianAlt;
            thePrimeMeridianAlt = this.getPrimeMeridianAlt();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "primeMeridianAlt", thePrimeMeridianAlt), currentHashCode, thePrimeMeridianAlt, this.isSetPrimeMeridianAlt());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof PrimeMeridianAltPropertyType) {
            final PrimeMeridianAltPropertyType copy = ((PrimeMeridianAltPropertyType) draftCopy);
            {
                Boolean primeMeridianAltShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetPrimeMeridianAlt());
                if (primeMeridianAltShouldBeCopiedAndSet == Boolean.TRUE) {
                    PrimeMeridianAltType sourcePrimeMeridianAlt;
                    sourcePrimeMeridianAlt = this.getPrimeMeridianAlt();
                    PrimeMeridianAltType copyPrimeMeridianAlt = ((PrimeMeridianAltType) strategy.copy(LocatorUtils.property(locator, "primeMeridianAlt", sourcePrimeMeridianAlt), sourcePrimeMeridianAlt, this.isSetPrimeMeridianAlt()));
                    copy.setPrimeMeridianAlt(copyPrimeMeridianAlt);
                } else {
                    if (primeMeridianAltShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.primeMeridianAlt = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof PrimeMeridianAltPropertyType) {
            final PrimeMeridianAltPropertyType target = this;
            final PrimeMeridianAltPropertyType leftObject = ((PrimeMeridianAltPropertyType) left);
            final PrimeMeridianAltPropertyType rightObject = ((PrimeMeridianAltPropertyType) right);
            {
                Boolean primeMeridianAltShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetPrimeMeridianAlt(), rightObject.isSetPrimeMeridianAlt());
                if (primeMeridianAltShouldBeMergedAndSet == Boolean.TRUE) {
                    PrimeMeridianAltType lhsPrimeMeridianAlt;
                    lhsPrimeMeridianAlt = leftObject.getPrimeMeridianAlt();
                    PrimeMeridianAltType rhsPrimeMeridianAlt;
                    rhsPrimeMeridianAlt = rightObject.getPrimeMeridianAlt();
                    PrimeMeridianAltType mergedPrimeMeridianAlt = ((PrimeMeridianAltType) strategy.merge(LocatorUtils.property(leftLocator, "primeMeridianAlt", lhsPrimeMeridianAlt), LocatorUtils.property(rightLocator, "primeMeridianAlt", rhsPrimeMeridianAlt), lhsPrimeMeridianAlt, rhsPrimeMeridianAlt, leftObject.isSetPrimeMeridianAlt(), rightObject.isSetPrimeMeridianAlt()));
                    target.setPrimeMeridianAlt(mergedPrimeMeridianAlt);
                } else {
                    if (primeMeridianAltShouldBeMergedAndSet == Boolean.FALSE) {
                        target.primeMeridianAlt = null;
                    }
                }
            }
            {
    ...
    public PrimeMeridianAltPropertyType withPrimeMeridianAlt(PrimeMeridianAltType value) {
        setPrimeMeridianAlt(value);
        return this;
    }

    public PrimeMeridianAltPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public PrimeMeridianAltPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public PrimeMeridianAltPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public PrimeMeridianAltPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public PrimeMeridianAltPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public PrimeMeridianAltPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public PrimeMeridianAltPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public PrimeMeridianAltPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public PrimeMeridianAltPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public PrimeMeridianAltPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public PrimeMeridianAltPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
