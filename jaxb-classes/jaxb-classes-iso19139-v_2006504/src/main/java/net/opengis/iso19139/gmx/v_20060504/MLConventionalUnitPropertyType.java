...
public class MLConventionalUnitPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlConventionalUnit", buffer, theMLConventionalUnit, this.isSetMLConventionalUnit());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLConventionalUnitPropertyType that = ((MLConventionalUnitPropertyType) object);
        {
            MLConventionalUnitType lhsMLConventionalUnit;
            lhsMLConventionalUnit = this.getMLConventionalUnit();
            MLConventionalUnitType rhsMLConventionalUnit;
            rhsMLConventionalUnit = that.getMLConventionalUnit();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlConventionalUnit", lhsMLConventionalUnit), LocatorUtils.property(thatLocator, "mlConventionalUnit", rhsMLConventionalUnit), lhsMLConventionalUnit, rhsMLConventionalUnit, this.isSetMLConventionalUnit(), that.isSetMLConventionalUnit())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLConventionalUnitType theMLConventionalUnit;
            theMLConventionalUnit = this.getMLConventionalUnit();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlConventionalUnit", theMLConventionalUnit), currentHashCode, theMLConventionalUnit, this.isSetMLConventionalUnit());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLConventionalUnitPropertyType) {
            final MLConventionalUnitPropertyType copy = ((MLConventionalUnitPropertyType) draftCopy);
            {
                Boolean mlConventionalUnitShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLConventionalUnit());
                if (mlConventionalUnitShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLConventionalUnitType sourceMLConventionalUnit;
                    sourceMLConventionalUnit = this.getMLConventionalUnit();
                    MLConventionalUnitType copyMLConventionalUnit = ((MLConventionalUnitType) strategy.copy(LocatorUtils.property(locator, "mlConventionalUnit", sourceMLConventionalUnit), sourceMLConventionalUnit, this.isSetMLConventionalUnit()));
                    copy.setMLConventionalUnit(copyMLConventionalUnit);
                } else {
                    if (mlConventionalUnitShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlConventionalUnit = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLConventionalUnitPropertyType) {
            final MLConventionalUnitPropertyType target = this;
            final MLConventionalUnitPropertyType leftObject = ((MLConventionalUnitPropertyType) left);
            final MLConventionalUnitPropertyType rightObject = ((MLConventionalUnitPropertyType) right);
            {
                Boolean mlConventionalUnitShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLConventionalUnit(), rightObject.isSetMLConventionalUnit());
                if (mlConventionalUnitShouldBeMergedAndSet == Boolean.TRUE) {
                    MLConventionalUnitType lhsMLConventionalUnit;
                    lhsMLConventionalUnit = leftObject.getMLConventionalUnit();
                    MLConventionalUnitType rhsMLConventionalUnit;
                    rhsMLConventionalUnit = rightObject.getMLConventionalUnit();
                    MLConventionalUnitType mergedMLConventionalUnit = ((MLConventionalUnitType) strategy.merge(LocatorUtils.property(leftLocator, "mlConventionalUnit", lhsMLConventionalUnit), LocatorUtils.property(rightLocator, "mlConventionalUnit", rhsMLConventionalUnit), lhsMLConventionalUnit, rhsMLConventionalUnit, leftObject.isSetMLConventionalUnit(), rightObject.isSetMLConventionalUnit()));
                    target.setMLConventionalUnit(mergedMLConventionalUnit);
                } else {
                    if (mlConventionalUnitShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlConventionalUnit = null;
                    }
                }
            }
            {
    ...
    public MLConventionalUnitPropertyType withMLConventionalUnit(MLConventionalUnitType value) {
        setMLConventionalUnit(value);
        return this;
    }

    public MLConventionalUnitPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLConventionalUnitPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLConventionalUnitPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLConventionalUnitPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLConventionalUnitPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLConventionalUnitPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLConventionalUnitPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLConventionalUnitPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLConventionalUnitPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLConventionalUnitPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLConventionalUnitPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
