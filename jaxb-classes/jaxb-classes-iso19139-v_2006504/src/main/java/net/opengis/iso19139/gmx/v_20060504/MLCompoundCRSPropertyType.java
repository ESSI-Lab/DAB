...
public class MLCompoundCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlCompoundCRS", buffer, theMLCompoundCRS, this.isSetMLCompoundCRS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLCompoundCRSPropertyType that = ((MLCompoundCRSPropertyType) object);
        {
            MLCompoundCRSType lhsMLCompoundCRS;
            lhsMLCompoundCRS = this.getMLCompoundCRS();
            MLCompoundCRSType rhsMLCompoundCRS;
            rhsMLCompoundCRS = that.getMLCompoundCRS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlCompoundCRS", lhsMLCompoundCRS), LocatorUtils.property(thatLocator, "mlCompoundCRS", rhsMLCompoundCRS), lhsMLCompoundCRS, rhsMLCompoundCRS, this.isSetMLCompoundCRS(), that.isSetMLCompoundCRS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLCompoundCRSType theMLCompoundCRS;
            theMLCompoundCRS = this.getMLCompoundCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlCompoundCRS", theMLCompoundCRS), currentHashCode, theMLCompoundCRS, this.isSetMLCompoundCRS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLCompoundCRSPropertyType) {
            final MLCompoundCRSPropertyType copy = ((MLCompoundCRSPropertyType) draftCopy);
            {
                Boolean mlCompoundCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLCompoundCRS());
                if (mlCompoundCRSShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLCompoundCRSType sourceMLCompoundCRS;
                    sourceMLCompoundCRS = this.getMLCompoundCRS();
                    MLCompoundCRSType copyMLCompoundCRS = ((MLCompoundCRSType) strategy.copy(LocatorUtils.property(locator, "mlCompoundCRS", sourceMLCompoundCRS), sourceMLCompoundCRS, this.isSetMLCompoundCRS()));
                    copy.setMLCompoundCRS(copyMLCompoundCRS);
                } else {
                    if (mlCompoundCRSShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlCompoundCRS = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLCompoundCRSPropertyType) {
            final MLCompoundCRSPropertyType target = this;
            final MLCompoundCRSPropertyType leftObject = ((MLCompoundCRSPropertyType) left);
            final MLCompoundCRSPropertyType rightObject = ((MLCompoundCRSPropertyType) right);
            {
                Boolean mlCompoundCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLCompoundCRS(), rightObject.isSetMLCompoundCRS());
                if (mlCompoundCRSShouldBeMergedAndSet == Boolean.TRUE) {
                    MLCompoundCRSType lhsMLCompoundCRS;
                    lhsMLCompoundCRS = leftObject.getMLCompoundCRS();
                    MLCompoundCRSType rhsMLCompoundCRS;
                    rhsMLCompoundCRS = rightObject.getMLCompoundCRS();
                    MLCompoundCRSType mergedMLCompoundCRS = ((MLCompoundCRSType) strategy.merge(LocatorUtils.property(leftLocator, "mlCompoundCRS", lhsMLCompoundCRS), LocatorUtils.property(rightLocator, "mlCompoundCRS", rhsMLCompoundCRS), lhsMLCompoundCRS, rhsMLCompoundCRS, leftObject.isSetMLCompoundCRS(), rightObject.isSetMLCompoundCRS()));
                    target.setMLCompoundCRS(mergedMLCompoundCRS);
                } else {
                    if (mlCompoundCRSShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlCompoundCRS = null;
                    }
                }
            }
            {
    ...
    public MLCompoundCRSPropertyType withMLCompoundCRS(MLCompoundCRSType value) {
        setMLCompoundCRS(value);
        return this;
    }

    public MLCompoundCRSPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLCompoundCRSPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLCompoundCRSPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLCompoundCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLCompoundCRSPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLCompoundCRSPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLCompoundCRSPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLCompoundCRSPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLCompoundCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLCompoundCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLCompoundCRSPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
