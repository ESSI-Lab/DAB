...
public class MLTemporalDatumPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlTemporalDatum", buffer, theMLTemporalDatum, this.isSetMLTemporalDatum());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLTemporalDatumPropertyType that = ((MLTemporalDatumPropertyType) object);
        {
            MLTemporalDatumType lhsMLTemporalDatum;
            lhsMLTemporalDatum = this.getMLTemporalDatum();
            MLTemporalDatumType rhsMLTemporalDatum;
            rhsMLTemporalDatum = that.getMLTemporalDatum();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlTemporalDatum", lhsMLTemporalDatum), LocatorUtils.property(thatLocator, "mlTemporalDatum", rhsMLTemporalDatum), lhsMLTemporalDatum, rhsMLTemporalDatum, this.isSetMLTemporalDatum(), that.isSetMLTemporalDatum())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLTemporalDatumType theMLTemporalDatum;
            theMLTemporalDatum = this.getMLTemporalDatum();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlTemporalDatum", theMLTemporalDatum), currentHashCode, theMLTemporalDatum, this.isSetMLTemporalDatum());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLTemporalDatumPropertyType) {
            final MLTemporalDatumPropertyType copy = ((MLTemporalDatumPropertyType) draftCopy);
            {
                Boolean mlTemporalDatumShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLTemporalDatum());
                if (mlTemporalDatumShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLTemporalDatumType sourceMLTemporalDatum;
                    sourceMLTemporalDatum = this.getMLTemporalDatum();
                    MLTemporalDatumType copyMLTemporalDatum = ((MLTemporalDatumType) strategy.copy(LocatorUtils.property(locator, "mlTemporalDatum", sourceMLTemporalDatum), sourceMLTemporalDatum, this.isSetMLTemporalDatum()));
                    copy.setMLTemporalDatum(copyMLTemporalDatum);
                } else {
                    if (mlTemporalDatumShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlTemporalDatum = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLTemporalDatumPropertyType) {
            final MLTemporalDatumPropertyType target = this;
            final MLTemporalDatumPropertyType leftObject = ((MLTemporalDatumPropertyType) left);
            final MLTemporalDatumPropertyType rightObject = ((MLTemporalDatumPropertyType) right);
            {
                Boolean mlTemporalDatumShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLTemporalDatum(), rightObject.isSetMLTemporalDatum());
                if (mlTemporalDatumShouldBeMergedAndSet == Boolean.TRUE) {
                    MLTemporalDatumType lhsMLTemporalDatum;
                    lhsMLTemporalDatum = leftObject.getMLTemporalDatum();
                    MLTemporalDatumType rhsMLTemporalDatum;
                    rhsMLTemporalDatum = rightObject.getMLTemporalDatum();
                    MLTemporalDatumType mergedMLTemporalDatum = ((MLTemporalDatumType) strategy.merge(LocatorUtils.property(leftLocator, "mlTemporalDatum", lhsMLTemporalDatum), LocatorUtils.property(rightLocator, "mlTemporalDatum", rhsMLTemporalDatum), lhsMLTemporalDatum, rhsMLTemporalDatum, leftObject.isSetMLTemporalDatum(), rightObject.isSetMLTemporalDatum()));
                    target.setMLTemporalDatum(mergedMLTemporalDatum);
                } else {
                    if (mlTemporalDatumShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlTemporalDatum = null;
                    }
                }
            }
            {
    ...
    public MLTemporalDatumPropertyType withMLTemporalDatum(MLTemporalDatumType value) {
        setMLTemporalDatum(value);
        return this;
    }

    public MLTemporalDatumPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLTemporalDatumPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLTemporalDatumPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLTemporalDatumPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLTemporalDatumPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLTemporalDatumPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLTemporalDatumPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLTemporalDatumPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLTemporalDatumPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLTemporalDatumPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLTemporalDatumPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
