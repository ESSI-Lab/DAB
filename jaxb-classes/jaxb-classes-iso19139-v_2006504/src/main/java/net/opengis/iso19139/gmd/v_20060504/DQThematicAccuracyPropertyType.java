...
public class DQThematicAccuracyPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "abstractDQThematicAccuracy", buffer, theAbstractDQThematicAccuracy, this.isSetAbstractDQThematicAccuracy());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<? extends AbstractDQThematicAccuracyType> lhsAbstractDQThematicAccuracy;
            lhsAbstractDQThematicAccuracy = this.getAbstractDQThematicAccuracy();
            JAXBElement<? extends AbstractDQThematicAccuracyType> rhsAbstractDQThematicAccuracy;
            rhsAbstractDQThematicAccuracy = that.getAbstractDQThematicAccuracy();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractDQThematicAccuracy", lhsAbstractDQThematicAccuracy), LocatorUtils.property(thatLocator, "abstractDQThematicAccuracy", rhsAbstractDQThematicAccuracy), lhsAbstractDQThematicAccuracy, rhsAbstractDQThematicAccuracy, this.isSetAbstractDQThematicAccuracy(), that.isSetAbstractDQThematicAccuracy())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractDQThematicAccuracyType> theAbstractDQThematicAccuracy;
            theAbstractDQThematicAccuracy = this.getAbstractDQThematicAccuracy();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractDQThematicAccuracy", theAbstractDQThematicAccuracy), currentHashCode, theAbstractDQThematicAccuracy, this.isSetAbstractDQThematicAccuracy());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DQThematicAccuracyPropertyType) {
            final DQThematicAccuracyPropertyType copy = ((DQThematicAccuracyPropertyType) draftCopy);
            {
                Boolean abstractDQThematicAccuracyShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractDQThematicAccuracy());
                if (abstractDQThematicAccuracyShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractDQThematicAccuracyType> sourceAbstractDQThematicAccuracy;
                    sourceAbstractDQThematicAccuracy = this.getAbstractDQThematicAccuracy();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractDQThematicAccuracyType> copyAbstractDQThematicAccuracy = ((JAXBElement<? extends AbstractDQThematicAccuracyType> ) strategy.copy(LocatorUtils.property(locator, "abstractDQThematicAccuracy", sourceAbstractDQThematicAccuracy), sourceAbstractDQThematicAccuracy, this.isSetAbstractDQThematicAccuracy()));
                    copy.setAbstractDQThematicAccuracy(copyAbstractDQThematicAccuracy);
                } else {
                    if (abstractDQThematicAccuracyShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.abstractDQThematicAccuracy = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DQThematicAccuracyPropertyType) {
            final DQThematicAccuracyPropertyType target = this;
            final DQThematicAccuracyPropertyType leftObject = ((DQThematicAccuracyPropertyType) left);
            final DQThematicAccuracyPropertyType rightObject = ((DQThematicAccuracyPropertyType) right);
            {
                Boolean abstractDQThematicAccuracyShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractDQThematicAccuracy(), rightObject.isSetAbstractDQThematicAccuracy());
                if (abstractDQThematicAccuracyShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractDQThematicAccuracyType> lhsAbstractDQThematicAccuracy;
                    lhsAbstractDQThematicAccuracy = leftObject.getAbstractDQThematicAccuracy();
                    JAXBElement<? extends AbstractDQThematicAccuracyType> rhsAbstractDQThematicAccuracy;
                    rhsAbstractDQThematicAccuracy = rightObject.getAbstractDQThematicAccuracy();
                    JAXBElement<? extends AbstractDQThematicAccuracyType> mergedAbstractDQThematicAccuracy = ((JAXBElement<? extends AbstractDQThematicAccuracyType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractDQThematicAccuracy", lhsAbstractDQThematicAccuracy), LocatorUtils.property(rightLocator, "abstractDQThematicAccuracy", rhsAbstractDQThematicAccuracy), lhsAbstractDQThematicAccuracy, rhsAbstractDQThematicAccuracy, leftObject.isSetAbstractDQThematicAccuracy(), rightObject.isSetAbstractDQThematicAccuracy()));
                    target.setAbstractDQThematicAccuracy(mergedAbstractDQThematicAccuracy);
                } else {
                    if (abstractDQThematicAccuracyShouldBeMergedAndSet == Boolean.FALSE) {
                        target.abstractDQThematicAccuracy = null;
                    }
                }
            }
            {
    ...
    public DQThematicAccuracyPropertyType withAbstractDQThematicAccuracy(JAXBElement<? extends AbstractDQThematicAccuracyType> value) {
        setAbstractDQThematicAccuracy(value);
        return this;
    }

    public DQThematicAccuracyPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DQThematicAccuracyPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DQThematicAccuracyPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DQThematicAccuracyPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DQThematicAccuracyPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DQThematicAccuracyPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DQThematicAccuracyPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DQThematicAccuracyPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DQThematicAccuracyPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DQThematicAccuracyPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DQThematicAccuracyPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
