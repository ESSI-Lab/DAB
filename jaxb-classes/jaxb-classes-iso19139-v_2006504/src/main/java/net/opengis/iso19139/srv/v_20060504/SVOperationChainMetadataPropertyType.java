...
public class SVOperationChainMetadataPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "svOperationChainMetadata", buffer, theSVOperationChainMetadata, this.isSetSVOperationChainMetadata());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SVOperationChainMetadataPropertyType that = ((SVOperationChainMetadataPropertyType) object);
        {
            SVOperationChainMetadataType lhsSVOperationChainMetadata;
            lhsSVOperationChainMetadata = this.getSVOperationChainMetadata();
            SVOperationChainMetadataType rhsSVOperationChainMetadata;
            rhsSVOperationChainMetadata = that.getSVOperationChainMetadata();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "svOperationChainMetadata", lhsSVOperationChainMetadata), LocatorUtils.property(thatLocator, "svOperationChainMetadata", rhsSVOperationChainMetadata), lhsSVOperationChainMetadata, rhsSVOperationChainMetadata, this.isSetSVOperationChainMetadata(), that.isSetSVOperationChainMetadata())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            SVOperationChainMetadataType theSVOperationChainMetadata;
            theSVOperationChainMetadata = this.getSVOperationChainMetadata();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "svOperationChainMetadata", theSVOperationChainMetadata), currentHashCode, theSVOperationChainMetadata, this.isSetSVOperationChainMetadata());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SVOperationChainMetadataPropertyType) {
            final SVOperationChainMetadataPropertyType copy = ((SVOperationChainMetadataPropertyType) draftCopy);
            {
                Boolean svOperationChainMetadataShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSVOperationChainMetadata());
                if (svOperationChainMetadataShouldBeCopiedAndSet == Boolean.TRUE) {
                    SVOperationChainMetadataType sourceSVOperationChainMetadata;
                    sourceSVOperationChainMetadata = this.getSVOperationChainMetadata();
                    SVOperationChainMetadataType copySVOperationChainMetadata = ((SVOperationChainMetadataType) strategy.copy(LocatorUtils.property(locator, "svOperationChainMetadata", sourceSVOperationChainMetadata), sourceSVOperationChainMetadata, this.isSetSVOperationChainMetadata()));
                    copy.setSVOperationChainMetadata(copySVOperationChainMetadata);
                } else {
                    if (svOperationChainMetadataShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.svOperationChainMetadata = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SVOperationChainMetadataPropertyType) {
            final SVOperationChainMetadataPropertyType target = this;
            final SVOperationChainMetadataPropertyType leftObject = ((SVOperationChainMetadataPropertyType) left);
            final SVOperationChainMetadataPropertyType rightObject = ((SVOperationChainMetadataPropertyType) right);
            {
                Boolean svOperationChainMetadataShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSVOperationChainMetadata(), rightObject.isSetSVOperationChainMetadata());
                if (svOperationChainMetadataShouldBeMergedAndSet == Boolean.TRUE) {
                    SVOperationChainMetadataType lhsSVOperationChainMetadata;
                    lhsSVOperationChainMetadata = leftObject.getSVOperationChainMetadata();
                    SVOperationChainMetadataType rhsSVOperationChainMetadata;
                    rhsSVOperationChainMetadata = rightObject.getSVOperationChainMetadata();
                    SVOperationChainMetadataType mergedSVOperationChainMetadata = ((SVOperationChainMetadataType) strategy.merge(LocatorUtils.property(leftLocator, "svOperationChainMetadata", lhsSVOperationChainMetadata), LocatorUtils.property(rightLocator, "svOperationChainMetadata", rhsSVOperationChainMetadata), lhsSVOperationChainMetadata, rhsSVOperationChainMetadata, leftObject.isSetSVOperationChainMetadata(), rightObject.isSetSVOperationChainMetadata()));
                    target.setSVOperationChainMetadata(mergedSVOperationChainMetadata);
                } else {
                    if (svOperationChainMetadataShouldBeMergedAndSet == Boolean.FALSE) {
                        target.svOperationChainMetadata = null;
                    }
                }
            }
            {
    ...
    public SVOperationChainMetadataPropertyType withSVOperationChainMetadata(SVOperationChainMetadataType value) {
        setSVOperationChainMetadata(value);
        return this;
    }

    public SVOperationChainMetadataPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public SVOperationChainMetadataPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public SVOperationChainMetadataPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public SVOperationChainMetadataPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SVOperationChainMetadataPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public SVOperationChainMetadataPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public SVOperationChainMetadataPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SVOperationChainMetadataPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SVOperationChainMetadataPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SVOperationChainMetadataPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public SVOperationChainMetadataPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
