...
public class MDResolutionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdResolution", buffer, theMDResolution, this.isSetMDResolution());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            MDResolutionType lhsMDResolution;
            lhsMDResolution = this.getMDResolution();
            MDResolutionType rhsMDResolution;
            rhsMDResolution = that.getMDResolution();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdResolution", lhsMDResolution), LocatorUtils.property(thatLocator, "mdResolution", rhsMDResolution), lhsMDResolution, rhsMDResolution, this.isSetMDResolution(), that.isSetMDResolution())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MDResolutionType theMDResolution;
            theMDResolution = this.getMDResolution();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdResolution", theMDResolution), currentHashCode, theMDResolution, this.isSetMDResolution());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDResolutionPropertyType) {
            final MDResolutionPropertyType copy = ((MDResolutionPropertyType) draftCopy);
            {
                Boolean mdResolutionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDResolution());
                if (mdResolutionShouldBeCopiedAndSet == Boolean.TRUE) {
                    MDResolutionType sourceMDResolution;
                    sourceMDResolution = this.getMDResolution();
                    MDResolutionType copyMDResolution = ((MDResolutionType) strategy.copy(LocatorUtils.property(locator, "mdResolution", sourceMDResolution), sourceMDResolution, this.isSetMDResolution()));
                    copy.setMDResolution(copyMDResolution);
                } else {
                    if (mdResolutionShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdResolution = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDResolutionPropertyType) {
            final MDResolutionPropertyType target = this;
            final MDResolutionPropertyType leftObject = ((MDResolutionPropertyType) left);
            final MDResolutionPropertyType rightObject = ((MDResolutionPropertyType) right);
            {
                Boolean mdResolutionShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDResolution(), rightObject.isSetMDResolution());
                if (mdResolutionShouldBeMergedAndSet == Boolean.TRUE) {
                    MDResolutionType lhsMDResolution;
                    lhsMDResolution = leftObject.getMDResolution();
                    MDResolutionType rhsMDResolution;
                    rhsMDResolution = rightObject.getMDResolution();
                    MDResolutionType mergedMDResolution = ((MDResolutionType) strategy.merge(LocatorUtils.property(leftLocator, "mdResolution", lhsMDResolution), LocatorUtils.property(rightLocator, "mdResolution", rhsMDResolution), lhsMDResolution, rhsMDResolution, leftObject.isSetMDResolution(), rightObject.isSetMDResolution()));
                    target.setMDResolution(mergedMDResolution);
                } else {
                    if (mdResolutionShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdResolution = null;
                    }
                }
            }
            {
    ...
    public MDResolutionPropertyType withMDResolution(MDResolutionType value) {
        setMDResolution(value);
        return this;
    }

    public MDResolutionPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDResolutionPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDResolutionPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
