...
public class MLEllipsoidalCSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlEllipsoidalCS", buffer, theMLEllipsoidalCS, this.isSetMLEllipsoidalCS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLEllipsoidalCSPropertyType that = ((MLEllipsoidalCSPropertyType) object);
        {
            MLEllipsoidalCSType lhsMLEllipsoidalCS;
            lhsMLEllipsoidalCS = this.getMLEllipsoidalCS();
            MLEllipsoidalCSType rhsMLEllipsoidalCS;
            rhsMLEllipsoidalCS = that.getMLEllipsoidalCS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlEllipsoidalCS", lhsMLEllipsoidalCS), LocatorUtils.property(thatLocator, "mlEllipsoidalCS", rhsMLEllipsoidalCS), lhsMLEllipsoidalCS, rhsMLEllipsoidalCS, this.isSetMLEllipsoidalCS(), that.isSetMLEllipsoidalCS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLEllipsoidalCSType theMLEllipsoidalCS;
            theMLEllipsoidalCS = this.getMLEllipsoidalCS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlEllipsoidalCS", theMLEllipsoidalCS), currentHashCode, theMLEllipsoidalCS, this.isSetMLEllipsoidalCS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLEllipsoidalCSPropertyType) {
            final MLEllipsoidalCSPropertyType copy = ((MLEllipsoidalCSPropertyType) draftCopy);
            {
                Boolean mlEllipsoidalCSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLEllipsoidalCS());
                if (mlEllipsoidalCSShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLEllipsoidalCSType sourceMLEllipsoidalCS;
                    sourceMLEllipsoidalCS = this.getMLEllipsoidalCS();
                    MLEllipsoidalCSType copyMLEllipsoidalCS = ((MLEllipsoidalCSType) strategy.copy(LocatorUtils.property(locator, "mlEllipsoidalCS", sourceMLEllipsoidalCS), sourceMLEllipsoidalCS, this.isSetMLEllipsoidalCS()));
                    copy.setMLEllipsoidalCS(copyMLEllipsoidalCS);
                } else {
                    if (mlEllipsoidalCSShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlEllipsoidalCS = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLEllipsoidalCSPropertyType) {
            final MLEllipsoidalCSPropertyType target = this;
            final MLEllipsoidalCSPropertyType leftObject = ((MLEllipsoidalCSPropertyType) left);
            final MLEllipsoidalCSPropertyType rightObject = ((MLEllipsoidalCSPropertyType) right);
            {
                Boolean mlEllipsoidalCSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLEllipsoidalCS(), rightObject.isSetMLEllipsoidalCS());
                if (mlEllipsoidalCSShouldBeMergedAndSet == Boolean.TRUE) {
                    MLEllipsoidalCSType lhsMLEllipsoidalCS;
                    lhsMLEllipsoidalCS = leftObject.getMLEllipsoidalCS();
                    MLEllipsoidalCSType rhsMLEllipsoidalCS;
                    rhsMLEllipsoidalCS = rightObject.getMLEllipsoidalCS();
                    MLEllipsoidalCSType mergedMLEllipsoidalCS = ((MLEllipsoidalCSType) strategy.merge(LocatorUtils.property(leftLocator, "mlEllipsoidalCS", lhsMLEllipsoidalCS), LocatorUtils.property(rightLocator, "mlEllipsoidalCS", rhsMLEllipsoidalCS), lhsMLEllipsoidalCS, rhsMLEllipsoidalCS, leftObject.isSetMLEllipsoidalCS(), rightObject.isSetMLEllipsoidalCS()));
                    target.setMLEllipsoidalCS(mergedMLEllipsoidalCS);
                } else {
                    if (mlEllipsoidalCSShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlEllipsoidalCS = null;
                    }
                }
            }
            {
    ...
    public MLEllipsoidalCSPropertyType withMLEllipsoidalCS(MLEllipsoidalCSType value) {
        setMLEllipsoidalCS(value);
        return this;
    }

    public MLEllipsoidalCSPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLEllipsoidalCSPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLEllipsoidalCSPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLEllipsoidalCSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLEllipsoidalCSPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLEllipsoidalCSPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLEllipsoidalCSPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLEllipsoidalCSPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLEllipsoidalCSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLEllipsoidalCSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLEllipsoidalCSPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
