...
public class EXGeographicExtentPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "abstractEXGeographicExtent", buffer, theAbstractEXGeographicExtent, this.isSetAbstractEXGeographicExtent());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            JAXBElement<? extends AbstractEXGeographicExtentType> lhsAbstractEXGeographicExtent;
            lhsAbstractEXGeographicExtent = this.getAbstractEXGeographicExtent();
            JAXBElement<? extends AbstractEXGeographicExtentType> rhsAbstractEXGeographicExtent;
            rhsAbstractEXGeographicExtent = that.getAbstractEXGeographicExtent();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractEXGeographicExtent", lhsAbstractEXGeographicExtent), LocatorUtils.property(thatLocator, "abstractEXGeographicExtent", rhsAbstractEXGeographicExtent), lhsAbstractEXGeographicExtent, rhsAbstractEXGeographicExtent, this.isSetAbstractEXGeographicExtent(), that.isSetAbstractEXGeographicExtent())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractEXGeographicExtentType> theAbstractEXGeographicExtent;
            theAbstractEXGeographicExtent = this.getAbstractEXGeographicExtent();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractEXGeographicExtent", theAbstractEXGeographicExtent), currentHashCode, theAbstractEXGeographicExtent, this.isSetAbstractEXGeographicExtent());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof EXGeographicExtentPropertyType) {
            final EXGeographicExtentPropertyType copy = ((EXGeographicExtentPropertyType) draftCopy);
            {
                Boolean abstractEXGeographicExtentShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractEXGeographicExtent());
                if (abstractEXGeographicExtentShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractEXGeographicExtentType> sourceAbstractEXGeographicExtent;
                    sourceAbstractEXGeographicExtent = this.getAbstractEXGeographicExtent();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractEXGeographicExtentType> copyAbstractEXGeographicExtent = ((JAXBElement<? extends AbstractEXGeographicExtentType> ) strategy.copy(LocatorUtils.property(locator, "abstractEXGeographicExtent", sourceAbstractEXGeographicExtent), sourceAbstractEXGeographicExtent, this.isSetAbstractEXGeographicExtent()));
                    copy.setAbstractEXGeographicExtent(copyAbstractEXGeographicExtent);
                } else {
                    if (abstractEXGeographicExtentShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.abstractEXGeographicExtent = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof EXGeographicExtentPropertyType) {
            final EXGeographicExtentPropertyType target = this;
            final EXGeographicExtentPropertyType leftObject = ((EXGeographicExtentPropertyType) left);
            final EXGeographicExtentPropertyType rightObject = ((EXGeographicExtentPropertyType) right);
            {
                Boolean abstractEXGeographicExtentShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractEXGeographicExtent(), rightObject.isSetAbstractEXGeographicExtent());
                if (abstractEXGeographicExtentShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractEXGeographicExtentType> lhsAbstractEXGeographicExtent;
                    lhsAbstractEXGeographicExtent = leftObject.getAbstractEXGeographicExtent();
                    JAXBElement<? extends AbstractEXGeographicExtentType> rhsAbstractEXGeographicExtent;
                    rhsAbstractEXGeographicExtent = rightObject.getAbstractEXGeographicExtent();
                    JAXBElement<? extends AbstractEXGeographicExtentType> mergedAbstractEXGeographicExtent = ((JAXBElement<? extends AbstractEXGeographicExtentType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractEXGeographicExtent", lhsAbstractEXGeographicExtent), LocatorUtils.property(rightLocator, "abstractEXGeographicExtent", rhsAbstractEXGeographicExtent), lhsAbstractEXGeographicExtent, rhsAbstractEXGeographicExtent, leftObject.isSetAbstractEXGeographicExtent(), rightObject.isSetAbstractEXGeographicExtent()));
                    target.setAbstractEXGeographicExtent(mergedAbstractEXGeographicExtent);
                } else {
                    if (abstractEXGeographicExtentShouldBeMergedAndSet == Boolean.FALSE) {
                        target.abstractEXGeographicExtent = null;
                    }
                }
            }
            {
    ...
    public EXGeographicExtentPropertyType withAbstractEXGeographicExtent(JAXBElement<? extends AbstractEXGeographicExtentType> value) {
        setAbstractEXGeographicExtent(value);
        return this;
    }

    public EXGeographicExtentPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public EXGeographicExtentPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public EXGeographicExtentPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public EXGeographicExtentPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public EXGeographicExtentPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public EXGeographicExtentPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public EXGeographicExtentPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public EXGeographicExtentPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public EXGeographicExtentPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public EXGeographicExtentPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public EXGeographicExtentPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
