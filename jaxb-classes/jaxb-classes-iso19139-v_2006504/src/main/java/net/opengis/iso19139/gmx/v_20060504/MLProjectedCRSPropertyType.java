...
public class MLProjectedCRSPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlProjectedCRS", buffer, theMLProjectedCRS, this.isSetMLProjectedCRS());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLProjectedCRSPropertyType that = ((MLProjectedCRSPropertyType) object);
        {
            MLProjectedCRSType lhsMLProjectedCRS;
            lhsMLProjectedCRS = this.getMLProjectedCRS();
            MLProjectedCRSType rhsMLProjectedCRS;
            rhsMLProjectedCRS = that.getMLProjectedCRS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlProjectedCRS", lhsMLProjectedCRS), LocatorUtils.property(thatLocator, "mlProjectedCRS", rhsMLProjectedCRS), lhsMLProjectedCRS, rhsMLProjectedCRS, this.isSetMLProjectedCRS(), that.isSetMLProjectedCRS())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLProjectedCRSType theMLProjectedCRS;
            theMLProjectedCRS = this.getMLProjectedCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlProjectedCRS", theMLProjectedCRS), currentHashCode, theMLProjectedCRS, this.isSetMLProjectedCRS());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLProjectedCRSPropertyType) {
            final MLProjectedCRSPropertyType copy = ((MLProjectedCRSPropertyType) draftCopy);
            {
                Boolean mlProjectedCRSShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLProjectedCRS());
                if (mlProjectedCRSShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLProjectedCRSType sourceMLProjectedCRS;
                    sourceMLProjectedCRS = this.getMLProjectedCRS();
                    MLProjectedCRSType copyMLProjectedCRS = ((MLProjectedCRSType) strategy.copy(LocatorUtils.property(locator, "mlProjectedCRS", sourceMLProjectedCRS), sourceMLProjectedCRS, this.isSetMLProjectedCRS()));
                    copy.setMLProjectedCRS(copyMLProjectedCRS);
                } else {
                    if (mlProjectedCRSShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlProjectedCRS = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLProjectedCRSPropertyType) {
            final MLProjectedCRSPropertyType target = this;
            final MLProjectedCRSPropertyType leftObject = ((MLProjectedCRSPropertyType) left);
            final MLProjectedCRSPropertyType rightObject = ((MLProjectedCRSPropertyType) right);
            {
                Boolean mlProjectedCRSShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLProjectedCRS(), rightObject.isSetMLProjectedCRS());
                if (mlProjectedCRSShouldBeMergedAndSet == Boolean.TRUE) {
                    MLProjectedCRSType lhsMLProjectedCRS;
                    lhsMLProjectedCRS = leftObject.getMLProjectedCRS();
                    MLProjectedCRSType rhsMLProjectedCRS;
                    rhsMLProjectedCRS = rightObject.getMLProjectedCRS();
                    MLProjectedCRSType mergedMLProjectedCRS = ((MLProjectedCRSType) strategy.merge(LocatorUtils.property(leftLocator, "mlProjectedCRS", lhsMLProjectedCRS), LocatorUtils.property(rightLocator, "mlProjectedCRS", rhsMLProjectedCRS), lhsMLProjectedCRS, rhsMLProjectedCRS, leftObject.isSetMLProjectedCRS(), rightObject.isSetMLProjectedCRS()));
                    target.setMLProjectedCRS(mergedMLProjectedCRS);
                } else {
                    if (mlProjectedCRSShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlProjectedCRS = null;
                    }
                }
            }
            {
    ...
    public MLProjectedCRSPropertyType withMLProjectedCRS(MLProjectedCRSType value) {
        setMLProjectedCRS(value);
        return this;
    }

    public MLProjectedCRSPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLProjectedCRSPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLProjectedCRSPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLProjectedCRSPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLProjectedCRSPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLProjectedCRSPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLProjectedCRSPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLProjectedCRSPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLProjectedCRSPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLProjectedCRSPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLProjectedCRSPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
