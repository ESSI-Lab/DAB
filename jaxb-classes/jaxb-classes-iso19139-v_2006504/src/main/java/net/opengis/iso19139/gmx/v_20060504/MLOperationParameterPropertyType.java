...
public class MLOperationParameterPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlOperationParameter", buffer, theMLOperationParameter, this.isSetMLOperationParameter());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLOperationParameterPropertyType that = ((MLOperationParameterPropertyType) object);
        {
            MLOperationParameterType lhsMLOperationParameter;
            lhsMLOperationParameter = this.getMLOperationParameter();
            MLOperationParameterType rhsMLOperationParameter;
            rhsMLOperationParameter = that.getMLOperationParameter();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlOperationParameter", lhsMLOperationParameter), LocatorUtils.property(thatLocator, "mlOperationParameter", rhsMLOperationParameter), lhsMLOperationParameter, rhsMLOperationParameter, this.isSetMLOperationParameter(), that.isSetMLOperationParameter())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLOperationParameterType theMLOperationParameter;
            theMLOperationParameter = this.getMLOperationParameter();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlOperationParameter", theMLOperationParameter), currentHashCode, theMLOperationParameter, this.isSetMLOperationParameter());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLOperationParameterPropertyType) {
            final MLOperationParameterPropertyType copy = ((MLOperationParameterPropertyType) draftCopy);
            {
                Boolean mlOperationParameterShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLOperationParameter());
                if (mlOperationParameterShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLOperationParameterType sourceMLOperationParameter;
                    sourceMLOperationParameter = this.getMLOperationParameter();
                    MLOperationParameterType copyMLOperationParameter = ((MLOperationParameterType) strategy.copy(LocatorUtils.property(locator, "mlOperationParameter", sourceMLOperationParameter), sourceMLOperationParameter, this.isSetMLOperationParameter()));
                    copy.setMLOperationParameter(copyMLOperationParameter);
                } else {
                    if (mlOperationParameterShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlOperationParameter = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLOperationParameterPropertyType) {
            final MLOperationParameterPropertyType target = this;
            final MLOperationParameterPropertyType leftObject = ((MLOperationParameterPropertyType) left);
            final MLOperationParameterPropertyType rightObject = ((MLOperationParameterPropertyType) right);
            {
                Boolean mlOperationParameterShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLOperationParameter(), rightObject.isSetMLOperationParameter());
                if (mlOperationParameterShouldBeMergedAndSet == Boolean.TRUE) {
                    MLOperationParameterType lhsMLOperationParameter;
                    lhsMLOperationParameter = leftObject.getMLOperationParameter();
                    MLOperationParameterType rhsMLOperationParameter;
                    rhsMLOperationParameter = rightObject.getMLOperationParameter();
                    MLOperationParameterType mergedMLOperationParameter = ((MLOperationParameterType) strategy.merge(LocatorUtils.property(leftLocator, "mlOperationParameter", lhsMLOperationParameter), LocatorUtils.property(rightLocator, "mlOperationParameter", rhsMLOperationParameter), lhsMLOperationParameter, rhsMLOperationParameter, leftObject.isSetMLOperationParameter(), rightObject.isSetMLOperationParameter()));
                    target.setMLOperationParameter(mergedMLOperationParameter);
                } else {
                    if (mlOperationParameterShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlOperationParameter = null;
                    }
                }
            }
            {
    ...
    public MLOperationParameterPropertyType withMLOperationParameter(MLOperationParameterType value) {
        setMLOperationParameter(value);
        return this;
    }

    public MLOperationParameterPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLOperationParameterPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLOperationParameterPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLOperationParameterPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLOperationParameterPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLOperationParameterPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLOperationParameterPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLOperationParameterPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLOperationParameterPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLOperationParameterPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLOperationParameterPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
