...
public class MLTransformationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlTransformation", buffer, theMLTransformation, this.isSetMLTransformation());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLTransformationPropertyType that = ((MLTransformationPropertyType) object);
        {
            MLTransformationType lhsMLTransformation;
            lhsMLTransformation = this.getMLTransformation();
            MLTransformationType rhsMLTransformation;
            rhsMLTransformation = that.getMLTransformation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlTransformation", lhsMLTransformation), LocatorUtils.property(thatLocator, "mlTransformation", rhsMLTransformation), lhsMLTransformation, rhsMLTransformation, this.isSetMLTransformation(), that.isSetMLTransformation())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLTransformationType theMLTransformation;
            theMLTransformation = this.getMLTransformation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlTransformation", theMLTransformation), currentHashCode, theMLTransformation, this.isSetMLTransformation());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLTransformationPropertyType) {
            final MLTransformationPropertyType copy = ((MLTransformationPropertyType) draftCopy);
            {
                Boolean mlTransformationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLTransformation());
                if (mlTransformationShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLTransformationType sourceMLTransformation;
                    sourceMLTransformation = this.getMLTransformation();
                    MLTransformationType copyMLTransformation = ((MLTransformationType) strategy.copy(LocatorUtils.property(locator, "mlTransformation", sourceMLTransformation), sourceMLTransformation, this.isSetMLTransformation()));
                    copy.setMLTransformation(copyMLTransformation);
                } else {
                    if (mlTransformationShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlTransformation = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLTransformationPropertyType) {
            final MLTransformationPropertyType target = this;
            final MLTransformationPropertyType leftObject = ((MLTransformationPropertyType) left);
            final MLTransformationPropertyType rightObject = ((MLTransformationPropertyType) right);
            {
                Boolean mlTransformationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLTransformation(), rightObject.isSetMLTransformation());
                if (mlTransformationShouldBeMergedAndSet == Boolean.TRUE) {
                    MLTransformationType lhsMLTransformation;
                    lhsMLTransformation = leftObject.getMLTransformation();
                    MLTransformationType rhsMLTransformation;
                    rhsMLTransformation = rightObject.getMLTransformation();
                    MLTransformationType mergedMLTransformation = ((MLTransformationType) strategy.merge(LocatorUtils.property(leftLocator, "mlTransformation", lhsMLTransformation), LocatorUtils.property(rightLocator, "mlTransformation", rhsMLTransformation), lhsMLTransformation, rhsMLTransformation, leftObject.isSetMLTransformation(), rightObject.isSetMLTransformation()));
                    target.setMLTransformation(mergedMLTransformation);
                } else {
                    if (mlTransformationShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlTransformation = null;
                    }
                }
            }
            {
    ...
    public MLTransformationPropertyType withMLTransformation(MLTransformationType value) {
        setMLTransformation(value);
        return this;
    }

    public MLTransformationPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLTransformationPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLTransformationPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLTransformationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLTransformationPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLTransformationPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLTransformationPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLTransformationPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLTransformationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLTransformationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLTransformationPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
