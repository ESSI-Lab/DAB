...
public class OperationParameterAltPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "operationParameterAlt", buffer, theOperationParameterAlt, this.isSetOperationParameterAlt());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final OperationParameterAltPropertyType that = ((OperationParameterAltPropertyType) object);
        {
            OperationParameterAltType lhsOperationParameterAlt;
            lhsOperationParameterAlt = this.getOperationParameterAlt();
            OperationParameterAltType rhsOperationParameterAlt;
            rhsOperationParameterAlt = that.getOperationParameterAlt();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "operationParameterAlt", lhsOperationParameterAlt), LocatorUtils.property(thatLocator, "operationParameterAlt", rhsOperationParameterAlt), lhsOperationParameterAlt, rhsOperationParameterAlt, this.isSetOperationParameterAlt(), that.isSetOperationParameterAlt())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            OperationParameterAltType theOperationParameterAlt;
            theOperationParameterAlt = this.getOperationParameterAlt();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "operationParameterAlt", theOperationParameterAlt), currentHashCode, theOperationParameterAlt, this.isSetOperationParameterAlt());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof OperationParameterAltPropertyType) {
            final OperationParameterAltPropertyType copy = ((OperationParameterAltPropertyType) draftCopy);
            {
                Boolean operationParameterAltShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetOperationParameterAlt());
                if (operationParameterAltShouldBeCopiedAndSet == Boolean.TRUE) {
                    OperationParameterAltType sourceOperationParameterAlt;
                    sourceOperationParameterAlt = this.getOperationParameterAlt();
                    OperationParameterAltType copyOperationParameterAlt = ((OperationParameterAltType) strategy.copy(LocatorUtils.property(locator, "operationParameterAlt", sourceOperationParameterAlt), sourceOperationParameterAlt, this.isSetOperationParameterAlt()));
                    copy.setOperationParameterAlt(copyOperationParameterAlt);
                } else {
                    if (operationParameterAltShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.operationParameterAlt = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof OperationParameterAltPropertyType) {
            final OperationParameterAltPropertyType target = this;
            final OperationParameterAltPropertyType leftObject = ((OperationParameterAltPropertyType) left);
            final OperationParameterAltPropertyType rightObject = ((OperationParameterAltPropertyType) right);
            {
                Boolean operationParameterAltShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetOperationParameterAlt(), rightObject.isSetOperationParameterAlt());
                if (operationParameterAltShouldBeMergedAndSet == Boolean.TRUE) {
                    OperationParameterAltType lhsOperationParameterAlt;
                    lhsOperationParameterAlt = leftObject.getOperationParameterAlt();
                    OperationParameterAltType rhsOperationParameterAlt;
                    rhsOperationParameterAlt = rightObject.getOperationParameterAlt();
                    OperationParameterAltType mergedOperationParameterAlt = ((OperationParameterAltType) strategy.merge(LocatorUtils.property(leftLocator, "operationParameterAlt", lhsOperationParameterAlt), LocatorUtils.property(rightLocator, "operationParameterAlt", rhsOperationParameterAlt), lhsOperationParameterAlt, rhsOperationParameterAlt, leftObject.isSetOperationParameterAlt(), rightObject.isSetOperationParameterAlt()));
                    target.setOperationParameterAlt(mergedOperationParameterAlt);
                } else {
                    if (operationParameterAltShouldBeMergedAndSet == Boolean.FALSE) {
                        target.operationParameterAlt = null;
                    }
                }
            }
            {
    ...
    public OperationParameterAltPropertyType withOperationParameterAlt(OperationParameterAltType value) {
        setOperationParameterAlt(value);
        return this;
    }

    public OperationParameterAltPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public OperationParameterAltPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public OperationParameterAltPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public OperationParameterAltPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public OperationParameterAltPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public OperationParameterAltPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public OperationParameterAltPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public OperationParameterAltPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public OperationParameterAltPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public OperationParameterAltPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public OperationParameterAltPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
