...
public class CodeAlternativeExpressionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "codeAlternativeExpression", buffer, theCodeAlternativeExpression, this.isSetCodeAlternativeExpression());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CodeAlternativeExpressionPropertyType that = ((CodeAlternativeExpressionPropertyType) object);
        {
            CodeAlternativeExpressionType lhsCodeAlternativeExpression;
            lhsCodeAlternativeExpression = this.getCodeAlternativeExpression();
            CodeAlternativeExpressionType rhsCodeAlternativeExpression;
            rhsCodeAlternativeExpression = that.getCodeAlternativeExpression();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "codeAlternativeExpression", lhsCodeAlternativeExpression), LocatorUtils.property(thatLocator, "codeAlternativeExpression", rhsCodeAlternativeExpression), lhsCodeAlternativeExpression, rhsCodeAlternativeExpression, this.isSetCodeAlternativeExpression(), that.isSetCodeAlternativeExpression())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            CodeAlternativeExpressionType theCodeAlternativeExpression;
            theCodeAlternativeExpression = this.getCodeAlternativeExpression();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "codeAlternativeExpression", theCodeAlternativeExpression), currentHashCode, theCodeAlternativeExpression, this.isSetCodeAlternativeExpression());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CodeAlternativeExpressionPropertyType) {
            final CodeAlternativeExpressionPropertyType copy = ((CodeAlternativeExpressionPropertyType) draftCopy);
            {
                Boolean codeAlternativeExpressionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCodeAlternativeExpression());
                if (codeAlternativeExpressionShouldBeCopiedAndSet == Boolean.TRUE) {
                    CodeAlternativeExpressionType sourceCodeAlternativeExpression;
                    sourceCodeAlternativeExpression = this.getCodeAlternativeExpression();
                    CodeAlternativeExpressionType copyCodeAlternativeExpression = ((CodeAlternativeExpressionType) strategy.copy(LocatorUtils.property(locator, "codeAlternativeExpression", sourceCodeAlternativeExpression), sourceCodeAlternativeExpression, this.isSetCodeAlternativeExpression()));
                    copy.setCodeAlternativeExpression(copyCodeAlternativeExpression);
                } else {
                    if (codeAlternativeExpressionShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.codeAlternativeExpression = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CodeAlternativeExpressionPropertyType) {
            final CodeAlternativeExpressionPropertyType target = this;
            final CodeAlternativeExpressionPropertyType leftObject = ((CodeAlternativeExpressionPropertyType) left);
            final CodeAlternativeExpressionPropertyType rightObject = ((CodeAlternativeExpressionPropertyType) right);
            {
                Boolean codeAlternativeExpressionShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCodeAlternativeExpression(), rightObject.isSetCodeAlternativeExpression());
                if (codeAlternativeExpressionShouldBeMergedAndSet == Boolean.TRUE) {
                    CodeAlternativeExpressionType lhsCodeAlternativeExpression;
                    lhsCodeAlternativeExpression = leftObject.getCodeAlternativeExpression();
                    CodeAlternativeExpressionType rhsCodeAlternativeExpression;
                    rhsCodeAlternativeExpression = rightObject.getCodeAlternativeExpression();
                    CodeAlternativeExpressionType mergedCodeAlternativeExpression = ((CodeAlternativeExpressionType) strategy.merge(LocatorUtils.property(leftLocator, "codeAlternativeExpression", lhsCodeAlternativeExpression), LocatorUtils.property(rightLocator, "codeAlternativeExpression", rhsCodeAlternativeExpression), lhsCodeAlternativeExpression, rhsCodeAlternativeExpression, leftObject.isSetCodeAlternativeExpression(), rightObject.isSetCodeAlternativeExpression()));
                    target.setCodeAlternativeExpression(mergedCodeAlternativeExpression);
                } else {
                    if (codeAlternativeExpressionShouldBeMergedAndSet == Boolean.FALSE) {
                        target.codeAlternativeExpression = null;
                    }
                }
            }
            {
    ...
    public CodeAlternativeExpressionPropertyType withCodeAlternativeExpression(CodeAlternativeExpressionType value) {
        setCodeAlternativeExpression(value);
        return this;
    }

    public CodeAlternativeExpressionPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CodeAlternativeExpressionPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CodeAlternativeExpressionPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public CodeAlternativeExpressionPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CodeAlternativeExpressionPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CodeAlternativeExpressionPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CodeAlternativeExpressionPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CodeAlternativeExpressionPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CodeAlternativeExpressionPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CodeAlternativeExpressionPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CodeAlternativeExpressionPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
