...
public class DSSensorPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "dsSensor", buffer, theDSSensor, this.isSetDSSensor());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            DSSensorType lhsDSSensor;
            lhsDSSensor = this.getDSSensor();
            DSSensorType rhsDSSensor;
            rhsDSSensor = that.getDSSensor();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dsSensor", lhsDSSensor), LocatorUtils.property(thatLocator, "dsSensor", rhsDSSensor), lhsDSSensor, rhsDSSensor, this.isSetDSSensor(), that.isSetDSSensor())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            DSSensorType theDSSensor;
            theDSSensor = this.getDSSensor();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dsSensor", theDSSensor), currentHashCode, theDSSensor, this.isSetDSSensor());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DSSensorPropertyType) {
            final DSSensorPropertyType copy = ((DSSensorPropertyType) draftCopy);
            {
                Boolean dsSensorShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDSSensor());
                if (dsSensorShouldBeCopiedAndSet == Boolean.TRUE) {
                    DSSensorType sourceDSSensor;
                    sourceDSSensor = this.getDSSensor();
                    DSSensorType copyDSSensor = ((DSSensorType) strategy.copy(LocatorUtils.property(locator, "dsSensor", sourceDSSensor), sourceDSSensor, this.isSetDSSensor()));
                    copy.setDSSensor(copyDSSensor);
                } else {
                    if (dsSensorShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.dsSensor = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DSSensorPropertyType) {
            final DSSensorPropertyType target = this;
            final DSSensorPropertyType leftObject = ((DSSensorPropertyType) left);
            final DSSensorPropertyType rightObject = ((DSSensorPropertyType) right);
            {
                Boolean dsSensorShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDSSensor(), rightObject.isSetDSSensor());
                if (dsSensorShouldBeMergedAndSet == Boolean.TRUE) {
                    DSSensorType lhsDSSensor;
                    lhsDSSensor = leftObject.getDSSensor();
                    DSSensorType rhsDSSensor;
                    rhsDSSensor = rightObject.getDSSensor();
                    DSSensorType mergedDSSensor = ((DSSensorType) strategy.merge(LocatorUtils.property(leftLocator, "dsSensor", lhsDSSensor), LocatorUtils.property(rightLocator, "dsSensor", rhsDSSensor), lhsDSSensor, rhsDSSensor, leftObject.isSetDSSensor(), rightObject.isSetDSSensor()));
                    target.setDSSensor(mergedDSSensor);
                } else {
                    if (dsSensorShouldBeMergedAndSet == Boolean.FALSE) {
                        target.dsSensor = null;
                    }
                }
            }
            {
    ...
    public DSSensorPropertyType withDSSensor(DSSensorType value) {
        setDSSensor(value);
        return this;
    }

    public DSSensorPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DSSensorPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DSSensorPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public DSSensorPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DSSensorPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DSSensorPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DSSensorPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DSSensorPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DSSensorPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DSSensorPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DSSensorPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
