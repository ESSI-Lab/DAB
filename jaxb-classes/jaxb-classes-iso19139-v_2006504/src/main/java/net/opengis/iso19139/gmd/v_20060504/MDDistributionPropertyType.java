...
public class MDDistributionPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDDistributionPropertyType) {
            final MDDistributionPropertyType copy = ((MDDistributionPropertyType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDDistributionPropertyType) {
            final MDDistributionPropertyType target = this;
            final MDDistributionPropertyType leftObject = ((MDDistributionPropertyType) left);
            final MDDistributionPropertyType rightObject = ((MDDistributionPropertyType) right);
            {
                Boolean mdDistributionShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDDistribution(), rightObject.isSetMDDistribution());
                if (mdDistributionShouldBeMergedAndSet == Boolean.TRUE) {
                    MDDistributionType lhsMDDistribution;
                    lhsMDDistribution = leftObject.getMDDistribution();
                    MDDistributionType rhsMDDistribution;
                    rhsMDDistribution = rightObject.getMDDistribution();
                    MDDistributionType mergedMDDistribution = ((MDDistributionType) strategy.merge(LocatorUtils.property(leftLocator, "mdDistribution", lhsMDDistribution), LocatorUtils.property(rightLocator, "mdDistribution", rhsMDDistribution), lhsMDDistribution, rhsMDDistribution, leftObject.isSetMDDistribution(), rightObject.isSetMDDistribution()));
                    target.setMDDistribution(mergedMDDistribution);
                } else {
                    if (mdDistributionShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdDistribution = null;
                    }
                }
            }
            {
    ...
    public MDDistributionPropertyType withMDDistribution(MDDistributionType value) {
        setMDDistribution(value);
        return this;
    }

    public MDDistributionPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDDistributionPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDDistributionPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDDistributionPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDDistributionPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDDistributionPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDDistributionPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDDistributionPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDDistributionPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDDistributionPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDDistributionPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
