...
public class CrsAltPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "crsAlt", buffer, theCrsAlt, this.isSetCrsAlt());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CrsAltPropertyType that = ((CrsAltPropertyType) object);
        {
            CrsAltType lhsCrsAlt;
            lhsCrsAlt = this.getCrsAlt();
            CrsAltType rhsCrsAlt;
            rhsCrsAlt = that.getCrsAlt();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "crsAlt", lhsCrsAlt), LocatorUtils.property(thatLocator, "crsAlt", rhsCrsAlt), lhsCrsAlt, rhsCrsAlt, this.isSetCrsAlt(), that.isSetCrsAlt())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            CrsAltType theCrsAlt;
            theCrsAlt = this.getCrsAlt();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "crsAlt", theCrsAlt), currentHashCode, theCrsAlt, this.isSetCrsAlt());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CrsAltPropertyType) {
            final CrsAltPropertyType copy = ((CrsAltPropertyType) draftCopy);
            {
                Boolean crsAltShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCrsAlt());
                if (crsAltShouldBeCopiedAndSet == Boolean.TRUE) {
                    CrsAltType sourceCrsAlt;
                    sourceCrsAlt = this.getCrsAlt();
                    CrsAltType copyCrsAlt = ((CrsAltType) strategy.copy(LocatorUtils.property(locator, "crsAlt", sourceCrsAlt), sourceCrsAlt, this.isSetCrsAlt()));
                    copy.setCrsAlt(copyCrsAlt);
                } else {
                    if (crsAltShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.crsAlt = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CrsAltPropertyType) {
            final CrsAltPropertyType target = this;
            final CrsAltPropertyType leftObject = ((CrsAltPropertyType) left);
            final CrsAltPropertyType rightObject = ((CrsAltPropertyType) right);
            {
                Boolean crsAltShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCrsAlt(), rightObject.isSetCrsAlt());
                if (crsAltShouldBeMergedAndSet == Boolean.TRUE) {
                    CrsAltType lhsCrsAlt;
                    lhsCrsAlt = leftObject.getCrsAlt();
                    CrsAltType rhsCrsAlt;
                    rhsCrsAlt = rightObject.getCrsAlt();
                    CrsAltType mergedCrsAlt = ((CrsAltType) strategy.merge(LocatorUtils.property(leftLocator, "crsAlt", lhsCrsAlt), LocatorUtils.property(rightLocator, "crsAlt", rhsCrsAlt), lhsCrsAlt, rhsCrsAlt, leftObject.isSetCrsAlt(), rightObject.isSetCrsAlt()));
                    target.setCrsAlt(mergedCrsAlt);
                } else {
                    if (crsAltShouldBeMergedAndSet == Boolean.FALSE) {
                        target.crsAlt = null;
                    }
                }
            }
    ...
    public CrsAltPropertyType withCrsAlt(CrsAltType value) {
        setCrsAlt(value);
        return this;
    }

    public CrsAltPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public CrsAltPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public CrsAltPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public CrsAltPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CrsAltPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CrsAltPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CrsAltPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CrsAltPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CrsAltPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CrsAltPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public CrsAltPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
