...
public class SVOperationMetadataPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "svOperationMetadata", buffer, theSVOperationMetadata, this.isSetSVOperationMetadata());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SVOperationMetadataPropertyType that = ((SVOperationMetadataPropertyType) object);
        {
            SVOperationMetadataType lhsSVOperationMetadata;
            lhsSVOperationMetadata = this.getSVOperationMetadata();
            SVOperationMetadataType rhsSVOperationMetadata;
            rhsSVOperationMetadata = that.getSVOperationMetadata();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "svOperationMetadata", lhsSVOperationMetadata), LocatorUtils.property(thatLocator, "svOperationMetadata", rhsSVOperationMetadata), lhsSVOperationMetadata, rhsSVOperationMetadata, this.isSetSVOperationMetadata(), that.isSetSVOperationMetadata())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            SVOperationMetadataType theSVOperationMetadata;
            theSVOperationMetadata = this.getSVOperationMetadata();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "svOperationMetadata", theSVOperationMetadata), currentHashCode, theSVOperationMetadata, this.isSetSVOperationMetadata());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SVOperationMetadataPropertyType) {
            final SVOperationMetadataPropertyType copy = ((SVOperationMetadataPropertyType) draftCopy);
            {
                Boolean svOperationMetadataShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSVOperationMetadata());
                if (svOperationMetadataShouldBeCopiedAndSet == Boolean.TRUE) {
                    SVOperationMetadataType sourceSVOperationMetadata;
                    sourceSVOperationMetadata = this.getSVOperationMetadata();
                    SVOperationMetadataType copySVOperationMetadata = ((SVOperationMetadataType) strategy.copy(LocatorUtils.property(locator, "svOperationMetadata", sourceSVOperationMetadata), sourceSVOperationMetadata, this.isSetSVOperationMetadata()));
                    copy.setSVOperationMetadata(copySVOperationMetadata);
                } else {
                    if (svOperationMetadataShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.svOperationMetadata = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SVOperationMetadataPropertyType) {
            final SVOperationMetadataPropertyType target = this;
            final SVOperationMetadataPropertyType leftObject = ((SVOperationMetadataPropertyType) left);
            final SVOperationMetadataPropertyType rightObject = ((SVOperationMetadataPropertyType) right);
            {
                Boolean svOperationMetadataShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSVOperationMetadata(), rightObject.isSetSVOperationMetadata());
                if (svOperationMetadataShouldBeMergedAndSet == Boolean.TRUE) {
                    SVOperationMetadataType lhsSVOperationMetadata;
                    lhsSVOperationMetadata = leftObject.getSVOperationMetadata();
                    SVOperationMetadataType rhsSVOperationMetadata;
                    rhsSVOperationMetadata = rightObject.getSVOperationMetadata();
                    SVOperationMetadataType mergedSVOperationMetadata = ((SVOperationMetadataType) strategy.merge(LocatorUtils.property(leftLocator, "svOperationMetadata", lhsSVOperationMetadata), LocatorUtils.property(rightLocator, "svOperationMetadata", rhsSVOperationMetadata), lhsSVOperationMetadata, rhsSVOperationMetadata, leftObject.isSetSVOperationMetadata(), rightObject.isSetSVOperationMetadata()));
                    target.setSVOperationMetadata(mergedSVOperationMetadata);
                } else {
                    if (svOperationMetadataShouldBeMergedAndSet == Boolean.FALSE) {
                        target.svOperationMetadata = null;
                    }
                }
            }
            {
    ...
    public SVOperationMetadataPropertyType withSVOperationMetadata(SVOperationMetadataType value) {
        setSVOperationMetadata(value);
        return this;
    }

    public SVOperationMetadataPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public SVOperationMetadataPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public SVOperationMetadataPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public SVOperationMetadataPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SVOperationMetadataPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public SVOperationMetadataPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public SVOperationMetadataPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SVOperationMetadataPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SVOperationMetadataPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SVOperationMetadataPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public SVOperationMetadataPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
