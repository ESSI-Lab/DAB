...
public class SVServiceTypePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "svServiceType", buffer, theSVServiceType, this.isSetSVServiceType());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SVServiceTypePropertyType that = ((SVServiceTypePropertyType) object);
        {
            SVServiceTypeType lhsSVServiceType;
            lhsSVServiceType = this.getSVServiceType();
            SVServiceTypeType rhsSVServiceType;
            rhsSVServiceType = that.getSVServiceType();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "svServiceType", lhsSVServiceType), LocatorUtils.property(thatLocator, "svServiceType", rhsSVServiceType), lhsSVServiceType, rhsSVServiceType, this.isSetSVServiceType(), that.isSetSVServiceType())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            SVServiceTypeType theSVServiceType;
            theSVServiceType = this.getSVServiceType();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "svServiceType", theSVServiceType), currentHashCode, theSVServiceType, this.isSetSVServiceType());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SVServiceTypePropertyType) {
            final SVServiceTypePropertyType copy = ((SVServiceTypePropertyType) draftCopy);
            {
                Boolean svServiceTypeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSVServiceType());
                if (svServiceTypeShouldBeCopiedAndSet == Boolean.TRUE) {
                    SVServiceTypeType sourceSVServiceType;
                    sourceSVServiceType = this.getSVServiceType();
                    SVServiceTypeType copySVServiceType = ((SVServiceTypeType) strategy.copy(LocatorUtils.property(locator, "svServiceType", sourceSVServiceType), sourceSVServiceType, this.isSetSVServiceType()));
                    copy.setSVServiceType(copySVServiceType);
                } else {
                    if (svServiceTypeShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.svServiceType = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SVServiceTypePropertyType) {
            final SVServiceTypePropertyType target = this;
            final SVServiceTypePropertyType leftObject = ((SVServiceTypePropertyType) left);
            final SVServiceTypePropertyType rightObject = ((SVServiceTypePropertyType) right);
            {
                Boolean svServiceTypeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSVServiceType(), rightObject.isSetSVServiceType());
                if (svServiceTypeShouldBeMergedAndSet == Boolean.TRUE) {
                    SVServiceTypeType lhsSVServiceType;
                    lhsSVServiceType = leftObject.getSVServiceType();
                    SVServiceTypeType rhsSVServiceType;
                    rhsSVServiceType = rightObject.getSVServiceType();
                    SVServiceTypeType mergedSVServiceType = ((SVServiceTypeType) strategy.merge(LocatorUtils.property(leftLocator, "svServiceType", lhsSVServiceType), LocatorUtils.property(rightLocator, "svServiceType", rhsSVServiceType), lhsSVServiceType, rhsSVServiceType, leftObject.isSetSVServiceType(), rightObject.isSetSVServiceType()));
                    target.setSVServiceType(mergedSVServiceType);
                } else {
                    if (svServiceTypeShouldBeMergedAndSet == Boolean.FALSE) {
                        target.svServiceType = null;
                    }
                }
            }
            {
    ...
    public SVServiceTypePropertyType withSVServiceType(SVServiceTypeType value) {
        setSVServiceType(value);
        return this;
    }

    public SVServiceTypePropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public SVServiceTypePropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public SVServiceTypePropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public SVServiceTypePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SVServiceTypePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public SVServiceTypePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public SVServiceTypePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SVServiceTypePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SVServiceTypePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SVServiceTypePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public SVServiceTypePropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
