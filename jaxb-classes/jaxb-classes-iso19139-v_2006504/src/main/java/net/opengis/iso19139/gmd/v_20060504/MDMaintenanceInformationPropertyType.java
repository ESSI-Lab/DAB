...
public class MDMaintenanceInformationPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mdMaintenanceInformation", buffer, theMDMaintenanceInformation, this.isSetMDMaintenanceInformation());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            MDMaintenanceInformationType lhsMDMaintenanceInformation;
            lhsMDMaintenanceInformation = this.getMDMaintenanceInformation();
            MDMaintenanceInformationType rhsMDMaintenanceInformation;
            rhsMDMaintenanceInformation = that.getMDMaintenanceInformation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mdMaintenanceInformation", lhsMDMaintenanceInformation), LocatorUtils.property(thatLocator, "mdMaintenanceInformation", rhsMDMaintenanceInformation), lhsMDMaintenanceInformation, rhsMDMaintenanceInformation, this.isSetMDMaintenanceInformation(), that.isSetMDMaintenanceInformation())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MDMaintenanceInformationType theMDMaintenanceInformation;
            theMDMaintenanceInformation = this.getMDMaintenanceInformation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mdMaintenanceInformation", theMDMaintenanceInformation), currentHashCode, theMDMaintenanceInformation, this.isSetMDMaintenanceInformation());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MDMaintenanceInformationPropertyType) {
            final MDMaintenanceInformationPropertyType copy = ((MDMaintenanceInformationPropertyType) draftCopy);
            {
                Boolean mdMaintenanceInformationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMDMaintenanceInformation());
                if (mdMaintenanceInformationShouldBeCopiedAndSet == Boolean.TRUE) {
                    MDMaintenanceInformationType sourceMDMaintenanceInformation;
                    sourceMDMaintenanceInformation = this.getMDMaintenanceInformation();
                    MDMaintenanceInformationType copyMDMaintenanceInformation = ((MDMaintenanceInformationType) strategy.copy(LocatorUtils.property(locator, "mdMaintenanceInformation", sourceMDMaintenanceInformation), sourceMDMaintenanceInformation, this.isSetMDMaintenanceInformation()));
                    copy.setMDMaintenanceInformation(copyMDMaintenanceInformation);
                } else {
                    if (mdMaintenanceInformationShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mdMaintenanceInformation = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MDMaintenanceInformationPropertyType) {
            final MDMaintenanceInformationPropertyType target = this;
            final MDMaintenanceInformationPropertyType leftObject = ((MDMaintenanceInformationPropertyType) left);
            final MDMaintenanceInformationPropertyType rightObject = ((MDMaintenanceInformationPropertyType) right);
            {
                Boolean mdMaintenanceInformationShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMDMaintenanceInformation(), rightObject.isSetMDMaintenanceInformation());
                if (mdMaintenanceInformationShouldBeMergedAndSet == Boolean.TRUE) {
                    MDMaintenanceInformationType lhsMDMaintenanceInformation;
                    lhsMDMaintenanceInformation = leftObject.getMDMaintenanceInformation();
                    MDMaintenanceInformationType rhsMDMaintenanceInformation;
                    rhsMDMaintenanceInformation = rightObject.getMDMaintenanceInformation();
                    MDMaintenanceInformationType mergedMDMaintenanceInformation = ((MDMaintenanceInformationType) strategy.merge(LocatorUtils.property(leftLocator, "mdMaintenanceInformation", lhsMDMaintenanceInformation), LocatorUtils.property(rightLocator, "mdMaintenanceInformation", rhsMDMaintenanceInformation), lhsMDMaintenanceInformation, rhsMDMaintenanceInformation, leftObject.isSetMDMaintenanceInformation(), rightObject.isSetMDMaintenanceInformation()));
                    target.setMDMaintenanceInformation(mergedMDMaintenanceInformation);
                } else {
                    if (mdMaintenanceInformationShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mdMaintenanceInformation = null;
                    }
                }
            }
            {
    ...
    public MDMaintenanceInformationPropertyType withMDMaintenanceInformation(MDMaintenanceInformationType value) {
        setMDMaintenanceInformation(value);
        return this;
    }

    public MDMaintenanceInformationPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MDMaintenanceInformationPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MDMaintenanceInformationPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MDMaintenanceInformationPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MDMaintenanceInformationPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MDMaintenanceInformationPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MDMaintenanceInformationPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MDMaintenanceInformationPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MDMaintenanceInformationPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MDMaintenanceInformationPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MDMaintenanceInformationPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
