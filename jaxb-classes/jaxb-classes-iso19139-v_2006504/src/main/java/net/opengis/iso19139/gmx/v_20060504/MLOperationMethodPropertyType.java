...
public class MLOperationMethodPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "mlOperationMethod", buffer, theMLOperationMethod, this.isSetMLOperationMethod());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final MLOperationMethodPropertyType that = ((MLOperationMethodPropertyType) object);
        {
            MLOperationMethodType lhsMLOperationMethod;
            lhsMLOperationMethod = this.getMLOperationMethod();
            MLOperationMethodType rhsMLOperationMethod;
            rhsMLOperationMethod = that.getMLOperationMethod();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mlOperationMethod", lhsMLOperationMethod), LocatorUtils.property(thatLocator, "mlOperationMethod", rhsMLOperationMethod), lhsMLOperationMethod, rhsMLOperationMethod, this.isSetMLOperationMethod(), that.isSetMLOperationMethod())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MLOperationMethodType theMLOperationMethod;
            theMLOperationMethod = this.getMLOperationMethod();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mlOperationMethod", theMLOperationMethod), currentHashCode, theMLOperationMethod, this.isSetMLOperationMethod());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MLOperationMethodPropertyType) {
            final MLOperationMethodPropertyType copy = ((MLOperationMethodPropertyType) draftCopy);
            {
                Boolean mlOperationMethodShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMLOperationMethod());
                if (mlOperationMethodShouldBeCopiedAndSet == Boolean.TRUE) {
                    MLOperationMethodType sourceMLOperationMethod;
                    sourceMLOperationMethod = this.getMLOperationMethod();
                    MLOperationMethodType copyMLOperationMethod = ((MLOperationMethodType) strategy.copy(LocatorUtils.property(locator, "mlOperationMethod", sourceMLOperationMethod), sourceMLOperationMethod, this.isSetMLOperationMethod()));
                    copy.setMLOperationMethod(copyMLOperationMethod);
                } else {
                    if (mlOperationMethodShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mlOperationMethod = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MLOperationMethodPropertyType) {
            final MLOperationMethodPropertyType target = this;
            final MLOperationMethodPropertyType leftObject = ((MLOperationMethodPropertyType) left);
            final MLOperationMethodPropertyType rightObject = ((MLOperationMethodPropertyType) right);
            {
                Boolean mlOperationMethodShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMLOperationMethod(), rightObject.isSetMLOperationMethod());
                if (mlOperationMethodShouldBeMergedAndSet == Boolean.TRUE) {
                    MLOperationMethodType lhsMLOperationMethod;
                    lhsMLOperationMethod = leftObject.getMLOperationMethod();
                    MLOperationMethodType rhsMLOperationMethod;
                    rhsMLOperationMethod = rightObject.getMLOperationMethod();
                    MLOperationMethodType mergedMLOperationMethod = ((MLOperationMethodType) strategy.merge(LocatorUtils.property(leftLocator, "mlOperationMethod", lhsMLOperationMethod), LocatorUtils.property(rightLocator, "mlOperationMethod", rhsMLOperationMethod), lhsMLOperationMethod, rhsMLOperationMethod, leftObject.isSetMLOperationMethod(), rightObject.isSetMLOperationMethod()));
                    target.setMLOperationMethod(mergedMLOperationMethod);
                } else {
                    if (mlOperationMethodShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mlOperationMethod = null;
                    }
                }
            }
            {
    ...
    public MLOperationMethodPropertyType withMLOperationMethod(MLOperationMethodType value) {
        setMLOperationMethod(value);
        return this;
    }

    public MLOperationMethodPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public MLOperationMethodPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public MLOperationMethodPropertyType withUuidref(String value) {
        setUuidref(value);
        return this;
    }

    public MLOperationMethodPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public MLOperationMethodPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public MLOperationMethodPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public MLOperationMethodPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public MLOperationMethodPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public MLOperationMethodPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public MLOperationMethodPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public MLOperationMethodPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
