...
public class KeywordListPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final KeywordListPropertyType that = ((KeywordListPropertyType) object);
        {
            KeywordListType lhsKeywordList;
            lhsKeywordList = this.getKeywordList();
            KeywordListType rhsKeywordList;
            rhsKeywordList = that.getKeywordList();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "keywordList", lhsKeywordList), LocatorUtils.property(thatLocator, "keywordList", rhsKeywordList), lhsKeywordList, rhsKeywordList, this.isSetKeywordList(), that.isSetKeywordList())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            KeywordListType theKeywordList;
            theKeywordList = this.getKeywordList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "keywordList", theKeywordList), currentHashCode, theKeywordList, this.isSetKeywordList());
        }
        {
            TypeType theTYPE;
            theTYPE = this.getTYPE();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof KeywordListPropertyType) {
            final KeywordListPropertyType copy = ((KeywordListPropertyType) draftCopy);
            {
                Boolean keywordListShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetKeywordList());
                if (keywordListShouldBeCopiedAndSet == Boolean.TRUE) {
                    KeywordListType sourceKeywordList;
                    sourceKeywordList = this.getKeywordList();
                    KeywordListType copyKeywordList = ((KeywordListType) strategy.copy(LocatorUtils.property(locator, "keywordList", sourceKeywordList), sourceKeywordList, this.isSetKeywordList()));
                    copy.setKeywordList(copyKeywordList);
                } else {
                    if (keywordListShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof KeywordListPropertyType) {
            final KeywordListPropertyType target = this;
            final KeywordListPropertyType leftObject = ((KeywordListPropertyType) left);
            final KeywordListPropertyType rightObject = ((KeywordListPropertyType) right);
            {
                Boolean keywordListShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetKeywordList(), rightObject.isSetKeywordList());
                if (keywordListShouldBeMergedAndSet == Boolean.TRUE) {
                    KeywordListType lhsKeywordList;
                    lhsKeywordList = leftObject.getKeywordList();
                    KeywordListType rhsKeywordList;
                    rhsKeywordList = rightObject.getKeywordList();
                    KeywordListType mergedKeywordList = ((KeywordListType) strategy.merge(LocatorUtils.property(leftLocator, "keywordList", lhsKeywordList), LocatorUtils.property(rightLocator, "keywordList", rhsKeywordList), lhsKeywordList, rhsKeywordList, leftObject.isSetKeywordList(), rightObject.isSetKeywordList()));
                    target.setKeywordList(mergedKeywordList);
                } else {
                    if (keywordListShouldBeMergedAndSet == Boolean.FALSE) {
                        target.keywordList = null;
                    }
                }
            }
            {
    ...
    public KeywordListPropertyType withKeywordList(KeywordListType value) {
        setKeywordList(value);
        return this;
    }

    public KeywordListPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public KeywordListPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public KeywordListPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public KeywordListPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public KeywordListPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public KeywordListPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public KeywordListPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
