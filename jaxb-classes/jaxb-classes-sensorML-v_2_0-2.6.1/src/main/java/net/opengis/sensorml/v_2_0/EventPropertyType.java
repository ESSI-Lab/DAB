...
public class EventPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final EventPropertyType that = ((EventPropertyType) object);
        {
            EventType lhsEvent;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof EventPropertyType) {
            final EventPropertyType copy = ((EventPropertyType) draftCopy);
            {
                ...
                if (eventShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    EventType copyEvent = ((EventType) strategy.copy(LocatorUtils.property(locator, "event", sourceEvent), sourceEvent, this.isSetEvent()));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof EventPropertyType) {
            final EventPropertyType target = this;
            final EventPropertyType leftObject = ((EventPropertyType) left);
            final EventPropertyType rightObject = ((EventPropertyType) right);
            {
                ...
                if (eventShouldBeMergedAndSet == Boolean.TRUE) {
                    EventType lhsEvent;
                    lhsEvent = leftObject.getEvent();
                    EventType rhsEvent;
                    rhsEvent = rightObject.getEvent();
                    EventType mergedEvent = ((EventType) strategy.merge(LocatorUtils.property(leftLocator, "event", lhsEvent), LocatorUtils.property(rightLocator, "event", rhsEvent), lhsEvent, rhsEvent, leftObject.isSetEvent(), rightObject.isSetEvent()));
                    target.setEvent(mergedEvent);
                } else {
    ...
    public EventPropertyType withEvent(EventType value) {
        setEvent(value);
        return this;
    }

    public EventPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public EventPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public EventPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public EventPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public EventPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public EventPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public EventPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
