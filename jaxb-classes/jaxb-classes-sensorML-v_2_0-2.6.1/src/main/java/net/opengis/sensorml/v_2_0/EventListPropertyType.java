...
public class EventListPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            EventListType theEventList;
            theEventList = this.getEventList();
            strategy.appendField(locator, this, "eventList", buffer, theEventList, this.isSetEventList());
        }
        {
            TypeType theTYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final EventListPropertyType that = ((EventListPropertyType) object);
        {
            EventListType lhsEventList;
            lhsEventList = this.getEventList();
            EventListType rhsEventList;
            rhsEventList = that.getEventList();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "eventList", lhsEventList), LocatorUtils.property(thatLocator, "eventList", rhsEventList), lhsEventList, rhsEventList, this.isSetEventList(), that.isSetEventList())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            EventListType theEventList;
            theEventList = this.getEventList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "eventList", theEventList), currentHashCode, theEventList, this.isSetEventList());
        }
        {
            TypeType theTYPE;
            theTYPE = this.getTYPE();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof EventListPropertyType) {
            final EventListPropertyType copy = ((EventListPropertyType) draftCopy);
            {
                Boolean eventListShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetEventList());
                if (eventListShouldBeCopiedAndSet == Boolean.TRUE) {
                    EventListType sourceEventList;
                    sourceEventList = this.getEventList();
                    EventListType copyEventList = ((EventListType) strategy.copy(LocatorUtils.property(locator, "eventList", sourceEventList), sourceEventList, this.isSetEventList()));
                    copy.setEventList(copyEventList);
                } else {
                    if (eventListShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.eventList = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof EventListPropertyType) {
            final EventListPropertyType target = this;
            final EventListPropertyType leftObject = ((EventListPropertyType) left);
            final EventListPropertyType rightObject = ((EventListPropertyType) right);
            {
                Boolean eventListShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetEventList(), rightObject.isSetEventList());
                if (eventListShouldBeMergedAndSet == Boolean.TRUE) {
                    EventListType lhsEventList;
                    lhsEventList = leftObject.getEventList();
                    EventListType rhsEventList;
                    rhsEventList = rightObject.getEventList();
                    EventListType mergedEventList = ((EventListType) strategy.merge(LocatorUtils.property(leftLocator, "eventList", lhsEventList), LocatorUtils.property(rightLocator, "eventList", rhsEventList), lhsEventList, rhsEventList, leftObject.isSetEventList(), rightObject.isSetEventList()));
                    target.setEventList(mergedEventList);
                } else {
                    if (eventListShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public EventListPropertyType withEventList(EventListType value) {
        setEventList(value);
        return this;
    }

    public EventListPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public EventListPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public EventListPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public EventListPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public EventListPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public EventListPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public EventListPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
