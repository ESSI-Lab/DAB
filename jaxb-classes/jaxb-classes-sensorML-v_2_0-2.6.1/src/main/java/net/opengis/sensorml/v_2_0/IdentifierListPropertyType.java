...
public class IdentifierListPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetIdentifierList() {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            IdentifierListType theIdentifierList;
            theIdentifierList = this.getIdentifierList();
            strategy.appendField(locator, this, "identifierList", buffer, theIdentifierList, this.isSetIdentifierList());
        }
        {
            TypeType theTYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final IdentifierListPropertyType that = ((IdentifierListPropertyType) object);
        {
            IdentifierListType lhsIdentifierList;
            lhsIdentifierList = this.getIdentifierList();
            IdentifierListType rhsIdentifierList;
            rhsIdentifierList = that.getIdentifierList();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "identifierList", lhsIdentifierList), LocatorUtils.property(thatLocator, "identifierList", rhsIdentifierList), lhsIdentifierList, rhsIdentifierList, this.isSetIdentifierList(), that.isSetIdentifierList())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            IdentifierListType theIdentifierList;
            theIdentifierList = this.getIdentifierList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "identifierList", theIdentifierList), currentHashCode, theIdentifierList, this.isSetIdentifierList());
        }
        {
            TypeType theTYPE;
            theTYPE = this.getTYPE();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof IdentifierListPropertyType) {
            final IdentifierListPropertyType copy = ((IdentifierListPropertyType) draftCopy);
            {
                Boolean identifierListShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetIdentifierList());
                if (identifierListShouldBeCopiedAndSet == Boolean.TRUE) {
                    IdentifierListType sourceIdentifierList;
                    sourceIdentifierList = this.getIdentifierList();
                    IdentifierListType copyIdentifierList = ((IdentifierListType) strategy.copy(LocatorUtils.property(locator, "identifierList", sourceIdentifierList), sourceIdentifierList, this.isSetIdentifierList()));
                    copy.setIdentifierList(copyIdentifierList);
                } else {
                    if (identifierListShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.identifierList = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof IdentifierListPropertyType) {
            final IdentifierListPropertyType target = this;
            final IdentifierListPropertyType leftObject = ((IdentifierListPropertyType) left);
            final IdentifierListPropertyType rightObject = ((IdentifierListPropertyType) right);
            {
                Boolean identifierListShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetIdentifierList(), rightObject.isSetIdentifierList());
                if (identifierListShouldBeMergedAndSet == Boolean.TRUE) {
                    IdentifierListType lhsIdentifierList;
                    lhsIdentifierList = leftObject.getIdentifierList();
                    IdentifierListType rhsIdentifierList;
                    rhsIdentifierList = rightObject.getIdentifierList();
                    IdentifierListType mergedIdentifierList = ((IdentifierListType) strategy.merge(LocatorUtils.property(leftLocator, "identifierList", lhsIdentifierList), LocatorUtils.property(rightLocator, "identifierList", rhsIdentifierList), lhsIdentifierList, rhsIdentifierList, leftObject.isSetIdentifierList(), rightObject.isSetIdentifierList()));
                    target.setIdentifierList(mergedIdentifierList);
                } else {
                    if (identifierListShouldBeMergedAndSet == Boolean.FALSE) {
                        target.identifierList = null;
                    }
                }
            }
            {
    ...
    public IdentifierListPropertyType withIdentifierList(IdentifierListType value) {
        setIdentifierList(value);
        return this;
    }

    public IdentifierListPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public IdentifierListPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public IdentifierListPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public IdentifierListPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public IdentifierListPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public IdentifierListPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public IdentifierListPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
