...
@XmlSeeAlso({
    DescribedObjectType.Capabilities.class
})
public class CapabilityListPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetCapabilityList() {
        return (this.capabilityList!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            CapabilityListType theCapabilityList;
            theCapabilityList = this.getCapabilityList();
            strategy.appendField(locator, this, "capabilityList", buffer, theCapabilityList, this.isSetCapabilityList());
        }
        {
            TypeType theTYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CapabilityListPropertyType that = ((CapabilityListPropertyType) object);
        {
            CapabilityListType lhsCapabilityList;
            lhsCapabilityList = this.getCapabilityList();
            CapabilityListType rhsCapabilityList;
            rhsCapabilityList = that.getCapabilityList();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "capabilityList", lhsCapabilityList), LocatorUtils.property(thatLocator, "capabilityList", rhsCapabilityList), lhsCapabilityList, rhsCapabilityList, this.isSetCapabilityList(), that.isSetCapabilityList())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            CapabilityListType theCapabilityList;
            theCapabilityList = this.getCapabilityList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "capabilityList", theCapabilityList), currentHashCode, theCapabilityList, this.isSetCapabilityList());
        }
        {
            TypeType theTYPE;
            theTYPE = this.getTYPE();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CapabilityListPropertyType) {
            final CapabilityListPropertyType copy = ((CapabilityListPropertyType) draftCopy);
            {
                Boolean capabilityListShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCapabilityList());
                if (capabilityListShouldBeCopiedAndSet == Boolean.TRUE) {
                    CapabilityListType sourceCapabilityList;
                    sourceCapabilityList = this.getCapabilityList();
                    CapabilityListType copyCapabilityList = ((CapabilityListType) strategy.copy(LocatorUtils.property(locator, "capabilityList", sourceCapabilityList), sourceCapabilityList, this.isSetCapabilityList()));
                    copy.setCapabilityList(copyCapabilityList);
                } else {
                    if (capabilityListShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.capabilityList = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CapabilityListPropertyType) {
            final CapabilityListPropertyType target = this;
            final CapabilityListPropertyType leftObject = ((CapabilityListPropertyType) left);
            final CapabilityListPropertyType rightObject = ((CapabilityListPropertyType) right);
            {
                Boolean capabilityListShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCapabilityList(), rightObject.isSetCapabilityList());
                if (capabilityListShouldBeMergedAndSet == Boolean.TRUE) {
                    CapabilityListType lhsCapabilityList;
                    lhsCapabilityList = leftObject.getCapabilityList();
                    CapabilityListType rhsCapabilityList;
                    rhsCapabilityList = rightObject.getCapabilityList();
                    CapabilityListType mergedCapabilityList = ((CapabilityListType) strategy.merge(LocatorUtils.property(leftLocator, "capabilityList", lhsCapabilityList), LocatorUtils.property(rightLocator, "capabilityList", rhsCapabilityList), lhsCapabilityList, rhsCapabilityList, leftObject.isSetCapabilityList(), rightObject.isSetCapabilityList()));
                    target.setCapabilityList(mergedCapabilityList);
                } else {
                    if (capabilityListShouldBeMergedAndSet == Boolean.FALSE) {
                        target.capabilityList = null;
                    }
                }
            }
            {
    ...
    public CapabilityListPropertyType withCapabilityList(CapabilityListType value) {
        setCapabilityList(value);
        return this;
    }

    public CapabilityListPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CapabilityListPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CapabilityListPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CapabilityListPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CapabilityListPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CapabilityListPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CapabilityListPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
