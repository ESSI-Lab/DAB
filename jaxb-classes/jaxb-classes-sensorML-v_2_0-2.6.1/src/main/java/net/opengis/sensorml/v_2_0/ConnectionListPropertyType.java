...
public class ConnectionListPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ConnectionListType theConnectionList;
            theConnectionList = this.getConnectionList();
            strategy.appendField(locator, this, "connectionList", buffer, theConnectionList, this.isSetConnectionList());
        }
        {
            TypeType theTYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ConnectionListPropertyType that = ((ConnectionListPropertyType) object);
        {
            ConnectionListType lhsConnectionList;
            lhsConnectionList = this.getConnectionList();
            ConnectionListType rhsConnectionList;
            rhsConnectionList = that.getConnectionList();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "connectionList", lhsConnectionList), LocatorUtils.property(thatLocator, "connectionList", rhsConnectionList), lhsConnectionList, rhsConnectionList, this.isSetConnectionList(), that.isSetConnectionList())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            ConnectionListType theConnectionList;
            theConnectionList = this.getConnectionList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "connectionList", theConnectionList), currentHashCode, theConnectionList, this.isSetConnectionList());
        }
        {
            TypeType theTYPE;
            theTYPE = this.getTYPE();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ConnectionListPropertyType) {
            final ConnectionListPropertyType copy = ((ConnectionListPropertyType) draftCopy);
            {
                Boolean connectionListShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetConnectionList());
                if (connectionListShouldBeCopiedAndSet == Boolean.TRUE) {
                    ConnectionListType sourceConnectionList;
                    sourceConnectionList = this.getConnectionList();
                    ConnectionListType copyConnectionList = ((ConnectionListType) strategy.copy(LocatorUtils.property(locator, "connectionList", sourceConnectionList), sourceConnectionList, this.isSetConnectionList()));
                    copy.setConnectionList(copyConnectionList);
                } else {
                    if (connectionListShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.connectionList = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ConnectionListPropertyType) {
            final ConnectionListPropertyType target = this;
            final ConnectionListPropertyType leftObject = ((ConnectionListPropertyType) left);
            final ConnectionListPropertyType rightObject = ((ConnectionListPropertyType) right);
            {
                Boolean connectionListShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetConnectionList(), rightObject.isSetConnectionList());
                if (connectionListShouldBeMergedAndSet == Boolean.TRUE) {
                    ConnectionListType lhsConnectionList;
                    lhsConnectionList = leftObject.getConnectionList();
                    ConnectionListType rhsConnectionList;
                    rhsConnectionList = rightObject.getConnectionList();
                    ConnectionListType mergedConnectionList = ((ConnectionListType) strategy.merge(LocatorUtils.property(leftLocator, "connectionList", lhsConnectionList), LocatorUtils.property(rightLocator, "connectionList", rhsConnectionList), lhsConnectionList, rhsConnectionList, leftObject.isSetConnectionList(), rightObject.isSetConnectionList()));
                    target.setConnectionList(mergedConnectionList);
                } else {
                    if (connectionListShouldBeMergedAndSet == Boolean.FALSE) {
                        target.connectionList = null;
                    }
                }
            }
            {
    ...
    public ConnectionListPropertyType withConnectionList(ConnectionListType value) {
        setConnectionList(value);
        return this;
    }

    public ConnectionListPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public ConnectionListPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public ConnectionListPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public ConnectionListPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public ConnectionListPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public ConnectionListPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ConnectionListPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
