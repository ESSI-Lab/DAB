...
public class SimpleProcessPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetSimpleProcess() {
        return (this.simpleProcess!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            SimpleProcessType theSimpleProcess;
            theSimpleProcess = this.getSimpleProcess();
            strategy.appendField(locator, this, "simpleProcess", buffer, theSimpleProcess, this.isSetSimpleProcess());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SimpleProcessPropertyType that = ((SimpleProcessPropertyType) object);
        {
            SimpleProcessType lhsSimpleProcess;
            lhsSimpleProcess = this.getSimpleProcess();
            SimpleProcessType rhsSimpleProcess;
            rhsSimpleProcess = that.getSimpleProcess();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "simpleProcess", lhsSimpleProcess), LocatorUtils.property(thatLocator, "simpleProcess", rhsSimpleProcess), lhsSimpleProcess, rhsSimpleProcess, this.isSetSimpleProcess(), that.isSetSimpleProcess())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            SimpleProcessType theSimpleProcess;
            theSimpleProcess = this.getSimpleProcess();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "simpleProcess", theSimpleProcess), currentHashCode, theSimpleProcess, this.isSetSimpleProcess());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SimpleProcessPropertyType) {
            final SimpleProcessPropertyType copy = ((SimpleProcessPropertyType) draftCopy);
            {
                Boolean simpleProcessShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSimpleProcess());
                if (simpleProcessShouldBeCopiedAndSet == Boolean.TRUE) {
                    SimpleProcessType sourceSimpleProcess;
                    sourceSimpleProcess = this.getSimpleProcess();
                    SimpleProcessType copySimpleProcess = ((SimpleProcessType) strategy.copy(LocatorUtils.property(locator, "simpleProcess", sourceSimpleProcess), sourceSimpleProcess, this.isSetSimpleProcess()));
                    copy.setSimpleProcess(copySimpleProcess);
                } else {
                    if (simpleProcessShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.simpleProcess = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SimpleProcessPropertyType) {
            final SimpleProcessPropertyType target = this;
            final SimpleProcessPropertyType leftObject = ((SimpleProcessPropertyType) left);
            final SimpleProcessPropertyType rightObject = ((SimpleProcessPropertyType) right);
            {
                Boolean simpleProcessShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSimpleProcess(), rightObject.isSetSimpleProcess());
                if (simpleProcessShouldBeMergedAndSet == Boolean.TRUE) {
                    SimpleProcessType lhsSimpleProcess;
                    lhsSimpleProcess = leftObject.getSimpleProcess();
                    SimpleProcessType rhsSimpleProcess;
                    rhsSimpleProcess = rightObject.getSimpleProcess();
                    SimpleProcessType mergedSimpleProcess = ((SimpleProcessType) strategy.merge(LocatorUtils.property(leftLocator, "simpleProcess", lhsSimpleProcess), LocatorUtils.property(rightLocator, "simpleProcess", rhsSimpleProcess), lhsSimpleProcess, rhsSimpleProcess, leftObject.isSetSimpleProcess(), rightObject.isSetSimpleProcess()));
                    target.setSimpleProcess(mergedSimpleProcess);
                } else {
                    if (simpleProcessShouldBeMergedAndSet == Boolean.FALSE) {
                        target.simpleProcess = null;
                    }
                }
            }
            {
    ...
    public SimpleProcessPropertyType withSimpleProcess(SimpleProcessType value) {
        setSimpleProcess(value);
        return this;
    }

    public SimpleProcessPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public SimpleProcessPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public SimpleProcessPropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public SimpleProcessPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SimpleProcessPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public SimpleProcessPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public SimpleProcessPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SimpleProcessPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SimpleProcessPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SimpleProcessPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public SimpleProcessPropertyType withOwns(boolean value) {
        setOwns(value);
        return this;
    }

    public SimpleProcessPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
