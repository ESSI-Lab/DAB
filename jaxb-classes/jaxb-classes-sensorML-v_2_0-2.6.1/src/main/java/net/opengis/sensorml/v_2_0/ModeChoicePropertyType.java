...
public class ModeChoicePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetModeChoice() {
        return (this.modeChoice!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ModeChoiceType theModeChoice;
            theModeChoice = this.getModeChoice();
            strategy.appendField(locator, this, "modeChoice", buffer, theModeChoice, this.isSetModeChoice());
        }
        {
            TypeType theTYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ModeChoicePropertyType that = ((ModeChoicePropertyType) object);
        {
            ModeChoiceType lhsModeChoice;
            lhsModeChoice = this.getModeChoice();
            ModeChoiceType rhsModeChoice;
            rhsModeChoice = that.getModeChoice();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "modeChoice", lhsModeChoice), LocatorUtils.property(thatLocator, "modeChoice", rhsModeChoice), lhsModeChoice, rhsModeChoice, this.isSetModeChoice(), that.isSetModeChoice())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            ModeChoiceType theModeChoice;
            theModeChoice = this.getModeChoice();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "modeChoice", theModeChoice), currentHashCode, theModeChoice, this.isSetModeChoice());
        }
        {
            TypeType theTYPE;
            theTYPE = this.getTYPE();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ModeChoicePropertyType) {
            final ModeChoicePropertyType copy = ((ModeChoicePropertyType) draftCopy);
            {
                Boolean modeChoiceShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetModeChoice());
                if (modeChoiceShouldBeCopiedAndSet == Boolean.TRUE) {
                    ModeChoiceType sourceModeChoice;
                    sourceModeChoice = this.getModeChoice();
                    ModeChoiceType copyModeChoice = ((ModeChoiceType) strategy.copy(LocatorUtils.property(locator, "modeChoice", sourceModeChoice), sourceModeChoice, this.isSetModeChoice()));
                    copy.setModeChoice(copyModeChoice);
                } else {
                    if (modeChoiceShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.modeChoice = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ModeChoicePropertyType) {
            final ModeChoicePropertyType target = this;
            final ModeChoicePropertyType leftObject = ((ModeChoicePropertyType) left);
            final ModeChoicePropertyType rightObject = ((ModeChoicePropertyType) right);
            {
                Boolean modeChoiceShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetModeChoice(), rightObject.isSetModeChoice());
                if (modeChoiceShouldBeMergedAndSet == Boolean.TRUE) {
                    ModeChoiceType lhsModeChoice;
                    lhsModeChoice = leftObject.getModeChoice();
                    ModeChoiceType rhsModeChoice;
                    rhsModeChoice = rightObject.getModeChoice();
                    ModeChoiceType mergedModeChoice = ((ModeChoiceType) strategy.merge(LocatorUtils.property(leftLocator, "modeChoice", lhsModeChoice), LocatorUtils.property(rightLocator, "modeChoice", rhsModeChoice), lhsModeChoice, rhsModeChoice, leftObject.isSetModeChoice(), rightObject.isSetModeChoice()));
                    target.setModeChoice(mergedModeChoice);
                } else {
                    if (modeChoiceShouldBeMergedAndSet == Boolean.FALSE) {
                        target.modeChoice = null;
                    }
                }
            }
            {
    ...
    public ModeChoicePropertyType withModeChoice(ModeChoiceType value) {
        setModeChoice(value);
        return this;
    }

    public ModeChoicePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public ModeChoicePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public ModeChoicePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public ModeChoicePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public ModeChoicePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public ModeChoicePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ModeChoicePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
