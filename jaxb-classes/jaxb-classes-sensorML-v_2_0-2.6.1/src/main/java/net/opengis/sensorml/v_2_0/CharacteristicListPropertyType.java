...
@XmlSeeAlso({
    DescribedObjectType.Characteristics.class
})
public class CharacteristicListPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetCharacteristicList() {
        return (this.characteristicList!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            CharacteristicListType theCharacteristicList;
            theCharacteristicList = this.getCharacteristicList();
            strategy.appendField(locator, this, "characteristicList", buffer, theCharacteristicList, this.isSetCharacteristicList());
        }
        {
            TypeType theTYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CharacteristicListPropertyType that = ((CharacteristicListPropertyType) object);
        {
            CharacteristicListType lhsCharacteristicList;
            lhsCharacteristicList = this.getCharacteristicList();
            CharacteristicListType rhsCharacteristicList;
            rhsCharacteristicList = that.getCharacteristicList();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "characteristicList", lhsCharacteristicList), LocatorUtils.property(thatLocator, "characteristicList", rhsCharacteristicList), lhsCharacteristicList, rhsCharacteristicList, this.isSetCharacteristicList(), that.isSetCharacteristicList())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            CharacteristicListType theCharacteristicList;
            theCharacteristicList = this.getCharacteristicList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "characteristicList", theCharacteristicList), currentHashCode, theCharacteristicList, this.isSetCharacteristicList());
        }
        {
            TypeType theTYPE;
            theTYPE = this.getTYPE();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CharacteristicListPropertyType) {
            final CharacteristicListPropertyType copy = ((CharacteristicListPropertyType) draftCopy);
            {
                Boolean characteristicListShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCharacteristicList());
                if (characteristicListShouldBeCopiedAndSet == Boolean.TRUE) {
                    CharacteristicListType sourceCharacteristicList;
                    sourceCharacteristicList = this.getCharacteristicList();
                    CharacteristicListType copyCharacteristicList = ((CharacteristicListType) strategy.copy(LocatorUtils.property(locator, "characteristicList", sourceCharacteristicList), sourceCharacteristicList, this.isSetCharacteristicList()));
                    copy.setCharacteristicList(copyCharacteristicList);
                } else {
                    if (characteristicListShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CharacteristicListPropertyType) {
            final CharacteristicListPropertyType target = this;
            final CharacteristicListPropertyType leftObject = ((CharacteristicListPropertyType) left);
            final CharacteristicListPropertyType rightObject = ((CharacteristicListPropertyType) right);
            {
                Boolean characteristicListShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCharacteristicList(), rightObject.isSetCharacteristicList());
                if (characteristicListShouldBeMergedAndSet == Boolean.TRUE) {
                    CharacteristicListType lhsCharacteristicList;
                    lhsCharacteristicList = leftObject.getCharacteristicList();
                    CharacteristicListType rhsCharacteristicList;
                    rhsCharacteristicList = rightObject.getCharacteristicList();
                    CharacteristicListType mergedCharacteristicList = ((CharacteristicListType) strategy.merge(LocatorUtils.property(leftLocator, "characteristicList", lhsCharacteristicList), LocatorUtils.property(rightLocator, "characteristicList", rhsCharacteristicList), lhsCharacteristicList, rhsCharacteristicList, leftObject.isSetCharacteristicList(), rightObject.isSetCharacteristicList()));
                    target.setCharacteristicList(mergedCharacteristicList);
                } else {
                    if (characteristicListShouldBeMergedAndSet == Boolean.FALSE) {
                        target.characteristicList = null;
                    }
                }
            }
            {
    ...
    public CharacteristicListPropertyType withCharacteristicList(CharacteristicListType value) {
        setCharacteristicList(value);
        return this;
    }

    public CharacteristicListPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public CharacteristicListPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public CharacteristicListPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public CharacteristicListPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public CharacteristicListPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public CharacteristicListPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public CharacteristicListPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
