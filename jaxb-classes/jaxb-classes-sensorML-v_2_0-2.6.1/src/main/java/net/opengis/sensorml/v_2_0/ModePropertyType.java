...
public class ModePropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ModePropertyType that = ((ModePropertyType) object);
        {
            ModeType lhsMode;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ModePropertyType) {
            final ModePropertyType copy = ((ModePropertyType) draftCopy);
            {
                ...
                if (modeShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    ModeType copyMode = ((ModeType) strategy.copy(LocatorUtils.property(locator, "mode", sourceMode), sourceMode, this.isSetMode()));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ModePropertyType) {
            final ModePropertyType target = this;
            final ModePropertyType leftObject = ((ModePropertyType) left);
            final ModePropertyType rightObject = ((ModePropertyType) right);
            {
                ...
                if (modeShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    ModeType mergedMode = ((ModeType) strategy.merge(LocatorUtils.property(leftLocator, "mode", lhsMode), LocatorUtils.property(rightLocator, "mode", rhsMode), lhsMode, rhsMode, leftObject.isSetMode(), rightObject.isSetMode()));
    ...
    public ModePropertyType withMode(ModeType value) {
        setMode(value);
        return this;
    }

    public ModePropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public ModePropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public ModePropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public ModePropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public ModePropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public ModePropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ModePropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
