...
public class ContactListPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ContactListType theContactList;
            theContactList = this.getContactList();
            strategy.appendField(locator, this, "contactList", buffer, theContactList, this.isSetContactList());
        }
        {
            TypeType theTYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ContactListPropertyType that = ((ContactListPropertyType) object);
        {
            ContactListType lhsContactList;
            lhsContactList = this.getContactList();
            ContactListType rhsContactList;
            rhsContactList = that.getContactList();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "contactList", lhsContactList), LocatorUtils.property(thatLocator, "contactList", rhsContactList), lhsContactList, rhsContactList, this.isSetContactList(), that.isSetContactList())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            ContactListType theContactList;
            theContactList = this.getContactList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "contactList", theContactList), currentHashCode, theContactList, this.isSetContactList());
        }
        {
            TypeType theTYPE;
            theTYPE = this.getTYPE();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ContactListPropertyType) {
            final ContactListPropertyType copy = ((ContactListPropertyType) draftCopy);
            {
                Boolean contactListShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetContactList());
                if (contactListShouldBeCopiedAndSet == Boolean.TRUE) {
                    ContactListType sourceContactList;
                    sourceContactList = this.getContactList();
                    ContactListType copyContactList = ((ContactListType) strategy.copy(LocatorUtils.property(locator, "contactList", sourceContactList), sourceContactList, this.isSetContactList()));
                    copy.setContactList(copyContactList);
                } else {
                    if (contactListShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.contactList = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ContactListPropertyType) {
            final ContactListPropertyType target = this;
            final ContactListPropertyType leftObject = ((ContactListPropertyType) left);
            final ContactListPropertyType rightObject = ((ContactListPropertyType) right);
            {
                Boolean contactListShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetContactList(), rightObject.isSetContactList());
                if (contactListShouldBeMergedAndSet == Boolean.TRUE) {
                    ContactListType lhsContactList;
                    lhsContactList = leftObject.getContactList();
                    ContactListType rhsContactList;
                    rhsContactList = rightObject.getContactList();
                    ContactListType mergedContactList = ((ContactListType) strategy.merge(LocatorUtils.property(leftLocator, "contactList", lhsContactList), LocatorUtils.property(rightLocator, "contactList", rhsContactList), lhsContactList, rhsContactList, leftObject.isSetContactList(), rightObject.isSetContactList()));
                    target.setContactList(mergedContactList);
                } else {
                    if (contactListShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public ContactListPropertyType withContactList(ContactListType value) {
        setContactList(value);
        return this;
    }

    public ContactListPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public ContactListPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public ContactListPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public ContactListPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public ContactListPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public ContactListPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ContactListPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
