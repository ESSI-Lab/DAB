...
public class ComponentListPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ComponentListType theComponentList;
            theComponentList = this.getComponentList();
            strategy.appendField(locator, this, "componentList", buffer, theComponentList, this.isSetComponentList());
        }
        {
            TypeType theTYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ComponentListPropertyType that = ((ComponentListPropertyType) object);
        {
            ComponentListType lhsComponentList;
            lhsComponentList = this.getComponentList();
            ComponentListType rhsComponentList;
            rhsComponentList = that.getComponentList();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "componentList", lhsComponentList), LocatorUtils.property(thatLocator, "componentList", rhsComponentList), lhsComponentList, rhsComponentList, this.isSetComponentList(), that.isSetComponentList())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            ComponentListType theComponentList;
            theComponentList = this.getComponentList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "componentList", theComponentList), currentHashCode, theComponentList, this.isSetComponentList());
        }
        {
            TypeType theTYPE;
            theTYPE = this.getTYPE();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ComponentListPropertyType) {
            final ComponentListPropertyType copy = ((ComponentListPropertyType) draftCopy);
            {
                Boolean componentListShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetComponentList());
                if (componentListShouldBeCopiedAndSet == Boolean.TRUE) {
                    ComponentListType sourceComponentList;
                    sourceComponentList = this.getComponentList();
                    ComponentListType copyComponentList = ((ComponentListType) strategy.copy(LocatorUtils.property(locator, "componentList", sourceComponentList), sourceComponentList, this.isSetComponentList()));
                    copy.setComponentList(copyComponentList);
                } else {
                    if (componentListShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.componentList = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ComponentListPropertyType) {
            final ComponentListPropertyType target = this;
            final ComponentListPropertyType leftObject = ((ComponentListPropertyType) left);
            final ComponentListPropertyType rightObject = ((ComponentListPropertyType) right);
            {
                Boolean componentListShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetComponentList(), rightObject.isSetComponentList());
                if (componentListShouldBeMergedAndSet == Boolean.TRUE) {
                    ComponentListType lhsComponentList;
                    lhsComponentList = leftObject.getComponentList();
                    ComponentListType rhsComponentList;
                    rhsComponentList = rightObject.getComponentList();
                    ComponentListType mergedComponentList = ((ComponentListType) strategy.merge(LocatorUtils.property(leftLocator, "componentList", lhsComponentList), LocatorUtils.property(rightLocator, "componentList", rhsComponentList), lhsComponentList, rhsComponentList, leftObject.isSetComponentList(), rightObject.isSetComponentList()));
                    target.setComponentList(mergedComponentList);
                } else {
                    if (componentListShouldBeMergedAndSet == Boolean.FALSE) {
                        target.componentList = null;
                    }
                }
            }
            {
    ...
    public ComponentListPropertyType withComponentList(ComponentListType value) {
        setComponentList(value);
        return this;
    }

    public ComponentListPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public ComponentListPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public ComponentListPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public ComponentListPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public ComponentListPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public ComponentListPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ComponentListPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
