...
public class DocumentListPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            DocumentListType theDocumentList;
            theDocumentList = this.getDocumentList();
            strategy.appendField(locator, this, "documentList", buffer, theDocumentList, this.isSetDocumentList());
        }
        {
            TypeType theTYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DocumentListPropertyType that = ((DocumentListPropertyType) object);
        {
            DocumentListType lhsDocumentList;
            lhsDocumentList = this.getDocumentList();
            DocumentListType rhsDocumentList;
            rhsDocumentList = that.getDocumentList();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "documentList", lhsDocumentList), LocatorUtils.property(thatLocator, "documentList", rhsDocumentList), lhsDocumentList, rhsDocumentList, this.isSetDocumentList(), that.isSetDocumentList())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            DocumentListType theDocumentList;
            theDocumentList = this.getDocumentList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "documentList", theDocumentList), currentHashCode, theDocumentList, this.isSetDocumentList());
        }
        {
            TypeType theTYPE;
            theTYPE = this.getTYPE();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DocumentListPropertyType) {
            final DocumentListPropertyType copy = ((DocumentListPropertyType) draftCopy);
            {
                Boolean documentListShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDocumentList());
                if (documentListShouldBeCopiedAndSet == Boolean.TRUE) {
                    DocumentListType sourceDocumentList;
                    sourceDocumentList = this.getDocumentList();
                    DocumentListType copyDocumentList = ((DocumentListType) strategy.copy(LocatorUtils.property(locator, "documentList", sourceDocumentList), sourceDocumentList, this.isSetDocumentList()));
                    copy.setDocumentList(copyDocumentList);
                } else {
                    if (documentListShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.documentList = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DocumentListPropertyType) {
            final DocumentListPropertyType target = this;
            final DocumentListPropertyType leftObject = ((DocumentListPropertyType) left);
            final DocumentListPropertyType rightObject = ((DocumentListPropertyType) right);
            {
                Boolean documentListShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDocumentList(), rightObject.isSetDocumentList());
                if (documentListShouldBeMergedAndSet == Boolean.TRUE) {
                    DocumentListType lhsDocumentList;
                    lhsDocumentList = leftObject.getDocumentList();
                    DocumentListType rhsDocumentList;
                    rhsDocumentList = rightObject.getDocumentList();
                    DocumentListType mergedDocumentList = ((DocumentListType) strategy.merge(LocatorUtils.property(leftLocator, "documentList", lhsDocumentList), LocatorUtils.property(rightLocator, "documentList", rhsDocumentList), lhsDocumentList, rhsDocumentList, leftObject.isSetDocumentList(), rightObject.isSetDocumentList()));
                    target.setDocumentList(mergedDocumentList);
                } else {
                    if (documentListShouldBeMergedAndSet == Boolean.FALSE) {
                        target.documentList = null;
                    }
                }
            }
            {
    ...
    public DocumentListPropertyType withDocumentList(DocumentListType value) {
        setDocumentList(value);
        return this;
    }

    public DocumentListPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DocumentListPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DocumentListPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DocumentListPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DocumentListPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DocumentListPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DocumentListPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
