...
public class DescribedObjectPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetDescribedObject() {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            JAXBElement<? extends DescribedObjectType> theDescribedObject;
            theDescribedObject = this.getDescribedObject();
            strategy.appendField(locator, this, "describedObject", buffer, theDescribedObject, this.isSetDescribedObject());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DescribedObjectPropertyType that = ((DescribedObjectPropertyType) object);
        {
            JAXBElement<? extends DescribedObjectType> lhsDescribedObject;
            lhsDescribedObject = this.getDescribedObject();
            JAXBElement<? extends DescribedObjectType> rhsDescribedObject;
            rhsDescribedObject = that.getDescribedObject();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "describedObject", lhsDescribedObject), LocatorUtils.property(thatLocator, "describedObject", rhsDescribedObject), lhsDescribedObject, rhsDescribedObject, this.isSetDescribedObject(), that.isSetDescribedObject())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends DescribedObjectType> theDescribedObject;
            theDescribedObject = this.getDescribedObject();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "describedObject", theDescribedObject), currentHashCode, theDescribedObject, this.isSetDescribedObject());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DescribedObjectPropertyType) {
            final DescribedObjectPropertyType copy = ((DescribedObjectPropertyType) draftCopy);
            {
                Boolean describedObjectShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDescribedObject());
                if (describedObjectShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends DescribedObjectType> sourceDescribedObject;
                    sourceDescribedObject = this.getDescribedObject();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends DescribedObjectType> copyDescribedObject = ((JAXBElement<? extends DescribedObjectType> ) strategy.copy(LocatorUtils.property(locator, "describedObject", sourceDescribedObject), sourceDescribedObject, this.isSetDescribedObject()));
                    copy.setDescribedObject(copyDescribedObject);
                } else {
                    if (describedObjectShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.describedObject = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DescribedObjectPropertyType) {
            final DescribedObjectPropertyType target = this;
            final DescribedObjectPropertyType leftObject = ((DescribedObjectPropertyType) left);
            final DescribedObjectPropertyType rightObject = ((DescribedObjectPropertyType) right);
            {
                Boolean describedObjectShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDescribedObject(), rightObject.isSetDescribedObject());
                if (describedObjectShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends DescribedObjectType> lhsDescribedObject;
                    lhsDescribedObject = leftObject.getDescribedObject();
                    JAXBElement<? extends DescribedObjectType> rhsDescribedObject;
                    rhsDescribedObject = rightObject.getDescribedObject();
                    JAXBElement<? extends DescribedObjectType> mergedDescribedObject = ((JAXBElement<? extends DescribedObjectType> ) strategy.merge(LocatorUtils.property(leftLocator, "describedObject", lhsDescribedObject), LocatorUtils.property(rightLocator, "describedObject", rhsDescribedObject), lhsDescribedObject, rhsDescribedObject, leftObject.isSetDescribedObject(), rightObject.isSetDescribedObject()));
                    target.setDescribedObject(mergedDescribedObject);
                } else {
                    if (describedObjectShouldBeMergedAndSet == Boolean.FALSE) {
                        target.describedObject = null;
                    }
                }
            }
            {
    ...
    public DescribedObjectPropertyType withDescribedObject(JAXBElement<? extends DescribedObjectType> value) {
        setDescribedObject(value);
        return this;
    }

    public DescribedObjectPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public DescribedObjectPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public DescribedObjectPropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public DescribedObjectPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public DescribedObjectPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public DescribedObjectPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public DescribedObjectPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public DescribedObjectPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public DescribedObjectPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public DescribedObjectPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public DescribedObjectPropertyType withOwns(boolean value) {
        setOwns(value);
        return this;
    }

    public DescribedObjectPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
