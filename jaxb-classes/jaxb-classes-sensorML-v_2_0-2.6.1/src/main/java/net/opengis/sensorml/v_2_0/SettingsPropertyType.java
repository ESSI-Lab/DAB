...
public class SettingsPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "settings", buffer, theSettings, this.isSetSettings());
        }
        {
            TypeType theTYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SettingsPropertyType that = ((SettingsPropertyType) object);
        {
            SettingsType lhsSettings;
            lhsSettings = this.getSettings();
            SettingsType rhsSettings;
            rhsSettings = that.getSettings();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "settings", lhsSettings), LocatorUtils.property(thatLocator, "settings", rhsSettings), lhsSettings, rhsSettings, this.isSetSettings(), that.isSetSettings())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            SettingsType theSettings;
            theSettings = this.getSettings();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "settings", theSettings), currentHashCode, theSettings, this.isSetSettings());
        }
        {
            TypeType theTYPE;
            theTYPE = this.getTYPE();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SettingsPropertyType) {
            final SettingsPropertyType copy = ((SettingsPropertyType) draftCopy);
            {
                Boolean settingsShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSettings());
                if (settingsShouldBeCopiedAndSet == Boolean.TRUE) {
                    SettingsType sourceSettings;
                    sourceSettings = this.getSettings();
                    SettingsType copySettings = ((SettingsType) strategy.copy(LocatorUtils.property(locator, "settings", sourceSettings), sourceSettings, this.isSetSettings()));
                    copy.setSettings(copySettings);
                } else {
                    if (settingsShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.settings = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SettingsPropertyType) {
            final SettingsPropertyType target = this;
            final SettingsPropertyType leftObject = ((SettingsPropertyType) left);
            final SettingsPropertyType rightObject = ((SettingsPropertyType) right);
            {
                Boolean settingsShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSettings(), rightObject.isSetSettings());
                if (settingsShouldBeMergedAndSet == Boolean.TRUE) {
                    SettingsType lhsSettings;
                    lhsSettings = leftObject.getSettings();
                    SettingsType rhsSettings;
                    rhsSettings = rightObject.getSettings();
                    SettingsType mergedSettings = ((SettingsType) strategy.merge(LocatorUtils.property(leftLocator, "settings", lhsSettings), LocatorUtils.property(rightLocator, "settings", rhsSettings), lhsSettings, rhsSettings, leftObject.isSetSettings(), rightObject.isSetSettings()));
                    target.setSettings(mergedSettings);
                } else {
                    if (settingsShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public SettingsPropertyType withSettings(SettingsType value) {
        setSettings(value);
        return this;
    }

    public SettingsPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public SettingsPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public SettingsPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public SettingsPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public SettingsPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public SettingsPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public SettingsPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
