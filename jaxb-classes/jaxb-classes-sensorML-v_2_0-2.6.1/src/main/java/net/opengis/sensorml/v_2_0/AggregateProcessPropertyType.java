...
public class AggregateProcessPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetAggregateProcess() {
        return (this.aggregateProcess!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            AggregateProcessType theAggregateProcess;
            theAggregateProcess = this.getAggregateProcess();
            strategy.appendField(locator, this, "aggregateProcess", buffer, theAggregateProcess, this.isSetAggregateProcess());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final AggregateProcessPropertyType that = ((AggregateProcessPropertyType) object);
        {
            AggregateProcessType lhsAggregateProcess;
            lhsAggregateProcess = this.getAggregateProcess();
            AggregateProcessType rhsAggregateProcess;
            rhsAggregateProcess = that.getAggregateProcess();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "aggregateProcess", lhsAggregateProcess), LocatorUtils.property(thatLocator, "aggregateProcess", rhsAggregateProcess), lhsAggregateProcess, rhsAggregateProcess, this.isSetAggregateProcess(), that.isSetAggregateProcess())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            AggregateProcessType theAggregateProcess;
            theAggregateProcess = this.getAggregateProcess();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "aggregateProcess", theAggregateProcess), currentHashCode, theAggregateProcess, this.isSetAggregateProcess());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof AggregateProcessPropertyType) {
            final AggregateProcessPropertyType copy = ((AggregateProcessPropertyType) draftCopy);
            {
                Boolean aggregateProcessShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAggregateProcess());
                if (aggregateProcessShouldBeCopiedAndSet == Boolean.TRUE) {
                    AggregateProcessType sourceAggregateProcess;
                    sourceAggregateProcess = this.getAggregateProcess();
                    AggregateProcessType copyAggregateProcess = ((AggregateProcessType) strategy.copy(LocatorUtils.property(locator, "aggregateProcess", sourceAggregateProcess), sourceAggregateProcess, this.isSetAggregateProcess()));
                    copy.setAggregateProcess(copyAggregateProcess);
                } else {
                    if (aggregateProcessShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.aggregateProcess = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof AggregateProcessPropertyType) {
            final AggregateProcessPropertyType target = this;
            final AggregateProcessPropertyType leftObject = ((AggregateProcessPropertyType) left);
            final AggregateProcessPropertyType rightObject = ((AggregateProcessPropertyType) right);
            {
                Boolean aggregateProcessShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAggregateProcess(), rightObject.isSetAggregateProcess());
                if (aggregateProcessShouldBeMergedAndSet == Boolean.TRUE) {
                    AggregateProcessType lhsAggregateProcess;
                    lhsAggregateProcess = leftObject.getAggregateProcess();
                    AggregateProcessType rhsAggregateProcess;
                    rhsAggregateProcess = rightObject.getAggregateProcess();
                    AggregateProcessType mergedAggregateProcess = ((AggregateProcessType) strategy.merge(LocatorUtils.property(leftLocator, "aggregateProcess", lhsAggregateProcess), LocatorUtils.property(rightLocator, "aggregateProcess", rhsAggregateProcess), lhsAggregateProcess, rhsAggregateProcess, leftObject.isSetAggregateProcess(), rightObject.isSetAggregateProcess()));
                    target.setAggregateProcess(mergedAggregateProcess);
                } else {
                    if (aggregateProcessShouldBeMergedAndSet == Boolean.FALSE) {
                        target.aggregateProcess = null;
                    }
                }
            }
            {
    ...
    public AggregateProcessPropertyType withAggregateProcess(AggregateProcessType value) {
        setAggregateProcess(value);
        return this;
    }

    public AggregateProcessPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public AggregateProcessPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public AggregateProcessPropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public AggregateProcessPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public AggregateProcessPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public AggregateProcessPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public AggregateProcessPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public AggregateProcessPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public AggregateProcessPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public AggregateProcessPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public AggregateProcessPropertyType withOwns(boolean value) {
        setOwns(value);
        return this;
    }

    public AggregateProcessPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
