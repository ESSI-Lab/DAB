...
public class PhysicalSystemPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetPhysicalSystem() {
        return (this.physicalSystem!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            PhysicalSystemType thePhysicalSystem;
            thePhysicalSystem = this.getPhysicalSystem();
            strategy.appendField(locator, this, "physicalSystem", buffer, thePhysicalSystem, this.isSetPhysicalSystem());
        }
        {
            boolean theOwns;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PhysicalSystemPropertyType that = ((PhysicalSystemPropertyType) object);
        {
            PhysicalSystemType lhsPhysicalSystem;
            lhsPhysicalSystem = this.getPhysicalSystem();
            PhysicalSystemType rhsPhysicalSystem;
            rhsPhysicalSystem = that.getPhysicalSystem();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "physicalSystem", lhsPhysicalSystem), LocatorUtils.property(thatLocator, "physicalSystem", rhsPhysicalSystem), lhsPhysicalSystem, rhsPhysicalSystem, this.isSetPhysicalSystem(), that.isSetPhysicalSystem())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            PhysicalSystemType thePhysicalSystem;
            thePhysicalSystem = this.getPhysicalSystem();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "physicalSystem", thePhysicalSystem), currentHashCode, thePhysicalSystem, this.isSetPhysicalSystem());
        }
        {
            boolean theOwns;
            theOwns = (this.isSetOwns()?this.isOwns():false);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof PhysicalSystemPropertyType) {
            final PhysicalSystemPropertyType copy = ((PhysicalSystemPropertyType) draftCopy);
            {
                Boolean physicalSystemShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetPhysicalSystem());
                if (physicalSystemShouldBeCopiedAndSet == Boolean.TRUE) {
                    PhysicalSystemType sourcePhysicalSystem;
                    sourcePhysicalSystem = this.getPhysicalSystem();
                    PhysicalSystemType copyPhysicalSystem = ((PhysicalSystemType) strategy.copy(LocatorUtils.property(locator, "physicalSystem", sourcePhysicalSystem), sourcePhysicalSystem, this.isSetPhysicalSystem()));
                    copy.setPhysicalSystem(copyPhysicalSystem);
                } else {
                    if (physicalSystemShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.physicalSystem = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof PhysicalSystemPropertyType) {
            final PhysicalSystemPropertyType target = this;
            final PhysicalSystemPropertyType leftObject = ((PhysicalSystemPropertyType) left);
            final PhysicalSystemPropertyType rightObject = ((PhysicalSystemPropertyType) right);
            {
                Boolean physicalSystemShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetPhysicalSystem(), rightObject.isSetPhysicalSystem());
                if (physicalSystemShouldBeMergedAndSet == Boolean.TRUE) {
                    PhysicalSystemType lhsPhysicalSystem;
                    lhsPhysicalSystem = leftObject.getPhysicalSystem();
                    PhysicalSystemType rhsPhysicalSystem;
                    rhsPhysicalSystem = rightObject.getPhysicalSystem();
                    PhysicalSystemType mergedPhysicalSystem = ((PhysicalSystemType) strategy.merge(LocatorUtils.property(leftLocator, "physicalSystem", lhsPhysicalSystem), LocatorUtils.property(rightLocator, "physicalSystem", rhsPhysicalSystem), lhsPhysicalSystem, rhsPhysicalSystem, leftObject.isSetPhysicalSystem(), rightObject.isSetPhysicalSystem()));
                    target.setPhysicalSystem(mergedPhysicalSystem);
                } else {
                    if (physicalSystemShouldBeMergedAndSet == Boolean.FALSE) {
                        target.physicalSystem = null;
                    }
                }
            }
            {
    ...
    public PhysicalSystemPropertyType withPhysicalSystem(PhysicalSystemType value) {
        setPhysicalSystem(value);
        return this;
    }

    public PhysicalSystemPropertyType withOwns(boolean value) {
        setOwns(value);
        return this;
    }

    public PhysicalSystemPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public PhysicalSystemPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public PhysicalSystemPropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public PhysicalSystemPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public PhysicalSystemPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public PhysicalSystemPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public PhysicalSystemPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public PhysicalSystemPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public PhysicalSystemPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public PhysicalSystemPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public PhysicalSystemPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
