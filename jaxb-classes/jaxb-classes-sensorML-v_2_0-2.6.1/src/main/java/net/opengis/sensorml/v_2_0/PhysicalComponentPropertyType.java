...
public class PhysicalComponentPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetPhysicalComponent() {
        return (this.physicalComponent!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            PhysicalComponentType thePhysicalComponent;
            thePhysicalComponent = this.getPhysicalComponent();
            strategy.appendField(locator, this, "physicalComponent", buffer, thePhysicalComponent, this.isSetPhysicalComponent());
        }
        {
            boolean theOwns;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PhysicalComponentPropertyType that = ((PhysicalComponentPropertyType) object);
        {
            PhysicalComponentType lhsPhysicalComponent;
            lhsPhysicalComponent = this.getPhysicalComponent();
            PhysicalComponentType rhsPhysicalComponent;
            rhsPhysicalComponent = that.getPhysicalComponent();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "physicalComponent", lhsPhysicalComponent), LocatorUtils.property(thatLocator, "physicalComponent", rhsPhysicalComponent), lhsPhysicalComponent, rhsPhysicalComponent, this.isSetPhysicalComponent(), that.isSetPhysicalComponent())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            PhysicalComponentType thePhysicalComponent;
            thePhysicalComponent = this.getPhysicalComponent();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "physicalComponent", thePhysicalComponent), currentHashCode, thePhysicalComponent, this.isSetPhysicalComponent());
        }
        {
            boolean theOwns;
            theOwns = (this.isSetOwns()?this.isOwns():false);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof PhysicalComponentPropertyType) {
            final PhysicalComponentPropertyType copy = ((PhysicalComponentPropertyType) draftCopy);
            {
                Boolean physicalComponentShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetPhysicalComponent());
                if (physicalComponentShouldBeCopiedAndSet == Boolean.TRUE) {
                    PhysicalComponentType sourcePhysicalComponent;
                    sourcePhysicalComponent = this.getPhysicalComponent();
                    PhysicalComponentType copyPhysicalComponent = ((PhysicalComponentType) strategy.copy(LocatorUtils.property(locator, "physicalComponent", sourcePhysicalComponent), sourcePhysicalComponent, this.isSetPhysicalComponent()));
                    copy.setPhysicalComponent(copyPhysicalComponent);
                } else {
                    if (physicalComponentShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.physicalComponent = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof PhysicalComponentPropertyType) {
            final PhysicalComponentPropertyType target = this;
            final PhysicalComponentPropertyType leftObject = ((PhysicalComponentPropertyType) left);
            final PhysicalComponentPropertyType rightObject = ((PhysicalComponentPropertyType) right);
            {
                Boolean physicalComponentShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetPhysicalComponent(), rightObject.isSetPhysicalComponent());
                if (physicalComponentShouldBeMergedAndSet == Boolean.TRUE) {
                    PhysicalComponentType lhsPhysicalComponent;
                    lhsPhysicalComponent = leftObject.getPhysicalComponent();
                    PhysicalComponentType rhsPhysicalComponent;
                    rhsPhysicalComponent = rightObject.getPhysicalComponent();
                    PhysicalComponentType mergedPhysicalComponent = ((PhysicalComponentType) strategy.merge(LocatorUtils.property(leftLocator, "physicalComponent", lhsPhysicalComponent), LocatorUtils.property(rightLocator, "physicalComponent", rhsPhysicalComponent), lhsPhysicalComponent, rhsPhysicalComponent, leftObject.isSetPhysicalComponent(), rightObject.isSetPhysicalComponent()));
                    target.setPhysicalComponent(mergedPhysicalComponent);
                } else {
                    if (physicalComponentShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public PhysicalComponentPropertyType withPhysicalComponent(PhysicalComponentType value) {
        setPhysicalComponent(value);
        return this;
    }

    public PhysicalComponentPropertyType withOwns(boolean value) {
        setOwns(value);
        return this;
    }

    public PhysicalComponentPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public PhysicalComponentPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public PhysicalComponentPropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public PhysicalComponentPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public PhysicalComponentPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public PhysicalComponentPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public PhysicalComponentPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public PhysicalComponentPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public PhysicalComponentPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public PhysicalComponentPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public PhysicalComponentPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
