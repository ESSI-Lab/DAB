...
public class AbstractMetadataListPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetAbstractMetadataList() {
        return (this.abstractMetadataList!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            JAXBElement<? extends AbstractMetadataListType> theAbstractMetadataList;
            theAbstractMetadataList = this.getAbstractMetadataList();
            strategy.appendField(locator, this, "abstractMetadataList", buffer, theAbstractMetadataList, this.isSetAbstractMetadataList());
        }
        {
            TypeType theTYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final AbstractMetadataListPropertyType that = ((AbstractMetadataListPropertyType) object);
        {
            JAXBElement<? extends AbstractMetadataListType> lhsAbstractMetadataList;
            lhsAbstractMetadataList = this.getAbstractMetadataList();
            JAXBElement<? extends AbstractMetadataListType> rhsAbstractMetadataList;
            rhsAbstractMetadataList = that.getAbstractMetadataList();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractMetadataList", lhsAbstractMetadataList), LocatorUtils.property(thatLocator, "abstractMetadataList", rhsAbstractMetadataList), lhsAbstractMetadataList, rhsAbstractMetadataList, this.isSetAbstractMetadataList(), that.isSetAbstractMetadataList())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractMetadataListType> theAbstractMetadataList;
            theAbstractMetadataList = this.getAbstractMetadataList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractMetadataList", theAbstractMetadataList), currentHashCode, theAbstractMetadataList, this.isSetAbstractMetadataList());
        }
        {
            TypeType theTYPE;
            theTYPE = this.getTYPE();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof AbstractMetadataListPropertyType) {
            final AbstractMetadataListPropertyType copy = ((AbstractMetadataListPropertyType) draftCopy);
            {
                Boolean abstractMetadataListShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractMetadataList());
                if (abstractMetadataListShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractMetadataListType> sourceAbstractMetadataList;
                    sourceAbstractMetadataList = this.getAbstractMetadataList();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractMetadataListType> copyAbstractMetadataList = ((JAXBElement<? extends AbstractMetadataListType> ) strategy.copy(LocatorUtils.property(locator, "abstractMetadataList", sourceAbstractMetadataList), sourceAbstractMetadataList, this.isSetAbstractMetadataList()));
                    copy.setAbstractMetadataList(copyAbstractMetadataList);
                } else {
                    if (abstractMetadataListShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.abstractMetadataList = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof AbstractMetadataListPropertyType) {
            final AbstractMetadataListPropertyType target = this;
            final AbstractMetadataListPropertyType leftObject = ((AbstractMetadataListPropertyType) left);
            final AbstractMetadataListPropertyType rightObject = ((AbstractMetadataListPropertyType) right);
            {
                Boolean abstractMetadataListShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractMetadataList(), rightObject.isSetAbstractMetadataList());
                if (abstractMetadataListShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractMetadataListType> lhsAbstractMetadataList;
                    lhsAbstractMetadataList = leftObject.getAbstractMetadataList();
                    JAXBElement<? extends AbstractMetadataListType> rhsAbstractMetadataList;
                    rhsAbstractMetadataList = rightObject.getAbstractMetadataList();
                    JAXBElement<? extends AbstractMetadataListType> mergedAbstractMetadataList = ((JAXBElement<? extends AbstractMetadataListType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractMetadataList", lhsAbstractMetadataList), LocatorUtils.property(rightLocator, "abstractMetadataList", rhsAbstractMetadataList), lhsAbstractMetadataList, rhsAbstractMetadataList, leftObject.isSetAbstractMetadataList(), rightObject.isSetAbstractMetadataList()));
                    target.setAbstractMetadataList(mergedAbstractMetadataList);
                } else {
                    if (abstractMetadataListShouldBeMergedAndSet == Boolean.FALSE) {
                        target.abstractMetadataList = null;
                    }
                }
            }
            {
    ...
    public AbstractMetadataListPropertyType withAbstractMetadataList(JAXBElement<? extends AbstractMetadataListType> value) {
        setAbstractMetadataList(value);
        return this;
    }

    public AbstractMetadataListPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public AbstractMetadataListPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public AbstractMetadataListPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public AbstractMetadataListPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public AbstractMetadataListPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public AbstractMetadataListPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public AbstractMetadataListPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
