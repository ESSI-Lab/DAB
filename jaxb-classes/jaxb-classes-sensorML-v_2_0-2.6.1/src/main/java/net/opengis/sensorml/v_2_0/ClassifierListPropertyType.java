...
public class ClassifierListPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ClassifierListType theClassifierList;
            theClassifierList = this.getClassifierList();
            strategy.appendField(locator, this, "classifierList", buffer, theClassifierList, this.isSetClassifierList());
        }
        {
            TypeType theTYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ClassifierListPropertyType that = ((ClassifierListPropertyType) object);
        {
            ClassifierListType lhsClassifierList;
            lhsClassifierList = this.getClassifierList();
            ClassifierListType rhsClassifierList;
            rhsClassifierList = that.getClassifierList();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "classifierList", lhsClassifierList), LocatorUtils.property(thatLocator, "classifierList", rhsClassifierList), lhsClassifierList, rhsClassifierList, this.isSetClassifierList(), that.isSetClassifierList())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            ClassifierListType theClassifierList;
            theClassifierList = this.getClassifierList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "classifierList", theClassifierList), currentHashCode, theClassifierList, this.isSetClassifierList());
        }
        {
            TypeType theTYPE;
            theTYPE = this.getTYPE();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ClassifierListPropertyType) {
            final ClassifierListPropertyType copy = ((ClassifierListPropertyType) draftCopy);
            {
                Boolean classifierListShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetClassifierList());
                if (classifierListShouldBeCopiedAndSet == Boolean.TRUE) {
                    ClassifierListType sourceClassifierList;
                    sourceClassifierList = this.getClassifierList();
                    ClassifierListType copyClassifierList = ((ClassifierListType) strategy.copy(LocatorUtils.property(locator, "classifierList", sourceClassifierList), sourceClassifierList, this.isSetClassifierList()));
                    copy.setClassifierList(copyClassifierList);
                } else {
                    if (classifierListShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.classifierList = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ClassifierListPropertyType) {
            final ClassifierListPropertyType target = this;
            final ClassifierListPropertyType leftObject = ((ClassifierListPropertyType) left);
            final ClassifierListPropertyType rightObject = ((ClassifierListPropertyType) right);
            {
                Boolean classifierListShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetClassifierList(), rightObject.isSetClassifierList());
                if (classifierListShouldBeMergedAndSet == Boolean.TRUE) {
                    ClassifierListType lhsClassifierList;
                    lhsClassifierList = leftObject.getClassifierList();
                    ClassifierListType rhsClassifierList;
                    rhsClassifierList = rightObject.getClassifierList();
                    ClassifierListType mergedClassifierList = ((ClassifierListType) strategy.merge(LocatorUtils.property(leftLocator, "classifierList", lhsClassifierList), LocatorUtils.property(rightLocator, "classifierList", rhsClassifierList), lhsClassifierList, rhsClassifierList, leftObject.isSetClassifierList(), rightObject.isSetClassifierList()));
                    target.setClassifierList(mergedClassifierList);
                } else {
                    if (classifierListShouldBeMergedAndSet == Boolean.FALSE) {
                        target.classifierList = null;
                    }
                }
            }
            {
    ...
    public ClassifierListPropertyType withClassifierList(ClassifierListType value) {
        setClassifierList(value);
        return this;
    }

    public ClassifierListPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public ClassifierListPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public ClassifierListPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public ClassifierListPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public ClassifierListPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public ClassifierListPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ClassifierListPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
