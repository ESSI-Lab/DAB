...
public class ProcessMethodPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetProcessMethod() {
        return (this.processMethod!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ProcessMethodType theProcessMethod;
            theProcessMethod = this.getProcessMethod();
            strategy.appendField(locator, this, "processMethod", buffer, theProcessMethod, this.isSetProcessMethod());
        }
        {
            TypeType theTYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProcessMethodPropertyType that = ((ProcessMethodPropertyType) object);
        {
            ProcessMethodType lhsProcessMethod;
            lhsProcessMethod = this.getProcessMethod();
            ProcessMethodType rhsProcessMethod;
            rhsProcessMethod = that.getProcessMethod();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "processMethod", lhsProcessMethod), LocatorUtils.property(thatLocator, "processMethod", rhsProcessMethod), lhsProcessMethod, rhsProcessMethod, this.isSetProcessMethod(), that.isSetProcessMethod())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            ProcessMethodType theProcessMethod;
            theProcessMethod = this.getProcessMethod();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "processMethod", theProcessMethod), currentHashCode, theProcessMethod, this.isSetProcessMethod());
        }
        {
            TypeType theTYPE;
            theTYPE = this.getTYPE();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ProcessMethodPropertyType) {
            final ProcessMethodPropertyType copy = ((ProcessMethodPropertyType) draftCopy);
            {
                Boolean processMethodShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetProcessMethod());
                if (processMethodShouldBeCopiedAndSet == Boolean.TRUE) {
                    ProcessMethodType sourceProcessMethod;
                    sourceProcessMethod = this.getProcessMethod();
                    ProcessMethodType copyProcessMethod = ((ProcessMethodType) strategy.copy(LocatorUtils.property(locator, "processMethod", sourceProcessMethod), sourceProcessMethod, this.isSetProcessMethod()));
                    copy.setProcessMethod(copyProcessMethod);
                } else {
                    if (processMethodShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.processMethod = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ProcessMethodPropertyType) {
            final ProcessMethodPropertyType target = this;
            final ProcessMethodPropertyType leftObject = ((ProcessMethodPropertyType) left);
            final ProcessMethodPropertyType rightObject = ((ProcessMethodPropertyType) right);
            {
                Boolean processMethodShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetProcessMethod(), rightObject.isSetProcessMethod());
                if (processMethodShouldBeMergedAndSet == Boolean.TRUE) {
                    ProcessMethodType lhsProcessMethod;
                    lhsProcessMethod = leftObject.getProcessMethod();
                    ProcessMethodType rhsProcessMethod;
                    rhsProcessMethod = rightObject.getProcessMethod();
                    ProcessMethodType mergedProcessMethod = ((ProcessMethodType) strategy.merge(LocatorUtils.property(leftLocator, "processMethod", lhsProcessMethod), LocatorUtils.property(rightLocator, "processMethod", rhsProcessMethod), lhsProcessMethod, rhsProcessMethod, leftObject.isSetProcessMethod(), rightObject.isSetProcessMethod()));
                    target.setProcessMethod(mergedProcessMethod);
                } else {
                    if (processMethodShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public ProcessMethodPropertyType withProcessMethod(ProcessMethodType value) {
        setProcessMethod(value);
        return this;
    }

    public ProcessMethodPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public ProcessMethodPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public ProcessMethodPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public ProcessMethodPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public ProcessMethodPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public ProcessMethodPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public ProcessMethodPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }
