...
public class AbstractPhysicalProcessPropertyType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean isSetAbstractPhysicalProcess() {
        return (this.abstractPhysicalProcess!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            JAXBElement<? extends AbstractPhysicalProcessType> theAbstractPhysicalProcess;
            theAbstractPhysicalProcess = this.getAbstractPhysicalProcess();
            strategy.appendField(locator, this, "abstractPhysicalProcess", buffer, theAbstractPhysicalProcess, this.isSetAbstractPhysicalProcess());
        }
        {
            boolean theOwns;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final AbstractPhysicalProcessPropertyType that = ((AbstractPhysicalProcessPropertyType) object);
        {
            JAXBElement<? extends AbstractPhysicalProcessType> lhsAbstractPhysicalProcess;
            lhsAbstractPhysicalProcess = this.getAbstractPhysicalProcess();
            JAXBElement<? extends AbstractPhysicalProcessType> rhsAbstractPhysicalProcess;
            rhsAbstractPhysicalProcess = that.getAbstractPhysicalProcess();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractPhysicalProcess", lhsAbstractPhysicalProcess), LocatorUtils.property(thatLocator, "abstractPhysicalProcess", rhsAbstractPhysicalProcess), lhsAbstractPhysicalProcess, rhsAbstractPhysicalProcess, this.isSetAbstractPhysicalProcess(), that.isSetAbstractPhysicalProcess())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractPhysicalProcessType> theAbstractPhysicalProcess;
            theAbstractPhysicalProcess = this.getAbstractPhysicalProcess();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractPhysicalProcess", theAbstractPhysicalProcess), currentHashCode, theAbstractPhysicalProcess, this.isSetAbstractPhysicalProcess());
        }
        {
            boolean theOwns;
            theOwns = (this.isSetOwns()?this.isOwns():false);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof AbstractPhysicalProcessPropertyType) {
            final AbstractPhysicalProcessPropertyType copy = ((AbstractPhysicalProcessPropertyType) draftCopy);
            {
                Boolean abstractPhysicalProcessShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetAbstractPhysicalProcess());
                if (abstractPhysicalProcessShouldBeCopiedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractPhysicalProcessType> sourceAbstractPhysicalProcess;
                    sourceAbstractPhysicalProcess = this.getAbstractPhysicalProcess();
                    @SuppressWarnings("unchecked")
                    JAXBElement<? extends AbstractPhysicalProcessType> copyAbstractPhysicalProcess = ((JAXBElement<? extends AbstractPhysicalProcessType> ) strategy.copy(LocatorUtils.property(locator, "abstractPhysicalProcess", sourceAbstractPhysicalProcess), sourceAbstractPhysicalProcess, this.isSetAbstractPhysicalProcess()));
                    copy.setAbstractPhysicalProcess(copyAbstractPhysicalProcess);
                } else {
                    if (abstractPhysicalProcessShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.abstractPhysicalProcess = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof AbstractPhysicalProcessPropertyType) {
            final AbstractPhysicalProcessPropertyType target = this;
            final AbstractPhysicalProcessPropertyType leftObject = ((AbstractPhysicalProcessPropertyType) left);
            final AbstractPhysicalProcessPropertyType rightObject = ((AbstractPhysicalProcessPropertyType) right);
            {
                Boolean abstractPhysicalProcessShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetAbstractPhysicalProcess(), rightObject.isSetAbstractPhysicalProcess());
                if (abstractPhysicalProcessShouldBeMergedAndSet == Boolean.TRUE) {
                    JAXBElement<? extends AbstractPhysicalProcessType> lhsAbstractPhysicalProcess;
                    lhsAbstractPhysicalProcess = leftObject.getAbstractPhysicalProcess();
                    JAXBElement<? extends AbstractPhysicalProcessType> rhsAbstractPhysicalProcess;
                    rhsAbstractPhysicalProcess = rightObject.getAbstractPhysicalProcess();
                    JAXBElement<? extends AbstractPhysicalProcessType> mergedAbstractPhysicalProcess = ((JAXBElement<? extends AbstractPhysicalProcessType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractPhysicalProcess", lhsAbstractPhysicalProcess), LocatorUtils.property(rightLocator, "abstractPhysicalProcess", rhsAbstractPhysicalProcess), lhsAbstractPhysicalProcess, rhsAbstractPhysicalProcess, leftObject.isSetAbstractPhysicalProcess(), rightObject.isSetAbstractPhysicalProcess()));
                    target.setAbstractPhysicalProcess(mergedAbstractPhysicalProcess);
                } else {
                    if (abstractPhysicalProcessShouldBeMergedAndSet == Boolean.FALSE) {
                        target.abstractPhysicalProcess = null;
                    }
                }
            }
            {
    ...
    public AbstractPhysicalProcessPropertyType withAbstractPhysicalProcess(JAXBElement<? extends AbstractPhysicalProcessType> value) {
        setAbstractPhysicalProcess(value);
        return this;
    }

    public AbstractPhysicalProcessPropertyType withOwns(boolean value) {
        setOwns(value);
        return this;
    }

    public AbstractPhysicalProcessPropertyType withNilReason(String... values) {
        if (values!= null) {
    ...
    public AbstractPhysicalProcessPropertyType withNilReason(Collection<String> values) {
        if (values!= null) {
    ...
    public AbstractPhysicalProcessPropertyType withRemoteSchema(String value) {
        setRemoteSchema(value);
        return this;
    }

    public AbstractPhysicalProcessPropertyType withTYPE(TypeType value) {
        setTYPE(value);
        return this;
    }

    public AbstractPhysicalProcessPropertyType withHref(String value) {
        setHref(value);
        return this;
    }

    public AbstractPhysicalProcessPropertyType withRole(String value) {
        setRole(value);
        return this;
    }

    public AbstractPhysicalProcessPropertyType withArcrole(String value) {
        setArcrole(value);
        return this;
    }

    public AbstractPhysicalProcessPropertyType withTitle(String value) {
        setTitle(value);
        return this;
    }

    public AbstractPhysicalProcessPropertyType withShow(ShowType value) {
        setShow(value);
        return this;
    }

    public AbstractPhysicalProcessPropertyType withActuate(ActuateType value) {
        setActuate(value);
        return this;
    }

    public AbstractPhysicalProcessPropertyType withNilReason(List<String> value) {
        setNilReason(value);
        return this;
    }
