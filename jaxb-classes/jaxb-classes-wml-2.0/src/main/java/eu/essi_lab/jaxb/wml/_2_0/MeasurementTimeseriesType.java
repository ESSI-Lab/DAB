...
/**
 * <p>Java class for MeasurementTimeseriesType complex type.
 * 
...
@XmlType(name = "MeasurementTimeseriesType", propOrder = {
    "point"
})
public class MeasurementTimeseriesType
    extends TimeseriesType
{
     ...
     * {@link MeasurementTimeseriesType.Point }
     * 
     * 
     */
    public List<MeasurementTimeseriesType.Point> getPoint() {
        if (point == null) {
            point = new ArrayList<MeasurementTimeseriesType.Point>();
        }
        return this.point;
    }
    ...
    public static class Point {
        ...
        @XmlElement(name = "MeasurementTVP", required = true)
        protected MeasureTVPType measurementTVP;
         ...
         *     
         */
        public MeasureTVPType getMeasurementTVP() {
         ...
         *     
         */
        public void setMeasurementTVP(MeasureTVPType value) {
            this.measurementTVP = value;
        }
