    ...
    extends JAXBElement<SolidPropertyType>
{
    ...
    protected final static QName NAME = new QName("http://www.opengis.net/gml/3.2", "solidMember");

    public SingleSolidMember(SolidPropertyType value) {
        super(NAME, ((Class) SolidPropertyType.class), null, value);
    }

    public SingleSolidMember() {
