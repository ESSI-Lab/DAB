...
public class SphericalCSProperty
    extends JAXBElement<SphericalCSPropertyType>
{

    protected final static QName NAME = new QName("http://www.opengis.net/gml/3.2", "sphericalCS");

    public SphericalCSProperty(SphericalCSPropertyType value) {
        super(NAME, ((Class) SphericalCSPropertyType.class), null, value);
    }

    public SphericalCSProperty() {
