...
/**
 * <p>Java class for ResultTemplatePropertyType complex type.
 * 
...
@XmlType(name = "ResultTemplatePropertyType", propOrder = {
    "resultTemplate"
})
public class ResultTemplatePropertyType {

    @XmlElement(name = "ResultTemplate")
