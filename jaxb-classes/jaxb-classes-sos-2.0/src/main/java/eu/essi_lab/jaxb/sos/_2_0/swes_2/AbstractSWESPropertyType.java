...
import eu.essi_lab.jaxb.sos._2_0.ResultTemplateType;
...
public class AbstractSWESPropertyType {
    ...
    @XmlElementRef(name = "AbstractSWES", namespace = "http://www.opengis.net/swes/2.0", type = JAXBElement.class, required = false)
    protected JAXBElement<? extends AbstractSWESType> abstractSWES;
