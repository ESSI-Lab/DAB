...
public class AbstractOfferingPropertyType {

    @XmlElementRef(name = "AbstractOffering", namespace = "http://www.opengis.net/swes/2.0", type = JAXBElement.class, required = false)
