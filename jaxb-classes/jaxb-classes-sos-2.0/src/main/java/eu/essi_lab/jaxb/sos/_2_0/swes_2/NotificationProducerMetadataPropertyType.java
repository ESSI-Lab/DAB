...
public class NotificationProducerMetadataPropertyType {

    @XmlElementRef(name = "NotificationProducerMetadata", namespace = "http://www.opengis.net/swes/2.0", type = JAXBElement.class, required = false)
    protected JAXBElement<? extends NotificationProducerMetadataType> notificationProducerMetadata;
    ...
    public void setNotificationProducerMetadata(JAXBElement<? extends NotificationProducerMetadataType> value) {
        this.notificationProducerMetadata = value;
    }
