...
public class AbstractContentsPropertyType {
    ...
    @XmlElementRef(name = "AbstractContents", namespace = "http://www.opengis.net/swes/2.0", type = JAXBElement.class, required = false)
    protected JAXBElement<? extends AbstractContentsType> abstractContents;
