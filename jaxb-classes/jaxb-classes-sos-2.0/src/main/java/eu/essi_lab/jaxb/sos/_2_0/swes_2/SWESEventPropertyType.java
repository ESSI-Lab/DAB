 ...
 *         &lt;element ref="{http://www.opengis.net/swes/2.0}SWESEvent"/&gt;
 *       &lt;/sequence&gt;
...
public class SWESEventPropertyType {

    @XmlElementRef(name = "SWESEvent", namespace = "http://www.opengis.net/swes/2.0", type = JAXBElement.class, required = false)
    protected JAXBElement<? extends SWESEventType> swesEvent;
