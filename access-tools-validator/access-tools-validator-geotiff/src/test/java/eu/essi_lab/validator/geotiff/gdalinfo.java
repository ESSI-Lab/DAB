...
public class gdalinfo {
    ...
    {
	System.out.println("Usage: gdalinfo [--help-general] [-mm] [-stats] [-hist] [-nogcp] [-nomd]\n"
    ...
    public static void main(String[] args) {
	{
		...
		if (adfGeoTransform[2] == 0.0 && adfGeoTransform[4] == 0.0) {
		    ...
		    System.out.println("  " + adfGeoTransform[0] + ", " + adfGeoTransform[1] + ", " + adfGeoTransform[2]);
		    System.out.println("  " + adfGeoTransform[3] + ", " + adfGeoTransform[4] + ", " + adfGeoTransform[5]);
		}
	    }
		...
		while (e.hasMoreElements()) {
		    ...
		    System.out.println("GCP[" + (count++) + "]: Id=" + gcp.getId() + ", Info=" + gcp.getInfo());
		    System.out.println("    (" + gcp.getGCPPixel() + "," + gcp.getGCPLine() + ") (" + gcp.getGCPX() + "," + gcp.getGCPY()
			    + "," + gcp.getGCPZ() + ")");
		}
	    ...
	    GDALInfoReportCorner(hDataset, "Lower Right", hDataset.getRasterXSize(), hDataset.getRasterYSize());
		...
		System.out.println("Band " + (iBand + 1) + " Block=" + blockXSize[0] + "x" + blockYSize[0] + " Type="
			+ gdal.GetDataTypeName(hBand.getDataType()) + ", ColorInterp="
		...
		if (hBand.GetStatistics(bApproxStats, bStats, dfMin, dfMax, dfMean, dfStdDev) == gdalconstConstants.CE_None) {
		    System.out
			    .println("  Minimum=" + dfMin[0] + ", Maximum=" + dfMax[0] + ", Mean=" + dfMean[0] + ", StdDev=" + dfStdDev[0]);
		}
		...
		if (hBand.GetRasterColorInterpretation() == gdalconstConstants.GCI_PaletteIndex
		    ...
		    System.out.println("  Color Table (" + gdal.GetPaletteInterpretationName(hTable.GetPaletteInterpretation()) + " with "
