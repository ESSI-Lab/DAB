...
public class InstantiableUserJobResultStorageURI extends UserJobResultsStorageURI implements IGSConfigurationInstantiable {

    private static final String USER_JOB_RESULT_STORAGE_URI = "USER_JOB_RESULT_STORAGE_URI";
    @XmlTransient
    @JsonIgnore
    private transient  IGSConfigurable dbConf;
    private String componentId;

    public InstantiableUserJobResultStorageURI() {
	super();
	setComponentId(USER_JOB_RESULT_STORAGE_URI);
    }
    ...
    @XmlTransient
    @JsonIgnore
    public IGSConfigurable getDataBaseConfiguraiton() {
	return dbConf;
    }
