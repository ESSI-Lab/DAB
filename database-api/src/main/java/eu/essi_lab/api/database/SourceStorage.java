...
public abstract class SourceStorage implements DatabaseProvider, Configurable<SourceStorageSetting> {
	...
	public void harvestingStarted(//
		...
		try {
			...
			GSLoggerFactory.getLogger(getClass()).error("Error occurred during harvesting initialization of source {}",
					source);
	...
	public void harvestingEnded(//
		...
		try {
			...
			GSLoggerFactory.getLogger(getClass()).error("Error occurred during harvesting finalization of source {}",
					source);
