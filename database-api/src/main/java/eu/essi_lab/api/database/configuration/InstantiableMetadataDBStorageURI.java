...
public class InstantiableMetadataDBStorageURI extends MetadataDataDabaseStoragiURI implements IGSConfigurationInstantiable {

    private IGSConfigurable dbConf;
    private String componentId;

    public InstantiableMetadataDBStorageURI() {
	super();
    }
