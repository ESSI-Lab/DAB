...
```
cd existing_repo
git remote add origin https://gitlab.platform.sim-dev.mase.gov.it/trasversali/dab.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.platform.sim-dev.mase.gov.it/trasversali/dab/-/settings/integrations)
...
>>>>>>> fb926dc9d74ed589e48d5fa3ac82db0af019c186
