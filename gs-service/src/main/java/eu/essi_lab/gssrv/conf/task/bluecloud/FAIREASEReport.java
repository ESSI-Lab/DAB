...
public class FAIREASEReport extends MetadataReport {
    ...
    public FAIREASEReport(S3TransferWrapper manager, boolean uploadToS3, Integer maxRecords, String[] viewIdentifiers) throws Exception {
	...
	return "gs-service-preproduction.geodab.eu";
    }
	...
	return new BlueCloudMetadataElement[] { //
		...
		BlueCloudMetadataElement.LICENSE_USE_LIMITAION, BlueCloudMetadataElement.LICENSE_USE_CONSTRAINTS,//
