 ...
 * and it can also show, when available, the <a href="../classes/GINode.html#method_googleImageMapType" class="crosslink">Google Maps layers</a> or the <a href="../classes/GINode.html#method_olMWS_Layer" class="crosslink">Openlayers 3 layers</a>
 ...
 * <br>See also {{#crossLink "GINode/googleImageMapType:method"}}{{/crossLink}} method for Google Maps or {{#crossLink "GINode/olMWS_Layer:method"}}{{/crossLink}} method for Openlayers 3
