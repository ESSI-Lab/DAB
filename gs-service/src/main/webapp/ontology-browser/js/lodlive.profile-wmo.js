                ...
                'profile',
                {
                    ...
                    'connection' : {                       
                        /*'Hydro-ontology' : {
                            ...
                            endpoint : 'http://localhost:3030/hydro-ontology/sparql',
                            examples : [ {
                                uri : 'https://hiscentral.cuahsi.org/webservices/hiscentral.asmx/getOntologyTree?conceptKeyword=Hydrosphere',
                                label : 'Hydrosphere'
                            } ]
                        },*/
                        'WMO codes' : {
                            ...
                            examples : [ {
                                uri : 'http://codes.wmo.int/wmdr/ObservedVariableTerrestrial/_171',
