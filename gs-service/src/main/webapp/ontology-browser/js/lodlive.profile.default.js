		...
		'profile',
		{
			...
			'connection': {
				'Hydro-ontology': {
					...
					endpoint: 'https://hydro.geodab.eu/hydro-ontology/sparql',
					examples: [{
						uri: 'http://hydro.geodab.eu/hydro-ontology/concept/1',
						label: 'Hydrosphere'
					},
					{
						uri: 'http://hydro.geodab.eu/hydro-ontology/concept/scheme',
