...
public class HarvestSchedulingRequestTest {
	...
	Assert.assertEquals(
		Parameter.of(HarvestSchedulingRequest.SOURCE_ID, ContentType.TEXTUAL, InputPattern.ALPHANUMERIC_AND_UNDERSCORE_AND_MINUS, true),
		parameters.get(0));
	...
	Assert.assertEquals(Parameter.of(HarvestSchedulingRequest.REPEAT_INTERVAL, ContentType.INTEGER, false), parameters.get(2));
	Assert.assertEquals(Parameter.of(HarvestSchedulingRequest.REPEAT_INTERVAL_UNIT, ContentType.TEXTUAL, RepeatIntervalUnit.class, false),
		parameters.get(3));
    }
