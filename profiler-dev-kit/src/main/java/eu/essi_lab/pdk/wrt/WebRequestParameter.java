...
/**
 * Represents a parameter of a {@link WebRequest} with <i>GET</i> method and optionally provides a {@link Bond} representation of such
 * parameter (see {@link #asBond(String)})
...
public abstract class WebRequestParameter {
     ...
     * @param defaultValue a default value for the parameter. Usually a parameter with a default value is also optional, and the default
     * value can be used in case the parameter is missing
     ...
     * @see #setMandatory(boolean)
     */
    public WebRequestParameter(String name, String type, String defaultValue, boolean decodeValue) {
	this.name = name;
	this.valueType = type;
    ...
    /**
     * Get the optional default value. Usually a parameter with a default value is also optional, and the default value can be used in case
    ...
    /**
     * Finds the {@link WebRequestParameter} with the given <code>name</code> declared with the <i>static</i> modifier in the given
    ...
    /**
     * Creates the {@link Bond} representation of this parameter.<br> In some particular cases the represented {@link Bond} can be a
     * {@link LogicalBond} of several {@link Bond}s, but more often it will be a single {@link QueryableBond}<br>
     * <br>
     * <b>Implementation example</b><br>
     * <br>
     * In this example, the {@link WebRequest} is a GET request with a parameter that, basing on its semantic, can be mapped on the
     * {@link MetadataElement#TITLE} and a non exact match. The following bond representation can be provided:
     * <pre>
     * &#64;Override
     ...
     * }
     * </pre>
     * If the semantic of the parameter relates to an exact match, the {@link BondOperator#EQUAL} should be used instead of
     * {@link BondOperator#TEXT_SEARCH}
     * <pre>
     * &#64;Override
     * public Optional&lt;Bond&gt; asBond(String value) {
     ...
     * @return an {@code Optional} describing the the {@link Bond} representation of this parameter, if non-null, otherwise returns an empty
     * {@code Optional}
