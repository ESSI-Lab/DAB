...
/**
 * Simple implementation which accepts any kind of PUT requests also according to the request path.<br>
 * Subclasses can override the {@link #accept(ClonableInputStream)} method by inspecting the request content
 * 
 * @author Fabrizio
 */
public class PUTRequestFilter extends PathRequestFilter {

    /**
     * @param path
     */
    public PUTRequestFilter(String path) {
	...
	boolean putRequest = request.isPutRequest();
