...
public class GSOAuthAuthenticator extends GSOAuthProvider implements IGSConfigurationInstantiable {

    private static final long serialVersionUID = 2592764679919172140L;

    @XmlTransient
    @JsonIgnore
    private IGSConfigurable oauthConfigurable;
	...
	this.oauthConfigurable = configurable;
    ...
    @XmlTransient
    @JsonIgnore
    public IGSConfigurable getOauthConfigurable() {
	return oauthConfigurable;
    }
