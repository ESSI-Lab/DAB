...
/**
 * Users having the "trigger" role, are allowed to discovery if and only if:<br>
 * <br>
 * 1) the view creator is "trigger"<br>
 *
 ...
 * @author Fabrizio
 */
public class TRIGGERPermissionPolicySet extends CreatorPermissionPolicySet {

    public TRIGGERPermissionPolicySet() {
