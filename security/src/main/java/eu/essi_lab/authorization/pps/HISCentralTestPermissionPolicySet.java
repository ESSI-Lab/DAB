...
/**
 * Users having the "his_central_test" role, are allowed to discovery if and only if:<br>
 * <br>
 * 1) the view creator is "his_central_test"<br>
 *
 ...
 * @author Fabrizio
 */
public class HISCentralTestPermissionPolicySet extends CreatorPermissionPolicySet {

    /**
     * 
     */
    public HISCentralTestPermissionPolicySet() {

	super("his_central_test");
    }
