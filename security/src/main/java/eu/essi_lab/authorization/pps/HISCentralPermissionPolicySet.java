...
/**
 * Users having the "his_central" role, are allowed to discovery if and only if:<br>
 * <br>
 * 1) the view creator is "his_central"<br>
 *
 ...
 * @author Fabrizio
 */
public class HISCentralPermissionPolicySet extends CreatorPermissionPolicySet {

    /**
     * 
     */
    public HISCentralPermissionPolicySet() {
