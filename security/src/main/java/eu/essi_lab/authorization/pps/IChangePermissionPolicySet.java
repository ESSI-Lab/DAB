...
/**
 * Users having the "i-change" role, are allowed to discovery if and only if:<br>
 * <br>
 * 1) the view creator is "i-change"<br>
 *
 ...
 * @author Fabrizio
 */
public class IChangePermissionPolicySet extends CreatorPermissionPolicySet {

    public IChangePermissionPolicySet() {
