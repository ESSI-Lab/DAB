...
public class StationRecord {
	...
	public StationRecord(BBOX4326 bbox4326, BBOX3857 bbox3857, String dataIdentifier, String metadataIdentifier,
			String datasetName, String downloadUrl, String featureInfo, String themeCategory, String sourceIdentifier)
			throws Exception {
		super();
	...
	private BBOX3857 calculateBBOX3857(BBOX4326 bbox4326) throws Exception {
		...
		SimpleEntry<Double, Double> lower = new SimpleEntry<>(bbox4326.getSouth().doubleValue(),
				bbox4326.getWest().doubleValue());
		SimpleEntry<Double, Double> upper = new SimpleEntry<>(bbox4326.getNorth().doubleValue(),
				bbox4326.getEast().doubleValue());
		SimpleEntry<SimpleEntry<Double, Double>, SimpleEntry<Double, Double>> sourceCorners = new SimpleEntry<>(lower,
				upper);
		...
		return new BBOX3857(new BigDecimal(lower2.getKey()), new BigDecimal(lower2.getValue()),
				new BigDecimal(upper2.getKey()), new BigDecimal(upper2.getValue()));
	}
