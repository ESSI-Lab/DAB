...
public class HisCentralComparator {
	...
	url2 = "https://gs-service-test.geodab.eu/gs-service/services/essi/token/token/view/whos-cuahsi/hiscentral.asmx/GetWaterOneFlowServiceInfo";
	...
	for (Node service : services) {
		...
		System.err.println("URL: " + servURL);
		System.out.println();
		bad++;
		notfound++;
	    } else {
