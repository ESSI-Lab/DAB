...
import eu.essi_lab.accessor.wof.discovery.sites.GetSitesByBoxRequest;
...
public abstract class WOFRequestValidator implements WebRequestValidator {

    public WOFRequestValidator() {
	...
	try {
	    WOFRequest bboxRequest = getWOFRequest(request);
    ...
    public abstract WOFRequest getWOFRequest(WebRequest request);
