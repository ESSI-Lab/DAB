 ...
 * @author boldrini
 */
public class GetSitesByBoxObjectResultSetFormatter extends SitesResultSetFormatter {

    @Override
    public String getResponseName() {
	return "GetSitesByBoxObjectResponse";
    }

    @Override
    protected WOFRequest getWOFRequest(WebRequest request) {
	return new GetSitesByBoxObjectRequest(request);
    }
