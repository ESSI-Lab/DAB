 ...
 * @author boldrini
 */
public class GetWaterOneFlowServiceInfoValidator implements WebRequestValidator {

    public GetWaterOneFlowServiceInfoValidator() {
    }
	...
	try {
	    new GetWaterOneFlowServiceInfoRequest(request);
	    Optional<String> view = request.extractViewId();
	    if (!view.isPresent()) {
		return getErrorMessage("View not present");
	    }
