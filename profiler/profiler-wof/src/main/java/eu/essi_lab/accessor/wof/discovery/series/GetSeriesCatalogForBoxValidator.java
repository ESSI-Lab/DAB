 ...
 * @author boldrini
 */
public class GetSeriesCatalogForBoxValidator implements WebRequestValidator {

    public GetSeriesCatalogForBoxValidator() {
    }
	...
	if (request.isGetRequest()) {
	    ...
	    if (request.getRequestPath().contains("GetSeriesCatalogForBox")) {
