 ...
 * @author boldrini
 */
public class GetSitesByBoxObjectRequestFilterNoSeries extends GETRequestFilter {

    @Override
    public boolean accept(WebRequest request) throws GSException {

	GetSitesByBoxObjectValidatorNoSeries validator = new GetSitesByBoxObjectValidatorNoSeries();
