 ...
 * @author boldrini
 */
public class GetSitesByBoxObjectValidatorWithSeries implements WebRequestValidator {

    public GetSitesByBoxObjectValidatorWithSeries() {
	...
	try {
	    GetSitesByBoxObjectRequest bboxRequest = new GetSitesByBoxObjectRequest(request);
