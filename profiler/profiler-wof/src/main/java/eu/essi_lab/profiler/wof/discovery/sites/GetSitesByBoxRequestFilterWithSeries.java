 ...
 * @author boldrini
 */
public class GetSitesByBoxRequestFilterWithSeries extends GETRequestFilter {

    @Override
    public boolean accept(WebRequest request) throws GSException {

	GetSitesByBoxValidatorWithSeries validator = new GetSitesByBoxValidatorWithSeries();
