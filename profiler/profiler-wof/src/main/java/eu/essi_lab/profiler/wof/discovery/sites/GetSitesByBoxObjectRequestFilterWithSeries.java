 ...
 * @author boldrini
 */
public class GetSitesByBoxObjectRequestFilterWithSeries extends GETRequestFilter {

    @Override
    public boolean accept(WebRequest request) throws GSException {

	GetSitesByBoxObjectValidatorWithSeries validator = new GetSitesByBoxObjectValidatorWithSeries();
