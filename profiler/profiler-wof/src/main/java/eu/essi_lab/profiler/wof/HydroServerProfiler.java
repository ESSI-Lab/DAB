...
import eu.essi_lab.profiler.wof.access.GetValuesObjectRequestFilter;
import eu.essi_lab.profiler.wof.access.GetValuesObjectResultSetMapper;
import eu.essi_lab.profiler.wof.access.GetValuesObjectTransformer;
import eu.essi_lab.profiler.wof.access.GetValuesRequestFilter;
import eu.essi_lab.profiler.wof.access.GetValuesResultSetFormatter;
import eu.essi_lab.profiler.wof.access.GetValuesResultSetMapper;
import eu.essi_lab.profiler.wof.access.GetValuesTransformer;
import eu.essi_lab.profiler.wof.discovery.sites.GetSiteInfoObjectRequestFilter;
import eu.essi_lab.profiler.wof.discovery.sites.GetSiteInfoObjectResultSetFormatter;
import eu.essi_lab.profiler.wof.discovery.sites.GetSiteInfoObjectTransformer;
import eu.essi_lab.profiler.wof.discovery.sites.GetSiteInfoRequestFilter;
import eu.essi_lab.profiler.wof.discovery.sites.GetSiteInfoResultSetFormatter;
import eu.essi_lab.profiler.wof.discovery.sites.GetSiteInfoResultSetMapper;
import eu.essi_lab.profiler.wof.discovery.sites.GetSiteInfoTransformer;
import eu.essi_lab.profiler.wof.discovery.sites.GetSitesByBoxObjectRequestFilterNoSeries;
import eu.essi_lab.profiler.wof.discovery.sites.GetSitesByBoxObjectRequestFilterWithSeries;
import eu.essi_lab.profiler.wof.discovery.sites.GetSitesByBoxObjectResultSetFormatter;
import eu.essi_lab.profiler.wof.discovery.sites.GetSitesByBoxRequestFilterNoSeries;
import eu.essi_lab.profiler.wof.discovery.sites.GetSitesByBoxRequestFilterWithSeries;
import eu.essi_lab.profiler.wof.discovery.sites.GetSitesByBoxResultSetFormatter;
import eu.essi_lab.profiler.wof.discovery.sites.GetSitesByBoxTransformerNoSeries;
import eu.essi_lab.profiler.wof.discovery.sites.GetSitesByBoxTransformerWithSeries;
import eu.essi_lab.profiler.wof.discovery.sites.GetSitesObjectHandler;
import eu.essi_lab.profiler.wof.discovery.sites.GetSitesObjectRequest;
import eu.essi_lab.profiler.wof.discovery.sites.GetSitesObjectResultSetFormatter;
import eu.essi_lab.profiler.wof.discovery.sites.GetSitesObjectTransformer;
import eu.essi_lab.profiler.wof.discovery.sites.GetSitesRequest;
import eu.essi_lab.profiler.wof.discovery.sites.GetSitesResultSetFormatter;
import eu.essi_lab.profiler.wof.discovery.sites.GetSitesResultSetMapper;
import eu.essi_lab.profiler.wof.discovery.sites.GetSitesTransformer;
import eu.essi_lab.profiler.wof.discovery.variables.GetVariableInfoObjectRequest;
import eu.essi_lab.profiler.wof.discovery.variables.GetVariableInfoObjectResultSetFormatter;
import eu.essi_lab.profiler.wof.discovery.variables.GetVariableInfoObjectTransformer;
import eu.essi_lab.profiler.wof.discovery.variables.GetVariableInfoRequest;
import eu.essi_lab.profiler.wof.discovery.variables.GetVariableInfoResultSetFormatter;
import eu.essi_lab.profiler.wof.discovery.variables.GetVariableInfoTransformer;
import eu.essi_lab.profiler.wof.discovery.variables.GetVariablesObjectRequest;
import eu.essi_lab.profiler.wof.discovery.variables.GetVariablesObjectResultSetFormatter;
import eu.essi_lab.profiler.wof.discovery.variables.GetVariablesObjectTransformer;
import eu.essi_lab.profiler.wof.discovery.variables.GetVariablesRequest;
import eu.essi_lab.profiler.wof.discovery.variables.GetVariablesResultSetFormatter;
import eu.essi_lab.profiler.wof.discovery.variables.GetVariablesResultSetMapper;
import eu.essi_lab.profiler.wof.discovery.variables.GetVariablesTransformer;
import eu.essi_lab.profiler.wof.wsdl.HydroServerWSDLHandler;
 ...
 * @author boldrini
 */
public class HydroServerProfiler extends Profiler<HydroServerProfilerSetting> {
    ...
    @Override
    protected HydroServerProfilerSetting initSetting() {

	return new HydroServerProfilerSetting();
    }
