...
import eu.essi_lab.pdk.rsm.impl.xml.iso19139.GMD_2007_ResultSetMapper;

/**
 * @author boldrini
 */
public class ISO_2007_OAIPMH19139Profile extends OAIPMHProfile {

    @Override
    public MetadataFormatType getSupportedMetadataFormat() {

	MetadataFormatType type = new MetadataFormatType();
	type.setMetadataNamespace(CommonNameSpaceContext.GMD_NS_URI);
	type.setSchema("http://schemas.opengis.net/iso/19139/20070417/gmd/gmd.xsd");
	type.setMetadataPrefix("ISO19139-2007");
	...
	return new GMD_2007_ResultSetMapper();
    }
