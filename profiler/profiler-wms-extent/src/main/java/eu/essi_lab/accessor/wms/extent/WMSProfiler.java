...
import eu.essi_lab.accessor.wms.extent.capabilities.WMSCapabilitiesFilter;
import eu.essi_lab.accessor.wms.extent.capabilities.WMSCapabilitiesHandler;
import eu.essi_lab.accessor.wms.extent.demo.WMSDemoFilter;
import eu.essi_lab.accessor.wms.extent.demo.WMSDemoHandler;
import eu.essi_lab.accessor.wms.extent.feature.info.WMSGetFeatureInfoHandler;
import eu.essi_lab.accessor.wms.extent.feature.info.WMSGetFeatureInfoRequestFilter;
import eu.essi_lab.accessor.wms.extent.legend.WMSGetLegendHandler;
import eu.essi_lab.accessor.wms.extent.legend.WMSLegendRequestFilter;
import eu.essi_lab.accessor.wms.extent.map.WMSGetMapHandler;
import eu.essi_lab.accessor.wms.extent.map.WMSMapRequestFilter;
...
/**
 * Profiler implementing WMS protocol providing a map of record extents
 * 
 * @author boldrini
 */
public class WMSProfiler extends Profiler {
     ...
     * The profiler type
     */
    private static final String WMS_PROFILER_TYPE = "WMS-EXTENT";

    public static final ProfilerSetting WMS_SERVICE_INFO = new ProfilerSetting();
    static {
	WMS_SERVICE_INFO.setServiceName("WMS Extent Profiler");
	WMS_SERVICE_INFO.setServiceType(WMS_PROFILER_TYPE);
	WMS_SERVICE_INFO.setServicePath("wms-extent");
