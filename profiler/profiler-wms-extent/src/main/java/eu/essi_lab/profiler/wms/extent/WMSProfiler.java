...
import eu.essi_lab.profiler.wms.extent.capabilities.WMSCapabilitiesFilter;
import eu.essi_lab.profiler.wms.extent.capabilities.WMSCapabilitiesHandler;
import eu.essi_lab.profiler.wms.extent.demo.WMSDemoFilter;
import eu.essi_lab.profiler.wms.extent.demo.WMSDemoHandler;
import eu.essi_lab.profiler.wms.extent.feature.info.WMSGetFeatureInfoHandler;
import eu.essi_lab.profiler.wms.extent.feature.info.WMSGetFeatureInfoRequestFilter;
import eu.essi_lab.profiler.wms.extent.legend.WMSGetLegendHandler;
import eu.essi_lab.profiler.wms.extent.legend.WMSLegendRequestFilter;
import eu.essi_lab.profiler.wms.extent.map.WMSGetMapHandler;
import eu.essi_lab.profiler.wms.extent.map.WMSMapRequestFilter;
 ...
 * @author boldrini
 */
public class WMSProfiler extends Profiler<WMSExtentProfilerSetting> {
    ...
    @Override
    protected WMSExtentProfilerSetting initSetting() {

	return new WMSExtentProfilerSetting();
    }
}
