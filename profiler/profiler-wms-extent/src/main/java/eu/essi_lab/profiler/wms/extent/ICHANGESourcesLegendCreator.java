...
public class ICHANGESourcesLegendCreator extends LegendCreator {

    @Override
    public List<InfoLegend> getLegend(String layers, StationRecord station) {
	List<InfoLegend> ret = new ArrayList<>();
	if (station == null) {
	    ret.add(getInfoLegend("ichangePolytope","I-CHANGE Citizen Observatory Archive"));
	} else {
