 ...
 * @author boldrini
 */
public class GWISResultSetMapper extends DiscoveryResultSetMapper<GSResource> {

    public GWISResultSetMapper() {
     ...
     */
    public static final MappingSchema GWIS_MAPPING_SCHEMA = new MappingSchema();

    @Override
    public MappingSchema getMappingSchema() {

	return GWIS_MAPPING_SCHEMA;
    }
