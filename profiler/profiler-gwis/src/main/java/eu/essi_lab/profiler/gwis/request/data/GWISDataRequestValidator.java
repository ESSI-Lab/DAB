 ...
 * @author boldrini
 */
public class GWISDataRequestValidator implements WebRequestValidator {

    public GWISDataRequestValidator() {
	// empty constructor useful for service loading
    }
