...
public class OSLayerFeatureRetrieval {

    private static OSLayerFeatureRetrieval instance = null;
    private static final Provider PROVIDER = new ESSILabProvider();

    private OSLayerFeatureRetrieval() {
    }

    public static OSLayerFeatureRetrieval getInstance() {
	if (instance == null) {
	    instance = new OSLayerFeatureRetrieval();
	}
	return instance;
    }
