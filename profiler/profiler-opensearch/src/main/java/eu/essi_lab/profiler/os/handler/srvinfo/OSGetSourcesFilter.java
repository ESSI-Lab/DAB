...
public class OSGetSourcesFilter implements WebRequestFilter {
	...
	Optional<OSParameter> sources = WebRequestParameter.findParameter(OSParameters.PARENTS.getName(), OSParameters.class);

	if (sources.isPresent()) {

	    String sourcesValue = parser.parse(sources.get());
