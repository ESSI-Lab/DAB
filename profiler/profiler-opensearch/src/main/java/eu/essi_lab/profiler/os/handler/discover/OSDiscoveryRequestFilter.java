 ...
 * @author Fabrizio
 */
public class OSDiscoveryRequestFilter implements WebRequestFilter {
	...
	if (!OSGetSourcesFilter.isGetSourcesQuery(request)) {
	    ...
	    return new GETRequestFilter("opensearch/query").accept(request) || //
		    new POSTRequestFilter("opensearch/query").accept(request);
