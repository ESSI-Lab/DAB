...
public class WISDatasetDiscoveryMetadataFilter implements WebRequestFilter {
	...
	return topRequest != null && topRequest.equals(TopRequest.COLLECTIONS) && collectionItem.equals(CollectionItems.DATASETS);
    }
