...
public class WISDiscoveryMetadataFilter implements WebRequestFilter {
	...
	WISRequest wr = null;
	try {
	    wr = new WISRequest(request);

	} catch (IllegalArgumentException ex) {
	    // HTTP request type not supported
	    return false;
	}
	...
	return topRequest != null && topRequest.equals(TopRequest.COLLECTIONS) && collectionItem.equals(CollectionItems.DISCOVERY_METADATA);
    }
}
