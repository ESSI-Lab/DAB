...
// * @author boldrini
// */
//public class FeatureQueryIdentifiersRequestFilter extends FeatureQueryRequestFilter {
//
//    @Override
//    public boolean accept(WebRequest request) throws GSException {
//	ESRIRequest esriRequest = new ESRIRequest (request);
//	return esriRequest.isQuery() && !esriRequest.isCount() && esriRequest.isIdentifiersOnly();
//
//    }
//
//}
