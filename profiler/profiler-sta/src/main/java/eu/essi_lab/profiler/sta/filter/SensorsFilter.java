...
/**
 * Filter for OGC STA Sensors entity set.
 */
public class SensorsFilter implements WebRequestFilter {
	...
	return path != null && (path.contains("/Sensors") || path.endsWith("Sensors"));
    }
}
