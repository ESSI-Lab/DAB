...
/**
 * Filter for OGC STA ObservedProperties entity set.
 */
public class ObservedPropertiesFilter implements WebRequestFilter {
	...
	return path != null && (path.contains("/ObservedProperties") || path.endsWith("ObservedProperties"));
    }
}
