...
import eu.essi_lab.profiler.sta.filter.HistoricalLocationsFilter;
import eu.essi_lab.profiler.sta.filter.MultiDatastreamsFilter;
...
import eu.essi_lab.profiler.sta.handler.HistoricalLocationsHandler;
import eu.essi_lab.profiler.sta.handler.MultiDatastreamsHandler;
...
public class STAProfiler extends Profiler<STAProfilerSetting> {
	...
	selector.register(new DatastreamsObservationsFilter(), new DatastreamsHandler());
	selector.register(new DatastreamsFilter(), new DatastreamsHandler());
	selector.register(new HistoricalLocationsFilter(), new HistoricalLocationsHandler());
	selector.register(new MultiDatastreamsFilter(), new MultiDatastreamsHandler());
