...
/**
 * Filter for OGC STA FeaturesOfInterest entity set.
 */
public class FeaturesOfInterestFilter implements WebRequestFilter {
	...
	return path != null && (path.contains("/FeaturesOfInterest") || path.endsWith("FeaturesOfInterest"));
    }
}
