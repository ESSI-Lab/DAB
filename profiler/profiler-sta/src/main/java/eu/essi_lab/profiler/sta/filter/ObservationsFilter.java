...
/**
 * Filter for OGC STA Observations entity set.
 */
public class ObservationsFilter implements WebRequestFilter {
	...
	return path != null && (path.contains("/Observations") || path.endsWith("Observations"));
    }
}
