...
/**
 * Filter for Things(id)/Locations navigation property.
 */
public class ThingsLocationsFilter implements WebRequestFilter {

    private static final Pattern PATTERN = Pattern.compile(".*/Things\\([^)]+\\)/Locations.*");
