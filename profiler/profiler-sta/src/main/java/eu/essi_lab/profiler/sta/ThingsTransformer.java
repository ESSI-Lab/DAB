...
/**
 * Transformer for STA Things entity set (distinct platforms).
 */
public class ThingsTransformer extends STATransformer {

    @Override
    protected void applyEntitySpecificFilterBonds(String filter, Set<Bond> operands) {
	addEntityIdFilter(filter, "Thing", MetadataElement.UNIQUE_PLATFORM_IDENTIFIER, operands);
