...
/**
 * Filter for OGC STA Locations entity set.
 */
public class LocationsFilter implements WebRequestFilter {
	...
	return path != null && (path.contains("/Locations") || path.endsWith("Locations"));
    }
}
