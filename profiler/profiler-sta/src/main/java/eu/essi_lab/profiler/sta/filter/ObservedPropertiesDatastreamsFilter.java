...
/**
 * Filter for ObservedProperties(id)/Datastreams navigation property.
 */
public class ObservedPropertiesDatastreamsFilter implements WebRequestFilter {

    private static final Pattern PATTERN = Pattern.compile(".*/ObservedProperties\\([^)]+\\)/Datastreams.*");
