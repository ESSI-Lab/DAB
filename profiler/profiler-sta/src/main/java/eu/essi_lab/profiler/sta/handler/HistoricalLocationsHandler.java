...
/**
 * Handler for OGC STA HistoricalLocations entity set.
 * Returns empty array (not implemented).
 */
public class HistoricalLocationsHandler extends StreamingRequestHandler {
	...
	return output -> {
		...
		throw new WebApplicationException("Error handling HistoricalLocations request", e);
	    }
	};
    }
