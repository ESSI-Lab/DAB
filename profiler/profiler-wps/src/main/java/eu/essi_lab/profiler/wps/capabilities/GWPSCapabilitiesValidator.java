 ...
 * @author boldrini
 */
public class GWPSCapabilitiesValidator implements WebRequestValidator {

    public GWPSCapabilitiesValidator() {
    }
	...
	if (request.isGetRequest()) {
	    ...
	    if (request.getQueryString().contains("gi-axe-capabilities")) {
		ValidationMessage message = new ValidationMessage();
		message.setResult(ValidationResult.VALIDATION_SUCCESSFUL);
		return message;
	    }
	    
	    return getErrorMessage("gi-axe-capabilities parameter not found");
	}
