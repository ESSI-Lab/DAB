package eu.essi_lab.accessor.wps;
...
import eu.essi_lab.accessor.wps.bulk.GWPSBulkDownloadHandler;
import eu.essi_lab.accessor.wps.bulk.GWPSBulkDownloadRequestFilter;
import eu.essi_lab.accessor.wps.bulk.GWPSBulkDownloadRequestFilterSynch;
import eu.essi_lab.accessor.wps.capabilities.GWPSCapabilitiesRequestFilter;
import eu.essi_lab.accessor.wps.capabilities.GWPSCapabilitiesResultSetFormatter;
import eu.essi_lab.accessor.wps.capabilities.GWPSCapabilitiesResultSetMapper;
import eu.essi_lab.accessor.wps.capabilities.GWPSCapabilitiesTransformer;
import eu.essi_lab.accessor.wps.capabilities.GWPS_GP_CapabilitiesResultSetFormatter;
import eu.essi_lab.accessor.wps.executor.GWPSExecuteTransformer;
import eu.essi_lab.accessor.wps.executor.asynch.GWPSExecuteFormatter;
import eu.essi_lab.accessor.wps.executor.asynch.GWPSExecuteResultMapper;
...
public class GWPSProfiler extends Profiler {
	...
	GWPS_SERVICE_INFO.setServicePath("gwps");
	GWPS_SERVICE_INFO.setServiceVersion("1.0.0");
    }
	...
	selector.register(new eu.essi_lab.accessor.wps.executor.synch.GWPSExecuteRequestFilter(), executeSynchHandler);
	...
	selector.register(new eu.essi_lab.accessor.wps.executor.asynch.GWPSExecuteRequestFilter(), executeAsynchHandler);
