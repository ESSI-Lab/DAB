			...
			return new StreamingOutput() {
				...
				public void write(OutputStream output) throws IOException, WebApplicationException {
					...
					try {
						...
						ServiceLoader<IDiscoveryStringExecutor> loader = ServiceLoader
								.load(IDiscoveryStringExecutor.class);
						...
						SpatialExtent se = new SpatialExtent(bboxMiny + tol, bboxMinx + tol, bboxMaxy - tol,
								bboxMaxx - tol);
				...
				private String extractValue(String res, String key) {
					return res.substring(res.indexOf("<" + key + ">"), res.indexOf("</" + key + ">"))
							.replace("<" + key + ">", "");
				}
