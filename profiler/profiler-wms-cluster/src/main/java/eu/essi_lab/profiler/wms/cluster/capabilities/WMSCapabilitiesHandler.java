 ...
 * 
 */
package eu.essi_lab.profiler.wms.cluster.capabilities;
...
public class WMSCapabilitiesHandler extends DefaultRequestHandler {
	...
	try {
	    ...
	    legendOnline.setHref(url + "?service=WMS&request=GetLegendGraphic&LAYER=" + view);
