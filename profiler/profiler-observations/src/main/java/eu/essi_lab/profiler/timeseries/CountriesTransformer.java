...
public class CountriesTransformer extends TimeseriesTransformer {
...
//	selector.addIndex(MetadataElement.BOUNDING_BOX);
	...
	selector.addIndex(MetadataElement.COUNTRY_ISO3);
	...
	return Optional.of(MetadataElement.COUNTRY_ISO3);
