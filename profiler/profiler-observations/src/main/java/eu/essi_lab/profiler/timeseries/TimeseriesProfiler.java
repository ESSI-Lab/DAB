 ...
 * @author boldrini
 */
public class TimeseriesProfiler extends Profiler<TimeseriesProfilerSetting> {
    ...
    @Override
    protected TimeseriesProfilerSetting initSetting() {

	return new TimeseriesProfilerSetting();
    }
