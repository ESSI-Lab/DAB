...
public class WorldCerealFilter implements WebRequestFilter {

    @Override
    public boolean accept(WebRequest request) throws GSException {

	String path = request.getServletRequest().getPathInfo();
	return path.endsWith("worldcereal");
//	    return new GETRequestFilter("worldcereal/query").accept(request);
