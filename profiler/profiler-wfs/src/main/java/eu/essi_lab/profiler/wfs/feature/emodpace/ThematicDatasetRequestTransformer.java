 ...
 * @author boldrini
 */
public class ThematicDatasetRequestTransformer extends DiscoveryRequestTransformer {

    public static final String FEATURE_QUERY_ERROR = "FEATURE_QUERY_ERROR";
    private ThematicDataset thematicDataset;

    public ThematicDatasetRequestTransformer(ThematicDataset thematicDataset) {
	...
	return thematicDataset.getBond();
