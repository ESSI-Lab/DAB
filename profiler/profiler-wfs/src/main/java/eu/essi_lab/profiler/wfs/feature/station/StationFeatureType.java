...
public class StationFeatureType extends FeatureType {

    @Override
    public QName getQName() {
	return new QName("http://essi-lab.eu", "station", "essi");
    }
	...
	return "Geo locations (points) of observing stations";
    }

    @Override
    public String[] getKeywords() {
	return new String[] { "station", "platform", "point" };
    }
