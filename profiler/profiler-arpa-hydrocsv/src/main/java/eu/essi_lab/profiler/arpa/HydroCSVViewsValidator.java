 ...
 * @author boldrini
 */
public class HydroCSVViewsValidator implements WebRequestValidator {

    public HydroCSVViewsValidator() {
    }
	...
	try {
	    ...
	    String type = parameters.getParameter(HydroCSVParameter.TYPE);
	...
	return getErrorMessage("Not a valid views request");
