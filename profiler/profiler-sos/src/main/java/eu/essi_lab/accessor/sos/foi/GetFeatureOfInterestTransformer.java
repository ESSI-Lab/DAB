...
import eu.essi_lab.accessor.sos.SOSProfiler;
import eu.essi_lab.accessor.sos.SOSRequest.Parameter;
import eu.essi_lab.accessor.sos.SOSUtils;
 ...
 * @author boldrini
 */
public class GetFeatureOfInterestTransformer extends DiscoveryRequestTransformer {

    public GetFeatureOfInterestTransformer() {
    }
	...
	return new GetFeatureOfInterestValidator();
    }

    @Override
    protected Bond getUserBond(WebRequest webRequest) throws GSException {

	GetFeatureOfInterestRequest request = new GetFeatureOfInterestRequest(webRequest);
