...
public abstract class SOSRequest {

    public enum Parameter {
	SERVICE("SERVICE", "service"), //
	REQUEST("REQUEST", "request"), //
	PROCEDURE("PROCEDURE", "procedure"), //
	PROCEDURE_DESCRIPTION_FORMAT("procedureDescriptionFormat"), //
	OBSERVED_PROPERTY("observedProperty", "OBSERVEDPROPERTY", "observedproperty"), //
	OFFERING("OFFERING", "offering"), //
	FEATURE_OF_INTEREST("featureOfInterest", "FEATUREOFINTEREST", "featureofinterest"), //
	RESPONSE_FORMAT("responseFormat", "RESPONSEFORMAT", "responseformat"), //
	TIME_POSITION("timePosition", "TIMEPOSITION", "timeposition"), //
	BEGIN_POSITION("beginPosition", "BEGINPOSITION", "beginposition"), //
	END_POSITION("endPosition", "ENDPOSITION", "endposition")//
	;
    ...
    public SOSRequest(WebRequest request) {
