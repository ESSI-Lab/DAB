...
public class RadioComponentsHandlerListener extends AbstractValueChangeListener {
     ...
     * @param handler
     */
    public RadioComponentsHandlerListener(RadioComponentsHandler handler) {

	this.handler = handler;
	this.discardServerSideEvents = false;
    }
	...
	if (event.isFromClient()) {
	    ...
	    handler.getGroupSetting().select(set -> set.getName().equals(value));
	}
    }
}
