...
public class TabSheetContent extends TabSheet implements Renderable {
     ...
     * @param container
     */
    public void add(TabDescriptor desc, TabContent container){

	add(desc.getLabel(), container);
    }
	...
	this.getChildren().map(comp -> (Renderable)comp).forEach(rend -> rend.render(refresh));
    }
