...
public class Hydro1BlockTest {
    ...
    /**
     * No workflows are found, because output temporal subsetting is required as TRUE, but no subset blocks are
     * available
     * 
     * @throws Exception
     */
	...
	DataDescriptor outputDescriptor = TestUtils.create(DataType.TIME_SERIES, CRS.fromIdentifier("EPSG:4326"), DataFormat.NETCDF_3());
