...
import eu.essi_lab.workflow.processor.grid.GDAL_NetCDF_CRS_Only_Converter_Processor;

public class NetCDFOnlyReprojector extends WorkblockBuilder {

    private DataType type = DataType.GRID;
    private DataFormat format = DataFormat.NETCDF();

    public NetCDFOnlyReprojector() {
	...
	return new GDAL_NetCDF_CRS_Only_Converter_Processor();
    }
