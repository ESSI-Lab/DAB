...
import eu.essi_lab.workflow.processor.grid.GDAL_To_PNG_Processor;

/**
 * @author boldrini
 */
public class NetCDF_To_PNG_FormatConverter extends DataFormatConverter {
	...
	return new GDAL_To_PNG_Processor();
    }
}
