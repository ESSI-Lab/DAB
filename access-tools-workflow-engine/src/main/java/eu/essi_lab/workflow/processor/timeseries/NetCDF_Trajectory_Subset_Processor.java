...
public class NetCDF_Trajectory_Subset_Processor extends AbstractTimeSubsetProcessor {
	...
	if (type == null || !type.equals("trajectory")) {
	    throw getGSException("Not a trajectory");
	}
