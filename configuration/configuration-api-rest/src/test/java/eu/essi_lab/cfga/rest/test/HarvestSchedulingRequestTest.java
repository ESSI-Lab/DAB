...
import eu.essi_lab.cfga.rest.source.HarvestSchedulingRequest.RepeatCount;
import eu.essi_lab.cfga.rest.source.HarvestSchedulingRequest.RepeatIntervalUnit;
import eu.essi_lab.cfga.rest.source.PutSourceRequest.SourceType.*;
...
public class HarvestSchedulingRequestTest {
	...
	Assert.assertEquals(
		Parameter.of(HarvestSchedulingRequest.SOURCE_ID, ContentType.TEXTUAL, InputPattern.ALPHANUMERIC_AND_UNDERSCORE_AND_MINUS,
			true), parameters.get(0));
	...
	Assert.assertEquals(
		Parameter.of(HarvestSchedulingRequest.REPEAT_COUNT, ContentType.TEXTUAL, HarvestSchedulingRequest.RepeatCount.class, true),
		parameters.get(2));

	Assert.assertEquals(Parameter.of(HarvestSchedulingRequest.REPEAT_INTERVAL, ContentType.INTEGER, false), parameters.get(3));
	Assert.assertEquals(Parameter.of(HarvestSchedulingRequest.REPEAT_INTERVAL_UNIT, ContentType.TEXTUAL,
		HarvestSchedulingRequest.RepeatIntervalUnit.class, false), parameters.get(4));
    }
	...
	request.put(HarvestSchedulingRequest.REPEAT_INTERVAL_UNIT, HarvestSchedulingRequest.RepeatIntervalUnit.WEEKS.getLabel());
	request.put(HarvestSchedulingRequest.REPEAT_COUNT, HarvestSchedulingRequest.RepeatCount.INDEFINITELY.getLabel());
