...
public class PutSourceRequestTest {
	...
	request.put(PutSourceRequest.SERVICE_TYPE, PutSourceRequest.SourceType.WCS_111.getLabel());
	...
	Assert.assertEquals(PutSourceRequest.SourceType.WCS_111.getLabel(), request.read(PutSourceRequest.SERVICE_TYPE).get());
	...
	request.put(PutSourceRequest.HARVEST_SCHEDULING, HarvestSchedulingRequest.START_TIME,
		ISO8601DateTimeUtils.getISO8601DateTime("Europe/Berlin"));
