...
/**
 * The BNDMET identifier mangler is primarily used by the BNDMET mapper to create the file identifier and the
 * distribution
 * online resource name for BNDMET resources.
 * 
 * @author boldrini
 */
public class BNDMETIdentifierMangler extends KVPMangler {
    private static final String PLATFORM_KEY = "platform";
    private static final String PARAMETER_KEY = "parameter";

    public BNDMETIdentifierMangler() {
	super(";");
    }
