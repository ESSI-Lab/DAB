...
/**
 * The API Tempo identifier mangler is used by the API Tempo mapper to create the file identifier and the
 * distribution online resource name for API Tempo resources.
 * 
 * @author boldrini
 */
public class APITempoIdentifierMangler extends KVPMangler {
    private static final String PLATFORM_KEY = "platform";
    private static final String PARAMETER_KEY = "parameter";

    public APITempoIdentifierMangler() {
	super(";");
    }
