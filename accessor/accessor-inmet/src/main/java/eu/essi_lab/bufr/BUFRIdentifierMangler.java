...
/**
 * The BUFR identifier mangler is primarily used by the BUFR mapper to create the file identifier and the distribution
 * online resource name for BUFR resources.
 * 
 * @author boldrini
 */
public class BUFRIdentifierMangler extends KVPMangler {
    private static final String PLATFORM_KEY = "platform";
    private static final String PARAMETER_KEY = "parameter";

    public BUFRIdentifierMangler() {
	super(";");
    }
