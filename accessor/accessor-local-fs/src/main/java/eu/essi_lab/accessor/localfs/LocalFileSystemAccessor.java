 ...
 * @author Fabrizio
 */
public class LocalFileSystemAccessor extends HarvestedAccessor<LocalFileSystemConnector> {
	...
	return "Local FileSystem Accessor";
    }
    ...
    @Override
    protected LocalFileSystemConnectorSetting initHarvestedConnectorSetting() {
