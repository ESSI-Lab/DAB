...
public class AggregatedTRIGGERDownloader extends DataDownloader {

    private static final String AGGREGATED_TRIGGER_DOWNLOADER_ERROR = "AGGREGATED_TRIGGER_DOWNLOADER_ERROR";
    private Downloader downloader;

    public AggregatedTRIGGERDownloader() {
	...
	return (online.getFunctionCode() != null && //
		...
		online.getProtocol().equals(CommonNameSpaceContext.AGGREGATED_TRIGGER));
    }
	...
	try {
	    return !AggregatedTRIGGERConnector.getResponse(online.getLinkage()).isEmpty();
	} catch (Exception e) {
	    e.printStackTrace();
	}
	return false;
