 ...
 * @author Fabrizio
 */
public class SOSGROWAccessor_ExternalTestIT {
	...
	gsSourceSetting.setSourceEndpoint("http://grow-beta-api.hydronet.com/api/service/sos?");
	...
	//
	connectorSetting.selectConnectorType(SOSGROWConnector.TYPE);

	SOSGROWConnector selectedConnector = (SOSGROWConnector) connectorSetting.getSelectedConnector();

	Assert.assertEquals(SOSGROWConnector.class, selectedConnector.getClass());
