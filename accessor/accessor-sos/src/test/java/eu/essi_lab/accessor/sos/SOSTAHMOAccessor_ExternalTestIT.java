 ...
 * @author Fabrizio
 */
public class SOSTAHMOAccessor_ExternalTestIT {
	...
	gsSourceSetting.setSourceEndpoint("http://twiga-api.hydronet.com/api/service/sos?");
	...
	//
	connectorSetting.selectConnectorType(SOSTAHMOConnector.TYPE);

	SOSTAHMOConnector selectedConnector = (SOSTAHMOConnector) connectorSetting.getSelectedConnector();

	Assert.assertEquals(SOSTAHMOConnector.class, selectedConnector.getClass());
