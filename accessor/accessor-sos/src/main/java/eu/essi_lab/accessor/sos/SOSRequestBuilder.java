...
public class SOSRequestBuilder {
	...
	if (observedProperty != null) {
	    property = "&observedProperty=" + encode(observedProperty);
	}
	return baseEndpoint + "&REQUEST=GetDataAvailability&featureOfInterest=" + encode(feature) + "&procedure=" + encode(procedure)
		+ property;
    }
