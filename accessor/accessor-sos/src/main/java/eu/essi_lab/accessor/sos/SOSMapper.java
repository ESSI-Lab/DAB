...
public class SOSMapper extends OriginalIdentifierMapper {
    ...
    private long nowEndDateMilliseconds = TimeUnit.DAYS.toMillis(5); // the last 5 days
	...
	// String stationDescription = reader.evaluateString("*:" + SOSConnector.SAVA_HIS_ROOT
	...
	// from GML
	// String elevation = reader.evaluateString("*:" + SOSConnector.SAVA_HIS_ROOT + "/*:featureMember/*/*:z");
	// String authority = reader.evaluateString("*:" + SOSConnector.SAVA_HIS_ROOT +
	// "/*:featureMember/*/*:authority");
	// String metadataCurator = reader.evaluateString("*:" + SOSConnector.SAVA_HIS_ROOT +
	...
	// String riverKilometer = reader.evaluateString("*:" + SOSConnector.SAVA_HIS_ROOT +
	// "/*:featureMember/*/*:river_kilometer");
	// String catchmentArea = reader.evaluateString("*:" + SOSConnector.SAVA_HIS_ROOT +
	// "/*:featureMember/*/*:catchment_area");
	// String bank = reader.evaluateString("*:" + SOSConnector.SAVA_HIS_ROOT + "/*:featureMember/*/*:bank");
	// String classification = reader.evaluateString("*:" + SOSConnector.SAVA_HIS_ROOT +
	// "/*:featureMember/*/*:classification");
	// String timestep = reader.evaluateString("*:" + SOSConnector.SAVA_HIS_ROOT +
	// "/*:featureMember/*/*:timestep");
	// String monitoringType = reader.evaluateString("*:" + SOSConnector.SAVA_HIS_ROOT +
	...
	// } catch (Exception e) {
	// GSLoggerFactory.getLogger(getClass()).warn("Unable to parse site elevation: " + elevation + " " +
	// e.getMessage());
	// }

	CoverageDescription coverageDescription = new CoverageDescription();
	// the name is from the CUAHSI concepts controlled vocabulary
	coverageDescription.setAttributeIdentifier(parameterIdentifier);// obs. property id
	...
	if (source.getEndpoint().contains("hnapi.hydronet.com") || source.getEndpoint().contains("hn4s.hydronet.com")
	    ...
	    coreMetadata.addDistributionOnlineResource(
		    ...
		    builder.removeCredentialsInRequests(url), NetProtocols.HTTP.getCommonURN(), "download");
	}
	...
	return stationName + " - " + parameterIdentifier;
    }
