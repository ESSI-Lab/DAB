 ...
 * @author Fabrizio
 */
public class WCSAccessor_100_ExternalTestIT {
	...
	// default a connector
	//
	WCSConnector_100 selectedConnector = (WCSConnector_100) connectorSetting.getSelectedConnector();

	Assert.assertEquals(WCSConnector_100.class, selectedConnector.getClass());
	...
	Assert.assertEquals("WCS_SCHEME_WCSConnector_100", listMetadataFormats.get(0));
    }
	...
	Assert.assertEquals("WCS_SCHEME_WCSConnector_100", schemeURI);
