 ...
 * @author Fabrizio
 */
public abstract class WCSConnector extends AbstractHarvestedQueryConnector {
     ...
     *
     */
    private static final long serialVersionUID = 2729877637089979745L;
	...
	if (identifiers == null) {
		...
		throw GSException.createException(//
			...
			WCS_CONNECTOR_NO_CAPABILITIES_ERROR, e);
	    }
