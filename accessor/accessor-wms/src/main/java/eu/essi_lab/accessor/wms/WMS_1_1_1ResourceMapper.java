...
public class WMS_1_1_1ResourceMapper extends OriginalIdentifierMapper {
	...
	try {
	    ...
	    WMS111Capabilities wmsCapabilities = new WMS111Capabilities(wmtsCapabilities);
	    ...
	    WMS111Layer wmsLayer = new WMS111Layer(wmsCapabilities, last);
	...
	WMS111Capabilities capabilities = new WMS111Capabilities(wmsCapabilities);
	...
	WMS111Layer wmsLayer = new WMS111Layer(capabilities, last);
