...
public class WMS111Layer extends IWMSLayer {

    private WMS111Capabilities capabilities;
    private Layer layer;
    private List<Layer> hierarchy;
    private static final String EPSG4326 = "EPSG:4326";

    public WMS111Layer(WMS111Capabilities capabilities, Layer layer) {
    ...
    public WMS111Layer(WMS111Capabilities capabilities, String name) {
	this.capabilities = capabilities;
	Layer rootLayer = capabilities.getCapabilities().getCapability().getLayer();
	...
	for (Layer localLayer : children) {
	    WMS111Layer child = new WMS111Layer(capabilities, localLayer);
	    ret.add(child);
	}
	return ret;
    }
