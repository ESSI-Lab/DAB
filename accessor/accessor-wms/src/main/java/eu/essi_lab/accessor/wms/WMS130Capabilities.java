...
public class WMS130Capabilities implements IWMSCapabilities {
    ...
    public WMS130Capabilities(WMSCapabilities capabilities) {
	this();
	this.capabilities = capabilities;
    }

    public WMS130Capabilities() {
	...
	return new WMS130Layer(this, name);
    }
	...
	return new WMS130Layer(this, newLayer);
    }
	...
	for (Layer layer : layers) {
	    ret.add(new WMS130Layer(this, layer));
	}
	return ret;
    }
