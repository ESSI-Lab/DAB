...
public class WMS_1_1_1Connector extends AbstractHarvestedQueryConnector implements IWMSConnector {
    ...
    @JsonIgnore
    static transient JAXBContext context;
    @JsonIgnore
    ...
    @JsonIgnore
    private transient WMTMSCapabilities capabilities;
    @JsonIgnore
	...
	try {
		...
		Optional<Integer> maxRecords = getMaxRecords();
	...
	return new WMS111Capabilities(fullCapabilities);
    }
    ...
    public void setCapabilities(WMS111Capabilities capabilities) {
