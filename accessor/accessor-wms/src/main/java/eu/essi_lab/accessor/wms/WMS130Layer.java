...
public class WMS130Layer extends IWMSLayer {

    private WMS130Capabilities capabilities;
    private Layer layer;
    private List<Layer> hierarchy;
    private static final String EPSG4326 = "EPSG:4326";

    public WMS130Layer(WMS130Capabilities capabilities, Layer layer) {
    ...
    public WMS130Layer(WMS130Capabilities capabilities, String name) {
	this.capabilities = capabilities;
	Layer rootLayer = capabilities.getCapabilities().getCapability().getLayer();
	...
	for (Layer localLayer : children) {
	    WMS130Layer child = new WMS130Layer(capabilities, localLayer);
	    ret.add(child);
	}
	return ret;
    }
