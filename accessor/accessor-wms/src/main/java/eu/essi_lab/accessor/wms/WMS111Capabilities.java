...
public class WMS111Capabilities implements IWMSCapabilities {
    ...
    public WMS111Capabilities(WMTMSCapabilities capabilities) {
	this();
	this.capabilities = capabilities;
    }

    public WMS111Capabilities() {
	...
	return new WMS111Layer(this, name);
    }
	...
	return new WMS111Layer(this, newLayer);
    }
	...
	for (Layer layer : layers) {
	    ret.add(new WMS111Layer(this, layer));
	}
	return ret;
    }
