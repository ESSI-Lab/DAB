 ...
 * @author Fabrizio
 */
public class WMS_1_1_1Accessor_ExternalTestIT {
	...
	// default a connector
	//
	WMS_1_1_1Connector selectedConnector = (WMS_1_1_1Connector) connectorSetting.getSelectedConnector();

	Assert.assertEquals(WMS_1_1_1Connector.class, selectedConnector.getClass());
	...
	Assert.assertEquals(CommonNameSpaceContext.WMS_1_1_1_NS_URI, listMetadataFormats.get(0));
    }
	...
	Assert.assertEquals(CommonNameSpaceContext.WMS_1_1_1_NS_URI, schemeURI);

	String metadata = gsResource.getOriginalMetadata().getMetadata();

	Assert.assertTrue(metadata.contains("WMT_MS_Capabilities"));
    }
}
