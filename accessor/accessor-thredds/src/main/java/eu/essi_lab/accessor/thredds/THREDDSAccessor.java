 ...
 * @author boldrini
 */
public class THREDDSAccessor extends HarvestedAccessor<THREDDSConnector> {
    ...
    @Override
    protected THREDDSConnectorSetting initHarvestedConnectorSetting() {
