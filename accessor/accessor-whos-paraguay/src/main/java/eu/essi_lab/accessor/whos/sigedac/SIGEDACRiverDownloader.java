 ...
 * @author boldrini
 */
public class SIGEDACRiverDownloader extends WMLDataDownloader {

    private static final String SIGEDAC_RIVER_DOWNLOADER_GET_REMOTE_DESCRIPTOR_ERROR = "SIGEDAC_RIVER_DOWNLOADER_GET_REMOTE_DESCRIPTOR_ERROR";
    private static final String SIGEDAC_RIVER_DOWNLOADER_DOWNLOAD_ERROR = "SIGEDAC_RIVER_DOWNLOADER_DOWNLOAD_ERROR";

    @Override
    public boolean canConnect() {
	return online.getLinkage().contains(CommonNameSpaceContext.SIGEDAC_RIVER_URI);
    }
	...
	return (online.getProtocol() != null && online.getProtocol().equals(CommonNameSpaceContext.SIGEDAC_RIVER_URI));
    }
	...
	try {
	    ...
	    throw GSException.createException(//
		    ...
		    SIGEDAC_RIVER_DOWNLOADER_GET_REMOTE_DESCRIPTOR_ERROR, //
		    e);
	}
    }
	...
	try {
	    ...
	    throw GSException.createException(//
		    ...
		    ErrorInfo.ERRORTYPE_INTERNAL, //
		    ErrorInfo.SEVERITY_ERROR, //
		    SIGEDAC_RIVER_DOWNLOADER_DOWNLOAD_ERROR, //
		    e);
	}
