 ...
 * @author boldrini
 */
public class AutomaticSystemDownloader extends WMLDataDownloader {
	...
	return online.getLinkage().contains(CommonNameSpaceContext.AUTOMATIC_SYSTEM_PARAGUAY_URI);
    }
	...
	return (online.getProtocol() != null && online.getProtocol().equals(CommonNameSpaceContext.AUTOMATIC_SYSTEM_PARAGUAY_URI));
    }
...
//	    Date end = variable.getObservationsEnd();
	...
	try {
	    ...
	    List<AutomaticSystemObservation> observations = client.getObservations(stationCode, parameterCode, begin, end);
