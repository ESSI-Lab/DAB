...
public class MeteoTrackerMapperTest {
...
//    }
    ...
    private MeteoTrackerMapper mapper;
    
    @Before
    public void init() {
	this.mapper = new MeteoTrackerMapper();
    }
    
    //@Test
    public void testMinimalMapperFromExample() throws Exception {
	InputStream stream = MeteoTrackerMapperTest.class.getClassLoader().getResourceAsStream("meteoTrackerRecord.json");
