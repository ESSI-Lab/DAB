 ...
 * @author Fabrizio
 */
public class SOCATAccessor extends HarvestedAccessor<SOCATConnector> {

    /**
     * 
     */
    public static final String TYPE = "SOCAT";
    ...
    @Override
    protected SOCATConnectorSetting initHarvestedConnectorSetting() {
