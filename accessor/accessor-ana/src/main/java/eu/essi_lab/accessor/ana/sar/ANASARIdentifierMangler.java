...
/**
 * The ANASAR identifier mangler is primarily used by the ANASAR mapper to create the file identifier and the
 * distribution
 * online resource name for ANASAR resources.
 * 
 * @author boldrini
 */
public class ANASARIdentifierMangler extends KVPMangler {
    private static final String PLATFORM_KEY = "platform";
    private static final String PARAMETER_KEY = "parameter";

    public ANASARIdentifierMangler() {
	super(";");
    }
