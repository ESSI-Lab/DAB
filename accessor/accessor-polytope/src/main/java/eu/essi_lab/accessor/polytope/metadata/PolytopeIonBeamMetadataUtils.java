...
public class PolytopeIonBeamMetadataUtils {

    private static final InputStream ALL_STATIONS = PolytopeIonBeamMetadataUtils.class.getClassLoader().getResourceAsStream("amsterdam/ams_full.csv");
