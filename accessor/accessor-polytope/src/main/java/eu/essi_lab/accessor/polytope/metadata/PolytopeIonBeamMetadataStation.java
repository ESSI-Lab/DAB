...
public class PolytopeIonBeamMetadataStation {
...
//    String endTime; // e.g. 1500 (yyyymmdd)
    ...
    public PolytopeIonBeamMetadataStation() {

    }

    public PolytopeIonBeamMetadataStation(String stationCode, String name, List<List<Double>> multipoint, String minLat, String minLon, String maxLat,
