...
public class PolytopeMeteoTrackerDownloader extends DataDownloader {

    private Downloader downloader;

    public PolytopeMeteoTrackerDownloader() {
	...
	try {
		...
		for (CSVRecord record : records) {
		    ...
		    Date initialDateTime = PolytopeMapper.setTime(date, time);
		    BigDecimal timeOffset = new BigDecimal(timeOffsetString);
		    Date observationDateTime = PolytopeMeteoTrackerMapper.updateDateTime(initialDateTime, timeOffset);
		...
		NetCDFVariable<Integer> temperatureVariable = new NetCDFVariable<>("temperature", temperatures, "K",
