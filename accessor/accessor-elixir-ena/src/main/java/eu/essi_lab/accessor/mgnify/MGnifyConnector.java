	...
	public ListRecordsResponse<OriginalMetadata> listRecords(ListRecordsRequest request) throws GSException {
		...
		for (Pages<Study> studyPages : pagedStudies) {
			...
			while (studyPages != null) {
				...
				GSLoggerFactory.getLogger(getClass()).info("Study page {} out of {}", studyPages.getPage(),
						studyPages.getPages());
				...
				for (Study study : studies) {
					...
					try {
						...
						while (samplePages != null) {
							GSLoggerFactory.getLogger(getClass()).info("Sample page {} out of {}",
									samplePages.getPage(), samplePages.getPages());
						...
						while (analysisPages != null) {
							GSLoggerFactory.getLogger(getClass()).info("Analysis page {} out of {}",
									analysisPages.getPage(), analysisPages.getPages());
							...
							for (Analysis ana : analyses) {
								...
								while (taxonomyPages != null) {
									GSLoggerFactory.getLogger(getClass()).info("Taxonomy page {} out of {}",
											taxonomyPages.getPage(), taxonomyPages.getPages());
						...
						GSLoggerFactory.getLogger(getClass()).error("Error for MGNIFY study {}, {}", study.getId(),
								e.getMessage());
						e.printStackTrace();
					}
					// return ret;
