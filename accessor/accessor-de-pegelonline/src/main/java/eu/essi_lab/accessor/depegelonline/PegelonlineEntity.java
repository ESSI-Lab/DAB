 ...
 * @author boldrini
 */
public class PegelonlineEntity extends JSONObjectWrapper {
	...
	STATION, TIMESERIES, MEASUREMENT;
    }

    /**
     * @param source
     */
    public PegelonlineEntity(String source) {
     ...
     * @param object
     */
    public PegelonlineEntity(JSONObject object) {
     ...
     * @param type
     */
    public PegelonlineEntity(JSONObject object, EntityType type) {
	...
	case TIMESERIES:
	    ...
	    break;
	case MEASUREMENT:
	    getObject().put("entityType", "measurement");
	    break;
	}
    }
