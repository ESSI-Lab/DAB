...
//    public static String REFRESH_BEARER_TOKEN = null;
	...
	if (res != null) {
	       stationsArray = new JSONArray(res);
	}
	...
	if (stationsArray != null) {
		...
		if (id != null && !id.isEmpty()) {
		    String getMeasurePath = SENSOR_URL + "category=All&station_id=" + id
				+ "&field=ElementName&field=ElementId&field=StationName&field=StartDate&field=EndDate&field=MeasUnit";
		    String measureString = client.getData(getMeasurePath);
		    JSONArray measuresArray = null;
		    if(measureString != null) {
			measuresArray = new JSONArray(measureString);
		    }	    
...
//    }
	...
	return endpoint.contains("rlazio.dynalias.org") || endpoint.contains("93.43.40.47");
    }
