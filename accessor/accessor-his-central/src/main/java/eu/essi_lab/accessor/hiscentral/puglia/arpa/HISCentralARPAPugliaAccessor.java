 ...
 * @author Roberto
 */
public class HISCentralARPAPugliaAccessor extends HarvestedAccessor<HISCentralARPAPugliaConnector> {
    ...
    @Override
    protected HISCentralARPAPugliaConnectorSetting initHarvestedConnectorSetting() {
