 ...
 * @author Roberto
 */
public class HISCentralPugliaAccessor extends HarvestedAccessor<HISCentralPugliaConnector> {
    ...
    @Override
    protected HISCentralPugliaConnectorSetting initHarvestedConnectorSetting() {
