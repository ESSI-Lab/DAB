...
/**
 * Encodes platform, parameter and source identifiers in the distribution online resource name.
 */
public class HISCentralLiguriaIdentifierMangler extends KVPMangler {

    private static final String PLATFORM_KEY = "platform";
    private static final String PARAMETER_KEY = "parameter";
    private static final String SOURCE_KEY = "source";

    public HISCentralLiguriaIdentifierMangler() {
	super(";");
    }
