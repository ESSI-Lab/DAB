 ...
 * @author Fabrizio
 */
public class HISCentralSardegnaScaleDeflussoDownloader extends WMLDataDownloader {

    private static final String HISCENTRAL_SARDEGNA_SCALE_DEFLUSSO_DOWNLOAD_ERROR = "HISCENTRAL_SARDEGNA_SCALE_DEFLUSSO_DOWNLOAD_ERROR";
     ...
     *
     */
    public HISCentralSardegnaScaleDeflussoDownloader() {
	...
	if (ex != null) {
	    ...
	    throw GSException.createException(//
		    ...
		    HISCENTRAL_SARDEGNA_SCALE_DEFLUSSO_DOWNLOAD_ERROR);
	}
	...
	for (int i = 0; i < results.length(); i++) {
	    ...
	    throw GSException.createException(getClass(), "Unable to parse paginated rating curves", null, ErrorInfo.ERRORTYPE_INTERNAL,
		    ErrorInfo.SEVERITY_ERROR, HISCENTRAL_SARDEGNA_SCALE_DEFLUSSO_DOWNLOAD_ERROR);
