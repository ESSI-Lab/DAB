 ...
 * @author ilsanto
 */
public class CMRGranulesBondHandler implements DiscoveryBondHandler {

    private final CMRGranulesTemplate template;
    private Logger logger = GSLoggerFactory.getLogger(CMRGranulesBondHandler.class);
    ...
    public CMRGranulesBondHandler(String templateUrl) {
	template = new CMRGranulesTemplate(templateUrl);
