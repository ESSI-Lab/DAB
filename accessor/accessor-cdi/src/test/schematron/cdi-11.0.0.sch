...
<!-- 
    ...
    *
    * schematron rules version 11.0.0
    */
-->
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    ...
    <sch:pattern>
        ...
        <sch:rule context="gmd:MD_Metadata">            
            <sch:assert test="count(gmd:referenceSystemInfo)&lt;2">referenceSystemInfo cardinality bigger than 1</sch:assert>
        </sch:rule>
    </sch:pattern>
    <sch:pattern>
    ...
    <sch:pattern>
        <sch:title>geographicElement (337) -> mandatory</sch:title>
        <sch:rule context="gmd:EX_Extent">            
