...
<!-- 
    ...
    *
    * schematron rules version 4.0.0
    */
-->
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    ...
    <sch:pattern>
        <sch:title>spatialRepresentationInfo (12) -> mandatory</sch:title>
        <sch:rule context="gmd:MD_Metadata">            
            <sch:assert test="gmd:spatialRepresentationInfo">spatialRepresentationInfo missing</sch:assert>
        </sch:rule>
    </sch:pattern>
    <sch:pattern>
        <sch:title>referenceSystemInfo (13) -> restricted cardinality</sch:title>
        <sch:rule context="gmd:MD_Metadata">            
            <sch:assert test="count(gmd:referenceSystemInfo)=1">referenceSystemInfo cardinality differs from 1</sch:assert>
        </sch:rule>
    </sch:pattern>
    <sch:pattern>
    ...
    <sch:pattern>
        <sch:title>pointOfContact (29) -> mandatory</sch:title>
    ...
    <sch:pattern>
        ...
        <sch:rule context="gmd:keyword">            
            <sch:assert test="gco:CharacterString or sdn:SDN_DeviceCategoryCode or sdn:SDN_PlatformCategoryCode or sdn:SDN_ParameterDiscoveryCode or sdn:SDN_EDMERPCode or sdn:SDN_PortCode or sdn:SDN_CountryCode or sdn:SDN_PlatformCode or sdn:SDN_WaterBodyCode or sdn:SDN_MarsdenCode">keyword type must be one of CharacterString or SDN_DeviceCategoryCode or SDN_PlatformCategoryCode or SDN_ParameterDiscoveryCode or SDN_EDMERPCode or SDN_PortCode or SDN_CountryCode or SDN_PlatformCode or SDN_WaterBodyCode or SDN_MarsdenCode</sch:assert>
        </sch:rule>
    </sch:pattern>    
    
    <!-- Resolution information -->
    <!-- e.g. uom = http://www.seadatanet.org/urnurl/SDN:P06::ULAA -->
    <!-- e.g. uomValue = ULAA -->
    <!-- e.g. length = 4-->
    ...
    <sch:pattern>
        ...
        <sch:rule context="gmd:MD_Resolution">            
            <sch:let name="list" value="'http://www.seadatanet.org/urnurl/SDN:P06::'"/>
            ...
            <!--sch:let name="catalog" value="document('http://www.seadatanet.org/urnurl/SDN:P06')"/-->
            <sch:let name="catalog" value="document($uom)"/>            
            <sch:assert test="gmd:distance">distance missing</sch:assert>            
            <sch:assert test="starts-with($uom,$list)">distance uom must start with http://www.seadatanet.org/urnurl/SDN:P06::</sch:assert>
    ...
    <sch:pattern>
        <sch:title>report (82) -> mandatory</sch:title>
        <sch:rule context="gmd:DQ_DataQuality">            
    ...
    <sch:pattern>
        <sch:title>code (207) -> restricted domain</sch:title>
        <sch:rule context="gmd:MD_Identifier">            
            <sch:assert test="gmd:code/gco:CharacterString or gmd:code/sdn:SDN_EDMEDCode">CharacterString or EDMED code missing</sch:assert>
        </sch:rule>
    </sch:pattern>
    <sch:pattern>
        <sch:title>code (207) -> restricted domain</sch:title>
    ...
    <!-- Extent information -->
    <sch:pattern>
        <sch:title>geographicElement (336,337) -> conditional</sch:title>
        <sch:rule context="gmd:EX_Extent">            
            <sch:assert test="gmd:geographicElement or gmd:temporalElement or gmd:verticalElement">geographicElement, temporalElement and verticalElement missing</sch:assert>
        </sch:rule>
    </sch:pattern>    
    <sch:pattern>
    ...
    <sch:pattern>
        ...
        <sch:rule context="gmd:EX_VerticalExtent">
            <sch:let name="list" value="'http://www.seadatanet.org/urnurl/SDN:L11::'"/>
            ...
            <!--sch:let name="catalog" value="document('http://www.seadatanet.org/urnurl/SDN:L11')"/-->
            <sch:let name="catalog" value="document($identifier)"/>
            <sch:assert test="starts-with($identifier,$list)">vertical datum identifier must start with http://www.seadatanet.org/urnurl/SDN:L11::</sch:assert>           
    ...
    <sch:pattern>
        ...
        <sch:rule context="*">            
            <sch:assert test="node() or @gco:nilReason or @xlink:href">null objects are not permitted unless for optional elements - in that case a reason for the null must be provided - a xlink pointer is also allowed</sch:assert>
        </sch:rule>
    </sch:pattern>
    ...
    <sch:pattern>
        ...
        <sch:rule context="gmd:RS_identifier">            
            ...
            <sch:assert test="gmd:authority/gmd:CI_Citation/gmd:identifier/gmd:MD_Identifier/gmd:code/gco:CharacterString='http://www.seadatanet.org/urnurl/SDN:L10'">L10 should be referenced</sch:assert>
        </sch:rule>
    </sch:pattern>
    <sch:pattern>
        ...
        <sch:rule context="gmd:MD_Keywords[gmd:keyword/sdn:SDN_ParameterDiscoveryCode]">            
            ...
            <sch:assert test="gmd:thesaurusName/gmd:CI_Citation/gmd:identifier/gmd:MD_Identifier/gmd:code/gco:CharacterString='http://www.seadatanet.org/urnurl/SDN:P02'">P02 should be referenced</sch:assert>
        </sch:rule>
    </sch:pattern>
    <sch:pattern>
        <sch:title>MD_Keywords -> SDN thesaurus should be documented</sch:title>
        <sch:rule context="gmd:MD_Keywords[gmd:keyword/sdn:SDN_DeviceCategoryCode]">            
            ...
            <sch:assert test="gmd:thesaurusName/gmd:CI_Citation/gmd:identifier/gmd:MD_Identifier/gmd:code/gco:CharacterString='http://www.seadatanet.org/urnurl/SDN:L05'">L05 should be referenced</sch:assert>
        </sch:rule>
    </sch:pattern>
    <sch:pattern>
        <sch:title>MD_Keywords -> SDN thesaurus should be documented</sch:title>
        <sch:rule context="gmd:MD_Keywords[gmd:keyword/sdn:SDN_PlatformCategoryCode]">            
            ...
            <sch:assert test="gmd:thesaurusName/gmd:CI_Citation/gmd:identifier/gmd:MD_Identifier/gmd:code/gco:CharacterString='http://www.seadatanet.org/urnurl/SDN:L06'">L06 should be referenced</sch:assert>
        </sch:rule>
    </sch:pattern>
    <sch:pattern>
        <sch:title>MD_Keywords -> SDN thesaurus should be documented</sch:title>
        <sch:rule context="gmd:MD_Keywords[gmd:keyword/sdn:SDN_EDMERPCode]">            
            ...
            <sch:assert test="gmd:thesaurusName/gmd:CI_Citation/gmd:identifier/gmd:MD_Identifier/gmd:code/gco:CharacterString='http://www.seadatanet.org/urnurl/SDN:EDMERP'">EDMERP should be referenced</sch:assert>
        </sch:rule>
    </sch:pattern>
    ...
    <sch:pattern>
        <sch:title>INSPIRE conformance report</sch:title>
        <sch:rule context="gmd:MD_Metadata">            
            <sch:assert test="gmd:dataQualityInfo/*/gmd:report/*/gmd:result/*/gmd:specification/gmd:CI_Citation/gmd:title/gco:CharacterString">[INSPIRE conformance report] conformance report against INSPIRE metadata regulation must be documented</sch:assert>
        </sch:rule>
    </sch:pattern>
