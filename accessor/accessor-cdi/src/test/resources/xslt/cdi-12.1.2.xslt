      ...
      <xsl:otherwise>
        <svrl:failed-assert test="$catalog//dc:identifier[substring(.,string-length(.) - $length + 1,$length) = $uomValue]">
          ...
          <svrl:text>
            <xsl:text />
            <xsl:value-of select="local-name(.)" />
            <xsl:text />: the given uomValue (<xsl:text />
            <xsl:value-of select="$uomValue" />
            <xsl:text />) is not included in P06 list          </svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M32" select="*" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="string-length(normalize-space(substring-after(gco:Decimal, '.'))) > 1">
          ...
          <svrl:text>Precision of two decimal places is required for westBoundLongitude</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M54" select="*" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="string-length(normalize-space(substring-after(gco:Decimal, '.'))) > 1">
          ...
          <svrl:text>Precision of two decimal places is required for eastBoundLongitude</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M55" select="*" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="string-length(normalize-space(substring-after(gco:Decimal, '.'))) > 1">
          ...
          <svrl:text>Precision of two decimal places is required for southBoundLatitude</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M56" select="*" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="string-length(normalize-space(substring-after(gco:Decimal, '.'))) > 1">
          ...
          <svrl:text>Precision of two decimal places is required for northBoundLatitude</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M57" select="*" />
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="$catalog//dc:identifier[substring(.,string-length(.) - $length + 1,$length) = $identifierValue]">
          ...
          <svrl:text>
            <xsl:text />
            <xsl:value-of select="local-name(.)" />
            <xsl:text />: the given vertical datum identifier (<xsl:text />
            <xsl:value-of select="$identifierValue" />
            <xsl:text />) is not included in L11 list          </svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="* or normalize-space(text()) or @gco:nilReason or @xlink:href">
          ...
          <svrl:text>Empty <xsl:text />
            <xsl:value-of select="local-name(../.)" />
            <xsl:text /> / <xsl:text />
            <xsl:value-of select="local-name(.)" />
            <xsl:text />. Empty objects are not permitted unless for optional elements - in that case a reason must be provided - a xlink pointer is also allowed</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M75" select="*" />
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="$catalog//gmx:codelistItem/*[@gml:id=$codeList or @gml32:id=$codeList]/gmx:codeEntry/*[gml:identifier=$codeListValue or gml32:identifier=$codeListValue]">
          ...
          <svrl:text>
            <xsl:text />
            <xsl:value-of select="local-name(.)" />
            <xsl:text />: the given value (<xsl:text />
            <xsl:value-of select="$codeListValue" />
            <xsl:text />) is not allowed by the codelist catalogue          </svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M91" select="*" />
