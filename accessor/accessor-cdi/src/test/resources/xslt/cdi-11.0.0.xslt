...
<xsl:template match="/">
    <svrl:schematron-output schemaVersion="" title="SeaDatanet profile schematron">
      ...
      <svrl:active-pattern>
        ...
        <xsl:attribute name="name">geographicElement (337) -&gt; mandatory</xsl:attribute>
        <xsl:apply-templates />
      </svrl:active-pattern>
...
<xsl:template match="gmd:MD_Metadata" mode="M19" priority="1000">
    <svrl:fired-rule context="gmd:MD_Metadata" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="count(gmd:referenceSystemInfo)&lt;2" />
      <xsl:otherwise>
        <svrl:failed-assert test="count(gmd:referenceSystemInfo)&lt;2">
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>referenceSystemInfo cardinality bigger than 1</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<!--PATTERN geographicElement (337) -> mandatory-->
<svrl:text>geographicElement (337) -&gt; mandatory</svrl:text>
...
<svrl:text>EX_BoundingPolygon (341) -&gt; restricted domain</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:EX_BoundingPolygon" mode="M51" priority="1000">
...
<svrl:text>EX_GeographicBoundingBox (343) -&gt; restricted domain</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:EX_GeographicBoundingBox" mode="M52" priority="1000">
...
<svrl:text>geographicIdentifier (349) -&gt; restricted domain</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:geographicIdentifier" mode="M53" priority="1000">
...
<svrl:text>extent (351) -&gt; restricted domain</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:EX_TemporalExtent/gmd:extent" mode="M54" priority="1000">
...
<svrl:text>verticalDatum (358) -&gt; restricted domain</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:EX_VerticalExtent" mode="M55" priority="1000">
...
<svrl:text>identifier (365)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:identifier" mode="M56" priority="1000">
...
<svrl:text>country (385) -&gt; restricted data type and domain</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:country" mode="M60" priority="1000">
...
<svrl:text>electronicMailAddress (386) -&gt; mandatory</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:CI_Address" mode="M61" priority="1000">
...
<svrl:text>address (389) -&gt; mandatory</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:CI_Contact" mode="M62" priority="1000">
...
<svrl:text>linkage (397) -&gt; restricted domain</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:linkage" mode="M63" priority="1000">
...
<svrl:text>otherConstraints (72) -&gt; conditional</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_LegalConstraints" mode="M64" priority="1000">
...
<svrl:text>EX_GeographicBoundingBox (343) -&gt; restricted domain</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:EX_GeographicBoundingBox" mode="M69" priority="1000">
    <svrl:fired-rule context="gmd:EX_GeographicBoundingBox" />
...
<svrl:text>null elements are not allowed</svrl:text>
	...
	<!--RULE -->
<xsl:template match="*" mode="M70" priority="1000">
...
<svrl:text>RS_Identifier -&gt; L101 thesaurus should be documented</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:RS_identifier" mode="M74" priority="1000">
    <svrl:fired-rule context="gmd:RS_identifier" />
...
<svrl:text>MD_Keywords -&gt; SDN thesaurus should be documented</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_Keywords[gmd:keyword/sdn:SDN_ParameterDiscoveryCode]" mode="M75" priority="1000">
...
<svrl:text>MD_Keywords -&gt; SDN thesaurus should be documented</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_Keywords[gmd:keyword/sdn:SDN_DeviceCategoryCode]" mode="M76" priority="1000">
...
<svrl:text>MD_Keywords -&gt; SDN thesaurus should be documented</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_Keywords[gmd:keyword/sdn:SDN_PlatformCategoryCode]" mode="M77" priority="1000">
...
<svrl:text>MD_Keywords -&gt; SDN thesaurus should be documented</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_Keywords[gmd:keyword/sdn:SDN_EDMERPCode]" mode="M78" priority="1000">
...
<svrl:text>INSPIRE SC16</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_Metadata/gmd:contact/gmd:CI_ResponsibleParty/gmd:role/gmd:CI_RoleCode" mode="M82" priority="1000">
...
<svrl:text>INSPIRE SC17</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_DataIdentification" mode="M83" priority="1000">
...
<svrl:text>INSPIRE conformance report</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_Metadata" mode="M84" priority="1000">
    <svrl:fired-rule context="gmd:MD_Metadata" />
...
<svrl:text>Validation of codelists</svrl:text>
	...
	<!--RULE -->
<xsl:template match="*[@codeList]" mode="M85" priority="1000">
