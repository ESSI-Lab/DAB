...
<svrl:text>geographicIdentifier (349) -&gt; restricted domain</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:geographicIdentifier" mode="M54" priority="1000">
...
<svrl:text>extent (351) -&gt; restricted domain</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:EX_TemporalExtent/gmd:extent" mode="M55" priority="1000">
...
<svrl:text>verticalDatum (358) -&gt; restricted domain</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:EX_VerticalExtent" mode="M56" priority="1000">
...
<svrl:text>identifier (365)</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:identifier" mode="M57" priority="1000">
...
<svrl:text>organisationName (376) -&gt; restricted domain</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:CI_ResponsibleParty" mode="M59" priority="1000">
    <svrl:fired-rule context="gmd:CI_ResponsibleParty" />
...
<svrl:text>contactInfo (378) -&gt; mandatory; restricted cardinality</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:CI_ResponsibleParty" mode="M60" priority="1000">
    <svrl:fired-rule context="gmd:CI_ResponsibleParty" />
...
<svrl:text>country (385) -&gt; restricted data type and domain</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:country" mode="M61" priority="1000">
...
<svrl:text>electronicMailAddress (386) -&gt; mandatory</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:CI_Address" mode="M62" priority="1000">
...
<svrl:text>address (389) -&gt; mandatory</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:CI_Contact" mode="M63" priority="1000">
...
<svrl:text>linkage (397) -&gt; restricted domain</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:linkage" mode="M64" priority="1000">
...
<svrl:text>otherConstraints (72) -&gt; conditional</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_LegalConstraints" mode="M65" priority="1000">
...
<svrl:text>condition (312) -&gt; conditional</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_ExtendedElementInformation" mode="M68" priority="1000">
    <svrl:fired-rule context="gmd:MD_ExtendedElementInformation" />
...
<svrl:text>obligation (311), maximumOccurrence (314), domainValue (315) -&gt; conditional</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_ExtendedElementInformation" mode="M69" priority="1000">
    <svrl:fired-rule context="gmd:MD_ExtendedElementInformation" />
    <xsl:variable name="datatypeCode" select="gmd:dataType/gmd:MD_DatatypeCode/@codeListValue" />
...
<svrl:text>EX_GeographicBoundingBox (343) -&gt; restricted domain</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:EX_GeographicBoundingBox" mode="M70" priority="1000">
    <svrl:fired-rule context="gmd:EX_GeographicBoundingBox" />
...
<svrl:text>null elements are not allowed</svrl:text>
	...
	<!--RULE -->
<xsl:template match="*" mode="M71" priority="1000">
...
<svrl:text>associationType (66.5) -&gt; At least one keyword with type 'platform_class' should be documented</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_Metadata" mode="M73" priority="1000">
    <svrl:fired-rule context="gmd:MD_Metadata" />
...
<svrl:text>associationType (66.5) -&gt; At least one keyword with type 'parameter' should be documented</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_Metadata" mode="M74" priority="1000">
    <svrl:fired-rule context="gmd:MD_Metadata" />
...
<svrl:text>RS_Identifier -&gt; L101 thesaurus should be documented</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:RS_identifier" mode="M75" priority="1000">
    <svrl:fired-rule context="gmd:RS_identifier" />
...
<svrl:text>MD_Keywords -&gt; SDN thesaurus should be documented</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_Keywords[gmd:keyword/sdn:SDN_ParameterDiscoveryCode]" mode="M76" priority="1000">
...
<svrl:text>MD_Keywords -&gt; SDN thesaurus should be documented</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_Keywords[gmd:keyword/sdn:SDN_DeviceCategoryCode]" mode="M77" priority="1000">
...
<svrl:text>MD_Keywords -&gt; SDN thesaurus should be documented</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_Keywords[gmd:keyword/sdn:SDN_PlatformCategoryCode]" mode="M78" priority="1000">
...
<svrl:text>MD_Keywords -&gt; SDN thesaurus should be documented</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_Keywords[gmd:keyword/sdn:SDN_EDMERPCode]" mode="M79" priority="1000">
...
<svrl:text>INSPIRE SC8</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification" mode="M81" priority="1000">
    <svrl:fired-rule context="gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification" />
...
<svrl:text>INSPIRE SC10</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification" mode="M82" priority="1000">
    <svrl:fired-rule context="gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification" />
...
<svrl:text>INSPIRE SC16</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_Metadata/gmd:contact/gmd:CI_ResponsibleParty/gmd:role/gmd:CI_RoleCode" mode="M83" priority="1000">
...
<svrl:text>INSPIRE SC17</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_DataIdentification" mode="M84" priority="1000">
...
<svrl:text>INSPIRE conformance report as regards metadata</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_Metadata" mode="M85" priority="1001">
    <svrl:fired-rule context="gmd:MD_Metadata" />
...
<svrl:text>INSPIRE conformance report as regards interoperability of spatial data sets and services</svrl:text>
	...
	<!--RULE -->
<xsl:template match="gmd:MD_Metadata" mode="M86" priority="1001">
    <svrl:fired-rule context="gmd:MD_Metadata" />
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="gmd:dataQualityInfo[*/gmd:report/*/gmd:result/*/gmd:specification/gmd:CI_Citation/gmd:title/gco:CharacterString='COMMISSION REGULATION (EU) No 1089/2010 of 23 November 2010 implementing Directive 2007/2/EC of the European Parliament and of the Council as regards interoperability of spatial data sets and services']" mode="M86" priority="1000">
...
<svrl:text>Validation of codelists</svrl:text>
	...
	<!--RULE -->
<xsl:template match="*[@codeList]" mode="M87" priority="1000">
