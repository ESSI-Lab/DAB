 ...
 * @author Fabrizio
 */
public class GBIFMixedHarvestedAccessor extends MixedHarvestedAccessor<GBIFHarvestedConnector> {

    public static final String ACCESSOR_TYPE = "GBIFMixedHarvested";
