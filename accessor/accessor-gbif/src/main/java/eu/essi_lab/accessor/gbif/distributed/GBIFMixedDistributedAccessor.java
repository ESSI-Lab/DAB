 ...
 * @author Fabrizio
 */
public class GBIFMixedDistributedAccessor extends MixedDistributedAccessor<GBIFDistributedConnector> {

    public static final String ACCESSOR_TYPE = "GBIFMixedDistributed";

    @Override
    protected AccessorSetting initMixedSetting() {

	return GBIFMixedSettingFactory.createMixedSetting();
    }
