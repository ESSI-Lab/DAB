...
import eu.essi_lab.accessor.csw.CSWRCMRDConnector;
 ...
 * @author Fabrizio
 */
public class CSWAccessorCSWRCMRDConnectorExternalTestIT {
	...
	gsSourceSetting.setSourceEndpoint("http://geoportal.rcmrd.org/catalogue/csw?");
	...
	// default connector
	//
	connectorSetting.selectConnectorType(CSWRCMRDConnector.TYPE);

	CSWRCMRDConnector selectedConnector = (CSWRCMRDConnector) connectorSetting.getSelectedConnector();

	Assert.assertEquals(CSWRCMRDConnector.class, selectedConnector.getClass());
