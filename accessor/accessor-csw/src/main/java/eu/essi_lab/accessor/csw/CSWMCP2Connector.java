...
public class CSWMCP2Connector extends CSWConnector {
    private static final long serialVersionUID = 8433160599862211120L;

    public CSWMCP2Connector() {
    }

    @Override
    public String getLabel() {

	return "CSW MCP 2 Connector";
    }
