 ...
 * @author Fabrizio
 */
public class NextGEOSSOpenSearchAccessor extends MixedHarvestedAccessor<NextGEOSSOpensearchConnector> {

    /**
     * 
     */
    public static final String TYPE = "NextGEOSSOpenSearch";
