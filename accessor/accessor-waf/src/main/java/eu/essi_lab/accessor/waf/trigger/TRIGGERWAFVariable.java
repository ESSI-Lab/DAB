...
public enum TRIGGERWAFVariable {
    ...
    MUGWORT_POLLEN("Mugwort pollen","cams_eu_mugwort_pollen_web","The AUX provides forecasts for various pollen types, measured in grains per cubic meter (grains/m³)", "grains/m³"),
    GRASS_POLLEN("Grass pollen","cams_eu_grass_pollen_web","The AUX provides forecasts for various pollen types, measured in grains per cubic meter (grains/m³)", "grains/m³"),
    BIRCH_POLLEN("Birch pollen","cams_eu_birch_pollen_web","The AUX provides forecasts for various pollen types, measured in grains per cubic meter (grains/m³)", "grains/m³");
