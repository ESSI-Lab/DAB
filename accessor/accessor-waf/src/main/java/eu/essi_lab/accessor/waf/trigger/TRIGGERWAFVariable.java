...
public enum TRIGGERWAFVariable {
    ...
    HUMIDITY("2m relative humidity (2R)", "2r", "The ratio of the partial pressure of water vapour to the equilibrium vapour pressure of water at the same temperature near the surface. Note that the specific height level above ground might vary from one centre to another.","percent"),
