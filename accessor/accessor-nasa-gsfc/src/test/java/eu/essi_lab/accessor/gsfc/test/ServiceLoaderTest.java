package eu.essi_lab.accessor.gsfc.test;
...
import eu.essi_lab.accessor.gsfc.NasaGSFCAccessor;
import eu.essi_lab.accessor.gsfc.NasaGSFCConnector;
...
public class ServiceLoaderTest {
...

	{
	    ...
	    Assert.assertEquals(NasaGSFCAccessor.class, accessors.get(0).getClass());
