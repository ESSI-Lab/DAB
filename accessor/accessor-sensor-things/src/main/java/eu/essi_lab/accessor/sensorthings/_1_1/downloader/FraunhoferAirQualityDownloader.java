 ...
 * @author Fabrizio
 */
public class FraunhoferAirQualityDownloader extends SensorThingsDownloader {
	...
	String phenomenonTime = super.getPhenomenonTime(arrayElement, phenomenonTimeIndex);

	return phenomenonTime.substring(0, phenomenonTime.indexOf("/"));
    }
}
