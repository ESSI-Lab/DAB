 ...
 * @author roncella
 */
public class AgrostacGranulesConnector extends DistributedQueryConnector<AgrostacGranulesConnectorSetting> {

    /**
     * 
     */
    public static final String TYPE = "AgrostacGranulesConnector";
     ...
     * 
     */
    public AgrostacGranulesConnector() {
    }
	...
	return AgrostacCollectionMapper.readInt(json, COUNT_KEY).orElse(0);
    }
	...
	AgrostacGranulesBondHandler bondHandler = parse(message, page.getStart(), page.getSize(), datasetId);
    ...
    AgrostacGranulesBondHandler parse(ReducedDiscoveryMessage message, int start, int count, String datasetId) {

	AgrostacGranulesBondHandler bondHandler = new AgrostacGranulesBondHandler(datasetId);
	...
	for (int i = 0; i < array.length(); i++) {
	    ...
	    om.setSchemeURI(AgrostacGranulesMapper.WORLDCEREAL_GRANULES_SCHEME_URI);
    ...
    @Override
    protected AgrostacGranulesConnectorSetting initSetting() {

	return new AgrostacGranulesConnectorSetting();
    }
