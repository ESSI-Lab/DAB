 ...
 * @author Roberto
 */
public class CopernicusDataspaceGranulesAccessor extends MixedDistributedAccessor<CopernicusDataspaceGranulesConnector> {

    /**
     * 
     */
    public static final String TYPE = "CopernicusDataspaceGranules";
