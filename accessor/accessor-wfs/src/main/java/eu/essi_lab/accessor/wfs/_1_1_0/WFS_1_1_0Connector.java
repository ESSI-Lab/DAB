 ...
 * @author boldrini
 */
public class WFS_1_1_0Connector extends WFSConnector {
	...
	for (URL url : urlsList) {
		...
		if (ret.isPresent()) {
		    ...
		    throw GSException.createException(getClass(), "No stream from WFS 1.1.0 Connector " + sourceURL, null,
			    ErrorInfo.ERRORTYPE_SERVICE, ErrorInfo.SEVERITY_ERROR, CANT_CREATE_CAP_URL);
		}
