...
/**
 * The RIHMI identifier mangler is primarily used by the RIHMI mapper to create the file identifier and the distribution
 * online resource name for RIHMI resources.
 * 
 * @author boldrini
 */
public class RIHMIIdentifierMangler extends KVPMangler {
    private static final String PLATFORM_KEY = "platform";
    private static final String PARAMETER_KEY = "parameter";

    public RIHMIIdentifierMangler() {
	super(";");
    }
