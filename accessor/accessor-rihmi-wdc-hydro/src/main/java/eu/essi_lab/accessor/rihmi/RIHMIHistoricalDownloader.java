...
public class RIHMIHistoricalDownloader extends DataDownloader {

    private static final String RIHMI_HISTORICAL_DOWNLOADER_ERROR = "RIHMI_HISTORICAL_DOWNLOADER_ERROR";
	...
	return (online.getProtocol() != null && online.getProtocol().equals(CommonNameSpaceContext.RIHMI_HISTORICAL_URI));
	...
	try {
	    ...
	    throw GSException.createException(//
		    ...
		    RIHMI_HISTORICAL_DOWNLOADER_ERROR, //
		    e);
	}
