...
public class RIHMIDownloader extends DataDownloader {

    private static final String RIHMI_DOWNLOAD_ERROR = "RIHMI_DOWNLOAD_ERROR";
	...
	try {
	    ...
	    InputStream data = client.getWaterML(stationId, start, end);
	...
	return (online.getProtocol() != null && online.getProtocol().equals(CommonNameSpaceContext.RIHMI_URI));
	...
	try {
		...
		if (begin != null && end != null) {
		    InputStream wml = client.getWaterML(stationId, begin, end);
