 ...
 * @author Fabrizio
 */
public class FEDEOMixedHarvestedAccessor extends MixedHarvestedAccessor<FEDEOCollectionConnector> {

    public static final String ACCESSOR_TYPE = "FEDEOMixedHarvested";
