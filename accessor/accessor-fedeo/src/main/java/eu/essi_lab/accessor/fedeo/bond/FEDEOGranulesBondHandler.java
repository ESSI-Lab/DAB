...
import eu.essi_lab.accessor.fedeo.distributed.FEDEOGranulesTemplate;
 ...
 * @author roncella
 */
public class FEDEOGranulesBondHandler implements DiscoveryBondHandler {

    private final FEDEOGranulesTemplate template;
    private Logger logger = GSLoggerFactory.getLogger(FEDEOGranulesBondHandler.class);
	...
	template.setLat("" + south);

	template.setLon("" + west);
    ...
    public FEDEOGranulesBondHandler(String templateUrl) {
	template = new FEDEOGranulesTemplate(templateUrl);
