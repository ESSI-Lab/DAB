 ...
 * @author Fabrizio
 */
public class FEDEOMixedDistributedAccessor extends MixedDistributedAccessor<FEDEOGranulesConnector> {

    public static final String ACCESSOR_TYPE = "FEDEOMixedDistributed";
	...
	return FEDEOMixedSettingFactory.createMixedSetting();
    }
}
