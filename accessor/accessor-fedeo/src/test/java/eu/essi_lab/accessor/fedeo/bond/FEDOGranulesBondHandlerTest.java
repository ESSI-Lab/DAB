package eu.essi_lab.accessor.fedeo.bond;
...
public class FEDOGranulesBondHandlerTest {
	...
	String template = "https://fedeo.ceos.org/opensearch/request?httpAccept=application%2Fatom%2Bxml&parentIdentifier=EOP:SSARA&startRecord={startRecord?}&maximumRecords={maximumRecords?}&startDate={time:start}&endDate={time:end}&bbox={geo:box}&clientId=gs-service";
	...
	// https://fedeo.ceos.org/opensearch/request?httpAccept=application/atom%2Bxml&parentIdentifier=EOP:SSARA&startDate=2000-01-01T00:00:00Z&endDate=2018-01-31T00:00:00Z
	// http://fedeo.ceos.org/opensearch/request?httpAccept=application%2Fatom%2Bxml&parentIdentifier=EOP:SSARA&startRecord={startRecord?}&maximumRecords={maximumRecords?}&startDate={time:start}&endDate={time:end}&bbox={geo:box}&clientId=gs-service";
	FEDEOGranulesBondHandler handler = new FEDEOGranulesBondHandler(template);
	...
	Assert.assertEquals(
		"https://fedeo.ceos.org/opensearch/request?httpAccept=application%2Fatom%2Bxml&parentIdentifier=EOP:SSARA&clientId=gs-service&startDate=2000-01-01T00:00:00Z&endDate=2018-01-31T00:00:00Z&maximumRecords=10&startRecord=1&clientId=geo-dab&",
		query);
