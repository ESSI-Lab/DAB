...
import eu.essi_lab.accessor.ckan.packagesearch.CKANPackageSearchAccessor;
import eu.essi_lab.accessor.ckan.packagesearch.CKANPackageSearchConnector;
...
public class ServiceLoaderTest {
...

	{
	    ...
	    Assert.assertEquals(CKANAccessor.class, accessors.get(0).getClass());
	    Assert.assertEquals(CKANPackageSearchAccessor.class, accessors.get(1).getClass());
	}
