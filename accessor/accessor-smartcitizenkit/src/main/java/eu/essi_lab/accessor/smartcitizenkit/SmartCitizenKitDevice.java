...
public class SmartCitizenKitDevice {
...
//    String endTime; // e.g. 1500 (yyyymmdd)
    ...
    public SmartCitizenKitDevice() {

    }

    public SmartCitizenKitDevice(String stationCode, String name, List<List<Double>> multipoint, String minLat, String minLon, String maxLat,
