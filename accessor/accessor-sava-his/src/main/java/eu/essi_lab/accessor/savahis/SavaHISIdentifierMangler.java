...
/**
 * The SavaHIS identifier mangler is primarily used by the SavaHIS mapper to create the file identifier and the
 * distribution
 * online resource name for SavaHIS resources.
 * 
 * @author boldrini
 */
public class SavaHISIdentifierMangler extends KVPMangler {
    private static final String PLATFORM_KEY = "platform";
    private static final String PARAMETER_KEY = "parameter";
    private static final String MONITORING_TYPE_KEY = "monitoringType";

    public SavaHISIdentifierMangler() {
	super(";");
    }
	...
	setParameter(MONITORING_TYPE_KEY, monitoringType);
    }

    public String getMonitoringType() {
	return getParameterValue(MONITORING_TYPE_KEY);
    }
