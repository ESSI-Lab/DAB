...
@JsonSubTypes({//
	@JsonSubTypes.Type(value = MetadataElement.class, name = "metadataElement"),//
	@JsonSubTypes.Type(value = ResourceProperty.class, name = "resourceProperty"),//
	@JsonSubTypes.Type(value = OntologyObjectProperty.class, name = "ontologyObjectProperty"),//
	@JsonSubTypes.Type(value = RuntimeInfoElement.class, name = "runtimeInfoElement")//
})
