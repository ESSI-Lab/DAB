...
public class GSConfOptionBoolean extends GSConfOption<Boolean> {
    private static final long serialVersionUID = 995962386243422203L;
	...
	for (Boolean b : getAllowedValues()) {
