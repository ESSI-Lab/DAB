...
@XmlRootElement(name = "DatasetService", namespace = NameSpace.GS_DATA_MODEL_SCHEMA_URI)
public class DatasetService extends GSResource {

    public DatasetService() {

	super(ResourceType.SERVICE);
    }
