...
public enum RuntimeInfoElement implements Queryable {
    ...
    DISCOVERY_MESSAGE_OBSERVED_PROPERTY_URI("DISCOVERY_MESSAGE_observedPropertyURI"), //
    ...
    /** Discovery user-bond flag; ES field name matches {@code DISCOVERY_MESSAGE_isTimeseries}. */
    DISCOVERY_MESSAGE_IS_TIMESERIES("DISCOVERY_MESSAGE_isTimeseries"),
    ...
    RESULT_SET_ATTRIBUTE_URI("RESULT_SET_ATTRIBUTE_URI"), //
