...
//    	Created request with bbox south(-7.640272891266931E-4),west(0.0),north(85.05106286921993),east(179.9999999999)
    	...
    	SimpleEntry<Double, Double> lower = new SimpleEntry<Double, Double>(-87.,-180.);//-10018754.171394622 0
    	SimpleEntry<Double, Double> upper = new SimpleEntry<Double, Double>(87.,180.);//0 10018754.171394628
    	SimpleEntry<SimpleEntry<Double, Double>, SimpleEntry<Double, Double>> result2 = new SimpleEntry<>(lower,upper);
    	SimpleEntry<SimpleEntry<Double, Double>, SimpleEntry<Double, Double>> result3 = CRSUtils.translateBBOX(result2, CRS.EPSG_4326(), CRS.EPSG_3857());
    	SimpleEntry<Double, Double> lower3 = result3.getKey();	
    	SimpleEntry<Double, Double> upper3 = result3.getValue();
    	System.out.println(lower3);
    	System.out.println(upper3);
    	
    	SimpleEntry<SimpleEntry<Double, Double>, SimpleEntry<Double, Double>> result4 = CRSUtils.translateBBOX(result3, CRS.EPSG_3857(), CRS.EPSG_4326());
