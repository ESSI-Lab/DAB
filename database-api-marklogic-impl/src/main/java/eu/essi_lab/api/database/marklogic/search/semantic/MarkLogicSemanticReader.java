 ...
 * @author Fabrizio
 */
public class MarkLogicSemanticReader implements DatabaseReader {
     ...
     * @param markLogicDB
     */
    public MarkLogicSemanticReader(MarkLogicDatabase markLogicDB) {
    ...
    */
    ...
    @Override
    public boolean resourceExists(IdentifierType identifierType, String privateIdentifier) throws GSException {

	return false;
    }

    @Override
    public List<GSResource> getResources(IdentifierType identifierType, String privateIdentifier) throws GSException {
