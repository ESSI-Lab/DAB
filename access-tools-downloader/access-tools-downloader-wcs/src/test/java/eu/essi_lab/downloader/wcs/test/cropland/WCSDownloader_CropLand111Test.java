...
public class WCSDownloader_CropLand111Test extends WCSDownloader_CropLand111ExternalTestIT implements WCSMockedDownloader {

    public SimpleEntry<String, String> getCoverageUrlFile() {
	return new SimpleEntry<String, String>(CROP_LAND_WCS_111_DOWNLOAD_URL, "crop-land-wcs111-coverage.tif");
    }

    public String getCapabilitiesFile() {
	return "crop-land-wcs111-capabilities.xml";
    }

    public String getCoverageDescription() {
	return "crop-land-wcs111-coverage-description.xml";
    }
