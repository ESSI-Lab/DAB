...
/**
 * Abstract implementation for augmenters which only augment a {@link GSResource} and do not generates any concepts
 * 
 * @author Fabrizio
 */
public abstract class ResourceAugmenter<S extends AugmenterSetting> extends Augmenter<S> {
     ...
     */
    @Override
    public List<GSKnowledgeResourceDescription> generate(GSResource resource) throws GSException {
