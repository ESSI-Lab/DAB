...
public class CountResponseParser extends JSONDocumentParser {
	...
	try {
	    ...
	    return jsonObject.getLong(COUNT_KEY);

	} catch (JSONException e) {
	    throw GSException.createException(getClass(), "Can't parse count response", null, ErrorInfo.ERRORTYPE_SERVICE,
		    ErrorInfo.SEVERITY_ERROR, IOEXCEPTION_PARSING_ES_COUNT, e);
	}
    }
}
