...
public class GetDocumentParser extends JSONDocumentParser {
    ...
    public GetDocumentParser(String json) throws GSException {

	super(json);

    }

    public Optional<InputStream> getSource() throws GSException {

	try {

	    JSONObject source = jsonObject.getJSONObject(SOURCE_KEY);
