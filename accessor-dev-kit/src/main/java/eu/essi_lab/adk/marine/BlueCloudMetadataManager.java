...
public class BlueCloudMetadataManager {

    private static BlueCloudMetadataManager instance = null;

    public static BlueCloudMetadataManager getInstance() {
	if (instance == null) {
	    instance = new BlueCloudMetadataManager();
	}
	return instance;
    }

    private BlueCloudMetadataManager() {
    }
