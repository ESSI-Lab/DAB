...
public interface IGSAccessorConfigurable extends IGSConfigurableComposed {
        public List<BrokeringStrategy> getSupportedBrokeringStrategies();

    IDistributedAccessor getDistributedAccessor();

    IHarvestedAccessor getHarvestedAccessor();
