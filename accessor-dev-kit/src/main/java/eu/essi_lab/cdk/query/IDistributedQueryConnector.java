 ...
 * @param <T>
 */
public interface IDistributedQueryConnector<T extends DistributedConnectorSetting>
	extends IDriverConnector<T>, IDistributedQuerySubmitter<OriginalMetadata> {
