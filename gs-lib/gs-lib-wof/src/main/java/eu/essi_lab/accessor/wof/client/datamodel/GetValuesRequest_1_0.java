...
public class GetValuesRequest_1_0 extends GetValuesRequest {

    public GetValuesRequest_1_0() {
	super(GetValuesRequest_1_0.class.getClassLoader().getResourceAsStream("cuahsi/1.0/GetValuesRequest.xml"));
    }

    public static void main(String[] args) throws Exception {
	GetValuesRequest gvr = new GetValuesRequest_1_0();
