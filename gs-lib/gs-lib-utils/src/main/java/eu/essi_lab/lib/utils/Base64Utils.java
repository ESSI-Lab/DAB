...
public class Base64Utils {
     ...
     * @since 1.4
     */
    public static Optional<String> optionalEncodeObject(java.io.Serializable serializableObject) {
        try {
	    return Optional.ofNullable(encodeObject(serializableObject, NO_OPTIONS));
	} catch (IOException e) {
	    e.printStackTrace();
	}
     ...
     * </pre>
     * <p>
     * Example: <code>encodeObject( myObj, Base64SerializationUtils.GZIP )</code> or
     * <p>
     * Example: <code>encodeObject( myObj, Base64SerializationUtils.GZIP | Base64SerializationUtils.DONT_BREAK_LINES )</code>
     * 
     * @param serializableObject
     *            The object to encode
     * @param options
     ...
     * </pre>
     * <p>
     * Example: <code>encodeBytes( myData, Base64SerializationUtils.GZIP )</code> or
     * <p>
     * Example: <code>encodeBytes( myData, Base64SerializationUtils.GZIP | Base64SerializationUtils.DONT_BREAK_LINES )</code>
     * 
     * 
     * @param source
     *            The data to convert
...
//                System.err.println( "Bad Base64 input character at " + i + ": " + source[i] + "(decimal)" );
    ...
    public static boolean encodeToFile(byte[] dataToEncode, String filename) {
        ...
        try {
            bos = new Base64Utils.OutputStream(new java.io.FileOutputStream(filename), Base64Utils.ENCODE);
    ...
    public static boolean decodeToFile(String dataToDecode, String filename) {
        ...
        Base64Utils.OutputStream bos = null;
        try {
            bos = new Base64Utils.OutputStream(new java.io.FileOutputStream(filename), Base64Utils.DECODE);
    ...
    public static byte[] decodeFromFile(String filename) {
        ...
        try {
            ...
            // Open a stream
            bis = new Base64Utils.InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)),
                    Base64Utils.DECODE);
    ...
    /**
     * A {@link Base64Utils.InputStream} will read data from another <tt>java.io.InputStream</tt>, given
    ...
    public static class InputStream extends java.io.FilterInputStream {
        ...
        /**
         * Constructs a {@link Base64Utils.InputStream} in either ENCODE or DECODE mode.
         * <p>
         * Valid options:
         * 
         * <pre>
         ...
         * </pre>
         * <p>
         * Example: <code>new Base64SerializationUtils.InputStream( in, Base64SerializationUtils.DECODE )</code>
         * 
         * 
         * @param in
         *            the <tt>java.io.InputStream</tt> from which to read data.
    ...
    /**
     * A {@link Base64Utils.OutputStream} will write data to another <tt>java.io.OutputStream</tt>, given
     * in the constructor, and encode/decode to/from Base64 notation on the fly.
     * 
     * @see Base64
     * @since 1.3
    ...
    public static class OutputStream extends java.io.FilterOutputStream {
        ...
        /**
         * Constructs a {@link Base64Utils.OutputStream} in either ENCODE or DECODE mode.
         * <p>
         * Valid options:
         * 
         * <pre>
         ...
         * </pre>
         * <p>
         * Example: <code>new Base64SerializationUtils.OutputStream( out, Base64SerializationUtils.ENCODE )</code>
         * 
         * @param out
         *            the <tt>java.io.OutputStream</tt> to which data will be written.
         * @param options
            ...
            // Else, Decoding
                ...
                if (DECODABET[theByte & 0x7f] > WHITE_SPACE_ENC) {
                    ...
                    if (position >= bufferLength) // Enough to output.
                    {
                        ...
                        out.write(b4, 0, len);
                        //out.write( Base64SerializationUtils.decode4to3( buffer ) );
                        position = 0;
                    } // end if: enough to output
