 ...
 * with DOM (using e.g. XMLDocumentReader) as the parsed DOM is being stored in memory in that case.
 * This implementation uses instead StAX parser to return an iterator of smaller DOM parsed XML documents (each one
 * being an element of the initial list, having as root the provided searchElement element).
 * 
 * @author boldrini
 */
public class StAXDocumentIterator implements Iterator<XMLDocumentReader> {
