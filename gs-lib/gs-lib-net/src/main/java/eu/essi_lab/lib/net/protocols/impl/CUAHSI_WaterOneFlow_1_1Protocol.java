...
public class CUAHSI_WaterOneFlow_1_1Protocol extends AbstractNetProtocol implements NetProtocol {

    @Override
    public String getDescription() {

	return "CUAHSI WaterOneFlow 1.1 Protocol";
    }

    @Override
    public String[] getURNs() {

	return new String[] { "urn:ogc:serviceType:WaterOneFlow:1.1:HTTP" };
    }
