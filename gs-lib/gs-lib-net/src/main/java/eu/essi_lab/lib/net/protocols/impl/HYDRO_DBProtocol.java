...
public class HYDRO_DBProtocol extends AbstractNetProtocol implements NetProtocol {

    @Override
    public String getDescription() {

	return "ARPA HYDRO-DB Protocol";
    }

    @Override
    public String[] getURNs() {

	return new String[] { "HYDROSERVER-DB" };
    }

    @Override
    public String getSrvType() {

	return "HYDROSERVER-DB";
    }
