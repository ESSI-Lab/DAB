...
public class WCS_1_0_0Protocol extends AbstractNetProtocol implements NetProtocol {

    @Override
    public String getDescription() {

	return "OGC Web Coverage Service 1.0.0 Protocol";
    }

    @Override
    public String[] getURNs() {

	return new String[] { "urn:ogc:serviceType:WebCoverageService:1.0.0:HTTP", "OGC:WCS-1.0-http-get",
