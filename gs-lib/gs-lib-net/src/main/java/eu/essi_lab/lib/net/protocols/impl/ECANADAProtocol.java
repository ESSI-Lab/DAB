...
public class ECANADAProtocol extends AbstractNetProtocol implements NetProtocol {

    @Override
    public String getDescription() {

	return "Environment Canada Protocol";
    }

    @Override
    public String[] getURNs() {

	return new String[] { "urn:essi-lab.eu:protocols:dd.weather.gc.ca:hydrometric" };
    }
