...
public class TILED_SERVICEProtocol extends AbstractNetProtocol implements NetProtocol {

    @Override
    public String getDescription() {

	return "Tiled Service";
    }

    @Override
    public String[] getURNs() {

	return new String[] { "urn:essi:serviceType:TiledMapService:HTTP" };
    }
