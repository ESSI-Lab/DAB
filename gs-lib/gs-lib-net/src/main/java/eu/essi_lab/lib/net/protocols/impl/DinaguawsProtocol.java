...
public class DinaguawsProtocol extends AbstractNetProtocol implements NetProtocol {

    @Override
    public String getDescription() {

	return "Dinaguaws Protocol";
    }

    @Override
    public String[] getURNs() {

	return new String[] { "urn:essi:serviceType:DinaguaWS" };
    }
