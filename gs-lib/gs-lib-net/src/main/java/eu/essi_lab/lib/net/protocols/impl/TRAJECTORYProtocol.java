...
public class TRAJECTORYProtocol extends AbstractNetProtocol implements NetProtocol {

    @Override
    public String getDescription() {

	return "Trajectory Protocol";
    }

    @Override
    public String[] getURNs() {

	return new String[] { "urn:essi:serviceType:Trajectory:HTTP" };
    }

    @Override
    public String getSrvType() {

	return "Trajectory GML";
    }
