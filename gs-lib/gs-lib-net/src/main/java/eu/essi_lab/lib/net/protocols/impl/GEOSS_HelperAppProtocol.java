...
public class GEOSS_HelperAppProtocol extends AbstractNetProtocol implements NetProtocol {

    @Override
    public String getDescription() {

	return "GEOSS Helper Application";
    }

    @Override
    public String[] getURNs() {

	return new String[] { "geoss:helperapp" };
    }
