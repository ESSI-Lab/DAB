...
public class WCS_1_1_1Protocol extends AbstractNetProtocol implements NetProtocol {

    @Override
    public String getDescription() {

	return "OGC Web Coverage Service 1.1.1 Protocol";
    }

    @Override
    public String[] getURNs() {

	return new String[] { "urn:ogc:serviceType:WebCoverageService:1.1.1:HTTP", "OGC:WCS-1.1.1-http-get",
