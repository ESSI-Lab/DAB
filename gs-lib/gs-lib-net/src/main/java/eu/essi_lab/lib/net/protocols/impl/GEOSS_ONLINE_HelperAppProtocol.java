...
public class GEOSS_ONLINE_HelperAppProtocol extends AbstractNetProtocol implements NetProtocol {

    @Override
    public String getDescription() {

	return "GEOSS Online Helper Application";
    }

    @Override
    public String[] getURNs() {

	return new String[] { "geoss:helperapp:online" };
    }
