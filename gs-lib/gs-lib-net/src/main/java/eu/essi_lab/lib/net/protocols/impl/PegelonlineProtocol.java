 ...
 * @author boldrini
 */
public class PegelonlineProtocol extends AbstractNetProtocol implements NetProtocol {

    @Override
    public String getDescription() {

	return "PEGELONLINE REST API Protocol";
    }

    @Override
    public String[] getURNs() {

	return new String[] { "https://www.pegelonline.wsv.de/webservices/rest-api" };
    }
