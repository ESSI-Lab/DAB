 ...
 * @author boldrini
 */
public class UKHydrologyProtocol extends AbstractNetProtocol implements NetProtocol {

    @Override
    public String getDescription() {

	return "UK Environment Agency Hydrology API Protocol";
    }

    @Override
    public String[] getURNs() {

	return new String[] { "https://environment.data.gov.uk/hydrology" };
    }
