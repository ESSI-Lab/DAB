...
public class UDDCProtocol extends AbstractNetProtocol implements NetProtocol {

    @Override
    public String getDescription() {

	return "NetCDF Attribute Convention for Dataset Discovery Report";
    }

    @Override
    public String[] getURNs() {

	return new String[] { "UDDC" };
    }
