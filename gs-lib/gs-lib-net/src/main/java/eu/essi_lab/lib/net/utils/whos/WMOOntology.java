...
public class WMOOntology {
	...
	CUBIC_METRES_PER_SECOND("http://codes.wmo.int/common/unit/m3_s-1","cubic metres per second","m3/s","m³/s","cms","cubic meters per second","cubic metres per second","cubic metre per second","cubic meter per second","metros cúbicos por segundo"),//
	...
	DECIPASCALS_PER_SECOND_MICROBAR_PER_SECOND("http://codes.wmo.int/common/unit/dPa_s-1","decipascals per second (microbar per second)","dPa/s"),//
	...
	DEGREE_CELSIUS("http://codes.wmo.int/common/unit/Cel","degree Celsius","Cel","˚C","°C","degrees Celsius","grados centígrados"),//
	...
	KELVIN_SQUARE_METRES_PER_KILOGRAM_PER_SECOND("http://codes.wmo.int/common/unit/K_m2_kg-1_s-1","kelvin square metres per kilogram per second","K m2 kg-1 s-1"),//
	...
	KILOGRAMS_PER_KILOGRAM_PER_SECOND("http://codes.wmo.int/common/unit/kg_kg-1_s-1","kilograms per kilogram per second","kg kg-1 s-1"),//
	...
	KILOGRAMS_PER_SQUARE_METRE_PER_SECOND("http://codes.wmo.int/common/unit/kg_m-2_s-1","kilograms per square metre per second","kg m-2 s-1"),//
	...
	METRES_TO_THE_TWO_THIRDS_POWER_PER_SECOND("http://codes.wmo.int/common/unit/m2_-1","metres to the two thirds power per second","m2/3 s-1"),//
	MICRO("http://codes.wmo.int/common/unit/u_pref","micro","u"),//
	MILLI("http://codes.wmo.int/common/unit/m_pref","milli","m"),//
	MILLIMETRE("http://codes.wmo.int/common/unit/mm","millimetre","mm","milímetros","millimeters","millimetres","millimeter","millimetre"),//
	...
	MILLIMETRES_PER_THE_SIXTH_POWER_PER_CUBIC_METRE("http://codes.wmo.int/common/unit/mm6_m-3","millimetres per the sixth power per cubic metre","mm6 m-3"),//
	...
	WATTS_PER_CUBIC_METRE_PER_STERADIAN("http://codes.wmo.int/common/unit/W_m-3_sr-1","watts per cubic metre per steradian","W m-3 sr-1"),//
	...
	WATTS_PER_SQUARE_METRE_PER_STERADIAN("http://codes.wmo.int/common/unit/W_m-2_sr-1","watts per square metre per steradian","W m-2 sr-1"),//
	WATTS_PER_SQUARE_METRE_PER_STERADIAN_CENTIMETRE("http://codes.wmo.int/common/unit/W_m-2_sr-1_cm","watts per square metre per steradian centimetre","W m-2 sr-1 cm"),//
	WATTS_PER_SQUARE_METRE_PER_STERADIAN_METRE("http://codes.wmo.int/common/unit/W_m-2_sr-1_m","watts per square metre per steradian metre","W m-2 sr-1 m"),//
	...
	if (unitCache.entrySet().isEmpty()) {
		...
		url = url + query;
		InputStream stream = d.downloadStream(url).get();
