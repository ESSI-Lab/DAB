...
public class SystemSetting extends ConfigurableSetting implements EditableSetting, KeyValueOptionDecorator {
	...
	public SystemSetting() {
		...
		Option<BooleanChoice> harvestingMailOption = BooleanChoiceOptionBuilder.get().//
				...
				withDescription(
						"System restart required. This feature also require that E-mail settings are correctly compiled")
				.//
				withSingleSelection().//
		...
		Option<String> proxyEndpoint = StringOptionBuilder.get().//
				...
				withDescription(
						"The GI-proxy endpoint used by accessors and downloaders (e.g. to circumvent firewalls)")
				.//
				cannotBeDisabled().//
				build();
