...
public interface DistributedQueryExecutor extends QueryExecutor {
    ...
    ResultSet<Node> retrieveNodes(ReducedDiscoveryMessage message, Page page) throws GSException;

    ResultSet<String> retrieveStrings(ReducedDiscoveryMessage message, Page page) throws GSException;
}
